...
public abstract class AbstractFont {
	...
	public static CacheNode_Sub13 aCacheNode_Sub13_788;
	...
	public static final void method528(int i, int i_22_) {
		anInt793++;
		if (i != 255)
			aCacheNode_Sub13_788 = null;
		CacheNode_Sub2 cachenode_sub2 = Class320_Sub19.method3754(i ^ 0xfc, 4, i_22_);
		cachenode_sub2.method2291((byte) 121);
	}

	public static final Node_Sub38 method530(int i, int i_39_) {
		anInt803++;
		int i_40_ = i;
		while_64_: do {
			while_63_: do {
	...
	public static final void method544(int i, int i_117_, int i_118_, int i_119_, byte b) {
		anInt791++;
	...
	AbstractFont(GraphicsToolkit graphicstoolkit, Class357 class357) {
	...
	public final int method525(GLSprite[] glsprites, int i, int i_0_, int i_1_, int i_2_, String string, int[] is, int i_3_,
			Random random, int i_4_) {
		anInt792++;
		if (string == null)
			return 0;
		random.setSeed(i);
	...
	public final void method527(int i, int i_14_, int i_15_, int i_16_, int i_17_, String string, int i_18_, int i_19_) {
		anInt790++;
		if (string != null) {
			...
			for (int i_21_ = 0; i_20_ > i_21_; i_21_++)
				is[i_21_] = (int) (Math.sin(i_15_ + i_21_ / 1.5) * d);
			method529(null, string, i_16_, null, -(aClass357_789.method4033((byte) -6, string) / 2) + i_14_, is, true,
					null);
		}
	}

	private final void method529(int[] is, String string, int i, GLSprite[] glsprites, int i_23_, int[] is_24_,
			boolean bool, int[] is_25_) {
			...
			if (c == 60)
							...
							if (!string_31_.equals("reg")) {
								if (string_31_.startsWith("img="))
									try {
										...
										glsprite.method1191(i_32_ + i_23_,
												i_33_ + -i_35_ + (i + aClass357_789.anInt4430), 1, 0, 1);
										i_27_ = -1;
				...
				if (i_26_ == -1) {
					...
					if ((Class339.anInt4204 ^ 0xffffffff) != 0)
						aGraphicsToolkit799.method1242((int) (0.7 * aClass357_789.anInt4430) + i, Class339.anInt4204,
								i_23_, false, i_38_);
					if ((Class370.anInt4568 ^ 0xffffffff) != 0)
						aGraphicsToolkit799.method1242(aClass357_789.anInt4430 + i, Class370.anInt4568, i_23_, false,
								i_38_);
					i_23_ += i_38_;
					i_27_ = c;
				}
	...
	private final void method533(GLSprite[] glsprites, int i, int i_44_, String string, int i_45_, boolean bool,
			aa var_aa, int i_46_, int[] is) {
			...
			for (int i_50_ = 0; (i_49_ ^ 0xffffffff) < (i_50_ ^ 0xffffffff); i_50_++) {
				...
				if (c == 60)
										...
										if (!string_51_.equals("reg")) {
											if (string_51_.startsWith("img="))
												try {
													...
													if ((Class270_Sub2_Sub2.anInt10558 & ~0xffffff
															^ 0xffffffff) == 16777215)
														glsprite.method1191(i_45_,
																-i_53_ + (aClass357_789.anInt4430 + i_46_), 1, 0, 1);
													else
														glsprite.method1191(i_45_,
																-i_53_ + i_46_ + aClass357_789.anInt4430, 0,
																Class270_Sub2_Sub2.anInt10558 & ~0xffffff | 0xffffff,
																1);
													i_48_ = -1;
					...
					if (i_47_ == -1) {
						...
						if ((Class339.anInt4204 ^ 0xffffffff) != 0)
							aGraphicsToolkit799.method1242(i_46_ + (int) (0.7 * aClass357_789.anInt4430),
									Class339.anInt4204, i_45_, false, i_54_);
						if ((Class370.anInt4568 ^ 0xffffffff) != 0)
							aGraphicsToolkit799.method1242(1 + (aClass357_789.anInt4430 + i_46_), Class370.anInt4568,
									i_45_, false, i_54_);
						i_48_ = c;
						i_45_ += i_54_;
					}
	...
	public final int method535(int i, int[] is, int i_57_, String string, aa var_aa, GLSprite[] glsprites, int i_58_,
			int i_59_, int i_60_, int i_61_, int i_62_, int i_63_, int i_64_, int i_65_, int i_66_, int i_67_) {
		anInt798++;
		return method539(i_64_, 2, i_57_, i_59_, glsprites, 0, i, i_58_, i_67_, i_61_, var_aa, i_65_, i_66_, i_63_,
				i_62_, is, string);
	}

	public final void drawText(int i, int i_70_, int i_71_, String string, int i_73_, GLSprite[] glsprites,
			int[] is) {
		anInt794++;
		if (string != null) {
			method534(1, i, i_70_);
	...
	public final void method537(int i, byte b, int i_74_, String string, int i_75_, int i_76_) {
		if (b >= 95) {
			anInt785++;
			if (string != null) {
				method534(1, i_76_, i);
				method533(null, 0, 0, string, -(aClass357_789.method4033((byte) -6, string) / 2) + i_74_, true, null,
						i_75_, null);
			}
		}
	}

	public final void method538(int i, int i_77_, String string, int i_78_, int i_79_, int i_80_) {
		anInt804++;
		if (string != null) {
	...
	public final int method539(int i, int i_81_, int i_82_, int i_83_, GLSprite[] glsprites, int i_84_, int i_85_, int i_86_,
			int i_87_, int i_88_, aa var_aa, int i_89_, int i_90_, int i_91_, int i_92_, int[] is, String string) {
		anInt795++;
		if (string == null)
			return 0;
		if (i_81_ != 2)
		...
		int[] is_93_;
		if ((i_89_ + (aClass357_789.anInt4442 + aClass357_789.anInt4434) ^ 0xffffffff) >= (i_87_ ^ 0xffffffff)
				|| (i_87_ ^ 0xffffffff) <= (i_89_ - -i_89_ ^ 0xffffffff))
		...
		if ((i_84_ ^ 0xffffffff) < -1 && (i_84_ ^ 0xffffffff) >= (i_94_ ^ 0xffffffff)) {
			i_94_ = i_84_;
			Class9.aStringArray167[i_84_ - 1] = aClass357_789.method4032(Class9.aStringArray167[i_84_ + -1], glsprites,
					i_90_, i_81_ + -3);
		}
		if (i == 3 && i_94_ == 1)
			i = 1;
		...
		if ((i ^ 0xffffffff) != -1) {
			if ((i ^ 0xffffffff) == -2)
				i_95_ = (-aClass357_789.anInt4442 + -aClass357_789.anInt4434 + (i_87_ - i_89_ * (-1 + i_94_))) / 2
						+ aClass357_789.anInt4434 + i_86_;
			else if (i == 2)
				i_95_ = -(i_89_ * (i_94_ - 1)) + (-aClass357_789.anInt4442 + (i_87_ + i_86_));
			else {
				int i_96_ = (-aClass357_789.anInt4434 + i_87_ + -aClass357_789.anInt4442 - i_89_ * (i_94_ - 1))
						/ (1 + i_94_);
			...
			if ((i_92_ ^ 0xffffffff) != -1) {
				if (i_92_ != 1) {
					if ((i_92_ ^ 0xffffffff) == -3)
						method533(glsprites, i_85_, i_88_, Class9.aStringArray167[i_97_],
								i_91_ + (i_90_ + -aClass357_789.method4033((byte) -6, Class9.aStringArray167[i_97_])),
								true, var_aa, i_95_, is);
					else if (i_94_ - 1 == i_97_)
						method533(glsprites, i_85_, i_88_, Class9.aStringArray167[i_97_], i_91_, true, var_aa, i_95_,
								is);
					else {
					...
					method533(glsprites, i_85_, i_88_, Class9.aStringArray167[i_97_],
							i_91_ - -((i_90_ - aClass357_789.method4033((byte) -6, Class9.aStringArray167[i_97_])) / 2),
							true, var_aa, i_95_, is);
			} else
	...
	private final void method540(int i, String string) {
		try {
			if (string.startsWith("col="))
				Class270_Sub2_Sub2.anInt10558 = Class270_Sub2_Sub2.anInt10558 & ~0xffffff
						| Class10.method187(string.substring(4), 16, true) & 0xffffff;
			else if (string.equals("/col"))
				Class270_Sub2_Sub2.anInt10558 = Class270_Sub2_Sub2.anInt10558 & ~0xffffff
						| Node_Sub25_Sub4.anInt10011 & 0xffffff;
				...
				if (string.equals("/argb"))
					...
					if (string.equals("str"))
						...
						if (!string.startsWith("u=")) {
							if (string.equals("u"))
								...
								if (!string.equalsIgnoreCase("shad=-1")) {
									if (string.startsWith("shad="))
										CacheNode_Sub4.anInt9465 = Class270_Sub2_Sub2.anInt10558 & ~0xffffff
												| Class10.method187(string.substring(5), 16, true);
							...
							Class370.anInt4568 = ~0xffffff & Class270_Sub2_Sub2.anInt10558
									| Class10.method187(string.substring(2), 16, true);
					} else
						Class339.anInt4204 = -1;
				} else
					Class339.anInt4204 = ~0xffffff & Class270_Sub2_Sub2.anInt10558
							| Class10.method187(string.substring(4), 16, true);
			} else
	...
	public final void method541(int i, int i_98_, String string, int i_99_, int i_100_, int i_101_, int i_102_) {
		anInt805++;
		if (string != null) {
			...
			if (i_102_ == 16777215) {
				for (int i_105_ = 0; (i_103_ ^ 0xffffffff) < (i_105_ ^ 0xffffffff); i_105_++) {
					is[i_105_] = (int) (5.0 * Math.sin(i_105_ / 5.0 + i_98_ / 5.0));
					is_104_[i_105_] = (int) (5.0 * Math.sin(i_105_ / 3.0 + i_98_ / 5.0));
				}
				method529(is, string, i_101_, null, -(aClass357_789.method4033((byte) -6, string) / 2) + i_99_, is_104_,
						true, null);
			}
		}
	}

	public final void method542(int i, int i_106_, int i_107_, String string, int i_108_, int i_109_, int i_110_) {
		anInt787++;
		if (string != null) {
			...
			if (i == 5) {
				...
				for (int i_112_ = 0; i_111_ > i_112_; i_112_++)
					is[i_112_] = (int) (5.0 * Math.sin(i_112_ / 2.0 + i_107_ / 5.0));
				method529(null, string, i_109_, null, i_108_ - aClass357_789.method4033((byte) -6, string) / 2, is,
						true, null);
			}
		}
	}

	public final void displayInterText(int i, String string, int i_113_, int i_114_, int i_115_) {
		anInt802++;
		if (string != null) {
	...
	/**
	 * Displays a string of text on the client
	 * @param string
	 * @param x
	 * @param y
	 */
	public final void sendStringOverlay(int x, int y, String text) {
		anInt802++;
		if (text != null) {
			method534(1, -256, -1);
			method533(null, 0, 0, text, x + -aClass357_789.method4033((byte) -6, text), true, null, y, null);
		}
	}

	public final int method545(int[] is, int i, int i_120_, int i_121_, int[] is_122_, int i_123_, int i_124_, Random random,
			String string, int i_125_, int i_126_, GLSprite[] glsprites, int i_127_, int i_128_, int i_129_) {
		anInt801++;
		if (string == null)
			return 0;
		random.setSeed(i_127_);
