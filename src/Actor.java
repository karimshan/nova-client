...
abstract class Actor extends Mobile {
	public static Class257 aClass257_10823 = new Class257(6, 16);
	public static int anInt10816;
	public static int anInt10818;
	public static int anInt10820;
	public static int anInt10821;
	public static int anInt10822;
	public static int anInt10824;
	public static int anInt10825;
	public static int anInt10827;
	public static int anInt10828;
	public static int anInt10830;
	public static int anInt10831;
	public static int anInt10833;
	public static int anInt10834;
	public static int anInt10836;
	public static int anInt10837;
	public static int anInt10839;
	public static int anInt10840;
	public static int anInt10841;
	public static int anInt10843;
	public static int anInt10846;
	public static int anInt10847;
	public static int anInt10852;
	...
	public static final boolean method859(int i, int i_48_, int i_49_, Animable_Sub2 animable_sub2, int i_50_) {
		anInt10830++;
		...
		if (animable_sub2.aShort9110 == 1) {
			if (!Class99.method1087(i_51_, i_52_, i_54_, i_54_, i_53_, (byte) 89, i_52_, Class179.anInt2129 + i_52_,
					i_51_, i_51_))
				return false;
			if (!Class99.method1087(i_51_, i_52_, i_54_, i_53_, i_53_, (byte) 89, i_52_ + Class179.anInt2129,
					i_52_ + Class179.anInt2129, i_51_, i_51_))
				return false;
			Node_Sub52.anInt7651++;
			return true;
		}
		if ((animable_sub2.aShort9110 ^ 0xffffffff) == -3) {
			if (!Class99.method1087(i_51_ - -Class179.anInt2129, i_52_ - -Class179.anInt2129, i_54_, i_54_, i_53_,
					(byte) 89, i_52_ - -Class179.anInt2129, Class179.anInt2129 + i_52_, i_51_, i_51_))
				return false;
			if (!Class99.method1087(i_51_ + Class179.anInt2129, i_52_ - -Class179.anInt2129, i_53_, i_54_, i_53_,
					(byte) 89, Class179.anInt2129 + i_52_, i_52_ + Class179.anInt2129, i_51_,
					i_51_ + Class179.anInt2129))
				return false;
			Node_Sub52.anInt7651++;
			return true;
		}
		if ((animable_sub2.aShort9110 ^ 0xffffffff) == -5) {
			if (!Class99.method1087(Class179.anInt2129 + i_51_, i_52_, i_54_, i_54_, i_53_, (byte) 89, i_52_,
					Class179.anInt2129 + i_52_, i_51_ - -Class179.anInt2129, Class179.anInt2129 + i_51_))
				return false;
			if (!Class99.method1087(i_51_ + Class179.anInt2129, i_52_, i_54_, i_53_, i_53_, (byte) 89,
					Class179.anInt2129 + i_52_, Class179.anInt2129 + i_52_, i_51_ - -Class179.anInt2129,
					Class179.anInt2129 + i_51_))
				return false;
			Node_Sub52.anInt7651++;
			return true;
		}
		if ((animable_sub2.aShort9110 ^ 0xffffffff) == -9) {
			if (!Class99.method1087(Class179.anInt2129 + i_51_, i_52_, i_54_, i_54_, i_53_, (byte) 89, i_52_, i_52_,
					i_51_, i_51_))
				return false;
			if (!Class99.method1087(Class179.anInt2129 + i_51_, i_52_, i_53_, i_54_, i_53_, (byte) 89, i_52_, i_52_,
					i_51_, i_51_ + Class179.anInt2129))
				return false;
			Node_Sub52.anInt7651++;
			return true;
		}
		if ((animable_sub2.aShort9110 ^ 0xffffffff) == -17) {
			if (!Node_Sub25.method2653(Class135.anInt1692, i_54_, i_51_, i_49_ ^ 0x1036, Class135.anInt1692 + i_52_,
					i_53_, Class135.anInt1692))
				return false;
			Node_Sub52.anInt7651++;
			return true;
		}
		if ((animable_sub2.aShort9110 ^ 0xffffffff) == -33) {
			if (!Node_Sub25.method2653(Class135.anInt1692, i_54_, i_51_ + Class135.anInt1692, 255,
					Class135.anInt1692 + i_52_, i_53_, Class135.anInt1692))
				return false;
			Node_Sub52.anInt7651++;
			return true;
		}
		if ((animable_sub2.aShort9110 ^ 0xffffffff) == -65) {
			if (!Node_Sub25.method2653(Class135.anInt1692, i_54_, Class135.anInt1692 + i_51_, 255, i_52_, i_53_,
					Class135.anInt1692))
				return false;
			Node_Sub52.anInt7651++;
			return true;
		...
		if ((animable_sub2.aShort9110 ^ 0xffffffff) == -129) {
			if (!Node_Sub25.method2653(Class135.anInt1692, i_54_, i_51_, i_49_ + -4042, i_52_, i_53_,
					Class135.anInt1692))
				return false;
			Node_Sub52.anInt7651++;
			return true;
	...
	public static final void method863(byte[][] bs, byte b, Class277_Sub1 class277_sub1) {
		anInt10821++;
		int i = bs.length;
		for (int i_66_ = 0; i > i_66_; i_66_++) {
			...
			if (bs_67_ != null) {
				...
				class277_sub1.method3337(buffer, i_71_, Class304.SCENE_CLIP_DATA_PLANES, Class320_Sub4.gameSceneBaseY,
						(byte) -120, Node_Sub53.gameSceneBaseX, i_70_);
				class277_sub1.method3351(i_71_, buffer, i_70_, Class93.graphicsToolkit, 17986);
			}
		}
		if (b != -74)
			aClass257_10823 = null;
	...
	@Override
	public final void method845(int i) {
		anInt10865++;
	...
	public final void method847(int i) {
	...
	public final void method848(int i, int i_0_, GraphicsToolkit graphicstoolkit, Class259 class259, int i_1_, int i_2_,
			int i_3_) {
		if (i_3_ > -57)
		...
		for (int i_4_ = 0; i_4_ < aClass165Array10886.length; i_4_++) {
			...
			if (class165.graphicsId == -1 || class165.anAnimator2026.method242((byte) -77))
				...
				Login class195 = Class16.aClass101_228.method1090(86, class165.graphicsId);
				...
				if (!bool) {
					...
					i_5_ |= 0x7;
				DrawableModel drawablemodel = aDrawableModelArray10909[1 + i_4_] = class195
						.method1989(class165.anAnimator2026, b, i_5_, (byte) 87, graphicstoolkit);
				if (drawablemodel != null) {
					if ((class165.anInt2025 ^ 0xffffffff) <= -1 && class259.anIntArrayArray3273 != null
							&& class259.anIntArrayArray3273[class165.anInt2025] != null) {
						int i_6_ = 0;
						int i_7_ = 0;
						int i_8_ = 0;
						...
						if (class259.anIntArrayArray3249 != null
								&& class259.anIntArrayArray3249[class165.anInt2025] != null) {
	...
	public final void method849(int i, int i_16_, boolean bool) {
		if (i_16_ > -27)
			aClass99_10898 = null;
		anInt10833++;
	...
	public final void method852(int i, int i_17_, int i_18_, byte b, int i_19_, int i_20_, int i_21_, int i_22_) {
		anInt10843++;
		boolean bool = true;
	...
	public final int method854(int i) {
		anInt10827++;
	...
	public final void method856(byte b, int i) {
		anInt10859++;
		Class259 class259 = method868((byte) -127);
	...
	public final void method857(DrawableModel drawablemodel, boolean bool) {
		if (bool != false)
			method867(43);
		anInt10831++;
	...
	public final boolean method858(int i, int i_38_, int i_39_) {
		anInt10837++;
		...
		if (i_39_ == -1) {
			...
			if (-i_41_ <= i_44_ && (i_41_ ^ 0xffffffff) <= (i_44_ ^ 0xffffffff)) {
				...
				for (int i_45_ = 0; (Class63.aClass363_922.anIntArray4508.length ^ 0xffffffff) < (i_45_
						^ 0xffffffff); i_45_++)
	...
	public final void method861(int i, int i_65_) {
		if (i != -1000)
			method823((byte) -92);
		anInt10851 = i_65_;
		anInt10870++;
	...
	public final void method864(int i, String string, boolean bool, int i_76_, int i_77_) {
		anInt10824++;
	...
	public final void method865(int i, int i_79_, int i_80_, int i_81_, int i_82_, int i_83_) {
		anInt10840++;
		...
		anInt10872 = 0x3fff & (int) (2607.5945876176133 * Math.atan2(-i_109_ + i_108_, i_82_));
		int i_111_ = i_102_ > i_92_ ? i_92_ : i_102_;
		anInt10862 = (int) (Math.atan2(i_111_ - i_110_, i_81_) * 2607.5945876176133) & 0x3fff;
		if (i_83_ < -78) {
	...
	public final void method866(int[] is, int[] is_114_, byte b) {
		anInt10818++;
	...
	public final void method867(int i) {
		anInt10852++;
		anInt10904 = 0;
		anInt10900 = 0;
		if (i != 536)
	...
	public final Class259 method868(byte b) {
		if (b > -122)
			return null;
		anInt10822++;
		int i = method871(0);
	...
	public final void method870(GraphicsToolkit graphicstoolkit, byte b, boolean bool, DrawableModel[] drawablemodels,
			Class336 class336) {
		if (bool) {
			if (anEntityNode_Sub4_10902 != null)
				anEntityNode_Sub4_10902.method958(Class174.clientCycle);
		} else {
			int i = 0;
			int i_117_ = 0;
			int i_118_ = 0;
			...
			if ((anEntityNode_Sub4_10902 == null || anEntityNode_Sub4_10902.aBoolean5972)
					&& ((i_117_ ^ 0xffffffff) < -1 || i_119_ > 0))
			...
			if (anEntityNode_Sub4_10902 != null) {
				...
				anEntityNode_Sub4_10902.method952(graphicstoolkit, Class174.clientCycle, class300s_123_, class218s_127_,
						false);
				aBoolean10906 = true;
			}
		}
	...
	public final void sendGraphics(int slot, int rotation, boolean bool, int settings, int i_57_, int id) {
		Class165 class165 = aClass165Array10886[slot];
		int i_60_ = class165.graphicsId;
		do
			if ((id ^ 0xffffffff) != 0 && i_60_ != -1)
				if (i_60_ == id) {
					Login class195 = Class16.aClass101_228.method1090(-120, id);
					...
					Login class195 = Class16.aClass101_228.method1090(-120, id);
					Login class195_62_ = Class16.aClass101_228.method1090(-96, i_60_);
		...
		if (id != -1 && bool)
			i_64_ = 1;
		class165.anAnimator2026.method228(id == -1 ? -1 : Class16.aClass101_228.method1090(72, id).anInt2394,
				settings & 0xffff, (byte) 114, i_64_, false);
	}
}
