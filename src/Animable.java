...
abstract class Animable extends EntityNode {
	public static Class193 aClass193_5936 = new Class193();
	public static float aFloat5932;
	...
	public static final void method822(int i, int i_10_, int i_11_) {
		anInt5943++;
	...
	public final int method808(int i, Node_Sub29[] node_sub29s, int i_0_, int i_1_) {
		anInt5939++;
		if (i != -23024)
			aFloat5932 = 0.34159562F;
		long l = PlayerMasks.aLongArrayArrayArray1228[plane][i_1_][i_0_];
		long l_2_ = 0L;
		int i_3_ = 0;
	...
	abstract void method816(int i, boolean bool, GraphicsToolkit graphicstoolkit, int i_7_, byte b, int i_8_,
			Animable animable_9_);
