...
class AnimableAnimator extends Animator {
	public static Class124 aClass124_5500 = new Class124(60);
	public static Class42 aClass42_5498;
	...
	public static final void method253(d var_d, GraphicsToolkit graphicstoolkit, boolean bool) {
		anInt5496++;
		if (Class20.aCacheNode_Sub11_318 != null) {
			if (Node_Sub25_Sub1.anInt9947 < 10) {
				if (!Class20.aClass302_314.method3527(Class20.aCacheNode_Sub11_318.aString9537, 0)) {
					Node_Sub25_Sub1.anInt9947 = r_Sub1.aClass302_11047.method3522((byte) 127,
							Class20.aCacheNode_Sub11_318.aString9537) / 10;
					return;
				}
			...
			if (Node_Sub25_Sub1.anInt9947 == 10) {
				...
				int i = -1;
				int i_0_ = -1;
				if (Class20.aCacheNode_Sub11_318.method2337(-12584, is,
						Class320_Sub4.gameSceneBaseY - -(Player.get.anInt5940 >> 9), Player.get.plane,
						(Player.get.anInt5934 >> 9) + Node_Sub53.gameSceneBaseX)) {
				...
				} else if ((Class262_Sub8.anInt7756 ^ 0xffffffff) == 0
						|| (IOException_Sub1.anInt84 ^ 0xffffffff) == 0) {
					Class20.aCacheNode_Sub11_318.method2334(2048,
							(0xfffc787 & Class20.aCacheNode_Sub11_318.anInt9535) >> 14,
							Class20.aCacheNode_Sub11_318.anInt9535 & 0x3fff, is);
					Class327.anInt5360 = is[2] - Class20.anInt343;
					Class94.anInt1250 = -Class20.anInt354 + is[1];
				} else {
					Class20.aCacheNode_Sub11_318.method2334(2048, Class262_Sub8.anInt7756, IOException_Sub1.anInt84,
							is);
					if (is != null) {
						Class327.anInt5360 = is[2] - Class20.anInt343;
						Class94.anInt1250 = -Class20.anInt354 + is[1];
				...
				if ((Node_Sub25_Sub1.anInt9947 ^ 0xffffffff) == -21) {
					...
					if (!Class20.aClass302_314.method3516(Class20.aCacheNode_Sub11_318.aString9537 + "_staticelements",
							-74))
						Class20.aClass224_330 = new Class224(0);
					else {
						if (!Class20.aClass302_314
								.method3527(Class20.aCacheNode_Sub11_318.aString9537 + "_staticelements", 0))
							return;
						Class20.aClass224_330 = Class152.method1695(Class101.aBoolean1313, 0, Class20.aClass302_314,
								Class20.aCacheNode_Sub11_318.aString9537 + "_staticelements");
					}
					Class20.method289();
					...
					EntityNode_Sub6.aClass299_5988 = new Class299(graphicstoolkit, 12, true,
					...
					Class150_Sub2.aClass299_8962 = new Class299(graphicstoolkit, 19, true,
							Node_Sub38_Sub20.aCanvas10309);
					Node_Sub25_Sub1.anInt9947 = 85;
					Node_Sub24.method2650(true, -14651);
					Node_Sub38_Sub10.method2824(0);
				} else if ((Node_Sub25_Sub1.anInt9947 ^ 0xffffffff) == -86) {
					Node_Sub25_Sub3.aClass299_9980 = new Class299(graphicstoolkit, 22, true,
							Node_Sub38_Sub20.aCanvas10309);
					Node_Sub25_Sub1.anInt9947 = 88;
					Node_Sub24.method2650(true, -14651);
					Node_Sub38_Sub10.method2824(0);
				} else if ((Node_Sub25_Sub1.anInt9947 ^ 0xffffffff) == -89) {
					Login.aClass299_2380 = new Class299(graphicstoolkit, 26, true, Node_Sub38_Sub20.aCanvas10309);
	...
	public static final int method254(int i, int i_1_, int i_2_) {
		anInt5499++;
		if (i_1_ != 16939)
			aClass42_5498 = null;
	...
	@Override
	public final void method222(int i, Class48 class48, byte b) {
