...
public class Animable_Sub2_Sub2 extends Animable_Sub2 implements Interface19 {
	public static int anInt10736;
	public static int anInt10738;
	public static int anInt10739;
	public static int anInt10741;
	public static int anInt10742;
	public static int anInt10744;
	public static int anInt10745;
	public static int anInt10747;
	public static int anInt10748;
	public static int anInt10749;
	public static int anInt10755;
	public static int anInt10757;
	public static int anInt10759;
	...
	public static int anInt10765;
	public static int anInt10766;
	public static int anInt10767;
	public static short aShort10750 = 32767;

	public static final long method843(String string, int i) {
		anInt10761++;
		if (i >= -87)
	...
	Animable_Sub2_Sub2(GraphicsToolkit graphicstoolkit, ObjectDefinition objectdefinition, int i, int i_0_, int i_1_,
			int i_2_, int i_3_, boolean bool, int i_4_, int i_5_, boolean bool_6_) {
		...
		aBoolean10740 = graphicstoolkit.r() && objectdefinition.aBoolean2972 && !aBoolean10737
	...
	public final EntityNode_Sub6 method807(int i, GraphicsToolkit graphicstoolkit) {
		...
		if (Node_Sub15_Sub10.aBoolean9850)
			aDrawableModel10756.method622(class336, entitynode_sub6.anEntityNode_Sub5Array5995[0], Class308.anInt3912,
					0);
		else
	...
	public final Class171 method809(GraphicsToolkit graphicstoolkit, int i) {
		if (aClass171_10758 == null)
			aClass171_10758 = Class167.method1752(0, anInt5937, anInt5934, method841(graphicstoolkit, (byte) 62, 0),
					anInt5940);
		if (i >= -93)
			aClass171_10758 = null;
		anInt10741++;
	...
	@Override
	public final boolean method810(int i, int i_14_, boolean bool, GraphicsToolkit graphicstoolkit) {
		anInt10767++;
	...
	@Override
	public final void method816(int i, boolean bool, GraphicsToolkit graphicstoolkit, int i_8_, byte b, int i_9_,
			Animable animable) {
	...
	private final Class243 method842(GraphicsToolkit graphicstoolkit, boolean bool, int i, boolean bool_12_) {
		...
		return objectdefinition.method3046(aByte10743, anInt5940, anInt5934, plane, bool_12_, (byte) 0, anInt5937,
				aByte10751, graphicstoolkit, null, i, plane_13_);
	}
}
