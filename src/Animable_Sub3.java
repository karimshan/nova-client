...
abstract class Animable_Sub3 extends Animable {
	public static Class124 aClass124_9135 = new Class124(17);
	public static Class124 aClass124_9141 = new Class124(33);
	/* synthetic */static Class<?> aClass9144;
	public static int anInt9131;
	public static int anInt9132;
	...
	public static int anInt9139;
	public static int anInt9140;
	public static int anInt9143;
	public static int[] anIntArray9142;

	public static final void method918(byte b) {
		...
		if (Class240.aSignLink2946.aBoolean3985)
			...
			try {
				Method method = (aClass9144 == null ? aClass9144 = method922("java.lang.Runtime") : aClass9144)
	...
	public static final void method919(int i, int i_2_, int i_3_, int i_4_, int i_5_, boolean bool, int i_6_) {
		anInt9143++;
		if (i_2_ > i_5_ || i_3_ < 512 || (-1024 + Node_Sub54.GAME_SCENE_WDITH * 512 ^ 0xffffffff) > (i_5_ ^ 0xffffffff)
				|| (-1024 + Class377_Sub1.GAME_SCENE_HEIGHT * 512 ^ 0xffffffff) > (i_3_ ^ 0xffffffff))
			...
			if (!Node_Sub15_Sub10.aBoolean9850) {
				if (bool)
					Class93.graphicsToolkit.H(i_5_, i_7_, i_3_, Class119.anIntArray1516);
				else
					Class93.graphicsToolkit.da(i_5_, i_7_, i_3_, Class119.anIntArray1516);
			} else
				Class93.graphicsToolkit.HA(i_5_, i_7_, i_3_, Class308.anInt3912, Class119.anIntArray1516);
			if (!Class71.aBoolean967) {
				Class290_Sub6.aClass336_8114.method3863(-i_6_, 0, 0);
				Class93.graphicsToolkit.a(Class290_Sub6.aClass336_8114);
			} else
	...
	public static final void method921(int i, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_) {
		anInt9133++;
	...
	public final boolean method815(byte b, GraphicsToolkit graphicstoolkit) {
		...
		return Class150.method1652(class256.aMobile3239.method817(2) + this.method817(2), plane,
				anInt5934 >> Class36.anInt549, 0, anInt5940 >> Class36.anInt549);
	}
