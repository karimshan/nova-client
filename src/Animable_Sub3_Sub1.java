...
public class Animable_Sub3_Sub1 extends Animable_Sub3 {
	public static Class234 aClass234_11017;
	public static OutgoingPacket aClass318_11004 = new OutgoingPacket(37, -1);
	public static float aFloat11014;
	public static Model[] aModelArray11008 = new Model[4];
	public static int anInt10997;
	public static int anInt10998;
	public static int anInt10999;
	public static int anInt11000;
	public static int anInt11006;
	public static int anInt11009;
	public static int anInt11012 = 0;
	public static int anInt11013;
	public static int anInt11015;
	public static int anInt11016;
	...
	public static final byte[] method924(byte b, File file, int i) {
		anInt11006++;
		try {
			byte[] bs = new byte[i];
			if (b != 22)
	...
	public final EntityNode_Sub6 method807(int i, GraphicsToolkit graphicstoolkit) {
		anInt11000++;
		Class256 class256 = Class290_Sub7.method3442(plane, anInt5934 >> Class36.anInt549,
				anInt5940 >> Class36.anInt549);
		Animable_Sub1 animable_sub1 = Class270_Sub1_Sub1.method3303(plane, anInt5934 >> Class36.anInt549,
				anInt5940 >> Class36.anInt549);
		int i_10_ = 0;
		...
		if (anInt11019 == 0) {
			...
			if (i_15_ != 0) {
				int i_32_ = 0x3fff & (int) (2607.5945876176133 * Math.atan2(-i_29_ + i_28_, i_15_));
				if ((i_32_ ^ 0xffffffff) != -1)
					class336.method3859(i_32_);
			}
			if (i_14_ != 0) {
				int i_33_ = 0x3fff & (int) (Math.atan2(-i_30_ + i_31_, i_14_) * 2607.5945876176133);
				if (i_33_ != 0)
		...
		aBoolean11002 = false;
		if (anInt11007 != -1) {
			DrawableModel drawablemodel = EntityNode_Sub3_Sub1.aClass86_9166.method1010(anInt11007, 14434)
					.method1689(null, 2048, null, anInt11001, graphicstoolkit, 83);
			if (drawablemodel != null) {
				if (!Node_Sub15_Sub10.aBoolean9850)
					drawablemodel.method611(class336, entitynode_sub6.anEntityNode_Sub5Array5995[2], 0);
				else
					drawablemodel.method622(class336, entitynode_sub6.anEntityNode_Sub5Array5995[2], Class308.anInt3912,
							0);
		...
		if ((anInt11010 ^ 0xffffffff) != 0) {
			DrawableModel drawablemodel = EntityNode_Sub3_Sub1.aClass86_9166.method1010(anInt11010, 14434)
					.method1689(null, 2048, null, anInt11005, graphicstoolkit, 68);
			if (drawablemodel != null) {
				if (!Node_Sub15_Sub10.aBoolean9850)
					drawablemodel.method611(class336, entitynode_sub6.anEntityNode_Sub5Array5995[1], 0);
				else
					drawablemodel.method622(class336, entitynode_sub6.anEntityNode_Sub5Array5995[1], Class308.anInt3912,
							0);
				aBoolean11002 |= drawablemodel.F();
		...
		DrawableModel drawablemodel = EntityNode_Sub3_Sub1.aClass86_9166.method1010(anInt10996, 14434).method1689(null,
				2048, null, anInt11003, graphicstoolkit, 127);
		if (drawablemodel != null) {
			if (!Node_Sub15_Sub10.aBoolean9850)
	...
	@Override
	public final boolean method810(int i, int i_3_, boolean bool, GraphicsToolkit graphicstoolkit) {
		anInt11009++;
		if (bool != false)
			method809(null, 104);
		Class336 class336 = graphicstoolkit.A();
		...
		if (drawablemodel != null && (!Node_Sub15_Sub10.aBoolean9850
				? drawablemodel.method624(i_3_, i, class336, true, itemdefinition.anInt1919)
				: drawablemodel.method621(i_3_, i, class336, true, itemdefinition.anInt1919, Class308.anInt3912)))
			return true;
		if ((anInt11010 ^ 0xffffffff) != 0) {
			...
			if (drawablemodel != null && (Node_Sub15_Sub10.aBoolean9850
					? drawablemodel.method621(i_3_, i, class336, true, itemdefinition_4_.anInt1919, Class308.anInt3912)
					: drawablemodel.method624(i_3_, i, class336, true, itemdefinition_4_.anInt1919)))
				return true;
		}
		if ((anInt11007 ^ 0xffffffff) != 0) {
			...
			if (drawablemodel != null && (!Node_Sub15_Sub10.aBoolean9850
					? drawablemodel.method624(i_3_, i, class336, true, itemdefinition_5_.anInt1919)
					: drawablemodel.method621(i_3_, i, class336, true, itemdefinition_5_.anInt1919,
							Class308.anInt3912)))
				return true;
		}
		return false;
