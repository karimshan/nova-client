...
public class Animable_Sub4_Sub2 extends Animable_Sub4 implements Interface19 {
	public static byte[][] aByteArrayArray10804 = new byte[250][];
	public static Class77 aClass77_10805 = new Class77();
	public static int anInt10795;
	public static int anInt10796;
	public static int anInt10797;
	public static int anInt10798;
	public static int anInt10799;
	public static int anInt10800;
	public static int anInt10801;
	public static int anInt10802;
	public static int anInt10803;
	public static int anInt10806;
	public static int anInt10807;
	public static int anInt10808;
	public static int anInt10809;
	public static int anInt10811;
	public static int anInt10812;
	public static int anInt10814;
	...
	Animable_Sub4_Sub2(GraphicsToolkit graphicstoolkit, ObjectDefinition objectdefinition, int i, int i_6_, int i_7_,
			int i_8_, int i_9_, boolean bool, int i_10_, int i_11_, int i_12_, int i_13_, int i_14_) {
	...
	public final void method820(GraphicsToolkit graphicstoolkit, int i) {
		...
		if (drawablemodel != null) {
			...
			aClass310_10794.method3600(i_16_, drawablemodel, false, i + -9822, graphicstoolkit, i_15_, i_15_, i_16_,
					class336);
		}
	}
	...
	public final void method933(Class121 class121, byte b) {
		if (b <= 26)
			aClass77_10805 = null;
