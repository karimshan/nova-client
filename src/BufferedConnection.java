...
public class BufferedConnection implements Runnable {
	public static Class346 aClass346_615 = new Class346();
	...
	public static final void method422(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_,
			int i_8_, int i_9_, int i_10_) {
		anInt597++;
		if (CacheNode_Sub15.method2379(7015, i_7_) && i_1_ == -1)
			if (Class79.aWidgetArrayArray1082[i_7_] == null)
				ConnectionDecoder.method121(Class134_Sub3.widgetsList[i_7_], -1, i_10_, i_2_, i_5_, i, i_6_, i_0_, i_8_,
						i_3_, i_9_, i_4_);
			else
				ConnectionDecoder.method121(Class79.aWidgetArrayArray1082[i_7_], -1, i_10_, i_2_, i_5_, i, i_6_, i_0_, i_8_, i_3_,
						i_9_, i_4_);
	}

	public static final void method427(Class48 class48, int i, Animable animable, byte b) {
		anInt600++;
		if ((Class23.anInt434 ^ 0xffffffff) > -51 && (class48 != null && class48.anIntArrayArray700 != null
				&& (class48.anIntArrayArray700.length ^ 0xffffffff) < (i ^ 0xffffffff)
			...
			if ((class48.anIntArrayArray700[i].length ^ 0xffffffff) < -2) {
				int i_17_ = (int) (Math.random() * class48.anIntArrayArray700[i].length);
				if (i_17_ > 0)
			...
			if (class48.anIntArray690 != null && class48.anIntArray692 != null)
				i_19_ = class48.anIntArray690[i]
						+ (int) ((-class48.anIntArray690[i] + class48.anIntArray692[i]) * Math.random());
			int i_20_ = class48.anIntArray701 == null ? 255 : class48.anIntArray701[i];
			if ((i_18_ ^ 0xffffffff) == -1) {
				if (animable == Player.get)
					if (!class48.aBoolean699)
						PlayerMasks.method1033(i_19_, 0, i_15_, i_16_, i_20_, 0);
					else
				...
				int i_23_ = animable == Player.get ? 0
						: i_18_ + (i_22_ << 8) + ((i_21_ << 16) + (animable.plane << 24));
				Node_Sub38_Sub19.aClass78Array10284[Class23.anInt434++] = new Class78(
						class48.aBoolean699 ? (byte) 2 : (byte) 1, i_15_, i_16_, 0, i_20_, i_23_, i_19_, animable);
			}
		}
	}
	...
	public final void method423(int i) throws IOException {
		if (i != -1650936088)
			anInt603 = 99;
		anInt607++;
		if (!aBoolean601)
	...
	public final int method424(int i) throws IOException {
		anInt610++;
		if (aBoolean601)
			return 0;
		if (i != -1)
	...
	public final void method425(int i, byte b, int i_12_, byte[] bs) throws IOException {
		anInt606++;
		if (b < 47)
			method421(-53);
		if (!aBoolean601) {
	...
	public final void method426(byte b) {
		anInt595++;
		if (!aBoolean601) {
			if (b >= -61)
				aClass346_615 = null;
	...
	public final int method428(int i) throws IOException {
		anInt599++;
		if (i != 0)
	...
	public final void method429(int i, int i_24_, byte[] bs, byte b) throws IOException {
		anInt598++;
		if (b == 78 && !aBoolean601) {
			if (aBoolean614) {
				aBoolean614 = false;
	...
	public final void method430(int i) {
		anInt616++;
		if (!aBoolean601) {
			synchronized (this) {
				if (i != 20692)
