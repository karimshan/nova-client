...
class BufferedStream extends Node {
	public static IncomingPacket aClass192_7014 = new IncomingPacket(136, 6);
	...
	public static int anInt7007;
	public static int anInt7008;
	...
	public static final void method2205(int i, Node node, Node node_38_) {
	...
	public final void encryptXteas(int[] is, int i, boolean bool, int i_29_) {
		anInt7012++;
		int i_30_ = offset;
		offset = i;
		int i_31_ = (i_29_ - i) / 8;
	...
	public final String method2180(byte b) {
		anInt7025++;
	...
	public final int method2188(int i) {
		if (i <= 110)
			return 97;
		anInt7008++;
		offset += 4;
		return (0xff & buffer[-4 + offset]) + ((buffer[offset + -1] << 24 & ~0xffffff)
				+ ((buffer[-2 + offset] & 0xff) << 16) - -(0xff00 & buffer[offset + -3] << 8));
	}

	public final void method2189(int i, int i_9_) {
		anInt6968++;
		if (i_9_ != 32768)
			method2197(71);
		if (i >= 0 && i < 128)
	...
	public final int method2190(int i, boolean bool) {
		if (bool != false)
			anInt7023 = -121;
		anInt6979++;
	...
	public final void method2191(int i, int i_11_) {
	...
	public final void method2192(int[] is, int i) {
		if (i <= 96)
			anInt7023 = -75;
		anInt6985++;
		int i_12_ = offset / 8;
	...
	public final void method2194(int i, int i_20_) {
		anInt6988++;
	...
	public final long method2196(byte b) {
		if (b != -104)
			return -23L;
		anInt7003++;
		long l = 0xffffffffL & method2188(114);
		long l_23_ = 0xffffffffL & method2188(112);
		return l + (l_23_ << 32);
	}

	public final int method2197(int i) {
		anInt6975++;
	...
	public final void method2202(int i) {
		anInt7011++;
		if (buffer != null)
	...
	public final void method2204(int i, byte b) {
		anInt6999++;
	...
	public final void method2206(byte b, int i, long l) {
		i--;
		anInt7010++;
		if (b <= 112)
			buffer = null;
	...
	public final boolean method2216(int i) {
		anInt6995++;
		offset -= 4;
	...
	public final void method2217(int i) {
		buffer[offset - (i + 1)] = (byte) i;
	}

	public final int method2218(int i) {
		offset += 2;
		anInt6976++;
	...
	public final void method2231(int i, int[] is, int i_59_, int i_60_) {
		anInt6970++;
		int i_61_ = offset;
		offset = i;
		int i_62_ = (-i + i_59_) / 8;
	...
	public final void method2232(int i, int i_69_) {
	...
	public final void method2237(int i, int i_71_) {
		anInt6958++;
		if (i != 0)
			buffer = null;
	...
	public final int method2239(int i) {
		anInt6962++;
	...
	public final long method2241(int i) {
		anInt6998++;
		if (i > -53)
			return -50L;
		long l = 0xffffffffL & readUnsignedByte();
		long l_74_ = 0xffffffffL & readInt();
		return l_74_ + (l << 32);
	}

	public final long method2244(int i, int i_75_) {
		anInt7020++;
		...
		long l = 0L;
		for (/**/; i_76_ >= 0; i_76_ -= 8)
			l |= (0xffL & buffer[offset++]) << i_76_;
		return l;
	}

	public final int method2246(int i) {
		anInt6967++;
		if (i != -22301)
			offset = -18;
		offset += 3;
		return ((0xff & buffer[offset - 3]) << 16)
				- (-(buffer[offset - 1] << 8 & 0xff00) - (0xff & buffer[-2 + offset]));
	}

	public final byte read128Byte() {
		return (byte) (128 - buffer[offset++]);
	}

	public final int read24BitInteger() {
		offset += 3;
		return ((buffer[offset - 2] & 0xff) << 8) + ((0xff & buffer[offset - 3]) << 16) - -(buffer[-1 + offset] & 0xff);
	}

	public final int read24BitInteger(byte b) {
		anInt7000++;
		offset += 3;
		int i = (0xff & buffer[-1 + offset])
				+ (((0xff & buffer[-3 + offset]) << 16) + ((buffer[-2 + offset] & 0xff) << 8));
	...
	public final void readBytes(byte[] data, int dataStartOffset, int length) {
	...
	public final int readInt() {
		offset += 4;
		return ((0xff & buffer[offset + -4]) << 24) - (-((0xff & buffer[-3 + offset]) << 16)
				- (buffer[offset - 2] << 8 & 0xff00) - (buffer[-1 + offset] & 0xff));
	}

	public final int readIntLE() {
		offset += 4;
		return (0xff & buffer[-4 + offset])
				+ (((0xff & buffer[-2 + offset]) << 16) + (buffer[-1 + offset] << 24 & ~0xffffff))
				- -((0xff & buffer[-3 + offset]) << 8);
	}

	public final int readIntV1() {
		offset += 4;
		return ((buffer[offset + -1] & 0xff) << 16) + ((buffer[offset - 2] << 24 & ~0xffffff)
				- (-((buffer[-4 + offset] & 0xff) << 8) + -(buffer[-3 + offset] & 0xff)));
	}

	public final int readIntV2() {
		offset += 4;
		return (buffer[offset + -4] << 16 & 0xff0000)
				+ (((buffer[offset + -3] & 0xff) << 24) - -((0xff & buffer[offset + -1]) << 8))
				- -(buffer[offset - 2] & 0xff);
	}

	public final long readLong() {
		long l = 0xffffffffL & readInt();
		long l_70_ = 0xffffffffL & readInt();
		return l_70_ + (l << 32);
	}
	...
	public final int readSmart2(boolean bool) {
		anInt6964++;
		int i = 0;
		int i_6_;
	...
	public final String readString2() {
		if (buffer[offset] == 0) {
			offset++;
			return null;
		}
	...
	public final int readUnsigned128Byte() {
	...
	public final int readUnsignedShort128() {
		offset += 2;
	...
	public final int readUnsignedShortLE128() {
		offset += 2;
		return (-128 + buffer[offset - 2] & 0xff) + ((0xff & buffer[offset - 1]) << 8);
	}

	public final void rsaDecrypt(int i, BigInteger biginteger, BigInteger biginteger_49_) {
		anInt7001++;
		int i_50_ = offset;
		offset = 0;
	...
	public final void write128Byte(int i) {
		buffer[offset++] = (byte) (-i + 128);
	}

	public final void write24BitInt(byte b, int i) {
	...
	public final void writeByte128(int i) {
		buffer[offset++] = (byte) (i + 128);
	}

	public final void writeByteC(int i) {
		buffer[offset++] = (byte) -i;
	}

	public final void writeBytes(int i, byte[] bs, int i_54_) {
	...
	public final void writeIntLE(int i) {
		buffer[offset++] = (byte) i;
		buffer[offset++] = (byte) (i >> 8);
		buffer[offset++] = (byte) (i >> 16);
		buffer[offset++] = (byte) (i >> 24);
	...
	public final void writeIntV2(int i) {
		buffer[offset++] = (byte) (i >> 16);
		buffer[offset++] = (byte) (i >> 24);
		buffer[offset++] = (byte) i;
		buffer[offset++] = (byte) (i >> 8);
	...
	public final void writeJagString(String string, int i) {
		anInt6977++;
	...
	public final void writeShort128(int i) {
		buffer[offset++] = (byte) (i >> 8);
		buffer[offset++] = (byte) (128 + i);
	}

	public final void writeShortLE(int i) {
		buffer[offset++] = (byte) i;
		buffer[offset++] = (byte) (i >> 8);
	}

	public final void writeShortLE128(int i) {
		buffer[offset++] = (byte) (i + 128);
		buffer[offset++] = (byte) (i >> 8);
	}
