...
public class CacheNode extends Node {
	...
	public static IncomingPacket aClass192_7038 = new IncomingPacket(76, 9);
	public static int anInt7033;
	public static int anInt7034;
	public static int anInt7039;
	public static int anInt7040;
	public static int anInt7041;

	public static final void method2277(int i, int i_0_) {
		anInt7039++;
		CacheNode_Sub2 cachenode_sub2 = Class320_Sub19.method3754(i ^ 0x1, i, i_0_);
	...
	public static final void method2279(int i, int i_1_, int i_2_, int i_3_, int i_4_, GraphicsToolkit graphicstoolkit) {
	...
	public final void method2275(int i) {
		anInt7034++;
	...
	public final boolean method2276(byte b) {
		anInt7041++;
		if (aCacheNode7036 == null)
			return false;
		if (b < 52)
