...
public class CacheNode_Sub1 extends CacheNode {
	public static boolean aBoolean9425 = false;
	public static Class257 aClass257_9421;
	public static int anInt9420;
	public static int anInt9422;
	public static int anInt9424;
	public static int anInt9426;
	public static int[] anIntArray9427;
	static {
		aClass257_9421 = new Class257(10, 19);
	}

	public static final void method2280(int i) {
	...
	private final void method2281(int i, BufferedStream buffer, int i_2_) {
		if (i == 249) {
			...
			for (int i_5_ = 0; i_3_ > i_5_; i_5_++) {
				...
				aHashTable9423.put(i_6_, node, -124);
			}
		}
		if (i_2_ <= -118)
			anInt9422++;
	...
	public final int method2282(int i, int i_7_, int i_8_) {
		anInt9420++;
		if (aHashTable9423 == null)
			return i;
		Node_Sub32 node_sub32 = (Node_Sub32) aHashTable9423.getNode(3512, i_8_);
		if (node_sub32 == null)
			return i;
		return node_sub32.anInt7381;
	}

	public final void method2283(byte b, BufferedStream buffer) {
		anInt9426++;
		for (;;) {
	...
	public final String method2284(int i, String string, int i_10_) {
		anInt9424++;
		if (aHashTable9423 == null)
			return string;
		if (i_10_ != 27908)
			return null;
		Node_Sub18 node_sub18 = (Node_Sub18) aHashTable9423.getNode(3512, i);
		if (node_sub18 == null)
			return string;
