...
public class CacheNode_Sub11 extends CacheNode {
	public static byte[][][] aByteArrayArrayArray9550;
	public static Class212 aClass212_9548 = new Class212("", 16);
	public static Class329 aClass329_9538 = new Class329("WTI", "office", "_wti", 5);
	public static int anInt9532;
	public static int anInt9533;
	public static int anInt9534;
	public static int anInt9536;
	public static int anInt9539;
	public static int anInt9551;

	public static final boolean method2336(int i, int i_4_, int i_5_) {
		if (i != -1)
	...
	public final boolean method2334(int i, int i_0_, int i_1_, int[] is) {
		anInt9551++;
		if (i != 2048)
			method2340(-86, (byte) -124, 70, null);
		for (Node_Sub52 node_sub52 = (Node_Sub52) aClass312_9549.method3613(
				65280); node_sub52 != null; node_sub52 = (Node_Sub52) aClass312_9549.method3620(i ^ 0xfff700))
	...
	public final boolean method2335(byte b, int i, int i_2_) {
		@SuppressWarnings("unused")
		int i_3_ = 93 / ((b - 39) / 44);
		anInt9539++;
		for (Node_Sub52 node_sub52 = (Node_Sub52) aClass312_9549
				.method3613(65280); node_sub52 != null; node_sub52 = (Node_Sub52) aClass312_9549.method3620(16776960))
			if (node_sub52.method2977(i, (byte) -76, i_2_))
				return true;
		return false;
	}

	public final boolean method2337(int i, int[] is, int i_6_, int i_7_, int i_8_) {
		anInt9533++;
		if (i != -12584)
			return true;
		for (Node_Sub52 node_sub52 = (Node_Sub52) aClass312_9549
	...
	public final void method2339(int i) {
		anInt9545 = 0;
		anInt9534++;
		anInt9541 = 12800;
		if (i == 16) {
			...
			anInt9531 = 0;
			for (Node_Sub52 node_sub52 = (Node_Sub52) aClass312_9549.method3613(
					65280); node_sub52 != null; node_sub52 = (Node_Sub52) aClass312_9549.method3620(16776960)) {
	...
	public final boolean method2340(int i, byte b, int i_9_, int[] is) {
		anInt9532++;
		for (Node_Sub52 node_sub52 = (Node_Sub52) aClass312_9549
				.method3613(65280); node_sub52 != null; node_sub52 = (Node_Sub52) aClass312_9549.method3620(16776960))
