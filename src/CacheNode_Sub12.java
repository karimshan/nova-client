...
public class CacheNode_Sub12 extends CacheNode {
	public static IncomingPacket aClass192_9552;
	public static Class61 aClass61_9556;
	public static int anInt9553;
	public static int anInt9555 = 0;
	public static int anInt9557;
	static {
		aClass192_9552 = new IncomingPacket(44, 10);
		aClass61_9556 = new Class61(8);
	}

	public static final Class98 method2341(int i, BufferedStream buffer) {
		anInt9557++;
	...
	public static final void method2343(ObjectDefinition objectdefinition, byte b, int i, GraphicsToolkit graphicstoolkit,
			int i_10_, int i_11_) {
		anInt9553++;
		...
		if ((class140.anInt1740 ^ 0xffffffff) != 0) {
			...
			if (glsprite != null) {
				...
				if (class140.anInt1737 != 0)
					glsprite.method1199(i_10_, -((i_13_ + -1) * 4) + i_11_, i_14_, i_15_, 0,
