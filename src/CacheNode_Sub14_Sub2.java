...
public class CacheNode_Sub14_Sub2 extends CacheNode_Sub14 {
	public static IncomingPacket aClass192_11037 = new IncomingPacket(141, 2);
	public static IncomingPacket aClass192_11040 = new IncomingPacket(81, 12);
	public static Class312 aClass312_11039 = new Class312();
	public static int anInt11030;
	public static int anInt11031;
	public static int anInt11032;
	public static int anInt11033;
	public static int anInt11035;
	public static int anInt11036;
	public static int anInt11038;

	public static final void decodePlayerMasks(Packet packet) {
		for (int i = 0; i < Node_Sub9_Sub4.DECODE_MASKS_PLAYERS_COUNT; i++) {
			...
			Player player = Client.LOCAL_PLAYERS[playerIndex];
			int mask = packet.readUnsignedByte();
			if ((mask & 0x80) != 0)
				mask += packet.readUnsignedByte() << 8;
			if ((mask & 0x800) != 0)
				mask += packet.readUnsignedByte() << 16;
			PlayerMasks.decodePlayerMasks(-1, player, playerIndex, packet, mask);
		}
	}
	...
	public static final boolean method2352(int i, int i_0_, int i_1_) {
		anInt11033++;
		if (i != 0)
			method2352(-85, -123, -8);
		if (!(Class144_Sub2.method1634(i_1_, i_0_, false) | (0x60000 & i_0_) != 0)
				&& !GraphicsBuffer.method2596(-1, i_0_, i_1_))
			return false;
		return true;
	}

	public static final void method2353(byte b, BufferedStream buffer) {
		anInt11031++;
				...
				if ((buffer.buffer.length + -buffer.offset ^ 0xffffffff) <= -3) {
					...
					if ((6 * i_2_ ^ 0xffffffff) >= (buffer.buffer.length - buffer.offset ^ 0xffffffff))
						for (int i_3_ = 0; (i_2_ ^ 0xffffffff) < (i_3_ ^ 0xffffffff); i_3_++) {
							...
							if ((i_4_ ^ 0xffffffff) > (Class320_Sub22.anIntArray8417.length ^ 0xffffffff)
									&& FileOnDisk.aBooleanArray1332[i_4_]
									&& ((Node_Sub53.aClass176_7667.method1805(i_4_, -4409).aChar3210
											^ 0xffffffff) != -50 || i_5_ >= -1 && (i_5_ ^ 0xffffffff) >= -2))
	...
	public static final void method2354(Index class302, int i, boolean bool, int i_6_, int i_7_, int i_8_, boolean bool_9_) {
		anInt11036++;
	...
	public static final DrawableModel method2356(int i, DrawableModel drawablemodel, int i_12_, int i_13_, int i_14_,
			int i_15_, boolean bool, GraphicsToolkit graphicstoolkit, int i_16_, Animator animator, int i_17_,
			int i_18_, int i_19_) {
		anInt11038++;
		...
		long l = ((long) i_13_ << 48) + ((long) i_19_ << 32) + i_15_ + ((i_16_ << 16) + (i << 24));
		...
		if (drawablemodel_21_ == null || graphicstoolkit.b(drawablemodel_21_.ua(), i_20_) != 0) {
			...
			for (int i_33_ = 0; (i_23_ ^ 0xffffffff) < (i_33_ ^ 0xffffffff); i_33_++) {
				...
				short s = (short) ((i_34_ * (i_13_ & 0x7f) + i_35_ * (0x7f & i_19_) & 0x7f00)
						+ ((0x380 & i_19_) * i_35_ + (0x380 & i_13_) * i_34_ & 0x38000)
						+ ((0xfc00 & i_19_) * i_35_ + (0xfc00 & i_13_) * i_34_ & 0xfc0000) >> 8);
				for (int i_36_ = 0; i_22_ > i_36_; i_36_++)
					if (i_33_ == 0)
						model.method2080(true, i_24_, is_25_[0][i_36_], is_25_[0][(i_36_ + 1) % i_22_], s, (short) -1,
								b, (byte) 1, (byte) -1);
					else {
						model.method2080(bool, is_25_[i_33_ + -1][i_36_], is_25_[i_33_][(i_36_ + 1) % i_22_],
								is_25_[-1 + i_33_][(1 + i_36_) % i_22_], s, (short) -1, b, (byte) 1, (byte) -1);
						model.method2080(true, is_25_[i_33_ - 1][i_36_], is_25_[i_33_][i_36_],
								is_25_[i_33_][(1 + i_36_) % i_22_], s, (short) -1, b, (byte) 1, (byte) -1);
					}
			}
