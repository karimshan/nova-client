...
public class CacheNode_Sub19 extends CacheNode {
	public static Class68 aClass68_9621 = new Class68(3);
	public static int anInt9610;
	public static int anInt9612;
	public static int anInt9613;
	public static int anInt9615;
	public static int anInt9620;
	public static String[] aStringArray9622;
	...
	public static final boolean method2404(int i, int i_30_, int i_31_) {
		anInt9610++;
		if ((0x20 & i_30_) == 0)
			return false;
		return true;
	...
	public final float[] method2400(byte b, int i, d var_d, Index class302, boolean bool, int i_0_) {
		Class308.aClass302_3909 = class302;
		if (b >= -98)
			method2400((byte) -31, -48, null, null, true, -25);
		anInt9613++;
		Node_Sub38_Sub35.aD10455 = var_d;
		for (Node_Sub38 element : aNode_Sub38Array9618)
			element.method2782(i, i_0_, false);
		...
		for (int i_3_ = 0; i_3_ < i; i_3_++) {
			...
			for (int i_10_ = -1 + i_0_; i_10_ >= 0; i_10_--) {
				float f = is_8_[i_10_] / 4096.0F;
				if (f < 0.0F)
					f = 0.0F;
				else if (f > 1.0F)
					f = 1.0F;
				float f_11_ = (1.0F + 31.0F * is_9_[i_10_] / 4096.0F) / 4096.0F;
				fs[i_2_++] = f_11_ * is[i_10_];
				fs[i_2_++] = f_11_ * is_5_[i_10_];
				fs[i_2_++] = f_11_ * is_4_[i_10_];
				fs[i_2_++] = f;
				if (bool)
					i_2_ += -4 + (i_0_ << 2);
			}
	...
	public final boolean method2401(Index class302, d var_d, byte b) {
		anInt9612++;
		if ((Class230.anInt5209 ^ 0xffffffff) > -1) {
			...
			for (int i = 0; i < anIntArray9616.length; i++)
				if (!class302.requestDownload(anIntArray9616[i], Class230.anInt5209, 0))
					return false;
		if (b != 4)
			return true;
	...
	public final int[] method2402(int i, double d, boolean bool, int i_13_, byte b, d var_d, Index class302) {
		Class308.aClass302_3909 = class302;
		Node_Sub38_Sub35.aD10455 = var_d;
		anInt9615++;
	...
	public final int[] method2405(Index class302, double d, boolean bool, d var_d, boolean bool_33_, int i, int i_34_,
			int i_35_) {
		Node_Sub38_Sub35.aD10455 = var_d;
		Class308.aClass302_3909 = class302;
		anInt9620++;
		for (Node_Sub38 element : aNode_Sub38Array9618)
			element.method2782(i, i_34_, false);
		Class385.method4205(false, d);
