...
abstract class CacheNode_Sub20 extends CacheNode {
	public static long[] aLongArray9626 = new long[256];
	public static int anInt9623;
	public static int anInt9624;
	public static int anInt9625;
	public static int[] anIntArray9628;
	static {
		for (int i = 0; i < 256; i++) {
			long l = i;
	...
	public static final void method2406(String string, int i) {
		anInt9624++;
		if (i < 46)
			method2407(-64);
	...
	public static final void method2407(int i) { // Facebook login
		System.out.println("Method2407 invoked in CacheNode_Sub20");
	...
	public static final void method2408(int i, boolean bool) {
		anInt9623++;
