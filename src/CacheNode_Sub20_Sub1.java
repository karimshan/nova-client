...
public class CacheNode_Sub20_Sub1 extends CacheNode_Sub20 {
	public static int anInt11088;
	public static int anInt11090;
	public static int anInt11091;
	public static int anInt11093;
	public static int myPlayerPlane;

	public static final float method2412(byte b, float f, float f_0_, int i, float f_1_, float f_2_, float f_3_, float f_4_) {
		anInt11090++;
		float f_5_ = 0.0F;
		float f_6_ = -f + f_4_;
		...
		while (f_5_ < 1.1F) {
			...
			if ((i_15_ ^ 0xffffffff) < -1 && (i_16_ ^ 0xffffffff) < -1 && Node_Sub54.GAME_SCENE_WDITH > i_15_
					&& (i_16_ ^ 0xffffffff) > (Class377_Sub1.GAME_SCENE_HEIGHT ^ 0xffffffff)) {
				int i_17_ = Player.get.plane;
				...
				if (f_13_ > i_18_) {
					if ((i ^ 0xffffffff) > -3)
						return f_5_;
					return method2412((byte) 52, f_9_, f_14_, -1 + i, f_11_, f_13_, f_10_, f_12_) * 0.1F
							+ (-0.1F + f_5_);
				}
			}
			f_11_ = f_14_;
	...
	public static final void method2413(boolean bool, int i, String string) {
		anInt11088++;
		CacheNode_Sub2 cachenode_sub2 = Class320_Sub19.method3754(3, 2, i);
		if (bool != true)
			method2413(true, -71, null);
		cachenode_sub2.method2288(0);
		cachenode_sub2.text = string;
	}
