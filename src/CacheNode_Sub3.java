...
public class CacheNode_Sub3 extends CacheNode {
	public static Class61 aClass61_9446 = new Class61(5);
	...
	public static int[] anIntArray9442;

	public static final void method2292(int i) {
		...
		CacheNode_Sub20_Sub1.myPlayerPlane = Player.get.plane = (byte) 0;
		Player.get.method888(8, -90, i);
		int i_2_ = 18;
		...
		i_2_ = 0;
		for (int i_3_ = (-(Node_Sub54.GAME_SCENE_WDITH >> 4) + i_0_)
				/ 8; ((i_0_ - -(Node_Sub54.GAME_SCENE_WDITH >> 4)) / 8 ^ 0xffffffff) <= (i_3_ ^ 0xffffffff); i_3_++)
			for (int i_4_ = (-(Class377_Sub1.GAME_SCENE_HEIGHT >> 4) + i_1_)
					/ 8; i_4_ <= ((Class377_Sub1.GAME_SCENE_HEIGHT >> 4) + i_1_) / 8; i_4_++) {
				int i_5_ = i_4_ + (i_3_ << 8);
				Class262_Sub1.MAP_REGION_HASHES[i_2_] = i_5_;
				StandardPlane.anIntArray7980[i_2_] = Animable_Sub1_Sub1.aClass302_10618
						.method3519("m" + i_3_ + "_" + i_4_, (byte) 97);
				Class144.anIntArray1789[i_2_] = Animable_Sub1_Sub1.aClass302_10618.method3519("l" + i_3_ + "_" + i_4_,
						(byte) 17);
				Class204.anIntArray2460[i_2_] = Animable_Sub1_Sub1.aClass302_10618.method3519("n" + i_3_ + "_" + i_4_,
						(byte) 86);
				Class42.anIntArray645[i_2_] = Animable_Sub1_Sub1.aClass302_10618.method3519("um" + i_3_ + "_" + i_4_,
						(byte) 122);
				ProducingGraphicsBuffer.anIntArray9895[i_2_] = Animable_Sub1_Sub1.aClass302_10618
						.method3519("ul" + i_3_ + "_" + i_4_, (byte) 48);
	...
	public static final boolean method2296(int i, byte b, int i_13_) {
		anInt9447++;
	...
	public final void method2293(BufferedStream buffer, boolean bool) {
		for (;;) {
	...
	public final int method2297(char c, int i) {
		anInt9451++;
	...
	public final int method2298(byte b, char c) {
		anInt9453++;
	...
	public final void method2299(byte b) {
		anInt9440++;
		if (anIntArray9448 != null)
