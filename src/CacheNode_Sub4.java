...
public class CacheNode_Sub4 extends CacheNode {
	public static boolean[] aBooleanArray9454 = new boolean[100];
	public static Class1 aClass1_9466;
	public static Class124 aClass124_9463 = new Class124(11);
	public static int anInt9455;
	public static int anInt9456;
	public static int anInt9459;
	public static int anInt9460;
	public static int anInt9461;
	public static int anInt9464;
	public static int anInt9465 = 0;

	public static final int method2302(byte b) {
		anInt9455++;
		GraphicsToolkit graphicstoolkit = Class93.graphicsToolkit;
		boolean bool = false;
	...
	public static final void method2304(int i) {
	...
	public static final void method2305(int i, boolean bool, int i_4_, IComponentDefinitions widget) {
		if (bool == true) {
	...
	public final int method2300(byte b) {
		if (b != 88)
			method2302((byte) 100);
		anInt9460++;
	...
	public final boolean method2301(int i, CacheNode_Sub13 cachenode_sub13) {
		anInt9461++;
		if (i < 3)
			method2302((byte) -37);
	...
	public final boolean method2303(int i, CacheNode_Sub13 cachenode_sub13) {
		anInt9459++;
		boolean bool = true;
		...
		while (cachenode_sub13_2_ != null) {
			if (DeveloperConsole.method2935((byte) 69, cachenode_sub13.anInt9562, cachenode_sub13_2_.anInt9562)) {
