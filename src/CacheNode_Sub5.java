...
public class CacheNode_Sub5 extends CacheNode {
	public static Index aClass302_9477;
	public static int anInt9467;
	public static int anInt9469;
	public static int anInt9474;

	public static final boolean method2307(int i, int i_0_, int i_1_) {
		anInt9469++;
		if ((i_0_ & i_1_ ^ 0xffffffff) != -1 | Class73.method749((byte) -65, i_1_, i)
				|| PacketDecoder.method2248(i_1_, i, 51))
			return true;
		if ((0x37 & i) != 0 || !LoadingBarStage.method1135(i_1_, i, false))
			return false;
		return true;
	}

	public static final Class169_Sub2_Sub1 method2308(GLToolkit gltoolkit, int i, int i_2_, boolean bool, int i_3_, int[] is,
			int i_4_, int i_5_) {
		anInt9474++;
		if (i != 25448)
			return null;
		if (!gltoolkit.aBoolean6652 && (!Class371.method4094(i_2_, false) || !Class371.method4094(i_4_, false))) {
			...
			return new Class169_Sub2_Sub1(gltoolkit, i_2_, i_4_, Class320_Sub19.method3753(i_2_, -729073628),
					Class320_Sub19.method3753(i_4_, i ^ ~0x2b74a4b3), is);
		}
	...
	public final void method2309(byte b) {
		...
		if (aClass218_9476.aClass336_2562 != null)
			aClass218_9476.aClass336_2562.method3867(aClass249_9473.anInt3157, aClass249_9473.anInt3166,
					aClass249_9473.anInt3150, Node_Sub38.anIntArray7457);
		if (b >= 85) {
