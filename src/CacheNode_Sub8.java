...
public class CacheNode_Sub8 extends CacheNode {
	...
	public static int anInt9492 = -1;

	public static int anInt9493 = -1;

	public static int anInt9494 = -1;

	public static final void method2318(int i, int i_0_, byte b, long l, aa var_aa, int i_1_, int i_2_, int i_3_,
		...
		if (b == 124) {
			...
			if (i_4_ <= l) {
				...
				if (i_4_ <= i_5_ * i_5_)
					MiniMapDots.method171((byte) -116, i_2_, var_aa, Class101.aGLSpriteArray1301[i_1_], i_3_, i, widget,
							i_0_);
				else {
					i_5_ -= 10;
					int i_6_;
					...
					Class150_Sub3.aGLSpriteArray8973[i_1_].method1180(i_11_ + (widget.anInt4809 / 2.0F + i_0_),
							(-i_12_) + (widget.anInt4695 / 2.0F + i_2_), 4096,
							(int) ((-d / 6.2831853071795862D) * 65535D));
				}
			}
		}
	}

	public static final Animable_Sub4 method2320(int i, int i_13_, int i_14_) {
	...
	public final long method2319(boolean bool) {
		if (bool)
			return -33L;
		else
			return aShortArrayArray9491.length << 0 | aShortArrayArray9491[0].length;
	}
