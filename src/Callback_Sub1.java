...
public class Callback_Sub1 extends Callback {
	...
	public final synchronized int method80(int i, int i_0_, int i_1_, int i_2_) {
		if (anInt2 != i) {
	...
	public final void method81(int i, int i_5_, int i_6_) {
		if (i_5_ == -33)
			User32.SetCursorPos(i, i_6_);
	}

	@SuppressWarnings("deprecation")
	public final void method82(boolean bool, Component component, byte b) {
