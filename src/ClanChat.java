...
public class ClanChat {
	public static Class151 aClass151_756 = new Class151(4, 1, 1, 1);
	...
	public static final boolean method494(byte b, int i, int i_11_) {
		anInt728++;
		if (b != 14)
			return true;
		if ((0x800 & i) == 0)
	...
	public static final void method507(Throwable throwable, String string, int i) {
		if (i > -105)
			aClass151_756 = null;
		anInt766++;
		do {
			try {
				...
				if (CacheNode_Sub16.anApplet9601 != null) {
					Class241 class241 = Class152.aSignLink1940.method3642((byte) -80, new URL(
							CacheNode_Sub16.anApplet9601.getCodeBase(),
							"clienterror.ws?c=" + Class320_Sub14.anInt8347 + "&u="
									+ (Node_Sub40.myPlayerDisplayName != null ? Node_Sub40.myPlayerDisplayName
											: String.valueOf(Node_Sub23.aLong7203))
									+ "&v1=" + SignLink.aString3989 + "&v2=" + SignLink.aString3995 + "&e="
									+ string_38_));
	...
	public final int method486(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
		anInt743++;
		if (i_3_ != 15883)
			return 72;
		int i_4_ = (1 << i_2_) - 1;
	...
	public final void method488(int i, String string, long l, int i_8_) {
		if (string != null && (string.length() ^ 0xffffffff) == -1)
			string = null;
		anInt767++;
		if (aBoolean758 != l > 0L)
			throw new RuntimeException(
					"Invalid UserHash arg to this method - useUserHashes:" + aBoolean758 + " but userhash:" + l);
		if (!aBoolean742 != (string == null))
			throw new RuntimeException("Invalid DisplayName arg to this method - useDisplayNames:" + aBoolean742
					+ " but displayname:" + string);
		if (l > 0L && (aLongArray768 == null || anInt734 >= aLongArray768.length) || string != null
				&& (aStringArray740 == null || (aStringArray740.length ^ 0xffffffff) >= (anInt734 ^ 0xffffffff)))
	...
	public final Long method489(byte b, int i) {
		anInt732++;
		if (aHashTable735 == null)
			return null;
		Node node = aHashTable735.getNode(3512, i);
		if (b != -24)
	...
	public final int method490(String string, byte b) {
		anInt733++;
		if (string == null || (string.length() ^ 0xffffffff) == -1)
			return -1;
	...
	public final boolean method492(String string, int i, boolean bool) {
		if (string == null)
			string = "";
		...
		if (bool != true)
			return true;
		aHashTable735.put(i, new Node_Sub18(string), -125);
		return true;
	}
	...
	public final String method495(int i, int i_12_) {
		anInt731++;
		if (aHashTable735 == null)
			return null;
		Node node = aHashTable735.getNode(3512, i_12_);
		if (node == null || !(node instanceof Node_Sub18))
			return null;
		return ((Node_Sub18) node).aString7149;
	}

	public final void method496(int i, int i_14_) {
		anInt741++;
	...
	public final void method497(String string, long l, int i) {
		...
		if (aBoolean742 == (string == null))
			throw new RuntimeException("Invalid DisplayName arg to this method - useDisplayNames:" + aBoolean742
					+ " but displayname:" + string);
		if (l > 0L && (aLongArray753 == null || (aLongArray753.length ^ 0xffffffff) >= (anInt739 ^ 0xffffffff))
				|| string != null && (aStringArray769 == null
						|| (anInt739 ^ 0xffffffff) <= (aStringArray769.length ^ 0xffffffff)))
	...
	public final int[] method498(int i) {
	...
	public final boolean method499(byte b, int i, long l) {
		anInt736++;
		if (b != 89)
			return false;
		if (aHashTable735 == null)
		...
		aHashTable735.put(i, new Node_Sub44(l), -127);
		return true;
	}

	public final int method500(byte b, byte b_17_, int i) {
		anInt759++;
		if (b == b_17_ || b == 127)
			return -1;
	...
	public final Integer method501(int i, int i_18_) {
		if (i_18_ >= -18)
			anInt739 = -52;
		anInt723++;
		if (aHashTable735 == null)
	...
	public final void method502(int i, byte b) {
		anInt761++;
		anInt739--;
		if (anInt739 != 0) {
			if (aLongArray753 != null)
	...
	public final boolean method504(int i, int i_19_, int i_20_, int i_21_, int i_22_) {
		anInt745++;
		int i_23_ = (1 << i_19_) - 1;
		...
		if (aHashTable735 == null)
			...
			Node node = aHashTable735.getNode(3512, i_21_);
			if (node != null) {
		...
		aHashTable735.put(i_21_, new Node_Sub32(i_20_), -126);
		return true;
	}
			...
			if (i_30_ > 0) {
				...
				while ((i_30_-- ^ 0xffffffff) < -1) {
					...
					if ((i_33_ ^ 0xffffffff) == -1) {
						...
						aHashTable735.put(i_32_, new Node_Sub32(i_34_), -124);
					} else if ((i_33_ ^ 0xffffffff) == -2) {
						long l = buffer.readLong();
						aHashTable735.put(i_32_, new Node_Sub44(l), -123);
					} else if ((i_33_ ^ 0xffffffff) == -3) {
						String string = buffer.readString();
						aHashTable735.put(i_32_, new Node_Sub18(string), -127);
					}
				}
			}
		}
	...
	public final Integer method506(byte b, int i, int i_35_, int i_36_) {
		anInt727++;
		if (aHashTable735 == null)
			return null;
		Node node = aHashTable735.getNode(3512, i);
	...
	public final int method508(int i, int i_39_, int i_40_, int i_41_) {
		if (i_39_ != -23948)
			aByte724 = (byte) -88;
		anInt746++;
	...
	public final boolean method509(int i, int i_43_, int i_44_) {
		if (i_44_ != -553)
		...
		if (aHashTable735 == null)
			...
			Node node = aHashTable735.getNode(i_44_ ^ ~0xf90, i_43_);
			if (node != null) {
				if (node instanceof Node_Sub32) {
					Node_Sub32 node_sub32 = (Node_Sub32) node;
		...
		aHashTable735.put(i_43_, new Node_Sub32(i), -127);
		return true;
	}
}
