...
public class Class104 {
	...
	public static final void method1114(long l, boolean bool, int i, int i_0_, int i_1_, int i_2_, Index class302) {
		anInt1348++;
		if (i <= 48)
	...
	public static final Actor method1115(int i, int i_3_, int i_4_, int i_5_) {
		anInt1347++;
		...
		for (Class256 class256 = class261.aClass256_3312; class256 != null; class256 = class256.aClass256_3238) {
			...
			if (mobile instanceof Actor) {
				...
				if ((i_9_ ^ 0xffffffff) >= (i ^ 0xffffffff) && (i_3_ ^ 0xffffffff) <= (i_10_ ^ 0xffffffff) && i <= i_11_
						&& i_3_ <= i_12_) {
