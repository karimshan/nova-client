...
public class Class105 implements Interface10 {
	public static Class61 aClass61_5202 = new Class61(4);
	public static GLSprite[] aGLSpriteArray5194;
	...
	public static Object anObject5203;

	public static final void method1116(int i, int i_0_, int i_1_, byte b, int i_2_, int i_3_, boolean voice) {
		if ((voice ? Class213.aNode_Sub27_2512.aClass320_Sub25_7276.method3776(false)
				: Class213.aNode_Sub27_2512.aClass320_Sub25_7295.method3776(false)) != 0 && i_0_ != 0
				&& Class23.anInt434 < 50 && (i ^ 0xffffffff) != 0)
			Node_Sub38_Sub19.aClass78Array10284[Class23.anInt434++] = new Class78(voice ? (byte) 3 : (byte) 2, i, i_0_,
					i_2_, i_3_, 0, i_1_, null);
		anInt5198++;
	}

	public static final CacheNode_Sub11 method1117(int i) {
		if (i < 104)
	...
	public static final void method1119(int i, int i_9_, int i_10_) {
	...
	private AbstractFont aClass52_5201;
	...
	public final void method26(int i) {
		...
		aClass52_5201 = Class93.graphicsToolkit.a(class357,
				Class383.method4199(aClass302_5200, aClass98_5192.anInt5054), true);
	}
	...
	public final void method27(boolean bool, int i) {
		anInt5197++;
		if (bool) {
			int i_6_ = aClass98_5192.aClass379_5066.method4160(-108, Node_Sub38_Sub12.anInt10225,
					aClass98_5192.anInt5062) + aClass98_5192.anInt5065;
			int i_7_ = aClass98_5192.aClass77_5069.method775(Class257.anInt3244, false, aClass98_5192.anInt5055)
					+ aClass98_5192.anInt5067;
			aClass52_5201.method535(0, null, aClass98_5192.anInt5064, aClass98_5192.aString5057, null, null, i_7_,
					aClass98_5192.anInt5059, 83, 0, aClass98_5192.anInt5056, i_6_, aClass98_5192.anInt5068,
					aClass98_5192.anInt5063, aClass98_5192.anInt5062, aClass98_5192.anInt5055);
		}
	}
}
