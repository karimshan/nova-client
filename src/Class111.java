...
public class Class111 {
	...
	public static int anInt1415 = 52;
	public static int anInt1416;
	public static int anInt1417;
	public static int anInt1418 = 0;

	public static final synchronized void method1137(byte[] bs, int i) {
		anInt1414++;
		...
		else if ((bs.length ^ 0xffffffff) == -30001 && GlobalMessage.anInt429 < 50)
			Class282.aByteArrayArray3588[GlobalMessage.anInt429++] = bs;
		else if (i == -251)
			if (Class113.aByteArrayArrayArray1447 != null)
				for (int i_0_ = 0; CacheNode_Sub1.anIntArray9427.length > i_0_; i_0_++)
					if ((CacheNode_Sub1.anIntArray9427[i_0_] ^ 0xffffffff) == (bs.length ^ 0xffffffff)
							&& (Class113.aByteArrayArrayArray1447[i_0_].length
									^ 0xffffffff) < (Class132.anIntArray1682[i_0_] ^ 0xffffffff)) {
						Class113.aByteArrayArrayArray1447[i_0_][Class132.anIntArray1682[i_0_]++] = bs;
						break;
					}
	}

	public static final int method1138(String string, byte[] bs, byte b, int i) {
		anInt1417++;
		if (b >= -65)
			anInt1418 = -11;
		int i_1_ = i;
		...
		for (int i_3_ = 0; (i_3_ ^ 0xffffffff) > (i_2_ ^ 0xffffffff); i_3_ += 4) {
			...
			int i_5_ = (i_3_ - -1 ^ 0xffffffff) <= (i_2_ ^ 0xffffffff) ? -1
					: Node_Sub16.method2591((byte) -115, string.charAt(i_3_ + 1));
			int i_6_ = (i_2_ ^ 0xffffffff) < (i_3_ - -2 ^ 0xffffffff)
					? Node_Sub16.method2591((byte) -115, string.charAt(2 + i_3_)) : -1;
	...
	public static final synchronized byte[] method1139(boolean bool, int i) {
		anInt1416++;
		...
		if ((i ^ 0xffffffff) == -30001 && GlobalMessage.anInt429 > 0) {
			byte[] bs = Class282.aByteArrayArray3588[--GlobalMessage.anInt429];
			Class282.aByteArrayArray3588[GlobalMessage.anInt429] = null;
			return bs;
		}
		if (bool != true)
			anInt1418 = 35;
		if (Class113.aByteArrayArrayArray1447 != null)
			for (int i_8_ = 0; i_8_ < CacheNode_Sub1.anIntArray9427.length; i_8_++)
				if ((i ^ 0xffffffff) == (CacheNode_Sub1.anIntArray9427[i_8_] ^ 0xffffffff)
						&& Class132.anIntArray1682[i_8_] > 0) {
