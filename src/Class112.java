...
public class Class112 {
	...
	Class112(Class353 class353, int i, boolean bool, Index class302, Index class302_4_) {
		...
		if (Node_Sub38_Sub34.aClass353_10443 != aClass353_1421)
			...
			aStringArray1438 = new String[] { null, null, null, null, null, GlobalMessage.aClass22_385.getMessage(anInt1422) };
	}

	public final void method1140(int i) {
	...
	public final void method1141(boolean bool, int i) {
		anInt1420++;
	...
	public final void method1142(int i) {
		anInt1429++;
		if (i < 13)
	...
	public final void method1143(int i, boolean bool) {
		anInt1425++;
	...
	public final void method1144(int i, int i_0_) {
		if (i != 64)
			aClass302_1433 = null;
	...
	public final ObjectDefinition method1145(int i, int i_1_) {
		anInt1432++;
		if (i_1_ <= 29)
			return null;
		ObjectDefinition objectdefinition;
		synchronized (aClass61_1427) {
			objectdefinition = (ObjectDefinition) aClass61_1427.method607(i, 0);
		}
		...
		synchronized (aClass61_1427) {
			aClass61_1427.method601(objectdefinition, 25566, i);
		}
		return objectdefinition;
	}

	public final void method1146(int i, int i_2_) {
		anInt1428++;
		if (i_2_ == 500) {
			synchronized (aClass61_1427) {
	...
	public final void method1147(int i, int i_3_) {
		anInt1423++;
		anInt1437 = i;
		synchronized (aClass61_1434) {
			aClass61_1434.method608(false);
