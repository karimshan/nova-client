...
public class Class113 {
	public static byte[][][] aByteArrayArrayArray1447;
	public static Class336 aClass336_1440;
	public static float aFloat1439;
	...
	public static final int method1148(boolean bool, int i, int i_0_) {
		anInt1445++;
		if (bool != true)
			return 95;
	...
	public static final void method1150(byte b) {
		...
		anInt1446++;
		Class262_Sub4.abstractFont = null;
		Node_Sub52.aGLSpriteArray7655 = null;
		Node_Sub53.aGLSpriteArray7666 = null;
		MiniMap.HINT_ICONS = null;
		ReferenceTable.aGLSpriteArray284 = null;
	}

	public static final void method1151(int i, int i_2_, int i_3_, byte b, int i_4_) {
		if (b > -103)
	...
	public static final boolean method1152(int i) {
		anInt1451++;
		if (i > -65)
			method1152(-37);
	...
	public static final long method1153(int i, String string) {
		anInt1442++;
		if (i != 1)
			method1153(79, null);
