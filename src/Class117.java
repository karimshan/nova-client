...
abstract class Class117 {
	public static IncomingPacket aClass192_1475 = new IncomingPacket(83, 7);
	...
	public static Node_Sub7 aNode_Sub7_1472;
	...
	public static final void method1166(int i, int i_1_, String string) {
		anInt1470++;
		if (i_1_ <= 8)
			aClass192_1475 = null;
	...
	public static final void method1168(int i, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_) {
		anInt1471++;
		int i_7_ = 0;
		int i_8_ = i_2_;
		int i_9_ = i_4_ * i_4_;
	...
	Class117(GLToolkit gltoolkit, int i, Buffer buffer, int i_27_, boolean bool) {
		anInt1473 = i_27_;
	...
	public final void method1165(byte b, int i, byte[] bs) {
