...
public class Class117_Sub1 extends Class117 implements Interface1 {
	public static OutgoingPacket aClass318_4932 = new OutgoingPacket(0, 9);
	/* synthetic */static Class<?> aClass4933;
	public static Class94 aClass94_4924 = new Class94();
	...
	public static String aString4931;
	...
	public static final void method1170(GraphicsToolkit graphicstoolkit, int i, int i_3_, int i_4_, int i_5_, int i_6_,
			int i_7_, int i_8_, int i_9_) {
		anInt4927++;
		Interface19 interface19 = (Interface19) Node_Sub38_Sub12.method2830(i_8_, i_3_, i_4_);
		if (interface19 != null) {
			ObjectDefinition objectdefinition = Class186.aClass112_2256.method1145(interface19.getObjectId(-32136),
					i_7_ ^ 0x12fe);
		...
		interface19 = (Interface19) Class262_Sub20.method3203(i_8_, i_3_, i_4_,
				aClass4933 == null ? aClass4933 = method1171("Interface19") : aClass4933);
		if (interface19 != null) {
			ObjectDefinition objectdefinition = Class186.aClass112_2256.method1145(interface19.getObjectId(-32136), 61);
		...
		if (interface19 != null) {
			ObjectDefinition objectdefinition = Class186.aClass112_2256.method1145(interface19.getObjectId(i_7_ ^ ~0x6f5c),
					106);
	...
	@Override
	public final void method1167(int i) {
