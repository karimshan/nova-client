...
public class Class117_Sub2 extends Class117 implements Interface9 {
	public static BufferedStream aBuffer5154;
	...
	public static short[][][] aShortArrayArrayArray5151;

	public static final int method1172(int i, int i_2_) {
	...
	public static final void method1174(int i, byte[][][] bs, int i_3_, int i_4_, int i_5_, int i_6_,
			GraphicsToolkit graphicstoolkit, int i_7_, int i_8_, byte b, int i_9_, int i_10_, int i_11_) {
		anInt5153++;
	...
	Class117_Sub2(GLToolkit gltoolkit, int i, Buffer buffer, int i_1_, boolean bool) {
