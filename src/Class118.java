...
public class Class118 implements Interface17 {
	...
	public static final boolean method1175(byte[] bs, int i, int i_0_, int i_1_, int i_2_, int i_3_) {
		anInt5411++;
		boolean bool = true;
		...
		for (;;) {
			...
			for (;;)
				if (bool_7_) {
					...
					if ((i_13_ ^ 0xffffffff) < -1 && i_14_ > 0 && (-1 + i_1_ ^ 0xffffffff) < (i_13_ ^ 0xffffffff)
							&& (-1 + i_3_ ^ 0xffffffff) < (i_14_ ^ 0xffffffff)) {
						ObjectDefinition objectdefinition = Class186.aClass112_2256.method1145(i_4_, i + 110);
						if (i_12_ != 22 || Class213.aNode_Sub27_2512.aClass320_Sub6_7267.method3701(false) != 0
								|| (objectdefinition.anInt3057 ^ 0xffffffff) != -1
								|| (objectdefinition.anInt3010 ^ 0xffffffff) == -2 || objectdefinition.aBoolean3051) {
							bool_7_ = true;
	...
	public final int method64(int i, byte b) {
		anInt5408++;
		Node_Sub32 node_sub32 = (Node_Sub32) Class18.aHashTable308.getNode(b ^ ~0xd91, i | 0x100000000L);
		if (b != -42)
	...
	public final int method65(int i, int i_15_) {
		...
		anInt5409++;
		Node_Sub32 node_sub32 = (Node_Sub32) Class18.aHashTable308.getNode(3512, i);
		if (node_sub32 == null)
