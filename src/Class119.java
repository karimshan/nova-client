...
public class Class119 {
	public static IncomingPacket aClass192_1497 = new IncomingPacket(55, 2);
	public static Class346 aClass346_1515 = new Class346();
	...
	public static int[] anIntArray1516 = new int[3];
	...
	public final void method1216(boolean bool, int i, GraphicsToolkit graphicstoolkit, int i_0_, int i_1_, int i_2_, int i_3_,
			int i_4_, int i_5_, int i_6_, int i_7_, boolean bool_8_, byte b) {
		anInt1514++;
		int i_9_ = 0;
		if (aBoolean1480)
			i_9_ = anInt1506;
		if (aClass119_1499 != null) {
			...
			class119_10_.method1218(i_3_, i_6_, i_4_, graphicstoolkit, bool, bool_8_, i_2_, i_1_, -30262, i_5_, i_0_,
					i_9_, i_7_, i);
			class119_11_.method1218(i_3_, i_6_, i_4_, graphicstoolkit, false, bool_8_, i_2_, i_1_, -30262, i_5_, i_0_,
					-i_9_ + 255, i_7_, i);
		} else
	...
	public final void method1217(int i, int i_12_, byte b) {
		anInt1482++;
		anInt1506 = anInt1489 + (i - anInt1489) * i_12_ / 255;
	}

	private final void method1218(int i, int i_14_, int i_15_, GraphicsToolkit graphicstoolkit, boolean bool,
			boolean bool_16_, int i_17_, int i_18_, int i_19_, int i_20_, int i_21_, int i_22_, int i_23_, int i_24_) {
		anInt1486++;
		int i_25_ = 255 + -i_22_;
		if (aDrawableModel1504 != null) {
			...
			if (anInt1491 == -1 || anInt1507 == 0)
				...
				PlayerMasks class91 = Class376.aD4661.method10(anInt1491, -8217);
				if (aGLSprite1490 == null && Class376.aD4661.method7(i_19_ + 40162, anInt1491)) {
					int[] is = (class91.anInt1226 ^ 0xffffffff) == -3
							? Class376.aD4661.method8(0.7F, anInt1491, anInt1507, false, false, anInt1507)
							: Class376.aD4661.method11(anInt1507, false, anInt1507, anInt1491, (byte) 0, 0.7F);
					anInt1481 = is[0];
				...
				if (aGLSprite1490 != null) {
					...
					if (anInt1502 == 1) {
						for (int i_29_ = -i_15_ + i_28_; i_18_ > i_29_; i_29_ = i_29_ + i_15_)
							aGLSprite1490.method1199(i_20_ + i_29_, i_27_ + i_24_, i_15_, i_15_, 0,
									0xffffff | i_25_ << 24, i_26_);
						...
						if ((~0xffffff & anInt1495 ^ 0xffffffff) != -1)
							graphicstoolkit.method1239(i_18_, i_15_ - (i_15_ + i_27_) + -i_24_, i_15_ + (i_24_ + i_27_),
									(byte) 116, 0, anInt1495);
					} else {
						...
						for (int i_30_ = -i_15_ + i_28_; (i_18_ ^ 0xffffffff) < (i_30_ ^ 0xffffffff); i_30_ += i_15_)
							for (int i_31_ = i_27_ - i_15_; i_15_ > i_31_; i_31_ += i_15_)
								aGLSprite1490.method1199(i_20_ + i_30_, i_31_ - -i_24_, i_15_, i_15_, 0,
										0xffffff | i_25_ << 24, i_26_);
					}
				}
			}
		...
		if (i_19_ == -30262) {
			for (int i_32_ = anInt1492 + -1; i_32_ >= 0; i_32_--)
				aClass182Array1484[i_32_].method1838(graphicstoolkit, i_20_, i_24_, i_18_, i_15_, i_23_, i_21_,
						anInt1512, anInt1493, anInt1488, i_25_);
			graphicstoolkit.ya();
		}
	}

	public final void method1219(int i, int i_33_, GraphicsToolkit graphicstoolkit, int i_34_, int i_35_, int i_36_, int i_37_,
	...
	public final void method1220(byte b, Class119 class119_43_) {
		anInt1510++;
		if (!aBoolean1480) {
	...
	public final boolean method1222(byte b) {
		anInt1508++;
		return aBoolean1480;
	}
	...
	public final Class119 method1224(byte b) {
		anInt1503++;
		if (b != 58)
			return null;
	...
	public final boolean method1225(int i, int i_50_, int i_51_, GraphicsToolkit graphicstoolkit) {
	...
	public final void method1226(int i) {
		aBoolean1480 = false;
		anInt1496++;
		anInt1506 = 0;
		if (i == 2)
