...
public class Class120 {
	...
	public static final void method1228(int i) {
		if (i > -93)
			method1228(-86);
		anInt1520++;
	...
	public static final void method1229(String username, String password, byte b) {
		anInt1519++;
		if (username.length() <= 320 && Node_Sub38_Sub23.method2866(false)) {
			...
			System.out.println("This is where the username & password are set: in method1229 in Class120: " + username
					+ " - " + password);
			if (b == 88)
	...
	public static final void method1230(int i) {
		anInt1517++;
