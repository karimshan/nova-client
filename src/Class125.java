...
public class Class125 {
	public static Class61 aClass61_1609 = new Class61(4);
	public static int anInt1606;
	public static int anInt1607;
	public static int anInt1608;
	public static int anInt1610;

	public static final void method1527(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_) {
		anInt1610++;
	...
	public static final boolean method1529(int i, int i_10_, int i_11_) {
		if (i != 2048)
			aClass61_1609 = null;
		anInt1608++;
	...
	public static final void method1530(byte b, int i, int[] is, long[] ls, int i_12_) {
		if (b != -114)
			aClass61_1609 = null;
		anInt1606++;
		if (i > i_12_) {
	...
	public static final void method1531(int i) {
		if (i == 2288) {
			anInt1607++;
