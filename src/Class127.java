...
public class Class127 {
	public static Class124 aClass124_1638 = new Class124(16);
	public static IncomingPacket aClass192_1644 = new IncomingPacket(115, 8);
	public static int anInt1640;
	public static int anInt1643;
	public static int[][] anIntArrayArray1642 = { { 0, 2, 4, 6 }, { 6, 0, 2, 3, 5, 3 }, { 6, 0, 2, 4 }, { 2, 5, 6, 1 },
			{ 0, 2, 6 }, { 6, 0, 2 }, { 5, 6, 0, 1, 2, 4 }, { 7, 7, 1, 2, 4, 6 }, { 2, 4, 4, 7 },
			{ 6, 6, 4, 0, 1, 1, 3, 3 }, { 0, 2, 2, 6, 6, 4 }, { 0, 2, 2, 3, 7, 0, 4, 3 }, { 0, 2, 4, 6 } };
	public static Index index22;

	public static final void drawHintIcons(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_) {
		anInt1640++;
		if (i != 3)
			method1541(103);
		...
		for (int i_6_ = 0; (class223s.length ^ 0xffffffff) < (i_6_ ^ 0xffffffff); i_6_++) {
			...
			if (class223 != null && (class223.anInt2654 ^ 0xffffffff) == -3) {
				Animable_Sub1.method826(2 * class223.anInt2657, -1, class223.anInt2662, i_0_, i_2_ >> 1, i_1_,
						class223.anInt2653, class223.anInt2661, i_5_ >> 1);
				if ((Class119.anIntArray1516[0] ^ 0xffffffff) < 0 && Class174.clientCycle % 20 < 10) {
					...
					Class362.method4053(i_8_, glsprite.method1186() + i_8_, i_7_, (byte) -118,
							glsprite.method1197() + i_7_);
				}
			}
		}
	}
	...
	public static final void method1542(int i, boolean bool) {
		anInt1643++;
		if (i != 11582)
			method1541(34);
		IncomingPacketHolder[] class123s = Class218.aClass123Array2567;
		for (IncomingPacketHolder class123 : class123s) {
		...
		if (!bool) {
			...
			try {
				Class2.displayApplet("loggedout", Class96.mainGameApplet, (byte) -95);
