...
public class Class128 {
	public static OutgoingPacket aClass318_1651 = new OutgoingPacket(5, 4);
	public static OutgoingPacket aClass318_1658 = new OutgoingPacket(45, 7);
	public static OutgoingPacket aClass318_1660 = new OutgoingPacket(75, 4);
	...
	public static final void method1544(int i, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_,
			int i_8_) {
		anInt1653++;
		if ((i_3_ ^ 0xffffffff) <= -2 && (i ^ 0xffffffff) <= -2
				&& (-2 + Node_Sub54.GAME_SCENE_WDITH ^ 0xffffffff) <= (i_3_ ^ 0xffffffff)
				&& (-2 + Class377_Sub1.GAME_SCENE_HEIGHT ^ 0xffffffff) <= (i ^ 0xffffffff)) {
			int i_9_ = i_6_;
			if (i_9_ < 3 && Class238.method3021(i, i_3_, 106))
				i_9_++;
			if ((Class213.aNode_Sub27_2512.aClass320_Sub19_7301.method3751(false) ^ 0xffffffff) == -1
					&& !Class369.method4085(i, 0, Class94.anInt1249, i_3_, i_9_)
					|| Class175.aClass261ArrayArrayArray2099 == null)
				return;
			Node_Sub38_Sub1.aClass277_Sub1_10084.method3359(i_5_, (byte) 102, i, Class304.SCENE_CLIP_DATA_PLANES[i_6_],
					i_6_, i_3_, Class93.graphicsToolkit);
			if (i_8_ >= 0) {
				...
				Node_Sub38_Sub1.aClass277_Sub1_10084.method3352(i_1_, i_8_, Class304.SCENE_CLIP_DATA_PLANES[i_6_], i,
						Class93.graphicsToolkit, i_3_, i_2_, -102, i_9_, i_6_, i_4_);
	...
	public static final boolean method1547(int i, int i_13_, int i_14_) {
		anInt1657++;
		if (i_14_ == 11)
			i_14_ = 10;
		if (i_13_ != 1)
	...
	public static final Class262 method1548(BufferedStream buffer, byte b) {
		anInt1647++;
			...
			while_133_: do {
				while_132_: do {
					while_131_: do {
																...
																while_120_: do {
																	while_119_: do {
																		while_118_: do {
																											...
																											while_109_: do {
																												do {
																													if (Class194_Sub1_Sub1.aClass124_9368 != class124_16_) {
																														...
																														class262 = new Class262_Sub16(
																																buffer);// sendobject
																																		// or
																																		// destroy?
																														break while_134_;
																													}
																													class262 = new Class262_Sub2(
																															buffer); // sendobject
																																		// or
																																		// destroy?
																													break while_134_;
																												} while (false);
																												class262 = new Class262_Sub6(
																														buffer); // object
																																	// animation
																												break while_134_;
																											} while (false);
																											class262 = new Class262_Sub12(
																													buffer); // music
																											break while_134_;
																										} while (false);
																										class262 = new Class262_Sub13(
																												buffer); // sound
																															// 2
																										break while_134_;
																									} while (false);
																									class262 = new Class262_Sub8(
																											buffer); // music
																														// effect
																									break while_134_;
																								} while (false);
																								class262 = new Class262_Sub14(
																										buffer); // sound
																													// 1
																								break while_134_;
																							} while (false);
																							class262 = new Class262_Sub15_Sub1(
																									buffer); // gfx
																												// on
																												// floor
																							break while_134_;
																						} while (false);
																						class262 = new Class262_Sub5(
																								buffer); // message
																											// on
																											// tile
																						break while_134_;
																					} while (false);
																					class262 = new Class262_Sub4(
																							buffer);
																					break while_134_;
																				} while (false);
																			...
																			class262 = new Class262_Sub10(buffer); // setcamera
																													// pos
																			break while_134_;
																		} while (false);
						...
						class262 = new Class262_Sub19(buffer, false); // sets
						// mask
						break while_134_;
					} while (false);
	...
	public static final int method1550(int i, int i_18_, int i_19_) {
		if (i != -13892)
			return 98;
		anInt1654++;
		int i_20_ = i_19_ >>> 31;
	...
	public final ConfigDefinitions getConfigDefinitions(int i) {
		anInt1655++;
		ConfigDefinitions class70;
		synchronized (aClass61_1656) {
			class70 = (ConfigDefinitions) aClass61_1656.method607(i, 0);
		}
		if (class70 != null)
			return class70;
		byte[] bs;
		...
		synchronized (aClass61_1656) {
			aClass61_1656.method601(class70, 11 + 25555, i);
		}
		return class70;
	}

	public final void method1543(int i, int i_0_) {
		synchronized (aClass61_1656) {
	...
	public final void method1546(int i) {
		synchronized (aClass61_1656) {
	...
	public final void method1551(int i, int i_21_) {
		synchronized (aClass61_1656) {
			if (i != 75)
				aClass318_1651 = null;
	...
	public final void method1552(byte b) {
		anInt1648++;
		synchronized (aClass61_1656) {
			aClass61_1656.method608(false);
			if (b != 101)
