...
public class Class13 {
	public static IncomingPacket aClass192_203 = new IncomingPacket(106, 8);
	...
	public static String[][] aStringArrayArray209 = {
	...
	public static final boolean method206(char c, int i) {
		if (i <= 3)
			method208(21, 86, -113);
		anInt200++;
	...
	public static final boolean method208(int i, int i_1_, int i_2_) {
		if (i_2_ != 0)
			return false;
		anInt211++;
		if (!(Class179.method1816(i_1_, i_2_ + -1, i) | (0x70000 & i_1_) != 0)
				&& !OutgoingPacket.method3669(i_1_, (byte) 120, i))
			return false;
		return true;
	}

	public static final void method209(boolean bool, int i, int i_3_, int i_4_, int i_5_) {
		anInt204++;
		if (CacheNode_Sub15.method2379(7015, i)) {
			Class320_Sub9.method3716(true, i_5_, bool, i_4_, Class134_Sub3.widgetsList[i], -1);
			if (i_3_ > -28)
				aClass192_203 = null;
		}
	}
	...
	public final Class314 method207(int i, int i_0_) {
		anInt206++;
		Class314 class314;
		synchronized (aClass61_207) {
			class314 = (Class314) aClass61_207.method607(i, i_0_);
		}
		if (class314 != null)
			return class314;
		byte[] bs;
		...
		synchronized (aClass61_207) {
			aClass61_207.method601(class314, 25566, i);
		}
		return class314;
	}

	public final void method210(int i) {
		anInt210++;
		synchronized (aClass61_207) {
	...
	public final void method211(int i, byte b) {
		if (b == 94) {
			anInt208++;
			synchronized (aClass61_207) {
	...
	public final void method213(byte b) {
		anInt201++;
		synchronized (aClass61_207) {
			if (b != -72) {
				/* empty */
