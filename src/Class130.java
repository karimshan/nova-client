...
public class Class130 {
	public static Class312 aClass312_1670 = new Class312();
	public static int anInt1671;
	public static int anInt1672;

	public static final void method1557(byte b, Index class302, GraphicsToolkit graphicstoolkit) {
		anInt1671++;
		...
		MiniMap.HINT_ICONS = new GLSprite[class383s.length];
		for (int i_1_ = 0; (i_1_ ^ 0xffffffff) > (class383s.length ^ 0xffffffff); i_1_++)
			MiniMap.HINT_ICONS[i_1_] = graphicstoolkit.a(class383s[i_1_], true);
		...
		class383s = Class383.method4187(class302, LoadingBar.anInt2019, 0);
	...
	public static final int method1559(int i, int i_9_) {
		anInt1672++;
		int i_10_ = i_9_ & 0x3f;
