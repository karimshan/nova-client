...
abstract class Class134 implements Interface13 {
	public static OutgoingPacket aClass318_5301;
	...
	public static int[] SKILL_MAX_LEVEL = { 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99,
			99, 99, 99, 120 };
	static {
		aClass318_5301 = new OutgoingPacket(80, -1);
	}

	public static final boolean method1567(char c, int i) {
		anInt5316++;
		if (i != 4493)
	...
	public static final Class210 method1568(String string, GLToolkit gltoolkit, int i, int i_0_) {
		anInt5298++;
	...
	public static final void method1569() {
		for (;;) {
			boolean bool = true;
	...
	public static final boolean method1574(boolean bool, int i) {
		anInt5300++;
		if ((i ^ 0xffffffff) == -26 || (i ^ 0xffffffff) == -6 || (i ^ 0xffffffff) == -51 || i == 6 || i == 45
				|| (i ^ 0xffffffff) == -1008)
			return true;
		if (i == 17)
			return true;
	...
	public final int method1570(int i) {
		anInt5314++;
		if (i != 10242)
			return -71;
	...
	public final void method1575(int i, int[] is, int i_3_, int i_4_, int i_5_) {
		anInt5310++;
		...
		for (;;) {
			OpenGL.glTexImage2Di(i, i_6_, method1570(10242), i_5_, i_4_, 0, 32993, aGLXToolkit5299.anInt9321, is_10_,
					0);
			if (i_7_ <= 1)
				break;
			int i_12_ = 0;
				...
				for (int i_17_ = 0; (i_8_ ^ 0xffffffff) < (i_17_ ^ 0xffffffff); i_17_++) {
					...
					is_11_[i_12_++] = Node_Sub16.method2590(
							Node_Sub16.method2590(
									Node_Sub16.method2590(Node_Sub30.method2723(i_23_ << 14, 16711680),
											Node_Sub30.method2723(i_22_ << 22, -16777216)),
	...
	public final void method1577(int i, int i_27_, int i_28_, byte[] bs, int i_29_) {
		anInt5303++;
		...
		for (;;) {
			OpenGL.glTexImage2Dub(i_27_, i_31_, method1570(i_28_ ^ 0x2803), i_29_, i, 0,
					Node_Sub36.method2753((byte) -18, aClass68_5317), 5121, bs_35_, 0);
			if (i_32_ <= 1)
				break;
	...
	public final void method1578(float[] fs, int i, int i_46_, boolean bool, int i_47_) {
		anInt5307++;
		...
		if (bool == true) {
			...
			for (;;) {
				OpenGL.glTexImage2Df(i_47_, i_49_, method1570(10242), i, i_46_, 0,
						Node_Sub36.method2753((byte) -18, aClass68_5317), 5126, fs_53_, 0);
				if (i_50_ <= 1)
					break;
				int i_55_ = i * i_48_;
