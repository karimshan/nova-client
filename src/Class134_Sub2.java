...
public class Class134_Sub2 extends Class134 implements Interface13_Impl2 {
	public static int anInt9021;
	public static int anInt9022 = -60;
	public static int anInt9023;
	public static int anInt9024;

	public static final boolean method1582(int i, int i_2_, byte[] bs, int i_3_, byte b, int i_4_, int i_5_) {
		if (b != -78)
			anInt9021 = -124;
		anInt9023++;
		int i_6_ = i_3_ % i;
	...
	Class134_Sub2(GLXToolkit glxtoolkit, int i, boolean bool, int[][] is) {
		...
		if (bool)
			...
			for (int i_1_ = 0; i_1_ < 6; i_1_++)
				OpenGL.glTexImage2Di(34069 + i_1_, 0, this.method1570(10242), i, i, 0,
						Node_Sub36.method2753((byte) -18, aClass68_5317), aGLXToolkit5299.anInt9321, is[i_1_], 0);
	}
}
