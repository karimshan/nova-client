...
public class Class134_Sub3 extends Class134 implements Interface13_Impl1 {
	public static int anInt9025;
	public static int anInt9026;
	public static int anInt9027;
	public static int anInt9028;
	public static int anInt9029;
	public static int anInt9031;
	public static int anInt9033;
	public static int anInt9034;
	public static int anInt9036;
	public static IComponentDefinitions[][] widgetsList;

	public static final void method1583(Animable animable, int i, int i_22_, int i_23_) {
		if (i_22_ < Class328.anInt4115) {
			...
			if (class261 != null && class261.anAnimable_Sub1_3317 != null && class261.anAnimable_Sub1_3317.method821(0))
				animable.method816(0, true, CacheNode_Sub18.aGraphicsToolkit9607, 0, (byte) 108, Class179.anInt2129,
						class261.anAnimable_Sub1_3317);
		}
		if (i_23_ < Class328.anInt4115) {
			Class261 class261 = Class175.aClass261ArrayArrayArray2099[i][i_22_][i_23_ + 1];
			if (class261 != null && class261.anAnimable_Sub1_3317 != null && class261.anAnimable_Sub1_3317.method821(0))
				animable.method816(0, true, CacheNode_Sub18.aGraphicsToolkit9607, Class179.anInt2129, (byte) 118, 0,
						class261.anAnimable_Sub1_3317);
		}
		if (i_22_ < Class328.anInt4115 && i_23_ < GameMessage.anInt7623) {
			Class261 class261 = Class175.aClass261ArrayArrayArray2099[i][i_22_ + 1][i_23_ + 1];
			if (class261 != null && class261.anAnimable_Sub1_3317 != null && class261.anAnimable_Sub1_3317.method821(0))
				animable.method816(0, true, CacheNode_Sub18.aGraphicsToolkit9607, Class179.anInt2129, (byte) 122,
						Class179.anInt2129, class261.anAnimable_Sub1_3317);
		}
		if (i_22_ < Class328.anInt4115 && i_23_ > 0) {
			Class261 class261 = Class175.aClass261ArrayArrayArray2099[i][i_22_ + 1][i_23_ - 1];
			if (class261 != null && class261.anAnimable_Sub1_3317 != null && class261.anAnimable_Sub1_3317.method821(0))
				animable.method816(0, true, CacheNode_Sub18.aGraphicsToolkit9607, -Class179.anInt2129, (byte) 121,
						Class179.anInt2129, class261.anAnimable_Sub1_3317);
		}
	}
	...
	Class134_Sub3(GLXToolkit glxtoolkit, Class68 class68, Class372 class372, int i, int i_13_) {
		...
		OpenGL.glTexImage2Dub(anInt5296, 0, this.method1570(10242), i, i_13_, 0,
				Node_Sub36.method2753((byte) -18, aClass68_5317), Class136.method1590((byte) 108, aClass372_5297), null,
				0);
	}
	...
	Class134_Sub3(GLXToolkit glxtoolkit, Class68 class68, int i, int i_30_, byte[] bs, int i_31_, int i_32_) {
		...
		OpenGL.glTexImage2Dub(anInt5296, 0, this.method1570(10242), i, i_30_, 0,
				Node_Sub36.method2753((byte) -18, aClass68_5317), 5121, bs, i_31_);
	...
	Class134_Sub3(GLXToolkit glxtoolkit, Class68 class68, int i, int i_0_, float[] fs, int i_1_, int i_2_) {
		...
		OpenGL.glTexImage2Df(anInt5296, 0, this.method1570(10242), i, i_0_, 0,
				Node_Sub36.method2753((byte) -18, aClass68_5317), 5126, fs, 4 * i_1_);
		OpenGL.glPixelStorei(3314, 0);
	}
	...
	Class134_Sub3(GLXToolkit glxtoolkit, int i, int i_9_, int[] is, int i_10_, int i_11_) {
		...
		OpenGL.glTexImage2Di(anInt5296, 0, 6408, anInt9030, anInt9032, 0, 32993, aGLXToolkit5299.anInt9321, is,
				4 * i_10_);
		OpenGL.glPixelStorei(3314, 0);
	}
	...
	@Override
	public final void method50(int i, int i_24_, int i_25_, int i_26_, byte[] bs, int i_27_, Class68 class68, int i_28_,
			int i_29_) {
		anInt9027++;
		aGLXToolkit5299.method1312((byte) -21, this);
		...
		OpenGL.glTexSubImage2Dub(anInt5296, 0, i_28_, i_27_, i_29_, i_25_, Node_Sub36.method2753((byte) -18, class68),
				5121, bs, i);
