...
public class Class134_Sub4 extends Class134 implements Interface13_Impl1 {
	public static IncomingPacket aClass192_9045 = new IncomingPacket(129, 4);
	public static IncomingPacket aClass192_9052 = new IncomingPacket(120, -2);
	...
	public static int anInt9051;
	public static Rectangle[] aRectangleArray9048 = new Rectangle[100];
	...
	Class134_Sub4(GLXToolkit glxtoolkit, Class68 class68, Class372 class372, int i, int i_34_) {
		...
		OpenGL.glTexImage2Dub(anInt5296, 0, this.method1570(10242), i, i_34_, 0,
				Node_Sub36.method2753((byte) -18, aClass68_5317), Class136.method1590((byte) -97, aClass372_5297), null,
				0);
	}

	Class134_Sub4(GLXToolkit glxtoolkit, Class68 class68, int i, int i_31_, boolean bool, byte[] bs, int i_32_,
			int i_33_) {
		...
		if (!bool || (i_33_ ^ 0xffffffff) != -1 || i_32_ != 0) {
			...
			OpenGL.glTexImage2Dub(anInt5296, 0, this.method1570(10242), i, i_31_, 0,
					Node_Sub36.method2753((byte) -18, aClass68_5317), 5121, bs, i_32_);
	...
	Class134_Sub4(GLXToolkit glxtoolkit, Class68 class68, int i, int i_0_, boolean bool, float[] fs, int i_1_,
			int i_2_) {
	...
	Class134_Sub4(GLXToolkit glxtoolkit, int i, int i_9_, boolean bool, int[] is, int i_10_, int i_11_) {
		...
		if (!bool || (i_11_ ^ 0xffffffff) != -1 || i_10_ != 0) {
			...
			OpenGL.glTexImage2Di(anInt5296, 0, 6408, anInt9037, anInt9041, 0, 32993, aGLXToolkit5299.anInt9321, is,
					i_10_ * 4);
			OpenGL.glPixelStorei(3314, 0);
		} else
	...
	public final void method1586(Class68 class68, int i, int i_19_, int i_20_, float[] fs, int i_21_, int i_22_, int i_23_,
			int i_24_) {
		anInt9042++;
		aGLXToolkit5299.method1312((byte) -21, this);
		OpenGL.glPixelStorei(3314, i_23_);
		OpenGL.glTexSubImage2Df(anInt5296, 0, i, i_22_, i_24_, i_19_, Node_Sub36.method2753((byte) -18, class68), 5121,
				fs, i_20_);
		if (i_21_ == -27322)
			OpenGL.glPixelStorei(3314, 0);
	}
	...
	@Override
	public final void method50(int i, int i_13_, int i_14_, int i_15_, byte[] bs, int i_16_, Class68 class68, int i_17_,
			int i_18_) {
		aGLXToolkit5299.method1312((byte) -21, this);
		anInt9043++;
		OpenGL.glPixelStorei(3317, 1);
		...
		if (i_15_ != -15178)
			aClass192_9052 = null;
		OpenGL.glTexSubImage2Dub(anInt5296, 0, i_17_, i_16_, i_18_, i_14_, Node_Sub36.method2753((byte) -18, class68),
				5121, bs, i);
		OpenGL.glPixelStorei(3314, 0);
		OpenGL.glPixelStorei(3317, 4);
	}
