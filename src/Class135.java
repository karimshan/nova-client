...
public class Class135 {
	...
	public static final void method1587(int i, Player player) {
		if (i > 40) {
			anInt1689++;
			...
			if (node_sub47 != null)
				...
				Class262_Sub1.method3150(player.plane, player, player.scenePositionXQueue[0],
						player.scenePositionYQueue[0], null, null, (byte) -8, 0);
		}
	}

	public static final Object method1588(byte[] bs, int i, boolean bool) {
		anInt1691++;
		if (bs == null)
			return null;
