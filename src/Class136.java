...
public class Class136 {
	...
	public static int[] anIntArray1695 = new int[13];
	...
	public static final int method1590(byte b, Class372 class372) {
	...
	public final void method1591(int i) {
		if (i == -28841) {
	...
	public final void method1592(boolean bool) {
	...
	public final Class169_Sub2 method1593(byte b, int i) {
		anInt1700++;
		Object object = aClass61_1699.method607(i, 0);
		if (object != null)
			return (Class169_Sub2) object;
		if (!aD1698.method7(9900, i))
			return null;
		PlayerMasks class91 = aD1698.method10(i, b ^ 0x2007);
		if (b != -32)
		...
		if (class91.aBoolean1215 && aGLToolkit1696.w()) {
			...
			class169_sub2 = new Class169_Sub2(aGLToolkit1696, 3553, 34842, i_0_, i_0_, class91.aByte1207 != 0, fs,
					6408);
		} else {
			int[] is;
			...
			class169_sub2 = new Class169_Sub2(aGLToolkit1696, 3553, 6408, i_0_, i_0_,
					(class91.aByte1207 ^ 0xffffffff) != -1, is, 0, 0, false);
		}
		class169_sub2.method1776(class91.aBoolean1212, -100, class91.aBoolean1210);
		aClass61_1699.method601(class169_sub2, 25566, i);
