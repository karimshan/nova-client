...
public class Class137 {
	public static boolean aBoolean1715 = false;
	public static IncomingPacket aClass192_1709 = new IncomingPacket(72, 2);
	...
	public final void method1594(byte b) {
		anInt1713++;
		aClass349ArrayArray1703 = new Class349[anInt1702][anInt1708];
		if (b < 0)
			for (int i = 0; i < anInt1708; i++)
				for (int i_0_ = 0; i_0_ < anInt1702; i_0_++)
					aClass349ArrayArray1703[i_0_][i] = new Class349(aGLToolkit1714, this, aGLPlane1707, i_0_, i,
							anInt1711, i_0_ * 128 + 1, 1 + i * 128);
	}

	public final void method1595(byte b, int i, int i_1_, r var_r) {
		anInt1701++;
	...
	public final void method1596(int i, boolean bool, boolean bool_12_, int i_13_, boolean[][] bools, int i_14_) {
		anInt1717++;
		...
		float f = 1.0F / (aGLToolkit1714.anInt6606 * 128);
		if (bool)
			for (int i_15_ = 0; (anInt1708 ^ 0xffffffff) < (i_15_ ^ 0xffffffff); i_15_++) {
				...
				for (int i_18_ = 0; i_18_ < anInt1702; i_18_++) {
					...
					while_136_: for (int i_21_ = i_19_; (i_20_ ^ 0xffffffff) < (i_21_ ^ 0xffffffff); i_21_++)
						if (-i_14_ <= -i + i_21_ && -i + i_21_ <= i_14_)
							for (int i_22_ = i_16_; i_17_ > i_22_; i_22_++)
								if (-i_14_ <= -i_13_ + i_22_ && (i_14_ ^ 0xffffffff) <= (i_22_ - i_13_ ^ 0xffffffff)
										&& bools[i_14_ + -i + i_21_][i_14_ + i_22_ + -i_13_]) {
			...
			for (int i_23_ = 0; (anInt1708 ^ 0xffffffff) < (i_23_ ^ 0xffffffff); i_23_++) {
				...
				for (int i_26_ = 0; (i_26_ ^ 0xffffffff) > (anInt1702 ^ 0xffffffff); i_26_++) {
					...
					PacketDecoder floatbuffer = aGLToolkit1714.aFloatBuffer6661;
					...
					for (int i_30_ = i_24_; i_30_ < i_25_; i_30_++)
						if (-i_14_ <= i_30_ + -i_13_ && (-i_13_ + i_30_ ^ 0xffffffff) >= (i_14_ ^ 0xffffffff)) {
							...
							for (int i_32_ = i_28_; i_29_ > i_32_; i_32_++) {
								if ((-i + i_32_ ^ 0xffffffff) <= (-i_14_ ^ 0xffffffff)
										&& (-i + i_32_ ^ 0xffffffff) >= (i_14_ ^ 0xffffffff)
										&& bools[i_14_ + (i_32_ - i)][-i_13_ + i_30_ + i_14_]) {
									short[] ses = aGLPlane1707.aShortArrayArray7925[i_31_];
									if (ses != null)
										if (!aGLToolkit1714.aBoolean6736)
											for (int i_33_ = 0; (ses.length ^ 0xffffffff) < (i_33_
													^ 0xffffffff); i_33_++) {
												floatbuffer.method2191(-116, 0xffff & ses[i_33_]);
												i_27_++;
											}
										else
											for (int i_34_ = 0; (ses.length ^ 0xffffffff) < (i_34_
													^ 0xffffffff); i_34_++) {
												i_27_++;
					...
					if ((i_27_ ^ 0xffffffff) < -1) {
						...
						OpenGL.glLoadIdentity();
						OpenGL.glScalef(f, f, 1.0F);
						OpenGL.glTranslatef(-i_26_ / f, -i_23_ / f, 1.0F);
						OpenGL.glMatrixMode(5888);
	...
	public final boolean method1597(int i, int i_35_, r var_r, int i_36_) {
		anInt1710++;
		r_Sub2 var_r_Sub2 = (r_Sub2) var_r;
	...
	public final void method1598(int i, r var_r, int i_46_, byte b) {
		anInt1705++;
		r_Sub2 var_r_Sub2 = (r_Sub2) var_r;
		...
		if ((i_50_ ^ 0xffffffff) < -1 && (i_49_ ^ 0xffffffff) < -1) {
			Node_Sub38_Sub33.method2898(i_52_, i_51_, i_47_, aByteArray1704, i_48_, var_r_Sub2.aByteArray11058, i_49_,
					i_50_, 0);
