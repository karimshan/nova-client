...
public class Class140 {
	public static boolean[] aBooleanArray1739 = new boolean[8];
	...
	public static final void method1610(int i, String string, String string_3_, SignLink signlink, boolean bool,
			boolean bool_4_) {
		if (i != 0)
		...
		if (bool_4_) {
			if (SignLink.aString3981.startsWith("win") && signlink.aBoolean4005) {
				...
				if (Class96.mainGameApplet != null)
					string_5_ = Class96.mainGameApplet.getParameter("haveie6");
			...
			if (SignLink.aString3981.startsWith("mac")) {
				...
				if (Class96.mainGameApplet != null)
					string_6_ = Class96.mainGameApplet.getParameter("havefirefox");
	...
	public final GLSprite method1606(int i, GraphicsToolkit graphicstoolkit, boolean bool, int i_0_) {
		anInt1736++;
		long l = graphicstoolkit.anInt1537 << 19 | ((bool ? 262144 : 0) | (i << 16 | anInt1740));
	...
	public final boolean method1607(byte b) {
		if (b <= 21)
			return true;
		anInt1738++;
	...
	public final void method1611(BufferedStream buffer, int i) {
		anInt1735++;
		for (;;) {
