...
public class Class143 {
	public static byte[] aByteArray1773 = null;
	public static Class326[] aClass326Array1771;
	public static int anInt1768;
	public static int anInt1770;
	public static int anInt1780;
	public static int[] anIntArray1764;
	static {
		anIntArray1764 = new int[32];
	}

	public static final int[] method1622(int i, int i_0_, boolean bool, int i_1_, int i_2_, int i_3_, float f, int i_4_) {
		anInt1770++;
		int[] is = new int[i_2_];
	...
	public static final void method1623(int i, int i_5_, int i_6_, int i_7_, int i_8_) {
		anInt1780++;
		int i_9_ = 0;
		if (i_6_ == -957563775) {
			int i_10_ = i_7_;
	...
	public final boolean method1625(int i, Class143 class143_19_) {
		anInt1768++;
		if (i <= 66)
			method1622(2, 6, true, 113, -82, 64, 0.5866943F, -83);
		if (class143_19_.anInt1767 == anInt1767 && class143_19_.anInt1776 == anInt1776
				&& (class143_19_.anInt1769 ^ 0xffffffff) == (anInt1769 ^ 0xffffffff))
			return true;
		return false;
	}
}
