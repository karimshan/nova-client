...
abstract class Class144 {
	public static boolean aBoolean1791 = true;
	public static byte[][] aByteArrayArray1782 = new byte[1000][];
	public static IncomingPacket aClass192_1786 = new IncomingPacket(138, -1);
	public static IncomingPacket aClass192_1790;
	public static int anInt1783;
	public static int anInt1784;
	public static int[] anIntArray1789;
	static {
		aClass192_1790 = new IncomingPacket(109, 10);
	}
	...
	public static final void method1628(int i) {
		...
		for (Node_Sub28 node_sub28 = (Node_Sub28) Class320_Sub16.aClass312_8358
				.method3613(65280); node_sub28 != null; node_sub28 = (Node_Sub28) Class320_Sub16.aClass312_8358
			...
			for (int i_18_ = i_7_; i_13_ + i_7_ > i_18_; i_18_++) {
				...
				while (i_20_ < i_6_ - -i_12_) {
					if (bool)
						Class330.anIntArrayArrayArray4128[i_11_][i_14_ + i_8_][i_19_ + i_9_] = (i_18_ << 3)
								+ ((i_20_ << 14) + (i_10_ << 24)) + (i_5_ << 1);
					else
						Class330.anIntArrayArrayArray4128[i_11_][i_19_ + i_8_][i_9_ + i_14_] = (i_5_ << 1)
								+ ((i_18_ << 3) + (i_10_ << 24) + (i_20_ << 14));
					i_20_++;
					i_19_ += i_16_;
				}
				i_14_ += i_17_;
		...
		for (Node_Sub28 node_sub28 = (Node_Sub28) Class320_Sub16.aClass312_8358
			...
			for (int i_26_ = i_22_ >>> 3; i_24_ >= i_26_; i_26_++)
				while_142_: for (int i_27_ = i_23_ >>> 3; i_27_ <= i_25_; i_27_++) {
					...
					StandardPlane.anIntArray7980[i_21_] = Animable_Sub1_Sub1.aClass302_10618
							.method3519("m" + i_26_ + "_" + i_27_, (byte) 119);
					anIntArray1789[i_21_] = Animable_Sub1_Sub1.aClass302_10618.method3519("l" + i_26_ + "_" + i_27_,
							(byte) 23);
					Class42.anIntArray645[i_21_] = Animable_Sub1_Sub1.aClass302_10618
							.method3519("um" + i_26_ + "_" + i_27_, (byte) 120);
					ProducingGraphicsBuffer.anIntArray9895[i_21_] = Animable_Sub1_Sub1.aClass302_10618
							.method3519("ul" + i_26_ + "_" + i_27_, (byte) 121);
					i_21_++;
				}
		}
		Class15.XTEA_KEYS = Class169.anIntArrayArray4954;
		Class169.anIntArrayArray4954 = null;
		Class364.method4057(false, Node_Sub54.GAME_SCENE_WDITH >> 4, 12, Class377_Sub1.GAME_SCENE_HEIGHT >> 4,
				(byte) -36);
	}

	public static final void method1631(byte b) {
		anInt1784++;
