...
public class Class144_Sub1 extends Class144 {
	public static Class232 aClass232_6802;
	public static float aFloat6808 = 1.0F;
	public static int anInt6803;
	public static int anInt6806;
	public static int anInt6809;
	public static int anInt6811;
	public static short aShort6804 = 256;
	static {
		anInt6806 = -1;
	}
	...
	@Override
	public final void method1626(int i, int i_18_, int i_19_) {
		anInt6811++;
	...
	@Override
	public final void method1629(int i, int i_6_, int i_7_) {
		anInt6803++;
	...
	@Override
	public final void method1630(int i, int i_12_, int i_13_) {
		anInt6809++;
		if (i_12_ == -1) {
