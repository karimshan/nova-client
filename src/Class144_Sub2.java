...
public class Class144_Sub2 extends Class144 {
	...
	public static final void method1633(int i, int i_2_) {
		if (i <= -18) {
	...
	public static final boolean method1634(int i, int i_9_, boolean bool) {
		anInt6814++;
		if (bool != false)
			method1633(-109, 100);
		if ((0x10 & i_9_) == 0)
	...
	@Override
	public final void method1626(int i, int i_16_, int i_17_) {
		anInt6819++;
	...
	@Override
	public final void method1629(int i, int i_0_, int i_1_) {
		anInt6820++;
		if (i_0_ != -12850)
			method1629(85, 97, 74);
	}
	...
	@Override
	public final void method1630(int i, int i_3_, int i_4_) {
		anInt6816++;
		if (i_3_ != -1)
			anInt6817 = 74;
