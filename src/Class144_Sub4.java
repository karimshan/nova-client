...
public class Class144_Sub4 extends Class144 {
	public static Class124 aClass124_6838;
	public static Class124 aClass124_6846;
	public static OutgoingPacket aClass318_6847;
	public static float[] aFloatArray6843 = new float[4];
	...
	@Override
	public final void method1626(int i, int i_11_, int i_12_) {
		if (i_12_ != 3)
			aFloatArray6843 = null;
		anInt6844++;
	}
	...
	@Override
	public final void method1629(int i, int i_5_, int i_6_) {
		anInt6845++;
		if (i_5_ != -12850)
			method1630(-37, 80, -95);
	...
	@Override
	public final void method1630(int i, int i_13_, int i_14_) {
		if (i_13_ == -1)
			anInt6840++;
	}
}
