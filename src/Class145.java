...
public class Class145 {
	public static IncomingPacket aClass192_1798 = new IncomingPacket(6, -2);
	public static Index aClass302_1799;
	public static int anInt1792;
	public static int anInt1793;
	public static int anInt1794;
	public static int anInt1796;

	public static final int method1638(int i, String string, int i_0_, boolean bool) {
		anInt1796++;
	...
	public static final void method1639(boolean bool) {
		anInt1794++;
		if (bool != true)
			aClass192_1798 = null;
	...
	public static final void method1641(int i, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_, byte b, int i_13_,
			int i_14_) {
		anInt1792++;
		if (b < -60)
			Node_Sub25_Sub2.aClass54Array9959[Class167.anInt2033++] = new Class54(i, i_13_, i_9_, i_14_, i_14_, i_9_,
					i_10_, i_12_, i_12_, i_10_, i_11_, i_11_, i_8_, i_8_);
	}
