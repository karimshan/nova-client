...
public class Class149 implements Interface5 {
	...
	public final void method13(int i, int i_9_, int i_10_) throws Exception {
		...
		if (aByteArrayArray5034[i_9_] == null
				|| (aByteArrayArray5034[i_9_].length ^ 0xffffffff) != (i_11_ ^ 0xffffffff)) {
			aByteArrayArray5034[i_9_] = new byte[i_11_];
			aDSBufferDescArray5024[i_9_].bufferBytes = i_11_;
		}
		if (i_10_ != 65535)
			aDirectSound5030 = null;
		aDirectSoundBufferArray5033[i_9_] = aDirectSound5030.createSoundBuffer(aDSBufferDescArray5024[i_9_],
				aWaveFormatEx5023);
