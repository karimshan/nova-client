...
public class Class15 {
	...
	public static final void method220(int i, int i_0_, float[] fs, int[] is, int i_1_, float[] fs_2_, int i_3_, int i_4_,
			int[] is_5_, int i_6_, int i_7_, int i_8_, int i_9_) {
		if (i_8_ == -5) {
			anInt221++;
									...
									if (i == 9)
										...
										if ((i ^ 0xffffffff) != -13)
											throw new RuntimeException(
													"Unrecognised ClanSettingsDelta type in decode()");
	...
	public final void method219(int i, ClanChat clanchat) {
		anInt227++;
		if ((aLong223 ^ 0xffffffffffffffffL) != (clanchat.aLong747 ^ 0xffffffffffffffffL)
				|| (anInt226 ^ 0xffffffff) != (clanchat.anInt757 ^ 0xffffffff))
			throw new RuntimeException(
					"ClanSettingsDelta.applyToClanSettings(): Credentials do not match! Settings.owner:"
							+ Class154.method1699(clanchat.aLong747, i + 25589) + " updateNum:" + clanchat.anInt757
							+ " delta.owner:" + Class154.method1699(aLong223, 25589) + " updateNum:" + anInt226);
		if (i != 0)
			method219(119, null);
		for (Node_Sub15 node_sub15 = (Node_Sub15) aClass312_222
				.method3613(65280); node_sub15 != null; node_sub15 = (Node_Sub15) aClass312_222.method3620(16776960))
