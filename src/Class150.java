...
class Class150 implements Interface7 {
	...
	public static final boolean method1652(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
		anInt5089++;
		...
		if (Node_Sub25.method2653(Class179.anInt2129, i, i_4_, 255, i_5_,
				Class320_Sub10.aPlaneArray8300[i_0_].method3251(i_3_, i_1_, (byte) -118), Class179.anInt2129)) {
			Class187.anInt2267++;
			return true;
		}
		return false;
	...
	public static final void method1653(File file, int i, byte[] bs, int i_6_) throws IOException {
		anInt5078++;
	...
	public static final float method1654(float f, float f_7_, float f_8_, int i, byte b) {
	...
	Class150(Class379 class379, Class77 class77, int i, int i_10_, int i_11_, int i_12_, int i_13_, int i_14_,
			int i_15_) {
		anInt5081 = i_12_;
		anInt5083 = i_14_;
