...
public class Class150_Sub1 extends Class150 {
	public static Class151 aClass151_8949 = new Class151(11, 0, 1, 2);
	public static IncomingPacket aClass192_8952 = new IncomingPacket(113, 3);
	public static int anInt8947;
	public static int anInt8948;
	public static int anInt8954;
	public static final int INDEXES_COUNT = 37; // 37
	public static SeekableFile[] aSeekableFileArray8953 = new SeekableFile[INDEXES_COUNT];
	...
	public static final void method1656(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
		anInt8948++;
		int i_4_ = MouseHandler.anInt6067;
		int i_5_ = LoadingBar.anInt2014;
		...
		if ((Node_Sub38_Sub28.anInt10403 ^ 0xffffffff) == -2) {
			...
			Class362.method4053(-8 + i_5_, i_5_ - 8 - -glsprite.method1186(), i_4_ - 8, (byte) -79,
					glsprite.method1197() + -8 + i_4_);
		}
		if (Node_Sub38_Sub28.anInt10403 == 2) {
			GLSprite glsprite = Node_Sub15_Sub7.aGLSpriteArray9828[Node_Sub37.anInt7431 / 100 + 4];
			glsprite.method1196(i_4_ + -8, -8 + i_5_);
			Class362.method4053(i_5_ - 8, glsprite.method1186() + (-8 + i_5_), i_4_ + -8, (byte) 56,
					glsprite.method1197() + i_4_ + -8);
		}
		if (i_1_ != 16427)
			aSeekableFileArray8953 = null;
	...
	public static final void method1657(boolean bool) {
		Class175.keyStrokes.method3453((byte) 62);
		anInt8954++;
		...
		// Sets the keystrokehandler
		Class175.keyStrokes = Class361.setKeyStrokeHandler(2, Node_Sub38_Sub20.aCanvas10309);
		System.out.println("Setting the keystrokehandler in this class: Class150_Sub1");
		Class106.aClass93_1356 = Class328_Sub1.method3830(Node_Sub38_Sub20.aCanvas10309, -19397, bool);
	}

	public static final boolean method1658(Animable animable, boolean bool, byte[][][] bs, int i, byte b) {
		...
		for (int i_10_ = i_6_; i_10_ <= i_7_; i_10_++)
			for (int i_11_ = i_8_; i_11_ <= i_9_; i_11_++)
				if (animable.aByte5931 < Class159.anInt1995 && i_10_ >= Class238.anInt2915 && i_10_ < Class46.anInt679
						&& i_11_ >= Class320_Sub9.anInt8295 && i_11_ < Class367.anInt4533)
					if (bs != null && animable.plane >= i && bs[animable.plane][i_10_][i_11_] == b
						...
						if (!bool && i_10_ >= Class216.anInt2551 - 16 && i_10_ <= Class216.anInt2551 + 16
								&& i_11_ >= EntityNode_Sub7.anInt6013 - 16 && i_11_ <= EntityNode_Sub7.anInt6013 + 16)
	...
	Class150_Sub1(Class379 class379, Class77 class77, int i, int i_12_, int i_13_, int i_14_, int i_15_, int i_16_,
