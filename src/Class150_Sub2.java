...
public class Class150_Sub2 extends Class150 {
	public static boolean[][][] aBooleanArrayArrayArray8960;
	public static Class299 aClass299_8962;
	public static int anInt8955;
	public static int anInt8956;
	public static int anInt8957;
	public static int anInt8961;

	public static final boolean method1659(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_,
			int i_7_) {
		anInt8961++;
	...
	public static final Class357 method1660(byte b, int i, GraphicsToolkit graphicstoolkit) {
	...
	Class150_Sub2(Class379 class379, Class77 class77, int i, int i_9_, int i_10_, int i_11_, int i_12_, int i_13_,
