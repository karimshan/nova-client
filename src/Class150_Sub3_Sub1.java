...
public class Class150_Sub3_Sub1 extends Class150_Sub3 {
	public static IncomingPacket aClass192_10576 = new IncomingPacket(10, 0);
	...
	public static final void method1665(byte b, int i) {
		@SuppressWarnings("unused")
		int i_13_ = -101 / ((b - -59) / 32);
		for (Node node = Class156.aHashTable1964.method1516(false); node != null; node = Class156.aHashTable1964
				.method1520(107))
			if (i == (node.aLong2797 >> 48 & 0xffffL))
	...
	Class150_Sub3_Sub1(Class379 class379, Class77 class77, int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_,
