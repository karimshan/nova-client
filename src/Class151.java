...
public class Class151 {
	public static IncomingPacket aClass192_1845 = new IncomingPacket(86, 0);
	public static int anInt1841;
	public static int anInt1843 = 0;

	public static final void method1671(int i, int i_0_, int i_1_, int i_2_, byte[][][] bs, int[] is, int[] is_3_, int[] is_4_,
			int[] is_5_, int[] is_6_, int i_7_, byte b, int i_8_, int i_9_, boolean bool, boolean bool_10_, int i_11_,
		...
		if (Class367.anInt4533 > GameMessage.anInt7623)
			Class367.anInt4533 = GameMessage.anInt7623;
		...
		if (Class307.aBoolean3898) {
			for (int i_15_ = 0; i_15_ < Node_Sub9_Sub1.anInt9656 + Node_Sub9_Sub1.anInt9656 + 2; i_15_++) {
				...
				for (int i_18_ = 0; i_18_ < Node_Sub9_Sub1.anInt9656 + Node_Sub9_Sub1.anInt9656 + 2; i_18_++) {
					...
					if (i_19_ >= 0 && i_20_ >= 0 && i_19_ < Class328.anInt4115 && i_20_ < GameMessage.anInt7623) {
						int i_21_ = i_19_ << Class36.anInt549;
						int i_22_ = i_20_ << Class36.anInt549;
						int i_23_ = Node_Sub38_Sub37.aPlaneArray10466[Node_Sub38_Sub37.aPlaneArray10466.length - 1]
								.method3251(i_20_, i_19_, (byte) -118) - (1000 << Class36.anInt549 - 7);
						int i_24_ = (Class368.aPlaneArray4548 != null
								? Class368.aPlaneArray4548[0].method3251(i_20_, i_19_, (byte) -118) + Class179.anInt2129
								: Node_Sub38_Sub37.aPlaneArray10466[0].method3251(i_20_, i_19_, (byte) -118)
										+ Class179.anInt2129)
								+ (1000 << Class36.anInt549 - 7);
						i_17_ = i_11_ >= 0
								? CacheNode_Sub18.aGraphicsToolkit9607.r(i_21_, i_23_, i_22_, i_21_, i_24_, i_22_,
										i_11_)
					...
					if (i_15_ > 0 && i_18_ > 0) {
						int i_25_ = Node_Sub38_Sub7.anIntArray10150[i_18_ - 1] & Node_Sub38_Sub7.anIntArray10150[i_18_]
								& i_16_ & i_17_;
			...
			if (Class122.aBooleanArrayArray1555 == null)
				Class122.aBooleanArrayArray1555 = new boolean[Class328.anInt4115 + Class328.anInt4115
						+ 1][GameMessage.anInt7623 + Class328.anInt4115 + 1];
		...
		if (!Node_Sub36_Sub3.aClass179_10058.aBoolean2130) {
			...
			for (EntityNode_Sub6 entitynode_sub6 = (EntityNode_Sub6) class103.method1113(
					(byte) 108); entitynode_sub6 != null; entitynode_sub6 = (EntityNode_Sub6) class103.method1108(61)) {
		...
		if (Class188_Sub2.aBoolean6868) {
			...
			for (int i_30_ = 0; i_30_ < Class290.anInt3655 - 1; i_30_++)
				Node_Sub38_Sub25.anIntArray10358[i_30_] = i_29_ * (i_30_ + 1) + Client.anIntArray8039[i_30_];
		...
		if (Class188_Sub2.aBoolean6868) {
			...
			if (GlobalMessage.anInt427 == 2)
				if (Class270_Sub1.aLongArray8029[0] < Class270_Sub1.aLongArray8029[1]) {
					if (Node_Sub38_Sub25.anIntArray10358[0]
							+ Client.anIntArray8039[0] > Class129.anIntArray1669[0])
						Client.anIntArray8039[0]++;
				} else if (Class270_Sub1.aLongArray8029[0] > Class270_Sub1.aLongArray8029[1]
						&& Node_Sub38_Sub25.anIntArray10358[0]
								+ Client.anIntArray8039[0] < Class129.anIntArray1669[2])
					Client.anIntArray8039[0]--;
		}
		if (!Class307.aBoolean3898) {
