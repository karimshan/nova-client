...
public class Class156 implements Runnable {
	public static IncomingPacket aClass192_1962 = new IncomingPacket(128, -2);
	public static GLSprite[] aGLSpriteArray1969;
	public static HashTable aHashTable1964 = new HashTable(512);
	...
	public static final int method1705(int i, int i_3_) {
		if (i != -983162425)
			method1705(73, -108);
		anInt1970++;
		return i_3_ >>> 7;
	...
	public final boolean method1703(int i, int i_0_) throws IOException {
		anInt1959++;
	...
	public final void method1704(boolean bool) {
		if (bool != false)
			aByteArray1971 = null;
		anInt1966++;
	...
	public final void method1706(byte b) {
		synchronized (this) {
			if (b > -75)
				return;
			if (anIOException1968 == null)
	...
	public final int method1708(int i, int i_5_, int i_6_, byte[] bs) throws IOException {
		anInt1967++;
