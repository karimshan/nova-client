...
public class Class158 {
	public static ConnectionDecoder aClient1983;
	...
	public static final void method1718(int i, int i_0_, int i_1_) {
		anInt1985++;
		if (i == -5091) {
			CacheNode_Sub2 cachenode_sub2 = Class320_Sub19.method3754(3, 13, i_0_);
			cachenode_sub2.method2288(0);
			cachenode_sub2.itemId = i_1_;
		}
	}

	public static final Class169_Sub2_Sub1 method1724(int i, int i_3_, int i_4_, byte b, int i_5_, GLToolkit gltoolkit) {
		anInt1989++;
		if (!gltoolkit.aBoolean6652 && (!Class371.method4094(i_4_, false) || !Class371.method4094(i_3_, false))) {
			if (!gltoolkit.aBoolean6649)
				return new Class169_Sub2_Sub1(gltoolkit, i, i_5_, i_4_, i_3_,
						Class320_Sub19.method3753(i_4_, -729073628), Class320_Sub19.method3753(i_3_, -729073628), true);
	...
	public static final void method1725(int i, int i_7_, int i_8_, int i_9_, int i_10_) {
	...
	public final CacheNode method1717(int i) {
		anInt1991++;
	...
	public final void method1719(boolean bool, CacheNode cachenode) {
		anInt1992++;
	...
	public final int method1720(byte b) {
		anInt1986++;
		int i = 0;
		CacheNode cachenode = aCacheNode1984.aCacheNode7035;
	...
	public final CacheNode method1721(int i) {
		anInt1988++;
		if (i != 0)
			return null;
	...
	public final void method1722(boolean bool) {
		for (;;) {
			CacheNode cachenode = aCacheNode1984.aCacheNode7035;
			if (cachenode == aCacheNode1984)
				break;
	...
	public final CacheNode method1723(int i) {
		if (i != 13)
