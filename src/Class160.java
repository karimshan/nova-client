...
public class Class160 {
	...
	public static int[] anIntArray2000 = new int[3];

	public static final void method1726(boolean bool) {
		Class243.username = Node_Sub5.password = "";
		if (bool == false)
			anInt1998++;
	}

	public static final void method1727(boolean bool, byte b, boolean bool_0_) {
		if (b < 27)
			method1728((byte) 87);
		anInt1997++;
		if (bool_0_) {
	...
	public static final void method1729(int i, BufferedStream buffer) {
		anInt2001++;
