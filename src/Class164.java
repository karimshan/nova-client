...
public class Class164 {
	...
	public static final synchronized void method1739(int i, Interface3 interface3) {
		if (!aBoolean2022)
			if (anInt2024 <= i)
				interface3.w(false);
			else {
	...
	public static final synchronized void method1740(int i) {
		for (;;) {
	...
	public static final synchronized void method1741(int i) {
		if (i == -1)
			anInt2024++;
	}

	public static final synchronized void method1742(boolean bool, int i) {
		aBoolean2022 = bool;
		if (i != 0)
			anInt2024 = -114;
	}

	public static final synchronized void method1743(int i) {
		anInt2024--;
