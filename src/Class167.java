...
public class Class167 {
	public static OutgoingPacket aClass318_2034 = new OutgoingPacket(56, 0);
	...
	public static final int method1748(int i, byte b, int i_0_) {
		if (i_0_ < i) {
			int i_1_ = i_0_;
			i_0_ = i;
			i = i_1_;
	...
	public static final Class171 method1752(int i, int i_6_, int i_7_, DrawableModel drawablemodel, int i_8_) {
		anInt2037++;
		if (drawablemodel == null)
			return null;
		if (i != 0)
			method1752(-1, -28, -46, null, 113);
		Class171 class171 = new Class171(i_7_, i_6_, i_8_, drawablemodel.na(), drawablemodel.V(), drawablemodel.RA(),
				drawablemodel.fa(), drawablemodel.EA(), drawablemodel.HA(), drawablemodel.G());
		return class171;
	}
	...
	public final boolean method1749(byte b, float f, Class169_Sub3 class169_sub3, Class169_Sub3 class169_sub3_3_) {
		anInt2040++;
		if (!method1751(80))
			return false;
		Class382 class382 = aGLToolkit2036.aClass382_6701;
		CacheNode_Sub17 cachenode_sub17 = new CacheNode_Sub17(aGLToolkit2036, 6408, class169_sub3.anInt8819,
				class169_sub3.anInt8809);
		...
		if (class382.method4180(10785)) {
			...
			OpenGL.glUniform2fARB(OpenGL.glGetUniformLocationARB(aClass145_2035.aLong1795, "sampleSize"),
					1.0F / class169_sub3_3_.anInt8819, 1.0F / class169_sub3_3_.anInt8809);
	...
	public final boolean method1751(int i) {
