...
abstract class Class169 implements Interface2 {
	...
	public static int[] anIntArray4965 = new int[32];
	public static int[][] anIntArrayArray4954;
	public static short aShort4961;

	public static final char method1755(int i, int i_0_, char c) {
		anInt4959++;
		if (c >= 192 && c <= 255) {
	...
	public static final void method1760(boolean bool) {
	...
	public static final int method1762(byte b, int i) {
		if (b != 114)
			return 89;
		anInt4952++;
		return 0x3ff & i;
	...
	public final void method1757(boolean bool, boolean bool_1_) {
		if (bool == false) {
	...
	public final int method1759(byte b) {
	...
	public final void method1761(byte b) {
		if (b == -53) {
			anInt4949++;
			if (anInt4960 > 0) {
	...
	public final boolean method1765(int i) {
		if (i != -231)
			anIntArrayArray4954 = null;
		anInt4955++;
	...
	public final void method1766(byte b, boolean bool) {
