...
public class Class169_Sub1 extends Class169 {
	public static boolean aBoolean8783 = false;
	public static boolean[] aBooleanArray8788;
	public static IncomingPacket aClass192_8785 = new IncomingPacket(91, -1);
	...
	public static final void method1768(int i) {
		if (i == 0) {
	...
	public static final void method1769(int i, int i_4_, int i_5_) {
	...
	Class169_Sub1(GLToolkit gltoolkit, int i, int i_11_) {
		...
		for (int i_12_ = 0; i_12_ < 6; i_12_++)
			OpenGL.glTexImage2Dub(i_12_ + 34069, 0, anInt4950, i_11_, i_11_, 0,
	...
	Class169_Sub1(GLToolkit gltoolkit, int i, int i_13_, boolean bool, int[][] is) {
		...
		if (!bool)
			for (int i_14_ = 0; (i_14_ ^ 0xffffffff) > -7; i_14_++)
				OpenGL.glTexImage2Di(34069 - -i_14_, 0, anInt4950, i_13_, i_13_, 0, 32993, aGLToolkit4947.anInt6740,
						is[i_14_], 0);
		else
			for (int i_15_ = 0; (i_15_ ^ 0xffffffff) > -7; i_15_++)
				Class258.method3124(i_13_, i_15_ + 34069, is[i_15_], 32993, anInt4950, i_13_, 1,
						aGLToolkit4947.anInt6740);
		this.method1757(false, true);
	}

	public final void method1767(int i, byte b, int i_0_, int i_1_, int i_2_) {
		anInt8792++;
