...
class Class169_Sub2 extends Class169 {
	public static Class170 aClass170_8806 = new Class170(2, 2);
	public static IncomingPacket aClass192_8798 = new IncomingPacket(100, 1);
	public static Class257 aClass257_8804 = new Class257(5, 3);
	...
	Class169_Sub2(GLToolkit gltoolkit, int i, int i_15_, int i_16_, int i_17_) {
		...
		OpenGL.glTexImage2Dub(anInt4951, 0, anInt4950, i_16_, i_17_, 0, Class320_Sub16.method3742(6406, anInt4950),
				5121, null, 0);
		this.method1757(false, true);
	}

	Class169_Sub2(GLToolkit gltoolkit, int i, int i_0_, int i_1_, int i_2_, boolean bool, byte[] bs, int i_3_,
			boolean bool_4_) {
	...
	Class169_Sub2(GLToolkit gltoolkit, int i, int i_28_, int i_29_, int i_30_, boolean bool, int[] is, int i_31_,
			int i_32_, boolean bool_33_) {
		...
		if ((anInt4951 ^ 0xffffffff) != -34038 && bool && i_31_ == 0 && (i_32_ ^ 0xffffffff) == -1) {
			...
			OpenGL.glTexImage2Di(anInt4951, 0, anInt4950, anInt8795, anInt8803, 0, 32993, aGLToolkit4947.anInt6740, is,
					4 * i_32_);
	...
	public final void method1772(byte b, int[] is, boolean bool, int i, int i_18_, int i_19_, int i_20_, int i_21_,
			int i_22_) {
		if (i_21_ == 0)
			i_21_ = i_19_;
		anInt8796++;
		...
		OpenGL.glTexSubImage2Di(anInt4951, 0, i, -i_18_ + -i_20_ + anInt8803, i_19_, i_18_, 32993,
				aGLToolkit4947.anInt6740, is, i_22_);
		if ((i_19_ ^ 0xffffffff) != (i_21_ ^ 0xffffffff))
			OpenGL.glPixelStorei(3314, 0);
	}

	public final void method1773(int i, int i_39_, int i_40_, byte b, int i_41_, int i_42_, int i_43_) {
		anInt8800++;
		if (b > 60) {
	...
	public final void method1774(int i, int i_49_, int i_50_, int i_51_) {
		anInt8802++;
	...
	public final void method1775(int i, byte b, int i_52_, int i_53_, int i_54_, byte[] bs, boolean bool, int i_55_, int i_56_,
			int i_57_) {
	...
	public final void method1776(boolean bool, int i, boolean bool_66_) {
