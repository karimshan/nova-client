...
public class Class169_Sub4 extends Class169 {
	public static volatile boolean aBoolean8829;
	public static Class353 aClass353_8825 = new Class353("stellardawn", "Stellar Dawn", 1);
	public static int anInt8822;
	public static int anInt8823;
	public static int anInt8827;
	public static int anInt8828;
	public static int anInt8831;
	public static int[][] anIntArrayArray8826;
	public static String aString8830 = null;
	static {
		aBoolean8829 = false;
	}
	...
	public static final void method1786(int i) {
		if (i <= 87)
			aString8830 = null;
	...
	public static final void method1787(byte b) {
		anInt8828++;
		int i = 1024;
		int i_2_ = 3072;
		...
		if (Class257.aFloat3243 < i)
			Class257.aFloat3243 = i;
		for (/**/; Node_Sub12.aFloat5450 >= 16384.0F; Node_Sub12.aFloat5450 -= 16384.0F) {
			/* empty */
		}
		if (i_2_ < Class257.aFloat3243)
			Class257.aFloat3243 = i_2_;
		...
		int i_5_ = 99 / ((73 - b) / 34);
		int i_6_ = Node_Sub38_Sub7.method2809(CacheNode_Sub20_Sub1.myPlayerPlane, -29754, Class25.anInt444,
				Mobile_Sub4.anInt10987);
		int i_7_ = 0;
		if ((i_3_ ^ 0xffffffff) < -4 && (i_4_ ^ 0xffffffff) < -4 && -4 + Node_Sub54.GAME_SCENE_WDITH > i_3_
				&& i_4_ < Class377_Sub1.GAME_SCENE_HEIGHT - 4)
			for (int i_8_ = i_3_ - 4; 4 + i_3_ >= i_8_; i_8_++)
				for (int i_9_ = i_4_ - 4; (i_9_ ^ 0xffffffff) >= (i_4_ - -4 ^ 0xffffffff); i_9_++) {
					...
					if (i_10_ < 3 && Class238.method3021(i_9_, i_8_, -83))
						i_10_++;
					int i_11_ = 0;
					if (Node_Sub38_Sub1.aClass277_Sub1_10084.aByteArrayArrayArray3518 != null
							&& Node_Sub38_Sub1.aClass277_Sub1_10084.aByteArrayArrayArray3518[i_10_] != null)
						i_11_ = 8 * (Node_Sub38_Sub1.aClass277_Sub1_10084.aByteArrayArrayArray3518[i_10_][i_8_][i_9_]
								& 0xff) << 2;
					if (Class320_Sub10.aPlaneArray8300 != null && Class320_Sub10.aPlaneArray8300[i_10_] != null) {
						int i_12_ = i_11_
								- (Class320_Sub10.aPlaneArray8300[i_10_].method3251(i_9_, i_8_, (byte) -118) - i_6_);
						if (i_7_ < i_12_)
							i_7_ = i_12_;
					}
				}
	...
	public final void method1784(int i, boolean bool) {
		aGLToolkit4947.method1444(-2, this);
		if (i != 33071)
			method5(37);
		anInt8823++;
