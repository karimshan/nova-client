...
public class Class170 {
	public static OutgoingPacket aClass318_2051 = new OutgoingPacket(64, 8);
	...
	public static int[] anIntArray2054;
					...
					if (class261 != null) {
						...
						if (animable_sub2 != null && animable_sub2.method821(0)) {
							...
							if (animable_sub2_2_ != null && animable_sub2_2_.method821(0)) {
								...
								animable_sub2_2_.method816(0, false, CacheNode_Sub18.aGraphicsToolkit9607, 0,
										(byte) 126, 0, animable_sub2);
						...
						for (Class256 class256 = class261.aClass256_3312; class256 != null; class256 = class256.aClass256_3238) {
							...
							if (mobile != null && mobile.method821(0)) {
								Class336_Sub3.method3901(mobile, i, i_0_, i_1_,
										mobile.aShort9130 - mobile.aShort9119 + 1,
										mobile.aShort9124 - mobile.aShort9120 + 1);
	...
	public static final void method1789(int i) {
		anInt2050++;
		int i_4_ = 0;
	...
	public static final int method1790(int i, int i_9_, byte b, int i_10_, int i_11_, int i_12_) {
		anInt2049++;
		if (b < 107)
			method1791((byte) 40);
		...
		if ((i_9_ ^ 0xffffffff) > -4) {
			int i_13_ = i_12_ >> 9;
			int i_14_ = i >> 9;
			if (i_10_ < 0 || i_11_ < 0 || Node_Sub54.GAME_SCENE_WDITH + -1 < i_10_
					|| (-1 + Class377_Sub1.GAME_SCENE_HEIGHT ^ 0xffffffff) > (i_11_ ^ 0xffffffff))
				return 0;
			if (i_13_ < 1 || (i_14_ ^ 0xffffffff) > -2
					|| (i_13_ ^ 0xffffffff) < (Node_Sub54.GAME_SCENE_WDITH + -1 ^ 0xffffffff)
					|| i_14_ > -1 + Class377_Sub1.GAME_SCENE_HEIGHT)
				return 0;
			boolean bool = (CacheNode_Sub11.aByteArrayArrayArray9550[1][i_12_ >> 9][i >> 9] & 0x2 ^ 0xffffffff) != -1;
			if ((0x1ff & i_12_) == 0) {
				boolean bool_15_ = (0x2 & CacheNode_Sub11.aByteArrayArrayArray9550[1][-1 + i_13_][i >> 9]
						^ 0xffffffff) != -1;
			...
			if ((0x1ff & i ^ 0xffffffff) == -1) {
				boolean bool_17_ = (0x2 & CacheNode_Sub11.aByteArrayArrayArray9550[1][i_12_ >> 9][i_14_ + -1]
						^ 0xffffffff) != -1;
