...
public class Class171 {
	public static boolean aBoolean2058 = true;
	public static Class278 aClass278_2062;
	public static long aLong2071 = 20000000L;
	public static int anInt2057;
	public static int anInt2064;
	public static int anInt2066;
	public static int anInt2074;
	public static int[] anIntArray2070 = new int[500];

	public static final AbstractFont method1792(boolean bool, boolean bool_0_, int i, int i_1_, GraphicsToolkit graphicstoolkit) {
		anInt2057++;
		if (i_1_ > -88)
			aBoolean2058 = false;
	...
	public final void method1793(int i, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_,
			int i_10_, int i_11_) {
		anInt2067 = i_8_;
		anInt2065 = i_3_;
		anInt2069 = i_7_ * i_7_;
	...
	public final boolean method1795(int i, byte b, int i_12_, int i_13_) {
		anInt2064++;
