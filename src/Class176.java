...
public class Class176 {
	public static Index aClass302_2102;
	public static int anInt2103;
	public static Node_Sub9_Sub3 aNode_Sub9_Sub3_2106;
	...
	public final Class254 method1805(int i, int i_0_) {
		anInt2103++;
		if (i_0_ != -4409)
			return null;
		Class254 class254;
		synchronized (aClass61_2104) {
			class254 = (Class254) aClass61_2104.method607(i, 0);
		}
		if (class254 != null)
			return class254;
		byte[] bs;
		...
		synchronized (aClass61_2104) {
			aClass61_2104.method601(class254, 25566, i);
		}
		return class254;
	}
}
