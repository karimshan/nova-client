...
public class Class179 {
	public static Index aClass302_2132;
	...
	public static String aString2123;
	...
	public static final boolean method1816(int i, int i_3_, int i_4_) {
		anInt2131++;
		if (i_3_ != -1)
			return true;
	...
	public static final boolean method1817(int i, int i_5_, int i_6_) {
		anInt2125++;
		if (i != -1)
			return false;
	...
	public final void method1813(int i, EntityNode_Sub6 entitynode_sub6) {
		anInt2128++;
		...
		if (!bool) {
			if (aBoolean2130)
				for (EntityNode_Sub6 entitynode_sub6_1_ = (EntityNode_Sub6) aClass103_2124.method1113(
						(byte) -3); entitynode_sub6_1_ != null; entitynode_sub6_1_ = (EntityNode_Sub6) aClass103_2124
								.method1108(99))
					if (entitynode_sub6_1_.anAnimable5990 == animable) {
						entitynode_sub6_1_.method803(false);
						Class148.method1650(i, entitynode_sub6_1_);
					}
			for (EntityNode_Sub6 entitynode_sub6_2_ = (EntityNode_Sub6) aClass103_2124.method1113(
					(byte) -117); entitynode_sub6_2_ != null; entitynode_sub6_2_ = (EntityNode_Sub6) aClass103_2124
							.method1108(94))
	...
	public final void method1815(byte b) {
		for (;;) {
