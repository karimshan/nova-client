...
public class Class182 {
	...
	private static final void method1834(GraphicsToolkit graphicstoolkit) {
		if (aDrawableModel2168 == null) {
			...
			model.method2086((byte) 0, (byte) 0, (byte) -66, (short) 0, (short) 0, (short) 1024, (short) 32767,
					(short) 1024, (short) 1024, (byte) 0);
			...
			for (int i = 0; i <= 24; i++) {
				...
				if (i > 0) {
					...
					for (int i_11_ = 1; i_11_ < 23; i_11_++) {
						int i_12_ = i_10_ + 1;
						int i_13_ = i_9_ + 1;
						model.method2080(true, i_10_, i_9_, i_12_, (short) 127, (short) 0, (byte) 0, (byte) 0,
								(byte) 0);
						model.method2080(true, i_12_, i_9_, i_13_, (short) 127, (short) 0, (byte) 0, (byte) 0,
								(byte) 0);
						i_10_ = i_12_;
						i_9_ = i_13_;
					}
			...
			for (int i = 0; i < 64; i++) {
				...
				for (int i_69_ = 0; i_69_ < 64; i_69_++) {
					...
					if (i_72_ < 0)
						...
						i_72_ = 255;
					int i_73_ = i_72_ / 2;
					is_64_[i_67_ + i_69_] = is_64_[i_67_
							+ i_71_] = is_64_[i_68_ + i_69_] = is_64_[i_68_ + i_71_] = ~0xffffff | i_72_ << 16;
					is[i_67_ + i_69_] = is[i_67_
							+ i_71_] = is[i_68_ + i_69_] = is[i_68_ + i_71_] = 127 - i_73_ << 24 | 0xffffff;
				}
			}
	...
	Class182(int i, int i_74_, int i_75_, int i_76_, int i_77_, int i_78_, int i_79_, boolean bool, int i_80_,
			int i_81_, int i_82_) {
		anInt2172 = i_75_;
		anInt2161 = i_76_;
		anInt2165 = i_77_;
	...
	public final boolean method1833(GraphicsToolkit graphicstoolkit, Class182 class182_0_) {
	...
	private final void method1835(GraphicsToolkit graphicstoolkit, Class182 class182_14_) {
		...
		graphicstoolkit.ZA(16777215, 1.0F, 1.0F, i, i_15_, i_16_);
	...
	private final void method1837(GraphicsToolkit graphicstoolkit, Class182 class182_26_) {
		...
		if (model != null) {
			...
			graphicstoolkit.xa(1.0F);
			graphicstoolkit.ZA(anInt2171, 1.0F, 1.0F, i, i_27_, i_28_);
	...
	public final void method1838(GraphicsToolkit graphicstoolkit, int i, int i_41_, int i_42_, int i_43_, int i_44_, int i_45_,
			int i_46_, int i_47_, int i_48_, int i_49_) {
	...
	public final boolean method1839(int i, int i_55_, int i_56_, int i_57_) {
		int i_58_;
		int i_59_;
		int i_60_;
		if (!aBoolean2173) {
			...
			anInt2166 = (int) Math.sqrt(i_58_ * i_58_ + i_59_ * i_59_ + i_60_ * i_60_);
			if (anInt2166 == 0)
				anInt2166 = 1;
		...
		int i_61_ = (int) (Math.sqrt(i_58_ * i_58_ + i_59_ * i_59_ + i_60_ * i_60_) * 256.0);
		if (i_61_ > 128) {
		...
		if (i_62_ != anInt2177)
			anInt2177 = i_62_;
		anInt2179 = (int) (Math.asin(i_59_ / 256.0F) * 2607.5945876176133) & 0x3fff;
		anInt2163 = (int) (Math.atan2(i_58_, -i_60_) * 2607.5945876176133) & 0x3fff;
		aGLSprite2176 = null;
		return true;
	}
