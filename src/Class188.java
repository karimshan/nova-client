...
abstract class Class188 {
	public static Class124 aClass124_2291 = new Class124(12);
	public static OutgoingPacket aClass318_2279 = new OutgoingPacket(74, -1);
	...
	public final void method1884(int i, byte b, int i_0_, int i_1_) {
		anInt2283++;
		int[] is = new int[i_1_];
		int[] is_2_ = new int[i];
	...
	private final void method1885(byte b) {
		...
		for (int i_43_ = 0; (i_43_ ^ 0xffffffff) > (anInt2282 ^ 0xffffffff); i_43_++)
			aShortArray2284[i_43_] = (short) (int) Math.pow(2.0, i_43_);
	}
	...
	private final void method1888(byte b) {
		anInt2288++;
		Random random = new Random(anInt2289);
		for (int i = 0; i < 255; i++)
