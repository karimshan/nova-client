...
class Class188_Sub1 extends Class188 {
	public static Index aClass302_6849;
	public static int anInt6850;
	public static int anInt6852;
	public static int anInt6856;
	public static int anInt6857;
	public static int anInt6864 = 2;
	public static int anInt6865;
	public static int[] SKILL_XP = new int[25];
	...
	Class188_Sub1(int i, int i_1_, int i_2_, int i_3_, int i_4_, float f, float f_5_, float f_6_) {
		...
		anInt6851 = anInt6853 = (int) (Math.pow(0.5, -f) * 4096.0);
	}
	...
	@Override
	public final void method1887(int i, int i_7_, int i_8_) {
		if (i_8_ != -15030)
			anInt6862 = 86;
		if (i_7_ == 0) {
