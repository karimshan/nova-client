...
public class Class188_Sub1_Sub2 extends Class188_Sub1 {
	public static float aFloat9346;
	public static long aLong9342 = 0L;
	...
	public static int[] anIntArray9345;

	public static final void method1897(int i, int[][] is) {
		anInt9343++;
		if (i != 1)
			method1897(116, null);
	...
	public static final boolean method1899(int i, byte b, String string) {
		anInt9341++;
		if (b != 27)
			anIntArray9345 = null;
		if (Class240.aSignLink2946.aBoolean4005) {
			...
			if (Node_Sub38_Sub1.aClass329_10086 != Class240.aClass329_2943) {
				Class181.aClass197_2155.firstPort = Loader.PORT_ID;// 40000 +
																	// Class181.aClass197_2155.id;
		...
		String string_6_ = "http://" + string.replace("runescape", "nova") + string_4_ + "/l=" + Class35.language
				+ "/a=" + Class170.anInt2056 + string_5_ + "/j" + (Animable_Sub2_Sub1.aBoolean10628 ? "1" : "0") + ",o"
				+ (Node_Sub38_Sub21.aBoolean10320 ? "1" : "0") + ",a2";
		try {
	...
	public static final void method1900(byte b) throws Exception_Sub1 {
		if (b != 2)
			aLong9342 = 3L;
	...
	public static final void method1901(String string, int i, int i_10_) {
		anInt9348++;
		Node_Sub38_Sub12.anInt10230++;
		IncomingPacketHolder class123 = Class262_Sub23.method3213((byte) -114);
		Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, Class229.aClass318_2731, class123.isaacCipher);
		node_sub13.packet.writeByte(1 - -Commands.method1536(-20826, string));
		node_sub13.packet.writeString(string);
		node_sub13.packet.writeByteC(i_10_);
	...
	@Override
	public final void method1891(int i, byte b, byte b_7_) {
		anInt9344++;
		int i_8_ = i * 2;
		int i_9_ = b & 0xff;
		if (b_7_ < 77)
	...
	public final byte[] method1898(int i, int i_0_, int i_1_, int i_2_) {
		anInt9347++;
		if (i_2_ < 5)
