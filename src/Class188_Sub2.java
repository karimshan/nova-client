...
class Class188_Sub2 extends Class188 {
	public static boolean aBoolean6868 = false;
	public static Class68 aClass68_6875 = new Class68(1);
	...
	public static int[] anIntArray6877 = { 0, 4, 3, 3, 1, 1, 3, 5, 1, 5, 3, 6, 4 };

	public static final void method1903(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_) {
		anInt6866++;
		int i_7_ = 0;
		int i_8_ = i_2_;
		int i_9_ = 0;
	...
	Class188_Sub2(int i, int i_44_, int i_45_, int i_46_, int i_47_, float f) {
		...
		for (int i_48_ = 0; (anInt2282 ^ 0xffffffff) < (i_48_ ^ 0xffffffff); i_48_++)
			anIntArray6874[i_48_] = (short) (int) (Math.pow(f, i_48_) * 4096.0);
	}

	@Override
	public final void method1886(int i) {
		if (i != 4096)
			anInt6878 = -80;
	...
	@Override
	public final void method1887(int i, int i_49_, int i_50_) {
		if (i_50_ != -15030)
			method1904(false);
	...
	@Override
	public final void method1890(int i) {
		anInt6878 = i;
		anInt6873++;
		anInt6871 = 0;
	}
