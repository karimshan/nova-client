...
public class Class188_Sub2_Sub2 extends Class188_Sub2 {
	public static Index aClass302_9361;
	public static Class36 aClass36_9366;
	public static int anInt9359;
	public static int anInt9360;
	public static int anInt9363;
	public static int anInt9364;
	public static int anInt9365;

	public static final boolean method1911(int i, int i_0_) {
		if (i_0_ != 2)
			aClass302_9361 = null;
		anInt9363++;
		if (i != 0 && i != 2)
	...
	public static final String method1914(String string, int i) {
		anInt9359++;
	...
	@Override
	public final void method1905(byte b, int i, byte b_1_) {
		if (b != -11)
	...
	public final byte[] method1913(int i, int i_3_, int i_4_, int i_5_) {
		if (i != 0)
			method1914(null, -41);
		anInt9364++;
