...
abstract class Class189 {
	...
	public static OutgoingPacket aClass318_2295;
	...
	public static boolean DEBUG_GLOBAL_PLAYER_UPDATE = false;
	static {
		aClass318_2295 = new OutgoingPacket(18, 8);
	}

	public static final short[] method1916(byte b, int i, short[] ses) {
		anInt2293++;
	...
	public static final void method1925() {
		for (int i = 0; i < Class188_Sub1_Sub1.anInt9337; i++)
			if (!Class147.aBooleanArray1820[i]) {
				...
				if (i_9_ >= GameMessage.anInt7623)
					i_9_ = GameMessage.anInt7623 - 1;
				for (int i_10_ = i_8_; i_10_ <= i_9_; i_10_++) {
					...
					for (int i_16_ = i_14_; i_16_ <= i_15_; i_16_++) {
						int i_17_ = 1;
						Mobile mobile = Class262_Sub20.method3203(i_3_, i_16_, i_10_,
								aClass2325 == null ? aClass2325 = method1935("Mobile") : aClass2325);
	...
	public static final void method1933(int i) {
		anInt2309++;
		if (Class96.mainGameApplet != null) {
			if (i != -9014)
				method1916((byte) 46, -36, null);
			try {
				String string = Class96.mainGameApplet.getParameter("cookiehost");
				int i_33_ = -11745 + (int) (Class313.method3650(false) / 86400000L);
				String string_34_ = "usrdob=" + i_33_ + "; version=1; path=/; domain=" + string;
				Class2.method168("document.cookie=\"" + string_34_ + "\"", Class96.mainGameApplet, 30639);
	...
	public static final void method1934(byte b) {
		if (b != 17)
			aClass318_2295 = null;
		anInt2300++;
	...
	private final Node_Sub25 method1915(byte b) throws IOException {
		...
		if (!anOggPage2294.isBOS()) {
			Node_Sub25 node_sub25 = (Node_Sub25) aHashTable2298.getNode(3512, i);
		...
		aHashTable2298.put(i, node_sub25, -123);
		return node_sub25;
	}

	public final void method1917(boolean bool, int i) {
	...
	private final boolean method1919(int i) {
		...
		if (i <= 124)
			method1927(98);
		if (aNode_Sub25_Sub1_2310 != null) {
			if (aNode_Sub25_Sub3_2316.method2677((byte) 85)
					&& !(method1928(124) > aNode_Sub25_Sub3_2316.method2676(94)))
				return false;
			return true;
		}
		double d = aNode_Sub25_Sub3_2316.method2667(0);
		if (d != 0.0 && !(Class313.method3650(false) >= 1000.0 / d + aNode_Sub25_Sub3_2316.method2675(-3744)))
			return false;
		return true;
	}

	public final boolean method1920(int i) {
		anInt2320++;
		if (i > -76)
			return false;
	...
	public final Node_Sub25_Sub4 method1921(int i) {
		anInt2319++;
		if (i != 3455)
			method1920(53);
	...
	public final void method1922(boolean bool) throws IOException {
		if (bool != false)
			method1932(110);
		anInt2313++;
		if (!aBoolean2304)
			while (!aBoolean2299) {
				...
				if (!aBoolean2301) {
					...
					node_sub25 = (Node_Sub25) aHashTable2298.getNode(3512, anOggPage2294.getSerialNumber());
	...
	private final void method1923(byte b) {
		anInt2303++;
		for (Node_Sub25 node_sub25 = (Node_Sub25) aHashTable2298
				.method1516(false); node_sub25 != null; node_sub25 = (Node_Sub25) aHashTable2298.method1520(74))
			if (node_sub25 instanceof Node_Sub25_Sub4) {
				Node_Sub25_Sub4 node_sub25_sub4 = (Node_Sub25_Sub4) node_sub25;
				while (node_sub25_sub4.anInt7234 <= 8 || method1928(116) > node_sub25_sub4.method2683(-96)) {
	...
	public final void method1924(byte b) {
		anInt2306++;
		if (!aBoolean2299) {
			for (Node_Sub25 node_sub25 = (Node_Sub25) aHashTable2298
					.method1516(false); node_sub25 != null; node_sub25 = (Node_Sub25) aHashTable2298.method1520(121)) {
	...
	public final void method1926(int i, String string) {
		aString2321 = string;
		anInt2305++;
		if (aString2321 == null)
			...
			if (aNode_Sub25_Sub4_2297 == null)
				for (Node_Sub25 node_sub25 = (Node_Sub25) aHashTable2298.method1516(
						false); node_sub25 != null; node_sub25 = (Node_Sub25) aHashTable2298.method1520(121))
					if (node_sub25 instanceof Node_Sub25_Sub4) {
						Node_Sub25_Sub4 node_sub25_sub4 = (Node_Sub25_Sub4) node_sub25;
	...
	public final double method1928(int i) {
		if (i <= 91)
			method1927(-37);
		anInt2311++;
		if (aNode_Sub25_Sub1_2310 != null)
	...
	public final Node_Sub25_Sub3 method1930(byte b) {
		anInt2302++;
	...
	private final void method1931(byte b) {
		for (Node_Sub25 node_sub25 = (Node_Sub25) aHashTable2298
				.method1516(false); node_sub25 != null; node_sub25 = (Node_Sub25) aHashTable2298.method1520(106))
	...
	public final Node_Sub25_Sub1 method1932(int i) {
		anInt2317++;
