...
public class Class189_Sub1 extends Class189 {
	public static Class257 aClass257_6882 = new Class257(8, 7);
	public static Class329 aClass329_6887 = new Class329("WTRC", "office", "_rc", 1);
	...
	@Override
	public final int method1929(byte[] bs, int i) throws IOException {
		anInt6885++;
		if (anIntArray6886 == null) {
			if (!index36.requestDownload(0, anInt6881, 0))
				return 0;
	...
	public final void method1937(int i) {
		anInt6879++;
		if (anIntArray6886 != null) {
			for (int i_1_ = 0; i_1_ < 10; i_1_++) {
				if ((i_1_ + anInt6888 ^ 0xffffffff) <= (anIntArray6886.length ^ 0xffffffff))
					break;
				if (aByteArrayArray6884[i_1_] == null && index36.requestDownload(0, anIntArray6886[anInt6888 - -i_1_], 0))
