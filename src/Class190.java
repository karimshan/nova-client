...
public class Class190 {
	public static boolean[] aBooleanArray2326 = new boolean[100];
	public static Class299 aClass299_2330;
	...
	public static int[] anIntArray2328;

	public static final int method1938(int i, int i_0_) {
		anInt2336++;
		if (i_0_ != 128)
			method1940(-126);
		return i >>> 8;
	...
	public static final int method1939(int[] is, int i, int i_1_, int[] is_2_, int i_3_, byte[][] bs, byte[] bs_4_,
			byte[][] bs_5_) {
		anInt2334++;
		int i_6_ = is[i_3_];
	...
	public static final int method1940(int i) {
		if (i != 255)
	...
	public final Class190 method1941(boolean bool) {
		if (bool != true)
			method1941(true);
		anInt2340++;
	...
	public final void method1943(byte b, Class190 class190_19_) {
