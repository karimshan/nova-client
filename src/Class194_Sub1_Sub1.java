...
public class Class194_Sub1_Sub1 extends Class194_Sub1 {
	public static Class124 aClass124_9368 = new Class124(20);
	public static Class212 aClass212_9369;
	public static int anInt9367;
	public static int[] anIntArray9370 = new int[250];
	...
	public static final void method1969(boolean bool, Class261[][][] class261s) {
		anInt9367++;
		if (bool != false)
			anIntArray9370 = null;
		for (Class261[][] class261s_0_ : class261s) {
			for (Class261[] element : class261s_0_)
				for (int i_2_ = 0; (i_2_ ^ 0xffffffff) > (element.length ^ 0xffffffff); i_2_++) {
					Class261 class261 = element[i_2_];
					if (class261 != null) {
