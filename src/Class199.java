...
public class Class199 {
	...
	public static final int method2006(byte b) {
		anInt2431++;
		int i = 0;
		...
		for (Field field : fields_1_) {
			if ((aClass2438 == null ? aClass2438 = method2011("Class320") : aClass2438)
	...
	public static final void method2007(int i, byte[] bs, int i_3_, int i_4_, int i_5_, byte b) {
		anInt2434++;
	...
	public static final void method2009(int i, Class312 class312, int i_11_, GraphicsToolkit graphicstoolkit, int i_12_) {
		if (i != -9404)
			method2006((byte) -16);
		Node_Sub43.aClass312_7541.method3614(i + 8803);
		anInt2436++;
		if (!ClientScript.aBoolean9510)
			for (Node_Sub14 node_sub14 = (Node_Sub14) class312
					.method3613(65280); node_sub14 != null; node_sub14 = (Node_Sub14) class312.method3620(16776960)) {
	...
	public static final void method2010(byte b) {
		if (b > 117) {
			Class23.anInt434 = 0;
			anInt2433++;
	...
	public final void method2008(Class206 class206, int i, int i_6_) {
		anInt2432++;
