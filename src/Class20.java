...
class Class20 {
	...
	public static byte[][][] aByteArrayArrayArray332;
	public static CacheNode_Sub11 aCacheNode_Sub11_318;
	private static Class103[][][] aClass103ArrayArrayArray353;
	public static Class112 aClass112_319;
	public static Class215 aClass215_322;
	public static Class224 aClass224_330;
	public static Index aClass302_314;
	public static Class312 aClass312_331;
	public static Class338 aClass338_315;
	private static Class58 aClass58_321;
	private static Class71 aClass71_320;
	public static float aFloat327;
	public static float aFloat329;
	...
	public static Interface17 anInterface17_317;
	...
	public static final CacheNode_Sub11 method269(int i) {
		return (CacheNode_Sub11) aHashTable316.getNode(3512, i);
	}

	public static final void method270(GraphicsToolkit graphicstoolkit) {
	...
	private static final void method271(GraphicsToolkit graphicstoolkit, int i, int i_3_, int i_4_, int i_5_, int i_6_,
			int i_7_, int i_8_, int[] ses, byte[] bs, boolean bool) {
		if (bool || i_6_ != 0 || i_7_ > 0)
			if (i_7_ == 0)
				...
				if (i_9_ == 0 || i_4_ <= 1 || i_5_ <= 1) {
					...
					int i_11_ = bool ? 0 : 1;
					Class117_Sub2.method1174(i_5_, aByteArrayArrayArray332, anIntArray342[i_7_], i_4_, anInt328, i,
							graphicstoolkit, i_11_, i_8_ >> 6 & 0x3, (byte) -122, i_3_, i_6_, i_9_);
				}
			}
		if (ses != null) {
			int i_12_;
	...
	public static final void method272(int i, int i_20_, int i_21_, int i_22_, int i_23_, int i_24_, int i_25_, int i_26_) {
		anInt349 = i - anInt354;
	...
	private static final void method273(GraphicsToolkit graphicstoolkit, int i, int i_27_, int i_28_, int i_29_,
			int[] ses, byte[] bs) {
		if (ses != null)
			for (int i_30_ = 0; i_30_ < ses.length; i_30_++) {
				...
				if (i_31_ != -1) {
					...
					GLSprite glsprite = class140.method1606(objectdefinition.aBoolean3056 ? bs[i_30_] >> 6 & 0x3 : 0,
							graphicstoolkit, objectdefinition.aBoolean3007 ? objectdefinition.aBoolean3039 : false, 0);
					if (glsprite != null) {
						...
						if (i_32_ != 0 && i_33_ != 0)
							if (class140.anInt1737 != 0)
								glsprite.method1199(i, i_27_ - i_33_ + i_29_, i_32_, i_33_, 0,
										~0xffffff | class140.anInt1737, 1);
							else
				...
				for (int i_54_ = -5; i_54_ < anInt333; i_54_++) {
					...
					if (i_54_ >= 0 && i_53_ > 0)
						if ((bs[i_43_ + i_54_ * anInt345] & 0xff) == 0) {
							...
							int i_58_ = i_52_ == 0 ? 0
									: Node_Sub25.method2651(i_51_ / i_53_, i_50_ / i_53_, false, i_49_ * 256 / i_52_);
							...
							int i_62_ = Class170.anIntArray2054[Node_Sub15_Sub2.method2560(5310,
									Class194_Sub1.method1964(96, -14042, i_60_)) & 0xffff];
	...
	public static final void method275(Index class302, Class71 class71, Class58 class58, Class112 class112, Class215 class215,
			Class338 class338, Interface17 interface17) {
		...
		if (is != null)
			for (int element : is) {
				CacheNode_Sub11 cachenode_sub11 = Class274.method3323(aClass302_314, i, element, 0);
				aHashTable316.put(cachenode_sub11.anInt9546, cachenode_sub11, -123);
			}
		LoadingBarStage.method1132(0, false, true);
	}
					...
					for (int i_79_ = 0; i_79_ < i_68_; i_79_++) {
						...
						if (i_82_ > 0) {
							...
							if (i_85_ == 0 && i_86_ == 0 && i_87_ == 0) {
								...
								if (i_87_ == 65535) {
									Node_Sub17 node_sub17 = (Node_Sub17) aHashTable347.getNode(3512,
											i_73_ << 16 | i_83_);
									if (node_sub17 != null)
										method271(graphicstoolkit, i_70_, i_80_, i_72_, i_82_, i_85_, i_86_,
												aByteArray346[i_84_], node_sub17.aShortArray7148,
												node_sub17.aByteArray7147, true);
								} else {
									aShortArray326[0] = (short) (i_87_ - 1);
									aByteArray325[0] = aByteArray340[i_84_];
									method271(graphicstoolkit, i_70_, i_80_, i_72_, i_82_, i_85_, i_86_,
											aByteArray346[i_84_], aShortArray326, aByteArray325, true);
								}
							} else
								method271(graphicstoolkit, i_70_, i_80_, i_72_, i_82_, i_85_, i_86_,
										aByteArray346[i_84_], null, null, true);
						}
					}
			}
		}
								...
								if (i_98_ > 0) {
									if (i_98_ == 65535) {
										Node_Sub17 node_sub17 = (Node_Sub17) aHashTable347.getNode(3512,
												i_92_ << 16 | i_97_);
										if (node_sub17 != null)
											method273(graphicstoolkit, i_89_, i_94_, i_91_, i_96_,
													node_sub17.aShortArray7148, node_sub17.aByteArray7147);
									} else {
										aShortArray326[0] = (short) (i_98_ - 1);
										aByteArray325[0] = aByteArray340[i_92_ + i_97_ * anInt345];
										method273(graphicstoolkit, i_89_, i_94_, i_91_, i_96_, aShortArray326,
												aByteArray325);
									}
								} else
			...
			for (int i_104_ = i_99_; i_104_ <= i_101_; i_104_++)
				for (int i_105_ = i_100_; i_105_ <= i_102_; i_105_++) {
					...
					if (class103 != null) {
						...
						for (EntityNode_Sub9 entitynode_sub9 = (EntityNode_Sub9) class103.method1113(
								(byte) -118); entitynode_sub9 != null; entitynode_sub9 = (EntityNode_Sub9) class103
										.method1108(106)) {
							...
							method271(graphicstoolkit, i_110_, i_112_, i_111_ - i_110_, i_113_ - i_112_,
									entitynode_sub9.anInt6027, entitynode_sub9.aByte6028 & 0xff,
									entitynode_sub9.aByte6026, entitynode_sub9.aShortArray6025,
									entitynode_sub9.aByteArray6030, false);
						}
					}
				}
			for (int i_114_ = i_99_; i_114_ <= i_101_; i_114_++)
				for (int i_115_ = i_100_; i_115_ <= i_102_; i_115_++) {
					...
					if (class103 != null) {
						...
						for (EntityNode_Sub9 entitynode_sub9 = (EntityNode_Sub9) class103.method1113(
								(byte) 127); entitynode_sub9 != null; entitynode_sub9 = (EntityNode_Sub9) class103
										.method1108(94)) {
							...
							method273(graphicstoolkit, i_120_, i_122_, i_121_ - i_120_, i_123_ - i_122_,
									entitynode_sub9.aShortArray6025, entitynode_sub9.aByteArray6030);
						}
					}
				}
		}
	...
	public static final void method277(d var_d, int i, int i_124_) {
	...
	private static final int method278(d var_d, int i, int i_126_, int i_127_) {
		...
		if (class289.anInt3629 >= 0) {
			...
			i_129_ = ~0xffffff
					| Class170.anIntArray2054[Node_Sub15_Sub2.method2560(5310, Class113.method1148(true, 96, i_132_))
							& 0xffff];
		} else if (i_128_ >= 0)
			i_129_ = ~0xffffff | Class170.anIntArray2054[Node_Sub15_Sub2.method2560(5310,
					Class113.method1148(true, 96, var_d.method10(i_128_, -8217).aShort1221)) & 0xffff];
			...
			i_129_ = ~0xffffff
					| Class170.anIntArray2054[Node_Sub15_Sub2.method2560(5310, Class113.method1148(true, 96, i_135_))
							& 0xffff];
		}
		return i_129_;
	}
	...
	public static final void method281(GraphicsToolkit graphicstoolkit, Node_Sub14 node_sub14, Class79 class79) {
		if (class79.anIntArray1049 != null) {
			...
			if (class79.anInt1074 > 0) {
				for (int i = 0; i < is.length / 2 - 1; i++) {
					...
					graphicstoolkit.a(i_138_, i_139_, i_140_, i_141_,
							class79.anIntArray1066[class79.aByteArray1057[i] & 0xff], 1, class79.anInt1074,
							class79.anInt1050, class79.anInt1080);
				}
				...
				graphicstoolkit.a(i, i_145_, i_146_, i_147_,
						class79.anIntArray1066[class79.aByteArray1057[class79.aByteArray1057.length - 1] & 0xff], 1,
						class79.anInt1074, class79.anInt1050, class79.anInt1080);
			} else {
				for (int i = 0; i < is.length / 2 - 1; i++)
					graphicstoolkit.method1236(is[(i + 1) * 2 + 1], is[i * 2 + 1], is[(i + 1) * 2],
							class79.anIntArray1066[class79.aByteArray1057[i] & 0xff], 1, is[i * 2]);
				graphicstoolkit.method1236(is[1], is[is.length - 1], is[0],
						class79.anIntArray1066[class79.aByteArray1057[class79.aByteArray1057.length - 1] & 0xff], 1,
						is[is.length - 2]);
			}
		}
	...
	public static final void method282(int i) {
		aCacheNode_Sub11_318 = (CacheNode_Sub11) aHashTable316.getNode(3512, i);
	}

	private static final void method283(GraphicsToolkit graphicstoolkit, Node_Sub14 node_sub14, int i, int i_151_,
	...
	private static final void method284(GraphicsToolkit graphicstoolkit, BufferedStream buffer, int i, int i_154_,
			int i_155_, int i_156_, int[] is, int[] is_157_) {
		...
		if ((i_158_ & 0x1) == 0) {
			...
			for (int i_162_ = 0; i_162_ < i_160_; i_162_++) {
				...
				if (i_162_ == 0) {
					...
					if (i_166_ == 1) {
						aShortArray334[v >= 0 ? v : 0] = buffer.readBigSmart();// (short)
						...
						for (int i_167_ = 0; i_167_ < i_166_; i_167_++) {
							ses[i_167_] = buffer.readBigSmart();// (short)
																// buffer.readUnsignedShort();
							bs[i_167_] = buffer.readByte();
						}
						aHashTable347.put(i_155_ << 16 | i_156_, new Node_Sub17(ses, bs), -123);
					}
				} else {
					int[] ses = null;
					byte[] bs = null;
					if (i_166_ > 0) {
						...
						for (int i_168_ = 0; i_168_ < i_166_; i_168_++) {
							ses[i_168_] = buffer.readBigSmart();// (short)
																// buffer.readUnsignedShort();
							bs[i_168_] = buffer.readByte();
						}
					}
					if (i_162_ - 1 >= 0 && i - (anInt354 >> 6) >= 0 && i_154_ - (anInt343 >> 6) >= 0) {
						if (aClass103ArrayArrayArray353[i_162_ - 1][i - (anInt354 >> 6)][i_154_
								- (anInt343 >> 6)] == null)
							aClass103ArrayArrayArray353[i_162_ - 1][i - (anInt354 >> 6)][i_154_
									- (anInt343 >> 6)] = new Class103();
						EntityNode_Sub9 entitynode_sub9 = new EntityNode_Sub9(i_155_ & 0x3f, i_156_ & 0x3f, i_163_,
								i_164_, i_165_, ses, bs);
						aClass103ArrayArrayArray353[i_162_ - 1][i - (anInt354 >> 6)][i_154_ - (anInt343 >> 6)]
	...
	private static final void method285() {
		for (int i = 0; i < anInt345; i++)
			for (int i_169_ = 0; i_169_ < anInt333; i_169_++) {
				...
				if (i_170_ != 0)
					if (i_170_ == 65535) {
						Node_Sub17 node_sub17 = (Node_Sub17) aHashTable347.getNode(3512, i << 16 | i_169_);
						if (node_sub17 != null)
							for (int element : node_sub17.aShortArray7148) {
								ObjectDefinition objectdefinition = aClass112_319.method1145(element & 0xffff, 115);
		...
		for (int i = 0; i < 3; i++)
			for (int i_174_ = 0; i_174_ < aClass103ArrayArrayArray353[0].length; i_174_++)
				for (int i_175_ = 0; i_175_ < aClass103ArrayArrayArray353[0][0].length; i_175_++) {
					...
					if (class103 != null)
						for (EntityNode_Sub9 entitynode_sub9 = (EntityNode_Sub9) class103.method1113(
								(byte) -44); entitynode_sub9 != null; entitynode_sub9 = (EntityNode_Sub9) class103
										.method1108(124))
							if (entitynode_sub9.aShortArray6025 != null)
								for (int element : entitynode_sub9.aShortArray6025) {
									ObjectDefinition objectdefinition = aClass112_319.method1145(element & 0xffff, 126);
									...
									if (i_177_ != -1) {
										...
										node_sub14.anInt7125 = (i_174_ + (anInt354 >> 6)) * 64
												+ entitynode_sub9.aByte6029 - anInt354;
										node_sub14.anInt7120 = (i_175_ + (anInt343 >> 6)) * 64
												+ entitynode_sub9.aByte6031 - anInt343;
										aClass312_331.method3625((byte) -54, node_sub14);
									}
								}
				}
	...
	public static final Class158 method286(int i, int i_178_) {
		Class158 class158 = new Class158();
		for (CacheNode_Sub11 cachenode_sub11 = (CacheNode_Sub11) aHashTable316.method1516(
				false); cachenode_sub11 != null; cachenode_sub11 = (CacheNode_Sub11) aHashTable316.method1520(101))
	...
	public static final CacheNode_Sub11 method288(int i, int i_179_) {
		for (CacheNode_Sub11 cachenode_sub11 = (CacheNode_Sub11) aHashTable316.method1516(
				false); cachenode_sub11 != null; cachenode_sub11 = (CacheNode_Sub11) aHashTable316.method1520(115))
	...
	public static final void method289() {
		...
		for (int i = 0; i < aClass224_330.anInt2670; i++) {
			boolean bool = aCacheNode_Sub11_318.method2337(-12584, is, aClass224_330.anIntArray2668[i] & 0x3fff,
					aClass224_330.anIntArray2668[i] >> 28 & 0x3, aClass224_330.anIntArray2668[i] >> 14 & 0x3fff);
			if (bool) {
	...
	public static final void method290(GraphicsToolkit graphicstoolkit, int i, int i_180_) {
		BufferedStream buffer = new BufferedStream(
				aClass302_314.method3529(aCacheNode_Sub11_318.aString9537, "area", 1));
		...
		for (int i_200_ = 0; i_200_ < 3; i_200_++) {
			...
			for (int i_201_ = 0; i_201_ < aClass103ArrayArrayArray353[i_200_].length; i_201_++)
				for (int i_202_ = 0; i_202_ < aClass103ArrayArrayArray353[i_200_][0].length; i_202_++) {
					...
					if (class103 != null)
						for (EntityNode_Sub9 entitynode_sub9 = (EntityNode_Sub9) class103.method1113(
								(byte) 98); entitynode_sub9 != null; entitynode_sub9 = (EntityNode_Sub9) class103
										.method1108(117))
							bs[i_201_ * 64 + entitynode_sub9.aByte6029 + (i_202_ * 64 + entitynode_sub9.aByte6031)
									* anInt345] = (byte) entitynode_sub9.anInt6027;
				}
			...
			for (int i_203_ = 0; i_203_ < aClass103ArrayArrayArray353[i_200_].length; i_203_++)
				for (int i_204_ = 0; i_204_ < aClass103ArrayArrayArray353[i_200_][0].length; i_204_++) {
					...
					if (class103 != null)
						for (EntityNode_Sub9 entitynode_sub9 = (EntityNode_Sub9) class103.method1113(
								(byte) 124); entitynode_sub9 != null; entitynode_sub9 = (EntityNode_Sub9) class103
										.method1108(109)) {
							int i_205_ = i_203_ * 64 + entitynode_sub9.aByte6029
									+ (i_204_ * 64 + entitynode_sub9.aByte6031) * anInt345;
							entitynode_sub9.anInt6027 = (aByteArray335[i_205_] & 0xff) << 16
									| aShortArray338[i_205_] & 0xffff;
	...
	public static final Class312 method291(GraphicsToolkit graphicstoolkit) {
		int i = anInt341 - anInt349;
	...
	private static final Class312 method292(GraphicsToolkit graphicstoolkit, int i, int i_209_, int i_210_,
			int i_211_) {
		for (Node_Sub14 node_sub14 = (Node_Sub14) aClass312_331
				.method3613(65280); node_sub14 != null; node_sub14 = (Node_Sub14) aClass312_331.method3620(16776960))
