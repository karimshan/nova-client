...
public class Class200_Sub1 extends Class200 implements Interface9 {
	public static Class135 aClass135_5139 = new Class135();
	public static float aFloat5140;
	...
	public static int anInt5146 = 1337;

	public static final void method2013(byte b, int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_,
			int i_7_) {
	...
	public static final int method2014(int i, int i_33_) {
		anInt5136++;
		if (i != -30444)
			anInt5145 = -44;
		return i_33_ >>> 8;
	...
	public static final boolean method2015(int i, int i_34_, int i_35_, Class84 class84, int i_36_, int i_37_, int i_38_,
		...
		while (i_50_ != i_49_) {
									...
									if (i_53_ != -3) {
										if (i_53_ != -2) {
											if ((i_53_ ^ 0xffffffff) != 0) {
												if ((i_53_ ^ 0xffffffff) == -1 || (i_53_ ^ 0xffffffff) == -2
														|| (i_53_ ^ 0xffffffff) == -3 || (i_53_ ^ 0xffffffff) == -4
														|| i_53_ == 9)
													break while_94_;
												break while_95_;
											}
			...
			if ((i_45_ ^ 0xffffffff) < -1 && Node_Sub36_Sub2.anIntArrayArray10047[i_45_ - 1][i_46_] == 0
					&& (is[i_52_ + -1][i_51_] & 0x42240000 ^ 0xffffffff) == -1) {
			...
			if ((i_45_ ^ 0xffffffff) > -128 && Node_Sub36_Sub2.anIntArrayArray10047[i_45_ - -1][i_46_] == 0
					&& (is[i_52_ - -1][i_51_] & 0x60240000 ^ 0xffffffff) == -1) {
				Node_Sub39.routeFinderXArray[i_49_] = 1 + i_43_;
				Class339_Sub6.routeFinderYArray[i_49_] = i_44_;
				i_49_ = 0xfff & 1 + i_49_;
			...
			if ((i_46_ ^ 0xffffffff) < -1
					&& (Node_Sub36_Sub2.anIntArrayArray10047[i_45_][-1 + i_46_] ^ 0xffffffff) == -1
					&& (is[i_52_][i_51_ - 1] & 0x40a40000) == 0) {
				Node_Sub39.routeFinderXArray[i_49_] = i_43_;
			...
			if ((i_46_ ^ 0xffffffff) > -128 && Node_Sub36_Sub2.anIntArrayArray10047[i_45_][i_46_ + 1] == 0
					&& (is[i_52_][i_51_ - -1] & 0x48240000 ^ 0xffffffff) == -1) {
				Node_Sub39.routeFinderXArray[i_49_] = i_43_;
				Class339_Sub6.routeFinderYArray[i_49_] = i_44_ - -1;
			...
			if (i_45_ > 0 && (i_46_ ^ 0xffffffff) < -1
					&& Node_Sub36_Sub2.anIntArrayArray10047[-1 + i_45_][i_46_ + -1] == 0
					&& (is[-1 + i_52_][i_51_ + -1] & 0x43a40000 ^ 0xffffffff) == -1
					&& (0x42240000 & is[i_52_ + -1][i_51_] ^ 0xffffffff) == -1
					&& (is[i_52_][-1 + i_51_] & 0x40a40000) == 0) {
			...
			if ((i_45_ ^ 0xffffffff) > -128 && i_46_ > 0
					&& Node_Sub36_Sub2.anIntArrayArray10047[i_45_ + 1][-1 + i_46_] == 0
					&& (is[i_52_ - -1][i_51_ - 1] & 0x60e40000) == 0 && (is[1 + i_52_][i_51_] & 0x60240000) == 0
					&& (is[i_52_][-1 + i_51_] & 0x40a40000 ^ 0xffffffff) == -1) {
				Node_Sub39.routeFinderXArray[i_49_] = i_43_ - -1;
			...
			if ((i_45_ ^ 0xffffffff) < -1 && (i_46_ ^ 0xffffffff) > -128
					&& (Node_Sub36_Sub2.anIntArrayArray10047[-1 + i_45_][1 + i_46_] ^ 0xffffffff) == -1
					&& (0x4e240000 & is[-1 + i_52_][1 + i_51_]) == 0
					&& (is[-1 + i_52_][i_51_] & 0x42240000 ^ 0xffffffff) == -1
					&& (is[i_52_][i_51_ + 1] & 0x48240000 ^ 0xffffffff) == -1) {
				Node_Sub39.routeFinderXArray[i_49_] = -1 + i_43_;
				Class339_Sub6.routeFinderYArray[i_49_] = i_44_ + 1;
			...
			if (i_45_ < 127 && (i_46_ ^ 0xffffffff) > -128
					&& (Node_Sub36_Sub2.anIntArrayArray10047[1 + i_45_][i_46_ - -1] ^ 0xffffffff) == -1
					&& (is[1 + i_52_][i_51_ - -1] & 0x78240000) == 0
					&& (0x60240000 & is[i_52_ + 1][i_51_] ^ 0xffffffff) == -1
					&& (0x48240000 & is[i_52_][i_51_ + 1] ^ 0xffffffff) == -1) {
				Node_Sub39.routeFinderXArray[i_49_] = 1 + i_43_;
				Class339_Sub6.routeFinderYArray[i_49_] = i_44_ + 1;
	...
	public static final int method2017(int i, Index class302) {
		anInt5135++;
		int i_57_ = i;
		...
		if (class302.method3510(OutgoingPacket.anInt4045, (byte) 63))
			i_57_++;
		if (class302.method3510(LoadingBar.anInt2019, (byte) 63))
			i_57_++;
	...
	Class200_Sub1(GLToolkit gltoolkit, int i, Buffer buffer) {
