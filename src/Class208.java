...
public class Class208 {
	...
	public final void method2045(Component component, boolean bool) {
		if (bool)
			component = null;
	...
	public final void method2046(int i, int i_0_) {
		aRobot2481.mouseMove(i, i_0_);
	}

	public final void method2047(Component component, int[] is, int i, int i_1_, Point point) {
		if (is != null) {
