...
public class Class212 implements Interface8 {
	...
	public static int[] anIntArray5128;

	public static final void method2051(int i, int i_0_, int i_1_, int i_2_, byte b, int i_3_, byte[] bs) {
		anInt5132++;
	...
	public static final void method2053(int i, int i_20_, int i_21_, float[] fs, int i_22_, float f, float[] fs_23_, int i_24_,
			int i_25_, int i_26_, int i_27_) {
		i_20_ -= i_22_;
		anInt5131++;
		i_21_ -= i_27_;
		i_25_ -= i;
		float f_28_ = fs_23_[2] * i_20_ + (fs_23_[1] * i_21_ + fs_23_[0] * i_25_);
		float f_29_ = i_21_ * fs_23_[4] + fs_23_[3] * i_25_ + i_20_ * fs_23_[5];
		float f_30_ = fs_23_[8] * i_20_ + (fs_23_[7] * i_21_ + fs_23_[6] * i_25_);
		float f_31_ = (float) Math.sqrt(f_28_ * f_28_ + f_29_ * f_29_ + f_30_ * f_30_);
		if (i_26_ != -4)
			method2052(34);
		float f_32_ = (float) Math.atan2(f_28_, f_30_) / 6.2831855F + 0.5F;
		float f_33_ = (float) Math.asin(f_29_ / f_31_) / 3.1415927F + 0.5F + f;
		if (i_24_ != 1) {
			if (i_24_ == 2) {
				f_32_ = -f_32_;
				f_33_ = -f_33_;
	...
	public static final void method2054(byte b, int i, Actor actor, int i_36_, Actor actor_37_, int i_38_, int i_39_,
		...
		if ((i_43_ ^ 0xffffffff) != 0) {
			...
			Object object = null;
			if (b == -124) {
				GLSprite glsprite = (GLSprite) Class262_Sub18.aClass61_7842.method607(i_43_, 0);
				if (glsprite == null) {
					Class383[] class383s = Class383.method4187(Node_Sub38_Sub39.aClass302_10500, i_43_, 0);
					if (class383s == null)
						return;
					glsprite = Class93.graphicsToolkit.a(class383s[0], true);
					Class262_Sub18.aClass61_7842.method601(glsprite, 25566, i_43_);
				}
				Animable_Sub3.method919(actor.plane, 512, actor.anInt5940, 0, actor.anInt5934, false,
						actor.getSize((byte) 55) * 256);
				...
				if (actor_37_ == actor)
					Class93.graphicsToolkit.method1234(i_45_ - 1, -256, 18, 18, (byte) 93, -1 + i_44_);
