...
public class Class220 implements Interface14 {
	public static IncomingPacket aClass192_5321 = new IncomingPacket(102, -1);
	public static int anInt5320;
	public static int anInt5322;
	public static int anInt5323;

	public static final void method2097(int i) {
	...
	public static final boolean method2099(boolean bool, Class79 class79) {
		anInt5320++;
		if (class79 == null)
			return false;
		if (bool != true)
		...
		if (!class79.method784((byte) 111, Class20.anInterface17_317))
			return false;
		if (CacheNode_Sub10.aHashTable9530.getNode(3512, class79.anInt1055) != null)
			return false;
		if (IComponentDefinitions.aHashTable4827.getNode(3512, class79.anInt1067) != null)
			return false;
		return true;
	}
	...
	public final String method52(int i, long l, Class151 class151, int[] is) {
		...
		if (Class35.aClass151_535 == class151 || Class345.aClass151_4267 == class151
				|| Class150_Sub1.aClass151_8949 == class151)
