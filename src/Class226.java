...
public class Class226 {
	public static Class103 aClass103_2684 = new Class103();
	...
	public static final int method2112(int i) {
		if (i != 256)
			aClass103_2684 = null;
		anInt2690++;
	...
	public static final void method2113(int i) {
	...
	public static final void method2114(int i, int i_2_, int i_3_, int i_4_, int i_5_) {
		anInt2682++;
		for (int i_6_ = 0; i_6_ < Node_Sub11.anInt7105; i_6_++) {
			Rectangle rectangle = Node_Sub38_Sub28.aRectangleArray10404[i_6_];
			if (i < rectangle.x - -rectangle.width && (rectangle.x ^ 0xffffffff) > (i_3_ + i ^ 0xffffffff)
					&& (rectangle.height + rectangle.y ^ 0xffffffff) < (i_2_ ^ 0xffffffff)
					&& (rectangle.y ^ 0xffffffff) > (i_2_ + i_4_ ^ 0xffffffff))
	...
	public final boolean method2110(Class37 class37, byte b, Class48 class48, int i, int i_0_, int[] is) {
		anInt2692++;
		if (b > -79)
			anInt2688 = 37;
		if (!aBoolean2689) {
	...
	public final void method2115(byte b) {
		if (b > -82)
			anInt2685 = -78;
		anInt2691 = 0;
		anInt2686++;
