...
public class Class227 {
	...
	static {
		...
		for (int i = 0; i < 32768; i++)
			anIntArray2700[i] = (int) (Math.sin(i / 5215.1903) * 16384.0);
	...
	public final void method2116(BufferedStream buffer) {
	...
	public final int[] method2117(int i, int i_2_) {
		...
		if (aClass177_2703 != null) {
			...
			i_3_ = (int) ((aClass177_2703.anInt2111 - aClass177_2703.anInt2109) * 32.768 / d);
			i_4_ = (int) (aClass177_2703.anInt2109 * 32.768 / d);
		}
		int i_6_ = 0;
		int i_7_ = 0;
		int i_8_ = 0;
		if (aClass177_2710 != null) {
			...
			i_6_ = (int) ((aClass177_2710.anInt2111 - aClass177_2710.anInt2109) * 32.768 / d);
			i_7_ = (int) (aClass177_2710.anInt2109 * 32.768 / d);
		}
		for (int i_9_ = 0; i_9_ < 5; i_9_++)
			if (anIntArray2695[i_9_] != 0) {
				anIntArray2712[i_9_] = 0;
				anIntArray2716[i_9_] = (int) (anIntArray2701[i_9_] * d);
				anIntArray2717[i_9_] = (anIntArray2695[i_9_] << 14) / 100;
				anIntArray2711[i_9_] = (int) ((aClass177_2699.anInt2111 - aClass177_2699.anInt2109) * 32.768
						* Math.pow(1.0057929410678534, anIntArray2714[i_9_]) / d);
				anIntArray2713[i_9_] = (int) (aClass177_2699.anInt2109 * 32.768 / d);
			}
		for (int i_10_ = 0; i_10_ < i; i_10_++) {
			...
			for (int i_17_ = 0; i_17_ < 5; i_17_++)
				if (anIntArray2695[i_17_] != 0) {
					...
					if (i_18_ < i) {
						anIntArray2706[i_18_] += method2118(anIntArray2712[i_17_], i_12_ * anIntArray2717[i_17_] >> 15,
								aClass177_2699.anInt2112);
		...
		if (aClass177_2696 != null) {
			...
			for (int i_21_ = 0; i_21_ < i; i_21_++) {
				...
				int i_24_;
				if (bool_20_)
					i_24_ = aClass177_2696.anInt2109
							+ ((aClass177_2696.anInt2111 - aClass177_2696.anInt2109) * i_22_ >> 8);
				else
					i_24_ = aClass177_2696.anInt2109
							+ ((aClass177_2696.anInt2111 - aClass177_2696.anInt2109) * i_23_ >> 8);
				i_19_ += 256;
				if (i_19_ >= i_24_) {
					i_19_ = 0;
					bool_20_ = !bool_20_;
		...
		if (aClass196_2704.anIntArray2409[0] > 0 || aClass196_2704.anIntArray2409[1] > 0) {
			...
			int i_28_ = aClass196_2704.method1993(0, i_27_ / 65536.0F);
			int i_29_ = aClass196_2704.method1993(1, i_27_ / 65536.0F);
			if (i >= i_28_ + i_29_) {
				int i_30_ = 0;
				int i_31_ = i_29_;
				if (i_31_ > i - i_28_)
				...
				for (/**/; i_30_ < i_31_; i_30_++) {
					...
					for (int i_33_ = 0; i_33_ < i_28_; i_33_++)
						i_32_ += (int) ((long) anIntArray2706[i_30_ + i_28_ - 1 - i_33_]
								* (long) Class196.anIntArrayArray2411[0][i_33_] >> 16);
					for (int i_34_ = 0; i_34_ < i_30_; i_34_++)
						i_32_ -= (int) ((long) anIntArray2706[i_30_ - 1 - i_34_]
								* (long) Class196.anIntArrayArray2411[1][i_34_] >> 16);
				...
				for (;;) {
					...
					for (/**/; i_30_ < i_31_; i_30_++) {
						...
						for (int i_36_ = 0; i_36_ < i_28_; i_36_++)
							i_35_ += (int) ((long) anIntArray2706[i_30_ + i_28_ - 1 - i_36_]
									* (long) Class196.anIntArrayArray2411[0][i_36_] >> 16);
						for (int i_37_ = 0; i_37_ < i_29_; i_37_++)
							i_35_ -= (int) ((long) anIntArray2706[i_30_ - 1 - i_37_]
									* (long) Class196.anIntArrayArray2411[1][i_37_] >> 16);
						anIntArray2706[i_30_] = i_35_;
						i_27_ = aClass177_2708.method1809(i + 1);
					}
					if (i_30_ >= i - i_28_)
						break;
					i_28_ = aClass196_2704.method1993(0, i_27_ / 65536.0F);
					i_29_ = aClass196_2704.method1993(1, i_27_ / 65536.0F);
					i_31_ += 128;
				}
				for (/**/; i_30_ < i; i_30_++) {
					int i_38_ = 0;
					for (int i_39_ = i_30_ + i_28_ - i; i_39_ < i_28_; i_39_++)
						i_38_ += (int) ((long) anIntArray2706[i_30_ + i_28_ - 1 - i_39_]
								* (long) Class196.anIntArrayArray2411[0][i_39_] >> 16);
					for (int i_40_ = 0; i_40_ < i_29_; i_40_++)
						i_38_ -= (int) ((long) anIntArray2706[i_30_ - 1 - i_40_]
								* (long) Class196.anIntArrayArray2411[1][i_40_] >> 16);
