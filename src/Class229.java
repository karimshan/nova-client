...
public class Class229 {
	public static boolean aBoolean2725;
	public static Class270 aClass270_2733;
	public static OutgoingPacket aClass318_2731 = new OutgoingPacket(41, -1);
	public static Class329 aClass329_2730 = new Class329("WTWIP", "office", "_wip", 3);
	public static GraphicsToolkit aGraphicsToolkit2732;
	...
	public final void method2122(boolean bool) {
	...
	public final Class293 method2123(int i, int i_0_) {
		anInt2727++;
		Class293 class293;
		synchronized (aClass61_2726) {
			class293 = (Class293) aClass61_2726.method607(i_0_, 0);
		}
		if (class293 != null)
			return class293;
		byte[] bs;
		...
		synchronized (aClass61_2726) {
			aClass61_2726.method601(class293, 25566, i_0_);
		}
		return class293;
	}

	public final void method2125(byte b) {
		if (b != 95)
			method2124((byte) -56);
		anInt2729++;
		synchronized (aClass61_2726) {
	...
	public final void method2126(int i, byte b) {
		anInt2722++;
		if (b >= 71)
			synchronized (aClass61_2726) {
