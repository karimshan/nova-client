...
class Class230 implements Interface10 {
	public static boolean aBoolean5214;
	public static boolean aBoolean5217;
	public static Class42 aClass42_5208;
	...
	public static final void method2127(byte b, String string) {
		anInt5216++;
		System.exit(1);
		if (b != 7)
			anInt5209 = -94;
	...
	public static final boolean method2128(int i, int i_0_, byte b, int i_1_, int i_2_, int i_3_) {
		anInt5218++;
		for (int i_4_ = i_1_; i_4_ <= i; i_4_++)
			for (int i_5_ = i_2_; i_5_ <= i_0_; i_5_++)
				if (Node_Sub38_Sub16.anIntArrayArray10269[i_4_][i_5_] == i_3_
						&& (Class79.anIntArrayArray1070[i_4_][i_5_] ^ 0xffffffff) >= -2)
					return true;
		return false;
	}

	public static final Node_Sub9_Sub1 method2129(byte b) {
		if (b > -60)
			anInt5209 = -61;
		anInt5215++;
	...
	public void method27(boolean bool, int i) {
		anInt5206++;
		if (bool) {
			int i_7_ = aClass235_5213.aClass379_5118.method4160(-107, Node_Sub38_Sub12.anInt10225,
					aGLSprite5211.method1197()) + aClass235_5213.anInt5124;
			int i_8_ = aClass235_5213.aClass77_5123.method775(Class257.anInt3244, false, aGLSprite5211.method1186())
					- -aClass235_5213.anInt5116;
