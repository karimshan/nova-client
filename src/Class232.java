...
public class Class232 {
	public static boolean[] aBooleanArray2781 = new boolean[200];
	public static OutgoingPacket aClass318_2772 = new OutgoingPacket(90, -1);
	...
	public static final int method2139(int i) {
		anInt2769++;
		if (i != -1313)
			method2141(-113, null);
	...
	public static final void method2141(int i, Plane plane) {
	...
	public final boolean method2136(int i) {
		anInt2778++;
		if (aBuffer2775 != null)
			return true;
		...
		byte[] whirpoolHash = GLXToolkit.generateWhirpoolHash((byte) 125, buffer.buffer, -bs.length + buffer.offset - 5,
				5);
		if (i != 255)
			aBooleanArray2781 = null;
	...
	public final Class34_Sub1 method2137(MainFile class6, int i, MainFile class6_5_, byte b) {
		anInt2774++;
		if (b >= -30)
			modulus = null;
	...
	private final Class34_Sub1 method2138(boolean bool, MainFile class6, int i, MainFile class6_6_, int i_7_) {
		...
		Class34_Sub1 class34_sub1 = new Class34_Sub1(i, class6, class6_6_, aClass266_2782, aClass141_2771, i_8_, bs,
				i_9_, bool);
		aClass34_Sub1Array2777[i] = class34_sub1;
		return class34_sub1;
	}

	public final void method2140(int i) {
		anInt2776++;
