...
abstract class Class234 {
	public static boolean[][][] aBooleanArrayArrayArray2790;
	...
	public static final Class233 method2144(int i) {
		anInt2789++;
		if (i <= 64)
			anInt2787 = 90;
		try {
	...
	public static final boolean method2150(int i, int i_1_, int i_2_) {
		anInt2791++;
		if (i_1_ != 256)
			method2144(-6);
	...
	public final int method2147(long l, int i) {
		anInt2788++;
		if (i <= 50)
			return -89;
