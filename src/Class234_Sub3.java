...
public class Class234_Sub3 extends Class234 {
	...
	@Override
	public final int method2145(byte b, long l) {
		if (b < 68)
			aLongArray6929 = null;
	...
	@Override
	public final void method2146(int i) {
		aLong6928 = 0L;
	...
	@Override
	public final long method2148(byte b) {
		if (b <= 88)
			aLong6925 = 62L;
	...
	@Override
	public final long method2151(int i) {
		if (i != 0)
			anInt6930 = 42;
		return aLong6926;
	}
