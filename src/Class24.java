...
public class Class24 {
	...
	public static Class275 aClass275_442;
	public static GLSprite[] aGLSpriteArray443;
	...
	public static final Class237 method304(int i, int i_0_, byte[] bs, GLXToolkit glxtoolkit) {
		anInt440++;
	...
	public static final boolean method305(int i, int i_2_, int i_3_, boolean bool, int[] is, int i_4_, int i_5_, int i_6_) {
		if (bool != false)
			return false;
		anInt439++;
		if (i < 0)
