...
public class Class242 {
	private static final int method3054(int i, int i_0_) {
		int i_1_;
		for (i_1_ = (int) Math.pow(i, 1.0 / i_0_) + 1; Class230_Sub1.method2131(i_0_, i_1_, 62) > i; i_1_--) {
			/* empty */
		}
		return i_1_;
	}
			...
			if (i == 1)
				for (int i_29_ = 0; i_29_ < anInt3060; i_29_++) {
					...
					for (int i_32_ = 0; i_32_ < anInt3061; i_32_++) {
						...
						float f_34_ = anIntArray3059[i_33_] * f_24_ + f + f_30_;
				...
				for (int i_35_ = 0; i_35_ < anInt3060; i_35_++) {
					...
					for (int i_38_ = 0; i_38_ < anInt3061; i_38_++) {
						float f_39_ = anIntArray3059[i_37_] * f_24_ + f + f_36_;
