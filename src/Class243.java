...
public class Class243 {
	public static boolean aBoolean3075;
	public static Class340 aClass340_3069;
	public static Class61 aClass61_3065 = new Class61(8);
	...
	public static final void method3059(int i, byte b, int i_0_, IComponentDefinitions widget) {
	...
	public static final void method3060(byte b, boolean bool, boolean bool_1_, Node_Sub2 node_sub2) {
		anInt3073++;
		...
		for (Node_Sub2 node_sub2_3_ = (Node_Sub2) class303
				.method3542(true); node_sub2_3_ != null; node_sub2_3_ = (Node_Sub2) class303.method3539(0)) {
	...
	public static final void method3061(int i) {
	...
	public static final boolean method3062(int i, byte b) {
		anInt3066++;
		if (b < 44)
			return true;
	...
	public static final boolean method3063(int i, Interface19 interface19) {
		if (i < 108)
			anIntArray3074 = null;
		anInt3067++;
		ObjectDefinition objectdefinition = Class186.aClass112_2256.method1145(interface19.getObjectId(-32136), 49);
