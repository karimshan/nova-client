...
public class Class245 {
	public static Class119 aClass119_3085;
	public static OutgoingPacket aClass318_3101 = new OutgoingPacket(30, -1);
	...
	public static final void method3069(int i, boolean bool) {
		anInt3091++;
		if (bool) {
			...
			for (Node_Sub2 node_sub2 = (Node_Sub2) Class289.aHashTable3630.method1516(
					false); node_sub2 != null; node_sub2 = (Node_Sub2) Class289.aHashTable3630.method1520(i + 115)) {
		...
		Player.get.anInt5940 = 512 * Class377_Sub1.GAME_SCENE_HEIGHT / 2;
		Player.get.anInt5934 = 512 * Node_Sub54.GAME_SCENE_WDITH / 2;
		Player.get.scenePositionXQueue[0] = Node_Sub54.GAME_SCENE_WDITH / 2;
		Class98.anInt5061 = Node_Sub10.anInt7079 = 0;
		Player.get.scenePositionYQueue[0] = Class377_Sub1.GAME_SCENE_HEIGHT / 2;
	...
	Class245(AbstractToolkit abstracttoolkit, Class263 class263, StandardPlane standardplane, int i, int i_13_,
		...
		if ((i_18_ ^ 0xffffffff) < -1) {
			...
			for (int i_24_ = 0; i_24_ < 4; i_24_++) {
				Buffer buffer = anInterface15_Impl1_3090.method54(true, (byte) 99);
				if (buffer != null) {
	...
	public final void method3067(int i, Interface15_Impl1 interface15_impl1, int i_0_) {
		if (i_0_ > 0) {
			method3068((byte) 108);
			anAbstractToolkit3098.method1312((byte) -21, anInterface13_Impl1_3093);
			anAbstractToolkit3098.method1276(anInt3087, (byte) -108, 0, interface15_impl1, anInt3086 - anInt3087 + 1,
					Class55.aClass104_833, i_0_);
		}
		anInt3092++;
		if (i <= 87)
			...
			if (anInterface13_Impl1_3093 != null && (i ^ 0xffffffff) == (anInt3097 ^ 0xffffffff))
				...
				if (!anAbstractToolkit3098.method1295(Node_Sub52.aClass68_7639, Class372.aClass372_4594, 1)) {
					...
					if (anInterface13_Impl1_3093 == null) {
						anInterface13_Impl1_3093 = anAbstractToolkit3098.method1258(false, 128, true, 128,
								Class262_Sub15_Sub1.anIntArray10523);
						anInterface13_Impl1_3093.method51(false, false, false);
					} else
						anInterface13_Impl1_3093.method47(Class262_Sub15_Sub1.anIntArray10523, 0, 0, 128, 23110, 128, 0,
								128);
				} else {
					...
					if (anInterface13_Impl1_3093 == null) {
						anInterface13_Impl1_3093 = anAbstractToolkit3098.method1252(128, Class201.aByteArray2442,
								Node_Sub52.aClass68_7639, 128, (byte) -3, false);
						anInterface13_Impl1_3093.method51(false, false, false);
					} else
						anInterface13_Impl1_3093.method50(0, 128, 128, -15178, Class201.aByteArray2442, 0,
								Node_Sub52.aClass68_7639, 0, 128);
				}
			}
		}
	}

	public final void method3070(int i) {
