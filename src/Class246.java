...
public class Class246 {
	public static OutgoingPacket aClass318_3103;
	...
	public static final void method3071(byte b) {
	...
	public static final void method3072(byte b) {
		Class169.aShort4961 = Animable_Sub2_Sub2.aShort10750;
		Node_Sub38_Sub23.aShort10345 = KeyStrokes.aShort3667;
		...
		if (Class270_Sub1.anInt8034 != 0 && Class259.anInt3254 != 0) {
			...
			Animable_Sub2_Sub2.aShort10750 = KeyStrokes.aShort3667 = (short) (512 * Class270_Sub1.anInt8034
					/ Class259.anInt3254);
		}
	}

	public static final void method3073(int i) {
		anInt3106++;
		...
		for (int i_0_ = 0; i_0_ < 65536; i_0_++) {
			double d_1_ = 0.0078125 + (i_0_ >> 10 & 0x3f) / 64.0;
			double d_2_ = 0.0625 + ((i_0_ & 0x3d8) >> 7) / 8.0;
			double d_3_ = (0x7f & i_0_) / 128.0;
			double d_4_ = d_3_;
			double d_5_ = d_3_;
			double d_6_ = d_3_;
			if (d_2_ != 0.0) {
