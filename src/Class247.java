...
public class Class247 {
	public static boolean aBoolean3122 = false;
	public static Calendar aCalendar3144 = Calendar.getInstance(TimeZone.getTimeZone("GMT"));
	public static IncomingPacket aClass192_3123 = new IncomingPacket(110, -1);
	public static Class197 aClass197_3115;
	public static Index aClass302_3143;
	public static OutgoingPacket aClass318_3130 = new OutgoingPacket(70, -1);
	public static GLSprite aGLSprite3141;
	...
	Class247(GLToolkit gltoolkit) {
		...
		if (aGLToolkit3121.aBoolean6719 && aGLToolkit3121.aBoolean6649) {
			...
			if ((aGLToolkit3121.anInt6599 ^ 0xffffffff) < -2 && aGLToolkit3121.aBoolean6662
					&& aGLToolkit3121.aBoolean6735)
	...
	private final boolean method3075(byte b) {
		...
		if (aBoolean3134) {
			...
			if (aClass382_3109 != null)
				aCacheNode_Sub17_3138 = new CacheNode_Sub17(aGLToolkit3121, anInt3142, anInt3114, anInt3113,
						aGLToolkit3121.anInt6599);
			aClass169_Sub2Array3132[0] = new Class169_Sub2(aGLToolkit3121, 34037, anInt3142, anInt3114, anInt3113);
			aClass169_Sub2Array3132[1] = anInt3136 <= 1 ? (Class169_Sub2) null
					: new Class169_Sub2(aGLToolkit3121, 34037, anInt3142, anInt3114, anInt3113);
			aBoolean3133 = true;
			aBoolean3131 = true;
			aBoolean3134 = false;
		}
	...
	public final void method3076(byte b) {
		anInt3118++;
		if (aBoolean3110) {
			if (aClass382_3109 != null) {
			...
			for (Node_Sub23 node_sub23_1_ = (Node_Sub23) aClass312_3112
					.method3613(65280); node_sub23_1_ != null; node_sub23_1_ = node_sub23) {
				...
				for (int i_3_ = 0; (i_2_ ^ 0xffffffff) < (i_3_ ^ 0xffffffff); i_3_++) {
					...
					if (node_sub23 != null || (-1 + i_2_ ^ 0xffffffff) != (i_3_ ^ 0xffffffff)) {
						...
						OpenGL.glBegin(7);
						OpenGL.glTexCoord2f(0.0F, anInt3113);
						OpenGL.glMultiTexCoord2f(33985, 0.0F, 1.0F);
						OpenGL.glVertex2i(0, 0);
						OpenGL.glTexCoord2f(0.0F, 0.0F);
						OpenGL.glMultiTexCoord2f(33985, 0.0F, 0.0F);
						OpenGL.glVertex2i(0, anInt3113);
						OpenGL.glTexCoord2f(anInt3114, 0.0F);
						OpenGL.glMultiTexCoord2f(33985, 1.0F, 0.0F);
						OpenGL.glVertex2i(anInt3114, anInt3113);
						OpenGL.glTexCoord2f(anInt3114, anInt3113);
	...
	public final boolean method3077(Node_Sub23 node_sub23, byte b) {
		anInt3127++;
	...
	private final void method3078(int i) {
		...
		int i_4_ = 0;
		int i_5_ = 0;
		for (Node_Sub23 node_sub23 = (Node_Sub23) aClass312_3112.method3613(
				i + 82734); node_sub23 != null; node_sub23 = (Node_Sub23) aClass312_3112.method3620(16776960)) {
	...
	public final boolean method3079(int i) {
		if (i != -2)
			return false;
		anInt3120++;
		if (aClass382_3129 == null)
	...
	public final void method3080(boolean bool) {
		aCacheNode_Sub17_3137 = null;
		if (bool != false)
			method3083(true);
		anInt3117++;
	...
	public final boolean method3081(int i, int i_10_, int i_11_, int i_12_, int i_13_) {
		anInt3124++;
	...
	public final void method3082(int i, Node_Sub23 node_sub23) {
		anInt3126++;
