...
public class Class25 {
	...
	public static final void method306(int junk, int sceneX, long l, int sceney) {
	...
	public static final long method308(int i, boolean bool) {
		anInt451++;
		if (bool != false)
			return -106L;
	...
	public final void method307(int i, int i_8_) {
		OpenGL.glNewList(anInt447 + i, i_8_);
		anInt445++;
	}

	public final void method309(boolean bool) {
		anInt448++;
		OpenGL.glEndList();
		if (bool != false)
			anInt447 = 43;
	...
	public final void method310(char c, byte b) {
		if (b >= -13)
			method309(false);
		anInt450++;
