...
public class Class250 {
	...
	public static boolean[][] aBooleanArrayArray3168;
	public static Index aClass302_3179;
	...
	static {
		aBooleanArrayArray3168 = new boolean[][] { new boolean[4], { false, true, true, false },
				...
				{ true, false, false, true }, { true, true, false, false }, new boolean[4],
	...
	public static final Class329 method3095(int i, int i_4_) {
		anInt3169++;
	...
	public static final boolean method3096(int i, int i_6_) {
		if (i_6_ >= -60)
			return false;
		anInt3171++;
	...
	public final int[] method3091(int i, byte b) {
		anInt3174++;
	...
	public final boolean method3092(boolean bool) {
		if (bool != false)
			method3095(88, -67);
		anInt3170++;
		if (anInt3178 == -1)
	...
	public final Class55 method3093(int i, boolean bool) {
		try {
			anInt3176++;
			...
			throw Commands.method1537(runtimeexception, "oka.D(" + i + ',' + bool + ')');
		}
	}
}
