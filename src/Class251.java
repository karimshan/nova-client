...
public class Class251 {
	...
	public static final void decodeReceivedDynamicMapRegions(boolean bool) {
		anInt3186++;
		...
		for (int i_71_ = 0; i_71_ < 4; i_71_++)
			for (int i_72_ = 0; Node_Sub54.GAME_SCENE_WDITH >> 3 > i_72_; i_72_++)
				for (int i_73_ = 0; (i_73_ ^ 0xffffffff) > (Class377_Sub1.GAME_SCENE_HEIGHT >> 3
						^ 0xffffffff); i_73_++) {
					...
					for (int i_80_ = 0; Class377_Sub1.GAME_SCENE_HEIGHT >> 3 > i_80_; i_80_++) {
						...
						if ((i_81_ ^ 0xffffffff) != 0) {
							...
							if (i_84_ != -1) {
								...
								StandardPlane.anIntArray7980[i_75_] = Animable_Sub1_Sub1.aClass302_10618
										.method3519("m" + i_86_ + "_" + i_87_, (byte) 102);
								Class144.anIntArray1789[i_75_] = Animable_Sub1_Sub1.aClass302_10618
										.method3519("l" + i_86_ + "_" + i_87_, (byte) 93);
								Class42.anIntArray645[i_75_] = Animable_Sub1_Sub1.aClass302_10618
										.method3519("um" + i_86_ + "_" + i_87_, (byte) 82);
								ProducingGraphicsBuffer.anIntArray9895[i_75_] = Animable_Sub1_Sub1.aClass302_10618
										.method3519("ul" + i_86_ + "_" + i_87_, (byte) 114);
								i_75_++;
							}
						}
					}
	...
	public static final void method3097(Actor actor, int i) {
		if (actor instanceof NPC) {
			NPC npc = (NPC) actor;
			if (npc.defs != null)
				Class352.drawNPCOptions((Player.get.plane ^ 0xffffffff) != (npc.plane ^ 0xffffffff), npc);
		} else if (actor instanceof Player) {
			Player player = (Player) actor;
			Class223.drawPlayerOptions(player.plane != Player.get.plane, player, -15052);
		}
		anInt3181++;
		if (i >= -80)
	...
	public static final int method3098(boolean bool) {
		anInt3184++;
		if (Class20.aFloat329 == 3.0)
			return 37;
		if (Class20.aFloat329 == 4.0)
			return 50;
		if (Class20.aFloat329 == 6.0)
			return 75;
		if (bool != true)
			method3097(null, -110);
		if (Class20.aFloat329 == 8.0)
			return 100;
		return 200;
	}

	public static final void method3099(byte b, int i, int i_0_, int i_1_, int i_2_, int[] is, int[] is_3_, int i_4_, int i_5_,
			int[] is_6_, boolean bool, boolean bool_7_, int i_8_, int[] is_9_, byte[][][] bs, int[] is_10_, int i_11_,
			int i_12_) {
		anInt3183++;
		if (Class320_Sub20.anInt8397 != -1) {
			...
			if ((Class320_Sub20.anInt8397 ^ 0xffffffff) == -2) {
				i_19_ = (int) ((double) Class148.anInt1825 * (double) i_17_ / Class303.anInt3831);
				i_18_ = (int) ((double) Class148.anInt1825 * (double) i_16_ / Class303.anInt3831);
			}
			if (!Class194_Sub1.aBoolean6892) {
				...
				int i_23_ = (int) ((Login.aDouble2401 * i_22_
						+ (SeekableFile.aDouble3883 * i_21_ + Class363.aDouble4509 * i_20_)) * i_18_ / i_8_);
				int i_24_ = (int) ((i_22_ * Class326.aDouble4108
						+ (i_21_ * FileOnDisk.aDouble1318 + i_20_ * Animable_Sub2_Sub1.aDouble10631)) * i_19_ / i_8_);
				double d = Class320_Sub6.aDouble8262 * i_20_ + i_21_ * Class165.aDouble2028
						+ Class282.aDouble3585 * i_22_;
				...
				if (i_25_ >= 0 && i_26_ >= 0 && (CacheNode_Sub15.anInt9589 ^ 0xffffffff) <= (i_27_ ^ 0xffffffff)
						&& i_28_ <= Class303.anInt3831 || (Class320_Sub20.anInt8397 ^ 0xffffffff) == -3) {
					if (Class320_Sub20.anInt8397 == 2)
						Class346.aDouble4277 = -d;
					Class166.anInt5100 = i_26_;
					Node_Sub38_Sub1.anInt10075 = i_25_;
				} else if ((i_27_ ^ 0xffffffff) >= -1 || (i_28_ ^ 0xffffffff) >= -1
						|| CacheNode_Sub15.anInt9589 <= i_25_ || Class303.anInt3831 <= i_26_)
					...
					if (Class320_Sub20.anInt8397 != 0) {
						if (Class320_Sub20.anInt8397 == 1) {
							...
							d_35_ = (i_29_ * i_31_ - -(i_32_ * i_30_)) * (d + Class346.aDouble4277)
									/ (i_30_ * i_30_ + i_29_ * i_29_);
						}
					} else {
						i_31_ = i_29_;
						i_32_ = i_30_;
					...
					for (EntityNode_Sub6 entitynode_sub6 = (EntityNode_Sub6) class103.method1113(
							(byte) 115); entitynode_sub6 != null; entitynode_sub6 = (EntityNode_Sub6) class103
									.method1108(109)) {
						EntityNode_Sub5[] entitynode_sub5s = entitynode_sub6.anEntityNode_Sub5Array5995;
						boolean bool_52_ = true;
						for (EntityNode_Sub5 entitynode_sub52 : entitynode_sub5s) {
							EntityNode_Sub5 entitynode_sub5 = entitynode_sub52;
							...
							if (bool_52_) {
								...
								if ((CacheNode_Sub15.anInt9589 ^ 0xffffffff) <= (i_59_ ^ 0xffffffff)) {
									...
									if (i_60_ <= Class303.anInt3831) {
										...
										if (i_61_ >= 0) {
											int i_62_ = ((i_55_ ^ 0xffffffff) <= (i_57_ ^ 0xffffffff) ? i_55_ : i_57_)
													- -i_58_;
					...
					if ((Class320_Sub20.anInt8397 ^ 0xffffffff) == -2) {
						...
						Class44.aGraphicsToolkit668.DA(Class186.anInt2250, Class320_Sub16.anInt8361,
								Node_Sub38_Sub20.anInt10298, Class349.anInt4305);
					} else {
						Class349.anInt4305 = i_19_;
					...
					if ((i_50_ ^ 0xffffffff) < -1) {
						...
						Class151.method1671(i_4_, i, i_1_, i_0_, bs, is_6_, is_9_, is, is_10_, is_3_, i_5_, b, i_11_,
								i_2_, bool, bool_7_, i_8_, 1, false);
					}
					if (i_45_ > 0) {
					...
					if (Class320_Sub20.anInt8397 == 1) {
						...
						for (int i_63_ = 0; (i_63_ ^ 0xffffffff) > (Class290_Sub11.anInt8181 ^ 0xffffffff); i_63_++) {
							int i_64_ = AnimableAnimator.method254(Class259.anInt3300 + i_63_, i_12_ ^ 0x422a,
									Class290_Sub11.anInt8181) * Class117.anInt1479;
							for (int i_65_ = 0; (i_65_ ^ 0xffffffff) > (Class117.anInt1479 ^ 0xffffffff); i_65_++) {
								int i_66_ = AnimableAnimator.method254(i_65_ + Class338.anInt4190, 16939,
										Class117.anInt1479) + i_64_;
								boolean bool_67_ = (i_63_ ^ 0xffffffff) <= (i_36_ ^ 0xffffffff)
										&& (i_63_ ^ 0xffffffff) > (i_36_ + i_37_ ^ 0xffffffff)
										|| i_39_ <= i_63_ && (i_63_ ^ 0xffffffff) > (i_41_ + i_39_ ^ 0xffffffff)
												&& i_65_ >= i_38_
												&& (i_65_ ^ 0xffffffff) > (i_40_ + i_38_ ^ 0xffffffff);
								Class352.anInterface6Array4332[i_66_].method18(i_65_ * StandardSprite.anInt8946,
										aa_Sub3.anInt5493 * i_63_, StandardSprite.anInt8946, aa_Sub3.anInt5493, 0, 0,
										bool_67_, true);
							}
						}
					}
			...
			if (Class194_Sub1.aBoolean6892) {
				...
				Class44.aGraphicsToolkit668.ya();
				Class44.aGraphicsToolkit668.GA(Node_Sub43.anInt7539);
				Class225.aClass336_2678.method3864(Class186.anInt2261, Class82.anInt1111, MainFile.anInt148,
						Class368.anInt4550, Class72.anInt973, Node_Sub29_Sub1.anInt10012);
				...
				Class320_Sub5.method3695(Class7.aClass179_157);
				Class151.method1671(i_4_, i, i_1_, i_0_, bs, is_6_, is_9_, is, is_10_, is_3_, i_5_, b, i_11_, i_2_,
						bool, bool_7_, i_8_, 1, false);
				Node_Sub38_Sub7.method2805();
			...
			if (Class320_Sub20.anInt8397 == 0)
				Node_Sub15_Sub9.anInterface6_9843.method19(Node_Sub38_Sub1.anInt10075, Class166.anInt5100,
						Animable_Sub1_Sub2.anInt10668, Class148.anInt1825, 0, 0, true, true);
			Class225.anInt2675++;
			...
			if (Class320_Sub20.anInt8397 != 0 && Class320_Sub20.anInt8397 != 2) {
				if ((Class320_Sub20.anInt8397 ^ 0xffffffff) == -2) {
					...
					Class44.aGraphicsToolkit668.DA(Class118.anInt5404, Class320_Sub23.anInt8433, Class30.anInt491,
							Class320_Sub10.anInt8303);
					Class44.aGraphicsToolkit668.KA(Node_Sub38_Sub1.anInt10075, Class166.anInt5100,
				...
				Class118.anInt5404 = -Node_Sub38_Sub1.anInt10075 + -Class319.anInt4057 + i_14_
						- -Node_Sub23_Sub1.anInt9929;
				Class320_Sub10.anInt8303 = i_19_;
				Class44.aGraphicsToolkit668.DA(Class118.anInt5404, Class320_Sub23.anInt8433, Class30.anInt491,
						Class320_Sub10.anInt8303);
			}
			Class151.method1671(i_4_, i, i_1_, i_0_, bs, is_6_, is_9_, is, is_10_, is_3_, i_5_, b, i_11_, i_2_, bool,
					bool_7_, i_8_, Class320_Sub20.anInt8397 != 2 ? 2 : 0, i_12_ == Class320_Sub20.anInt8397);
			Class44.aGraphicsToolkit668.la();
			Class44.aGraphicsToolkit668.DA(i_14_, i_15_, i_16_, i_17_);
		}
	}

	public static final boolean method3101(int i, byte b) {
		if (b != -62)
			return true;
		anInt3187++;
