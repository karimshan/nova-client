...
public class Class258 implements Interface12 {
	public static Class335 aClass335_5293 = new Class335(128);
	public static int anInt5288;
	public static int anInt5290;
	public static int anInt5291 = 0;
	public static int anInt5292;
	public static int anInt5294;
	public static int anInt5295;
	public static int[] calculatedScenePositionYs = new int[50];

	public static final void method3124(int i, int i_0_, int[] is, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_) {
		anInt5294++;
				...
				for (int i_17_ = 0; i_17_ < i_8_; i_17_++) {
					...
					is_11_[i_12_++] = Node_Sub16.method2590(
							Node_Sub16.method2590(
									Node_Sub16.method2590(Node_Sub30.method2723(i_25_, 1020) << 14,
											Node_Sub30.method2723(i_21_, 1020) << 22),
	...
	public static final void method3126(int i, BufferedStream buffer, SignLink signlink, int i_26_) {
		anInt5295++;
		if (i != -9821)
			...
			try {
				...
				if ((i_28_ ^ 0xffffffff) != -1 && i_28_ != 1 && (i_28_ ^ 0xffffffff) != -3) {
					if (i_28_ == 3 || (i_28_ ^ 0xffffffff) == -5) {
						...
						node_sub53.aClass241Array7664[i_27_] = signlink.method3638(Class260.method3139(string, 51),
								var_classes, string_29_, false);
					...
					node_sub53.aClass241Array7657[i_27_] = signlink.method3628(Class260.method3139(string, i + 9872),
							string_35_, Node_Sub19.method2612(i, -9821));
				}
	...
	public static final void method3127(byte b) {
		if (b == 122) {
			anInt5290++;
			Class44.aGraphicsToolkit668.a(NPC.aClass336_11113);
			Class44.aGraphicsToolkit668.DA(Class178.anInt2119, Class343.anInt4252, Class99.anInt1280,
					Class320_Sub30.anInt8495);
		}
	}
