...
public class Class259 {
	public static Class68 aClass68_3268;
	...
	public static int[] anIntArray3296 = new int[2];
	static {
	...
	public static final void method3132(int i, int i_9_, int i_10_, byte b) {
		anInt3248++;
		i = Class213.aNode_Sub27_2512.aClass320_Sub25_7274.method3776(false) * i >> 8;
		if ((i ^ 0xffffffff) != -1 && (i_9_ ^ 0xffffffff) != 0) {
			if (!Class377_Sub1.aBoolean8775 && (Class313.anInt4013 ^ 0xffffffff) != 0 && Class36.method390(b ^ 0x11)
					&& !Class113.method1152(-85)) {
				EntityNode_Sub1.aNode_Sub9_Sub1_5929 = Class230.method2129((byte) -127);
				Node_Sub9_Sub1 node_sub9_sub1 = CS2Definition.method359(EntityNode_Sub1.aNode_Sub9_Sub1_5929, -9293);
	...
	public final int method3128(boolean bool) {
		anInt3288++;
		if (bool != false)
			method3128(false);
		...
		if (anIntArray3294 != null) {
			int i = (int) (anInt3281 * Math.random());
			int i_0_;
	...
	public final boolean method3130(int i, byte b) {
		anInt3279++;
		if (i == -1)
			return false;
		if (i == anInt3259)
	...
	public final Class336[] method3131(int i, GraphicsToolkit graphicstoolkit) {
		anInt3257++;
		...
		for (int i_2_ = 0; i_2_ < anIntArrayArray3273.length; i_2_++) {
			...
			if (i_3_ != 0 || i_4_ != 0 || (i_5_ ^ 0xffffffff) != -1 || i_6_ != 0 || (i_7_ ^ 0xffffffff) != -1
					|| i_8_ != 0) {
																				...
																				if (i_11_ == 49)
																					...
																					if (i_11_ != 55) {
																						if (i_11_ == 56) {
																							...
																							for (int i_18_ = 0; (i_18_
																									^ 0xffffffff) > -4; i_18_++)
																								anIntArrayArray3249[i_17_][i_18_] = buffer
																										.readShort();
																						}
																					} else {
	...
	public final void method3134(byte b, BufferedStream buffer) {
		for (;;) {
