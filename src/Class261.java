...
public class Class261 {
	public static HashTable aHashTable3306 = new HashTable(16);
	public static int anInt3307;
	public static int anInt3309;
	public static int anInt3321;

	public static final int[][] method3142(boolean bool, int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_,
			float f) {
		anInt3307++;
	...
	public static final int method3144(boolean bool, int i, int i_7_) {
		anInt3321++;
		if (bool != false)
			aHashTable3306 = null;
	...
	public final void method3141(int i) {
		if (i > -82)
