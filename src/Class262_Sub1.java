...
public class Class262_Sub1 extends Class262 {
	public static Class124 aClass124_7696 = new Class124(2);
	public static int anInt7697;
	public static int anInt7702;
	public static int anInt7703;
	public static int[] MAP_REGION_HASHES;
	...
	public static final void method3150(int i, Player player, int i_0_, int i_1_, NPC npc, ObjectDefinition objectdefinition,
			byte b, int i_2_) {
		anInt7703++;
		...
		if (b == -8) {
			...
			if (objectdefinition == null) {
				if (npc != null) {
					...
					Class320_Sub3.aHashTable8234.put(player.index, node_sub47, -127);
				}
			} else {
				...
				if (node_sub47.anIntArray7579 != null)
					node_sub47.anInt7561 = (int) ((node_sub47.anInt7565 + -node_sub47.anInt7587) * Math.random())
							+ node_sub47.anInt7587;
				Class290_Sub6.aClass312_8122.method3625((byte) -54, node_sub47);
			}
		}
	}

	public static final void method3151(float[] fs, float f, int i, int i_5_, int i_6_, float[] fs_7_, float f_8_, int i_9_,
		...
		i_11_ -= i_9_;
		anInt7702++;
		float f_14_ = i_12_ * fs[2] + (fs[1] * i_11_ + i_5_ * fs[0]);
		float f_15_ = i_12_ * fs[5] + (i_11_ * fs[4] + fs[3] * i_5_);
		float f_16_ = fs[6] * i_5_ + i_11_ * fs[7] + fs[8] * i_12_;
		float f_17_ = (float) Math.atan2(f_14_, f_16_) / 6.2831855F + 0.5F;
		if (f_8_ != 1.0F)
			f_17_ *= f_8_;
