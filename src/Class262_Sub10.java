...
public class Class262_Sub10 extends Class262 {
	public static BigInteger aBigInteger7775 = new BigInteger("10001", 16);
	public static Index aClass302_7776;
	public static int anInt7767;
	public static int anInt7774;
	public static int[] anIntArray7773 = new int[13];
	...
	public static final void method3173(boolean bool) {
		anInt7774++;
