...
public class Class262_Sub11 extends Class262 {
	public static Class271 aClass271_7779 = new Class271();
	...
	public static final void method3175(int i, int i_0_) {
	...
	public static final void method3176(int i) {
		anInt7781++;
		if (Class170.anIntArray2054 == null) {
			...
			for (/**/; (i_3_ ^ 0xffffffff) > -513; i_3_++) {
				float f = ((i_3_ >> 3) / 64.0F + 0.0078125F) * 360.0F;
				float f_4_ = 0.0625F + (0x7 & i_3_) / 8.0F;
				for (int i_5_ = 0; i_5_ < 128; i_5_++) {
					float f_6_ = i_5_ / 128.0F;
					float f_7_ = 0.0F;
					float f_8_ = 0.0F;
					float f_9_ = 0.0F;
					float f_10_ = f / 60.0F;
					...
					f_8_ = (float) Math.pow(f_8_, d);
					f_9_ = (float) Math.pow(f_9_, d);
	...
	public static long method3177(long l, long l_21_) {
		return l ^ l_21_;
	}

	public static final void method3178(int i, int i_22_, Class48 class48) {
		anInt7783++;
		if (Class23.anInt434 < 50 && (class48 != null && class48.anIntArrayArray700 != null
			...
			if (class48.anIntArrayArray700[i].length > 1) {
				int i_25_ = (int) (Math.random() * class48.anIntArrayArray700[i].length);
			...
			if (!class48.aBoolean699)
				PlayerMasks.method1033(i_27_, 0, i_24_, i_26_, 255, 0);
			else
				Class105.method1116(i_24_, i_26_, i_27_, (byte) 57, 0, 255, false);
		}
	}

	public static final void method3179(long l, byte b) {
		if (b > 106) {
			anInt7777++;
			try {
				Thread.sleep(l);
