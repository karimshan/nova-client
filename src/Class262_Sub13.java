...
public class Class262_Sub13 extends Class262 {
	public static IncomingPacket aClass192_7795 = new IncomingPacket(4, 0);
	public static Class257 aClass257_7801 = new Class257(9, -1);
	public static int anInt7794;
	...
	public static final void method3182(boolean bool) {
		anInt7802++;
	...
	public static final void method3183(int i) {
		if (i == 9844) {
			anInt7797++;
	...
	public static final Class170[] method3184(int i) {
		if (i != 0)
			aClass257_7801 = null;
		anInt7794++;
		return new Class170[] { Node_Sub40.aClass170_7508, Class46.aClass170_680, Class169_Sub2.aClass170_8806,
				Class336_Sub3.aClass170_8613, Class96.aClass170_1273, Class262_Sub18.aClass170_7850,
				Class350.aClass170_5391, Class106.aClass170_1357, Class356.aClass170_4425, Class270.aClass170_3476 };
	}

	public static final void method3185(byte b, EntityNode entitynode, EntityNode entitynode_3_) {
		anInt7803++;
	...
	public final void method3148(int i) {
		PlayerMasks.method1033(anInt7804, 0, anInt7796, anInt7798, anInt7805, 0);
		anInt7799++;
		if (i >= -102)
			anInt7806 = 25;
	}
