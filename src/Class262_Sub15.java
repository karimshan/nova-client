...
abstract class Class262_Sub15 extends Class262 {
	public static Animable[] anAnimableArray7817;
	public static int anInt7816;
	public static int anInt7819;
	public static int[] anIntArray7821 = new int[32];

	public static final void method3188(int i) {
		anInt7816++;
	...
	public static final float[] method3189(float f, float f_0_, float f_1_, int i, int i_2_, int i_3_, int i_4_, int i_5_) {
		anInt7819++;
		float[] fs = new float[9];
		float[] fs_6_ = new float[9];
		float f_7_ = (float) Math.cos(i_4_ * 0.024543693F);
		float f_8_ = (float) Math.sin(i_4_ * 0.024543693F);
		...
		f_7_ = i_5_ / 32767.0F;
		float f_12_ = 0.0F;
		f_8_ = -(float) Math.sqrt(1.0F - f_7_ * f_7_);
		f_9_ = -f_7_ + 1.0F;
		float f_13_ = (float) Math.sqrt(i_2_ * i_2_ + i * i);
