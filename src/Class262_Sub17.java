...
public class Class262_Sub17 extends Class262 {
	public static boolean aBoolean7833 = false;
	public static int anInt7834;
	public static int anInt7838;
	public static int anInt7839 = 0;

	public static final void method3197(int i) {
		if (CacheNode_Sub18.aClass343ArrayArray9608 != null)
			for (int i_0_ = 0; (i_0_ ^ 0xffffffff) > (CacheNode_Sub18.aClass343ArrayArray9608.length
					^ 0xffffffff); i_0_++)
				for (int i_1_ = 0; CacheNode_Sub18.aClass343ArrayArray9608[i_0_].length > i_1_; i_1_++)
					CacheNode_Sub18.aClass343ArrayArray9608[i_0_][i_1_] = ToolTips.aClass343_3695;
		anInt7834++;
		if (i != 0)
			method3197(89);
	}
