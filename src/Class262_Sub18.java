...
public class Class262_Sub18 extends Class262 {
	public static Class170 aClass170_7850 = new Class170(5, 1);
	public static Class335 aClass335_7849 = new Class335(16);
	public static Class61 aClass61_7842 = new Class61(8);
	public static int anInt7840;
	public static int anInt7843;

	public static final int method3198(String string, boolean bool) {
		anInt7843++;
