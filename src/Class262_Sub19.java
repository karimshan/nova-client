...
public class Class262_Sub19 extends Class262 {
	...
	public static int[][] anIntArrayArray7854 = { { 0, 1, 2, 3 }, { 1, -1, -1, 0 }, { -1, 2, -1, 0 }, { -1, 0, -1, 2 },
			{ 0, 1, -1, 2 }, { 1, 2, -1, 0 }, { -1, 4, -1, 1 }, { -1, 3, 4, -1 }, { -1, 0, 2, -1 }, { -1, -1, 2, 0 },
			{ 0, 2, 5, 3 }, { 0, -1, 6, -1 }, { 0, 1, 2, 3 } };
	public static short[] aShortArray7852 = new short[256];

	public static final void method3200(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, boolean bool) {
		anInt7857++;
		Node_Sub19 node_sub19 = null;
		for (Node_Sub19 node_sub19_6_ = (Node_Sub19) Class89.aClass312_1199.method3613(
				65280); node_sub19_6_ != null; node_sub19_6_ = (Node_Sub19) Class89.aClass312_1199.method3620(16776960))
			if (i_3_ == node_sub19_6_.anInt7165 && node_sub19_6_.anInt7171 == i_2_ && i_5_ == node_sub19_6_.anInt7161
					&& (node_sub19_6_.anInt7166 ^ 0xffffffff) == (i_1_ ^ 0xffffffff)) {
		...
		if (node_sub19 == null) {
			...
			if (i_2_ >= 0 && i_5_ >= 0 && Node_Sub54.GAME_SCENE_WDITH > i_2_ && i_5_ < Class377_Sub1.GAME_SCENE_HEIGHT)
				PacketDecoder.method2247(103, node_sub19);
	...
	public static final void method3201(int i) {
		anInt7855++;
	...
	public final void method3148(int i) {
		anInt7856++;
		Node_Sub32 node_sub32 = (Node_Sub32) Class18.aHashTable308.getNode(3512, hash);
		if (node_sub32 != null)
