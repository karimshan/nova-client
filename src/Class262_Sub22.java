...
public class Class262_Sub22 extends Class262 {
	...
	public static int anInt7870;
	public static int anInt7871;
	public static int anInt7872;
	public static int anInt7873;
	public static int anInt7874;

	public static final void method3206(int i) {
		anInt7874++;
	...
	public static final Class42 method3207(SignLink signlink, byte b, int i, int i_1_, Component component) {
		anInt7871++;
	...
	public static final void method3208(long l, boolean bool) {
		anInt7870++;
	...
	public static final Class115 method3209(boolean bool) {
		anInt7869++;
		try {
			if (bool != true)
				return null;
	...
	public static final void method3210(int i, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_) {
		...
		if (Node_Sub13.anInt7116 >= 100) {
			...
			int i_10_ = Node_Sub38_Sub7.method2809(CacheNode_Sub20_Sub1.myPlayerPlane, -29754, i_9_, i_8_)
			...
			int i_14_ = (int) Math.sqrt(i_13_ * i_13_ + i_11_ * i_11_);
			OutgoingPacket.anInt4050 = (int) (2607.5945876176133 * Math.atan2(i_12_, i_14_)) & 0x3fff;
			Class170.anInt2053 = 0x3fff & (int) (-2607.5945876176133 * Math.atan2(i_11_, i_13_));
	...
	public static final Animable_Sub3 method3211(int i, int i_15_, int i_16_) {
