...
public class Class262_Sub23 extends Class262 {
	public static Class197 aClass197_7884;
	public static Class257 aClass257_7883;
	public static Index aClass302_7886;
	public static int anInt7878;
	public static int anInt7887;
	public static int anInt7890;
	public static int anInt7893;
	public static int anInt7894;
	public static int[][] anIntArrayArray7892 = new int[128][128];
	static {
		aClass257_7883 = new Class257(12, 7);
	}

	public static final void method3212(boolean bool, int i) {
	...
	public static final IncomingPacketHolder method3213(byte b) {
		if (b >= -52)
			return null;
		anInt7890++;
	...
	public static final int method3214(int i, int i_0_) {
		if (i_0_ != -20139)
			return -83;
		anInt7894++;
		return 0x7f & i;
	...
	public static final void method3215(int i) {
		if (Class298.anInt3740 < 102)
			Class298.anInt3740 += 6;
		anInt7887++;
		if (ClientBackground.anInt6904 != -1 && LoadingBar.aLong2020 < Class313.method3650(false)) {
			for (int i_1_ = ClientBackground.anInt6904; (i_1_ ^ 0xffffffff) > (Class339_Sub1.aStringArray8631.length
					^ 0xffffffff); i_1_++) {
				if (Class339_Sub1.aStringArray8631[i_1_].startsWith("pause")) {
					...
					DeveloperConsole.printConsoleMessage((byte) 43, "Pausing for " + i_2_ + " seconds...");
					ClientBackground.anInt6904 = 1 + i_1_;
					LoadingBar.aLong2020 = i_2_ * 1000 + Class313.method3650(false);
					return;
				}
				Node_Sub10.aString7081 = Class339_Sub1.aStringArray8631[i_1_];
				Node_Sub21.method2618(false, 0);
			}
			ClientBackground.anInt6904 = -1;
		}
			...
			if (i_4_ != 80) {
				if ((i_4_ ^ 0xffffffff) != -67 || (i_5_ & 0x4) == 0) {
					if ((i_4_ ^ 0xffffffff) == -68 && (i_5_ & 0x4 ^ 0xffffffff) != -1) {
						...
						Node_Sub10.aString7081 = Node_Sub10.aString7081.substring(0, Class315.anInt4034 + -1)
								+ Node_Sub10.aString7081.substring(Class315.anInt4034);
						Class315.anInt4034--;
					} else if ((i_4_ ^ 0xffffffff) == -102
							&& (Class315.anInt4034 ^ 0xffffffff) > (Node_Sub10.aString7081.length() ^ 0xffffffff))
						Node_Sub10.aString7081 = Node_Sub10.aString7081.substring(0, Class315.anInt4034)
								+ Node_Sub10.aString7081.substring(1 + Class315.anInt4034);
						...
						if ((i_4_ ^ 0xffffffff) == -98 && Class315.anInt4034 < Node_Sub10.aString7081.length())
							...
							if (i_4_ != 103) {
								if ((i_4_ ^ 0xffffffff) != -105
										|| Class210.messageLength.length <= Class332.anInt4145) {
					...
					String string = "";
					for (int i_6_ = Class210.messageLength.length + -1; i_6_ >= 0; i_6_--)
						if (Class210.messageLength[i_6_] != null && Class210.messageLength[i_6_].length() > 0)
							string += Class210.messageLength[i_6_] + '\n';
	...
	public final void method3148(int i) {
		...
		Mobile_Sub1 mobile_sub1 = new Mobile_Sub1(anInt7879, i_9_, i_9_, i_8_, i_7_, anInt7877 << 2,
				Class174.clientCycle, Class174.clientCycle - -anInt7881, anInt7880, i_12_, anInt7888 + 1, 1 + anInt7896,
				anInt7895 << 2, false, 0);
