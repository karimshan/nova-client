...
public class Class262_Sub3 extends Class262 {
	public static Index aClass302_7715;
	public static int anInt7716;
	public static int anInt7719;
	public static int anInt7720;
	public static int[] anIntArray7713 = new int[5];

	public static final int method3156(int i) {
		if (i < 56)
			return 118;
		anInt7719++;
	...
	public static final boolean method3157(int i, byte b) {
		if (b != 28)
			return false;
		anInt7720++;
