...
public class Class262_Sub9 extends Class262 {
	public static OutgoingPacket aClass318_7765 = new OutgoingPacket(4, 8);
	...
	public static final GraphicsToolkit method3171(Index class302, byte b, d var_d, int i, java.awt.Canvas canvas, int i_0_) {
		anInt7760++;
	...
	public final void method3148(int i) {
		Class121.aClass206Array1529[anInt7759].method2037(-61).method852(anInt7766, 0, anInt7761, (byte) -119,
				anInt7764, Class174.clientCycle, anInt7762, anInt7758);
		if (i >= -102)
