...
public class Class263 {
	public static Class104 aClass104_3337 = new Class104();
	public static Class119 aClass119_3340;
	public static int anInt3329;
	public static int anInt3332;
	public static int anInt3333;
	public static int anInt3335;
	public static int anInt3336 = 1;
	...
	public static final void method3223(int i, int i_67_, int i_68_, int i_69_, int i_70_, int i_71_, int i_72_, int i_73_) {
		anInt3338++;
		int i_74_ = 0;
		int i_75_ = i_69_;
		int i_76_ = 0;
		...
		if (Class384.anInt4906 <= i_71_ && (i_71_ ^ 0xffffffff) >= (Node_Sub25_Sub1.anInt9936 ^ 0xffffffff)) {
			...
			int i_105_ = Node_Sub38_Sub32.method2894(Class262_Sub4.anInt7722, za_Sub2.anInt10513, 929798380,
					-i_67_ + i);
			int i_106_ = Node_Sub38_Sub32.method2894(Class262_Sub4.anInt7722, za_Sub2.anInt10513, i_68_ ^ ~0x376bccb6,
					i - -i_67_);
		...
		while ((i_75_ ^ 0xffffffff) < -1) {
			...
			if (i_110_ >= Class384.anInt4906 && (i_109_ ^ 0xffffffff) >= (Node_Sub25_Sub1.anInt9936 ^ 0xffffffff)) {
				int i_111_ = Node_Sub38_Sub32.method2894(Class262_Sub4.anInt7722, za_Sub2.anInt10513,
						i_68_ ^ ~0x376bccb6, i - -i_74_);
				int i_112_ = Node_Sub38_Sub32.method2894(Class262_Sub4.anInt7722, za_Sub2.anInt10513, 929798380,
						i - i_74_);
				if (bool) {
					int i_113_ = Node_Sub38_Sub32.method2894(Class262_Sub4.anInt7722, za_Sub2.anInt10513,
							i_68_ + 929819975, i - -i_76_);
					int i_114_ = Node_Sub38_Sub32.method2894(Class262_Sub4.anInt7722, za_Sub2.anInt10513,
							i_68_ + 929819975, i - i_76_);
	...
	Class263(AbstractToolkit abstracttoolkit, StandardPlane standardplane) {
		...
		anInt3347 = 2
				+ (aStandardPlane3344.anInt3408 * aStandardPlane3344.anInt3398 >> anAbstractToolkit3331.anInt6350);
		anInt3341 = 2
				- -(aStandardPlane3344.anInt3398 * aStandardPlane3344.anInt3404 >> anAbstractToolkit3331.anInt6350);
	...
	public final void method3218(boolean[][] bools, int i, int i_10_, int i_11_, boolean bool, int i_12_) {
		anInt3335++;
		...
		float f = 1.0F / (anAbstractToolkit3331.anInt6320 * 128);
		if (bool)
			for (int i_13_ = 0; (anInt3345 ^ 0xffffffff) < (i_13_ ^ 0xffffffff); i_13_++) {
				...
				for (int i_16_ = 0; anInt3334 > i_16_; i_16_++)
					if (aClass245ArrayArray3342[i_16_][i_13_] != null) {
						...
						while_222_: for (int i_19_ = i_17_; i_18_ > i_19_; i_19_++)
							if ((i_19_ - i_11_ ^ 0xffffffff) <= (-i ^ 0xffffffff)
									&& (i ^ 0xffffffff) <= (-i_11_ + i_19_ ^ 0xffffffff))
								for (int i_20_ = i_14_; (i_15_ ^ 0xffffffff) < (i_20_ ^ 0xffffffff); i_20_++)
									if (-i <= -i_10_ + i_20_ && -i_10_ + i_20_ <= i
											&& bools[i + (-i_11_ + i_19_)][i_20_ - i_10_ - -i]) {
			...
			for (int i_21_ = 0; (anInt3345 ^ 0xffffffff) < (i_21_ ^ 0xffffffff); i_21_++) {
				...
				for (int i_24_ = 0; anInt3334 > i_24_; i_24_++) {
					...
					if (class245 != null) {
						Interface15_Impl1 interface15_impl1 = anAbstractToolkit3331.method1298(i_12_ + 1,
								class245.anInt3100 * 3);
						Buffer buffer = interface15_impl1.method54(true, (byte) 83);
						if (buffer != null) {
							...
							for (int i_28_ = i_22_; (i_23_ ^ 0xffffffff) < (i_28_ ^ 0xffffffff); i_28_++)
								if ((i_28_ + -i_10_ ^ 0xffffffff) <= (-i ^ 0xffffffff)
										&& (i ^ 0xffffffff) <= (i_28_ - i_10_ ^ 0xffffffff)) {
									int i_29_ = i_26_ + aStandardPlane3344.anInt3408 * i_28_;
									for (int i_30_ = i_26_; (i_27_ ^ 0xffffffff) < (i_30_ ^ 0xffffffff); i_30_++) {
										if ((-i ^ 0xffffffff) >= (i_30_ + -i_11_ ^ 0xffffffff)
												&& (i_30_ - i_11_ ^ 0xffffffff) >= (i ^ 0xffffffff)
												&& bools[i + (i_30_ + -i_11_)][i_28_ - (i_10_ - i)]) {
											short[] ses = aStandardPlane3344.aShortArrayArray7985[i_29_];
											if (ses != null)
												if (!Stream.b())
													for (int i_31_ = 0; (ses.length ^ 0xffffffff) < (i_31_
															^ 0xffffffff); i_31_++) {
	...
	public final void method3220(r var_r, int i, int i_33_, int i_34_) {
		anInt3339++;
		if (i >= -47)
	...
	public final boolean method3221(int i, r var_r, int i_45_, byte b) {
		anInt3333++;
		r_Sub1 var_r_Sub1 = (r_Sub1) var_r;
	...
	public final void method3222(r var_r, int i, int i_55_, int i_56_) {
		anInt3346++;
		r_Sub1 var_r_Sub1 = (r_Sub1) var_r;
		...
		if (i_60_ > 0 && (i_59_ ^ 0xffffffff) < -1) {
			Class339_Sub3.method3930(aByteArray3343, var_r_Sub1.aByteArray11044, i_57_, i_61_, i_63_, i_58_, -126,
					i_60_, i_59_);
			method3217(i_59_, i, i_56_, i_55_, i_60_);
		}
	}

	public final void method3224(byte b) {
		anInt3332++;
		...
		if (b == 122)
			for (/**/; anInt3345 > i; i++)
				for (int i_115_ = 0; anInt3334 > i_115_; i_115_++) {
					aClass245ArrayArray3342[i_115_][i] = new Class245(anAbstractToolkit3331, this, aStandardPlane3344,
							i_115_, i, anInt3330, 1 + 128 * i_115_, 128 * i - -1);
