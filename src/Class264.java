...
public class Class264 {
	...
	public static int anInt3355 = 1338;
	public static int anInt3358;
	public static int anInt3361;
	public static int[] anIntArray3352;
	static {
	...
	public final void method3226(BufferedStream buffer, byte b) {
		anInt3358++;
		for (;;) {
	...
	public final Model method3227(byte b) {
		anInt3350++;
	...
	public final boolean method3228(boolean bool) {
		anInt3354++;
		boolean bool_10_ = bool;
		synchronized (aClass181_3360.aClass302_2156) {
			for (int i = 0; (i ^ 0xffffffff) > -6; i++)
				if ((anIntArray3362[i] ^ 0xffffffff) != 0
						&& !aClass181_3360.aClass302_2156.requestDownload(0, anIntArray3362[i], 0))
					bool_10_ = false;
		}
		return bool_10_;
	}

	public final boolean method3229(int i) {
		anInt3348++;
		...
		synchronized (aClass181_3360.aClass302_2156) {
			for (int i_11_ = i; (anIntArray3357.length ^ 0xffffffff) < (i_11_ ^ 0xffffffff); i_11_++)
				if (!aClass181_3360.aClass302_2156.requestDownload(0, anIntArray3357[i_11_], 0))
					bool = false;
		}
		return bool;
	}

	public final Model method3231(int i) {
		anInt3351++;
		if (anIntArray3357 == null)
			return null;
