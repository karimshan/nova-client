...
public class Class265_Sub3 extends Class265 implements Interface13_Impl1 {
	...
	Class265_Sub3(D3DToolkit d3dtoolkit, Class68 class68, Class372 class372, int i, int i_17_) {
		...
		anIDirect3DTexture7906 = aD3DToolkit3365.anIDirect3DDevice9199.a(i, i_17_, 1, 0,
				D3DToolkit.method1396(aClass372_3366, aClass68_3367, -103), 1);
	}

	Class265_Sub3(D3DToolkit d3dtoolkit, Class68 class68, int i, int i_19_, boolean bool, byte[] bs, int i_20_,
			int i_21_) {
		...
		if (!bool)
			anIDirect3DTexture7906 = aD3DToolkit3365.anIDirect3DDevice9199.a(anInt7903, anInt7905, 1, 0,
					D3DToolkit.method1396(Class372.aClass372_4594, aClass68_3367, -32), 1);
		else
			anIDirect3DTexture7906 = aD3DToolkit3365.anIDirect3DDevice9199.a(anInt7903, anInt7905, 0, 1024,
					D3DToolkit.method1396(Class372.aClass372_4594, aClass68_3367, -31), 1);
	...
	@Override
	public final IDirect3DBaseTexture method3232(int i) {
		if (i > -46)
	...
	@Override
	public final void method50(int i, int i_8_, int i_9_, int i_10_, byte[] bs, int i_11_, Class68 class68, int i_12_,
			int i_13_) {
