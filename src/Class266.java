...
public class Class266 {
	public static boolean aBoolean3385;
	public static HashTable aHashTable3380 = new HashTable(64);
	...
	public static final void method3237(int i, GraphicsToolkit graphicstoolkit) {
		for (EntityNode_Sub4 entitynode_sub4 = (EntityNode_Sub4) Animable_Sub2.aClass103_9116.method1113(
				(byte) -45); entitynode_sub4 != null; entitynode_sub4 = (EntityNode_Sub4) Animable_Sub2.aClass103_9116
						.method1108(65))
	...
	public static final int method3243(int i, NPC npc) {
		anInt3383++;
		...
		if (i_16_ != -1 && !npc.aBoolean10867) {
			if (class259.anInt3252 != i_16_ && class259.anInt3271 != i_16_
					&& (class259.anInt3293 ^ 0xffffffff) != (i_16_ ^ 0xffffffff)
					&& (i_16_ ^ 0xffffffff) != (class259.anInt3270 ^ 0xffffffff)) {
				if (class259.anInt3262 == i_16_ || (i_16_ ^ 0xffffffff) == (class259.anInt3297 ^ 0xffffffff)
						|| (class259.anInt3304 ^ 0xffffffff) == (i_16_ ^ 0xffffffff)
						|| (class259.anInt3269 ^ 0xffffffff) == (i_16_ ^ 0xffffffff))
	...
	public final void method3233(byte b) {
		try {
	...
	public final int method3236(int i) {
		if (i != 0)
			return 87;
		anInt3375++;
	...
	public final boolean method3238(byte b) {
		if (aBufferedConnection3389 != null) {
		...
		try {
			...
			if (b != 70)
				aClass158_3386 = null;
			for (/**/; cachenode_sub16_sub1 != null; cachenode_sub16_sub1 = (CacheNode_Sub16_Sub1) aClass158_3384
					.method1721(0)) {
				aBuffer3392.offset = 0;
				aBuffer3392.writeByte(1);
				// aBuffer3392.write24BitInt((byte) 66, (int)
				// cachenode_sub16_sub1.aLong7037);
			...
			for (CacheNode_Sub16_Sub1 cachenode_sub16_sub1_0_ = (CacheNode_Sub16_Sub1) aClass158_3387.method1723(
					b ^ 0x4b); cachenode_sub16_sub1_0_ != null; cachenode_sub16_sub1_0_ = (CacheNode_Sub16_Sub1) aClass158_3387
							.method1721(0)) {
				aBuffer3392.offset = 0;
				aBuffer3392.writeByte(0);
				// aBuffer3392.write24BitInt((byte) 99, (int)
				// cachenode_sub16_sub1_0_.aLong7037);
				...
				if (i_2_ > 0) {
					...
					if (encryptValue != 0)
						for (int i_4_ = 0; (i_4_ ^ 0xffffffff) > (i_3_ ^ 0xffffffff); i_4_++)
							aBuffer3396.buffer[aBuffer3396.offset - -i_4_] = (byte) Node_Sub19
									.method2612(aBuffer3396.buffer[aBuffer3396.offset + i_4_], encryptValue);
					aBuffer3396.offset += i_3_;
					if (i_2_ <= aBuffer3396.offset)
						if (aCacheNode_Sub16_Sub1_3397 == null) {
							aBuffer3396.offset = 0;
							int indexId = aBuffer3396.readUnsignedByte(); // 1
							int archiveId = aBuffer3396.readInt(); // 3 read
																	// short
							...
							if (!noPriority) {
								for (cachenode_sub16_sub1_10_ = (CacheNode_Sub16_Sub1) aClass158_3386.method1723(
										13); cachenode_sub16_sub1_10_ != null; cachenode_sub16_sub1_10_ = (CacheNode_Sub16_Sub1) aClass158_3386
												.method1721(0))
									if ((cachenode_sub16_sub1_10_.aLong7037 ^ 0xffffffffffffffffL) == (l
											^ 0xffffffffffffffffL))
										break;
							} else
								for (cachenode_sub16_sub1_10_ = (CacheNode_Sub16_Sub1) aClass158_3388.method1723(
										13); cachenode_sub16_sub1_10_ != null; cachenode_sub16_sub1_10_ = (CacheNode_Sub16_Sub1) aClass158_3388
												.method1721(0))
									if ((cachenode_sub16_sub1_10_.aLong7037 ^ 0xffffffffffffffffL) == (l
											^ 0xffffffffffffffffL))
										break;
							...
							aCacheNode_Sub16_Sub1_3397.aBuffer11072 = new BufferedStream(
									i_11_ + size - -aCacheNode_Sub16_Sub1_3397.aByte11069);
					...
					int i_12_ = -aCacheNode_Sub16_Sub1_3397.aByte11069
							+ aCacheNode_Sub16_Sub1_3397.aBuffer11072.buffer.length;
					...
					if (i_13_ > i_1_)
						i_13_ = i_1_;
					aBufferedConnection3389.method425(i_13_, (byte) 67, aCacheNode_Sub16_Sub1_3397.aBuffer11072.offset,
							aCacheNode_Sub16_Sub1_3397.aBuffer11072.buffer);
					if ((encryptValue ^ 0xffffffff) != -1)
						for (int i_14_ = 0; i_14_ < i_13_; i_14_++)
							aCacheNode_Sub16_Sub1_3397.aBuffer11072.buffer[aCacheNode_Sub16_Sub1_3397.aBuffer11072.offset
									- -i_14_] = (byte) Node_Sub19.method2612(
											aCacheNode_Sub16_Sub1_3397.aBuffer11072.buffer[aCacheNode_Sub16_Sub1_3397.aBuffer11072.offset
													+ i_14_],
											encryptValue);
	...
	public final boolean method3239(int i) {
		if (i != 255)
			return false;
		anInt3376++;
	...
	public final void method3240(boolean bool, int i) {
		anInt3378++;
		if (aBufferedConnection3389 != null)
			try {
	...
	public final void method3241(boolean bool, int i, BufferedConnection bufferedconnection) {
		anInt3370++;
		if (aBufferedConnection3389 != null) {
			try {
				aBufferedConnection3389.method430(20692);
	...
	public final void method3242(int i) {
		anInt3369++;
		if (aBufferedConnection3389 != null)
			try {
				aBuffer3392.offset = 0;
	...
	public final boolean method3244(int i) {
		if (i != 24365)
	...
	public final void method3245(int i) {
		if (i != -2)
			anInt3394 = 79;
		if (aBufferedConnection3389 != null)
	...
	public final CacheNode_Sub16_Sub1 method3247(int i, int i_17_, byte b, boolean bool, byte b_18_) {
		anInt3372++;
		if (b != -79)
			method3236(-28);
