...
public class Class270_Sub1_Sub1 extends Class270_Sub1 {
	...
	public static int anInt10534;
	public static int anInt10535;

	public static final int method3301(int i, int i_3_, int i_4_, int i_5_) {
		anInt10535++;
		...
		if (i_4_ > -46)
			return 25;
		for (Node_Sub14 node_sub14 = (Node_Sub14) Class20.aClass312_331.method3613(
				65280); node_sub14 != null; node_sub14 = (Node_Sub14) Class20.aClass312_331.method3620(16776960))
	...
	public static final void method3302(int i, int i_14_, byte b, int i_15_, int i_16_) {
		if (b >= 90) {
			anInt10534++;
			if (i_15_ != 8 && (i_15_ ^ 0xffffffff) != -17) {
				...
				for (int i_17_ = 0; (Class83.anInt5183 ^ 0xffffffff) < (i_17_ ^ 0xffffffff); i_17_++) {
					...
					if (class54.aByte822 == i_15_ && (i ^ 0xffffffff) == (class54.aShort821 ^ 0xffffffff)
							&& (i_16_ ^ 0xffffffff) == (class54.aShort815 ^ 0xffffffff)
							|| (class54.aShort818 ^ 0xffffffff) == (i ^ 0xffffffff) && i_16_ == class54.aShort815) {
						if ((i_17_ ^ 0xffffffff) != (Class83.anInt5183 ^ 0xffffffff))
							Class311.method3605(IsaacCipher.aClass54Array1840, 1 + i_17_, IsaacCipher.aClass54Array1840,
									i_17_, -i_17_ + (-1 + IsaacCipher.aClass54Array1840.length));
						Class83.anInt5183--;
						break;
					}
				}
	...
	public static final Animable_Sub1 method3303(int i, int i_18_, int i_19_) {
	...
	@Override
	public final Interface13_Impl2 method3298(byte b) {
		anInt10532++;
		if (anInterface13_Impl2_10536 == null) {
			...
			for (int i_0_ = 0; i_0_ < 6; i_0_++) {
				if (!var_d.method7(b ^ 0x26e3, Class319.anIntArray4058[i_0_]))
					return null;
				PlayerMasks class91 = var_d.method10(Class319.anIntArray4058[i_0_], -8217);
			...
			for (int i_2_ = 0; (i_2_ ^ 0xffffffff) > -7; i_2_++)
				Mobile.anIntArrayArray9122[i_2_] = var_d.method11(i, false, i, Class319.anIntArray4058[i_2_], (byte) 0,
						1.0F);
