...
public class Class270_Sub2_Sub2 extends Client {
	public static HashTable aHashTable10552;
	public static int anInt10551;
	public static int anInt10557;
	public static int anInt10558 = 0;
	static {
		aHashTable10552 = new HashTable(16);
	}

	public static final void method3309(Animable animable, Node_Sub29[] node_sub29s) {
		...
		if (Class368.aPlaneArray4548 == Class320_Sub10.aPlaneArray8300) {
			...
			CacheNode_Sub18.aGraphicsToolkit9607.EA(
					Node_Sub38_Sub37.aPlaneArray10466[0].method3260(animable.anInt5940, -123, animable.anInt5934),
					Class320_Sub2.method3684(i, i_1_), Class184.method1844(i, i_1_), Class117_Sub2.method1172(i, i_1_));
		}
			...
			if (animable.aBoolean5945) {
				...
				for (EntityNode_Sub5 entitynode_sub5 : entitynode_sub5s) {
					if (entitynode_sub5.aBoolean5987)
						Class362.method4053(entitynode_sub5.anInt5986 - entitynode_sub5.anInt5983,
								entitynode_sub5.anInt5984 + entitynode_sub5.anInt5983,
								entitynode_sub5.anInt5985 - entitynode_sub5.anInt5983, (byte) -54,
	...
	@Override
	public final Class169_Sub1 method3304(boolean bool) {
		anInt10551++;
		if (aClass169_Sub1_10556 == null) {
			...
			for (int i_3_ = 0; (i_3_ ^ 0xffffffff) > -7; i_3_++) {
				if (!var_d.method7(9900, Class188_Sub1_Sub1.anIntArray9330[i_3_]))
					return null;
				PlayerMasks class91 = var_d.method10(Class188_Sub1_Sub1.anIntArray9330[i_3_], -8217);
			...
			for (int i_5_ = 0; i_5_ < 6; i_5_++)
				Class162.anIntArrayArray2005[i_5_] = var_d.method11(i, false, i,
						Class188_Sub1_Sub1.anIntArray9330[i_5_], (byte) 0, 1.0F);
