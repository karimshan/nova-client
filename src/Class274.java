...
public class Class274 implements d {
	public static Class124 aClass124_4975 = new Class124(15);
	public static Class56 aClass56_4971 = new Class56();
	public static GLSprite aGLSprite4981;
	...
	public static final CacheNode_Sub11 method3323(Index class302, int i, int i_3_, int i_4_) {
		anInt4980++;
		BufferedStream buffer = new BufferedStream(class302.method3524(false, i_3_, i));
		CacheNode_Sub11 cachenode_sub11 = new CacheNode_Sub11(i_3_, buffer.readString(), buffer.readString(),
				buffer.readInt(), buffer.readInt(), (buffer.readUnsignedByte() ^ 0xffffffff) == -2,
		...
		for (int i_6_ = i_4_; (i_5_ ^ 0xffffffff) < (i_6_ ^ 0xffffffff); i_6_++)
			cachenode_sub11.aClass312_9549.method3625((byte) -54,
					new Node_Sub52(buffer.readUnsignedByte(), buffer.readUnsignedShort(), buffer.readUnsignedShort(),
							buffer.readUnsignedShort(), buffer.readUnsignedShort(), buffer.readUnsignedShort(),
							buffer.readUnsignedShort(), buffer.readUnsignedShort(), buffer.readUnsignedShort()));
	...
	public static final void method3325(boolean bool, int i, int i_9_, int i_10_) {
		anInt4973++;
	...
	public static final void method3326(boolean bool, byte[][][] bs, int i, byte b, int i_11_, int i_12_, boolean bool_13_) {
		int i_14_ = bool ? 1 : 0;
			...
			for (Animable animable = Class303.anAnimableArray3827[i_14_]; animable != null; animable = animable.anAnimable5941)
				if (!Class150_Sub1.method1658(animable, bool, bs, i, b)) {
					...
					if (animable.anInt5944 != -1)
						CS2Definition.anAnimableArray516[DeveloperConsole.anInt7527++] = animable;
				}
		if ((i_12_ & 0x1) == 0) {
					...
					if (!Class150_Sub1.method1658(Node_Sub52.aMobileArray7648[i_15_], bool, bs, i, b)) {
						...
						if (Node_Sub52.aMobileArray7648[i_15_].anInt5944 != -1)
							if (Node_Sub52.aMobileArray7648[i_15_].method813(0))
								...
								CS2Definition.anAnimableArray516[DeveloperConsole.anInt7527++] = Node_Sub52.aMobileArray7648[i_15_];
					}
		}
		if (DeveloperConsole.anInt7527 > 0) {
			Node_Sub38_Sub26.method2876(CS2Definition.anAnimableArray516, 0, DeveloperConsole.anInt7527 - 1);
			for (int i_16_ = 0; i_16_ < DeveloperConsole.anInt7527; i_16_++)
				Class338.method3915(CS2Definition.anAnimableArray516[i_16_], true, bool_13_);
		}
		...
		if ((i_12_ & 0x2) == 0)
			for (int i_17_ = Class320_Sub12.anInt8327; i_17_ < Class159.anInt1995; i_17_++)
				if (i_17_ >= i && bs != null) {
					...
					if (Class320_Sub9.anInt8295 + Class139.aBooleanArrayArray1730[0].length > GameMessage.anInt7623)
						i_19_ -= Class320_Sub9.anInt8295 + Class139.aBooleanArrayArray1730[0].length
								- GameMessage.anInt7623;
					...
					if (Class307.aBoolean3898) {
						...
						for (int i_20_ = Commands.anInt1634; i_20_ < i_18_; i_20_++) {
							int i_21_ = i_20_ + Class238.anInt2915 - Commands.anInt1634;
								...
								if (Class139.aBooleanArrayArray1730[i_20_][i_22_]) {
									...
									for (int i_24_ = i_17_; i_24_ >= 0; i_24_--)
										if (Class175.aClass261ArrayArrayArray2099[i_24_][i_21_][i_23_] != null
											...
											if (i_24_ >= i && bs[i_24_][i_21_][i_23_] == b
													|| Class313.method3649(true, i_23_, i_17_, i_21_))
												bools[i_20_][i_22_] = false;
											else
					...
					if (Class188_Sub2.aBoolean6868) {
						...
						for (int i_25_ = 0; i_25_ < GlobalMessage.anInt427; i_25_++)
							Class364.aClass273Array4513[i_25_].method3314(new EntityNode_Sub8(i_17_ + 1), (byte) 51);
					} else if (i_11_ >= 0)
						Class320_Sub10.aPlaneArray8300[i_17_].method3259(Class216.anInt2551, EntityNode_Sub7.anInt6013,
								Node_Sub9_Sub1.anInt9656, Class75.aBooleanArrayArray1002, false, i_11_, i_12_);
					else
						Class320_Sub10.aPlaneArray8300[i_17_].method3252(Class216.anInt2551, EntityNode_Sub7.anInt6013,
								Node_Sub9_Sub1.anInt9656, Class75.aBooleanArrayArray1002, false, i_12_);
				} else {
					...
					if (Class320_Sub9.anInt8295 + Class139.aBooleanArrayArray1730[0].length > GameMessage.anInt7623)
						i_27_ -= Class320_Sub9.anInt8295 + Class139.aBooleanArrayArray1730[0].length
								- GameMessage.anInt7623;
					boolean[][] bools = Class75.aBooleanArrayArray1002;
					if (Class307.aBoolean3898) {
						if (Class188_Sub2.aBoolean6868)
							bools = Class234.aBooleanArrayArrayArray2790[i_17_];
						for (int i_28_ = Commands.anInt1634; i_28_ < i_26_; i_28_++) {
							int i_29_ = i_28_ + Class238.anInt2915 - Commands.anInt1634;
							for (int i_30_ = Node_Sub2.anInt6934; i_30_ < i_27_; i_30_++)
								if (Class139.aBooleanArrayArray1730[i_28_][i_30_] && !Class313.method3649(true,
										i_30_ + Class320_Sub9.anInt8295 - Node_Sub2.anInt6934, i_17_, i_29_))
					...
					if (Class188_Sub2.aBoolean6868) {
						if (i_11_ >= 0)
							...
							Class320_Sub10.aPlaneArray8300[i_17_].method3252(0, 0, 0, null, false, i_12_);
						for (int i_31_ = 0; i_31_ < GlobalMessage.anInt427; i_31_++)
							Class364.aClass273Array4513[i_31_].method3314(new EntityNode_Sub8(i_17_ + 1), (byte) 51);
					} else if (i_11_ >= 0)
						Class320_Sub10.aPlaneArray8300[i_17_].method3259(Class216.anInt2551, EntityNode_Sub7.anInt6013,
								Node_Sub9_Sub1.anInt9656, Class75.aBooleanArrayArray1002, true, i_11_, i_12_);
					else
						Class320_Sub10.aPlaneArray8300[i_17_].method3252(Class216.anInt2551, EntityNode_Sub7.anInt6013,
								Node_Sub9_Sub1.anInt9656, Class75.aBooleanArrayArray1002, true, i_12_);
				}
	...
	private static final void method3327(Animable animable) {
		CacheNode_Sub18.aGraphicsToolkit9607.H(animable.anInt5934, animable.anInt5937 + (animable.method817(2) >> 1),
				animable.anInt5940, Class144_Sub3.anIntArray6835);
	...
	private PlayerMasks[] aClass91Array4967;
	...
	Class274(Index class302, Index class302_38_, Index class302_39_) {
		...
		aClass91Array4967 = new PlayerMasks[anInt4976];
		for (int i = 0; (i ^ 0xffffffff) > (anInt4976 ^ 0xffffffff); i++)
			if (buffer.readUnsignedByte() == 1)
				aClass91Array4967[i] = new PlayerMasks();
	...
	@Override
	public final PlayerMasks method10(int i, int i_8_) {
		anInt4978++;
		if (i_8_ != -8217)
			aClass302_4982 = null;
	...
	public final int[] method11(int i, boolean bool, int i_1_, int i_2_, byte b, float f) {
		...
		if (b != 0)
			aClass302_4966 = null;
		return method3322(i_2_, (byte) 115).method2405(aClass302_4982, f, aClass91Array4967[i_2_].aBoolean1216, this,
				bool, i_1_, i, b);
	}

	private final CacheNode_Sub19 method3322(int i, byte b) {
		anInt4972++;
		CacheNode cachenode = aClass335_4979.method3849(i, true);
		if (cachenode != null)
		...
		aClass335_4979.method3848((byte) -128, cachenode_sub19, i);
	...
	public final int[] method8(float f, int i, int i_35_, boolean bool, boolean bool_36_, int i_37_) {
		if (bool != false)
			aClass124_4975 = null;
		anInt4968++;
		return method3322(i, (byte) -103).method2402(i_35_, f, aClass91Array4967[i].aBoolean1216, i_37_, (byte) -71,
				this, aClass302_4982);
	}
	...
	public final float[] method9(int i, int i_33_, float f, byte b, int i_34_, boolean bool) {
		...
		return method3322(i_33_, (byte) -69).method2400((byte) -114, i, this, aClass302_4982,
				aClass91Array4967[i_33_].aBoolean1216, i_34_);
	}
}
