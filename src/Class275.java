...
public class Class275 implements Interface17 {
	public static Class312 aClass312_5419 = new Class312();
	...
	// -1 follow
	// -4 walk
	public static final int calculateRoute(int startX, int startY, int toX, int toY, int size, int routeType,
			boolean alternativeRoute, int targetSizeX, int targetSizeY, int i_14_, int i_22_, Class84 planeClipData,
			int[] calculatedPositionXsArray, int[] calculatedPositionYsArray, byte junk) {
		anInt5418++;
		...
		boolean bool_25_;
		if (size == 1)
			bool_25_ = Class200_Sub1.method2015(targetSizeX, targetSizeY, routeType, planeClipData, startX, 11564,
					startY, toX, toY, i_22_, i_14_);
		else if (size == 2)
			bool_25_ = Node_Sub16.method2593(i_14_, startX, targetSizeY, toX, i_22_, routeType, targetSizeX, toY, false,
					startY, planeClipData);
		else
			bool_25_ = Node_Sub38_Sub20.method2856(i_22_, planeClipData, startX, targetSizeX, routeType, startY, i_14_,
					toX, toY, size, -1, targetSizeY);
		int i_26_ = startX + -64;
		int i_27_ = -64 + startY;
		...
		if (!bool_25_) {
			...
			for (int i_33_ = toX - i_32_; toX - -i_32_ >= i_33_; i_33_++)
				for (int i_34_ = toY + -i_32_; i_34_ <= i_32_ + toY; i_34_++) {
					...
					if (i_35_ >= 0 && (i_36_ ^ 0xffffffff) <= -1 && i_35_ < 128 && (i_36_ ^ 0xffffffff) > -129
							&& Class262_Sub23.anIntArrayArray7892[i_35_][i_36_] < 100) {
						int i_37_ = 0;
						...
						if (i_39_ < i_30_ || (i_39_ ^ 0xffffffff) == (i_30_ ^ 0xffffffff) && (i_31_
								^ 0xffffffff) < (Class262_Sub23.anIntArrayArray7892[i_35_][i_36_] ^ 0xffffffff)) {
							i_29_ = i_34_;
							i_28_ = i_33_;
							i_30_ = i_39_;
	...
	public static final int method3336(int i, int i_54_, int i_55_, int i_56_, int i_57_, int i_58_, int i_59_) {
		anInt5416++;
	...
	public final void method3328(int i, int i_0_, int i_1_) {
		anInt5426++;
		if (i > -18)
			anIntArray5421 = null;
		CONFIG_VALUES[i_0_] = i_1_;
		Node_Sub44 node_sub44 = (Node_Sub44) aHashTable5420.getNode(3512, i_0_);
		if (node_sub44 != null)
			node_sub44.aLong7550 = Class313.method3650(false) + 500L;
		else {
			node_sub44 = new Node_Sub44(500L + Class313.method3650(false));
			aHashTable5420.put(i_0_, node_sub44, -124);
		}
	}

	public final void method3329(byte b) {
		anInt5425++;
	...
	public final void method3330(byte b, int i, int i_6_) {
		if (b == 38) {
			anInt5423++;
	...
	public final void method3333(int i, int i_44_, int i_45_) {
		anInt5422++;
	...
	public final int method3334(int i, boolean bool) {
		anInt5424++;
		long l = Class313.method3650(false);
		Node_Sub44 node_sub44 = !bool ? (Node_Sub44) aHashTable5420.method1520(95)
				: (Node_Sub44) aHashTable5420.method1516(false);
	...
	public final void method3335(byte b, int i, int i_52_) {
		anInt5415++;
		anIntArray5421[i] = i_52_;
		Node_Sub44 node_sub44 = (Node_Sub44) aHashTable5420.getNode(3512, i);
		if (node_sub44 == null) {
			node_sub44 = new Node_Sub44(4611686018427387905L);
			aHashTable5420.put(i, node_sub44, -126);
