...
class Class277 {
	public static CacheNode_Sub13 aCacheNode_Sub13_3509;
	...
	public static final void method3344(int i, boolean bool, int i_135_) {
		if (i != 1420162185)
			method3342(true);
		anInt3529++;
		Node_Sub43 node_sub43 = !bool ? ItemDefinitions.aNode_Sub43_1925 : Class29.aNode_Sub43_477;
		if (node_sub43 != null && (i_135_ ^ 0xffffffff) <= -1
				&& (node_sub43.anInt7531 ^ 0xffffffff) < (i_135_ ^ 0xffffffff)) {
			Class24 class24 = node_sub43.aClass24Array7533[i_135_];
			if ((class24.aByte438 ^ 0xffffffff) == 0) {
				String string = class24.aString437;
				IncomingPacketHolder class123 = Class262_Sub23.method3213((byte) -85);
				Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, Class246.aClass318_3103,
						class123.isaacCipher);
				node_sub13.packet.writeByte(Commands.method1536(i + -1420183011, string) + 3);
				node_sub13.packet.writeByte(bool ? 1 : 0);
				node_sub13.packet.writeShort(i_135_);
	...
	public final void method3337(BufferedStream buffer, int i, Class84[] class84s, int i_0_, byte b, int i_1_, int i_2_) {
		if (!aBoolean3516)
			for (int i_3_ = 0; (i_3_ ^ 0xffffffff) > -5; i_3_++) {
				...
				for (int i_4_ = 0; (i_4_ ^ 0xffffffff) > -65; i_4_++)
					for (int i_5_ = 0; i_5_ < 64; i_5_++) {
						int i_6_ = i_4_ + i_2_;
						int i_7_ = i_5_ + i;
						if (i_6_ >= 0 && (anInt3524 ^ 0xffffffff) < (i_6_ ^ 0xffffffff) && i_7_ >= 0
								&& i_7_ < anInt3521)
		...
		for (int i_10_ = 0; (i_10_ ^ 0xffffffff) > (anInt3535 ^ 0xffffffff); i_10_++)
			for (int i_11_ = 0; i_11_ < 64; i_11_++)
				for (int i_12_ = 0; (i_12_ ^ 0xffffffff) > -65; i_12_++)
					method3345(0, i + i_12_, 0, i_11_ - -i_2_, i_8_ + i_11_, buffer, 0, i_12_ + i_9_, i_10_, -682,
							false);
		if (b > -78)
			anInt3535 = -107;
	}

	public final void method3338(int i, int i_13_, int i_14_, int i_15_, int i_16_) {
		int i_17_ = 0;
		if (i != -1)
	...
	public final void method3339(int i, int[][][] is, GraphicsToolkit graphicstoolkit, Class84[] class84s) {
		if (!aBoolean3516)
		...
		if (i == -2)
			for (int i_22_ = 0; (anInt3535 ^ 0xffffffff) < (i_22_ ^ 0xffffffff); i_22_++) {
				...
				Class232.method2141(i_22_, graphicstoolkit.a(anInt3524, anInt3521, anIntArrayArrayArray3520[i_22_],
						is_25_, 512, i_23_, i_24_));
			}
	}

	private final void method3340(int i, byte b, GraphicsToolkit graphicstoolkit, int[][] is, Plane plane,
			Plane plane_26_, Plane plane_27_) {
		for (int i_28_ = 0; (anInt3524 ^ 0xffffffff) < (i_28_ ^ 0xffffffff); i_28_++)
			for (int i_29_ = 0; i_29_ < anInt3521; i_29_++)
				if (Class256.anInt3237 == -1 || Class369.method4085(i_29_, 0, Class256.anInt3237, i_28_, i)) {
					...
					if (class289 != null && (class289.anInt3631 ^ 0xffffffff) == 0
							&& (class289.anInt3629 ^ 0xffffffff) == 0) {
					...
					if (class289 != null || class236 != null) {
						...
						if (class289 != null) {
							...
							if (!aBoolean3516 && i == 0)
								Class158.method1725(i_28_, i_29_, class289.anInt3646, 8 * class289.anInt3634,
										class289.anInt3641);
						} else
							i_39_ += i_36_;
						if (class236 != null)
						...
						for (int i_56_ = 0; (i_51_ ^ 0xffffffff) < (i_56_ ^ 0xffffffff); i_56_++) {
							...
							if (is_54_ != null && GLPlane.aBooleanArrayArray7950[b_30_][i_56_]) {
								...
								is_54_[i_56_] = plane.method3260(i_62_, -128, i_61_)
										- plane_26_.method3260(i_62_, -127, i_61_);
							}
							if (is_55_ != null)
								if (plane == null || GLPlane.aBooleanArrayArray7950[b_30_][i_56_]) {
									if (plane_27_ != null && !Node_Sub15_Sub7.aBooleanArrayArray9822[b_30_][i_56_]) {
										...
										is_55_[i_56_] = plane_27_.method3260(i_64_, -126, i_63_)
												+ -plane_26_.method3260(i_64_, -114, i_63_);
									}
								} else {
									int i_65_ = is_52_[i_56_] + (i_28_ << 9);
									int i_66_ = (i_29_ << 9) + is_53_[i_56_];
									is_55_[i_56_] = plane_26_.method3260(i_66_, -128, i_65_)
											+ -plane.method3260(i_66_, -115, i_65_);
								}
						}
						...
						if (bool && (i ^ 0xffffffff) < -2 || !bool && i > 0) {
							...
							if (class236 != null && !class236.aBoolean2892)
								...
								bool_71_ = false;
							if (bool_71_ && (i_68_ ^ 0xffffffff) == (i_67_ ^ 0xffffffff)
									&& (i_69_ ^ 0xffffffff) == (i_67_ ^ 0xffffffff) && i_67_ == i_70_)
								aByteArrayArrayArray3526[i][i_28_][i_29_] = (byte) Node_Sub16
										.method2590(aByteArrayArrayArray3526[i][i_28_][i_29_], 4);
						}
						int i_72_ = 0;
						int i_73_ = 0;
						int i_74_ = 0;
						...
						plane_26_.method3253(i_28_, i_29_, is_52_, is_54_, is_53_, is_55_, is_42_, is_43_, is_44_,
								is_45_, is_48_, is_46_, is_47_, i_72_, i_73_, i_74_, false);
	...
	private final void method3341(int i, Class289 class289, byte[][] bs, int i_75_, int i_76_, int i_77_, int i_78_,
			int i_79_, GraphicsToolkit graphicstoolkit, int i_80_, boolean[] bools, Class236 class236, byte[][] bs_81_,
			byte[][] bs_82_) {
		anInt3533++;
		boolean[] bools_83_ = class289 != null && class289.aBoolean3643 ? Class250.aBooleanArrayArray3168[i]
				: Node_Sub33.aBooleanArrayArray7406[i];
		if (i_80_ > 0) {
			if (i_77_ > 0) {
				...
				if ((class289_101_.anInt3631 ^ 0xffffffff) != 0) {
					...
					if (class289_101_.aBoolean3643) {
						...
						for (int i_106_ = 0; (i_106_ ^ 0xffffffff) > -4; i_106_++) {
							i_103_ = 0x7 & i_103_;
							i_104_ &= 0x7;
							if (GLPlane.aBooleanArrayArray7950[b][i_104_] && (class289_101_.anInt3633
									^ 0xffffffff) <= (Class327.anIntArray5348[i_103_] ^ 0xffffffff)) {
								...
								if ((Class327.anIntArray5348[i_103_] ^ 0xffffffff) != (class289_101_.anInt3633
										^ 0xffffffff))
									Class136.anIntArray1695[i_103_] = 32;
								else
									Class136.anIntArray1695[i_103_] = Node_Sub16
											.method2590(Class136.anIntArray1695[i_103_], 32);
				...
				if (class289_108_.anInt3631 != -1) {
					...
					if (class289_108_.aBoolean3643) {
						...
						for (int i_113_ = 0; i_113_ < 3; i_113_++) {
							i_110_ &= 0x7;
							i_111_ = 0x7 & i_111_;
							if (GLPlane.aBooleanArrayArray7950[b][i_111_]
								...
								if ((Class327.anIntArray5348[i_110_] ^ 0xffffffff) != (class289_108_.anInt3633
										^ 0xffffffff))
									Class136.anIntArray1695[i_110_] = 16;
								else
									Class136.anIntArray1695[i_110_] = Node_Sub16
											.method2590(Class136.anIntArray1695[i_110_], 16);
								Class327.anIntArray5348[i_110_] = class289_108_.anInt3633;
							}
							i_110_++;
							i_111_--;
				...
				if (class289_115_.anInt3631 != -1) {
					...
					if (class289_115_.aBoolean3643) {
						...
						for (int i_120_ = 0; (i_120_ ^ 0xffffffff) > -4; i_120_++) {
							i_117_ = 0x7 & i_117_;
							i_118_ = 0x7 & i_118_;
							if (GLPlane.aBooleanArrayArray7950[b][i_118_]
								...
								if ((class289_115_.anInt3633 ^ 0xffffffff) == (Class327.anIntArray5348[i_117_]
										^ 0xffffffff))
									Class136.anIntArray1695[i_117_] = Node_Sub16
											.method2590(Class136.anIntArray1695[i_117_], 8);
								else
				...
				if ((class289_122_.anInt3631 ^ 0xffffffff) != 0) {
					...
					if (class289_122_.aBoolean3643) {
						...
						for (int i_127_ = 0; i_127_ < 3; i_127_++) {
							i_125_ &= 0x7;
							i_124_ = 0x7 & i_124_;
							if (GLPlane.aBooleanArrayArray7950[b][i_125_] && (class289_122_.anInt3633
									^ 0xffffffff) <= (Class327.anIntArray5348[i_124_] ^ 0xffffffff)) {
								...
								if (Class327.anIntArray5348[i_124_] != class289_122_.anInt3633)
									...
									Class136.anIntArray1695[i_124_] = Node_Sub16
											.method2590(Class136.anIntArray1695[i_124_], 4);
		...
		if (class289 != null) {
			...
			if (class289.aBoolean3643)
				for (int i_129_ = 0; (i_129_ ^ 0xffffffff) > -9; i_129_++) {
					...
					if (GLPlane.aBooleanArrayArray7950[i][i_129_]
							&& (class289.anInt3633 ^ 0xffffffff) <= (Class327.anIntArray5348[i_130_] ^ 0xffffffff)) {
	...
	public final void method3343(int[][] is, byte b, int i) {
		anInt3517++;
	...
	private final void method3345(int i, int i_136_, int i_137_, int i_138_, int i_139_, BufferedStream buffer,
			int i_140_, int i_141_, int i_142_, int i_143_, boolean bool) {
		if (i == 1)
			i_137_ = 1;
		else if (i != 2) {
			if (i == 3)
			...
			for (;;) {
				...
				if (i_145_ == 0) {
					if (!aBoolean3516) {
						if ((i_142_ ^ 0xffffffff) != -1)
							anIntArrayArrayArray3520[i_142_][i_140_ + i_138_][i_137_ + i_136_] = -960
									+ anIntArrayArrayArray3520[-1 + i_142_][i_138_ - -i_140_][i_136_ + i_137_];
						else
							anIntArrayArrayArray3520[0][i_138_ - -i_140_][i_136_ + i_137_] = 8
									* -Class339_Sub1.method3925(i_139_ + 932731, 114, i_141_ + 556238) << 2;
					} else
				...
				if (i_145_ == 1) {
					...
					if (!aBoolean3516) {
						...
						if (i_142_ == 0)
							...
							anIntArrayArrayArray3520[i_142_][i_140_ + i_138_][i_136_
									+ i_137_] = anIntArrayArrayArray3520[i_142_ + -1][i_138_ - -i_140_][i_137_ + i_136_]
											- (8 * i_146_ << 2);
					} else
						anIntArrayArrayArray3520[0][i_140_ + i_138_][i_137_ + i_136_] = 8 * i_146_ << 2;
					break;
				...
				if ((i_145_ ^ 0xffffffff) >= -50) {
					if (bool)
						...
						aByteArrayArrayArray3525[i_142_][i_138_][i_136_] = (byte) Node_Sub30.method2723(3,
								-2 + i_145_ + i);
					}
				} else if (i_145_ <= 81) {
					if (!aBoolean3516 && !bool)
	...
	public final void method3346(byte b, GraphicsToolkit graphicstoolkit, Plane plane, Plane plane_147_) {
		anInt3510++;
		if (b == 75) {
					...
					if (i_149_ >= 0) {
						...
						for (int i_160_ = -5; i_160_ < anInt3521; i_160_++) {
							...
							if ((i_160_ ^ 0xffffffff) <= -1 && (i_158_ ^ 0xffffffff) < -1 && i_159_ > 0)
								is[i_149_][i_160_] = Node_Sub25.method2651(i_157_ / i_159_, i_156_ / i_159_, false,
										i_155_ * 256 / i_158_);
						}
					}
				}
				if (!Class382.aBoolean5254)
					method3340(i, (byte) -78, graphicstoolkit, is, i == 0 ? plane_147_ : null,
							Class320_Sub10.aPlaneArray8300[i], (i ^ 0xffffffff) == -1 ? plane : null);
				else
					method3348((i ^ 0xffffffff) == -1 ? plane_147_ : null, false, is,
							(i ^ 0xffffffff) != -1 ? null : plane, Class320_Sub10.aPlaneArray8300[i], graphicstoolkit,
							i);
	...
	public final void method3347(int i, int i_163_, int i_164_, int i_165_, int i_166_, int i_167_) {
		anInt3523++;
		for (int i_168_ = i_164_; (i_168_ ^ 0xffffffff) > (i_163_ + i_164_ ^ 0xffffffff); i_168_++)
			for (int i_169_ = i_165_; i_165_ + i_167_ > i_169_; i_169_++)
				if (i_169_ >= 0 && (anInt3524 ^ 0xffffffff) < (i_169_ ^ 0xffffffff) && i_168_ >= 0
						&& i_168_ < anInt3521)
					anIntArrayArrayArray3520[i_166_][i_169_][i_168_] = (i_166_ ^ 0xffffffff) >= -1 ? 0
							: anIntArrayArrayArray3520[i_166_ + -1][i_169_][i_168_] + -960;
		if (i_165_ > 0 && (i_165_ ^ 0xffffffff) > (anInt3524 ^ 0xffffffff))
			for (int i_170_ = i_164_ - -1; i_170_ < i_164_ - -i_163_; i_170_++)
				if (i_170_ >= 0 && i_170_ < anInt3521)
					anIntArrayArrayArray3520[i_166_][i_165_][i_170_] = anIntArrayArrayArray3520[i_166_][i_165_
							+ -1][i_170_];
		if (i_164_ > 0 && i_164_ < anInt3521)
			for (int i_171_ = 1 + i_165_; i_171_ < i_165_ - -i_167_; i_171_++)
				if (i_171_ >= 0 && i_171_ < anInt3524)
					anIntArrayArrayArray3520[i_166_][i_171_][i_164_] = anIntArrayArrayArray3520[i_166_][i_171_][i_164_
							+ -1];
		if (i != -13972)
			method3349(-48, -54, -84, -107, -23, null, -123, -43, null, (byte) 71);
		if ((i_165_ ^ 0xffffffff) <= -1 && (i_164_ ^ 0xffffffff) <= -1
				&& (anInt3524 ^ 0xffffffff) < (i_165_ ^ 0xffffffff) && (anInt3521 ^ 0xffffffff) < (i_164_ ^ 0xffffffff))
			if ((i_166_ ^ 0xffffffff) == -1) {
				if ((i_165_ ^ 0xffffffff) < -1
						&& (anIntArrayArrayArray3520[i_166_][i_165_ + -1][i_164_] ^ 0xffffffff) != -1)
					anIntArrayArrayArray3520[i_166_][i_165_][i_164_] = anIntArrayArrayArray3520[i_166_][i_165_
							- 1][i_164_];
				else if (i_164_ <= 0 || anIntArrayArrayArray3520[i_166_][i_165_][-1 + i_164_] == 0) {
					if (i_165_ > 0 && i_164_ > 0
							&& (anIntArrayArrayArray3520[i_166_][-1 + i_165_][-1 + i_164_] ^ 0xffffffff) != -1)
						anIntArrayArrayArray3520[i_166_][i_165_][i_164_] = anIntArrayArrayArray3520[i_166_][i_165_
								- 1][-1 + i_164_];
				} else
					anIntArrayArrayArray3520[i_166_][i_165_][i_164_] = anIntArrayArrayArray3520[i_166_][i_165_][i_164_
							- 1];
			} else if ((i_165_ ^ 0xffffffff) >= -1 || anIntArrayArrayArray3520[i_166_][i_165_
					- 1][i_164_] == anIntArrayArrayArray3520[i_166_ + -1][i_165_ + -1][i_164_]) {
				if (i_164_ <= 0 || anIntArrayArrayArray3520[i_166_][i_165_][i_164_
						+ -1] == anIntArrayArrayArray3520[i_166_ + -1][i_165_][-1 + i_164_]) {
					if (i_165_ > 0 && i_164_ > 0 && (anIntArrayArrayArray3520[-1 + i_166_][i_165_ - 1][-1 + i_164_]
							^ 0xffffffff) != (anIntArrayArrayArray3520[i_166_][i_165_ + -1][-1 + i_164_] ^ 0xffffffff))
						anIntArrayArrayArray3520[i_166_][i_165_][i_164_] = anIntArrayArrayArray3520[i_166_][i_165_
								- 1][i_164_ + -1];
				} else
					anIntArrayArrayArray3520[i_166_][i_165_][i_164_] = anIntArrayArrayArray3520[i_166_][i_165_][i_164_
				...
				anIntArrayArrayArray3520[i_166_][i_165_][i_164_] = anIntArrayArrayArray3520[i_166_][-1
						+ i_165_][i_164_];
	}

	private final void method3348(Plane plane, boolean bool, int[][] is, Plane plane_172_, Plane plane_173_,
			GraphicsToolkit graphicstoolkit, int i) {
		anInt3531++;
			...
			for (int i_179_ = 0; i_179_ < anInt3521; i_179_++) {
				...
				if (Class256.anInt3237 == -1 || Class369.method4085(i_179_, 0, Class256.anInt3237, i_177_, i)) {
					...
					if (i_184_ != 0 || i_185_ != 0) {
						Class289 class289 = (i_184_ ^ 0xffffffff) == -1 ? null
								: aClass71_3512.method743(-1 + i_184_, (byte) 118);
						...
						if (((b ^ 0xffffffff) == -1 || b == 12) && (i_177_ ^ 0xffffffff) < -1 && i_179_ > 0
								&& i_177_ < anInt3524 && anInt3521 > i_179_) {
							int i_190_ = 0;
							int i_191_ = 0;
							int i_192_ = 0;
							...
							if ((i_195_ ^ 0xffffffff) > -1)
								i_195_ = -i_195_;
							if (i_194_ == i_195_) {
								i_194_ = plane_173_.method3251(i_179_, i_177_, (byte) -118)
										- plane_173_.method3251(i_180_, i_178_, (byte) -118);
								if ((i_194_ ^ 0xffffffff) > -1)
									i_194_ = -i_194_;
								i_195_ = plane_173_.method3251(i_179_, i_178_, (byte) -118)
										- plane_173_.method3251(i_180_, i_177_, (byte) -118);
								if (i_195_ < 0)
									i_195_ = -i_195_;
							}
						...
						boolean[] bools_197_ = class289 != null && class289.aBoolean3643
								? Class250.aBooleanArrayArray3168[b] : Node_Sub33.aBooleanArrayArray7406[b];
						method3341(b, class289, bs_174_, anInt3524, 8, i_177_, i_183_, anInt3521, graphicstoolkit,
								i_179_, bools, class236, bs, bs_176_);
						boolean bool_198_ = class289 != null
								&& (class289.anInt3631 ^ 0xffffffff) != (class289.anInt3629 ^ 0xffffffff);
						if (!bool_198_)
							for (int i_199_ = 0; i_199_ < 8; i_199_++)
								if (Class327.anIntArray5348[i_199_] >= 0 && (Class262_Sub10.anIntArray7773[i_199_]
										^ 0xffffffff) != (Class188_Sub1_Sub1.anIntArray9339[i_199_] ^ 0xffffffff)) {
									bool_198_ = true;
									break;
								}
						if (!bools_197_[0x3 & 1 + i_183_])
							bools[1] = Class313.method3647(bools[1],
									(Node_Sub30.method2723(Class136.anIntArray1695[2], Class136.anIntArray1695[4])
											^ 0xffffffff) == -1);
						if (!bools_197_[0x3 & 3 + i_183_])
							bools[3] = Class313.method3647(bools[3],
									Node_Sub30.method2723(Class136.anIntArray1695[6], Class136.anIntArray1695[0]) == 0);
						if (!bools_197_[i_183_ & 0x3])
							bools[0] = Class313.method3647(bools[0],
									(Node_Sub30.method2723(Class136.anIntArray1695[0], Class136.anIntArray1695[2])
											^ 0xffffffff) == -1);
						if (!bools_197_[0x3 & 2 + i_183_])
							bools[2] = Class313.method3647(bools[2],
									(Node_Sub30.method2723(Class136.anIntArray1695[6], Class136.anIntArray1695[4])
											^ 0xffffffff) == -1);
						...
						if ((i_207_ ^ 0xffffffff) >= -1)
							...
							if (class289 == null) {
								...
								for (int i_223_ = 0; i_223_ < i_204_; i_223_++) {
									...
									if (!bools[-i_183_ & 0x3] || (is_201_[0] ^ 0xffffffff) != (i_208_ ^ 0xffffffff)) {
										if (!bools[0x3 & 2 - i_183_]
												|| (is_201_[2] ^ 0xffffffff) != (i_208_ ^ 0xffffffff)) {
											if (!bools[1 - i_183_ & 0x3]
													|| (is_201_[1] ^ 0xffffffff) != (i_208_ ^ 0xffffffff)) {
												if (bools[3 + -i_183_ & 0x3]
														&& (is_201_[3] ^ 0xffffffff) == (i_208_ ^ 0xffffffff)) {
									...
									for (int i_226_ = 0; i_225_ > i_226_; i_226_++) {
										...
										if (is_217_ != null && GLPlane.aBooleanArrayArray7950[b][i_227_]) {
											...
											is_217_[i_209_] = plane.method3260(i_234_, -115, i_233_)
													+ -plane_173_.method3260(i_234_, -112, i_233_);
										}
										if (is_218_ != null)
											if (plane == null || GLPlane.aBooleanArrayArray7950[b][i_227_]) {
												if (plane_172_ != null
														&& !Node_Sub15_Sub7.aBooleanArrayArray9822[b][i_227_]) {
													int i_235_ = i_232_ + (i_177_ << 9);
													int i_236_ = i_231_ + (i_179_ << 9);
													is_218_[i_209_] = plane_172_.method3260(i_236_, -109, i_235_)
															- plane_173_.method3260(i_236_, -115, i_235_);
												}
											} else {
												int i_237_ = i_232_ + (i_177_ << 9);
												int i_238_ = (i_179_ << 9) - -i_231_;
												is_218_[i_209_] = plane_173_.method3260(i_238_, -128, i_237_)
														- plane.method3260(i_238_, -111, i_237_);
											}
								...
								if (!aBoolean3516 && i == 0)
									Class158.method1725(i_177_, i_179_, class289.anInt3646, class289.anInt3634 * 8,
											class289.anInt3641);
								if ((b ^ 0xffffffff) != -13 && (class289.anInt3631 ^ 0xffffffff) != 0
										&& class289.aBoolean3638)
									bool_181_ = true;
							}
							if (class236 != null) {
								...
								for (int i_243_ = 0; (i_202_ ^ 0xffffffff) < (i_243_ ^ 0xffffffff); i_243_++) {
									...
									for (int i_246_ = 0; i_246_ < i_245_; i_246_++) {
										...
										if (is_217_ != null && GLPlane.aBooleanArrayArray7950[b][i_247_]) {
											...
											is_217_[i_209_] = plane.method3260(i_254_, -123, i_253_)
													- plane_173_.method3260(i_254_, -111, i_253_);
										}
										if (is_218_ != null)
											if (plane == null || GLPlane.aBooleanArrayArray7950[b][i_247_]) {
												if (plane_172_ != null
														&& !Node_Sub15_Sub7.aBooleanArrayArray9822[b][i_247_]) {
													int i_255_ = i_251_ + (i_177_ << 9);
													int i_256_ = (i_179_ << 9) + i_252_;
													is_218_[i_209_] = plane_172_.method3260(i_256_, -124, i_255_)
															- plane_173_.method3260(i_256_, -121, i_255_);
												}
											} else {
												int i_257_ = (i_177_ << 9) + i_251_;
												int i_258_ = i_252_ + (i_179_ << 9);
												is_218_[i_209_] = plane_173_.method3260(i_258_, -117, i_257_)
														- plane.method3260(i_258_, -116, i_257_);
											}
											...
											if (!bool_182_ || !GLPlane.aBooleanArrayArray7950[b][i_247_]) {
												if ((i_251_ ^ 0xffffffff) == -1 && i_252_ == 0) {
													...
													if (i_251_ == 512 && i_252_ == 512) {
														...
														int i_259_ = Node_Sub25_Sub1.method2664(is[i_178_][i_179_], 128,
																i_251_ << 7 >> 9, is[i_177_][i_179_]);
														int i_260_ = Node_Sub25_Sub1.method2664(is[i_178_][i_180_], 128,
																i_251_ << 7 >> 9, is[i_177_][i_180_]);
														is_214_[i_209_] = Node_Sub25_Sub1.method2664(i_260_, 128,
																i_252_ << 7 >> 9, i_259_);
													}
												} else {
							...
							if (bool_265_ && (i ^ 0xffffffff) < -2 || !bool_265_ && i > 0) {
								...
								if (class236 == null || class236.aBoolean2892) {
									if (i_185_ == 0 && b != 0)
										bool_266_ = false;
									else if ((i_184_ ^ 0xffffffff) < -1 && class289_189_ != null
											&& !class289_189_.aBoolean3636)
										bool_266_ = false;
								} else
									bool_266_ = false;
								if (bool_266_ && i_262_ == i_261_ && i_263_ == i_261_
										&& (i_261_ ^ 0xffffffff) == (i_264_ ^ 0xffffffff))
									aByteArrayArrayArray3526[i][i_177_][i_179_] = (byte) Node_Sub16
											.method2590(aByteArrayArrayArray3526[i][i_177_][i_179_], 4);
							}
							int i_267_ = 0;
							int i_268_ = 0;
							int i_269_ = 0;
							...
							plane_173_.U(i_177_, i_179_, is_212_, is_217_, is_213_, is_218_, is_214_, is_211_, is_215_,
									is_216_, i_267_, i_268_, i_269_, bool_181_);
							Class320_Sub24.method3775(i, i_177_, i_179_);
						}
					}
				}
	...
	public final void method3349(int i, int i_270_, int i_271_, int i_272_, int i_273_, BufferedStream buffer, int i_274_,
			int i_275_, Class84[] class84s, byte b) {
		anInt3514++;
		if (b > -115)
			anInt3535 = 62;
		...
		if (!aBoolean3516) {
			...
			for (int i_278_ = 0; i_278_ < 8; i_278_++)
				for (int i_279_ = 0; i_279_ < 8; i_279_++) {
					...
					if ((i_280_ ^ 0xffffffff) < -1 && (anInt3524 + -1 ^ 0xffffffff) < (i_280_ ^ 0xffffffff)
							&& i_281_ > 0 && (i_281_ ^ 0xffffffff) > (anInt3521 - 1 ^ 0xffffffff))
		...
		for (int i_286_ = 0; i_286_ < anInt3535; i_286_++)
			for (int i_287_ = 0; (i_287_ ^ 0xffffffff) > -65; i_287_++)
				for (int i_288_ = 0; i_288_ < 64; i_288_++)
					if ((i_270_ ^ 0xffffffff) != (i_286_ ^ 0xffffffff) || (i_287_ ^ 0xffffffff) > (i_276_ ^ 0xffffffff)
							|| i_287_ > 8 + i_276_ || (i_277_ ^ 0xffffffff) < (i_288_ ^ 0xffffffff)
							|| i_288_ > 8 + i_277_)
						...
						if ((i_276_ - -8 ^ 0xffffffff) == (i_287_ ^ 0xffffffff) || i_288_ == 8 + i_277_) {
							...
							method3345(0, i_290_, 0, i_289_, i_287_ + i_282_, buffer, 0, i_288_ + i_283_, i, -682,
									true);
						} else {
							...
							method3345(i_274_, i_290_, i_285_, i_289_, i_287_ + i_282_, buffer, i_284_, i_288_ + i_283_,
									i, -682, false);
						}
						if (i_287_ == 63 || i_288_ == 63) {
							...
							for (int i_292_ = 0; (i_291_ ^ 0xffffffff) < (i_292_ ^ 0xffffffff); i_292_++) {
								...
								if (i_296_ >= 0 && anInt3524 > i_296_ && i_295_ >= 0 && anInt3521 > i_295_)
									anIntArrayArrayArray3520[i][i_296_][i_295_] = anIntArrayArrayArray3520[i][i_284_
											+ i_289_][i_290_ - -i_285_];
							}
						}
					}
	}
