...
public class Class277_Sub1 extends Class277 {
	public static OutgoingPacket aClass318_8050 = new OutgoingPacket(29, -1);
	...
	public static int anInt8047;
	public static int anInt8048;
	public static int anInt8049;
	public static int anInt8051;
	public static int anInt8052;
	public static int[][][] anIntArrayArrayArray8042 = new int[2][][];

	public static final void method3357(boolean bool) {
		...
		if (!Class372.aBoolean4599 || !Class180.aBoolean2135) {
			...
			if (Class106.aClass93_1356.method1041((byte) 34)) {
				if (Class58.aWidget861.anInt4795 < RuntimeException_Sub1.anInt4916) {
					...
					if ((Class58.aWidget861.anInt4708 ^ 0xffffffff) > (i_158_ ^ 0xffffffff)
							|| (-Class58.aWidget861.anInt4708 ^ 0xffffffff) < (i_158_ ^ 0xffffffff)
							|| (Class58.aWidget861.anInt4708 ^ 0xffffffff) > (i_159_ ^ 0xffffffff)
				...
				if (Class99.aBoolean1282) {
					...
					if (Node_Sub38_Sub14.aWidget10244 != null && ConnectionDecoder.method109(Class58.aWidget861) != null)
						Class377.method4124(27547, Class58.aWidget861, Node_Sub38_Sub14.aWidget10244);
				} else if (Class121.anInt1521 != 1 && !Node_Sub16.method2594(true) || Class315.menuOptionCount <= 2) {
					if (Class46.method469(255))
						Class244.method3064((byte) -80, Node_Sub25_Sub4.anInt10005 + Node_Sub5_Sub2.anInt9412,
								Class60.anInt880 + Class83.anInt5179);
				} else
					Class244.method3064((byte) -86, Node_Sub5_Sub2.anInt9412 - -Node_Sub25_Sub4.anInt10005,
							Class60.anInt880 + Class83.anInt5179);
				Class58.aWidget861 = null;
			}
		}
	...
	public static final void method3360(byte b, Node_Sub14 node_sub14, GraphicsToolkit graphicstoolkit, Class79 class79) {
		anInt8044++;
		...
		if (glsprite != null) {
			...
			if (class79.aString1085 != null) {
				i_168_ = Class85.aClass357_1159.method4029(Node_Sub38_Sub3.aStringArray10107, null, b + -84, null,
						class79.aString1085);
			...
			int i_175_ = (int) (32767.0
					* (Math.atan2(i_166_ - node_sub14.anInt7126, i_167_ - node_sub14.anInt7118) / 3.141592653589793))
					& 0xffff;
			glsprite.method1180(i_166_ + i / 2.0F, i_167_ + i / 2.0F, 4096, i_175_);
			int i_176_ = -2;
			int i_177_ = -2;
			if (b != 43)
				method3357(true);
			...
			if (class79.aString1085 != null) {
				...
				if ((class79.anInt1077 ^ 0xffffffff) != -1)
					graphicstoolkit.method1239(i_178_ + -i_176_, i_179_ - i_177_, i_177_, (byte) 116, i_176_,
							class79.anInt1077);
				if ((class79.anInt1081 ^ 0xffffffff) != -1)
					graphicstoolkit.method1234(i_177_, class79.anInt1081, i_178_ + -i_176_, i_179_ - i_177_, (byte) -64,
							i_176_);
	...
	public final void method3350(int i, int i_0_, int i_1_, Class84[] class84s, GraphicsToolkit graphicstoolkit, byte[] bs) {
		anInt8052++;
		...
		for (;;) {
			...
			for (;;) {
				...
				int i_13_ = i_8_ - -i;
				int i_14_ = i_0_ + i_7_;
				if (i_13_ > 0 && (i_14_ ^ 0xffffffff) < -1 && i_13_ < -1 + anInt3524
						&& (i_14_ ^ 0xffffffff) > (anInt3521 + -1 ^ 0xffffffff)) {
	...
	public final void method3351(int i, BufferedStream buffer, int i_16_, GraphicsToolkit graphicstoolkit, int i_17_) {
		anInt8043++;
		if (!aBoolean3516) {
			boolean bool = false;
										...
										if ((b ^ 0xffffffff) != -2) {
											if ((b ^ 0xffffffff) == -3) {
												if (aByteArrayArrayArray3518[i_19_] == null)
													aByteArrayArrayArray3518[i_19_] = new byte[1 + anInt3524][anInt3521
															+ 1];
												if ((i_19_ ^ 0xffffffff) < -1) {
													...
													for (/**/; (i_20_ ^ 0xffffffff) > (i_21_ ^ 0xffffffff); i_20_++)
														for (/**/; i_23_ > i_22_; i_22_++)
															aByteArrayArrayArray3518[i_19_][i_20_][i_22_] = aByteArrayArrayArray3518[-1
																	+ i_19_][i_20_][i_22_];
												}
											}
										} else {
											if (aByteArrayArrayArray3518[i_19_] == null)
												aByteArrayArrayArray3518[i_19_] = new byte[1 + anInt3524][1
														+ anInt3521];
											for (int i_24_ = 0; (i_24_ ^ 0xffffffff) > -65; i_24_ += 4)
												for (int i_25_ = 0; i_25_ < 64; i_25_ += 4) {
													byte b_26_ = buffer.readByte();
													for (int i_27_ = i_24_ - -i_16_; (i_27_
															^ 0xffffffff) > (4 + (i_24_ + i_16_) ^ 0xffffffff); i_27_++)
														for (int i_28_ = i + i_25_; (i_28_
																^ 0xffffffff) > (i + (i_25_ - -4)
																		^ 0xffffffff); i_28_++)
															if ((i_27_ ^ 0xffffffff) <= -1
																	&& (anInt3524 ^ 0xffffffff) < (i_27_ ^ 0xffffffff)
																	&& i_28_ >= 0 && anInt3521 > i_28_)
						...
						if ((i_33_ ^ 0xffffffff) < -1)
							for (int i_34_ = 0; (i_34_ ^ 0xffffffff) > (i_33_ ^ 0xffffffff); i_34_++) {
								...
								if (class326.anInt4110 == 31) {
									Class367 class367 = CS2Definition.aClass359_508.method4039(buffer.readUnsignedShort(),
											(byte) 123);
									class326.method3819(class367.anInt4538, (byte) -27, class367.anInt4536,
											class367.anInt4537, class367.anInt4542);
								}
								if ((graphicstoolkit.e() ^ 0xffffffff) < -1) {
									...
									if (i_37_ >= 0 && i_38_ >= 0 && anInt3524 > i_37_ && anInt3521 > i_38_) {
										node_sub29.method2706(4752, i_35_, i_36_,
												anIntArrayArrayArray3520[class326.anInt4092][i_37_][i_38_]
														- node_sub29.method2704(30));
			...
			if (class343 != null)
				for (int i_39_ = 0; (i_39_ ^ 0xffffffff) > -9; i_39_++)
					for (int i_40_ = 0; i_40_ < 8; i_40_++) {
						...
						int i_42_ = i_40_ + (i >> 3);
						if ((i_41_ ^ 0xffffffff) <= -1 && anInt3524 >> 3 > i_41_ && i_42_ >= 0
								&& (anInt3521 >> 3 ^ 0xffffffff) < (i_42_ ^ 0xffffffff))
					...
					if (aByteArrayArrayArray3518[i_43_] != null)
						for (int i_44_ = 0; i_44_ < 16; i_44_++)
							for (int i_45_ = 0; (i_45_ ^ 0xffffffff) > -17; i_45_++) {
								...
								int i_47_ = (i >> 2) - -i_45_;
								if ((i_46_ ^ 0xffffffff) <= -1 && (i_46_ ^ 0xffffffff) > -27
										&& (i_47_ ^ 0xffffffff) <= -1 && (i_47_ ^ 0xffffffff) > -27)
									aByteArrayArrayArray3518[i_43_][i_46_][i_47_] = (byte) 0;
							}
		}
	}

	public final void method3352(int i, int objectId, Class84 class84, int i_49_, GraphicsToolkit graphicstoolkit, int i_50_,
			int i_51_, int i_52_, int i_53_, int i_54_, int i_55_) {
		anInt8048++;
		if ((Class213.aNode_Sub27_2512.aClass320_Sub19_7301.method3751(false) ^ 0xffffffff) != -1
				|| Class369.method4085(i_49_, 0, Class94.anInt1249, i_50_, i_53_)) {
			if ((i_54_ ^ 0xffffffff) > (anInt8046 ^ 0xffffffff))
				anInt8046 = i_54_;
			ObjectDefinition objectdefinition = Class186.aClass112_2256.method1145(objectId, 82);
			if (Class213.aNode_Sub27_2512.aClass320_Sub30_7275.method3796(false) != 0
					|| !objectdefinition.aBoolean2990) {
				int i_56_;
				int i_57_;
				...
				int i_62_ = plane.method3251(i_60_, i_59_, (byte) -118) + plane.method3251(i_60_, i_58_, (byte) -118)
						- (-plane.method3251(i_61_, i_59_, (byte) -118)
								- plane.method3251(i_61_, i_58_, (byte) -118)) >> 2;
				...
				boolean bool_65_ = i_55_ == -1 && !objectdefinition.method3037(0)
						&& objectdefinition.objectWithSprite == null && !objectdefinition.aBoolean2998
						&& !objectdefinition.aBoolean2992;
				if (!Class326.aBoolean4109 || (!r.method2361(i, 35) || (objectdefinition.anInt2977 ^ 0xffffffff) == -2)
						&& (!Node_Sub38_Sub18.method2844(i, true) || objectdefinition.anInt2977 != 0))
					if (i == 22) {
						if (Class213.aNode_Sub27_2512.aClass320_Sub6_7267.method3701(false) != 0
								|| (objectdefinition.anInt3057 ^ 0xffffffff) != -1 || objectdefinition.anInt3010 == 1
								|| objectdefinition.aBoolean3051) {
							Animable_Sub1 animable_sub1;
							if (!bool_65_)
								animable_sub1 = new Animable_Sub1_Sub2(graphicstoolkit, objectdefinition, i_54_, i_53_,
										i_63_, i_62_, i_64_, aBoolean3516, i_51_, i_55_);
							else {
								Animable_Sub1_Sub1 animable_sub1_sub1 = new Animable_Sub1_Sub1(graphicstoolkit,
										objectdefinition, i_54_, i_53_, i_63_, i_62_, i_64_, aBoolean3516, i_51_, bool);
						...
						Mobile mobile;
						if (bool_65_) {
							Mobile_Sub2 mobile_sub2_67_ = new Mobile_Sub2(graphicstoolkit, objectdefinition, i_54_,
									i_53_, i_63_, i_62_, i_64_, aBoolean3516, i_50_, -1 + (i_50_ - -i_57_), i_49_,
									-1 + (i_49_ - -i_56_), i, i_51_, bool);
							mobile_sub2 = mobile_sub2_67_;
							mobile = mobile_sub2_67_;
							i_66_ = mobile_sub2_67_.method903(-78);
						} else {
							i_66_ = 15;
							mobile = new Mobile_Sub3(graphicstoolkit, objectdefinition, i_54_, i_53_, i_63_, i_62_,
									i_64_, aBoolean3516, i_50_, -1 + i_50_ + i_57_, i_49_, -1 + (i_49_ - -i_56_), i,
									i_51_, i_55_);
						}
						...
						if ((objectdefinition.anInt3010 ^ 0xffffffff) != -1 && class84 != null)
							class84.method996(i_50_, i_56_, 1, i_49_, !objectdefinition.aBoolean3016, i_57_,
									objectdefinition.aBoolean3034);
					} else if ((i ^ 0xffffffff) <= -13 && (i ^ 0xffffffff) >= -18
							|| i >= 18 && (i ^ 0xffffffff) >= -22) {
						Mobile mobile;
						if (bool_65_) {
							Mobile_Sub2 mobile_sub2 = new Mobile_Sub2(graphicstoolkit, objectdefinition, i_54_, i_53_,
									i_63_, i_62_, i_64_, aBoolean3516, i_50_, -1 + (i_50_ - -i_57_), i_49_,
									-1 + (i_49_ - -i_56_), i, i_51_, bool);
							...
							mobile = new Mobile_Sub3(graphicstoolkit, objectdefinition, i_54_, i_53_, i_63_, i_62_,
									i_64_, aBoolean3516, i_50_, -1 + i_57_ + i_50_, i_49_, i_49_ - (-i_56_ - -1), i,
									i_51_, i_55_);
						Node_Sub38_Sub7.method2810(mobile, false);
						if (Class217.aBoolean2552 && !aBoolean3516 && i >= 12 && i <= 17 && (i ^ 0xffffffff) != -14
								&& (i_54_ ^ 0xffffffff) < -1 && objectdefinition.anInt2977 != 0)
							aByteArrayArrayArray3526[i_54_][i_50_][i_49_] = (byte) Node_Sub16
									.method2590(aByteArrayArrayArray3526[i_54_][i_50_][i_49_], 4);
						if ((objectdefinition.anInt3010 ^ 0xffffffff) != -1 && class84 != null)
							class84.method996(i_50_, i_56_, 1, i_49_, !objectdefinition.aBoolean3016, i_57_,
									objectdefinition.aBoolean3034);
					} else if ((i ^ 0xffffffff) == -1) {
						int i_70_ = objectdefinition.anInt2977;
						if (KeyStrokeHandler.aBoolean8188 && objectdefinition.anInt2977 == -1)
							i_70_ = 1;
						Animable_Sub2 animable_sub2;
						if (bool_65_) {
							Animable_Sub2_Sub2 animable_sub2_sub2 = new Animable_Sub2_Sub2(graphicstoolkit,
									objectdefinition, i_54_, i_53_, i_63_, i_62_, i_64_, aBoolean3516, i, i_51_, bool);
							animable_sub2 = animable_sub2_sub2;
							if (animable_sub2_sub2.method73(-19717))
								animable_sub2_sub2.method74(graphicstoolkit, -113);
						} else
							animable_sub2 = new Animable_Sub2_Sub1(graphicstoolkit, objectdefinition, i_54_, i_53_,
									i_63_, i_62_, i_64_, aBoolean3516, i, i_51_, i_55_);
						...
						if (i_51_ != 0) {
							if (i_51_ == 1) {
								...
								if ((i_70_ ^ 0xffffffff) == -2 && !aBoolean3516)
									Class320_Sub6.method3703(2, (byte) 86, -objectdefinition.anInt2962, 1 + i_49_,
											i_50_, i_54_, objectdefinition.anInt3032);
								...
								if (i_51_ == 3) {
									...
									if ((i_70_ ^ 0xffffffff) == -2 && !aBoolean3516)
										Class320_Sub6.method3703(2, (byte) 109, objectdefinition.anInt2962, i_49_,
												i_50_, i_54_, objectdefinition.anInt3032);
								}
							} else {
								if (Class217.aBoolean2552 && objectdefinition.aBoolean3033) {
								...
								if (i_70_ == 1 && !aBoolean3516)
									Class320_Sub6.method3703(1, (byte) 83, -objectdefinition.anInt2962, i_49_,
											1 + i_50_, i_54_, objectdefinition.anInt3032);
							}
						} else {
							if (Class217.aBoolean2552 && objectdefinition.aBoolean3033) {
								plane.ka(i_50_, i_49_, 50);
							...
							if ((i_70_ ^ 0xffffffff) == -2 && !aBoolean3516)
								Class320_Sub6.method3703(1, (byte) 53, objectdefinition.anInt2962, i_49_, i_50_, i_54_,
										objectdefinition.anInt3032);
						}
						if ((objectdefinition.anInt3010 ^ 0xffffffff) != -1 && class84 != null)
							class84.method986(106, objectdefinition.aBoolean3034, !objectdefinition.aBoolean3016, i_49_,
									i_51_, i, i_50_);
						...
						if (objectdefinition.anInt3010 != 0 && class84 != null)
							class84.method986(76, objectdefinition.aBoolean3034, !objectdefinition.aBoolean3016, i_49_,
									i_51_, i, i_50_);
					} else if (i == 2) {
						...
						if (!bool_65_) {
							animable_sub2_72_ = new Animable_Sub2_Sub1(graphicstoolkit, objectdefinition, i_54_, i_53_,
									i_63_, i_62_, i_64_, aBoolean3516, i, 4 + i_51_, i_55_);
							animable_sub2 = new Animable_Sub2_Sub1(graphicstoolkit, objectdefinition, i_54_, i_53_,
									i_63_, i_62_, i_64_, aBoolean3516, i, i_71_, i_55_);
						} else {
							Animable_Sub2_Sub2 animable_sub2_sub2 = new Animable_Sub2_Sub2(graphicstoolkit,
									objectdefinition, i_54_, i_53_, i_63_, i_62_, i_64_, aBoolean3516, i, i_51_ + 4,
									bool);
							Animable_Sub2_Sub2 animable_sub2_sub2_73_ = new Animable_Sub2_Sub2(graphicstoolkit,
									objectdefinition, i_54_, i_53_, i_63_, i_62_, i_64_, aBoolean3516, i, i_71_, bool);
							if (animable_sub2_sub2.method73(-19717))
						...
						if ((objectdefinition.anInt2977 == 1
								|| KeyStrokeHandler.aBoolean8188 && objectdefinition.anInt2977 == -1) && !aBoolean3516)
							if ((i_51_ ^ 0xffffffff) == -1) {
								Class320_Sub6.method3703(1, (byte) 110, objectdefinition.anInt2962, i_49_, i_50_, i_54_,
										objectdefinition.anInt3032);
								Class320_Sub6.method3703(2, (byte) 106, objectdefinition.anInt2962, 1 + i_49_, i_50_,
										i_54_, objectdefinition.anInt3032);
							} else if (i_51_ == 1) {
								Class320_Sub6.method3703(1, (byte) 42, objectdefinition.anInt2962, i_49_, i_50_ + 1,
										i_54_, objectdefinition.anInt3032);
								Class320_Sub6.method3703(2, (byte) 37, objectdefinition.anInt2962, 1 + i_49_, i_50_,
										i_54_, objectdefinition.anInt3032);
							} else if (i_51_ == 2) {
								Class320_Sub6.method3703(1, (byte) 117, objectdefinition.anInt2962, i_49_, 1 + i_50_,
										i_54_, objectdefinition.anInt3032);
								Class320_Sub6.method3703(2, (byte) 55, objectdefinition.anInt2962, i_49_, i_50_, i_54_,
										objectdefinition.anInt3032);
							} else if (i_51_ == 3) {
								Class320_Sub6.method3703(1, (byte) 95, objectdefinition.anInt2962, i_49_, i_50_, i_54_,
										objectdefinition.anInt3032);
								Class320_Sub6.method3703(2, (byte) 44, objectdefinition.anInt2962, i_49_, i_50_, i_54_,
										objectdefinition.anInt3032);
							}
						if (objectdefinition.anInt3010 != 0 && class84 != null)
							class84.method986(-35, objectdefinition.aBoolean3034, !objectdefinition.aBoolean3016, i_49_,
									i_51_, i, i_50_);
						...
						if (objectdefinition.aBoolean3033 && Class217.aBoolean2552)
							if ((i_51_ ^ 0xffffffff) != -1) {
								...
								plane.ka(i_50_, 1 + i_49_, 50);
						if ((objectdefinition.anInt3010 ^ 0xffffffff) != -1 && class84 != null)
							class84.method986(-43, objectdefinition.aBoolean3034, !objectdefinition.aBoolean3016, i_49_,
									i_51_, i, i_50_);
					} else if (i == 9) {
						Mobile mobile;
						if (!bool_65_)
							mobile = new Mobile_Sub3(graphicstoolkit, objectdefinition, i_54_, i_53_, i_63_, i_62_,
									i_64_, aBoolean3516, i_50_, -1 + (i_57_ + i_50_), i_49_, i_56_ + (i_49_ + -1), i,
									i_51_, i_55_);
						else {
							Mobile_Sub2 mobile_sub2 = new Mobile_Sub2(graphicstoolkit, objectdefinition, i_54_, i_53_,
									i_63_, i_62_, i_64_, aBoolean3516, i_50_, i_50_, i_49_, i_49_, i, i_51_, bool);
							if (mobile_sub2.method73(-19717))
						...
						if (objectdefinition.anInt2977 == 1 && !aBoolean3516) {
							...
							if ((0x1 & i_51_) == 0)
								...
								i_74_ = 16;
							Class320_Sub6.method3703(i_74_, (byte) 65, 0, i_49_, i_50_, i_54_,
									objectdefinition.anInt3032);
						}
						if (objectdefinition.anInt3010 != 0 && class84 != null)
							class84.method996(i_50_, i_56_, 1, i_49_, !objectdefinition.aBoolean3016, i_57_,
						...
						if (bool_65_) {
							Animable_Sub4_Sub1 animable_sub4_sub1 = new Animable_Sub4_Sub1(graphicstoolkit,
									objectdefinition, i_54_, i_53_, i_63_, i_62_, i_64_, aBoolean3516, 0, 0, i, i_51_);
							if (animable_sub4_sub1.method73(-19717))
								animable_sub4_sub1.method74(graphicstoolkit, -59);
							animable_sub4 = animable_sub4_sub1;
						} else
							animable_sub4 = new Animable_Sub4_Sub2(graphicstoolkit, objectdefinition, i_54_, i_53_,
									i_63_, i_62_, i_64_, aBoolean3516, 0, 0, i, i_51_, i_55_);
						...
						if (interface19 != null)
							i_75_ = 1 + Class186.aClass112_2256.method1145(interface19.getObjectId(-32136), 32).anInt3011;
						Animable_Sub4 animable_sub4;
						if (!bool_65_)
							animable_sub4 = new Animable_Sub4_Sub2(graphicstoolkit, objectdefinition, i_54_, i_53_,
									i_63_, i_62_, i_64_, aBoolean3516, Node_Sub38.anIntArray7452[i_51_] * i_75_,
									i_75_ * PlayerUpdateReference.anIntArray4083[i_51_], i, i_51_, i_55_);
						else {
							Animable_Sub4_Sub1 animable_sub4_sub1 = new Animable_Sub4_Sub1(graphicstoolkit,
									objectdefinition, i_54_, i_53_, i_63_, i_62_, i_64_, aBoolean3516,
									Node_Sub38.anIntArray7452[i_51_] * i_75_,
									PlayerUpdateReference.anIntArray4083[i_51_] * i_75_, i, i_51_);
							if (animable_sub4_sub1.method73(-19717))
						...
						Interface19 interface19 = (Interface19) Node_Sub38_Sub12.method2830(i_54_, i_50_, i_49_);
						if (interface19 != null)
							i_76_ = 1 + Class186.aClass112_2256.method1145(interface19.getObjectId(-32136), 115).anInt3011
									/ 2;
						Animable_Sub4 animable_sub4;
						if (bool_65_) {
							Animable_Sub4_Sub1 animable_sub4_sub1 = new Animable_Sub4_Sub1(graphicstoolkit,
									objectdefinition, i_54_, i_53_, i_63_, i_62_, i_64_, aBoolean3516,
									Node_Sub38.anIntArray7452[i_51_] * i_76_,
									i_76_ * PlayerUpdateReference.anIntArray4083[i_51_], i, i_51_ - -4);
							animable_sub4 = animable_sub4_sub1;
							if (animable_sub4_sub1.method73(-19717))
								animable_sub4_sub1.method74(graphicstoolkit, -105);
						} else
							animable_sub4 = new Animable_Sub4_Sub2(graphicstoolkit, objectdefinition, i_54_, i_53_,
									i_63_, i_62_, i_64_, aBoolean3516, Class219.anIntArray2625[i_51_] * i_76_,
									Class342.anIntArray4237[i_51_] * i_76_, i, 4 + i_51_, i_55_);
						Class320_Sub6.method3705(i_54_, i_50_, i_49_, animable_sub4, null);
						...
						if (bool_65_) {
							Animable_Sub4_Sub1 animable_sub4_sub1 = new Animable_Sub4_Sub1(graphicstoolkit,
									objectdefinition, i_54_, i_53_, i_63_, i_62_, i_64_, aBoolean3516, 0, 0, i,
									i_77_ + 4);
							animable_sub4 = animable_sub4_sub1;
							if (animable_sub4_sub1.method73(-19717))
							...
							animable_sub4 = new Animable_Sub4_Sub2(graphicstoolkit, objectdefinition, i_54_, i_53_,
									i_63_, i_62_, i_64_, aBoolean3516, 0, 0, i, i_77_ + 4, i_55_);
						Class320_Sub6.method3705(i_54_, i_50_, i_49_, animable_sub4, null);
						...
						Interface19 interface19 = (Interface19) Node_Sub38_Sub12.method2830(i_54_, i_50_, i_49_);
						if (interface19 != null)
							i_80_ = Class186.aClass112_2256.method1145(interface19.getObjectId(-32136), 92).anInt3011 / 2
									- -1;
						Animable_Sub4 animable_sub4;
						Animable_Sub4 animable_sub4_81_;
						if (!bool_65_) {
							Animable_Sub4_Sub2 animable_sub4_sub2 = new Animable_Sub4_Sub2(graphicstoolkit,
									objectdefinition, i_54_, i_53_, i_63_, i_62_, i_64_, aBoolean3516,
									Class219.anIntArray2625[i_51_] * i_80_, Class342.anIntArray4237[i_51_] * i_80_, i,
									i_51_ - -4, i_55_);
							animable_sub4_81_ = animable_sub4_sub2;
							Animable_Sub4_Sub2 animable_sub4_sub2_82_ = new Animable_Sub4_Sub2(graphicstoolkit,
									objectdefinition, i_54_, i_53_, i_63_, i_62_, i_64_, aBoolean3516, 0, 0, i,
									4 + i_79_, i_55_);
							...
							Animable_Sub4_Sub1 animable_sub4_sub1 = new Animable_Sub4_Sub1(graphicstoolkit,
									...
									Class219.anIntArray2625[i_51_] * i_80_, Class342.anIntArray4237[i_51_] * i_80_, i,
									4 + i_51_);
							Animable_Sub4_Sub1 animable_sub4_sub1_83_ = new Animable_Sub4_Sub1(graphicstoolkit,
									objectdefinition, i_54_, i_53_, i_63_, i_62_, i_64_, aBoolean3516, 0, 0, i,
									4 + i_79_);
							if (animable_sub4_sub1.method73(-19717))
	...
	public final void method3353(int i, int i_84_, GraphicsToolkit graphicstoolkit, int i_85_, BufferedStream buffer,
					...
					if ((i_94_ ^ 0xffffffff) < -1)
						for (int i_95_ = 0; (i_95_ ^ 0xffffffff) > (i_94_ ^ 0xffffffff); i_95_++) {
							...
							if (graphicstoolkit.e() > 0) {
								...
								if (i_89_ == class326.anInt4092 && i_96_ >= i_91_
										&& (i_96_ ^ 0xffffffff) > (8 + i_91_ ^ 0xffffffff)
										&& (i_97_ ^ 0xffffffff) <= (i_92_ ^ 0xffffffff) && i_92_ + 8 > i_97_) {
									int i_98_ = Class17.method261(false, 0xfff & node_sub29.method2705(32311),
											0xfff & node_sub29.method2708(27433), i_88_) + (i << 9);
									i_96_ = i_98_ >> 9;
									int i_99_ = (i_90_ << 9)
											+ Node_Sub38.method2781(0xfff & node_sub29.method2708(i_84_ + 29103), i_88_,
													0xfff & node_sub29.method2705(32311), 27542);
									i_97_ = i_99_ >> 9;
									if ((i_96_ ^ 0xffffffff) <= -1 && i_97_ >= 0 && i_96_ < anInt3524
											&& anInt3521 > i_97_) {
										node_sub29.method2706(i_84_ ^ ~0x1415, i_98_, i_99_,
												anIntArrayArrayArray3520[i_89_][i_96_][i_97_]
														- node_sub29.method2704(30));
										Class370.method4089(class326);
									}
								}
							...
							for (int i_105_ = 0; i_105_ < 64; i_105_ += 4)
								for (int i_106_ = 0; i_106_ < 64; i_106_ += 4) {
									...
									if ((i_89_ ^ 0xffffffff) <= (i_100_ ^ 0xffffffff))
										for (int i_108_ = i_105_; (i_108_ ^ 0xffffffff) > (i_105_ - -4
												^ 0xffffffff); i_108_++)
											for (int i_109_ = i_106_; (4 + i_106_ ^ 0xffffffff) < (i_109_
													^ 0xffffffff); i_109_++)
												if ((i_108_ ^ 0xffffffff) <= (i_91_ ^ 0xffffffff) && 8 + i_91_ > i_108_
														&& i_109_ >= i_92_
														&& (i_92_ - -8 ^ 0xffffffff) < (i_109_ ^ 0xffffffff)) {
													int i_110_ = i
															+ Class339.method3921(0x7 & i_108_, i_109_ & 0x7, 7, i_88_);
													int i_111_ = i_90_ - -Class280.method3378(0x7 & i_109_,
															i_108_ & 0x7, (byte) 125, i_88_);
													if (i_110_ >= 0 && i_110_ < anInt3524 && (i_111_ ^ 0xffffffff) <= -1
															&& i_111_ < anInt3521) {
	...
	public final Interface19 method3354(int i, int i_116_, int i_117_, int i_118_, int i_119_) {
		anInt8049++;
		...
		if ((i_118_ ^ 0xffffffff) == -3)
			interface19 = (Interface19) Class262_Sub20.method3203(i_117_, i, i_116_,
					aClass8053 != null ? aClass8053 : (aClass8053 = method3361("Interface19")));
	...
	public final void method3355(int i, Class84[] class84s, int i_120_, GraphicsToolkit graphicstoolkit, byte b, int i_121_,
			int i_122_, byte[] bs, int i_123_, int i_124_, int i_125_) {
		anInt8041++;
		if (b <= 8)
		...
		for (;;) {
			...
			for (;;) {
				...
				if ((i_124_ ^ 0xffffffff) == (i_132_ ^ 0xffffffff) && i <= i_131_
						&& (i_131_ ^ 0xffffffff) > (i + 8 ^ 0xffffffff) && i_125_ <= i_130_ && i_130_ < 8 + i_125_) {
					ObjectDefinition objectdefinition = Class186.aClass112_2256.method1145(objectid, 89);
					int i_136_ = CS2Definition.method354(objectdefinition.anInt3055, 0x7 & i_130_, (byte) 45,
							objectdefinition.anInt2986, i_135_, i_131_ & 0x7, i_123_) + i_121_;
					int i_137_ = Class275.method3336(i_123_, 0x7 & i_130_, objectdefinition.anInt2986, i_135_,
							objectdefinition.anInt3055, i_131_ & 0x7, 104) + i_122_;
					if (i_136_ > 0 && i_137_ > 0 && (i_136_ ^ 0xffffffff) > (-1 + anInt3524 ^ 0xffffffff)
							&& (i_137_ ^ 0xffffffff) > (-1 + anInt3521 ^ 0xffffffff)) {
						Class84 class84 = null;
						if (!aBoolean3516) {
							int i_138_ = i_120_;
						...
						method3352(i_134_, objectid, class84, i_137_, graphicstoolkit, i_136_, 0x3 & i_123_ + i_135_,
								84, i_120_, i_120_, -1);
					}
				}
			}
	...
	public final void method3356(boolean bool, GraphicsToolkit graphicstoolkit, byte b) {
		anInt8045++;
		Class170.method1788();
		if (b != 83)
			method3358(true);
				...
				for (int i_140_ = 0; (anInt3521 ^ 0xffffffff) <= (i_140_ ^ 0xffffffff); i_140_++)
					for (int i_141_ = 0; (i_141_ ^ 0xffffffff) >= (anInt3524 ^ 0xffffffff); i_141_++)
						if ((aByteArrayArrayArray3526[i][i_141_][i_140_] & 0x4 ^ 0xffffffff) != -1) {
							...
							int i_144_ = i_140_;
							int i_145_ = i_140_;
							for (/**/; (i_144_ ^ 0xffffffff) < -1
									&& (aByteArrayArrayArray3526[i][i_141_][-1 + i_144_] & 0x4
											^ 0xffffffff) != -1; i_144_--)
								if ((i_145_ + -i_144_ ^ 0xffffffff) <= -11)
									break;
							for (/**/; i_145_ < anInt3521 && (0x4 & aByteArrayArrayArray3526[i][i_141_][1 + i_145_]
									^ 0xffffffff) != -1; i_145_++)
								if (i_145_ - i_144_ >= 10)
									break;
							while_237_: for (/**/; (i_142_ ^ 0xffffffff) < -1; i_142_--) {
							...
							while_238_: for (/**/; (anInt3524 ^ 0xffffffff) < (i_143_ ^ 0xffffffff); i_143_++) {
								if (i_143_ - i_142_ >= 10)
									break;
							...
							if ((1 + (-i_142_ + i_143_)) * (1 + (i_145_ + -i_144_)) >= 4) {
								...
								Class145.method1641(4, 512 + (i_145_ << 9), i_142_ << 9, i_148_, i_144_ << 9, i_148_,
										(byte) -123, i, 512 + (i_143_ << 9));
								for (int i_149_ = i_142_; (i_149_ ^ 0xffffffff) >= (i_143_ ^ 0xffffffff); i_149_++)
									for (int i_150_ = i_144_; (i_145_ ^ 0xffffffff) <= (i_150_ ^ 0xffffffff); i_150_++)
										aByteArrayArrayArray3526[i][i_149_][i_150_] = (byte) Node_Sub30
												.method2723(aByteArrayArrayArray3526[i][i_149_][i_150_], -5);
							}
						}
	...
	public final void method3359(int i, byte b, int i_160_, Class84 class84, int i_161_, int i_162_,
			GraphicsToolkit graphicstoolkit) {
		anInt8040++;
		Interface19 interface19 = method3354(i_162_, i_160_, i_161_, i, 10675);
		if (interface19 != null) {
			ObjectDefinition objectdefinition = Class186.aClass112_2256.method1145(interface19.getObjectId(-32136), 98);
			...
			if (i != 0) {
				if (i == 1)
					...
					Class7.method181(i_161_, i_162_, i_160_,
							aClass8053 != null ? aClass8053 : (aClass8053 = method3361("Interface19")));
					if (objectdefinition.anInt3010 != 0
							&& (anInt3524 ^ 0xffffffff) < (objectdefinition.anInt3055 + i_162_ ^ 0xffffffff)
							&& anInt3521 > objectdefinition.anInt3055 + i_160_
							&& i_162_ + objectdefinition.anInt2986 < anInt3524
							&& objectdefinition.anInt2986 + i_160_ < anInt3521)
						class84.method992(objectdefinition.aBoolean3034, !objectdefinition.aBoolean3016, (byte) -106,
								i_162_, objectdefinition.anInt3055, objectdefinition.anInt2986, i_164_, i_160_);
				...
				if (objectdefinition.anInt3010 != 0)
					class84.method987(i_160_, i_164_, i_163_, (byte) -70, !objectdefinition.aBoolean3016, i_162_,
							objectdefinition.aBoolean3034);
