...
public class Class278 {
	public static IncomingPacket aClass192_3542 = new IncomingPacket(78, 8);
	public static IncomingPacket aClass192_3548 = new IncomingPacket(80, -2);
	...
	public static final boolean method3367(int i, int i_6_, byte b) {
	...
	public final void method3362(int i, int i_0_) {
		anInt3541++;
		if (i_0_ != 29)
			aClass192_3542 = null;
	...
	public final void method3363(int i) {
		if (i != -29945)
			aClass302_3539 = null;
		synchronized (aClass61_3543) {
	...
	public final void method3365(int i) {
		synchronized (aClass61_3543) {
	...
	public final Class119 method3366(Class57 class57, int i, int i_2_, int i_3_, int i_4_, boolean bool) {
		anInt3545++;
		if (bool != true)
			aClass302_3539 = null;
		...
		if (class82.anIntArray1115 != null) {
			...
			for (int i_5_ = 0; class182s.length > i_5_; i_5_++) {
				...
				class182s[i_5_] = new Class182(class7.anInt156, class7.anInt151, class7.anInt152, class7.anInt158,
						class7.anInt160, class7.anInt150, class7.anInt159, class7.aBoolean162, class7.anInt155,
						class7.anInt161, class7.anInt153);
			}
		}
		return new Class119(class82.anInt1119, class182s, class82.anInt1113, i_4_, i_3_, i, class82.anInt1114,
				class82.anInt1109);
	}
}
