...
public class Class281 {
	public static IncomingPacket aClass192_3575 = new IncomingPacket(114, 4);
	...
	public static int[] anIntArray3579 = new int[1000];
	...
	public static final void method3384(byte b) {
		anInt3580++;
		...
		for (/**/; cachenode_sub4 != null; cachenode_sub4 = (CacheNode_Sub4) Class184.aClass158_2189.method1721(0))
			if (cachenode_sub4.anInt9462 > 1) {
				...
				Class200_Sub2.aClass61_4941.method601(cachenode_sub4, 25566,
	...
	public final void method3379(byte b) {
	...
	public final void method3380(int i, boolean bool) {
		anInt3574++;
		if (bool != true)
			method3379((byte) 46);
		synchronized (aClass61_3576) {
	...
	public final void method3382(int i) {
		synchronized (aClass61_3576) {
	...
	public final Class259 method3383(byte b, int i) {
		anInt3573++;
		Class259 class259;
		synchronized (aClass61_3576) {
			class259 = (Class259) aClass61_3576.method607(i, 0);
		}
		if (class259 != null)
			return class259;
		byte[] bs;
		...
		synchronized (aClass61_3576) {
			if (b < 98)
				return null;
			aClass61_3576.method601(class259, 25566, i);
		}
		return class259;
	}
}
