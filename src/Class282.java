...
public class Class282 {
	public static byte[][] aByteArrayArray3588 = new byte[50][];
	public static Index aClass302_3583;
	public static double aDouble3585;
	...
	public static final void method3385(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, boolean bool,
			int i_6_) {
		anInt3582++;
		if (!CacheNode_Sub15.method2379(7015, i)) {
			if ((i_4_ ^ 0xffffffff) == 0)
				for (int i_7_ = 0; i_7_ < 100; i_7_++)
					Login.aBooleanArray2387[i_7_] = true;
			else
				Login.aBooleanArray2387[i_4_] = true;
		} else {
			if (bool != true)
			...
			if (Class79.aWidgetArrayArray1082[i] == null)
				Node_Sub6.method2416(-1, i_5_, Class134_Sub3.widgetsList[i], i_0_, i_2_, i_6_, i_4_, i_4_ < 0,
						90, i_1_, i_3_);
			else
				Node_Sub6.method2416(-1, i_5_, Class79.aWidgetArrayArray1082[i], i_0_, i_2_, i_6_, i_4_,
						(i_4_ ^ 0xffffffff) > -1, 27, i_1_, i_3_);
			if (Class71.aBoolean967) {
				if (i_4_ >= 0 && Node_Sub53.anInt7669 == 2)
					Class362.method4053(Class168.anInt2046, Class308.anInt3914, Node_Sub33.anInt7405, (byte) -115,
	...
	public static final void method3386(int i, byte b) {
	...
	public static final void method3387(int i, int i_13_) {
		anInt3586++;
