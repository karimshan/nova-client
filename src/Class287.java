...
public class Class287 {
	public static boolean aBoolean3606 = false;
	...
	public static final void method3401(Node_Sub19 node_sub19, boolean bool, int i) {
		if (!node_sub19.aBoolean7156) {
			if (node_sub19.aBoolean7159 && node_sub19.anInt7171 >= 1 && node_sub19.anInt7161 >= 1
					&& -2 + Node_Sub54.GAME_SCENE_WDITH >= node_sub19.anInt7171
					&& (-2 + Class377_Sub1.GAME_SCENE_HEIGHT ^ 0xffffffff) <= (node_sub19.anInt7161 ^ 0xffffffff)
					&& ((node_sub19.anInt7169 ^ 0xffffffff) > -1
							|| Class128.method1547(node_sub19.anInt7169, 1, node_sub19.anInt7168))) {
				if (bool)
					Node_Sub38_Sub37.method2907(node_sub19.anInt7166, -14347, node_sub19.aClass121_7160,
							node_sub19.anInt7161, node_sub19.anInt7165, node_sub19.anInt7171);
				else
					Class128.method1544(node_sub19.anInt7161, node_sub19.anInt7168, node_sub19.anInt7167,
							node_sub19.anInt7171, -1, node_sub19.anInt7166, node_sub19.anInt7165, -128,
							node_sub19.anInt7169);
				node_sub19.aBoolean7159 = false;
				if (bool || node_sub19.anInt7154 != node_sub19.anInt7169 || (node_sub19.anInt7154 ^ 0xffffffff) != 0) {
					if (!bool && (node_sub19.anInt7154 ^ 0xffffffff) == (node_sub19.anInt7169 ^ 0xffffffff)
							&& node_sub19.anInt7167 == node_sub19.anInt7170
							&& (node_sub19.anInt7168 ^ 0xffffffff) == (node_sub19.anInt7164 ^ 0xffffffff))
			...
			if (bool)
				Node_Sub38_Sub37.method2907(node_sub19.anInt7166, i ^ 0x380a, null, node_sub19.anInt7161,
						node_sub19.anInt7165, node_sub19.anInt7171);
			else
				Class128.method1544(node_sub19.anInt7161, node_sub19.anInt7164, node_sub19.anInt7170,
						node_sub19.anInt7171, -1, node_sub19.anInt7166, node_sub19.anInt7165, -39,
						node_sub19.anInt7154);
	...
	Class287(AbstractToolkit abstracttoolkit) {
		...
		aClass213_3620 = abstracttoolkit.method1372((byte) -128,
				new Class207[] { new Class207(
						new Commands[] { Commands.aClass126_1620, Commands.aClass126_1626, Commands.aClass126_1628 }),
						new Class207(Commands.aClass126_1625) });
		...
		Buffer buffer = anInterface15_Impl1_3622.method54(true, (byte) 74);
		if (buffer != null) {
		...
		Buffer buffer_77_ = anInterface15_Impl2_3618.method40(112, true);
		if (buffer_77_ != null) {
	...
	public final void method3396(byte b) {
		anInt3612++;
		if (b != -74)
			anIntArray3619 = null;
	...
	public final void method3397(Class198 class198, int i, int i_0_, AbstractToolkit abstracttoolkit) {
		anInt3609++;
		if (abstracttoolkit.aClass336_Sub1_6267 != null) {
			...
			try {
				...
				for (EntityNode_Sub3 entitynode_sub3_7_ = entitynode_sub3.anEntityNode_Sub3_5961; entitynode_sub3 != entitynode_sub3_7_; entitynode_sub3_7_ = entitynode_sub3_7_.anEntityNode_Sub3_5961) {
					...
					int i_8_ = (int) (f_1_ * (entitynode_sub3_sub2.anInt9171 >> 12)
							+ f * (entitynode_sub3_sub2.anInt9174 >> 12) + f_2_ * (entitynode_sub3_sub2.anInt9173 >> 12)
							+ f_3_);
				...
				while (entitynode_sub3_11_ != entitynode_sub3) {
					...
					for (/**/; entitynode_sub3 != entitynode_sub3_11_; entitynode_sub3_11_ = entitynode_sub3_11_.anEntityNode_Sub3_5961) {
						...
						if (i_4_ > 0 && (i_12_ != entitynode_sub3_sub2.anInt9177
								|| !entitynode_sub3_sub2.aBoolean9169 == bool)) {
							bool_13_ = true;
							break;
						}
						...
						if (i_16_ < 1600)
							if (anIntArray3619[i_16_] >= 64) {
								...
								anEntityNode_Sub3_Sub2ArrayArray3615[-1 + anIntArray3619[i_16_]
										- 64][anIntArray3616[anIntArray3619[i_16_] + -64 - 1]++] = entitynode_sub3_sub2;
							} else
	...
	public final void method3399(AbstractToolkit abstracttoolkit, int i) {
		anInt3617++;
	...
	private final void method3400(int i, byte b, AbstractToolkit abstracttoolkit) {
		...
		anInt3610++;
		abstracttoolkit.method1270((byte) -124, i);
	...
	private final void method3403(int i, boolean bool, AbstractToolkit abstracttoolkit) {
		...
		if (bool == false) {
			...
			Buffer buffer = anInterface15_Impl2_3605.method40(-87, true);
			if (buffer != null) {
					...
					for (int i_33_ = i - 1; (i_33_ ^ 0xffffffff) <= -1; i_33_--) {
						...
						if ((i_34_ ^ 0xffffffff) < -1) {
							for (int i_35_ = -1 + i_34_; i_35_ >= 0; i_35_--) {
								...
								float f_40_ = entitynode_sub3_sub2.anInt9174 >> 12;
								float f_41_ = entitynode_sub3_sub2.anInt9171 >> 12;
								float f_42_ = entitynode_sub3_sub2.anInt9173 >> 12;
								int i_43_ = entitynode_sub3_sub2.anInt9172 >> 12;
								stream.a(-i_43_ * f_24_ + f_40_);
								stream.a(-i_43_ * f_25_ + f_41_);
								stream.a(f_42_ + -i_43_ * f_26_);
								...
								stream.a(0.0F);
								stream.a(0.0F);
								stream.a(f_40_ + f_27_ * i_43_);
								stream.a(f_41_ + f_28_ * i_43_);
								stream.a(f_42_ + f_29_ * i_43_);
								...
								stream.a(1.0F);
								stream.a(1.0F);
								stream.a(i_43_ * f_30_ + f_40_);
								stream.a(f_31_ * i_43_ + f_41_);
								stream.a(f_42_ + f_32_ * i_43_);
								if (abstracttoolkit.anInt6360 != 0)
									stream.b(b, b_37_, b_38_, b_39_);
								else
									stream.a(b, b_37_, b_38_, b_39_);
							...
							if ((anIntArray3619[i_33_] ^ 0xffffffff) < -65) {
								...
								for (int i_45_ = -1 + anIntArray3616[i_44_]; (i_45_ ^ 0xffffffff) <= -1; i_45_--) {
									...
									float f_50_ = entitynode_sub3_sub2.anInt9174 >> 12;
									float f_51_ = entitynode_sub3_sub2.anInt9171 >> 12;
									float f_52_ = entitynode_sub3_sub2.anInt9173 >> 12;
									int i_53_ = entitynode_sub3_sub2.anInt9172 >> 12;
									stream.a(f_24_ * -i_53_ + f_50_);
									stream.a(f_51_ + -i_53_ * f_25_);
									stream.a(-i_53_ * f_26_ + f_52_);
									if (abstracttoolkit.anInt6360 == 0)
									...
									stream.a(0.0F);
									stream.a(0.0F);
									stream.a(i_53_ * f_27_ + f_50_);
									stream.a(f_28_ * i_53_ + f_51_);
									stream.a(f_52_ + i_53_ * f_29_);
									if (abstracttoolkit.anInt6360 == 0)
										stream.a(b, b_47_, b_48_, b_49_);
									else
										stream.b(b, b_47_, b_48_, b_49_);
									stream.a(1.0F);
									stream.a(0.0F);
									stream.a(i_53_ * f_24_ + f_50_);
									stream.a(f_51_ + f_25_ * i_53_);
									stream.a(f_26_ * i_53_ + f_52_);
									if ((abstracttoolkit.anInt6360 ^ 0xffffffff) != -1)
										stream.b(b, b_47_, b_48_, b_49_);
									else
										stream.a(b, b_47_, b_48_, b_49_);
									stream.a(1.0F);
									stream.a(1.0F);
									stream.a(f_30_ * i_53_ + f_50_);
									stream.a(f_51_ + f_31_ * i_53_);
									stream.a(i_53_ * f_32_ + f_52_);
									if (abstracttoolkit.anInt6360 != 0)
										stream.b(b, b_47_, b_48_, b_49_);
									else
										stream.a(b, b_47_, b_48_, b_49_);
					...
					for (int i_54_ = i + -1; i_54_ >= 0; i_54_--) {
						...
						if ((i_55_ ^ 0xffffffff) < -1) {
							for (int i_56_ = i_55_ - 1; i_56_ >= 0; i_56_--) {
								...
								float f_61_ = entitynode_sub3_sub2.anInt9174 >> 12;
								float f_62_ = entitynode_sub3_sub2.anInt9171 >> 12;
								float f_63_ = entitynode_sub3_sub2.anInt9173 >> 12;
								int i_64_ = entitynode_sub3_sub2.anInt9172 >> 12;
								stream.b(f_24_ * -i_64_ + f_61_);
								stream.b(f_62_ + -i_64_ * f_25_);
								stream.b(f_63_ + f_26_ * -i_64_);
								if ((abstracttoolkit.anInt6360 ^ 0xffffffff) == -1)
								...
								stream.b(0.0F);
								stream.b(0.0F);
								stream.b(f_61_ + f_27_ * i_64_);
								stream.b(f_28_ * i_64_ + f_62_);
								stream.b(f_29_ * i_64_ + f_63_);
								if ((abstracttoolkit.anInt6360 ^ 0xffffffff) != -1)
									stream.b(b, b_58_, b_59_, b_60_);
								else
									stream.a(b, b_58_, b_59_, b_60_);
								stream.b(1.0F);
								stream.b(0.0F);
								stream.b(f_61_ + f_24_ * i_64_);
								stream.b(f_25_ * i_64_ + f_62_);
								stream.b(f_63_ + i_64_ * f_26_);
								if (abstracttoolkit.anInt6360 != 0)
									stream.b(b, b_58_, b_59_, b_60_);
								else
									stream.a(b, b_58_, b_59_, b_60_);
								stream.b(1.0F);
								stream.b(1.0F);
								stream.b(f_61_ + f_30_ * i_64_);
								stream.b(i_64_ * f_31_ + f_62_);
								stream.b(f_63_ + f_32_ * i_64_);
								if ((abstracttoolkit.anInt6360 ^ 0xffffffff) != -1)
									stream.b(b, b_58_, b_59_, b_60_);
								else
									stream.a(b, b_58_, b_59_, b_60_);
							...
							if ((anIntArray3619[i_54_] ^ 0xffffffff) < -65) {
								...
								for (int i_66_ = anIntArray3616[i_65_] + -1; (i_66_ ^ 0xffffffff) <= -1; i_66_--) {
									...
									float f_71_ = entitynode_sub3_sub2.anInt9174 >> 12;
									float f_72_ = entitynode_sub3_sub2.anInt9171 >> 12;
									float f_73_ = entitynode_sub3_sub2.anInt9173 >> 12;
									int i_74_ = entitynode_sub3_sub2.anInt9172 >> 12;
									stream.b(f_24_ * -i_74_ + f_71_);
									stream.b(f_72_ + -i_74_ * f_25_);
									stream.b(f_26_ * -i_74_ + f_73_);
									if (abstracttoolkit.anInt6360 != 0)
									...
									stream.b(0.0F);
									stream.b(0.0F);
									stream.b(i_74_ * f_27_ + f_71_);
									stream.b(f_72_ + f_28_ * i_74_);
									stream.b(f_73_ + i_74_ * f_29_);
									if (abstracttoolkit.anInt6360 == 0)
										stream.a(b, b_68_, b_69_, b_70_);
									else
										stream.b(b, b_68_, b_69_, b_70_);
									stream.b(1.0F);
									stream.b(0.0F);
									stream.b(f_71_ + i_74_ * f_24_);
									stream.b(i_74_ * f_25_ + f_72_);
									stream.b(i_74_ * f_26_ + f_73_);
									if ((abstracttoolkit.anInt6360 ^ 0xffffffff) != -1)
										stream.b(b, b_68_, b_69_, b_70_);
									else
										stream.a(b, b_68_, b_69_, b_70_);
									stream.b(1.0F);
									stream.b(1.0F);
									stream.b(f_30_ * i_74_ + f_71_);
									stream.b(f_31_ * i_74_ + f_72_);
									stream.b(i_74_ * f_32_ + f_73_);
									if ((abstracttoolkit.anInt6360 ^ 0xffffffff) == -1)
										stream.a(b, b_68_, b_69_, b_70_);
									else
										stream.b(b, b_68_, b_69_, b_70_);
				...
				if (anInterface15_Impl2_3605.method39(124)) {
					...
					abstracttoolkit.method1276(0, (byte) -76, 0, anInterface15_Impl1_3622, 4 * i_18_,
							Class55.aClass104_833, 2 * i_18_);
				}
			}
		}
	}
