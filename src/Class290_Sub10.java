...
public class Class290_Sub10 extends Class290 {
	...
	Class290_Sub10(D3DToolkit d3dtoolkit, Index class302, Class5 class5) {
		...
		aClass5_8156 = class5;
		if (class302 != null && anAbstractToolkit3654.aBoolean6310 && anAbstractToolkit3654.aBoolean6366
				&& -258 >= (0xffff & aD3DToolkit8158.aD3DCAPS9188.VertexShaderVersion ^ 0xffffffff)) {
			anIDirect3DVertexShader8157 = aD3DToolkit8158.anIDirect3DDevice9199
					.b(class302.method3529("dx", "environment_mapped_water_v", 1));
			anIDirect3DPixelShader8154 = aD3DToolkit8158.anIDirect3DDevice9199
					.a(class302.method3529("dx", "environment_mapped_water_f", 1));
			aBoolean8153 = anIDirect3DVertexShader8157 != null && null != anIDirect3DPixelShader8154
					&& aClass5_8156.method172(10103);
		} else {
			aBoolean8153 = false;
	...
	public final void method3415(boolean bool, int i, int i_3_) {
		if (aBoolean8155) {
			...
			float f_6_ = (0x3 & i_3_ >> 16) / 8.0F;
			idirect3ddevice.a(14, i_4_ * anAbstractToolkit3654.anInt6332 % 40000 / 40000.0F, 0.0F, 0.0F, 0.0F);
			idirect3ddevice.a(15, f, 0.0F, 0.0F, 0.0F);
			idirect3ddevice.b(4, i_5_, 0.0F, 0.0F, 0.0F);
	...
	public final void method3416(byte b) {
		if (aBoolean8155) {
			...
			idirect3ddevice.b(0, ((anAbstractToolkit3654.anInt6276 & 0xff6aac) >> 16) / 255.0F,
					(0xff & anAbstractToolkit3654.anInt6276 >> 8) / 255.0F,
					(anAbstractToolkit3654.anInt6276 & 0xff) / 255.0F, 0.0F);
		}
		if (b != -56)
			method3412(26);
	}
	...
	public final void method3422(int i, boolean bool) {
		...
		if (aBoolean8153 && interface13_impl2 != null) {
			...
			method3412(0);
			method3416((byte) -56);
			idirect3ddevice.b(1, -anAbstractToolkit3654.aFloatArray6292[0], -anAbstractToolkit3654.aFloatArray6292[1],
					-anAbstractToolkit3654.aFloatArray6292[2], 0.0F);
			idirect3ddevice.b(2, anAbstractToolkit3654.aFloat6323, anAbstractToolkit3654.aFloat6293,
					anAbstractToolkit3654.aFloat6365, 1.0F);
