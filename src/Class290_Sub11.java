...
public class Class290_Sub11 extends Class290 {
	public static boolean aBoolean8175 = false;
	private static char[] aCharArray8172;
	public static IncomingPacket aClass192_8184;
	public static float[] aFloatArray8183;
	public static int anInt8162;
	public static int anInt8163;
	...
	public static int anInt8178;
	public static int anInt8179;
	public static int anInt8181;
	public static int[] anIntArray8180;
	static {
		...
		aClass192_8184 = new IncomingPacket(111, 3);
	}
	...
	public static final float[] method3445(int i, float[] fs, boolean bool) {
		if (bool != false)
			return null;
		anInt8179++;
	...
	Class290_Sub11(GLXToolkit glxtoolkit, Index class302) {
		...
		if (class302 == null || !glxtoolkit.aBoolean9326)
			...
			aClass106_8160 = Class157.method1709(glxtoolkit, 34336, -113,
					class302.method3529("gl", "uw_ground_unlit", 1));
			aClass106_8161 = Class157.method1709(glxtoolkit, 34336, -92, class302.method3529("gl", "uw_ground_lit", 1));
			aClass106_8171 = Class157.method1709(glxtoolkit, 34336, -124,
					class302.method3529("gl", "uw_model_unlit", 1));
	...
	public final void method3416(byte b) {
		...
		if (aBoolean8170) {
			...
			float f = i - (-i_2_ + i) * 0.125F;
			float f_3_ = -(0.25F * (i + -i_2_)) + i;
			OpenGL.glProgramLocalParameter4fARB(34336, 0, f_3_, f, 1.0F / anAbstractToolkit3654.method1329(512),
					anAbstractToolkit3654.method1344(-113) / 255.0F);
			anAbstractToolkit3654.method1362(255, 1);
	...
	@Override
	public final void method3417(boolean bool, boolean bool_4_) {
		anInt8177++;
		if (bool_4_ != false)
			anInt8181 = -44;
	}
	...
	public final void method3420(int i) {
		...
		if (!aBoolean8182)
			...
			OpenGL.glBindProgramARB(34336,
					(i_6_ ^ 0xffffffff) == -2147483648 ? aClass106_8161.anInt1350 : aClass106_8168.anInt1350);
		OpenGL.glEnable(34336);
		if (i >= 4) {
			aBoolean8170 = true;
			class336_sub1.method3872(i_6_, -1.0F, (byte) 86, 0.0F, aFloatArray8164, 0.0F);
			OpenGL.glProgramLocalParameter4fARB(34336, 1, aFloatArray8164[0], aFloatArray8164[1], aFloatArray8164[2],
					aFloatArray8164[3]);
			method3416((byte) -56);
		}
	}
