		...
		if ((i & 0x80) == 0) {
			if ((i_0_ & 0x1) == 1) {
				if (!aClass5_8066.aBoolean128) {
					...
					aFloat8065 = anAbstractToolkit3654.anInt6332 % 4000 / 4000.0F;
