...
public class Class290_Sub3 extends Class290 {
	...
	public static int anInt8081;
	public static int anInt8082;
	public static int anInt8084;
	public static int anInt8085;
	public static int anInt8087;
	public static int[] anIntArray8077 = new int[4];

	public static final void method3427(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
		anInt8080++;
		CacheNode_Sub2 cachenode_sub2 = Class320_Sub19.method3754(3, 19, (long) i_1_ << 32 | i_2_);
		cachenode_sub2.method2288(0);
		cachenode_sub2.itemId = i_0_;
	...
	public static final Class10 method3429(boolean bool) {
		anInt8087++;
		if (bool != true)
			return null;
		try {
	...
	Class290_Sub3(GLXToolkit glxtoolkit, Index class302, Class5 class5) {
		...
		if (class302 != null && glxtoolkit.aBoolean9315 && glxtoolkit.aBoolean9322) {
			Class237 class237 = Class24.method304(35633, -11847,
					class302.method3529("gl", "environment_mapped_water_v", 1), glxtoolkit);
			Class237 class237_10_ = Class24.method304(35632, -11847,
					class302.method3529("gl", "environment_mapped_water_f", 1), glxtoolkit);
	...
	@Override
	public final void method3415(boolean bool, int i, int i_5_) {
		if (aBoolean8086) {
			int i_6_ = 1 << (0x3 & i);
			float f = (1 << (0x7 & i >> 3)) / 32.0F;
			int i_7_ = 0xffff & i_5_;
			float f_8_ = (0x3 & i_5_ >> 16) / 8.0F;
			long l = aClass288_8079.aLong3626;
			OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "time"),
					i_6_ * anAbstractToolkit3654.anInt6332 % 40000 / 40000.0F);
			OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "scale"), f);
			OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "breakWaterDepth"), i_7_);
	...
	@Override
	public final void method3417(boolean bool, boolean bool_9_) {
		if (bool_9_ == false)
			anInt8081++;
	}
	...
	public final void method3422(int i, boolean bool) {
		...
		if (aBoolean8083 && interface13_impl2 != null) {
			...
			OpenGL.glUniform3fARB(OpenGL.glGetUniformLocationARB(l, "sunDir"),
					-anAbstractToolkit3654.aFloatArray6292[0], -anAbstractToolkit3654.aFloatArray6292[1],
					-anAbstractToolkit3654.aFloatArray6292[2]);
			OpenGL.glUniform4fARB(OpenGL.glGetUniformLocationARB(l, "sunColour"), anAbstractToolkit3654.aFloat6323,
					anAbstractToolkit3654.aFloat6293, anAbstractToolkit3654.aFloat6365, 1.0F);
			OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "sunExponent"),
					Math.abs(anAbstractToolkit3654.aFloatArray6292[1]) * 928.0F + 96.0F);
			aBoolean8086 = true;
		}
	}
}
