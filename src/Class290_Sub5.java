...
public class Class290_Sub5 extends Class290 {
	...
	static {
		aClass192_8103 = new IncomingPacket(9, 10);
	}

	public static final void method3434(int i, byte b) {
		anInt8106++;
	...
	public static final int method3435(int i) {
		anInt8108++;
		if (i >= -69)
			method3435(100);
	...
	public static final Class150_Sub1 method3436(BufferedStream buffer, byte b) {
		anInt8105++;
		...
		return new Class150_Sub1(class150.aClass379_5079, class150.aClass77_5087, class150.anInt5092,
				class150.anInt5080, class150.anInt5086, class150.anInt5081, class150.anInt5084, class150.anInt5083,
				class150.anInt5090, i_1_, i_2_, i_3_);
	}
