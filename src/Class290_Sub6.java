...
public class Class290_Sub6 extends Class290 {
	public static Class312 aClass312_8122 = new Class312();
	public static Class336 aClass336_8114;
	public static int anInt8115;
	public static int anInt8116 = 0;
	public static int anInt8117;
	public static int anInt8118;
	public static int anInt8119;
	public static int anInt8120;
	public static int anInt8121;
	public static int anInt8124;
	public static int anInt8125;
	public static int[] anIntArray8123;

	public static final int method3438(int i) {
		anInt8121++;
		...
		if (Class118.anInt5405 == 1) {
			...
			Class298.aClass298_3723.method3484(new Class108(MiniMapDots.index2), i ^ 0x3acb);
			...
			for (Class298 element : GLToolkit.aClass298Array6403)
				if (element.method3483((byte) -99) == null)
	...
	@Override
	public final void method3415(boolean bool, int i, int i_0_) {
		if (bool != true)
			anInt8116 = 49;
		anInt8117++;
	}
	...
	@Override
	public final void method3417(boolean bool, boolean bool_1_) {
		if (bool_1_ == false)
			anInt8120++;
	}
