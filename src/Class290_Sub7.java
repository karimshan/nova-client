...
public class Class290_Sub7 extends Class290 {
	...
	public static final boolean method3441(int i, String string) {
		anInt8136++;
		if (i != 2)
			method3440(15);
	...
	public static final Class256 method3442(int i, int i_1_, int i_2_) {
	...
	@Override
	public final void method3417(boolean bool, boolean bool_0_) {
