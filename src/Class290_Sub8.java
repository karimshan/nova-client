...
public class Class290_Sub8 extends Class290 {
	...
	Class290_Sub8(D3DToolkit d3dtoolkit, Index class302) {
		...
		if (null != class302 && (0xffff & aD3DToolkit8147.aD3DCAPS9188.VertexShaderVersion) >= 257) {
			anIDirect3DVertexShader8142 = aD3DToolkit8147.anIDirect3DDevice9199
					.b(class302.method3529("dx", "uw_ground_unlit", 1));
			anIDirect3DVertexShader8143 = aD3DToolkit8147.anIDirect3DDevice9199
					.b(class302.method3529("dx", "uw_ground_lit", 1));
			anIDirect3DVertexShader8146 = aD3DToolkit8147.anIDirect3DDevice9199
					.b(class302.method3529("dx", "uw_model_unlit", 1));
			anIDirect3DVertexShader8137 = aD3DToolkit8147.anIDirect3DDevice9199
					.b(class302.method3529("dx", "uw_model_lit", 1));
			if (!(anIDirect3DVertexShader8137 != null & (anIDirect3DVertexShader8146 != null
					& (anIDirect3DVertexShader8143 != null & anIDirect3DVertexShader8142 != null))))
				aBoolean8141 = false;
			else {
	...
	@Override
	public final void method3410(int i) {
	...
	@Override
	public final void method3412(int i) {
		if (i != 0)
	...
	@Override
	public final void method3413(int i) {
		if (null != anIDirect3DVertexShader8140) {
			IDirect3DDevice idirect3ddevice = aD3DToolkit8147.anIDirect3DDevice9199;
			Class336_Sub1 class336_sub1 = aD3DToolkit8147.method1378(50);
	...
	@Override
	public final void method3415(boolean bool, int i, int i_3_) {
		if (bool != true)
			method3422(-19, false);
	}

	@Override
	public final void method3416(byte b) {
		if (b == -56 && anIDirect3DVertexShader8140 != null) {
			IDirect3DDevice idirect3ddevice = aD3DToolkit8147.anIDirect3DDevice9199;
			int i = anAbstractToolkit3654.XA();
			int i_0_ = anAbstractToolkit3654.i();
			float f = -(0.125F * (-i_0_ + i)) + i;
			float f_1_ = i - (i + -i_0_) * 0.25F;
			idirect3ddevice.a(10, f_1_, 1.0F / (-f_1_ + f), f, 1.0F / (-f + i));
			idirect3ddevice.a(11, 1.0F / anAbstractToolkit3654.method1329(512),
					anAbstractToolkit3654.method1344(-119) / 255.0F, anAbstractToolkit3654.aFloat6328,
					1.0F / (anAbstractToolkit3654.aFloat6328 - anAbstractToolkit3654.aFloat6311));
			anAbstractToolkit3654.method1336(b + 54, anAbstractToolkit3654.method1249((byte) 114));
		}
	}

	@Override
	public final void method3417(boolean bool, boolean bool_2_) {
		if (bool_2_)
	...
	@Override
	public final void method3420(int i) {
		IDirect3DDevice idirect3ddevice = aD3DToolkit8147.anIDirect3DDevice9199;
		...
		if (aBoolean8144)
			idirect3dvertexshader = (i_5_ ^ 0xffffffff) == -2147483648 ? anIDirect3DVertexShader8143
					: anIDirect3DVertexShader8137;
		else
		...
		class336_sub1.method3872(i_5_, -1.0F, (byte) 86, 0.0F, aFloatArray8148, 0.0F);
		idirect3ddevice.a(12, aFloatArray8148);
	}

	@Override
	public final void method3421(boolean bool) {
		if (null != anIDirect3DVertexShader8140) {
			IDirect3DDevice idirect3ddevice = aD3DToolkit8147.anIDirect3DDevice9199;
	...
	private final void method3443(int i) {
		if (null != anIDirect3DVertexShader8140 && aBoolean8144) {
			...
			IDirect3DDevice idirect3ddevice = aD3DToolkit8147.anIDirect3DDevice9199;
			idirect3ddevice.a(13, anAbstractToolkit3654.aFloat6323 * anAbstractToolkit3654.aFloat6300,
					anAbstractToolkit3654.aFloat6293 * anAbstractToolkit3654.aFloat6300,
					anAbstractToolkit3654.aFloat6300 * anAbstractToolkit3654.aFloat6365, 1.0F);
			idirect3ddevice.a(14, anAbstractToolkit3654.aFloat6274 * anAbstractToolkit3654.aFloat6323,
					anAbstractToolkit3654.aFloat6274 * anAbstractToolkit3654.aFloat6293,
					anAbstractToolkit3654.aFloat6365 * anAbstractToolkit3654.aFloat6274, 1.0F);
			idirect3ddevice.a(16, anAbstractToolkit3654.aFloat6323 * anAbstractToolkit3654.aFloat6272,
					anAbstractToolkit3654.aFloat6293 * anAbstractToolkit3654.aFloat6272,
					anAbstractToolkit3654.aFloat6365 * anAbstractToolkit3654.aFloat6272, 1.0F);
			class336_sub1.method3890(anAbstractToolkit3654.aFloatArray6292[0], aFloatArray8148,
					anAbstractToolkit3654.aFloatArray6292[1], anAbstractToolkit3654.aFloatArray6292[2], (byte) -108);
			idirect3ddevice.SetVertexShaderConstantF(15, aFloatArray8148, 1);
			class336_sub1.method3890(anAbstractToolkit3654.aFloatArray6304[0], aFloatArray8148,
					anAbstractToolkit3654.aFloatArray6304[1], anAbstractToolkit3654.aFloatArray6304[2], (byte) 91);
