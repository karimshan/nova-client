...
public class Class290_Sub9 extends Class290 {
	...
	Class290_Sub9(D3DToolkit d3dtoolkit, Index class302, Class5 class5) {
		...
		aClass5_8152 = class5;
		if (null != class302 && aClass5_8152.method173(4)
				&& (0xffff & aD3DToolkit8149.aD3DCAPS9188.VertexShaderVersion) >= 257)
			anIDirect3DVertexShader8151 = aD3DToolkit8149.anIDirect3DDevice9199
					.b(class302.method3529("dx", "transparent_water", 1));
		else
	...
	public final void method3415(boolean bool, int i, int i_3_) {
		...
		if (aClass5_8152.aBoolean128) {
			float f = anAbstractToolkit3654.anInt6332 % 4000 / 4000.0F;
