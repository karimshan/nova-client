...
public class Class293 {
	public static Index aClass302_3681;
	public static int anInt3680;
	public static int anInt3683;
	public static int anInt3684;

	public static final void method3461(String[] strings, short[] ses, int i) {
	...
	public final void method3463(BufferedStream buffer, byte b) {
		anInt3683++;
		for (;;) {
