...
public class Class296 implements Interface18 {
	public static boolean aBoolean5428 = false;
	public static Class186 aClass186_5429;
	/* synthetic */static Class<?> aClass5442;
	public static GLSprite aGLSprite5437;
	...
	public static final boolean method3474(int i, int i_0_, int i_1_, int i_2_) {
		anInt5441++;
		boolean bool = true;
		Interface19 interface19 = (Interface19) Node_Sub38_Sub12.method2830(i_1_, i, i_0_);
		if (interface19 != null)
			bool &= Class243.method3063(119, interface19);
		interface19 = (Interface19) Class262_Sub20.method3203(i_1_, i, i_0_,
				aClass5442 == null ? aClass5442 = method3478("Interface19") : aClass5442);
		if (interface19 != null)
	...
	public static final void method3476(int i) {
	...
	public static final void method3477(int i, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_) {
		anInt5430++;
	...
	public final long method67(int i) {
		...
		long l = -1L;
		l = ls[(int) (0xffL & (l ^ anInt5431))] ^ l >>> 8;
		l = l >>> 8 ^ ls[(int) ((l ^ anInt5432 >> 8) & 0xffL)];
		if (i != 26165)
			method3476(-43);
		l = l >>> 8 ^ ls[(int) (0xffL & (anInt5432 ^ l))];
		l = l >>> 8 ^ ls[(int) ((l ^ anInt5427 >> 24) & 0xffL)];
		l = ls[(int) ((anInt5427 >> 16 ^ l) & 0xffL)] ^ l >>> 8;
		l = ls[(int) (0xffL & (anInt5427 >> 8 ^ l))] ^ l >>> 8;
		l = l >>> 8 ^ ls[(int) ((l ^ anInt5427) & 0xffL)];
		l = ls[(int) (0xffL & (l ^ anInt5433))] ^ l >>> 8;
		l = ls[(int) ((l ^ anInt5435 >> 24) & 0xffL)] ^ l >>> 8;
		l = l >>> 8 ^ ls[(int) (0xffL & (anInt5435 >> 16 ^ l))];
		l = l >>> 8 ^ ls[(int) ((l ^ anInt5435 >> 8) & 0xffL)];
		l = ls[(int) (0xffL & (l ^ anInt5435))] ^ l >>> 8;
		l = ls[(int) ((l ^ anInt5434) & 0xffL)] ^ l >>> 8;
		l = l >>> 8 ^ ls[(int) (((!aBoolean5440 ? 0 : 1) ^ l) & 0xffL)];
		return l;
	}
}
