...
public class Class299 {
	...
	Class299(GraphicsToolkit graphicstoolkit, int i, boolean bool, Component component) {
		...
		for (int i_19_ = 0; i_19_ < anInt3744; i_19_++)
			method3492(graphicstoolkit, font, fontmetrics,
	...
	private final void method3488(GraphicsToolkit graphicstoolkit, String string, int[] is, int i, int i_0_, int i_1_,
			boolean bool) {
		if (i_1_ == 0)
			bool = false;
		i_1_ |= ~0xffffff;
	...
	public final int method3489() {
		return anInt3743;
	}

	public final int method3490(String string) {
		int i = 0;
	...
	public final void method3491(GraphicsToolkit graphicstoolkit, String string, int i, int i_6_, int i_7_, boolean bool) {
		int i_8_ = method3490(string) / 2;
		graphicstoolkit.K(anIntArray3748);
		if (i - i_8_ <= anIntArray3748[2] && i + i_8_ >= anIntArray3748[0] && i_6_ - anInt3743 <= anIntArray3748[3]
				&& i_6_ + anInt3749 >= anIntArray3748[1])
			method3488(graphicstoolkit, string, anIntArray3748, i - i_8_, i_6_, i_7_, bool);
	}

	private final void method3492(GraphicsToolkit graphicstoolkit, Font font, FontMetrics fontmetrics, char c, int i,
			boolean bool) {
		...
		Object object = null;
		int i_14_ = 0;
		while_225_: for (int i_15_ = 0; i_15_ < i_12_; i_15_++)
