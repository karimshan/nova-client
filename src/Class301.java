...
public class Class301 {
	...
	public static final String method3503(int i, boolean bool, long l, int i_0_, boolean bool_1_) {
		anInt3775++;
		char c = ',';
		if (bool_1_ != true)
		...
		try {
			...
			if (aBoolean3780) {
				...
				for (int i = 0; i < 16; i++) {
					...
					aClass169_Sub2Array3774[i] = new Class169_Sub2(gltoolkit, 3553, 6410, 128, 128, true, bs, 6410,
							false);
				}
				aClass169_Sub2Array3779 = new Class169_Sub2[16];
				for (int i = 0; i < 16; i++) {
					byte[] bs = Node_Sub38_Sub5.method2801(32768, Class88.anObject5281, 1, 128 * i * 256);
					aClass169_Sub2Array3779[i] = new Class169_Sub2(gltoolkit, 3553, 6410, 128, 128, true, bs, 6410,
							false);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Commands.method1537(runtimeexception, "sa.<init>(" + (gltoolkit != null ? "{...}" : "null") + ')');
		}
	}
}
