...
public class Class303 {
	public static Animable[] anAnimableArray3827;
	...
	public static final boolean method3538(int i, int i_0_, int i_1_) {
		if (i_0_ >= -125)
			anInt3831 = 77;
		anInt3829++;
		return GraphicsBuffer.method2598(2048, i_1_, i) & (Class278.method3367(i, i_1_, (byte) 12)
				| (0x2000 & i_1_) != 0 | Class320_Sub9.method3713(110, i_1_, i));
	}

	public static final boolean method3540(boolean bool) {
		anInt3821++;
		try {
			if ((AbstractFont.anInt800 ^ 0xffffffff) == -3) {
				if (Player.aNode_Sub4_11155 == null) {
					Player.aNode_Sub4_11155 = Node_Sub4.method2173(MouseHandler.aClass302_6049,
							CacheNode_Sub6.anInt9485, Class101.anInt1306);
					if (Player.aNode_Sub4_11155 == null)
						return false;
				}
				...
				if (node_sub9_sub1.method2467(Class10.aClass96_176, Node_Sub38_Sub6.aClass302_10138, -127, 22050,
						Player.aNode_Sub4_11155)) {
					...
					if (Class339_Sub8.anInt8733 <= 0) {
						...
						AbstractFont.anInt800 = 3;
						Class307.aNode_Sub9_Sub1_3902.method2439(-12651, Class17.anInt282 < Class339_Sub8.anInt8733
								? Class17.anInt282 : Class339_Sub8.anInt8733);
					...
					if (Class61.aNode_Sub9_Sub1_885 == null)
						if (Class77.aLong1018 <= 0L)
							Class307.aNode_Sub9_Sub1_3902.method2457(197984776, Player.aNode_Sub4_11155,
									Class266.aBoolean3385);
						else
							Class307.aNode_Sub9_Sub1_3902.method2448(Player.aNode_Sub4_11155, Class266.aBoolean3385,
									-128, Class77.aLong1018, true);
	...
	public static final void method3543(byte b) {
		anInt3826++;
		if (b != 93)
			anInt3831 = 83;
	...
	public final Node method3539(int i) {
		anInt3825++;
	...
	public final Node method3542(boolean bool) {
		anInt3830++;
		if (bool != true)
			return null;
		anInt3823 = 0;
