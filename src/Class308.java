...
public class Class308 {
	public static Class124 aClass124_3907 = new Class124(3);
	public static Class139 aClass139_3915;
	public static Index aClass302_3909;
	...
	public static int anInt3916 = 7000;
	static {
		anInt3912 = anInt3916;
	...
	public static final IComponentDefinitions method3585(IComponentDefinitions widget, boolean bool) {
		anInt3911++;
		if (bool != false)
			method3585(null, true);
		IComponentDefinitions widget_1_ = ConnectionDecoder.method109(widget);
		if (widget_1_ == null)
	...
	public final CacheNode_Sub6 method3584(int i, int i_0_) {
		anInt3910++;
