...
public class Class309 {
	...
	public static final void method3586(int i) {
		anInt3917++;
		if (Class109.anInt1367 != -1 && Class203.anInt2452 != -1) {
			...
			float f = Class141.anInt1758 / 65535.0F;
			...
			for (/**/; (i_2_ ^ 0xffffffff) > -4; i_2_++) {
				...
				int i_6_ = (Class277_Sub1.anIntArrayArrayArray8042[Class109.anInt1367][i_1_ - -2][i_2_]
				...
				int i_10_ = Class277_Sub1.anIntArrayArrayArray8042[Class109.anInt1367][i_1_ + 2][i_2_]
						- (i_7_ - (i_5_ - i_6_));
				fs[i_2_] = i_7_ + (i_8_ + (f * i_10_ + i_9_) * f) * f;
			}
			...
			for (int i_13_ = 0; i_13_ < 3; i_13_++) {
				...
				int i_16_ = (Class277_Sub1.anIntArrayArrayArray8042[Class203.anInt2452][i_12_ - -2][i_13_]
						+ -Class277_Sub1.anIntArrayArrayArray8042[Class203.anInt2452][3 + i_12_][i_13_]
						+ Class277_Sub1.anIntArrayArrayArray8042[Class203.anInt2452][i_12_ + 2][i_13_]) * 3;
				...
				int i_20_ = Class277_Sub1.anIntArrayArrayArray8042[Class203.anInt2452][i_12_ + 2][i_13_] + -i_17_
						+ (i_15_ - i_16_);
				fs_11_[i_13_] = i_17_ + (i_18_ + (i_19_ + i_20_ * f) * f) * f;
			}
			...
			OutgoingPacket.anInt4050 = 0x3fff & (int) (Math.atan2(f_22_, d) * 2607.5945876176133);
			Class170.anInt2053 = 0x3fff & (int) (2607.5945876176133 * -Math.atan2(f_21_, f_23_));
			Class48.anInt704 = ((-Class277_Sub1.anIntArrayArrayArray8042[Class109.anInt1367][i_1_][3]
					+ Class277_Sub1.anIntArrayArrayArray8042[Class109.anInt1367][2 + i_1_][3])
					* Class141.anInt1758 >> 16) + Class277_Sub1.anIntArrayArrayArray8042[Class109.anInt1367][i_1_][3];
		}
	}
}
