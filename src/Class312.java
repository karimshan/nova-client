...
public class Class312 {
	public static boolean aBoolean3960 = false;
	public static IncomingPacket aClass192_3966;
	public static OutgoingPacket aClass318_3973;
	public static OutgoingPacket aClass318_3976;
	...
	public static int[] anIntArray3968 = { 16776960, 16711680, 65280, 65535, 16711935, 16777215 };
	static {
		aClass192_3966 = new IncomingPacket(82, 6);
	...
	public static final GraphicsToolkit method3612(d var_d, int i, int i_0_, int i_1_, java.awt.Canvas canvas) {
		anInt3954++;
		if (i_1_ != -25440)
			method3624(-29);
	...
	public static final void method3618(int i) {
		...
		if (Node_Sub38_Sub5.aBoolean10125 && i == 16711680)
			while ((Class180.aClass377_Sub1Array2143.length ^ 0xffffffff) < (EntityNode_Sub3_Sub1.anInt9163
					^ 0xffffffff)) {
				...
				if (class377_sub1 == null || (class377_sub1.anInt8779 ^ 0xffffffff) != 0)
					...
					if (GLToolkit.aNode_Sub7_6558 == null)
						GLToolkit.aNode_Sub7_6558 = Animable.aClass193_5936.method1959((byte) -60,
								class377_sub1.aString8773);
	...
	public static final Class244[] method3624(int i) {
		anInt3965++;
		if (i != 0)
		...
		if (Node_Sub52.aClass244Array7654 == null) {
			...
			while_228_: for (int i_10_ = 0; i_10_ < class244s.length; i_10_++) {
				Class244 class244 = class244s[i_10_];
				if (((class244.anInt3079 ^ 0xffffffff) >= -1 || (class244.anInt3079 ^ 0xffffffff) <= -25)
						&& (class244.anInt3084 ^ 0xffffffff) <= -801 && (class244.anInt3078 ^ 0xffffffff) <= -601
						&& (i_9_ != 2 || (class244.anInt3084 ^ 0xffffffff) >= -801
								&& (class244.anInt3078 ^ 0xffffffff) >= -601)
						&& (i_9_ != 1 || (class244.anInt3084 ^ 0xffffffff) >= -1025 && class244.anInt3078 <= 768)) {
					for (int i_11_ = 0; i_11_ < i_8_; i_11_++) {
						Class244 class244_12_ = class244s_7_[i_11_];
						if ((class244.anInt3084 ^ 0xffffffff) == (class244_12_.anInt3084 ^ 0xffffffff)
								&& class244.anInt3078 == class244_12_.anInt3078) {
	...
	public final void method3611(Node node, int i) {
		anInt3962++;
	...
	public final Node method3613(int i) {
		anInt3957++;
	...
	public final void method3614(int i) {
		anInt3975++;
		for (;;) {
			Node node = aNode3958.aNode2800;
			if (aNode3958 == node)
	...
	public final int method3615(int i) {
		if (i >= -63)
			aNode3970 = null;
		anInt3963++;
		int i_2_ = 0;
	...
	public final boolean method3616(int i) {
		if (i != 0)
			method3613(77);
		anInt3972++;
	...
	public final Node method3619(int i) {
		anInt3974++;
		Node node = aNode3958.aNode2800;
		if (node == aNode3958)
			return null;
	...
	public final Node method3620(int i) {
		if (i != 16776960)
			method3618(-17);
		anInt3956++;
		Node node = aNode3970;
	...
	public final void method3621(int i, Class312 class312_6_) {
	...
	public final Node method3622(byte b) {
		if (b != -60)
			aClass318_3973 = null;
		anInt3959++;
	...
	public final Node method3623(byte b) {
		anInt3969++;
		Node node = aNode3970;
		if (node == aNode3958) {
			aNode3970 = null;
	...
	public final void method3625(byte b, Node node) {
		if (node.aNode2799 != null)
