...
public class Class314 {
	...
	public static Node_Sub41[] LocalNPCs = new Node_Sub41[1024];
	...
	public static final void method3652(int i) {
		anInt4020++;
		int i_0_ = 256 + 512 * Renderer.anInt3663;
		int i_1_ = Node_Sub38_Sub38.anInt10490 * 512 + 256;
		int i_2_ = Node_Sub38_Sub7.method2809(CacheNode_Sub20_Sub1.myPlayerPlane, -29754, i_1_, i_0_)
				+ -Class194.anInt2370;
		if (ItemDefinitions.anInt1858 >= 100) {
			...
			if ((Class98.anInt5061 ^ 0xffffffff) > (i_0_ ^ 0xffffffff)) {
				Class98.anInt5061 += Class169_Sub3.anInt8821
						- -((-Class98.anInt5061 + i_0_) * ItemDefinitions.anInt1858 / 1000);
				if (i_0_ < Class98.anInt5061)
					Class98.anInt5061 = i_0_;
			}
			if (i_2_ > Class190.anInt2331) {
				Class190.anInt2331 += Class169_Sub3.anInt8821
						+ ItemDefinitions.anInt1858 * (i_2_ + -Class190.anInt2331) / 1000;
				if (i_2_ < Class190.anInt2331)
					Class190.anInt2331 = i_2_;
			}
			if ((i_0_ ^ 0xffffffff) > (Class98.anInt5061 ^ 0xffffffff)) {
				Class98.anInt5061 -= Class169_Sub3.anInt8821
						+ (-i_0_ + Class98.anInt5061) * ItemDefinitions.anInt1858 / 1000;
				if ((i_0_ ^ 0xffffffff) < (Class98.anInt5061 ^ 0xffffffff))
					Class98.anInt5061 = i_0_;
			}
			if (Class190.anInt2331 > i_2_) {
				Class190.anInt2331 -= Class169_Sub3.anInt8821
						+ (Class190.anInt2331 - i_2_) * ItemDefinitions.anInt1858 / 1000;
				if ((i_2_ ^ 0xffffffff) < (Class190.anInt2331 ^ 0xffffffff))
					Class190.anInt2331 = i_2_;
			}
			if ((Node_Sub10.anInt7079 ^ 0xffffffff) > (i_1_ ^ 0xffffffff)) {
				Node_Sub10.anInt7079 += Class169_Sub3.anInt8821
						- -((i_1_ - Node_Sub10.anInt7079) * ItemDefinitions.anInt1858 / 1000);
				if ((i_1_ ^ 0xffffffff) > (Node_Sub10.anInt7079 ^ 0xffffffff))
					Node_Sub10.anInt7079 = i_1_;
			}
			if ((Node_Sub10.anInt7079 ^ 0xffffffff) < (i_1_ ^ 0xffffffff)) {
				Node_Sub10.anInt7079 -= ItemDefinitions.anInt1858 * (Node_Sub10.anInt7079 + -i_1_) / 1000
						+ Class169_Sub3.anInt8821;
				if ((i_1_ ^ 0xffffffff) < (Node_Sub10.anInt7079 ^ 0xffffffff))
					Node_Sub10.anInt7079 = i_1_;
			}
		}
		...
		i_2_ = Node_Sub38_Sub7.method2809(CacheNode_Sub20_Sub1.myPlayerPlane, -29754, i_1_, i_0_)
				- Class134_Sub1.anInt9015;
		int i_3_ = i_0_ - Class98.anInt5061;
		int i_4_ = -Class190.anInt2331 + i_2_;
		int i_5_ = -Node_Sub10.anInt7079 + i_1_;
		int i_6_ = (int) Math.sqrt(i_5_ * i_5_ + i_3_ * i_3_);
		int i_7_ = (int) (2607.5945876176133 * Math.atan2(i_4_, i_6_)) & 0x3fff;
		int i_8_ = 0x3fff & (int) (-2607.5945876176133 * Math.atan2(i_3_, i_5_));
		...
		if (i >= 39) {
			if (OutgoingPacket.anInt4050 < i_7_) {
				OutgoingPacket.anInt4050 += (-OutgoingPacket.anInt4050 + i_7_ >> 3) * Node_Sub13.anInt7116 / 1000
						+ Node_Sub24.anInt7229 << 3;
				if (i_7_ < OutgoingPacket.anInt4050)
					OutgoingPacket.anInt4050 = i_7_;
			}
			if ((OutgoingPacket.anInt4050 ^ 0xffffffff) < (i_7_ ^ 0xffffffff)) {
				OutgoingPacket.anInt4050 -= Node_Sub24.anInt7229
						+ Node_Sub13.anInt7116 * (OutgoingPacket.anInt4050 + -i_7_ >> 3) / 1000 << 3;
				if (OutgoingPacket.anInt4050 < i_7_)
					OutgoingPacket.anInt4050 = i_7_;
			}
	...
	public final void method3654(BufferedStream buffer, int i) {
		if (i == -1050722685) {
			anInt4015++;
			for (;;) {
