...
public class Class317 {
	...
	public static final int method3663(int i, int i_0_, int i_1_, boolean bool) {
		anInt4042++;
		if (i_0_ != -1)
	...
	public static final byte[] method3664(int i, byte[] bs, int i_2_) {
		anInt4040++;
		if (i != 1)
			return null;
	...
	public static final void method3665(int i, IComponentDefinitions widget, boolean bool, int i_4_) {
		anInt4041++;
		if (Class58.aWidget861 == null && !Class213.aBoolean2510
				&& (widget != null && Class308.method3585(widget, !bool) != null)) {
			if (bool != true)
				anInt4038 = 51;
