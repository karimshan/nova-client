...
public class Class320_Sub12 extends Class320 {
	public static boolean aBoolean8325 = false;
	public static Class251 aClass251_8324 = new Class251(2);
	public static Index aClass302_8326;
	public static int anInt8316;
	public static int anInt8317;
	public static int anInt8318;
	public static int anInt8319;
	public static int anInt8320;
	public static int anInt8321;
	public static int anInt8322;
	public static int anInt8323;
	public static int anInt8327 = 0;

	public static final void method3727(Class121 class121, byte b, int i, int i_0_, int i_1_, int i_2_) {
		anInt8318++;
		@SuppressWarnings("unused")
		int i_3_ = -41 / ((-70 - b) / 56);
		Node_Sub19 node_sub19 = null;
		for (Node_Sub19 node_sub19_4_ = (Node_Sub19) Class262_Sub8.aClass312_7755
				.method3613(65280); node_sub19_4_ != null; node_sub19_4_ = (Node_Sub19) Class262_Sub8.aClass312_7755
						.method3620(16776960))
			if (node_sub19_4_.anInt7165 == i && node_sub19_4_.anInt7171 == i_1_
					&& (node_sub19_4_.anInt7161 ^ 0xffffffff) == (i_2_ ^ 0xffffffff)
					&& (i_0_ ^ 0xffffffff) == (node_sub19_4_.anInt7166 ^ 0xffffffff)) {
	...
	public static final void method3728(int i) {
		anInt8317++;
		int i_5_ = 0;
	...
	public final boolean method3726(byte b) {
		anInt8320++;
	...
	public final int method3730(boolean bool) {
		if (bool != false)
			return 109;
		anInt8322++;
		return anInt4064;
