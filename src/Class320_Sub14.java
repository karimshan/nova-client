...
public class Class320_Sub14 extends Class320 {
	public static int anInt8340;
	public static int anInt8341;
	public static int anInt8342;
	public static int anInt8343;
	public static int anInt8344;
	public static int anInt8345;
	public static int anInt8346;
	public static int anInt8347;

	public static final short[][] method3735(int i, float[][] fs, short[][] ses) {
	...
	public static final Class270 method3736(int i, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_) {
		anInt8343++;
		long l = 67481L * i_7_ ^ i_3_ * 97549L ^ 475427L * i_4_ ^ i_5_ * 986053L ^ 32147369L * i ^ i_6_ * 76724863L;
	...
	public final int method3737(boolean bool) {
		anInt8346++;
		if (bool != false)
			return -78;
		return anInt4064;
