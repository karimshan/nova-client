...
public class Class320_Sub16 extends Class320 {
	public static Class312 aClass312_8358 = new Class312();
	public static int anInt8356;
	public static int anInt8357;
	...
	public static final int method3742(int i, int i_0_) {
		anInt8357++;
	...
	public final boolean method3741(byte b) {
		if (b <= 63)
			aClass312_8358 = null;
		anInt8362++;
		return true;
	...
	public final int method3744(boolean bool) {
		if (bool != false)
			return 40;
		anInt8363++;
		return anInt4064;
