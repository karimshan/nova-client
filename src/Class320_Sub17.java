...
public class Class320_Sub17 extends Class320 {
	public static IncomingPacket aClass192_8368 = new IncomingPacket(135, 0);
	public static int anInt8366;
	public static int anInt8367;
	public static int anInt8369;
	public static int anInt8370;
	public static int anInt8371;
	public static int anInt8372;
	...
	public static final void method3746(int i, int i_0_, int i_1_, int i_2_) {
		...
		if (class261 != null) {
			...
			if (animable_sub4_3_ != null) {
				animable_sub4_3_.aShort9145 = (short) (animable_sub4_3_.aShort9145 * i_2_
						/ (16 << Class36.anInt549 - 7));
				animable_sub4_3_.aShort9147 = (short) (animable_sub4_3_.aShort9147 * i_2_
						/ (16 << Class36.anInt549 - 7));
			}
		}
	}
	...
	public final int method3747(boolean bool) {
		if (bool != false)
			method3677(-39);
		anInt8369++;
		return anInt4064;
