...
public class Class320_Sub18 extends Class320 {
	public static boolean aBoolean8375 = false;
	public static byte[][] aByteArrayArray8378;
	public static byte[][] aByteArrayArray8379;
	public static int anInt8373;
	public static int anInt8374;
	public static int anInt8376;
	public static int anInt8377;
	public static int anInt8380;
	public static int anInt8381;
	public static int[] anIntArray8382 = new int[8];
	...
	public final int method3677(int i) {
		...
		if (aNode_Sub27_4063.aClass320_Sub29_7270.method3789(-1)
				&& Class250.method3096(aNode_Sub27_4063.aClass320_Sub29_7270.method3791(false), -111))
			return 1;
		return 0;
	}

	public final int method3749(boolean bool) {
		if (bool != false)
	...
	public final boolean method3750(byte b) {
		anInt8381++;
		if (b <= 63)
			method3748((byte) -118);
