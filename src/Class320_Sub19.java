...
public class Class320_Sub19 extends Class320 {
	...
	public static final int method3753(int i, int i_0_) {
		anInt8391++;
		i--;
		if (i_0_ != -729073628)
			return -64;
	...
	public static final CacheNode_Sub2 method3754(int i, int i_1_, long l) {
		if (i != 3)
			anInt8385 = -39;
		anInt8384++;
		CacheNode_Sub2 cachenode_sub2 = (CacheNode_Sub2) Class270_Sub2_Sub2.aHashTable10552.getNode(3512,
				l | (long) i_1_ << 56);
	...
	public static final void method3755(int i, Node_Sub9 node_sub9) {
		...
		if (i != -729073628)
			method3752((byte) 14);
		for (Node_Sub9 node_sub9_2_ = node_sub9.method2429(); node_sub9_2_ != null; node_sub9_2_ = node_sub9
				.method2431())
	...
	public final int method3751(boolean bool) {
		if (bool != false)
