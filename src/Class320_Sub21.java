...
public class Class320_Sub21 extends Class320 {
	public static boolean[] aBooleanArray8403;
	public static int anInt8404;
	public static int anInt8405;
	...
	public static int anInt8412;
	public static int anInt8413;
	...
	public static final void method3760(boolean bool, GraphicsToolkit graphicstoolkit) {
		CacheNode_Sub18.aClass52_9609 = Class171.method1792(true, true, GameMessage.anInt7625, -115, graphicstoolkit);
		anInt8408++;
		Class85.aClass357_1159 = Class150_Sub2.method1660((byte) -23, GameMessage.anInt7625, graphicstoolkit);
		...
		Class262_Sub4.abstractFont = Class171.method1792(true, bool, Class340.anInt4220, -108, graphicstoolkit);
		Class262_Sub15_Sub1.aClass357_10524 = Class150_Sub2.method1660((byte) 109, Class340.anInt4220, graphicstoolkit);
	}

	public static final Class169_Sub2_Sub1 method3761(int i, int i_0_, int i_1_, byte[] bs, int i_2_, GLToolkit gltoolkit,
		...
		if (!gltoolkit.aBoolean6649)
			return new Class169_Sub2_Sub1(gltoolkit, i_0_, i_3_, i, Class320_Sub19.method3753(i_3_, -729073628),
					Class320_Sub19.method3753(i, -729073628), bs, i_2_);
		return new Class169_Sub2_Sub1(gltoolkit, 34037, i_0_, i_3_, i, bool, bs, i_2_);
	}

	public static final byte[] method3763(int i, String string) {
		anInt8404++;
	...
	public static final void method3764(int i) {
		for (int i_8_ = 0; i_8_ < 100; i_8_++)
			Login.aBooleanArray2387[i_8_] = true;
		if (i > -68)
			method3764(-15);
		anInt8411++;
	}
	...
	public final int method3762(boolean bool) {
		if (bool != false)
			return -53;
		anInt8412++;
		return anInt4064;
