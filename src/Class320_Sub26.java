...
public class Class320_Sub26 extends Class320 {
	public static IncomingPacket aClass192_8450;
	public static OutgoingPacket aClass318_8459;
	public static int anInt8451;
	public static int anInt8452;
	public static int anInt8453;
	public static int anInt8454;
	public static int anInt8455;
	public static int anInt8456 = 13156520;
	public static int anInt8457;
	public static int anInt8458;

	static {
		aClass192_8450 = new IncomingPacket(127, 6);
		aClass318_8459 = new OutgoingPacket(88, -1);
	}

	public static final void method3777() {
		...
		if (Class225.aClass261ArrayArrayArray2680 != null)
			for (int i = 0; i < Class225.aClass261ArrayArrayArray2680.length; i++)
				for (int i_2_ = 0; i_2_ < Class328.anInt4115; i_2_++)
					for (int i_3_ = 0; i_3_ < GameMessage.anInt7623; i_3_++) {
		...
		if (CS2Definition.anAnimableArray516 != null) {
			for (int i = 0; i < CS2Definition.anAnimableArray516.length; i++)
				CS2Definition.anAnimableArray516[i] = null;
		...
		if (Class143.aClass326Array1771 != null) {
			...
			for (int i = 0; i < Class159.anInt1995; i++)
				for (int i_4_ = 0; i_4_ < Class328.anInt4115; i_4_++)
					for (int i_5_ = 0; i_5_ < GameMessage.anInt7623; i_5_++)
						PlayerMasks.aLongArrayArrayArray1228[i][i_4_][i_5_] = 0L;
	...
	public final int method3779(boolean bool) {
		if (bool != false)
			method3677(62);
		anInt8458++;
		return anInt4064;
	...
	public final boolean method3780(byte b) {
		anInt8454++;
		if (b < 63)
			return false;
