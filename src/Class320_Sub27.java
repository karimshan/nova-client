...
public class Class320_Sub27 extends Class320 {
	public static boolean aBoolean8465 = false;
	public static int anInt8460;
	public static int anInt8461;
	public static int anInt8462;
	public static int anInt8463;
	public static int anInt8464;
	public static int anInt8466;
	public static int anInt8467;
	public static int anInt8468;

	public static final void method3781(int i, int i_0_, int i_1_, Animable_Sub2 animable_sub2,
			Animable_Sub2 animable_sub2_2_) {
	...
	public static final void method3782(boolean bool) {
		anInt8467++;
	...
	public final int method3783(boolean bool) {
		anInt8463++;
		if (bool != false)
			method3673((byte) -112);
		return anInt4064;
