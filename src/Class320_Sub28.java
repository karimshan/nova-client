...
public class Class320_Sub28 extends Class320 {
	public static int anInt8469;
	public static int anInt8470;
	public static int anInt8471;
	public static int anInt8472;
	public static int anInt8473;
	public static int anInt8475;
	public static int anInt8476;
	public static int anInt8477;
	public static Object anObject8474;

	public static final void method3784(byte b) {
		anInt8475++;
	...
	public final boolean method3786(byte b) {
		anInt8470++;
		if (b <= 63)
			anInt8469 = 85;
	...
	public final int method3787(boolean bool) {
		if (bool != false)
			return 92;
		anInt8472++;
		return anInt4064;
