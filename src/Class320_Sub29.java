...
public class Class320_Sub29 extends Class320 {
	public static IncomingPacket aClass192_8481;
	public static int anInt8478;
	...
	public static IComponentDefinitions aWidget8488 = null;
	static {
		aClass192_8481 = new IncomingPacket(108, 12);
	}

	public static final void method3788(int i, Class257 class257) {
		anInt8478++;
		...
		if (class257 == Class189_Sub1.aClass257_6882) { // sendDestroyGroundItem
			...
			if (Class266.aHashTable3380 != null) {
				Node_Sub11 node_sub11 = (Node_Sub11) Class266.aHashTable3380.getNode(3512,
						Class50.basePlane << 28 | i_2_ << 14 | i_4_);
				if (node_sub11 != null) {
					...
					if ((i_3_ ^ 0xffffffff) <= -1 && (i_1_ ^ 0xffffffff) <= -1 && Node_Sub54.GAME_SCENE_WDITH > i_3_
			...
			if ((i_11_ & 0x1 ^ 0xffffffff) != -2) {
				...
				Class320_Sub12.method3727(new Class121(Class187.aLong2275++, is, ses, ses_23_), (byte) -126,
						Class50.basePlane, i_10_, i_13_, i_14_);
			} else
			...
			LoadingBarStage.method1131(Class50.basePlane, i_28_, i_30_, i_25_, i_27_, i_31_, -4, i_32_);
			...
			if (class257 == Node_Sub37.aClass257_7443) {
				...
				if (i_36_ >= 0 && (i_37_ ^ 0xffffffff) <= -1
						&& (i_36_ ^ 0xffffffff) > (Node_Sub54.GAME_SCENE_WDITH ^ 0xffffffff)
						&& (Class377_Sub1.GAME_SCENE_HEIGHT ^ 0xffffffff) < (i_37_ ^ 0xffffffff)) {
					int i_45_ = i_40_ - -1;
					if (-i_45_ + i_36_ <= Player.get.scenePositionXQueue[0]
							&& i_45_ + i_36_ >= Player.get.scenePositionXQueue[0]
							&& Player.get.scenePositionYQueue[0] >= -i_45_ + i_37_
							&& (i_45_ + i_37_ ^ 0xffffffff) <= (Player.get.scenePositionYQueue[0] ^ 0xffffffff))
						Class95.method1067(i_43_, i_42_, (byte) 35, i_38_, i_41_, i_44_,
								i_40_ + ((i_37_ << 8) + (Class50.basePlane << 24)) - -(i_36_ << 16));
				}
				...
				if (Class134_Sub1.method1581(Class61.anInt898, -25900)
						|| (i_47_ ^ 0xffffffff) <= -1 && i_48_ >= 0 && Node_Sub54.GAME_SCENE_WDITH > i_47_
				...
				if (i_69_ == 255)
					i_69_ = -1;
				if (i_55_ >= 0 && (i_56_ ^ 0xffffffff) <= -1
						&& (i_55_ ^ 0xffffffff) > (Node_Sub54.GAME_SCENE_WDITH * 2 ^ 0xffffffff)
						&& i_56_ < Node_Sub54.GAME_SCENE_WDITH * 2 && i_60_ >= 0 && i_61_ >= 0
						&& 2 * Class377_Sub1.GAME_SCENE_HEIGHT > i_60_ && Class377_Sub1.GAME_SCENE_HEIGHT * 2 > i_61_
					...
					if ((i_62_ ^ 0xffffffff) != -1 && i_59_ != -1) {
						...
						if ((i_62_ ^ 0xffffffff) <= -1) {
							int i_71_ = i_62_ + -1;
							Node_Sub41 node_sub41 = (Node_Sub41) Class12.aHashTable187.getNode(3512, i_71_);
							if (node_sub41 != null)
								actor = node_sub41.aNpc7518;
						} else {
							int i_72_ = -1 + -i_62_;
							if (i_72_ != Class166.myPlayerIndex)
								actor = Client.LOCAL_PLAYERS[i_72_];
							else
								actor = Player.get;
						}
						if (actor != null) {
					...
					Mobile_Sub1 mobile_sub1 = new Mobile_Sub1(i_64_, Class50.basePlane, Class50.basePlane, i_55_, i_56_,
							i_65_, i_67_ - -Class174.clientCycle, Class174.clientCycle + i_68_, i_69_, i_70_, i_62_,
							i_63_, i_66_, bool, i_59_);
					mobile_sub1.method895(Node_Sub38_Sub7.method2809(Class50.basePlane, -29754, i_61_, i_60_) - i_66_,
							false, i_67_ + Class174.clientCycle, i_61_, i_60_);
				...
				if (i_73_ != Class166.myPlayerIndex) {
					boolean bool = i_77_ >= 0 && i_75_ >= 0 && Node_Sub54.GAME_SCENE_WDITH > i_77_
							&& (i_75_ ^ 0xffffffff) > (Class377_Sub1.GAME_SCENE_HEIGHT ^ 0xffffffff);
					if (bool || Class134_Sub1.method1581(Class61.anInt898, i + -25900)) {
						Node_Sub38_Sub1.method2789(Class50.basePlane, (byte) -108, i_76_, i_78_,
								new Node_Sub8(i_79_, i_80_));
						if (bool)
							Node_Sub36.method2750(false, Class50.basePlane, i_75_, i_77_);
					}
				}
			} else if (ConnectionDecoder.aClass257_5467 == class257) {
				...
				if (i_82_ >= 0 && i_83_ >= 0 && Node_Sub54.GAME_SCENE_WDITH > i_82_
						&& (Class377_Sub1.GAME_SCENE_HEIGHT ^ 0xffffffff) < (i_83_ ^ 0xffffffff)) {
					int i_91_ = 1 + i_86_;
					if (Player.get.scenePositionXQueue[0] >= -i_91_ + i_82_
							&& (i_91_ + i_82_ ^ 0xffffffff) <= (Player.get.scenePositionXQueue[0] ^ 0xffffffff)
							&& (Player.get.scenePositionYQueue[0] ^ 0xffffffff) <= (-i_91_ + i_83_ ^ 0xffffffff)
							&& Player.get.scenePositionYQueue[0] <= i_83_ + i_91_)
						Node_Sub13.method2549(i_87_, i_88_,
								i_86_ + (i_83_ << 8) + ((Class50.basePlane << 24) + (i_82_ << 16)), i + -620649727,
								false, i_90_, i_89_, i_84_);
				}
				...
				Node_Sub11 node_sub11 = (Node_Sub11) Class266.aHashTable3380.getNode(i ^ 0xdb8,
						i_95_ << 14 | Class50.basePlane << 28 | i_97_);
				if (node_sub11 != null) {
					for (Node_Sub8 node_sub8 = (Node_Sub8) node_sub11.aClass312_7104.method3613(
							i ^ 0xff00); node_sub8 != null; node_sub8 = (Node_Sub8) node_sub11.aClass312_7104
					...
					if (i_96_ >= 0 && (i_94_ ^ 0xffffffff) <= -1 && i_96_ < Node_Sub54.GAME_SCENE_WDITH
				...
				if (i_115_ == 255)
					i_115_ = -1;
				if ((i_105_ ^ 0xffffffff) <= -1 && (i_106_ ^ 0xffffffff) <= -1
						&& (Node_Sub54.GAME_SCENE_WDITH ^ 0xffffffff) < (i_105_ ^ 0xffffffff)
						&& i_106_ < Class377_Sub1.GAME_SCENE_HEIGHT && i_107_ >= 0 && i_108_ >= 0
						&& (Node_Sub54.GAME_SCENE_WDITH ^ 0xffffffff) < (i_107_ ^ 0xffffffff)
						&& i_108_ < Class377_Sub1.GAME_SCENE_HEIGHT && (i_110_ ^ 0xffffffff) != -65536) {
					...
					Mobile_Sub1 mobile_sub1 = new Mobile_Sub1(i_110_, Class50.basePlane, Class50.basePlane, i_105_,
							i_106_, i_111_, i_113_ - -Class174.clientCycle, i_114_ + Class174.clientCycle, i_115_,
							i_116_, 0, i_109_, i_112_, bool, -1);
					mobile_sub1.method895(
							-i_112_ + Node_Sub38_Sub7.method2809(Class50.basePlane, -29754, i_108_, i_107_), false,
							Class174.clientCycle + i_113_, i_108_, i_107_);
					Class270.aClass312_3477.method3625((byte) -54, new CacheNode_Sub12(mobile_sub1));
				}
				...
				if (Class134_Sub1.method1581(Class61.anInt898, -25900) || i_118_ >= 0 && i_119_ >= 0
						&& Node_Sub54.GAME_SCENE_WDITH > i_118_ && i_119_ < Class377_Sub1.GAME_SCENE_HEIGHT)
				...
				boolean bool = i_127_ >= 0 && i_125_ >= 0
				...
				if (bool || Class134_Sub1.method1581(Class61.anInt898, -25900)) {
					Node_Sub38_Sub1.method2789(Class50.basePlane, (byte) -108, i_126_, i_128_,
							new Node_Sub8(i_129_, i_130_));
					if (bool)
				...
				if ((i_132_ ^ 0xffffffff) <= -1 && (i_133_ ^ 0xffffffff) <= -1 && i_132_ < Node_Sub54.GAME_SCENE_WDITH
					...
					if (i_134_ == -1) {
						...
						if (i_140_ < 3 && Class238.method3021(i_133_, i_132_, 112))
							i_140_++;
						Mobile_Sub4 mobile_sub4 = new Mobile_Sub4(i_134_, i_136_, Class50.basePlane, i_140_, i_138_,
								Node_Sub38_Sub7.method2809(Class50.basePlane, -29754, i_139_, i_138_) - i_135_, i_139_,
								i_132_, i_132_, i_133_, i_133_, i_137_, false);
						Class20_Sub1.aHashTable5508.put(i_132_ << 16 | i_133_, new CacheNode_Sub18(mobile_sub4),
								i ^ ~0x7d);
					}
			} else {
	...
	public static final void method3790(byte b) {
		anInt8491++;
	...
	public final boolean method3789(int i) {
		anInt8484++;
		if (i != -1)
			aBoolean8486 = false;
		return aBoolean8490;
	...
	public final int method3791(boolean bool) {
		anInt8480++;
		if (bool != false)
			aBoolean8486 = true;
		return anInt4064;
	...
	public final boolean method3793(byte b) {
		anInt8483++;
	...
	public final void method3794(boolean bool, byte b) {
		aBoolean8490 = bool;
		anInt8489++;
		if (b != 99)
			aWidget8488 = null;
