...
public class Class320_Sub3 extends Class320 {
	public static boolean aBoolean8235 = false;
	public static OutgoingPacket aClass318_8233 = new OutgoingPacket(17, -1);
	public static HashTable aHashTable8234 = new HashTable(16);
	public static int anInt8223;
	...
	public static final void method3690(int i, int i_0_) {
		...
		System.out.println("Method3690 called in Class320_Sub3 " + Class188_Sub1_Sub1.aString9327);
		if (i != -11055)
			method3687(102);
	}

	public static final void method3692(byte[] bs, byte b, boolean bool) {
		anInt8231++;
		...
		if (b < -35) {
			...
			if (method3689((byte) 124)) {
				if (aNode_Sub27_4063.aClass320_Sub29_7270.method3789(-1)
						&& !Class188_Sub2_Sub2.method1911(aNode_Sub27_4063.aClass320_Sub29_7270.method3791(false), 2))
					anInt4064 = 1;
	...
	public final boolean method3688(byte b) {
		anInt8229++;
		if (b <= 63)
			aClass318_8233 = null;
		return true;
	...
	public final boolean method3689(byte b) {
		anInt8223++;
		if (b <= 118)
			aBoolean8235 = false;
	...
	public final int method3691(boolean bool) {
		anInt8232++;
		if (bool != false)
