...
public class Class320_Sub30 extends Class320 {
	...
	public static int anInt8494;
	public static int anInt8495;
	public static int anInt8496;
	public static int anInt8497;
	public static int anInt8498;
	public static int anInt8499;

	public static final boolean method3797(r var_r, int i, int i_0_, int i_1_, boolean[] bools) {
		boolean bool = false;
	...
	public static final void method3798(int i) {
		anInt8493++;
		if ((Class213.aNode_Sub27_2512.aClass320_Sub19_7301.method3751(false) ^ 0xffffffff) == -1
				&& (Class94.anInt1249 ^ 0xffffffff) != (CacheNode_Sub20_Sub1.myPlayerPlane ^ 0xffffffff))
			Class364.method4057(false, Player.anInt11178, 12, Class277.anInt3527, (byte) -36);
		else {
			Class56.method563(i ^ 0x2e92, Class93.graphicsToolkit);
	...
	public final boolean method3795(byte b) {
		anInt8494++;
		if (b < 63)
			anInt8495 = 20;
		if (aNode_Sub27_4063.method2691(3) == Node_Sub38_Sub34.aClass353_10443) {
	...
	public final int method3796(boolean bool) {
		anInt8492++;
		if (bool != false)
			anInt8495 = -119;
		return anInt4064;
