...
public class Class320_Sub4 extends Class320 {
	...
	public static int anInt8237;
	public static int anInt8238;
	public static int anInt8239;
	public static int anInt8240;
	public static int anInt8241;
	public static int anInt8242;
	public static int gameSceneBaseY;

	public static final boolean method3693(int i, int i_0_, int i_1_) {
		if (i < 20)
			gameSceneBaseY = 87;
		anInt8237++;
		if ((0x800 & i_0_) == 0)
	...
	public final int method3694(boolean bool) {
		if (bool != false)
			gameSceneBaseY = 102;
		anInt8238++;
		return anInt4064;
