...
public class Class320_Sub5 extends Class320 {
	public static Class124 aClass124_8253 = new Class124(41);
	public static IncomingPacket aClass192_8251 = new IncomingPacket(137, 8);
	public static GLSprite[] aGLSpriteArray8254;
	...
	public static int anInt8249;
	public static int anInt8250;
	public static int anInt8252;
	public static int[] anIntArray8255 = new int[64];

	public static final void method3695(Class179 class179) {
	...
	public static final Node_Sub13 method3699(int i) {
		anInt8249++;
		if (i <= 82)
			method3695(null);
	...
	public static final boolean method3700(int i, byte b, int i_1_) {
		anInt8245++;
		if (b <= 122)
	...
	public final int method3697(boolean bool) {
		if (bool != false)
			method3699(-30);
		anInt8247++;
		return anInt4064;
	...
	public final boolean method3698(byte b) {
		anInt8246++;
		int i = aNode_Sub27_4063.method2694(-13725).method1877((byte) 71);
		if (b <= 63)
			return false;
