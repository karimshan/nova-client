...
public class Class320_Sub6 extends Class320 {
	public static byte[][] aByteArrayArray8263;
	public static Class124 aClass124_8267 = new Class124(32);
	public static double aDouble8262;
	public static int anInt8256;
	public static int anInt8257;
	public static int anInt8258;
	public static int anInt8259;
	public static int anInt8260;
	public static int anInt8264;
	public static int anInt8266;
	public static Object anObject8265;
	public static Index index32or34;

	public static final void method3703(int i, byte b, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_) {
		if ((i ^ 0xffffffff) == -9 || (i ^ 0xffffffff) == -17) {
			if ((i ^ 0xffffffff) == -9) {
				...
				IsaacCipher.aClass54Array1840[Class83.anInt5183++] = new Class54(i, i_3_, i_5_, i_6_, i_6_, i_5_, i_9_,
						i_10_, -i_4_ + i_10_, -i_4_ + i_9_, i_7_, i_8_, i_8_, i_7_);
			} else {
				...
				IsaacCipher.aClass54Array1840[Class83.anInt5183++] = new Class54(i, i_3_, i_11_, i_12_, i_12_, i_11_,
						i_15_, i_16_, -i_4_ + i_16_, i_15_ - i_4_, i_13_, i_14_, i_14_, i_13_);
			}
		} else {
	...
	public static final void method3705(int i, int i_18_, int i_19_, Animable_Sub4 animable_sub4,
			Animable_Sub4 animable_sub4_20_) {
	...
	public final int method3701(boolean bool) {
		if (bool != false)
			method3673((byte) 11);
		anInt8266++;
		return anInt4064;
	...
	public final boolean method3702(byte b) {
		anInt8264++;
		if (b < 63)
			method3701(true);
