...
public class Class320_Sub7 extends Class320 {
	public static int anInt8268;
	public static int anInt8269;
	...
	public static int anInt8277;
	public static int anInt8278;
	public static int[] anIntArray8271 = new int[5];
	public static Interface21[] anInterface21Array8275 = new Interface21[128];
	...
	public static final byte method3707(int i, byte b, int i_0_) {
		anInt8270++;
		if (b != 125)
			return (byte) 75;
		if ((i ^ 0xffffffff) != -10)
	...
	public static final void method3710(byte b, int i) {
		anInt8268++;
	...
	public static final boolean method3711(byte b, int i, int i_1_) {
		anInt8278++;
		if (b < 28)
			return true;
	...
	public final int method3708(boolean bool) {
		anInt8273++;
		if (bool != false)
			return 72;
		return anInt4064;
	...
	public final boolean method3709(byte b) {
		if (b <= 63)
			method3708(true);
		anInt8274++;
