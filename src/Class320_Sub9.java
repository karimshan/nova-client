...
public class Class320_Sub9 extends Class320 {
	...
	public static final boolean method3713(int i, int i_0_, int i_1_) {
		if (i < 78)
	...
	public static final void method3714(int i, byte b, int i_2_, int i_3_, int i_4_) {
		for (Node_Sub47 node_sub47 = (Node_Sub47) Class290_Sub6.aClass312_8122.method3613(
				65280); node_sub47 != null; node_sub47 = (Node_Sub47) Class290_Sub6.aClass312_8122.method3620(16776960))
			Class338.method3913(i, node_sub47, i_4_, i_3_, (byte) 54, i_2_);
		anInt8289++;
		if (b < -123) {
			for (Node_Sub47 node_sub47 = (Node_Sub47) Class200_Sub2.aClass312_4942
					.method3613(65280); node_sub47 != null; node_sub47 = (Node_Sub47) Class200_Sub2.aClass312_4942
							.method3620(16776960)) {
				int i_5_ = 1;
				...
				if ((i_6_ ^ 0xffffffff) == 0 || node_sub47.aNpc7583.aBoolean10867)
					i_5_ = 0;
				else if ((i_6_ ^ 0xffffffff) != (class259.anInt3252 ^ 0xffffffff) && i_6_ != class259.anInt3271
						&& (i_6_ ^ 0xffffffff) != (class259.anInt3293 ^ 0xffffffff) && class259.anInt3270 != i_6_) {
					if ((class259.anInt3262 ^ 0xffffffff) == (i_6_ ^ 0xffffffff)
							|| (i_6_ ^ 0xffffffff) == (class259.anInt3297 ^ 0xffffffff) || class259.anInt3304 == i_6_
							|| i_6_ == class259.anInt3269)
						i_5_ = 3;
				} else
					i_5_ = 2;
				if ((node_sub47.anInt7586 ^ 0xffffffff) != (i_5_ ^ 0xffffffff)) {
					int i_7_ = Class266.method3243(-68, node_sub47.aNpc7583);
					NPCDefinition npcdefinition = node_sub47.aNpc7583.defs;
					...
					if (npcdefinition != null && (i_7_ ^ 0xffffffff) != 0) {
						if ((i_7_ ^ 0xffffffff) != (node_sub47.anInt7564 ^ 0xffffffff)
			...
			for (Node_Sub47 node_sub47 = (Node_Sub47) Class320_Sub3.aHashTable8234.method1516(
					false); node_sub47 != null; node_sub47 = (Node_Sub47) Class320_Sub3.aHashTable8234.method1520(69)) {
				int i_8_ = 1;
				...
				if (i_9_ == -1 || node_sub47.aPlayer7573.aBoolean10867)
					i_8_ = 0;
				else if ((i_9_ ^ 0xffffffff) == (class259.anInt3252 ^ 0xffffffff)
						|| (i_9_ ^ 0xffffffff) == (class259.anInt3271 ^ 0xffffffff)
						|| (class259.anInt3293 ^ 0xffffffff) == (i_9_ ^ 0xffffffff) || i_9_ == class259.anInt3270)
					i_8_ = 2;
				else if ((class259.anInt3262 ^ 0xffffffff) == (i_9_ ^ 0xffffffff)
						|| (i_9_ ^ 0xffffffff) == (class259.anInt3297 ^ 0xffffffff)
						|| (class259.anInt3304 ^ 0xffffffff) == (i_9_ ^ 0xffffffff) || i_9_ == class259.anInt3269)
					i_8_ = 3;
				if ((i_8_ ^ 0xffffffff) != (node_sub47.anInt7586 ^ 0xffffffff)) {
					int i_10_ = Class172.method1797(-1, node_sub47.aPlayer7573);
					if (node_sub47.anInt7564 == i_10_
							&& !node_sub47.aPlayer7573.hasDisplayName == !node_sub47.aBoolean7580) {
				...
				node_sub47.anInt7582 = node_sub47.aPlayer7573.anInt5934
						+ (node_sub47.aPlayer7573.getSize((byte) 127) << 8);
				node_sub47.anInt7563 = node_sub47.aPlayer7573.anInt5940;
				node_sub47.anInt7559 = node_sub47.aPlayer7573.anInt5940
						- -(node_sub47.aPlayer7573.getSize((byte) 62) << 8);
				Class338.method3913(i, node_sub47, i_4_, i_3_, (byte) 54, i_2_);
			}
		}
	}

	public static final void method3716(boolean bool, int i, boolean bool_11_, int i_12_, IComponentDefinitions[] widgets,
			int i_13_) {
		anInt8286++;
		int i_14_ = 0;
		if (bool == true)
	...
	public static final boolean method3717(Class42 class42, Index class302, Index class302_15_, Index class302_16_, int i,
			Node_Sub9_Sub1 node_sub9_sub1) {
	...
	public final int method3715(boolean bool) {
		anInt8287++;
		if (bool != false)
			method3676(false, -66);
		return anInt4064;
