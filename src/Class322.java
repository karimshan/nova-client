...
public class Class322 {
	...
	public final void method3803(int i) {
	...
	public final int method3804(int i, byte b) {
		int i_0_ = -125 % ((b - 58) / 37);
		return anIDirect3DSwapChain4071.Present(i);
	}

	public final void method3805(IDirect3DSurface idirect3dsurface, IDirect3DSwapChain idirect3dswapchain, byte b) {
	...
	public final boolean method3806(int i) {
		if (i != 0)
