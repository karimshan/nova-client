...
public class Class324 {
	...
	public static IComponentDefinitions aWidget4085 = null;
	...
	public static final void processLocalUpdate(int playerIndex, Packet packet) {
		anInt4086++;
		...
		if ((opcode ^ 0xffffffff) == -1) {
			if (needMasksUpdate)
				...
				Client.LOCAL_PLAYERS[playerIndex] = null;
			...
			if (teleportType == 0) { // local teleport up to 16 diff
				...
				int i_19_ = -Node_Sub53.gameSceneBaseX
						+ (player.scenePositionXQueue[0] - -Node_Sub53.gameSceneBaseX - -xOffset & 0x3fff);
				int i_20_ = -Class320_Sub4.gameSceneBaseY
						+ (0x3fff & yOffset + (player.scenePositionYQueue[0] + Class320_Sub4.gameSceneBaseY));
				if (needMasksUpdate) {
					player.aBoolean11156 = true;
				 ...
				 * //System.
				 * out.println("sceneBaseX: "+Node_Sub53.gameSceneBaseX); System
