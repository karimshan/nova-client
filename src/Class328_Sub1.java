...
public class Class328_Sub1 extends Class328 {
	...
	public static int anInt8501;
	public static int anInt8503;
	public static int[] calculatedScenePositionXs = new int[50];

	public static final Class93 method3830(Component component, int i, boolean bool) {
		anInt8503++;
		try {
			if (i != -19397)
				return null;
			Constructor<?> constructor = Class.forName("Class93_Sub1").getDeclaredConstructor(new Class[] {
					aClass8505 == null ? aClass8505 = method3832("java.awt.Component") : aClass8505, Boolean.TYPE });
	...
	@Override
	public final void method3826(float f, float f_0_, int i, float[] fs, int i_1_, float f_2_, int i_3_, float f_4_, int i_5_,
			byte b, int i_6_) {
		anInt8500++;
		int i_7_ = (int) (-1.0F + f_4_ * i);
		i_7_ &= 0xff;
		@SuppressWarnings("unused")
		int i_8_ = -121 / ((b - 24) / 50);
		int i_9_ = (int) (i_6_ * f - 1.0F);
		i_9_ &= 0xff;
		int i_10_ = (int) (-1.0F + i_5_ * f_2_);
		i_10_ &= 0xff;
		float f_11_ = i_3_ * f_2_;
		int i_12_ = (int) f_11_;
		int i_13_ = i_12_ - -1;
		float f_14_ = f_11_ - i_12_;
		...
		for (int i_19_ = 0; i_19_ < i_6_; i_19_++) {
			...
			for (int i_30_ = 0; (i ^ 0xffffffff) < (i_30_ ^ 0xffffffff); i_30_++) {
				float f_31_ = i_30_ * f_4_;
				int i_32_ = (int) f_31_;
				int i_33_ = i_32_ - -1;
				float f_34_ = -i_32_ + f_31_;
				...
				fs[i_1_++] = f_0_
						* GraphicsToolkit
								.method1244(
										GraphicsToolkit
												.method1244(
														GraphicsToolkit.method1244(Class150.method1654(f_14_,
																f_34_, f_23_,
																Node_Sub30.method2723(7, anIntArray8502[i_33_ + i_29_]),
																(byte) -88),
																105,
																Class150.method1654(f_14_, f_35_, f_23_,
																		Node_Sub30.method2723(
																				anIntArray8502[i_32_ + i_29_], 7),
																		(byte) -102),
																f_36_),
														78,
														GraphicsToolkit.method1244(
																Class150.method1654(f_14_, f_34_, f_24_,
																		Node_Sub30.method2723(7,
																				anIntArray8502[i_28_ + i_33_]),
																		(byte) 121),
																67,
																Class150.method1654(f_14_, f_35_, f_24_,
																		Node_Sub30.method2723(7,
																				anIntArray8502[i_32_ + i_28_]),
																		(byte) -108),
																f_36_),
														f_25_),
										75,
										GraphicsToolkit
												.method1244(
														GraphicsToolkit.method1244(
																Class150.method1654(f_15_, f_34_, f_23_,
																		Node_Sub30.method2723(7,
																				anIntArray8502[i_27_ + i_33_]),
																		(byte) -112),
																102,
																Class150.method1654(f_15_, f_35_, f_23_,
																		Node_Sub30.method2723(7,
																				anIntArray8502[i_27_ + i_32_]),
																		(byte) -64),
																f_36_),
														119,
														GraphicsToolkit.method1244(
																Class150.method1654(f_15_, f_34_, f_24_,
																		Node_Sub30.method2723(
																				anIntArray8502[i_26_ + i_33_], 7),
																		(byte) -61),
																78,
																Class150.method1654(f_15_, f_35_, f_24_,
																		Node_Sub30.method2723(
																				anIntArray8502[i_32_ - -i_26_], 7),
																		(byte) -75),
																f_36_),
														f_25_),
										f_16_);
