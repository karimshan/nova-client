...
public class Class329 {
	public static Class256 aClass256_4122;
	public static float aFloat4117;
	public static int anInt4118;
	public static int anInt4119;
	public static int anInt4120;
	public static int anInt4121;
	public static int anInt4124;

	public static final boolean method3833(byte b, int i) {
		anInt4124++;
		if (b != -61)
	...
	public static final void method3834(int i, int i_0_, int i_1_, aa var_aa, GraphicsToolkit graphicstoolkit, int i_2_,
			int i_3_, int i_4_, IComponentDefinitions widget) {
		anInt4120++;
		...
		if (class79 != null && class79.aBoolean1079 && class79.method784((byte) 109, Class24.aClass275_442)) {
			if (class79.anIntArray1049 != null) {
				...
				for (int i_5_ = 0; i_5_ < is.length / 2; i_5_++) {
					...
					is[i_5_ * 2] = widget.anInt4809 / 2 + (i_1_ - -(i_8_ * (4 * class79.anIntArray1049[i_5_ * 2] + i_4_)
							+ i_7_ * (i + class79.anIntArray1049[2 * i_5_ + 1] * 4) >> 14));
					is[2 * i_5_ + 1] = -(i_8_ * (i - -(class79.anIntArray1049[2 * i_5_ - -1] * 4))
							- i_7_ * (i_4_ - -(4 * class79.anIntArray1049[2 * i_5_])) >> 14) + i_3_
							+ widget.anInt4695 / 2;
				}
				Class127 class127 = widget.method4145(graphicstoolkit, 1);
				if (class127 != null)
					Class74.method761(graphicstoolkit, is, class79.anInt1084, class127.anIntArray1641,
							class127.anIntArray1635);
				if (class79.anInt1074 > 0) {
					for (int i_9_ = 0; i_9_ < is.length / 2 + -1; i_9_++) {
						...
						graphicstoolkit.a(i_10_, i_11_, i_12_, i_13_,
								class79.anIntArray1066[class79.aByteArray1057[i_9_] & 0xff], 1, var_aa, i_1_, i_3_,
					...
					if (i_19_ < i_17_) {
						...
						i_18_ = i_20_;
						i_20_ = i_22_;
					} else if ((i_17_ ^ 0xffffffff) == (i_19_ ^ 0xffffffff)
							&& (i_18_ ^ 0xffffffff) < (i_20_ ^ 0xffffffff)) {
						int i_23_ = i_18_;
						i_18_ = i_20_;
						i_20_ = i_23_;
					}
					graphicstoolkit.a(i_17_, i_18_, i_19_, i_20_,
							class79.anIntArray1066[class79.aByteArray1057[-1 + class79.aByteArray1057.length] & 0xff],
							1, var_aa, i_1_, i_3_, class79.anInt1074, class79.anInt1050, class79.anInt1080);
				} else {
					for (int i_24_ = 0; (i_24_ ^ 0xffffffff) > (is.length / 2 - 1 ^ 0xffffffff); i_24_++)
						graphicstoolkit.a(is[2 * i_24_], is[2 * i_24_ + 1], is[i_24_ * 2 + 2], is[1 + (1 + i_24_) * 2],
								class79.anIntArray1066[0xff & class79.aByteArray1057[i_24_]], 1, var_aa, i_1_, i_3_);
					graphicstoolkit.a(is[-2 + is.length], is[is.length - 1], is[0], is[1],
							class79.anIntArray1066[0xff & class79.aByteArray1057[-1 + class79.aByteArray1057.length]],
							1, var_aa, i_1_, i_3_);
				}
			}
			...
			if ((class79.anInt1062 ^ 0xffffffff) != 0) {
				...
				if (glsprite != null)
					MiniMapDots.method171((byte) -116, i_3_, var_aa, glsprite, i, i_4_, widget, i_1_);
			}
			if (class79.aString1085 != null) {
				...
				Node_Sub20.method2615(class52, class79.aString1085, class357, i_1_, class79.anInt1058, i_25_, false,
						widget, var_aa, i, i_3_, i_4_);
			}
		}
		if (i_0_ >= -116)
	...
	public static final String method3835(byte[] bs, boolean bool) {
		if (bool != true)
			return null;
		anInt4121++;
	...
	public static final void method3836(int i, int i_26_, int i_27_, int i_28_, int i_29_, int i_30_, int i_31_) {
		...
		if (i_26_ == 327263118) {
			...
			ClientBackground.anInt6907 = i_27_;
			anInt4118++;
		}
	}
