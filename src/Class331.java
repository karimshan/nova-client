...
public class Class331 {
	public static boolean aBoolean4129;
	public static float aFloat4140;
	...
	public static final Class129 method3841(int i, int i_2_) {
		anInt4132++;
		if (i != 20568)
			aBoolean4129 = false;
	...
	public static final void method3842(int i, int i_4_, int i_5_, int i_6_, int i_7_, byte b) {
		anInt4136++;
		if (b != -54)
			aBoolean4129 = true;
		if ((Class262_Sub4.anInt7722 ^ 0xffffffff) < (i_4_ ^ 0xffffffff)
				|| (za_Sub2.anInt10513 ^ 0xffffffff) > (i ^ 0xffffffff) || i_7_ < Class384.anInt4906
				|| (Node_Sub25_Sub1.anInt9936 ^ 0xffffffff) > (i_6_ ^ 0xffffffff))
			Class125.method1527(0, i_4_, i, i_5_, i_7_, i_6_);
		else
			Class296.method3477(i_7_, i_5_, i_4_, i_6_, i, 106);
	}

	public static final void method3843(boolean bool, int i, int i_8_, int i_9_) {
		anInt4137++;
		String string = "tele " + i + "," + (i_9_ >> 6) + "," + (i_8_ >> 6) + "," + (i_9_ & 0x3f) + "," + (i_8_ & 0x3f);
		Commands.method1538(90, true, bool, string);
	}
	...
	public final void method3840(int i, int i_0_) {
		anInt4131++;
