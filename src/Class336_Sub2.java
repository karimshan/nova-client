...
public class Class336_Sub2 extends Class336 {
	...
	@Override
	public final void method3853(int i, int i_13_, int i_14_, int[] is) {
		is[0] = (int) (aFloat8571 * i_13_ + aFloat8580 * i + i_14_ * aFloat8566 + aFloat8583);
		is[1] = (int) (aFloat8558 * i_14_ + (aFloat8578 * i + i_13_ * aFloat8561) + aFloat8579);
		anInt8560++;
		is[2] = (int) (i_14_ * aFloat8584 + (i * aFloat8577 + i_13_ * aFloat8567) + aFloat8589);
	}

	@Override
	public final void method3854(int i, int i_4_, int i_5_) {
	...
	public final void method3855(int[] is) {
		anInt8563++;
		float f = is[0] - aFloat8583;
		float f_2_ = is[1] - aFloat8579;
		float f_3_ = is[2] - aFloat8589;
	...
	@Override
	public final void method3863(int i, int i_0_, int i_1_) {
		anInt8572++;
		aFloat8579 += i_0_;
		aFloat8589 += i_1_;
		aFloat8583 += i;
	...
	@Override
	public final void method3864(int i, int i_15_, int i_16_, int i_17_, int i_18_, int i_19_) {
		anInt8575++;
		...
		aFloat8589 = -(i_16_ * aFloat8584) + (-(i_15_ * aFloat8567) + -i * aFloat8577);
		aFloat8583 = -(aFloat8566 * i_16_) + (-(aFloat8571 * i_15_) + aFloat8580 * -i);
		aFloat8579 = -(i_15_ * aFloat8561) + aFloat8578 * -i - i_16_ * aFloat8558;
	}
	...
	@Override
	public final void method3867(int i, int i_27_, int i_28_, int[] is) {
		is[1] = (int) (aFloat8561 * i_27_ + aFloat8578 * i + i_28_ * aFloat8558);
		anInt8576++;
		is[0] = (int) (i * aFloat8580 + i_27_ * aFloat8571 + aFloat8566 * i_28_);
		is[2] = (int) (i_28_ * aFloat8584 + (aFloat8567 * i_27_ + i * aFloat8577));
	}
	...
	@Override
	public final void method3869(int i, int i_6_, int i_7_, int[] is) {
		i_7_ -= aFloat8589;
		anInt8585++;
		i_6_ -= aFloat8579;
		i -= aFloat8583;
		is[2] = (int) (aFloat8566 * i + i_6_ * aFloat8558 + i_7_ * aFloat8584);
		is[1] = (int) (aFloat8567 * i_7_ + (aFloat8571 * i + aFloat8561 * i_6_));
		is[0] = (int) (i_7_ * aFloat8577 + (aFloat8580 * i + aFloat8578 * i_6_));
	}
}
