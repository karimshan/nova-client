...
public class Class336_Sub3 extends Class336 {
	...
	public static final void method3901(Animable animable, int i, int i_57_, int i_58_, int i_59_, int i_60_) {
		boolean bool = true;
		int i_61_ = i_57_;
				...
				for (int i_66_ = i_61_; i_66_ <= i_62_; i_66_++)
					if (i_66_ >= 0 && i_66_ < Class328.anInt4115)
						for (int i_67_ = i_63_; i_67_ <= i_64_; i_67_++)
							if (i_67_ >= 0 && i_67_ < GameMessage.anInt7623
									&& (!bool || i_66_ >= i_62_ || i_67_ >= i_64_ || i_67_ < i_58_ && i_66_ != i_57_)) {
								Class261 class261 = Class175.aClass261ArrayArrayArray2099[i_65_][i_66_][i_67_];
								if (class261 != null) {
									int i_68_ = (Class320_Sub10.aPlaneArray8300[i_65_].method3251(i_67_, i_66_,
											(byte) -118)
											+ Class320_Sub10.aPlaneArray8300[i_65_].method3251(i_67_, i_66_ + 1,
													(byte) -118)
											+ Class320_Sub10.aPlaneArray8300[i_65_].method3251(i_67_ + 1, i_66_,
													(byte) -118)
											+ Class320_Sub10.aPlaneArray8300[i_65_].method3251(i_67_ + 1, i_66_ + 1,
													(byte) -118))
											/ 4
											- (Class320_Sub10.aPlaneArray8300[i].method3251(i_58_, i_57_, (byte) -118)
													+ Class320_Sub10.aPlaneArray8300[i].method3251(i_58_, i_57_ + 1,
															(byte) -118)
													+ Class320_Sub10.aPlaneArray8300[i].method3251(i_58_ + 1, i_57_,
															(byte) -118)
													+ Class320_Sub10.aPlaneArray8300[i].method3251(i_58_ + 1, i_57_ + 1,
															(byte) -118))
													/ 4;
									...
									if (animable_sub2 != null && animable_sub2.method821(0))
										animable.method816(i_68_, bool, CacheNode_Sub18.aGraphicsToolkit9607,
												(i_67_ - i_58_) * Class179.anInt2129 + (1 - i_60_) * Class135.anInt1692,
												(byte) 110,
												(i_66_ - i_57_) * Class179.anInt2129 + (1 - i_59_) * Class135.anInt1692,
												animable_sub2);
									...
									for (Class256 class256 = class261.aClass256_3312; class256 != null; class256 = class256.aClass256_3238) {
										...
										if (mobile != null && mobile.method821(0)
											...
											animable.method816(i_68_, bool, CacheNode_Sub18.aGraphicsToolkit9607,
													(mobile.aShort9120 - i_58_) * Class179.anInt2129
															+ (i_71_ - i_60_) * Class135.anInt1692,
													(byte) 114, (mobile.aShort9119 - i_57_) * Class179.anInt2129
															+ (i_70_ - i_59_) * Class135.anInt1692,
													mobile);
										}
									}
								}
	...
	@Override
	public final void method3853(int i, int i_5_, int i_6_, int[] is) {
		is[0] = (int) (aFloat8594 + (aFloat8617 * i_6_ + (i * aFloat8596 + aFloat8608 * i_5_)));
		is[2] = (int) (aFloat8615 + (aFloat8604 * i_6_ + (i * aFloat8605 + aFloat8593 * i_5_)));
		is[1] = (int) (aFloat8625 * i + i_5_ * aFloat8607 + i_6_ * aFloat8591 + aFloat8609);
		anInt8598++;
	}

	@Override
	public final void method3854(int i, int i_54_, int i_55_) {
		aFloat8615 = i_55_;
	...
	public final void method3855(int[] is) {
		anInt8610++;
		float f = -aFloat8594 + is[0];
		float f_11_ = is[1] - aFloat8609;
		float f_12_ = -aFloat8615 + is[2];
	...
	@Override
	public final void method3863(int i, int i_45_, int i_46_) {
		aFloat8615 += i_46_;
		anInt8612++;
		aFloat8594 += i;
		aFloat8609 += i_45_;
	...
	@Override
	public final void method3864(int i, int i_27_, int i_28_, int i_29_, int i_30_, int i_31_) {
		anInt8623++;
		...
		aFloat8609 = -(aFloat8591 * i_28_) + (aFloat8625 * -i - aFloat8607 * i_27_);
		aFloat8594 = -i * aFloat8596 - i_27_ * aFloat8608 - aFloat8617 * i_28_;
		aFloat8615 = -(i_28_ * aFloat8604) + (aFloat8605 * -i - i_27_ * aFloat8593);
	}
	...
	@Override
	public final void method3867(int i, int i_52_, int i_53_, int[] is) {
		is[2] = (int) (i * aFloat8605 + aFloat8593 * i_52_ + aFloat8604 * i_53_);
		anInt8619++;
		is[0] = (int) (aFloat8617 * i_53_ + (i * aFloat8596 + i_52_ * aFloat8608));
		is[1] = (int) (i_52_ * aFloat8607 + aFloat8625 * i + aFloat8591 * i_53_);
	}
	...
	@Override
	public final void method3869(int i, int i_9_, int i_10_, int[] is) {
		i_9_ -= aFloat8609;
		i -= aFloat8594;
		anInt8595++;
		i_10_ -= aFloat8615;
		is[1] = (int) (i_10_ * aFloat8593 + (i_9_ * aFloat8607 + aFloat8608 * i));
		is[2] = (int) (i * aFloat8617 + aFloat8591 * i_9_ + aFloat8604 * i_10_);
		is[0] = (int) (i_10_ * aFloat8605 + (i_9_ * aFloat8625 + i * aFloat8596));
	}

	public final void method3894(int i) {
	...
	public final void method3895(byte b, Class336 class336) {
		anInt8592++;
		...
		aFloat8594 = -(aFloat8617 * class336_sub3_7_.aFloat8615
				+ (aFloat8596 * class336_sub3_7_.aFloat8594 + class336_sub3_7_.aFloat8609 * aFloat8608));
		aFloat8593 = class336_sub3_7_.aFloat8591;
		aFloat8604 = class336_sub3_7_.aFloat8604;
		aFloat8609 = -(class336_sub3_7_.aFloat8615 * aFloat8591
				+ (class336_sub3_7_.aFloat8594 * aFloat8625 + aFloat8607 * class336_sub3_7_.aFloat8609));
		aFloat8615 = -(class336_sub3_7_.aFloat8594 * aFloat8605 + class336_sub3_7_.aFloat8609 * aFloat8593
				+ aFloat8604 * class336_sub3_7_.aFloat8615);
		if (b < 26)
			aFloat8608 = -1.4741409F;
	}

	public final void method3896(float f, float f_18_, float f_19_, float f_20_, float[] fs, byte b) {
		anInt8621++;
	...
	public final float[] method3898(byte b) {
		anInt8622++;
	...
	public final float[] method3899(int i) {
