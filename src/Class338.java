...
public class Class338 {
	public static IncomingPacket aClass192_4201 = new IncomingPacket(89, -1);
	public static OutgoingPacket aClass318_4184 = new OutgoingPacket(78, -1);
	public static OutgoingPacket aClass318_4198 = new OutgoingPacket(83, -1);
	public static float[] aFloatArray4199 = new float[4];
	...
	public static String[] aStringArray4197 = new String[100];

	public static final Class150 method3906(BufferedStream buffer, int i) {
		anInt4191++;
	...
	public static final boolean method3911(int i, int i_8_, int i_9_) {
		anInt4195++;
		if (i_9_ != 24987)
			method3906(null, 46);
		if (!((i & 0x800 ^ 0xffffffff) != -1 | Class150_Sub3.method1663((byte) -21, i, i_8_))
				&& !LoadingBarStage.method1135(i, i_8_, false))
			return false;
		return true;
	}

	public static final void method3913(int i, Node_Sub47 node_sub47, int i_12_, int i_13_, byte b, int i_14_) {
		anInt4185++;
		if ((node_sub47.anInt7564 != -1 || node_sub47.anIntArray7579 != null) && b == 54) {
			...
			if ((node_sub47.anInt7567 ^ 0xffffffff) == -1 || node_sub47.anInt7567 < i_15_ + -256
					|| (Class213.aNode_Sub27_2512.aClass320_Sub25_7265.method3776(false) ^ 0xffffffff) == -1
				...
				if ((i_21_ ^ 0xffffffff) != -1 || (i_22_ ^ 0xffffffff) != -1) {
					int i_23_ = -Class170.anInt2053 - (int) (Math.atan2(i_21_, i_22_) * 2607.5945876176133) + -4096
							& 0x3fff;
					if (i_23_ > 8192)
						i_23_ = 16384 - i_23_;
					int i_24_;
				...
				if (node_sub47.aNode_Sub9_Sub2_7568 == null) {
					if ((node_sub47.anInt7564 ^ 0xffffffff) <= -1) {
						int i_25_ = node_sub47.anInt7572 == 256 && node_sub47.anInt7571 == 256 ? 256
						...
						if (node_sub47.aBoolean7580) {
							if (node_sub47.aNode_Sub49_7581 == null)
								node_sub47.aNode_Sub49_7581 = Node_Sub49.method2954(Class78.aClass302_1033,
										node_sub47.anInt7564);
							if (node_sub47.aNode_Sub49_7581 != null) {
								if (node_sub47.aNode_Sub45_Sub1_7576 == null)
									node_sub47.aNode_Sub45_Sub1_7576 = node_sub47.aNode_Sub49_7581
											.method2958(new int[] { 22050 });
								if (node_sub47.aNode_Sub45_Sub1_7576 != null) {
									Node_Sub9_Sub2 node_sub9_sub2 = Node_Sub9_Sub2
											.method2509(node_sub47.aNode_Sub45_Sub1_7576, i_25_, i_18_ << 6, i_20_);
							...
							if (class65 != null) {
								Node_Sub45_Sub1 node_sub45_sub1 = class65.method716()
										.method2947(Class361.aClass191_4486);
								Node_Sub9_Sub2 node_sub9_sub2 = Node_Sub9_Sub2.method2509(node_sub45_sub1, i_25_,
										i_18_ << 6, i_20_);
								node_sub9_sub2.method2481(-1);
								Class176.aNode_Sub9_Sub3_2106.method2513(node_sub9_sub2);
								node_sub47.aNode_Sub9_Sub2_7568 = node_sub9_sub2;
				...
				if (node_sub47.aNode_Sub9_Sub2_7556 != null) {
					...
					int i_26_ = node_sub47.anInt7572 != 256 || node_sub47.anInt7571 != 256 ? node_sub47.anInt7571
							+ (int) ((node_sub47.anInt7572 - node_sub47.anInt7571) * Math.random()) : 256;
					if (!node_sub47.aBoolean7584) {
						int i_27_ = (int) (node_sub47.anIntArray7579.length * Math.random());
						Class65 class65 = Class65.method714(Class148.aClass302_1827, node_sub47.anIntArray7579[i_27_],
								0);
						if (class65 != null) {
							Node_Sub45_Sub1 node_sub45_sub1 = class65.method716().method2947(Class361.aClass191_4486);
							Node_Sub9_Sub2 node_sub9_sub2 = Node_Sub9_Sub2.method2509(node_sub45_sub1, i_26_,
									i_18_ << 6, i_20_);
							node_sub9_sub2.method2481(0);
							Class176.aNode_Sub9_Sub3_2106.method2513(node_sub9_sub2);
							node_sub47.anInt7561 = (int) (Math.random()
									* (-node_sub47.anInt7587 + node_sub47.anInt7565)) + node_sub47.anInt7587;
							node_sub47.aNode_Sub9_Sub2_7556 = node_sub9_sub2;
						}
					} else {
						if (node_sub47.aNode_Sub49_7578 == null) {
							int i_28_ = (int) (Math.random() * node_sub47.anIntArray7579.length);
							node_sub47.aNode_Sub49_7578 = Node_Sub49.method2954(Class78.aClass302_1033,
									node_sub47.anIntArray7579[i_28_]);
						}
						if (node_sub47.aNode_Sub49_7578 != null) {
							if (node_sub47.aNode_Sub45_Sub1_7575 == null)
								node_sub47.aNode_Sub45_Sub1_7575 = node_sub47.aNode_Sub49_7578
										.method2958(new int[] { 22050 });
							if (node_sub47.aNode_Sub45_Sub1_7575 != null) {
								Node_Sub9_Sub2 node_sub9_sub2 = Node_Sub9_Sub2
										.method2509(node_sub47.aNode_Sub45_Sub1_7575, i_26_, i_18_ << 6, i_20_);
								node_sub9_sub2.method2481(0);
								Class176.aNode_Sub9_Sub3_2106.method2513(node_sub9_sub2);
								node_sub47.anInt7561 = (int) ((node_sub47.anInt7565 - node_sub47.anInt7587)
										* Math.random()) + node_sub47.anInt7587;
								node_sub47.aNode_Sub9_Sub2_7556 = node_sub9_sub2;
							}
						}
					}
	...
	public static final void method3915(Animable animable, boolean bool, boolean bool_30_) {
	...
	public final void method3907(byte b) {
	...
	public final void method3908(int i) {
		if (i != -32478)
			aClass61_4200 = null;
		synchronized (aClass61_4189) {
	...
	public final Class140 method3909(int i, int i_7_) {
		anInt4186++;
		Class140 class140;
		synchronized (aClass61_4189) {
			class140 = (Class140) aClass61_4189.method607(i, 0);
		}
		if (class140 != null)
			return class140;
		byte[] bs;
		...
		synchronized (aClass61_4189) {
			aClass61_4189.method601(class140, 25566, i);
		}
		return class140;
	}

	public final void method3912(int i, int i_10_, int i_11_) {
		anInt4188++;
	...
	public final void method3914(int i, int i_29_) {
		anInt4187++;
		synchronized (aClass61_4189) {
			if (i_29_ != 34)
				aClass302_4192 = null;
