...
public class Class339_Sub1 extends Class339 {
	...
	public static int anInt8638;
	public static int anInt8639;
	public static String[] aStringArray8631;

	public static final int method3925(int i, int i_15_, int i_16_) {
		anInt8628++;
		int i_17_ = Class270_Sub2_Sub1.method3306(i + 45365, (byte) 91, 4, i_16_ + 91923)
				- (128 - (Class270_Sub2_Sub1.method3306(i - -10294, (byte) 91, 2, 37821 + i_16_) - 128 >> 1)
						+ -(Class270_Sub2_Sub1.method3306(i, (byte) 91, 1, i_16_) + -128 >> 2));
		int i_18_ = -20 / ((i_15_ - 23) / 62);
		i_17_ = (int) (0.3 * i_17_) - -35;
		if (i_17_ >= 10) {
			if (i_17_ > 60)
				i_17_ = 60;
		} else
		...
		if (gltoolkit.aBoolean6654) {
			...
			for (int i_6_ = 0; (i_6_ ^ 0xffffffff) > -65; i_6_++)
				for (int i_7_ = 0; (i_7_ ^ 0xffffffff) > -65; i_7_++) {
					float f = i_6_ * 2.0F / 64.0F - 1.0F;
					float f_8_ = -1.0F + i_7_ * 2.0F / 64.0F;
					...
					for (int i_10_ = 0; i_10_ < 6; i_10_++) {
						...
						if (!(f_11_ > 0.0F))
							...
							i_13_ = (int) (i * Math.pow(f_11_, 36.0));
							i_14_ = (int) (i * Math.pow(f_11_, 12.0));
						}
	...
	@Override
	public final void method3919(int i, int i_0_, int i_1_) {
		if (i != -13437)
