...
public class Class339_Sub2 extends Class339 {
	...
	public static final void method3928(int i, Packet packet) {
		...
		packet.writeInt(Class107.INDEX.method3505(false));
	...
	@Override
	public final void method3917(Class169 class169, int i, int i_4_) {
		if (i_4_ == -28289)
			anInt8649++;
	}
	...
	@Override
	public final void method3919(int i, int i_1_, int i_2_) {
		if ((0x1 & i_2_ ^ 0xffffffff) == -2) {
			if (!aClass301_8643.aBoolean3780) {
				...
				Class144_Sub4.aFloatArray6843[3] = aGLToolkit4202.anInt6605 % 4000 / 4000.0F;
	...
	public final void method3923(boolean bool, int i) {
		...
		if (i < aGLToolkit4202.anInt6691) {
			float f = -0.5F / aGLToolkit4202.anInt6691;
			aGLToolkit4202.method1457(33984, 1);
			...
			OpenGL.glPopMatrix();
			aGLToolkit4202.method1438((byte) 99, 0.5F, aGLToolkit4202.anInt6691);
