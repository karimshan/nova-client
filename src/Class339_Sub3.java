...
public class Class339_Sub3 extends Class339 {
	public static Class26 aClass26_8664 = new Class26();
	public static int anInt8655;
	public static int anInt8656;
	public static int anInt8659;
	public static int anInt8660;
	public static int anInt8661;
	public static int anInt8662;
	public static int anInt8663;
	public static int[] anIntArray8665 = { 1, 2, 4, 8 };

	public static final void method3930(byte[] bs, byte[] bs_0_, int i, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_,
			int i_6_) {
		anInt8659++;
		if (i_4_ > -30)
			anIntArray8665 = null;
	...
	@Override
	public final void method3917(Class169 class169, int i, int i_11_) {
		anInt8661++;
		if (i_11_ == -28289) {
	...
	@Override
	public final void method3919(int i, int i_12_, int i_13_) {
		if (i != -13437)
			method3919(-23, -51, -34);
		anInt8656++;
	}
