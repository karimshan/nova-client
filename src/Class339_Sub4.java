...
public class Class339_Sub4 extends Class339 {
	public static long aLong8671 = -1L;
	public static int anInt8666;
	public static int anInt8667;
	public static int anInt8669;
	public static int anInt8673;
	public static int anInt8674;
	public static int anInt8675;
	public static int anInt8676;
	public static int anInt8679 = 0;
	public static int anInt8680;
	public static int[] anIntArray8668;
	static {
		anIntArray8668 = new int[8];
	}

	public static final void method3932(byte b, int[] is, String[] strings) {
		anInt8673++;
	...
	public static final boolean method3933(GraphicsToolkit graphicstoolkit, int i, Class79 class79, int i_2_,
			Node_Sub14 node_sub14, int i_3_) {
		anInt8675++;
		int i_4_ = 2147483647;
		int i_5_ = -2147483648;
		int i_6_ = 2147483647;
		...
		if (class79.anIntArray1049 != null) {
			i_7_ = Class20.anInt339 - (-Class20.anInt352 + node_sub14.anInt7120 + class79.anInt1051)
					* (-Class20.anInt350 + Class20.anInt339) / (Class20.anInt337 - Class20.anInt352);
			i_6_ = -((node_sub14.anInt7120 + class79.anInt1060 - Class20.anInt352)
					* (Class20.anInt339 + -Class20.anInt350) / (-Class20.anInt352 + Class20.anInt337))
					+ Class20.anInt339;
			i_4_ = Class20.anInt344 - -((Class20.anInt348 + -Class20.anInt344)
					* (-Class20.anInt349 + class79.anInt1068 - -node_sub14.anInt7125)
					/ (-Class20.anInt349 + Class20.anInt341));
			i_5_ = Class20.anInt344 + (class79.anInt1089 + node_sub14.anInt7125 - Class20.anInt349)
					* (-Class20.anInt344 + Class20.anInt348) / (Class20.anInt341 + -Class20.anInt349);
		}
		...
		if (class79.aString1085 != null) {
			...
			if (class299 != null) {
				i_12_ = Class85.aClass357_1159.method4029(Node_Sub38_Sub3.aStringArray10107, null, -100, null,
						class79.aString1085);
				i_14_ = node_sub14.anInt7118 - class79.anInt1092 * (Class20.anInt339 + -Class20.anInt350)
						/ (-Class20.anInt352 + Class20.anInt337);
				i_13_ = class79.anInt1071 * (Class20.anInt348 + -Class20.anInt344)
						/ (-Class20.anInt349 + Class20.anInt341) + node_sub14.anInt7126;
				if (glsprite != null)
		...
		if (i_5_ < Class20.anInt344 || (Class20.anInt348 ^ 0xffffffff) > (i_4_ ^ 0xffffffff) || Class20.anInt350 > i_7_
				|| (i_6_ ^ 0xffffffff) < (Class20.anInt339 ^ 0xffffffff))
			return true;
		Class20.method281(graphicstoolkit, node_sub14, class79);
		if (glsprite != null) {
			if (Class168.anInt2044 > 0
					&& ((Class253.anInt3201 ^ 0xffffffff) != 0 && node_sub14.anInt7128 == Class253.anInt3201
							|| (Node_Sub38_Sub19.anInt10296 ^ 0xffffffff) != 0
									&& class79.anInt1067 == Node_Sub38_Sub19.anInt10296)) {
				int i_23_;
				...
				graphicstoolkit.method1238(node_sub14.anInt7118, i_24_, node_sub14.anInt7126, (byte) 86,
						7 + glsprite.method1193() / 2);
				graphicstoolkit.method1238(node_sub14.anInt7118, i_24_, node_sub14.anInt7126, (byte) 86,
						5 + glsprite.method1193() / 2);
				graphicstoolkit.method1238(node_sub14.anInt7118, i_24_, node_sub14.anInt7126, (byte) 86,
						3 + glsprite.method1193() / 2);
				graphicstoolkit.method1238(node_sub14.anInt7118, i_24_, node_sub14.anInt7126, (byte) 86,
						glsprite.method1193() / 2 - -1);
				graphicstoolkit.method1238(node_sub14.anInt7118, i_24_, node_sub14.anInt7126, (byte) 86,
						glsprite.method1193() / 2);
			}
			glsprite.method1196(node_sub14.anInt7126 - (glsprite.method1197() >> 1),
					node_sub14.anInt7118 - (glsprite.method1186() >> 1));
		}
		if (class79.aString1085 != null && class299 != null)
			Node_Sub54.method2981(i_12_, node_sub14, i_13_, class79, class299, i_15_, (byte) 118, graphicstoolkit,
					i_14_);
	...
	@Override
	public final void method3919(int i, int i_25_, int i_26_) {
		if (i != -13437)
			method3933(null, 114, null, 95, null, -85);
		if (aBoolean8672) {
			int i_27_ = 1 << (0x3 & i_26_);
			float f = (1 << (i_26_ >> 3 & 0x7)) / 32.0F;
			int i_28_ = i_25_ & 0xffff;
			float f_29_ = ((0x38bf6 & i_25_) >> 16) / 8.0F;
			long l = aClass145_8670.aLong1795;
			OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "time"),
					aGLToolkit4202.anInt6605 * i_27_ % 40000 / 40000.0F);
			OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "scale"), f);
			OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "breakWaterDepth"), i_28_);
	...
	public final void method3923(boolean bool, int i) {
		...
		if (i == 0) {
			...
			if (aBoolean8678 && class169_sub1 != null) {
				...
				OpenGL.glUniform4fARB(OpenGL.glGetUniformLocationARB(l, "sunColour"), aGLToolkit4202.aFloat6734,
						aGLToolkit4202.aFloat6707, aGLToolkit4202.aFloat6672, 1.0F);
				OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "sunExponent"),
						928.0F * Math.abs(aGLToolkit4202.aFloatArray6664[1]) + 96.0F);
				aBoolean8672 = true;
			}
		}
	}
