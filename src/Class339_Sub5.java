...
public class Class339_Sub5 extends Class339 {
	...
	public static final boolean method3937(byte b, int i, int i_33_) {
		anInt8686++;
		if (b != -97)
			return false;
	...
	public static final boolean processOutsideUpdate(int playerIndex, Packet packet, int i_0_) {
		...
		if (opcode == 0) {
			...
			if (Client.LOCAL_PLAYERS[playerIndex] != null)
				throw new RuntimeException("hr:lr");
			PlayerUpdateReference class323 = Class320_Sub10.aClass323Array8296[playerIndex];
			Player player = Client.LOCAL_PLAYERS[playerIndex] = new Player();
		...
		if (opcode == 1) {
			...
			Class320_Sub10.aClass323Array8296[playerIndex].globalPositionHash = ((0x3
					& (oldHash >> 28) + planeOffset) << 28) + (oldHash & 0xfffffff);
			return false;
		}
		if (opcode == 2) {
	...
	@Override
	public final void method3917(Class169 class169, int i, int i_27_) {
	...
	@Override
	public final void method3919(int i, int i_28_, int i_29_) {
		anInt8689++;
		float f = -5.0E-4F * (1 + (i_29_ & 0x3));
		float f_30_ = ((0x3 & i_29_ >> 3) + 1) * 5.0E-4F;
		...
		if (i == -13437) {
			...
			Class290_Sub11.aFloatArray8183[0] = 0.0F;
			Class290_Sub11.aFloatArray8183[3] = aGLToolkit4202.anInt6605 * f % 1.0F;
			OpenGL.glTexGenfv(8193, 9474, Class290_Sub11.aFloatArray8183, 0);
			if (!aClass301_8688.aBoolean3780) {
				int i_32_ = (int) (16.0F * (aGLToolkit4202.anInt6605 * f_30_));
				aGLToolkit4202.method1444(-2, aClass301_8688.aClass169_Sub2Array3779[i_32_ % 16]);
			} else {
				Class290_Sub11.aFloatArray8183[3] = aGLToolkit4202.anInt6605 * f_30_ % 1.0F;
				Class290_Sub11.aFloatArray8183[0] = 0.0F;
				Class290_Sub11.aFloatArray8183[1] = 0.0F;
				Class290_Sub11.aFloatArray8183[2] = 0.0F;
