...
public class Class339_Sub6 extends Class339 {
	public static boolean aBoolean8715 = false;
	public static IncomingPacket aClass192_8709 = new IncomingPacket(123, 1);
	public static int anInt8693;
	public static int anInt8694;
	...
	public static int anInt8713 = 0;
	public static int anInt8714;
	public static int[] routeFinderYArray = new int[4096];
	static {
		new Class212("", 73);
	}
	...
	public static final int method3939(Class135 class135, int i) {
		anInt8703++;
	...
	Class339_Sub6(GLToolkit gltoolkit) {
		...
		if (aGLToolkit4202.aBoolean6703) {
			aClass50_8698 = Animable_Sub4.method926(
	...
	@Override
	public final void method3919(int i, int i_4_, int i_5_) {
		if (i == -13437)
			anInt8708++;
	}
	...
	public final void method3940(int i) {
		anInt8707++;
		if (i < 45)
			anInt8713 = 92;
		...
		if (aBoolean8697)
			OpenGL.glBindProgramARB(34336,
					aGLToolkit4202.anInt6689 == 2147483647 ? aClass50_8704.anInt773 : aClass50_8710.anInt773);
		else
			OpenGL.glBindProgramARB(34336,
					aGLToolkit4202.anInt6689 != 2147483647 ? aClass50_8706.anInt773 : aClass50_8698.anInt773);
		class336_sub3.method3896(0.0F, aGLToolkit4202.anInt6689, -1.0F, 0.0F, Class188_Sub1_Sub1.aFloatArray9331,
				(byte) -35);
		OpenGL.glProgramLocalParameter4fARB(34336, 1, Class188_Sub1_Sub1.aFloatArray9331[0],
				Class188_Sub1_Sub1.aFloatArray9331[1], Class188_Sub1_Sub1.aFloatArray9331[2],
	...
	public final void method3941(int i) {
		anInt8693++;
		if (i >= -10)
			method3923(true, -21);
		if (aBoolean8699) {
			...
			float f = i_1_ - 0.125F * (-i_2_ + i_1_);
			float f_3_ = -((-i_2_ + i_1_) * 0.25F) + i_1_;
			OpenGL.glProgramLocalParameter4fARB(34336, 0, f_3_, f, 1.0F / aGLToolkit4202.anInt6697,
					aGLToolkit4202.anInt6739 / 255.0F);
			aGLToolkit4202.method1457(33984, 1);
