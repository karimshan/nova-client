...
public class Class339_Sub7 extends Class339 {
	...
	public static GLSprite aGLSprite8718;
	public static int anInt8719;
	public static int anInt8720;
	public static int anInt8721;
	public static int anInt8722;
	public static int anInt8723;
	public static int anInt8724;
	public static int anInt8725;
	public static int anInt8728;
	public static IncomingPacket INCOMMING_PACKET_67 = new IncomingPacket(67, 3);

	public static final void method3942(int i, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, boolean bool) {
		anInt8720++;
		...
		for (int i_8_ = 0; (i_7_ ^ 0xffffffff) < (i_8_ ^ 0xffffffff); i_8_++) {
			...
			if ((aa.anInt101 ^ 0xffffffff) != -4) {
				if ((i_8_ ^ 0xffffffff) > (i_6_ ^ 0xffffffff))
					actor = Client.LOCAL_PLAYERS[is[i_8_]];
				else {
					actor = ((Node_Sub41) Class12.aHashTable187.getNode(3512,
							Class54.LocalNPCsIndexes[-i_6_ + i_8_])).aNpc7518;
					npcdefinition = ((NPC) actor).defs;
				...
				if ((actor.anInt10857 ^ 0xffffffff) > -1
						|| actor.anInt10815 != LoadingBarStage.anInt1412 && Player.get.plane != actor.plane)
					continue;
			} else {
				...
				if ((LoadingBarStage.anInt1412 ^ 0xffffffff) != (actor.anInt10815 ^ 0xffffffff))
					continue;
			...
			if ((Class119.anIntArray1516[0] ^ 0xffffffff) <= -1) {
				if (actor.method862((byte) -93)) {
					...
					if (class59 != null
							&& (Node_Sub37.anInt7445 ^ 0xffffffff) > (Node_Sub36_Sub2.anInt10042 ^ 0xffffffff)) {
						Node_Sub36_Sub2.anIntArray10052[Node_Sub37.anInt7445] = Class262_Sub15_Sub1.aClass357_10524
								.method4033((byte) -6, class59.method587(-102)) / 2;
				...
				if (actor.aBoolean10826 || (Class174.clientCycle ^ 0xffffffff) <= (actor.anInt10874 ^ 0xffffffff))
					i_9_ -= Math.max(Class262_Sub15_Sub1.aClass357_10524.anInt4434,
							Class320_Sub5.aGLSpriteArray8254[0].method1176());
				else {
					int i_10_ = -1;
					int i_11_ = 1;
					if (npcdefinition != null) {
						...
						Player player = Client.LOCAL_PLAYERS[is[i_8_]];
						...
						if (glsprites_12_ == null) {
							...
							if (class383s != null) {
								...
								for (int i_13_ = 0; (class383s.length ^ 0xffffffff) < (i_13_ ^ 0xffffffff); i_13_++)
									glsprites_12_[i_13_] = Class93.graphicsToolkit.a(class383s[i_13_], true);
					...
					Class93.graphicsToolkit.T(i_15_, i_9_, i_16_ + i_15_, i_9_ - -i_17_);
					glsprite_14_.method1196(i_15_, i_9_);
					Class93.graphicsToolkit.KA(i_4_, i, i_1_ + i_4_, i + i_5_);
				...
				if (!actor.aBoolean10826) {
					if (actor.anInt10835 > Class174.clientCycle) {
							...
							if (glsprites == null) {
								...
								if (class383s != null) {
									...
									for (int i_20_ = 0; (class383s.length ^ 0xffffffff) < (i_20_ ^ 0xffffffff); i_20_++)
										glsprites[i_20_] = Class93.graphicsToolkit.a(class383s[i_20_], true);
						...
						if ((actor.anInt10856 ^ 0xffffffff) > (i_21_ ^ 0xffffffff)) {
							...
							int i_23_ = actor.anInt10848 != 0
									? (actor.anInt10855 + -i_21_) / actor.anInt10848 * actor.anInt10848 : 0;
						...
						Class93.graphicsToolkit.T(i_25_, i_9_, i_22_ + i_25_, i_9_ + i_24_);
						glsprite_18_.method1196(i_25_, i_9_);
						Class93.graphicsToolkit.KA(i_4_, i, i_4_ + i_1_, i + i_5_);
					...
					if (npcdefinition == null) {
						...
						if (player.skullId != -1) {
							...
							Class362.method4053(i_9_, glsprite.method1186() + i_9_,
									Class119.anIntArray1516[0] + (i_4_ + -12), (byte) 107,
						...
						if (player.prayIconId != -1) {
							...
							Class362.method4053(i_9_, i_9_ + glsprite.method1186(),
									Class119.anIntArray1516[0] + (i_4_ + -12), (byte) -27,
									-12 + (Class119.anIntArray1516[0] + i_4_) - -glsprite.method1197());
							i_9_ -= 2;
						}
					} else if (npcdefinition.anInt2806 >= 0
							&& ReferenceTable.aGLSpriteArray284.length > npcdefinition.anInt2806) {
						...
						Class362.method4053(i_9_, glsprite.method1186() + i_9_,
								i_4_ + Class119.anIntArray1516[0] - (glsprite.method1193() >> 1), (byte) -48,
								Class119.anIntArray1516[0]
										+ (i_4_ + -(glsprite.method1193() >> 1) - -glsprite.method1197()));
						i_9_ -= 2;
					}
				}
				if (actor instanceof Player) {
					if ((i_8_ ^ 0xffffffff) <= -1) {
						...
						for (int i_27_ = 0; (class223s.length ^ 0xffffffff) < (i_27_ ^ 0xffffffff); i_27_++) {
							...
							if (class223 != null && class223.anInt2654 == 10 && class223.anInt2658 == is[i_8_]) {
								GLSprite glsprite = MiniMap.HINT_ICONS[class223.anInt2659];
								if ((i_26_ ^ 0xffffffff) > (glsprite.method1176() ^ 0xffffffff))
									i_26_ = glsprite.method1176();
								glsprite.method1196(-12 + Class119.anIntArray1516[0] + i_4_,
										i_9_ - glsprite.method1176());
								Class362.method4053(i_9_ + -glsprite.method1176(),
										i_9_ - glsprite.method1176() - -glsprite.method1186(),
										-12 + (i_4_ + Class119.anIntArray1516[0]), (byte) 126,
										Class119.anIntArray1516[0] + (i_4_ - 12) - -glsprite.method1197());
							}
						}
					...
					for (int i_29_ = 0; (i_29_ ^ 0xffffffff) > (class223s.length ^ 0xffffffff); i_29_++) {
						...
						if (class223 != null && class223.anInt2654 == 1 && (Class54.LocalNPCsIndexes[-i_6_ + i_8_]
								^ 0xffffffff) == (class223.anInt2658 ^ 0xffffffff)) {
							GLSprite glsprite = MiniMap.HINT_ICONS[class223.anInt2659];
							...
							if (bool_30_) {
								...
								Class362.method4053(-glsprite.method1176() + i_9_,
										-glsprite.method1176() + (i_9_ - -glsprite.method1186()),
										i_4_ - -Class119.anIntArray1516[0] + -12, (byte) 118,
					...
					if ((-i_35_ + i_33_ ^ 0xffffffff) >= (Class174.clientCycle ^ 0xffffffff)) {
						...
						if (class255 == null)
							...
							if (Class119.anIntArray1516[0] > -1) {
								...
								int i_60_ = 0;
								int i_61_ = 0;
								GLSprite glsprite_62_ = class255.method3114(0, Class93.graphicsToolkit);
								int i_63_ = 0;
								...
								GLSprite glsprite_65_ = class255.method3111(Class93.graphicsToolkit, -1);
								...
								GLSprite glsprite_67_ = class255.method3112(80, Class93.graphicsToolkit);
								...
								GLSprite glsprite_69_ = class255.method3113(Class93.graphicsToolkit, (byte) -95);
								...
								if (class255_37_ != null) {
									glsprite = class255_37_.method3114(0, Class93.graphicsToolkit);
									if (glsprite != null) {
									...
									glsprite_51_ = class255_37_.method3111(Class93.graphicsToolkit, -1);
									...
									glsprite_52_ = class255_37_.method3112(70, Class93.graphicsToolkit);
									...
									glsprite_53_ = class255_37_.method3113(Class93.graphicsToolkit, (byte) -110);
								...
								AbstractFont class52 = CacheNode_Sub18.aClass52_9609;
								AbstractFont class52_75_ = CacheNode_Sub18.aClass52_9609;
								Class357 class357 = Class85.aClass357_1159;
								Class357 class357_76_ = Class85.aClass357_1159;
								int i_77_ = class255.anInt3235;
								if (i_77_ >= 0) {
									AbstractFont class52_78_ = Class171.method1792(true, true, i_77_, -116,
											Class93.graphicsToolkit);
									Class357 class357_79_ = Class150_Sub2.method1660((byte) 126, i_77_,
											Class93.graphicsToolkit);
								...
								if (class255_37_ != null) {
									...
									if ((i_77_ ^ 0xffffffff) <= -1) {
										AbstractFont class52_80_ = Class171.method1792(true, true, i_77_, -112,
												Class93.graphicsToolkit);
										Class357 class357_81_ = Class150_Sub2.method1660((byte) -81, i_77_,
												Class93.graphicsToolkit);
								...
								if (i_115_ >= 0 && i_115_ < 255) {
									...
									if (glsprite_65_ != null)
										for (int i_118_ = 0; (i_118_ ^ 0xffffffff) > (i_87_ ^ 0xffffffff); i_118_++)
											glsprite_65_.method1191(i_92_ + i_105_ - (i_48_ - i_44_ * i_118_), i_106_,
													0, i_117_, 1);
									if (glsprite_69_ != null)
										glsprite_69_.method1191(-i_50_ + (i_105_ + i_95_), i_106_, 0, i_117_, 1);
									class52.method538(i_105_ + i_93_, i_109_, string_85_, 0, 1,
											i_116_ | class255.anInt3229);
									if (class255_37_ != null) {
										if (glsprite != null)
										...
										if (glsprite_51_ != null)
											for (int i_119_ = 0; i_88_ > i_119_; i_119_++)
												glsprite_51_.method1191(-i_59_ + (i_105_ + (i_98_ - -(i_55_ * i_119_))),
														i_106_, 0, i_117_, 1);
										if (glsprite_53_ != null)
											glsprite_53_.method1191(-i_61_ + (i_105_ + i_99_), i_106_, 0, i_117_, 1);
										class52_75_.method538(i_100_ + i_105_, i_112_, string, 0, 1,
												class255_37_.anInt3229 | i_116_);
									}
								} else {
									if (glsprite_62_ != null)
									...
									if (class255_37_ != null) {
										...
										if (glsprite_51_ != null)
											for (int i_121_ = 0; i_121_ < i_88_; i_121_++)
												glsprite_51_.method1196(i_105_ + i_98_ - i_59_ - -(i_55_ * i_121_),
														i_106_);
										if (glsprite_53_ != null)
											glsprite_53_.method1196(i_99_ + i_105_ - i_61_, i_106_);
										class52_75_.method538(i_100_ + i_105_, i_112_, string, 0, 1,
												class255_37_.anInt3229 | ~0xffffff);
									}
								}
		...
		for (/**/; (i_122_ ^ 0xffffffff) > (Class99.anInt1286 ^ 0xffffffff); i_122_++) {
			...
			Actor actor;
			if (i_123_ < 2048)
				actor = Client.LOCAL_PLAYERS[i_123_];
			else
				actor = ((Node_Sub41) Class12.aHashTable187.getNode(3512, -2048 + i_123_)).aNpc7518;
			int i_124_ = Node_Sub15_Sub4.anIntArray9802[i_122_];
			Actor actor_125_;
			if (i_124_ < 2048)
				actor_125_ = Client.LOCAL_PLAYERS[i_124_];
			else
				actor_125_ = ((Node_Sub41) Class12.aHashTable187.getNode(3512, i_124_ - 2048)).aNpc7518;
		...
		for (int i_127_ = 0; (i_127_ ^ 0xffffffff) > (Node_Sub37.anInt7445 ^ 0xffffffff); i_127_++) {
			...
			while (bool_131_) {
				...
				for (int i_132_ = 0; i_127_ > i_132_; i_132_++)
					if ((i_129_ + 2 ^ 0xffffffff) < (-i_126_ + Node_Sub36_Sub2.anIntArray10050[i_132_] ^ 0xffffffff)
							&& (i_129_ + -i_126_ ^ 0xffffffff) > (Node_Sub36_Sub2.anIntArray10050[i_132_] - -2
									^ 0xffffffff)
							&& (Node_Sub36_Sub2.anIntArray10051[i_132_] - -Node_Sub36_Sub2.anIntArray10052[i_132_]
									^ 0xffffffff) < (i_128_ - i_130_ ^ 0xffffffff)
							&& i_128_ - -i_130_ > Node_Sub36_Sub2.anIntArray10051[i_132_]
									+ -Node_Sub36_Sub2.anIntArray10052[i_132_]
			...
			if ((Class134_Sub1.anInt9014 ^ 0xffffffff) == -1) {
				...
				if (i_139_ == 6)
					i_138_ = (LoadingBarStage.anInt1412 % 20 ^ 0xffffffff) > -11 ? 16711680 : 16776960;
				if ((i_139_ ^ 0xffffffff) == -8)
					i_138_ = LoadingBarStage.anInt1412 % 20 >= 10 ? 65535 : 255;
				if (i_139_ == 8)
					i_138_ = LoadingBarStage.anInt1412 % 20 >= 10 ? 8454016 : 45056;
				if ((i_139_ ^ 0xffffffff) == -10) {
					int i_140_ = 150 + -(Node_Sub36_Sub2.aClass59Array10044[i_127_].method592((byte) -66) * 150
							/ Node_Sub36_Sub2.aClass59Array10044[i_127_].method585(-1));
				...
				if (i_139_ == 10) {
					int i_141_ = -(Node_Sub36_Sub2.aClass59Array10044[i_127_].method592((byte) -57) * 150
							/ Node_Sub36_Sub2.aClass59Array10044[i_127_].method585(-1)) + 150;
				...
				if (i_139_ == 11) {
					int i_142_ = -(Node_Sub36_Sub2.aClass59Array10044[i_127_].method592((byte) -39) * 150
							/ Node_Sub36_Sub2.aClass59Array10044[i_127_].method585(-1)) + 150;
					if (i_142_ < 50)
				...
				if ((i_144_ ^ 0xffffffff) == -1) {
					Class262_Sub4.abstractFont.method537(-16777216, (byte) 107, i_128_ + i_4_, string, i_129_ + i,
							i_143_);
					i_136_ -= i_133_ >> 1;
					i_134_ -= i_133_ >> 1;
				}
				if (i_144_ == 1) {
					i_137_ += 5;
					Class262_Sub4.abstractFont.method542(5, i_143_, LoadingBarStage.anInt1412, string, i_4_ - -i_128_,
							i_129_ + i, -16777216);
					i_136_ -= i_133_ >> 1;
					i_134_ -= i_133_ >> 1;
					i_135_ -= 5;
				...
				if (i_144_ == 2) {
					i_135_ -= 5;
					Class262_Sub4.abstractFont.method541(-16777216, LoadingBarStage.anInt1412, string, i_4_ - -i_128_, i_143_,
							i + i_129_, 16777215);
					i_137_ += 5;
					i_134_ -= 5 + (i_133_ >> 1);
					i_136_ -= -5 + (i_133_ >> 1);
				...
				if (i_144_ == 3) {
					int i_145_ = 150 + -(Node_Sub36_Sub2.aClass59Array10044[i_127_].method592((byte) -61) * 150
							/ Node_Sub36_Sub2.aClass59Array10044[i_127_].method585(-1));
					i_134_ -= i_133_ >> 1;
					i_137_ += 7;
					i_135_ -= 7;
					i_136_ -= i_133_ >> 1;
					Class262_Sub4.abstractFont.method527(i_145_, i_128_ + i_4_, LoadingBarStage.anInt1412, i + i_129_, i_143_,
							string, -16777216, -1072);
				}
				if ((i_144_ ^ 0xffffffff) == -5) {
					int i_146_ = -(Node_Sub36_Sub2.aClass59Array10044[i_127_].method592((byte) -49) * 150
							/ Node_Sub36_Sub2.aClass59Array10044[i_127_].method585(-1)) + 150;
					int i_147_ = (Class262_Sub15_Sub1.aClass357_10524.method4033((byte) -6, string) + 100) * i_146_
							/ 150;
					Class93.graphicsToolkit.T(-50 + (i_4_ - -i_128_), i, 50 + (i_128_ + i_4_), i - -i_5_);
					i_134_ += -i_147_ + 50;
					i_136_ += 50 + -i_147_;
					Class262_Sub4.abstractFont.method538(-i_147_ + (i_4_ - -i_128_ - -50), i_129_ + i, string,
							-16777216, 1, i_143_);
					Class93.graphicsToolkit.KA(i_4_, i, i_4_ + i_1_, i_5_ + i);
				}
				if ((i_144_ ^ 0xffffffff) == -6) {
					int i_148_ = -(150 * Node_Sub36_Sub2.aClass59Array10044[i_127_].method592((byte) -125)
							/ Node_Sub36_Sub2.aClass59Array10044[i_127_].method585(-1)) + 150;
					int i_149_ = 0;
					if ((i_148_ ^ 0xffffffff) > -26)
						...
						i_149_ = i_148_ + -125;
					int i_150_ = Class262_Sub15_Sub1.aClass357_10524.anInt4442
							+ Class262_Sub15_Sub1.aClass357_10524.anInt4434;
					Class93.graphicsToolkit.T(i_4_, i + (i_129_ - (i_150_ - -1)), i_1_ + i_4_, 5 + (i_129_ + i));
					i_137_ += i_149_;
					i_134_ -= i_133_ >> 1;
					i_136_ -= i_133_ >> 1;
					i_135_ += i_149_;
					Class262_Sub4.abstractFont.method537(-16777216, (byte) 110, i_4_ - -i_128_, string,
							i_149_ + i_129_ + i, i_143_);
					Class93.graphicsToolkit.KA(i_4_, i, i_4_ + i_1_, i + i_5_);
				}
			} else {
				Class262_Sub4.abstractFont.method537(-16777216, (byte) 115, i_128_ + i_4_, string, i - -i_129_, -256);
				i_134_ -= i_133_ >> 1;
				i_136_ -= i_133_ >> 1;
			}
	...
	@Override
	public final void method3917(Class169 class169, int i, int i_0_) {
		if (!aBoolean8727) {
	...
	@Override
	public final void method3919(int i, int i_151_, int i_152_) {
		if (aBoolean8727) {
			int i_153_ = 1 << (i_152_ & 0x3);
			float f = (1 << ((0x3e & i_152_) >> 3)) / 32.0F;
			int i_154_ = 0xffff & i_151_;
			float f_155_ = ((i_151_ & 0x30aa7) >> 16) / 8.0F;
			float f_156_ = (i_151_ >> 19 & 0xf) / 16.0F;
			float f_157_ = ((0x7bf0a08 & i_151_) >> 23) / 16.0F;
			...
			OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "time"),
					aGLToolkit4202.anInt6605 * i_153_ % 40000 / 40000.0F);
			OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "scale"), f);
			OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "breakWaterDepth"), i_154_);
			...
			OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "waveExponent"), i_158_);
		}
		if (i != -13437)
			method3943((byte) 44);
		anInt8724++;
	...
	public final void method3923(boolean bool, int i) {
		...
		if (i == 0) {
			...
			if (aBoolean8717 && class169_sub1 != null) {
				...
				OpenGL.glUniform3fARB(OpenGL.glGetUniformLocationARB(l, "sunDir"), -aGLToolkit4202.aFloatArray6664[0],
						-aGLToolkit4202.aFloatArray6664[1], -aGLToolkit4202.aFloatArray6664[2]);
				OpenGL.glUniform4fARB(OpenGL.glGetUniformLocationARB(l, "sunColour"), f * aGLToolkit4202.aFloat6734,
						aGLToolkit4202.aFloat6707 * f, aGLToolkit4202.aFloat6672 * f, 1.0F);
				OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "sunExponent"),
						64.0F + 928.0F * Math.abs(aGLToolkit4202.aFloatArray6664[1]));
				aBoolean8727 = true;
			}
		}
	}
