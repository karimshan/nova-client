...
abstract class Class34 {
	...
	public static OutgoingPacket aClass318_528 = new OutgoingPacket(85, 2);
	public static int anInt529;
	public static int anInt530;
	public static int anInt533;

	public static final Class345 method367(int i, Model model, int i_0_, int[] is) {
		anInt533++;
		int[] is_1_ = null;
		int[] is_2_ = null;
		int[] is_3_ = null;
			...
			for (int i_19_ = 0; i_19_ < i_4_; i_19_++) {
				...
				if (b > 0) {
					...
					if ((b ^ 0xffffffff) == -2) {
						...
						f = 64.0F / model.anIntArray2588[i_19_];
						if (i_22_ != 0) {
							if (i_22_ <= 0) {
								f_20_ = 1.0F;
								f_21_ = -i_22_ / 1024.0F;
						...
						f = 64.0F / model.anIntArray2588[i_19_];
						f_20_ = 64.0F / model.anIntArray2593[i_19_];
						f_21_ = 64.0F / model.anIntArray2603[i_19_];
					} else {
						f_21_ = model.anIntArray2603[i_19_] / 1024.0F;
						f = model.anIntArray2588[i_19_] / 1024.0F;
						f_20_ = model.anIntArray2593[i_19_] / 1024.0F;
					}
					fs[i_19_] = Class262_Sub15.method3189(f_21_, f, f_20_, model.aShortArray2613[i_19_],
							model.aShortArray2604[i_19_], 8, Node_Sub30.method2723(model.aByteArray2609[i_19_], 255),
	...
	public static final void method370(Actor actor, byte b) {
		anInt530++;
		...
		for (/**/; i < actor.aClass165Array10886.length; i++)
			if ((actor.aClass165Array10886[i].graphicsId ^ 0xffffffff) != 0) {
				...
				if (animator_24_.method242((byte) -77)) {
					Login class195 = Class16.aClass101_228.method1090(-121, actor.aClass165Array10886[i].graphicsId);
					Class48 class48 = animator_24_.method243((byte) -24);
					if (class195.aBoolean2402)
						if (class48.anInt698 == 3) {
							if (actor.anInt10900 > 0 && (Class174.clientCycle
									^ 0xffffffff) <= (actor.toFirstTileTicketDelay ^ 0xffffffff)
									&& actor.toSecondTileTicketDelay < Class174.clientCycle) {
								animator_24_.method249(true, -1);
								actor.aClass165Array10886[i].graphicsId = -1;
								continue;
							}
						} else if (class48.anInt698 == 1 && (actor.anInt10900 ^ 0xffffffff) < -1
								&& actor.toFirstTileTicketDelay <= Class174.clientCycle
								&& (Class174.clientCycle ^ 0xffffffff) < (actor.toSecondTileTicketDelay ^ 0xffffffff))
							continue;
				}
		...
		do
			if (animator_25_.method245(-127)) {
				...
				if (class48.anInt698 == 3) {
					if ((actor.anInt10900 ^ 0xffffffff) < -1 && actor.toFirstTileTicketDelay <= Class174.clientCycle
					...
					if ((actor.anInt10900 ^ 0xffffffff) < -1 && Class174.clientCycle >= actor.toFirstTileTicketDelay
							&& actor.toSecondTileTicketDelay < Class174.clientCycle) {
		...
		while (false);
		for (int i_26_ = 0; (actor.anAnimableAnimator_Sub1Array10894.length ^ 0xffffffff) < (i_26_
				^ 0xffffffff); i_26_++) {
