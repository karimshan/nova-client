...
public class Class343 {
	...
	public static short[] aShortArray4255;

	public static final Class241 method3962(String string, int i, int i_0_, SignLink signlink) {
		if (i > -102)
			return null;
		anInt4259++;
	...
	public static final boolean method3967(int i, int i_13_, int i_14_) {
		if (i_14_ < 10)
			aShortArray4255 = null;
		anInt4243++;
		if (!((0x40000 & i ^ 0xffffffff) != -1 | Class320_Sub7.method3711((byte) 76, i, i_13_))
				&& !LoadingBarStage.method1135(i, i_13_, false))
			return false;
		return true;
	}
	...
	public final void method3964(BufferedStream buffer, int i) {
		anInt4245++;
		if (i != -4807)
	...
	public final void method3965(BufferedStream buffer, boolean bool) {
		aFloat4244 = 8 * buffer.readUnsignedByte() / 255.0F;
		if (bool != true)
			method3962(null, -51, 80, null);
		anInt4242++;
		aFloat4239 = 8 * buffer.readUnsignedByte() / 255.0F;
		aFloat4251 = 8 * buffer.readUnsignedByte() / 255.0F;
	}

	public final void method3966(BufferedStream buffer, int i) {
		anInt4241++;
		int i_6_ = buffer.readUnsignedByte();
		if (i != 24176)
			method3964(null, -46);
		if ((Class213.aNode_Sub27_2512.aClass320_Sub24_7317.method3773(false) ^ 0xffffffff) != -2
				|| Class229.aGraphicsToolkit2732.e() <= 0) {
			...
			if ((0x2 & i_6_ ^ 0xffffffff) == -1)
				...
				aFloat4254 = buffer.readUnsignedShort() / 256.0F;
			if ((0x4 & i_6_ ^ 0xffffffff) != -1)
				aFloat4256 = buffer.readUnsignedShort() / 256.0F;
			else
				aFloat4256 = 0.69921875F;
			if ((i_6_ & 0x8 ^ 0xffffffff) == -1)
				aFloat4250 = 1.2F;
			else
				aFloat4250 = buffer.readUnsignedShort() / 256.0F;
		}
	...
	public final boolean method3968(byte b, Class343 class343_15_) {
		anInt4246++;
		int i = 39 / ((b - -4) / 42);
		if (anInt4253 != class343_15_.anInt4253 || class343_15_.aFloat4254 != aFloat4254
				|| aFloat4256 != class343_15_.aFloat4256 || aFloat4250 != class343_15_.aFloat4250
				|| class343_15_.aFloat4239 != aFloat4239 || aFloat4244 != class343_15_.aFloat4244
				|| aFloat4251 != class343_15_.aFloat4251
				|| (anInt4257 ^ 0xffffffff) != (class343_15_.anInt4257 ^ 0xffffffff)
				|| (class343_15_.anInt4258 ^ 0xffffffff) != (anInt4258 ^ 0xffffffff)
				|| class343_15_.aClass270_4240 != aClass270_4240 || class343_15_.aClass119_4238 != aClass119_4238)
			return false;
		return true;
	}
}
