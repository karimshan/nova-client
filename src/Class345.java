...
public class Class345 {
	public static Class151 aClass151_4267 = new Class151(7, 0, 1, 1);
	public static int anInt4269;
	public static int anInt4270 = 1;
	...
	public static final void method3971(Index class302, int i, boolean bool, Index class302_0_) {
		if (bool == true) {
	...
	public static final EntityNode_Sub6 method3972(boolean bool, byte b, int i) {
		anInt4271++;
		synchronized (Class30.aClass103Array494) {
			int i_1_ = -111 % ((b - 16) / 39);
			EntityNode_Sub6 entitynode_sub6;
			if ((Class30.aClass103Array494.length ^ 0xffffffff) >= (i ^ 0xffffffff)
					|| Class30.aClass103Array494[i].method1105(-92)) {
