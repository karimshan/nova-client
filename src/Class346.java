...
public class Class346 {
	public static double aDouble4277;
	...
	public static int[] anIntArray4275 = new int[128];
	...
	public static final boolean method3973(int i, int i_0_, int i_1_) {
		if (i_0_ != 18518)
	...
	public static final GraphicsToolkit method3974(int i, int i_2_, d var_d, int i_3_, java.awt.Canvas canvas) {
		if (i_2_ != 31206)
			return null;
		anInt4279++;
	...
	public static final void method3975(int i, int i_4_, IComponentDefinitions[] widgets) {
		for (IComponentDefinitions widget2 : widgets) {
			IComponentDefinitions widget = widget2;
			if (widget != null && widget.parentId == i_4_ && !ConnectionDecoder.method112(widget)) {
				...
				if (widget.type == 6 && (widget.anInt4773 ^ 0xffffffff) != 0) {
					...
					if (widget.anAnimator4755.method248(i ^ 0x496f, Node_Sub9_Sub1.anInt9637)
