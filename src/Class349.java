...
public class Class349 {
	...
	public static final void method3984(int i, int i_0_) {
		Class261 class261 = Class175.aClass261ArrayArrayArray2099[0][i][i_0_];
		for (int i_1_ = 0; i_1_ < 3; i_1_++) {
			Class261 class261_2_ = Class175.aClass261ArrayArrayArray2099[i_1_][i][i_0_] = Class175.aClass261ArrayArrayArray2099[i_1_
					+ 1][i][i_0_];
			if (class261_2_ != null) {
	...
	public static final void method3985(IComponentDefinitions widget, int i, int i_3_, int i_4_) {
		anInt4317++;
		Class127 class127 = widget.method4145(Class93.graphicsToolkit, i_3_);
		if (class127 != null) {
			Class93.graphicsToolkit.KA(i, i_4_, i - -widget.anInt4809, i_4_ + widget.anInt4695);
			if (Class262_Sub20.anInt7861 >= 3)
				Class93.graphicsToolkit.A(-16777216, class127.anAa1639, i, i_4_);
			else
				Class10.aGLSprite173.method1177(widget.anInt4809 / 2.0F + i, widget.anInt4695 / 2.0F + i_4_, 4096,
						((int) -Node_Sub12.aFloat5450 & 0x3fff) << 2, class127.anAa1639, i, i_4_);
		}
	}

	public static final boolean method3988(byte b, int i, int i_15_) {
		anInt4309++;
	...
	public static final int method3989(int i, byte b) {
		anInt4301++;
		if (i != 6406) {
			if (i != 6409) {
	...
	Class349(GLToolkit gltoolkit, Class137 class137, GLPlane glplane, int i, int i_18_, int i_19_, int i_20_,
			int i_21_) {
		aBoolean4307 = true;
			...
			if (!aGLToolkit4304.aBoolean6736)
				for (int i_29_ = 0; (i_22_ ^ 0xffffffff) < (i_29_ ^ 0xffffffff); i_29_++) {
					...
					for (int i_31_ = 0; i_22_ > i_31_; i_31_++) {
						...
						if (ses != null)
							for (short se : ses)
								buffer.method2191(-42, se & 0xffff);
					}
				}
			else
		...
		if (aBoolean4307) {
			...
			if (aClass169_Sub2_4310 != null && i == anInt4308)
				...
				if (aClass169_Sub2_4310 != null)
					aClass169_Sub2_4310.method1775(0, (byte) 122, 6406, 128, 128, aGLToolkit4304.aByteArray6746, false,
							0, 0, 0);
				else {
					aClass169_Sub2_4310 = new Class169_Sub2(aGLToolkit4304, 3553, 6406, 128, 128, false,
							aGLToolkit4304.aByteArray6746, 6406, false);
	...
	public final void method3987(int i) {
		anInt4312++;
		method3983(false, anInt4315, anInterface1_4313);
		int i_14_ = -83 / ((9 - i) / 63);
	}

	public final void method3990(int i, byte[] bs, byte b, int i_17_) {
		if (b != -78)
			method3984(38, -88);
		anInt4303++;
