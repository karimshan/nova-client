...
public class Class34_Sub1 extends Class34 {
	...
	public static int[] SKILL_REAL_LEVEL = new int[25];

	public static final void method375(int i, boolean bool, int i_0_, int i_1_, byte b, int i_2_) {
		anInt5523++;
		...
		if (b <= -80) {
			...
			if (i_3_ < 0)
				...
				i_3_ = 100;
			int i_4_ = (Node_Sub29_Sub3.aShort10026 + -Node_Sub29_Sub3.aShort10027) * i_3_ / 100
					+ Node_Sub29_Sub3.aShort10027;
			...
			if ((i_5_ ^ 0xffffffff) <= (KeyStrokes.aShort3667 ^ 0xffffffff)) {
				if (Animable_Sub2_Sub2.aShort10750 < i_5_) {
					...
					if ((Class18.aShort310 ^ 0xffffffff) < (i_4_ ^ 0xffffffff)) {
						...
						if (bool) {
							...
							Class93.graphicsToolkit.method1239(i_2_, i_7_, i_0_, (byte) 116, i, -16777216);
							Class93.graphicsToolkit.method1239(i_2_, i_7_, i_0_ - -i_1_ + -i_7_, (byte) 116, i,
									-16777216);
						}
						i_1_ -= 2 * i_7_;
						i_0_ += i_7_;
				...
				if (OutgoingPacket.aShort4053 < i_4_) {
					...
					if (bool) {
						Class93.graphicsToolkit.la();
						Class93.graphicsToolkit.method1239(i_9_, i_1_, i_0_, (byte) 116, i, -16777216);
						Class93.graphicsToolkit.method1239(i_9_, i_1_, i_0_, (byte) 116, -i_9_ + i_2_ + i,
								-16777216);
					}
					i += i_9_;
					i_2_ -= 2 * i_9_;
	...
	public static final void method378(int i) {
		...
		do {
			if (i_11_ != 2) {
				...
				CacheNode.method2279(-1, Class205.screenHeight, 100, Class360.screenWidth, 100,
						Class93.graphicsToolkit);
				break;
			}
			Class64.method711(Class93.graphicsToolkit, 2, Class360.screenWidth, GlobalMessage.anInt432,
					Node_Sub36_Sub1.anInt10039, 2, (byte) -128, Class205.screenHeight);
		} while (false);
	...
	public static final void method382(Animable[] animables, int i, int i_15_) {
		if (i < i_15_) {
			int i_16_ = (i + i_15_) / 2;
			int i_17_ = i;
	...
	Class34_Sub1(int i, MainFile class6, MainFile class6_32_, Class266 class266, Class141 class141, int i_33_,
			byte[] bs, int i_34_, boolean bool) {
	...
	@Override
	public final void method368(int i, int i_12_) {
		anInt5527++;
		if (aClass6_5539 != null) {
			if (i != 0)
				method381((byte) 122);
			for (Node node = aClass312_5541.method3613(65280); node != null; node = aClass312_5541.method3620(16776960))
				if ((node.aLong2797 ^ 0xffffffffffffffffL) == (i_12_ ^ 0xffffffffffffffffL))
					return;
			Node node = new Node();
			node.aLong2797 = i_12_;
			aClass312_5541.method3625((byte) -54, node);
		}
	}

	@Override
	public final int method369(byte b, int i) {
		if (b != -4)
			aByteArray5526 = null;
		anInt5518++;
		CacheNode_Sub16 cachenode_sub16 = (CacheNode_Sub16) aHashTable5514.getNode(3512, i);
	...
	@Override
	public final byte[] method373(int i, byte b) {
		anInt5513++;
	...
	@Override
	public final ReferenceTable method374(byte b) {
		anInt5529++;
	...
	public final int method376(int i) {
		anInt5533++;
		if (i != 100)
			return 111;
	...
	public final int method377(int i) {
		anInt5515++;
		if (anArchive5540 == null)
			return 0;
	...
	public final int method379(int i) {
		anInt5538++;
		if (i != 0)
			anInt5542 = 2;
		if (anArchive5540 == null)
	...
	public final void method380(int i) {
		anInt5532++;
		if (aClass312_5544 != null) {
			...
			if (!aBoolean5543) {
				if (!aBoolean5545)
					...
					boolean bool = true;
					for (Node node = aClass312_5544.method3613(65280); node != null; node = aClass312_5544
							.method3620(16776960)) {
		...
		if (aBoolean5546 && (Class313.method3650(false) ^ 0xffffffffffffffffL) <= (aLong5547 ^ 0xffffffffffffffffL)) {
			for (CacheNode_Sub16 cachenode_sub16 = (CacheNode_Sub16) aHashTable5514.method1516(
					false); cachenode_sub16 != null; cachenode_sub16 = (CacheNode_Sub16) aHashTable5514.method1520(99))
	...
	public final int method381(byte b) {
		if (b != 29)
			SKILL_REAL_LEVEL = null;
		anInt5534++;
		return anInt5537;
	...
	private final CacheNode_Sub16 method383(int i, int i_21_, int i_22_) {
		...
		if (cachenode_sub16 == null) {
			if ((i_21_ ^ 0xffffffff) == -1) {
				...
				throw new RuntimeException();
			aHashTable5514.put(i, cachenode_sub16, i_22_ + -125);
		}
		if (cachenode_sub16.aBoolean9602)
			return null;
		byte[] bs = cachenode_sub16.method2385(15);
			...
			try {
				...
				if (!(anInt5524 == 8 & i == 2498))
					if (i_23_ != anArchive5540.anIntArray299[i])
						// System.out.println("error crc "+i_23_+",
						// "+anArchive5540.anIntArray299[i]);
						// if(anInt5524 != 37)
						throw new RuntimeException();
				...
				if (cachenode_sub16.aBoolean9598 && !aClass266_5535.method3244(24365)) {
					CacheNode_Sub16_Sub1 cachenode_sub16_sub1 = aClass266_5535.method3247(anInt5524, i, (byte) -79,
							true, (byte) 2);
					aHashTable5514.put(i, cachenode_sub16_sub1, -123);
				}
				return null;
			}
		try {
			...
			if (cachenode_sub16.aBoolean9598 && !aClass266_5535.method3244(24365)) {
				CacheNode_Sub16_Sub1 cachenode_sub16_sub1 = aClass266_5535.method3247(anInt5524, i, (byte) -79, true,
						(byte) 2);
				aHashTable5514.put(i, cachenode_sub16_sub1, -124);
			}
	...
	public final void method385(boolean bool) {
		anInt5517++;
		if (aClass312_5544 != null && method374((byte) 0) != null) {
			for (Node node = aClass312_5541.method3613(65280); node != null; node = aClass312_5541
					.method3620(16776960)) {
	...
	public final void method386(byte b) {
		anInt5531++;
		if (aClass6_5539 != null) {
			aBoolean5545 = true;
			if (b != 119)
