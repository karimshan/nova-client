...
public class Class35 {
	public static Class151 aClass151_535 = new Class151(6, 0, 4, 2);
	public static IncomingPacket aClass192_536 = new IncomingPacket(54, -1);
	public static int anInt534;
	public static int language;
	public static int OUTSIDE_PLAYERS_INDEXES_COUNT = 0;

	static {
		language = 0;
	}

	public static final void method387(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_) {
		anInt534++;
		...
		if ((i_5_ ^ 0xffffffff) <= (Class384.anInt4906 ^ 0xffffffff) && Node_Sub25_Sub1.anInt9936 >= i_5_) {
			...
			int i_13_ = Node_Sub38_Sub32.method2894(Class262_Sub4.anInt7722, za_Sub2.anInt10513, 929798380,
					i_2_ + -i_4_);
			int i_14_ = Node_Sub38_Sub32.method2894(Class262_Sub4.anInt7722, za_Sub2.anInt10513, i_3_ ^ ~0x376b98ec,
					i_4_ + i_2_);
			int i_15_ = Node_Sub38_Sub32.method2894(Class262_Sub4.anInt7722, za_Sub2.anInt10513, 929798380,
					i_2_ + -i_7_);
			int i_16_ = Node_Sub38_Sub32.method2894(Class262_Sub4.anInt7722, za_Sub2.anInt10513, 929798380,
					i_2_ + i_7_);
		...
		while (i_8_ > i_6_) {
			...
			if ((i_9_ ^ 0xffffffff) <= -1) {
				...
				if ((Class384.anInt4906 ^ 0xffffffff) >= (i_19_ ^ 0xffffffff) && Node_Sub25_Sub1.anInt9936 >= i_18_)
					if (i_7_ > i_8_) {
						...
						int i_21_ = Node_Sub38_Sub32.method2894(Class262_Sub4.anInt7722, za_Sub2.anInt10513, 929798380,
								i_2_ - -i_6_);
						int i_22_ = Node_Sub38_Sub32.method2894(Class262_Sub4.anInt7722, za_Sub2.anInt10513, 929798380,
								i_2_ + -i_6_);
						int i_23_ = Node_Sub38_Sub32.method2894(Class262_Sub4.anInt7722, za_Sub2.anInt10513, 929798380,
								i_2_ - -i_20_);
						int i_24_ = Node_Sub38_Sub32.method2894(Class262_Sub4.anInt7722, za_Sub2.anInt10513, 929798380,
								-i_20_ + i_2_);
						...
						int i_25_ = Node_Sub38_Sub32.method2894(Class262_Sub4.anInt7722, za_Sub2.anInt10513, 929798380,
								i_2_ - -i_6_);
						int i_26_ = Node_Sub38_Sub32.method2894(Class262_Sub4.anInt7722, za_Sub2.anInt10513, 929798380,
								i_2_ + -i_6_);
						if (i_19_ <= Node_Sub25_Sub1.anInt9936)
							Class369.method4086(i_25_, i_1_, i_26_, Class169_Sub4.anIntArrayArray8826[i_19_],
									i_3_ ^ 0xffffffff);
			...
			if ((i_28_ ^ 0xffffffff) <= (Class384.anInt4906 ^ 0xffffffff) && i_27_ <= Node_Sub25_Sub1.anInt9936) {
				int i_29_ = i_2_ + i_8_;
				int i_30_ = -i_8_ + i_2_;
				if ((Class262_Sub4.anInt7722 ^ 0xffffffff) >= (i_29_ ^ 0xffffffff)
						&& (za_Sub2.anInt10513 ^ 0xffffffff) <= (i_30_ ^ 0xffffffff)) {
					...
					if (i_7_ <= i_6_) {
						...
						int i_32_ = Node_Sub38_Sub32.method2894(Class262_Sub4.anInt7722, za_Sub2.anInt10513, 929798380,
								i_31_ + i_2_);
						int i_33_ = Node_Sub38_Sub32.method2894(Class262_Sub4.anInt7722, za_Sub2.anInt10513,
								i_3_ + 929798381, i_2_ + -i_31_);
						if (Node_Sub25_Sub1.anInt9936 >= i_28_) {
