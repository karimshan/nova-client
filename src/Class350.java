...
public class Class350 implements Interface16 {
	public static Class170 aClass170_5391 = new Class170(6, 1);
	...
	public static final void method3992(int i, int i_1_) {
		anInt5395++;
		CacheNode_Sub2 cachenode_sub2 = Class320_Sub19.method3754(3, 14, i);
		cachenode_sub2.method2288(0);
		cachenode_sub2.itemId = i_1_;
	}

	public static final boolean method3993(byte b) {
		if (b != 108)
			return true;
		anInt5401++;
	...
	public static final int method3998(String string, int i) {
		if (i != -1)
			aClass170_5391 = null;
		anInt5362++;
	...
	public static final String method3999(long l, boolean bool, int i, int i_5_) {
		anInt5376++;
		Calendar calendar;
		if (!bool) {
		...
		return Integer.toString(i_6_ / 10) + i_6_ % 10 + "-" + Class13.aStringArrayArray209[i][i_7_] + "-" + i_8_ + " "
				+ i_9_ / 10 + i_9_ % 10 + ":" + i_10_ / 10 + i_10_ % 10;
	}
	...
	private final void method3995(int i) throws IllegalAccessException, NoSuchFieldException {
		anInt5381++;
		Class var_class = Class96.mainGameApplet.getClass();
	...
	private final void method3996(boolean bool) {
		LoadingBar.drawPreLoader(Class243.aClass340_3069.method3958((byte) 84),
				GLDrawableModel.aColorArray5590[Class178.anInt2118], RSCanvas.aColorArray73[Class178.anInt2118],
				Class382.aColorArray5258[Class178.anInt2118], Class243.aClass340_3069.method3957((byte) 39),
				(byte) -117);
		anInt5380++;
		if (bool != true)
	...
	private final int method3997(Class var_class, Object object, boolean bool, String string)
	...
	private final Object method4001(Class var_class, String string, byte b)
			throws IllegalAccessException, NoSuchFieldException {
		anInt5399++;
		Field field = var_class.getDeclaredField(string);
		if (b != -44)
			return null;
		Object object = field.get(Class96.mainGameApplet);
		field.set(Class96.mainGameApplet, null);
		return object;
	}

	private final boolean method4002(Object object, Class var_class, boolean bool, String string)
			throws IllegalAccessException, NoSuchFieldException {
		if (bool != false)
			anInt5366 = -90;
		anInt5396++;
		...
		if (aBoolean5389)
			...
			if (graphics == null)
				...
				try {
					...
					Graphics graphics_12_ = Class54.loadingScreen.getGraphics();
					...
					graphics_12_.drawImage(anImage5383, method3994(-24768, i_13_) + anInt5366 - anInt5379 / 2,
							method3991((byte) -121, i_16_) - -anInt5384, null);
					...
					for (int i_21_ = i_19_; (i_20_ ^ 0xffffffff) <= (i_21_ ^ 0xffffffff); i_21_ += i_15_)
						graphics_12_.drawImage(anImage5386, method3994(-24768, i_13_) + anInt5366 + i_21_,
								method3991((byte) -116, i_18_) - -anInt5384, null);
					graphics_12_.drawImage(anImage5398, method3994(-24768, i_14_) - -anInt5366 + anInt5379 / 2,
							method3991((byte) -128, i_17_) + anInt5384, null);
					...
					graphics_12_.drawImage(anImage5375, i_32_ + (anInt5371 - i_24_), i_33_ + (anInt5393 + -i_25_) / 2,
							null);
					if (anImage5400 == null)
					...
					for (int i_35_ = 0; (i_35_ ^ 0xffffffff) > (-i_24_ + (anInt5371 + -i_22_)
							^ 0xffffffff); i_35_ += i_27_)
						graphics_34_.drawImage(anImage5382, i_35_, 0, null);
					for (int i_36_ = 0; (-i_24_ + (anInt5371 - i_22_) ^ 0xffffffff) < (i_36_
							^ 0xffffffff); i_36_ = i_36_ + i_29_)
					...
					if ((i_37_ ^ 0xffffffff) < -1) {
						...
						int i_40_ = anInt5385 * ToolTips.method3471((byte) -34) / 10 % i_30_;
					...
					graphics_12_.drawString(string, (anInt5371 + -aFontMetrics5397.stringWidth(string)) / 2 + i_32_,
							anInt5364 + (4 + i_33_) + anInt5393 / 2);
