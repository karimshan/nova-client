...
public class Class352 {
	public static Class299 aClass299_4329;
	...
	public static Interface6[] anInterface6Array4332;
	public static IncomingPacket INCOMMING_PACKET_43 = new IncomingPacket(43, -2);

	public static final void drawNPCOptions(boolean hideOptions, NPC npc) {
		anInt4339++;
		if ((Class315.menuOptionCount ^ 0xffffffff) > -401) {
			...
			if (npcdefinition.aBoolean2854) {
				if (npc.combatLevel != 0) {
					String string_15_ = Class169_Sub4.aClass353_8825 != Class209.directory
							? GlobalMessage.aClass22_391.getMessage(Class35.language)
							: GlobalMessage.aClass22_393.getMessage(Class35.language);
					name += Class368.method4077(Player.get.combatLevel, npc.combatLevel) + " (" + string_15_
							+ npc.combatLevel + ")";
				}
				if (Class87.removeWalkHere && !hideOptions) {
					Class267 class267 = Class324.anInt4087 != -1
							? Class188_Sub2_Sub2.aClass36_9366.method394(Class324.anInt4087, -120) : null;
					if ((0x2 & Class200_Sub2.anInt4943) != 0 && (class267 == null
							|| (npcdefinition.method3009(86, Class324.anInt4087, class267.anInt3443)
									^ 0xffffffff) != (class267.anInt3443 ^ 0xffffffff))) {
						Class13.anInt205++;
						Node_Sub32.method2731(false, -1, npc.index, 0, 0, Class84.aString1148, 23, true,
								Class201.anInt2444, Class66.aString5177 + " -> <col=ffff00>" + name, npc.index,
								(byte) -18, false);
					}
				}
				if (!hideOptions) {
					...
					if (strings != null) {
						for (int i_16_ = strings.length - 1; (i_16_ ^ 0xffffffff) <= -1; i_16_--)
							if (strings[i_16_] != null
									&& ((npcdefinition.aByte2855 ^ 0xffffffff) == -1 || !strings[i_16_]
											.equalsIgnoreCase(GlobalMessage.aClass22_386.getMessage(Class35.language))
											&& !strings[i_16_].equalsIgnoreCase(
													GlobalMessage.aClass22_385.getMessage(Class35.language)))) {
								int i_17_ = 0;
								...
								Node_Sub32.method2731(false, -1, npc.index, 0, 0, strings[i_16_], i_17_, true,
										strings[i_16_]
												.equalsIgnoreCase(GlobalMessage.aClass22_386.getMessage(Class35.language))
														? npcdefinition.anInt2860 : i_18_,
										"<col=ffff00>" + name, npc.index, (byte) -18, false);
								Class216.anInt2548++;
							}
						if ((npcdefinition.aByte2855 ^ 0xffffffff) == -2)
							for (int i_19_ = 0; strings.length > i_19_; i_19_++)
								if (strings[i_19_] != null && (strings[i_19_]
										.equalsIgnoreCase(GlobalMessage.aClass22_386.getMessage(Class35.language))
										|| strings[i_19_]
												.equalsIgnoreCase(GlobalMessage.aClass22_385.getMessage(Class35.language)))) {
									short s = 0;
									if ((npc.combatLevel ^ 0xffffffff) < (Player.get.combatLevel ^ 0xffffffff))
										s = (short) 2000;
									short s_20_ = 0;
									...
									Actor.anInt10847++;
									Node_Sub32.method2731(false, -1, npc.index, 0, 0, strings[i_19_], s_20_, true,
											!strings[i_19_]
													.equalsIgnoreCase(GlobalMessage.aClass22_386.getMessage(Class35.language))
															? i_21_ : npcdefinition.anInt2860,
											"<col=ffff00>" + name, npc.index, (byte) -18, false);
								}
					}
				}
	...
	public static final GLSprite method4008(byte b, int i, GraphicsToolkit graphicstoolkit) {
		anInt4327++;
		int i_2_ = 96 % ((68 - b) / 40);
	...
	public static final void method4009(int i, int i_3_, int i_4_, int i_5_, Actor actor) {
		anInt4328++;
	...
	public static final void method4011(int[] emotes, int i, boolean bool, Actor actor, int i_8_) {
		anInt4331++;
		...
		for (int i_13_ = 0; i_13_ < emotes.length; i_13_++) {
			if ((emotes[i_13_] ^ 0xffffffff) != 0)
				bool_12_ = false;
			if (actor.anIntArray10817 == null || actor.anIntArray10817[i_13_] == -1
					|| (Class18.aClass37_306.method395(emotes[i_13_], (byte) -125).anInt710
							^ 0xffffffff) <= (Class18.aClass37_306.method395(actor.anIntArray10817[i_13_],
									(byte) -100).anInt710 ^ 0xffffffff)) {
	...
	public static final boolean method4012(int i) {
		int i_14_ = -7 / ((-59 - i) / 51);
		anInt4340++;
	...
	public final void method4007(int i, byte b, BufferedStream buffer) {
		if (b != 97)
			aBoolean4335 = false;
		for (;;) {
