...
public class Class355 {
	...
	public static volatile boolean aBoolean4366 = true;
	public static OutgoingPacket aClass318_4396 = new OutgoingPacket(40, 11);
	...
	public static final int[] method4014(int i, Node_Sub13 node_sub13) {
		anInt4363++;
	...
	public static final void method4017(int i, boolean bool, String string, boolean bool_14_, SignLink signlink) {
		if (i >= -43)
			aBoolean4366 = false;
		anInt4392++;
	...
	public static final void method4019(boolean bool) {
		if (bool == false) {
			anInt4421++;
	...
	public static final int method4020(int i, String string) {
		anInt4397++;
		if (string == null)
			return -1;
	...
	public static final void method4021(int i) {
		...
		KeyStrokeHandler.aClass13_8198.method210(-111);
		...
		CS2Definition.aClass359_508.method4040((byte) -103);
	...
	public final void method4016(int i) {
	...
	public final void method4018(byte b, BufferedStream buffer) {
		for (;;) {
