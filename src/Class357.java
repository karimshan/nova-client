...
public class Class357 {
	public static IncomingPacket aClass192_4444 = new IncomingPacket(13, 1);
	public static OutgoingPacket aClass318_4441 = new OutgoingPacket(26, 16);
	public static float aFloat4439;
				...
				if ((i_49_ ^ 0xffffffff) != -33 && (i_49_ ^ 0xffffffff) != -161)
					for (int i_50_ = 0; i_50_ < 256; i_50_++)
						if ((i_50_ ^ 0xffffffff) != -33 && (i_50_ ^ 0xffffffff) != -161)
							aByteArrayArray4433[i_49_][i_50_] = (byte) Class190.method1939(is_41_, 255, i_50_, is,
									i_49_, bs_43_, aByteArray4427, bs_46_);
	...
	public final int method4026(char c, int i, int i_0_) {
		if (i_0_ != 255)
			anInt4434 = 21;
		anInt4432++;
	...
	public final int method4027(int i, boolean bool) {
		anInt4437++;
		if (bool != false)
			aClass192_4444 = null;
	...
	public final int method4028(String string, GLSprite[] glsprites, byte b, int i) {
		anInt4438++;
		int i_1_ = -104 % ((b - 19) / 58);
		return method4029(Class330.aStringArray4126, new int[] { i }, -110, glsprites, string);
	}

	public final int method4029(String[] strings, int[] is, int i, GLSprite[] glsprites, String string) {
		anInt4431++;
		if (string == null)
			return 0;
		int i_2_ = 0;
			...
			if ((i_13_ ^ 0xffffffff) == -61)
				...
				if (i_14_ > 0) {
					...
					if (is != null) {
						...
						if ((is[(is.length ^ 0xffffffff) >= (i_9_ ^ 0xffffffff) ? -1 + is.length : i_9_]
	...
	public final int method4030(GLSprite[] glsprites, int i, String string, int i_18_) {
		anInt4443++;
	...
	public final int method4031(int i, GLSprite[] glsprites, String string) {
		anInt4436++;
		if (string == null)
			return 0;
		int i_23_ = -1;
	...
	public final String method4032(String string, GLSprite[] glsprites, int i, int i_30_) {
		anInt4440++;
	...
	public final int method4033(int i, String string) {
		anInt4435++;
		if (i != -6)
			return 120;
	...
	public final int method4034(int i, int i_51_, String string, GLSprite[] glsprites, byte b) {
		anInt4428++;
