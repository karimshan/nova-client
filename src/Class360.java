...
public class Class360 implements Runnable {
	...
	public static final Node_Sub6 method4043(Index class302, int i, boolean bool) {
		anInt4473++;
	...
	public final void method4041(int i) {
		synchronized (this) {
	...
	public final void method4042(byte[] bs, int i, int i_1_, int i_2_) throws IOException {
		anInt4471++;
	...
	public final void method4044(int i) {
		if (i == 0) {
			anInt4481++;
