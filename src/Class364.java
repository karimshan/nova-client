...
public class Class364 {
	public static boolean aBoolean4512;
	public static Class273[] aClass273Array4513;
	...
	public static final void method4057(boolean bool, int i, int i_0_, int i_1_, byte b) {
		if (aa.anInt101 == 4) {
			aa.anInt101 = 0;
			Class200_Sub2.anInt4935 = -1;
		}
		anInt4521++;
		if (bool || (Player.anInt11178 ^ 0xffffffff) != (i ^ 0xffffffff) || Class277.anInt3527 != i_1_
				|| Class94.anInt1249 != CacheNode_Sub20_Sub1.myPlayerPlane
						&& Class213.aNode_Sub27_2512.aClass320_Sub19_7301.method3751(false) != 1) {
			...
			Class169_Sub3.method1779(Class93.graphicsToolkit, GlobalMessage.LOADING_PLEASE_WAIT.getMessage(Class35.language),
			...
			if ((i_0_ ^ 0xffffffff) != -13) {
				...
				for (int i_9_ = 0; (Node_Sub32.cachedNPCcsCount ^ 0xffffffff) < (i_9_ ^ 0xffffffff); i_9_++) {
					...
					if (node_sub41 != null) {
						...
						if ((npc.anInt5934 ^ 0xffffffff) <= -1 && (i_7_ ^ 0xffffffff) <= (npc.anInt5934 ^ 0xffffffff)
								&& npc.anInt5940 >= 0 && i_8_ >= npc.anInt5940) {
							boolean bool_10_ = true;
							for (int i_11_ = 0; (npc.scenePositionXQueue.length ^ 0xffffffff) < (i_11_
									^ 0xffffffff); i_11_++) {
				...
				for (int i_12_ = 0; (i_12_ ^ 0xffffffff) > (Node_Sub32.cachedNPCcsCount ^ 0xffffffff); i_12_++) {
					...
					if (node_sub41 != null) {
						NPC npc = node_sub41.aNpc7518;
						for (int i_13_ = 0; (npc.scenePositionXQueue.length ^ 0xffffffff) < (i_13_
								^ 0xffffffff); i_13_++) {
			...
			for (int i_14_ = 0; (i_14_ ^ 0xffffffff) > -2049; i_14_++) {
				Player player = Client.LOCAL_PLAYERS[i_14_];
				if (player != null) {
					for (int i_15_ = 0; (i_15_ ^ 0xffffffff) > (player.scenePositionXQueue.length
							^ 0xffffffff); i_15_++) {
			...
			for (Class223 class2232 : class223s) {
				Class223 class223 = class2232;
				if (class223 != null) {
					class223.anInt2653 -= 512 * i_5_;
					class223.anInt2662 -= 512 * i_4_;
				}
			}
			for (Node_Sub19 node_sub19 = (Node_Sub19) Class89.aClass312_1199
					.method3613(b + 65316); node_sub19 != null; node_sub19 = (Node_Sub19) Class89.aClass312_1199
							.method3620(b ^ ~0xffff23)) {
				node_sub19.anInt7171 -= i_4_;
				node_sub19.anInt7161 -= i_5_;
				if (Class61.anInt898 != 4 && (node_sub19.anInt7171 < 0 || node_sub19.anInt7161 < 0
						|| (node_sub19.anInt7171 ^ 0xffffffff) <= (Node_Sub54.GAME_SCENE_WDITH ^ 0xffffffff)
						|| node_sub19.anInt7161 >= Class377_Sub1.GAME_SCENE_HEIGHT))
			...
			for (Node_Sub19 node_sub19 = (Node_Sub19) Class262_Sub8.aClass312_7755
				...
				node_sub19.anInt7171 -= i_4_;
				if (Class61.anInt898 != 4 && (node_sub19.anInt7171 < 0 || node_sub19.anInt7161 < 0
						|| node_sub19.anInt7171 >= Node_Sub54.GAME_SCENE_WDITH
						|| node_sub19.anInt7161 >= Class377_Sub1.GAME_SCENE_HEIGHT))
			...
			if (Class61.anInt898 != 4)
				for (Node_Sub11 node_sub11 = (Node_Sub11) Class266.aHashTable3380
					...
					if (i_18_ < 0 || (i_20_ ^ 0xffffffff) > -1 || i_18_ >= Node_Sub54.GAME_SCENE_WDITH
							|| (i_20_ ^ 0xffffffff) <= (Class377_Sub1.GAME_SCENE_HEIGHT ^ 0xffffffff))
			...
			if ((i_0_ ^ 0xffffffff) == -13) {
				...
				if (Math.abs(i_4_) > Node_Sub54.GAME_SCENE_WDITH
						|| (Math.abs(i_5_) ^ 0xffffffff) < (Class377_Sub1.GAME_SCENE_HEIGHT ^ 0xffffffff))
	...
	public final synchronized Class383 method4060(byte b) {
		anInt4517++;
	...
	public final void method4061(BufferedStream buffer, int i) {
		if (i != 0)
