...
public class Class366 {
	public static Class279 aClass279_4526;
	public static Class56 aClass56_4527 = new Class56();
	public static long aLong4528;
	public static int anInt4530;
	public static int anInt4531;
	public static SeekableFile aSeekableFile4529;

	public static final void method4071(int i, int i_0_) {
	...
	public static final String method4073(boolean bool) {
		anInt4531++;
		if (bool != false)
			method4072(true);
