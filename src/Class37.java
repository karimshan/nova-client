...
public class Class37 {
	public static OutgoingPacket aClass318_557 = new OutgoingPacket(53, 3);
	public static float aFloat558;
	...
	public static final int method401(boolean bool, String string) {
		anInt555++;
	...
	public final Class48 method395(int i, byte b) {
		anInt550++;
		Class48 class48;
		synchronized (aClass61_551) {
			class48 = (Class48) aClass61_551.method607(i, 0);
		}
		if (class48 != null)
			return class48;
		byte[] bs;
		synchronized (aClass302_559) {
			bs = aClass302_559.method3524(false, Class262_Sub23.method3214(i, -20139),
					Class156.method1705(-983162425, i));
		}
		class48 = new Class48();
		class48.anInt711 = i;
		if (bs != null)
		...
		class48.method476(2);
		synchronized (aClass61_551) {
			aClass61_551.method601(class48, 25566, i);
			if (b >= -78)
	...
	public final void method396(int i, int i_0_) {
		anInt552++;
		synchronized (aClass61_551) {
	...
	public final void method397(int i) {
		synchronized (aClass61_551) {
			if (i != 53)
				return;
	...
	public final void method398(byte b) {
		if (b == -128) {
			synchronized (aClass61_551) {
	...
	public final CacheNode_Sub15 method399(int i, int i_1_) {
		if (i_1_ > -49)
			return null;
		anInt556++;
		CacheNode_Sub15 cachenode_sub15;
		synchronized (aClass61_560) {
			cachenode_sub15 = (CacheNode_Sub15) aClass61_560.method607(i, 0);
			if (cachenode_sub15 == null) {
				cachenode_sub15 = new CacheNode_Sub15(i);
				aClass61_560.method601(cachenode_sub15, 25566, i);
			}
