...
public class Class371 {
	public static OutgoingPacket aClass318_4586 = new OutgoingPacket(10, 8);
	...
	public static final void method4092(int i, int i_0_, Rectangle[] rectangles) throws Exception_Sub1 {
	...
	public static final boolean method4094(int i, boolean bool) {
		anInt4580++;
		if (bool != false)
			method4097(17, -80, 66);
		if ((i & -i) != i)
	...
	public static final void method4096(byte b) {
		int i = -87 % ((-56 - b) / 40);
	...
	public static final void method4097(int i, int i_2_, int i_3_) {
		anInt4573++;
		CacheNode_Sub2 cachenode_sub2 = Class320_Sub19.method3754(3, 17, i_3_);
		int i_4_ = 6 % ((16 - i) / 61);
	...
	public final void method4093(String string, byte b) {
	...
	public final String[] method4095(int i) {
		if (i != -15202)
			aClass318_4586 = null;
		anInt4575++;
