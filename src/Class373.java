...
public class Class373 {
	public static boolean aBoolean4608 = true;
	public static int anInt4601;
	public static int anInt4603;
	public static int anInt4606;
	public static int anInt4609;
	public static int RUN_ENERGY = 0;

	public static final void method4106(boolean bool, Index class302) {
		anInt4606++;
		if (bool == true)
			Node_Sub38_Sub19.aClass302_10286 = class302;
	}

	public static final void method4108(EntityNode_Sub1 entitynode_sub1, int i) {
		int i_1_ = -113 / ((-45 - i) / 41);
		entitynode_sub1.anActor5925 = null;
		anInt4601++;
		if (MiniMapDots.anInt121 < 20) {
	...
	public final Interface10 method4105(int i, Interface7 interface7) {
		anInt4609++;
		if (i <= 98)
			return null;
		if (interface7 == null)
