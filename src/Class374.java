...
public class Class374 {
	public static Class151 aClass151_4614 = new Class151(15, 0, 1, 0);
	...
	public static final int method4112(int i, int i_0_) {
		anInt4625++;
		if (i != 1)
			aClass151_4614 = null;
		return i_0_ >>> 8;
	...
	public static final int method4113(int i, int i_1_, int i_2_, int i_3_) {
		if (i_1_ != -1145)
			aClass151_4614 = null;
		anInt4623++;
	...
	public final void method4109(boolean bool) {
		anInt4613++;
	...
	public final void method4111(Runnable runnable, int i) {
		anInt4612++;
