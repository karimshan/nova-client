...
public class Class375 {
	public static IncomingPacket aClass192_4655 = new IncomingPacket(107, 4);
	...
	public static final void method4115(byte b) {
	...
	public static final aa_Sub3 method4116(int i, int[] is, GLToolkit gltoolkit, int[] is_0_, int i_1_, int i_2_) {
		anInt4656++;
