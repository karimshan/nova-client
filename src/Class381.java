...
public class Class381 {
	...
	public static final synchronized void method4172(int i) {
		anInt4892++;
		if (Class66_Sub1.anObject8988 == null)
			try {
				...
				Method method_1_ = var_class.getMethod("newPlatformMXBeanProxy",
						new Class[] { Class.forName("javax.management.MBeanServerConnection"),
				...
				Class66_Sub1.anObject8988 = method_1_.invoke(null,
	...
	public static final void method4173(int i, int i_2_, Actor actor, byte b, int i_3_, int i_4_, int i_5_) {
