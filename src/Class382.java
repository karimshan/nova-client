...
public class Class382 implements Interface11 {
	public static boolean aBoolean5254 = false;
	public static boolean aBoolean5260;
	public static Class142 aClass142_5246;
	public static IncomingPacket aClass192_5249 = new IncomingPacket(133, -1);
	public static Color[] aColorArray5258 = { new Color(9179409), new Color(3289650), new Color(3289650), new Color(3289650) };
	...
	public static final int method4179(Class289 class289, byte b, GraphicsToolkit graphicstoolkit) {
		int i = -55 / ((-77 - b) / 43);
		anInt5255++;
		if (class289.anInt3629 != -1)
			return class289.anInt3629;
		if ((class289.anInt3640 ^ 0xffffffff) != 0) {
			PlayerMasks class91 = graphicstoolkit.aD1543.method10(class289.anInt3640, -8217);
	...
	public final void method4175(int i, int i_0_) {
		anInt5251++;
	...
	public final void method4178(CacheNode_Sub17 cachenode_sub17, int i, int i_4_) {
		anInt5248++;
		...
		} else if ((anInt5256 ^ 0xffffffff) != (cachenode_sub17.anInt8837 ^ 0xffffffff)
				|| (cachenode_sub17.anInt8850 ^ 0xffffffff) != (anInt5238 ^ 0xffffffff))
			throw new RuntimeException();
	...
	public final boolean method4180(int i) {
		if (i != 10785)
			aBoolean5254 = true;
		anInt5262++;
	...
	public final void method4181(int i, Class169_Sub2 class169_sub2, int i_7_) {
		anInt5261++;
	...
	public final void method4182(int i, Class169_Sub1 class169_sub1, int i_8_, int i_9_) {
	...
	public final void method4183(int i, byte b) {
	...
	public final void method4186(int i, byte b) {
		anInt5244++;
		if (anInt5234 == -1)
			throw new RuntimeException();
