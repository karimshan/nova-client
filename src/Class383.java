...
public class Class383 {
	public static final Class383[] method4187(Index class302, int i, int i_0_) {
	...
	public static final Class383 method4191(Index class302, int i) {
	...
	public static final Class383 method4194(Index class302, int i, int i_66_) {
	...
	public static final Class383[] method4199(Index class302, int i) {
	...
	public final void method4192(int i) {
	...
	public final void method4193(int i) {
		int i_48_ = -1;
		...
		for (int i_63_ = anInt4900 - 1; i_63_ > 0; i_63_--) {
			...
			for (int i_65_ = anInt4897 - 1; i_65_ > 0; i_65_--)
				if (anIntArray4904[aByteArray4903[i_65_ + i_64_] & 0xff] == 0
						&& anIntArray4904[aByteArray4903[i_65_ + i_64_ - 1 - anInt4897] & 0xff] != 0)
					aByteArray4903[i_65_ + i_64_] = (byte) i_48_;
		}
	}

	public final int[] method4195() {
		int i = method4190();
	...
	public final void method4197(int i) {
		int i_76_ = -1;
		if (anIntArray4904.length < 255) {
