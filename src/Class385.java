...
public class Class385 {
	public static Class94 aClass94_4911 = new Class94();
	public static int anInt4909;
	public static int anInt4910;
	public static int anInt4912;
	public static int anInt4913;
	public static int[] anIntArray4914 = new int[13];

	static {
		anInt4913 = -1;
	}

	public static final void method4204(GraphicsToolkit graphicstoolkit, int i, byte b) {
		anInt4909++;
		if (!Class12.aBoolean194 || !Mobile_Sub1.aBoolean10959)
			...
			aa.anInt100 = (int) (is[2] / 3.0F);
			OutputStream_Sub2.anInt96 = (int) (is[3] / 3.0F);
			graphicstoolkit.a(FileOnDisk.anIntArray1329);
			if ((Class144_Sub1.anInt6806 ^ 0xffffffff) != ((int) (FileOnDisk.anIntArray1329[0] / 3.0F) ^ 0xffffffff)
					|| ((int) (FileOnDisk.anIntArray1329[1] / 3.0F) ^ 0xffffffff) != (Class331.anInt4130
							^ 0xffffffff)) {
				Class144_Sub1.anInt6806 = (int) (FileOnDisk.anIntArray1329[0] / 3.0F);
				Class331.anInt4130 = (int) (FileOnDisk.anIntArray1329[1] / 3.0F);
			...
			if ((Class320_Sub21.anInt8406 ^ 0xffffffff) < -1) {
				...
				for (int i_6_ = 0; (Class320_Sub21.anInt8406 ^ 0xffffffff) < (i_6_ ^ 0xffffffff); i_6_++) {
					...
					Node.method2163(class54.aShortArray809[0], class54.aShortArray811[0], class54.aShortArray812[3],
							(byte) -52, class54.aShortArray812[1], class54.aShortArray811[3], class54.aShortArray809[3],
							class54.aShortArray811[1], class54.aShortArray812[0], class54.aShortArray809[1]);
					Node.method2163(class54.aShortArray809[1], class54.aShortArray811[1], class54.aShortArray812[3],
							(byte) -76, class54.aShortArray812[2], class54.aShortArray811[3], class54.aShortArray809[3],
							class54.aShortArray811[2], class54.aShortArray812[1], class54.aShortArray809[2]);
				}
	...
	public static final void method4205(boolean bool, double d) {
		if (bool != false)
			aClass94_4911 = null;
		anInt4910++;
		if (GLSprite_Sub1.aDouble8857 != d) {
			for (int i = 0; (i ^ 0xffffffff) > -257; i++) {
				int i_7_ = (int) (Math.pow(i / 255.0, d) * 255.0);
