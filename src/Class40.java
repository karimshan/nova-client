...
public class Class40 {
	public static GLSprite aGLSprite621;
	...
	public static final void method432(int i, int i_0_, int i_1_, int i_2_) {
		anInt619++;
		...
		if ((i_1_ ^ 0xffffffff) != 0 || Class377_Sub1.aBoolean8775) {
			if ((i_1_ ^ 0xffffffff) != 0
					&& ((Class313.anInt4013 ^ 0xffffffff) != (i_1_ ^ 0xffffffff) || !Class36.method390(-122))
					&& (i ^ 0xffffffff) != -1 && !Class377_Sub1.aBoolean8775) {
