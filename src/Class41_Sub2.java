...
public class Class41_Sub2 extends Class41 {
	public static Class aClass5549;
	public static Class aClass5550;

	public static Class method440(String string) {
		Class var_class;
		try {
	...
	@Override
	public final Socket method435(int i) throws IOException {
	...
	private final Socket method438(byte b, Proxy proxy) throws IOException {
		...
		if (proxy.type() == Proxy.Type.HTTP) {
			...
			try {
				...
				Method method = var_class.getDeclaredMethod("getProxyAuth", new Class[] {
						aClass5549 == null ? aClass5549 = method440("java.lang.String") : aClass5549, Integer.TYPE });
				...
				if (null != object) {
					...
					if (((Boolean) method_0_.invoke(object, new Object[0])).booleanValue()) {
						...
						Method method_2_ = var_class.getDeclaredMethod("getHeaderValue",
								new Class[] { aClass5550 == null ? aClass5550 = method440("java.net.URL") : aClass5550,
						...
						String string_4_ = (String) method_2_.invoke(object,
								new Object[] { new URL("https://" + aString625 + "/"), "https" });
	...
	private final Socket method439(String string, int i, String string_5_) throws IOException {
		...
		if (string_6_ != null) {
			...
			if (string_6_.startsWith("HTTP/1.0 407") || string_6_.startsWith("HTTP/1.1 407")) {
				...
				for (string_6_ = bufferedreader.readLine(); string_6_ != null
						&& (i_7_ ^ 0xffffffff) > -51; string_6_ = bufferedreader.readLine()) {
