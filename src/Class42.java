...
class Class42 {
	public static Class122 aClass122_631;
	public static Class181 aClass181_643;
	...
	public static int anInt649 = 16777215;
	public static int[] anIntArray645;

	public static final int method444(long l, boolean bool) {
		anInt637++;
		if (bool != false)
			return 123;
	...
	public final synchronized void method441(int i, Node_Sub9 node_sub9) {
		anInt630++;
	...
	public final synchronized void method445(int i) {
		if (i != 3)
	...
	public final synchronized void method451(byte b) {
		anInt644++;
		aBoolean656 = true;
		if (b != -50)
			method443(91, 24);
	...
	public final synchronized void method453(byte b) {
		anInt632++;
		if (!aBoolean647) {
			...
			try {
				if (aLong641 + 6000L < l)
					aLong641 = l - 6000L;
				for (/**/; (l ^ 0xffffffffffffffffL) < (5000L + aLong641 ^ 0xffffffffffffffffL); l = Class313
						.method3650(false)) {
					method443(-26994, 256);
