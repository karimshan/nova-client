...
public class Class42_Sub1 extends Class42 {
	public static Class aClass5556;

	public static Class method456(String string) {
		Class var_class;
		try {
	...
	@Override
	public final void method442() throws LineUnavailableException {
		...
		if (aBoolean5554) {
			...
			DataLine.Info info = new DataLine.Info(
					...
					anAudioFormat5555, anInt5553 << (!DrawableModel.aBoolean913 ? 1 : 2));
	...
	@Override
	public final void method447(int i) throws LineUnavailableException {
		try {
			DataLine.Info info = new DataLine.Info(
					aClass5556 == null ? aClass5556 = method456("javax.sound.sampled.SourceDataLine") : aClass5556,
					anAudioFormat5555, i << (!DrawableModel.aBoolean913 ? 1 : 2));
			aSourceDataLine5551 = (SourceDataLine) AudioSystem.getLine(info);
			aSourceDataLine5551.open();
			aSourceDataLine5551.start();
			anInt5553 = i;
	...
	@Override
	public final void method452(Component component) {
		...
		anAudioFormat5555 = new AudioFormat(Class365.anInt4523, 16, !DrawableModel.aBoolean913 ? 1 : 2, true, false);
