...
public class Class47 {
	public static Class26 aClass26_688 = new Class26();
	public static int anInt682;
	public static int anInt683;
	public static int anInt685;
	public static int[] anIntArray689 = new int[1];
	...
	public static final void method475(int i, int i_1_) {
		anInt683++;
		CacheNode_Sub2 cachenode_sub2 = Class320_Sub19.method3754(3, 17, i_1_);
	...
	public final void method473(Node_Sub43 node_sub43, boolean bool) {
		if (bool != false)
			aClass312_686 = null;
		anInt682++;
		if (node_sub43.aLong2797 != aLong687 || aLong684 != node_sub43.aLong7537)
			throw new RuntimeException("ClanChannelDelta.applyToClanChannel(): Credentials do not match! cc.clanHash:"
					+ node_sub43.aLong2797 + " updateNum:" + node_sub43.aLong7537 + " delta.clanHash:" + aLong687
					+ " updateNum:" + aLong684);
		for (Node_Sub36 node_sub36 = (Node_Sub36) aClass312_686
				.method3613(65280); node_sub36 != null; node_sub36 = (Node_Sub36) aClass312_686.method3620(16776960))
