...
public class Class48 {
	public static EntityNode_Sub4[] anEntityNode_Sub4Array694;
	...
	public static final void method478(int i, byte b) {
		anInt709++;
		if ((Class151.anInt1843 ^ 0xffffffff) != (i ^ 0xffffffff)) {
			...
			if ((i ^ 0xffffffff) == -6 || (i ^ 0xffffffff) == -14) {
				System.out.println("Method478 called in Class48");
			...
			boolean bool_1_ = (Class151.anInt1843 ^ 0xffffffff) == -3 || Class26.method311(Class151.anInt1843, -5)
			...
			if (!bool_1_ == bool)
				if (!bool) {
					...
					if ((Class213.aNode_Sub27_2512.aClass320_Sub25_7309.method3776(false) ^ 0xffffffff) != -1) {
						Class39.method408(2, Class317.anInt4038, 0, false,
								Class213.aNode_Sub27_2512.aClass320_Sub25_7309.method3776(false), SeekableFile.index6,
								false);
			...
			if (Class315.method3655(i, 128) || (i ^ 0xffffffff) == -15 || (i ^ 0xffffffff) == -16)
				Class93.graphicsToolkit.h();
			Class151.anInt1843 = i;
		}
	}

	public static final CacheNode_Sub2 method479(int i) {
		if (i != 1)
	...
	public static final void method481(int i) {
		anInt695++;
		Class182.method1832();
		if (i != 0)
			anInt704 = 16;
	...
	public static final void method483(String string, int i, String string_19_, boolean bool, int i_20_) {
		anInt717++;
		Node_Sub13 node_sub13 = Node_Sub25_Sub1.method2660(i_20_ ^ i_20_);
		node_sub13.packet.writeByte(Plane.aClass133_3414.packetId);
		node_sub13.packet.writeShort(0);
		int i_21_ = node_sub13.packet.offset;
		node_sub13.packet.writeShort(667);
		int[] is = Class355.method4014(i_20_ ^ ~0x1522, node_sub13);
		int i_22_ = node_sub13.packet.offset;
		node_sub13.packet.writeString(string);
		node_sub13.packet.writeShort(Class170.anInt2056);
		node_sub13.packet.writeString(string_19_);
		node_sub13.packet.writeLong(Node_Sub32.aLong7385);
		node_sub13.packet.writeByte(Class35.language);
		node_sub13.packet.writeByte(Class209.directory.anInt4344);
		EntityNode_Sub3.method941(i_20_ ^ 0x1b, node_sub13.packet);
		String string_23_ = Node_Sub38_Sub18.aString10283;
		node_sub13.packet.writeByte(string_23_ != null ? 1 : 0);
		if (string_23_ != null)
			node_sub13.packet.writeString(string_23_);
		node_sub13.packet.writeByte(i);
		node_sub13.packet.writeByte(bool ? 1 : 0);
		node_sub13.packet.offset += 7;
		node_sub13.packet.encryptXteas(is, i_22_, false, node_sub13.packet.offset);
		node_sub13.packet.method2194(node_sub13.packet.offset - i_21_, -2887);
	...
	public final void method476(int i) {
		if (anInt718 == -1)
	...
	public final void method477(BufferedStream buffer, int i) {
		for (;;) {
									...
									if (i != 18) {
										if ((i ^ 0xffffffff) == -20) {
											if (anIntArray701 == null) {
												...
												for (int i_16_ = 0; (anIntArrayArray700.length ^ 0xffffffff) < (i_16_
														^ 0xffffffff); i_16_++)
											...
											if (anIntArray690 == null || anIntArray692 == null) {
												...
												for (int i_17_ = 0; (anIntArrayArray700.length ^ 0xffffffff) < (i_17_
														^ 0xffffffff); i_17_++) {
