...
public class Class5 {
	...
	Class5(AbstractToolkit abstracttoolkit) {
		...
		if (aBoolean128
				&& !anAbstractToolkit126.method1377(Class372.aClass372_4594, Class259.aClass68_3268, (byte) -72))
			aBoolean128 = false;
		if (aBoolean128 || anAbstractToolkit126.method1295(Class259.aClass68_3268, Class372.aClass372_4594, 1)) {
			...
			if (aBoolean128) {
				...
				anInterface13_Impl3_130 = anAbstractToolkit126.method1262(Class259.aClass68_3268, bs, (byte) -57, 128,
						16, 128);
				...
				for (int i = 0; (i ^ 0xffffffff) > -17; i++) {
					...
					anInterface13_Impl1Array131[i] = anAbstractToolkit126.method1252(128, bs, Class259.aClass68_3268,
							128, (byte) -3, true);
				}
				...
				for (int i = 0; i < 16; i++) {
					...
					anInterface13_Impl1Array127[i] = anAbstractToolkit126.method1252(128, bs, Class259.aClass68_3268,
							128, (byte) -3, true);
				}
			}
		}
	...
	public final boolean method172(int i) {
		if (anInterface13_Impl3_129 == null) {
			if (Class105.anObject5203 == null) {
				byte[] bs = Class320_Sub20.method3756(16, 8, 128, 4.0F, 4.0F, 0.5F, i ^ 0x2777, 128, 16.0F, 0.6F,
						new Class328_Sub1(419684));
			...
			for (int i_2_ = 0; i_2_ < 16; i_2_++) {
				...
				for (int i_5_ = 0; i_5_ < 128; i_5_++) {
					...
					for (int i_9_ = 0; (i_9_ ^ 0xffffffff) > -129; i_9_++) {
						float f = -(0xff & bs[i_9_ + i_8_]) + (0xff & bs[i_7_ - -i_9_]);
						float f_10_ = -(bs[i_6_ - -(1 + i_9_ & 0x7f)] & 0xff) + (0xff & bs[i_6_ + (0x7f & -1 + i_9_)]);
						float f_11_ = (float) (128.0 / Math.sqrt(f * f + (f_10_ * f_10_ + 16384.0F)));
			...
			anInterface13_Impl3_129 = anAbstractToolkit126.method1262(Class99.aClass68_1290, bs_0_, (byte) -57, 128, 16,
					128);
		}
		if (i != 10103)
			return true;
	...
	public final boolean method173(int i) {
		anInt132++;
		if (i != 4)
			anInterface13_Impl1Array127 = null;
		if (!aBoolean128) {
