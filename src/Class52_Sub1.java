...
public class Class52_Sub1 extends AbstractFont {
	...
	Class52_Sub1(AbstractToolkit abstracttoolkit, Class357 class357, Class383[] class383s, boolean bool) {
		...
		if (bool) {
			...
			if (!abstracttoolkit.method1295(Node_Sub52.aClass68_7639, Class372.aClass372_4594, 1)) {
				...
				anInterface13_Impl1_5560 = abstracttoolkit.method1252(i_1_, bs, Node_Sub52.aClass68_7639, i_1_,
						(byte) -3, false);
			aBoolean5559 = true;
		} else {
		...
		for (int i_30_ = 0; i_30_ < 4; i_30_++) {
			Buffer buffer = anInterface15_Impl2_5562.method40(-12, true);
			if (buffer != null) {
				Stream stream = anAbstractToolkit5561.method1324(true, buffer);
				float f = anInterface13_Impl1_5560.method45(i_1_, -51) / i_1_;
				float f_31_ = anInterface13_Impl1_5560.method49(i_1_, (byte) -47) / i_1_;
				for (int i_32_ = 0; i_32_ < 256; i_32_++) {
					...
					float f_37_ = i_32_ % 16 * i;
					float f_38_ = i_32_ / 16 * i;
					float f_39_ = f_37_ * f;
					float f_40_ = f_38_ * f_31_;
					float f_41_ = (f_37_ + i_34_) * f;
					float f_42_ = (f_38_ + i_33_) * f_31_;
					if (Stream.b()) {
	...
	@Override
	public final void fa(char c, int i, int i_47_, int i_48_, boolean bool) {
	...
	@Override
	public final void method526(char c, int i, int i_43_, int i_44_, boolean bool, aa var_aa, int i_45_, int i_46_) {
		/* empty */
	}
}
