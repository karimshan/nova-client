...
public class Class52_Sub2 extends AbstractFont {
	...
	Class52_Sub2(GLToolkit gltoolkit, Class357 class357, Class383[] class383s, boolean bool) {
		...
		float f = aClass169_Sub2_Sub1_5565.aFloat10567 / aClass169_Sub2_Sub1_5565.anInt10566;
		float f_36_ = aClass169_Sub2_Sub1_5565.aFloat10568 / aClass169_Sub2_Sub1_5565.anInt10564;
		for (int i_37_ = 0; i_37_ < 256; i_37_++) {
			...
			float f_42_ = i_37_ % 16 * i;
			float f_43_ = i_37_ / 16 * i;
			float f_44_ = f_42_ * f;
			float f_45_ = f_43_ * f_36_;
			float f_46_ = (f_42_ + i_39_) * f;
			float f_47_ = (f_43_ + i_38_) * f_36_;
	...
	@Override
	public final void fa(char c, int i, int i_0_, int i_1_, boolean bool) {
	...
	@Override
	public final void method526(char c, int i, int i_2_, int i_3_, boolean bool, aa var_aa, int i_4_, int i_5_) {
		...
		float f_6_ = class169_sub2_sub1.aFloat10568 / class169_sub2_sub1.anInt10564;
