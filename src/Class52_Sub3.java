...
public class Class52_Sub3 extends AbstractFont {
	...
	@Override
	public final void fa(char c, int i, int i_86_, int i_87_, boolean bool) {
		i += anIntArray5570[c];
		...
		if (i_88_ > 0 && i_89_ > 0)
			if (bool)
				method546(aByteArrayArray5568[c], aPureJavaToolkit5571.anIntArray6787, i_87_, i_94_, i_91_, i_88_,
						i_89_, i_92_, i_93_);
			else
				method547(aByteArrayArray5568[c], aPureJavaToolkit5571.anIntArray6787, anIntArray5569, i_94_, i_91_,
						i_88_, i_89_, i_92_, i_93_);
	}

	@Override
	public final void method526(char c, int i, int i_0_, int i_1_, boolean bool, aa var_aa, int i_2_, int i_3_) {
		if (var_aa == null)
			...
			if (i_4_ > 0 && i_5_ > 0)
				if (bool)
					method549(aByteArrayArray5568[c], aPureJavaToolkit5571.anIntArray6787, i_1_, i_10_, i_7_, i_4_,
							i_5_, i_8_, i_9_, i, i_0_, anIntArray5572[c], var_aa, i_2_, i_3_);
				else
					method548(aByteArrayArray5568[c], aPureJavaToolkit5571.anIntArray6787, anIntArray5569, i_1_, i_10_,
							i_7_, i_4_, i_5_, i_8_, i_9_, i, i_0_, anIntArray5572[c], var_aa, i_2_, i_3_);
		}
	}

	private final void method546(byte[] bs, int[] is, int i, int i_14_, int i_15_, int i_16_, int i_17_, int i_18_,
			int i_19_) {
		int i_20_ = -(i_16_ >> 2);
		i_16_ = -(i_16_ & 0x3);
	...
	private final void method547(byte[] bs, int[] is, int[] is_24_, int i, int i_25_, int i_26_, int i_27_, int i_28_,
			int i_29_) {
		int i_30_ = -(i_26_ >> 2);
		i_26_ = -(i_26_ & 0x3);
		boolean bool = false;
	...
	private final void method548(byte[] bs, int[] is, int[] is_36_, int i, int i_37_, int i_38_, int i_39_, int i_40_,
			int i_41_, int i_42_, int i_43_, int i_44_, int i_45_, aa var_aa, int i_46_, int i_47_) {
	...
	private final void method549(byte[] bs, int[] is, int i, int i_62_, int i_63_, int i_64_, int i_65_, int i_66_,
			int i_67_, int i_68_, int i_69_, int i_70_, aa var_aa, int i_71_, int i_72_) {
		aa_Sub1 var_aa_Sub1 = (aa_Sub1) var_aa;
