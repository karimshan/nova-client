...
public class Class52_Sub4 extends AbstractFont {
	...
	@Override
	public final void fa(char c, int i, int i_55_, int i_56_, boolean bool) {
		i += anIntArray5575[c];
		...
		if (i_57_ > 0 && i_58_ > 0)
			method551(aByteArrayArray5574[c], aPureJavaToolkit5579.anIntArray6787, i_56_, i_63_, i_60_, i_57_, i_58_,
					i_61_, i_62_);
	}

	@Override
	public final void method526(char c, int i, int i_30_, int i_31_, boolean bool, aa var_aa, int i_32_, int i_33_) {
		if (var_aa == null)
			...
			if (i_34_ > 0 && i_35_ > 0)
				method550(aByteArrayArray5574[c], aPureJavaToolkit5579.anIntArray6787, i_31_, i_40_, i_37_, i_34_,
						i_35_, i_38_, i_39_, i, i_30_, anIntArray5576[c], var_aa, i_32_, i_33_);
		}
	}

	private final void method550(byte[] bs, int[] is, int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_,
		...
		for (int i_16_ = i_14_; i_16_ < i_15_; i_16_++) {
			...
			for (int i_23_ = -i_18_; i_23_ < 0; i_23_++) {
				...
				if (i_24_ != 0) {
					...
					i_24_ = 256 - i_24_;
					int i_26_ = is[i_1_];
					is[i_1_++] = (((i_26_ & 0xff00ff) * i_24_ & ~0xff00ff) + ((i_26_ & 0xff00) * i_24_ & 0xff0000) >> 8)
							+ i_25_;
				} else
					i_1_++;
			}
	...
	private final void method551(byte[] bs, int[] is, int i, int i_44_, int i_45_, int i_46_, int i_47_, int i_48_,
			int i_49_) {
		for (int i_50_ = -i_47_; i_50_ < 0; i_50_++) {
			for (int i_51_ = -i_46_; i_51_ < 0; i_51_++) {
				...
				if (i_52_ != 0) {
					...
					i_52_ = 256 - i_52_;
					int i_54_ = is[i_45_];
					is[i_45_++] = (((i_54_ & 0xff00ff) * i_52_ & ~0xff00ff)
							+ ((i_54_ & 0xff00) * i_52_ & 0xff0000) >> 8) + i_53_;
				} else
					i_45_++;
			}
			i_45_ += i_48_;
