...
public class Class52_Sub5 extends AbstractFont {
	...
	@Override
	public final void fa(char c, int i, int i_52_, int i_53_, boolean bool) {
		i += anIntArray5582[c];
		...
		if (i_54_ > 0 && i_55_ > 0)
			if ((i_53_ & ~0xffffff) == -16777216)
				method555(aByteArrayArray5585[c], aPureJavaToolkit5580.anIntArray6787, i_53_, i_60_, i_57_, i_54_,
						i_55_, i_58_, i_59_);
			else if ((i_53_ & ~0xffffff) != 0)
				method554(aByteArrayArray5585[c], aPureJavaToolkit5580.anIntArray6787, i_53_, i_60_, i_57_, i_54_,
						i_55_, i_58_, i_59_);
	}

	@Override
	public final void method526(char c, int i, int i_64_, int i_65_, boolean bool, aa var_aa, int i_66_, int i_67_) {
		if (var_aa == null)
			...
			if (i_68_ > 0 && i_69_ > 0)
				if ((i_65_ & ~0xffffff) == -16777216)
					method552(aByteArrayArray5585[c], aPureJavaToolkit5580.anIntArray6787, i_65_, i_74_, i_71_, i_68_,
							i_69_, i_72_, i_73_, i, i_64_, anIntArray5583[c], var_aa, i_66_, i_67_);
				else
					method553(aByteArrayArray5585[c], aPureJavaToolkit5580.anIntArray6787, i_65_, i_74_, i_71_, i_68_,
							i_69_, i_72_, i_73_, i, i_64_, anIntArray5583[c], var_aa, i_66_, i_67_);
		}
	}

	private final void method552(byte[] bs, int[] is, int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_,
			int i_6_, int i_7_, int i_8_, aa var_aa, int i_9_, int i_10_) {
	...
	private final void method553(byte[] bs, int[] is, int i, int i_24_, int i_25_, int i_26_, int i_27_, int i_28_,
			int i_29_, int i_30_, int i_31_, int i_32_, aa var_aa, int i_33_, int i_34_) {
		aa_Sub1 var_aa_Sub1 = (aa_Sub1) var_aa;
		...
		for (int i_42_ = i_38_; i_42_ < i_39_; i_42_++) {
			...
			for (int i_49_ = -i_44_; i_49_ < 0; i_49_++)
				if (bs[i_24_++] != 0) {
					...
					int i_51_ = is[i_25_];
					is[i_25_++] = (((i_51_ & 0xff00ff) * i_41_ & ~0xff00ff)
							+ ((i_51_ & 0xff00) * i_41_ & 0xff0000) >> 8) + i_50_;
				} else
					i_25_++;
			i_24_ += i_48_ + i_29_;
			i_25_ += i_48_ + i_28_;
	...
	private final void method554(byte[] bs, int[] is, int i, int i_78_, int i_79_, int i_80_, int i_81_, int i_82_,
			int i_83_) {
		int i_84_ = i >>> 24;
		int i_85_ = 255 - i_84_;
		for (int i_86_ = -i_81_; i_86_ < 0; i_86_++) {
			for (int i_87_ = -i_80_; i_87_ < 0; i_87_++)
				if (bs[i_78_++] != 0) {
					...
					int i_89_ = is[i_79_];
					is[i_79_++] = (((i_89_ & 0xff00ff) * i_85_ & ~0xff00ff)
							+ ((i_89_ & 0xff00) * i_85_ & 0xff0000) >> 8) + i_88_;
				} else
					i_79_++;
			i_79_ += i_82_;
			i_78_ += i_83_;
	...
	private final void method555(byte[] bs, int[] is, int i, int i_90_, int i_91_, int i_92_, int i_93_, int i_94_,
			int i_95_) {
		int i_96_ = -(i_92_ >> 2);
		i_92_ = -(i_92_ & 0x3);
