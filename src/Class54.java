...
public class Class54 {
	public static boolean aBoolean817 = false;
	public static Class56 aClass56_823 = new Class56();
	public static Image loadingScreen;
	public static int[] LocalNPCsIndexes = new int[1024];
	...
	Class54(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_,
