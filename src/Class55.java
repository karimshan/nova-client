...
public class Class55 {
	public static Class104 aClass104_833 = new Class104();
	public static Class346 aClass346_829 = new Class346();
	public static int anInt826;
	public static int anInt827;
	public static int anInt828;
	public static int anInt830;
	public static int[] anIntArray834;

	public static final void method558(byte b, String string) {
		anInt830++;
		Node_Sub13 node_sub13 = Node_Sub25_Sub1.method2660(0);
		node_sub13.packet.writeByte(Plane.aClass133_3419.packetId);
		node_sub13.packet.writeShort(0);
		if (b != -119)
			anIntArray834 = null;
		int i = node_sub13.packet.offset;
		node_sub13.packet.writeShort(667);
		int[] is = Class355.method4014(-5410, node_sub13);
		int i_0_ = node_sub13.packet.offset;
		node_sub13.packet.writeString(string);
		node_sub13.packet.writeByte(Class35.language);
		node_sub13.packet.offset += 7;
		node_sub13.packet.encryptXteas(is, i_0_, false, node_sub13.packet.offset);
		node_sub13.packet.method2194(-i + node_sub13.packet.offset, b + -2768);
	...
	public static final void method562(byte b) {
		if (b != 18)
			method560((byte) -65);
		anInt826++;
		Class229.aGraphicsToolkit2732
				.xa((Class213.aNode_Sub27_2512.aClass320_Sub22_7299.method3765(false) * 0.1F + 0.7F) * 1.1523438F);
	...
	public final void method561(BufferedStream buffer, byte b) {
