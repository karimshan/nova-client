...
public class Class60 {
	public static float aFloat883;
	public static int anInt880;
	public static int anInt881 = -1;
	public static int anInt884;
	public static int[][] anIntArrayArray882;

	static {
		anInt880 = -1;
		anIntArrayArray882 = new int[][] { { 0, 2, 4, 6 }, { 6, 0, 2, 4 }, { 6, 0, 2 }, { 2, 6, 0 }, { 0, 2, 6 },
	...
	public static final void method594(int i, int i_0_) {
		anInt884++;
		...
		if ((i_0_ ^ 0xffffffff) != (Node_Sub38_Sub23.anInt10346 ^ 0xffffffff)) {
			if ((i_0_ ^ 0xffffffff) != 0) {
				...
				if (class383 == null)
					...
					Class240.aSignLink2946.method3645(class383.method4196(), (byte) 121, class383.method4195(),
							Node_Sub38_Sub20.aCanvas10309, new Point(class364.anInt4511, class364.anInt4519),
							class383.method4190());
