...
public class Class61 {
	...
	public static Node_Sub9_Sub1 aNode_Sub9_Sub1_885;
	...
	public final Object method596(int i) {
		anInt893++;
		int i_0_ = -15 % ((27 - i) / 63);
	...
	public final int method597(int i) {
		anInt899++;
		if (i != 22349)
			return 125;
		return anInt902;
	...
	public final void method598(int i, int i_2_) {
		if (i_2_ != -11819)
			anInt897 = -40;
		if (Node_Sub34.aClass115_7410 != null)
			for (CacheNode_Sub20 cachenode_sub20 = (CacheNode_Sub20) aClass158_886.method1723(
					13); cachenode_sub20 != null; cachenode_sub20 = (CacheNode_Sub20) aClass158_886.method1721(0))
				if (!cachenode_sub20.method2411(-96)) {
					if ((++cachenode_sub20.aLong7037 ^ 0xffffffffffffffffL) < (i ^ 0xffffffffffffffffL)) {
	...
	public final int method599(byte b) {
		anInt894++;
		int i = 0;
		for (CacheNode_Sub20 cachenode_sub20 = (CacheNode_Sub20) aClass158_886.method1723(
				13); cachenode_sub20 != null; cachenode_sub20 = (CacheNode_Sub20) aClass158_886.method1721(0))
	...
	public final void method601(Object object, int i, long l) {
		anInt892++;
	...
	public final void method602(byte b) {
		if (b > -116)
			method597(101);
		for (CacheNode_Sub20 cachenode_sub20 = (CacheNode_Sub20) aClass158_886.method1723(
				13); cachenode_sub20 != null; cachenode_sub20 = (CacheNode_Sub20) aClass158_886.method1721(0))
	...
	public final Object method603(byte b) {
		anInt889++;
		if (b != -22)
			return null;
	...
	public final void method604(long l, Object object, int i, int i_5_) {
		anInt891++;
		if (i > anInt902)
	...
	public final void method605(long l, int i) {
		if (i == -13068) {
			anInt887++;
			CacheNode_Sub20 cachenode_sub20 = (CacheNode_Sub20) aHashTable901.getNode(3512, l);
			method600(-28711, cachenode_sub20);
		}
	}

	public final Object method607(long l, int i) {
		anInt896++;
		CacheNode_Sub20 cachenode_sub20 = (CacheNode_Sub20) aHashTable901.getNode(i ^ 0xdb8, l);
		if (i != 0)
			return null;
		if (cachenode_sub20 == null)
			return null;
	...
	public final void method608(boolean bool) {
		anInt903++;
