...
public class Class65 {
	public static final Class65 method714(Index class302, int i, int i_0_) {
	...
	private final byte[] method715() {
		...
		for (int i_1_ = 0; i_1_ < 10; i_1_++)
			if (aClass227Array925[i_1_] != null
					&& aClass227Array925[i_1_].anInt2698 + aClass227Array925[i_1_].anInt2707 > i)
	...
	public final Node_Sub45_Sub1 method716() {
		byte[] bs = method715();
