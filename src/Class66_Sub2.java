...
class Class66_Sub2 extends Class66 {
	public static long[] aLongArray8997 = new long[32];
	...
	@Override
	public final void method719(boolean bool, int i, byte b, int i_0_) {
		anInt8991++;
		if (bool) {
			int[] is = new int[4];
			Class93.graphicsToolkit.K(is);
			Class93.graphicsToolkit.KA(i, i_0_, i - -aClass150_5171.anInt5086, aClass150_5171.anInt5081 + i_0_);
			...
			aGLSprite8990.method1196(-i_3_ + (aClass150_5171.anInt5086 + i),
					(-i_4_ + aClass150_5171.anInt5081) / 2 + i_0_);
			Class93.graphicsToolkit.KA(i, i_0_, aClass150_5171.anInt5086 + i, aGLSprite8993.method1186() + i_0_);
			...
			Class93.graphicsToolkit.KA(i, aClass150_5171.anInt5081 + (i_0_ + -i_5_), i + aClass150_5171.anInt5086,
					i_0_ - -aClass150_5171.anInt5081);
			aGLSprite8996.method1192(i_1_ + i, aClass150_5171.anInt5081 + (i_0_ + -i_5_),
					aClass150_5171.anInt5086 + -i_1_ - i_3_, aClass150_5171.anInt5081);
			Class93.graphicsToolkit.KA(is[0], is[1], is[2], is[3]);
		}
		if (b != -16)
			method26(-123);
	}
	...
	@Override
	public final void method721(int i, int i_7_, boolean bool, int i_8_) {
		anInt8995++;
		...
		int[] is = new int[4];
		Class93.graphicsToolkit.K(is);
		Class93.graphicsToolkit.KA(i_9_, i_12_, i_16_ + i_9_, i_13_);
		method726(i_12_, i_9_, 4, i_14_, i_15_);
		Class93.graphicsToolkit.KA(i_16_ + i_9_, i_12_, i_11_, i_13_);
