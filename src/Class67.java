...
public class Class67 {
	public static Class77 aClass77_930 = new Class77();
	public static int anInt928;
	public static int anInt929;
	public static int anInt931;

	public static final String method730(boolean bool, String string) {
		anInt928++;
		int i = string.length();
		int i_0_ = 0;
	...
	public static final String method731(byte b) {
		anInt929++;
		if (Class213.aBoolean2510 || Node_Sub38_Sub23.aCacheNode_Sub13_10343 == null)
			return "";
		if (b != 115)
			return null;
		if ((Node_Sub38_Sub23.aCacheNode_Sub13_10343.aString9558 == null
				|| (Node_Sub38_Sub23.aCacheNode_Sub13_10343.aString9558.length() ^ 0xffffffff) == -1)
				&& Node_Sub38_Sub23.aCacheNode_Sub13_10343.aString9565 != null
				&& (Node_Sub38_Sub23.aCacheNode_Sub13_10343.aString9565.length() ^ 0xffffffff) < -1)
	...
	public static final int method733(int i) {
		anInt931++;
		if (i >= -73)
			aClass77_930 = null;
