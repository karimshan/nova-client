...
public class Class7 {
	public static Class179 aClass179_157 = new Class179(true);
	public static CRC32 aCRC32_163 = new CRC32();
	public static int anInt149;
	public static int anInt154;
	public static String[] aStringArray164 = new String[100];

	public static final void method181(int i, int i_1_, int i_2_, Class var_class) {
		...
		if (class261 != null)
			for (Class256 class256 = class261.aClass256_3312; class256 != null; class256 = class256.aClass256_3238) {
				...
				if (var_class.isAssignableFrom(mobile.getClass()) && mobile.aShort9119 == i_1_
						&& mobile.aShort9120 == i_2_) {
	...
	public final void method182(BufferedStream buffer, int i) {
		if (i != 16777215)
			anInt155 = 84;
		for (;;) {
