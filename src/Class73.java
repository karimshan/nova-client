...
public class Class73 {
	public static CacheNode_Sub4 aCacheNode_Sub4_988 = null;
	public static int anInt983;
	public static int anInt985;
	public static int anInt990;
	public static int anInt992;
	public static byte[] movementTypes = new byte[2048];

	public static final boolean method749(byte b, int i, int i_0_) {
		if (b != -65)
	...
	public final boolean method748(int i, byte b) {
		if (b < 21)
			return true;
		anInt990++;
	...
	public final boolean method750(byte b, int i, Class169 class169) {
		if (b <= 97)
			return false;
		anInt992++;
		if (anInt987 == 0)
	...
	public final void method751(int i, int i_1_, boolean bool, boolean bool_2_, int i_3_, int i_4_) {
		anInt985++;
