...
public class Class74 {
	...
	public static final void method755(GraphicsToolkit graphicstoolkit, int[] is, int i) {
	...
	private static final void method760(GraphicsToolkit graphicstoolkit, int[] is, int i, int i_32_, int i_33_,
			int[] is_34_, int[] is_35_) {
	...
	public static final void method761(GraphicsToolkit graphicstoolkit, int[] is, int i, int[] is_41_, int[] is_42_) {
