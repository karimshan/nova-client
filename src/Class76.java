...
public class Class76 {
	...
	public static final void method767(boolean bool, CacheNode cachenode, CacheNode cachenode_0_) {
	...
	public static final void method768(int i) {
		anInt1015++;
		if (i == -147) {
			...
			IncomingPacketHolder.anInt1568 = Class170.anInt2053;
	...
	public static final void method769(Actor actor, boolean bool) {
		anInt1012++;
				...
				if (i_3_ == -1) {
					...
					if ((i_3_ & ~0x3fffffff) != -1073741824) {
						if ((0x8000 & i_3_ ^ 0xffffffff) != -1) {
							...
							Player player = Client.LOCAL_PLAYERS[i_8_];
							if (player == null) {
					...
					if ((i_6_ ^ 0xffffffff) != -1 || (i_7_ ^ 0xffffffff) != -1)
						actor.method858(256, i, 0x3fff & (int) (Math.atan2(i_6_, i_7_) * 2607.5945876176133));
				}
			}
			if (bool_2_) {
	...
	public static final void method770(int i, int i_12_, int i_13_) {
		anInt1014++;
		if (i < 113)
			method767(false, null, null);
		if (CacheNode_Sub15.method2379(7015, i_13_))
			ConnectionDecoder.method115(Class134_Sub3.widgetsList[i_13_], 5204, i_12_);
	}

	public static final IComponentDefinitions method771(byte b, int i) {
		if (b != 107)
			method770(108, 116, -70);
		anInt1009++;
		int i_14_ = i >> 16;
		int i_15_ = i & 0xffff;
		if (Class134_Sub3.widgetsList[i_14_] == null
				|| Class134_Sub3.widgetsList[i_14_][i_15_] == null) {
			boolean bool = CacheNode_Sub15.method2379(b + 6908, i_14_);
			if (!bool)
				return null;
		}
		return Class134_Sub3.widgetsList[i_14_][i_15_];
	}
}
