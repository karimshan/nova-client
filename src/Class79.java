...
public class Class79 {
	public static boolean aBoolean1052 = false;
	...
	public static int[][] anIntArrayArray1070;
	public static IComponentDefinitions[][] aWidgetArrayArray1082;
	...
	public static final void method788(boolean bool) {
		anInt1061++;
		try {
			if (bool != true)
				aWidgetArrayArray1082 = null;
			Method method = (aClass1094 == null ? aClass1094 = method792("java.lang.Runtime") : aClass1094)
	...
	public final void method782(byte b, BufferedStream buffer) {
		if (b <= -59) {
			anInt1088++;
			for (;;) {
	...
	public final boolean method784(byte b, Interface17 interface17) {
		if (b <= 75)
			aByteArray1057 = null;
		anInt1073++;
		int i;
	...
	public final String method785(int i, int i_1_, String string) {
		anInt1059++;
		if (aHashTable1053 == null)
			return string;
		Node_Sub18 node_sub18 = (Node_Sub18) aHashTable1053.getNode(3512, i);
		if (node_sub18 == null)
			return string;
		if (i_1_ != -18740)
			anIntArrayArray1070 = null;
	...
	public final int method786(int i, int i_2_, int i_3_) {
		anInt1046++;
		if (aHashTable1053 == null)
			return i_2_;
		if (i != 0)
			method786(20, 39, 79);
		Node_Sub32 node_sub32 = (Node_Sub32) aHashTable1053.getNode(3512, i_3_);
		if (node_sub32 == null)
			return i_2_;
		return node_sub32.anInt7381;
	}

	public final GLSprite method787(int i, GraphicsToolkit graphicstoolkit) {
		anInt1043++;
		if (i != 32394)
			method789(true);
		GLSprite glsprite = (GLSprite) aClass215_1076.aClass61_2543
				.method607(0x20000 | anInt1093 | graphicstoolkit.anInt1537 << 29, 0);
		if (glsprite != null)
			return glsprite;
		...
		if (class383 != null) {
			...
			aClass215_1076.aClass61_2543.method601(glsprite, i + -6828,
					anInt1093 | 0x20000 | graphicstoolkit.anInt1537 << 29);
		}
		return glsprite;
	}

	public final void method789(boolean bool) {
		anInt1083++;
		if (bool != false)
			aString1085 = null;
	...
	public final GLSprite method790(boolean bool, byte b, GraphicsToolkit graphicstoolkit) {
		if (b >= -90)
			method787(-5, null);
		anInt1086++;
							...
							if ((i ^ 0xffffffff) == -17)
								...
								if (i == 18)
									...
									for (int i_9_ = 0; (i_9_ ^ 0xffffffff) > (i_7_ ^ 0xffffffff); i_9_++) {
										...
										aHashTable1053.put(i_10_, node, -126);
									}
								}
							} else
