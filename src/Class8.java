...
public class Class8 implements Interface15_Impl1 {
	...
	public final Buffer method54(boolean bool, byte b) {
		...
		if (null == anIDirect3DIndexBuffer9089)
			return null;
		bool &= aBoolean9084;
		if (!aBoolean9087 && lh.a((byte) 86,
				anIDirect3DIndexBuffer9089.Lock(0, anInt9088, !bool ? 0 : 8192, aD3DToolkit9083.aGeometryBuffer9184))) {
			aBoolean9087 = true;
	...
	public final void method56(int i, int i_0_) {
		...
		if ((anInt9088 ^ 0xffffffff) > (anInt9086 ^ 0xffffffff)) {
			...
			anIDirect3DIndexBuffer9089 = aD3DToolkit9083.anIDirect3DDevice9199.a(anInt9086, i_1_,
					aClass372_9085 != Class372.aClass372_4595 ? 102 : 101, i_2_, anIDirect3DIndexBuffer9089);
			anInt9088 = anInt9086;
		}
	}
