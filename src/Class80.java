...
public class Class80 implements Interface15_Impl2 {
	...
	public final boolean method37(int i, int i_1_, int i_2_) {
		...
		if ((anInt9077 ^ 0xffffffff) > (anInt9076 ^ 0xffffffff)) {
			...
			anIDirect3DVertexBuffer9080 = aD3DToolkit9081.anIDirect3DDevice9199.a(anInt9076, i_3_, 0, i_4_,
					anIDirect3DVertexBuffer9080);
			anInt9077 = anInt9076;
		}
		if (i_2_ != -12093)
			method39(46);
	...
	public final Buffer method40(int i, boolean bool) {
		if (null == anIDirect3DVertexBuffer9080)
			return null;
		bool &= aBoolean9078;
		if (!aBoolean9082 && lh.a((byte) 108, anIDirect3DVertexBuffer9080.Lock(0, anInt9077, !bool ? 0 : 8192,
				aD3DToolkit9081.aGeometryBuffer9184))) {
			aBoolean9082 = true;
	...
	public final int method793(int i) {
		if (i != -11856)
			return -40;
		return aByte9079;
	}
