...
public class Class86 {
	public static IncomingPacket SEND_INTERFACE_COMPONENT_SETTINGS = new IncomingPacket(3, 12);
	...
	public static void method1001(int i) {
		if (i != 32)
			SEND_INTERFACE_COMPONENT_SETTINGS = null;
		SEND_INTERFACE_COMPONENT_SETTINGS = null;
	}
	...
	Class86(Class353 class353, int i, boolean bool, Class36 class36, Index class302, Index class302_17_,
			Index index37) {
		OPTION = i;
		...
		if (aClass353_1164 != Node_Sub38_Sub34.aClass353_10443)
			aStringArray1184 = new String[] { null, null, GlobalMessage.aClass22_371.getMessage(OPTION), null, null, null };
		else
			aStringArray1184 = new String[] { null, null, GlobalMessage.aClass22_371.getMessage(OPTION), null, null,
					GlobalMessage.aClass22_385.getMessage(OPTION) };
		aStringArray1183 = new String[] { null, null, null, null, GlobalMessage.aClass22_372.getMessage(OPTION) };
	}

	public final void method1000(byte b) {
		anInt1177++;
	...
	public final GLSprite method1002(int i, GraphicsToolkit graphicstoolkit, GraphicsToolkit graphicstoolkit_0_,
			PlayerDefinition playerdefinition, boolean bool, int i_1_, int i_2_, boolean bool_3_, int i_4_,
			AbstractFont class52, int i_5_, int i_6_) {
		if (i_6_ != -16139)
			aClass61_1176 = null;
		anInt1166++;
		...
		if (i_2_ > 1 && itemdefinition.anIntArray1918 != null) {
			...
			for (int i_8_ = 0; i_8_ < 10; i_8_++)
				if ((itemdefinition.anIntArray1872[i_8_] ^ 0xffffffff) >= (i_2_ ^ 0xffffffff)
						&& itemdefinition.anIntArray1872[i_8_] != 0)
					i_7_ = itemdefinition.anIntArray1918[i_8_];
			if (i_7_ != -1)
				itemdefinition = method1010(i_7_, 14434);
		}
		int[] is = itemdefinition.method1682(i_4_, graphicstoolkit_0_, i_2_, (byte) 40, i_1_, bool_3_, playerdefinition,
				graphicstoolkit, class52, i);
		if (is == null)
			return null;
	...
	public final void method1003(int i, int i_10_) {
		if (i != 250)
			aClass12_1179 = null;
		anInt1169++;
		synchronized (aClass61_1174) {
	...
	public final void method1004(byte b) {
		anInt1160++;
		synchronized (aClass61_1174) {
	...
	public final void method1005(int i, int i_11_) {
		anInt1181 = i;
		anInt1178++;
		if (i_11_ > -20)
			method1004((byte) -108);
	...
	public final void method1006(int i) {
		synchronized (aClass61_1176) {
			if (i != -1)
				aClass61_1174 = null;
			aClass61_1176.method608(false);
	...
	public final GLSprite method1007(PlayerDefinition playerdefinition, byte b, GraphicsToolkit graphicstoolkit, int i,
	...
	public final void method1008(int i) {
		anInt1170++;
		synchronized (aClass12_1179) {
			aClass12_1179.method196(false);
		}
	...
	public final void method1009(byte b, boolean bool) {
		anInt1167++;
	...
	public final ItemDefinitions method1010(int i, int i_16_) {
		if (i_16_ != 14434)
			method1006(-81);
		anInt1171++;
		ItemDefinitions itemdefinition;
		synchronized (aClass61_1174) {
			itemdefinition = (ItemDefinitions) aClass61_1174.method607(i, i_16_ + -14434);
		}
		...
		if (itemdefinition.anInt1857 != -1)
			itemdefinition.method1677(method1010(itemdefinition.anInt1857, 14434), 45,
					method1010(itemdefinition.anInt1887, 14434));
		if ((itemdefinition.anInt1852 ^ 0xffffffff) != 0)
			itemdefinition.method1676((byte) 103, method1010(itemdefinition.anInt1927, 14434),
					method1010(itemdefinition.anInt1852, 14434));
		if ((itemdefinition.anInt1928 ^ 0xffffffff) != 0)
			itemdefinition.method1693(method1010(itemdefinition.anInt1928, i_16_), (byte) -121,
					method1010(itemdefinition.anInt1891, i_16_));
		if (!aBoolean1162 && itemdefinition.aBoolean1871) {
			itemdefinition.aString1860 = GlobalMessage.aClass22_368.getMessage(OPTION);
			...
			if (itemdefinition.aHashTable1873 != null) {
				boolean bool = false;
				for (Node node = itemdefinition.aHashTable1873
						.method1516(false); node != null; node = itemdefinition.aHashTable1873.method1520(85)) {
		...
		synchronized (aClass61_1174) {
			aClass61_1174.method601(itemdefinition, 25566, i);
		}
		return itemdefinition;
	}
}
