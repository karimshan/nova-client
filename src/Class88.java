...
public class Class88 implements Interface12 {
	public static GraphicsToolkit aGraphicsToolkit5280;
	public static int anInt5275;
	public static int anInt5276;
	public static int anInt5278;
	public static int anInt5279;
	public static Object anObject5281;
	public static String aString5274 = null;

	public static final void method1016(int i) {
	...
	public static final void method1018(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
		if (i_3_ > -90)
			anObject5281 = null;
		anInt5275++;
		int i_4_ = 0;
		...
		while ((i_4_ ^ 0xffffffff) > (i_5_ ^ 0xffffffff)) {
			...
			if (i_6_ > 0) {
				...
				if ((i_11_ ^ 0xffffffff) <= (Class384.anInt4906 ^ 0xffffffff) && i_10_ <= Node_Sub25_Sub1.anInt9936) {
					int i_12_ = Node_Sub38_Sub32.method2894(Class262_Sub4.anInt7722, za_Sub2.anInt10513, 929798380,
							i_2_ - -i_4_);
			...
			int i_14_ = -++i_4_ + i;
			int i_15_ = i_4_ + i;
			if ((Class384.anInt4906 ^ 0xffffffff) >= (i_15_ ^ 0xffffffff)
					&& (i_14_ ^ 0xffffffff) >= (Node_Sub25_Sub1.anInt9936 ^ 0xffffffff)) {
				int i_16_ = Node_Sub38_Sub32.method2894(Class262_Sub4.anInt7722, za_Sub2.anInt10513, 929798380,
						i_2_ + i_5_);
				int i_17_ = Node_Sub38_Sub32.method2894(Class262_Sub4.anInt7722, za_Sub2.anInt10513, 929798380,
						i_2_ + -i_5_);
