...
public class Class90 {
	...
	public static final int method1023(byte[] bs, int i, byte[] bs_0_, int i_1_, int i_2_) {
	...
	private static final void method1024(Class231 class231) {
		...
		while (bool_22_) {
			...
			for (int i_40_ = 0; i_40_ < i_29_; i_40_++) {
				...
				method1025(class231.anIntArrayArray2754[i_40_], class231.anIntArrayArray2762[i_40_],
						class231.anIntArrayArray2768[i_40_], class231.aByteArrayArray2748[i_40_], i_41_, b_42_, i_28_);
			...
			while (i_56_ != i_44_)
				if (i_56_ == 0 || i_56_ == 1) {
					...
					if (i_60_ < 16) {
						...
						for (/**/; i_63_ > 0; i_63_--) {
							class231.anIntArray2746[i_63_]--;
							class231.aByteArray2758[class231.anIntArray2746[i_63_]] = class231.aByteArray2758[class231.anIntArray2746[i_63_
									- 1] + 16 - 1];
						}
						...
						if (class231.anIntArray2746[0] == 0) {
							...
							for (int i_67_ = 15; i_67_ >= 0; i_67_--) {
								for (int i_68_ = 15; i_68_ >= 0; i_68_--) {
									class231.aByteArray2758[i_66_] = class231.aByteArray2758[class231.anIntArray2746[i_67_]
											+ i_68_];
									i_66_--;
								}
