...
public class Class95 {
	...
	public static final void method1066(int i) {
		anInt1255++;
		if (Class61.anInt898 != -1 && Node_Sub38_Sub7.anInt10153 != -1) {
			if (Class61.anInt898 == 1 || Class61.anInt898 == 3
					|| (Class61.anInt898 ^ 0xffffffff) != (Node_Sub38_Sub7.anInt10153 ^ 0xffffffff)
							&& (Class61.anInt898 == 0 || (Node_Sub38_Sub7.anInt10153 ^ 0xffffffff) == -1)) {
	...
	public static final void method1067(int i, int i_1_, byte b, int i_2_, int i_3_, int i_4_, int i_5_) {
		anInt1257++;
		if ((Class213.aNode_Sub27_2512.aClass320_Sub25_7295.method3776(false) ^ 0xffffffff) != -1
				&& (i_3_ ^ 0xffffffff) != -1 && Class23.anInt434 < 50 && (i_2_ ^ 0xffffffff) != 0)
			Node_Sub38_Sub19.aClass78Array10284[Class23.anInt434++] = new Class78((byte) 1, i_2_, i_3_, i_1_, i, i_5_,
					i_4_, null);
		if (b < 3)
			method1066(-88);
	}
	...
	public final void method1069(byte b, BufferedStream buffer) {
		for (;;) {
