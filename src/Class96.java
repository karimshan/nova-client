...
public class Class96 {
	...
	public static Class170 aClass170_1273 = new Class170(4, 1);
	public static IncomingPacket aClass192_1269 = new IncomingPacket(41, 7);
	public static Class61 aClass61_1272 = new Class61(10);
	public static Applet mainGameApplet;
	...
	public static int[] anIntArray1271 = new int[1];
	...
	public static final int method1075(int i, int i_7_) {
		anInt1262++;
		double d = (i_7_ >> 16 & 0xff) / 256.0;
		double d_8_ = ((0xfff2 & i_7_) >> 8) / 256.0;
		double d_9_ = (0xff & i_7_) / 256.0;
		double d_10_ = d;
		if (d_10_ > d_8_)
			d_10_ = d_8_;
		if (d_10_ > d_9_)
	...
	private final Node_Sub45_Sub1 method1071(int i, int i_0_, int i_1_, int[] is) {
		...
		i_2_ |= i_0_ << 16;
		long l = i_2_;
		Node_Sub45_Sub1 node_sub45_sub1 = (Node_Sub45_Sub1) aHashTable1268.getNode(3512, l);
	...
	private final Node_Sub45_Sub1 method1072(int[] is, int i, int i_3_, byte b) {
		...
		i_4_ |= i << 16;
		long l = i_4_ ^ 0x100000000L;
		Node_Sub45_Sub1 node_sub45_sub1 = (Node_Sub45_Sub1) aHashTable1268.getNode(3512, l);
		if (node_sub45_sub1 != null)
			return node_sub45_sub1;
		if (is != null && (is[0] ^ 0xffffffff) >= -1)
			return null;
		Node_Sub49 node_sub49 = (Node_Sub49) aHashTable1261.getNode(3512, l);
		if (node_sub49 == null) {
	...
	public final Node_Sub45_Sub1 method1073(boolean bool, int[] is, int i) {
		anInt1265++;
	...
	public final Node_Sub45_Sub1 method1074(int[] is, byte b, int i) {
		anInt1267++;
