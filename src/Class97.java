...
public class Class97 {
	public static Class103 aClass103_1277 = new Class103();
	...
	public static final void decodeLswp(Packet packet) {
		packet.initBitAccess();
		int myPlayerIndex = Class166.myPlayerIndex;
		Player myPlayer = Player.get = Client.LOCAL_PLAYERS[myPlayerIndex] = new Player();
		...
		// //System.out.println("coords: "+myPlayerX+", "+myPlayerY+",
		// "+myPlayerPlane);
	...
	public static final GLSprite method1077(int i, byte[] bs) {
		if (i > -123)
			aClass103_1277 = null;
		anInt1276++;
		if (bs == null)
		...
		for (;;)
			try {
				...
				return Class93.graphicsToolkit.method1235(i_9_, i_9_, i_10_, is, 0, 7468);
	...
	public static final void method1079(byte b, int i, int i_11_, boolean bool, int i_12_, boolean bool_13_, int i_14_) {
		if ((i ^ 0xffffffff) < (i_11_ ^ 0xffffffff)) {
			...
			for (int i_17_ = i_11_; i_17_ < i; i_17_++)
				if (Node_Sub38_Sub29.method2889(class377_sub1, i_12_, i_14_, bool_13_, 70,
						Class180.aClass377_Sub1Array2143[i_17_], bool) <= 0) {
	...
	public static final void method1080(int i, byte b, int i_19_, int i_20_, int i_21_, int i_22_, int i_23_) {
		anInt1278++;
		if (b >= 62)
			if ((Class262_Sub4.anInt7722 ^ 0xffffffff) >= (i_23_ ^ 0xffffffff) && za_Sub2.anInt10513 >= i_21_
					&& Class384.anInt4906 <= i_22_ && Node_Sub25_Sub1.anInt9936 >= i) {
				if (i_20_ == 1)
