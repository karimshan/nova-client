...
public class Class98 implements Interface7 {
	...
	public static final void method1081(int i, byte b) {
		if (b != -68)
			anInt5061 = 113;
		anInt5070++;
	...
	public static final void method1082(byte b, int i) {
	...
	public static final void method1083(int i, int i_3_) {
	...
	Class98(String string, Class379 class379, Class77 class77, int i, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_,
