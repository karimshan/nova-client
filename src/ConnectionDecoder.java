...
public class ConnectionDecoder extends GameStub implements ActionListener {
	...
	static IncomingPacket aClass192_5485 = new IncomingPacket(28, 4);
	...
	static final void method104() {
		...
		for (int i_1_ = 0; i_1_ < i_0_; i_1_++) {
			...
			if (aa.anInt101 == 3) {
				...
				if (i_1_ < i) {
					actor = Client.LOCAL_PLAYERS[is[i_1_]];
				} else {
					actor = ((Node_Sub41) Class12.aHashTable187.getNode(3512, (long) Class54.LocalNPCsIndexes[i_1_ - i])).aNpc7518;
				}
	...
	static final void method106(int i) {
		...
		for (int i_5_ = 0; i_5_ < i_4_; i_5_++) {
			...
			if (aa.anInt101 == 3) {
				...
				if (i_5_ < i_3_) {
					actor = Client.LOCAL_PLAYERS[is[i_5_]];
				} else {
					actor = ((Node_Sub41) Class12.aHashTable187.getNode(3512, (long) Class54.LocalNPCsIndexes[i_5_ - i_3_])).aNpc7518;
				}
				if (actor.plane != i) {
					continue;
				}
	...
	/*public static final void main(String[] strings) {
		...
		try {
			...
			ConnectionDecoder var_client = new ConnectionDecoder();
	...
	final synchronized void method93(int i) {
		anInt5470++;
		if (Class96.mainGameApplet != null && Node_Sub38_Sub20.aCanvas10309 == null && !Class240.aSignLink2946.aBoolean3985) {
			try {
				Class<? extends Applet> var_class = Class96.mainGameApplet.getClass();
				Field field = var_class.getDeclaredField("canvas");
				Node_Sub38_Sub20.aCanvas10309 = (java.awt.Canvas) field.get(Class96.mainGameApplet);
				field.set(Class96.mainGameApplet, null);
	...
	static final void method107() {
		...
		for (int i_18_ = 0; i_18_ < i; i_18_++) {
			Player player = Client.LOCAL_PLAYERS[is[i_18_]];
		...
		for (int i_20_ = 0; i_20_ < Node_Sub25_Sub3.localNPCsCount; i_20_++) {
			NPC npc = ((Node_Sub41) Class12.aHashTable187.getNode(3512, (long) Class54.LocalNPCsIndexes[i_20_])).aNpc7518;
			if (!npc.method873((byte) 66) || !npc.defs.method3010((byte) 96, Class24.aClass275_442)) {
				npc.anInt10857 = -1;
			} else {
				npc.method845(-94);
				if (npc.aShort9119 < 0 || npc.aShort9120 < 0 || npc.aShort9130 >= Node_Sub54.GAME_SCENE_WDITH || npc.aShort9124 >= Class377_Sub1.GAME_SCENE_HEIGHT) {
					...
					if (npc.defs.aBoolean2824) {
						i_21_ += 1024;
					} else if (!npc.defs.aBoolean2825) {
						i_21_ += 256;
					}
		...
		for (int i_22_ = 0; i_22_ < Class320_Sub24.cachedHintIcons.length; i_22_++) {
			...
			if (class223 != null) {
				if (class223.anInt2654 == 1) {
					Node_Sub41 node_sub41 = (Node_Sub41) Class12.aHashTable187.getNode(3512, (long) class223.anInt2658);
					if (node_sub41 != null) {
					...
					Player player = Client.LOCAL_PLAYERS[class223.anInt2658];
					if (player != null && player != Player.get && player.anInt10857 >= 0) {
	...
	public void startWheel() {
		...
		ZOOM_IN = new JButton();
		ZOOM_IN.setIcon(new ImageIcon(loader.getClass().getResource("/resources/zoomin.png")));
		ZOOM_IN.setBorderPainted(false);
		ZOOM_IN.setContentAreaFilled(false);
		
		ZOOM_OUT = new JButton();
		ZOOM_OUT.setIcon(new ImageIcon(loader.getClass().getResource("/resources/zoomout.png")));
		ZOOM_OUT.setBorderPainted(false);
		ZOOM_OUT.setContentAreaFilled(false);
	}
	...
	private final void method110(int i) {
		...
		if ((Class151.anInt1843 == 3 || Class151.anInt1843 == 9 || Class151.anInt1843 == 7) && (!Class132.method1561(-1) || (Class151.anInt1843 ^ 0xffffffff) == -10 && (Class339_Sub2.anInt8653 ^ 0xffffffff) == -43) && MiniMapDots.anInt124 == 0) {
		...
		for (EntityNode_Sub3_Sub1 entitynode_sub3_sub1 = (EntityNode_Sub3_Sub1) Class97.aClass103_1277.method1113((byte) 120); entitynode_sub3_sub1 != null; entitynode_sub3_sub1 = (EntityNode_Sub3_Sub1) Class97.aClass103_1277.method1108(104)) {
			if (((long) entitynode_sub3_sub1.anInt9162 ^ 0xffffffffffffffffL) > (Class313.method3650(false) / 1000L + -5L ^ 0xffffffffffffffffL)) {
				if ((entitynode_sub3_sub1.aShort9164 ^ 0xffffffff) < -1) {
					Class28.method331(entitynode_sub3_sub1.aString9156 + GlobalMessage.aClass22_382.getMessage(Class35.language), "", 123, 0, "", "", 5);
				}
				if (entitynode_sub3_sub1.aShort9164 == 0) {
					Class28.method331(entitynode_sub3_sub1.aString9156 + GlobalMessage.aClass22_383.getMessage(Class35.language), "", i + 101, 0, "", "", 5);
				}
			...
			if ((Class151.anInt1843 ^ 0xffffffff) == -8 && !Class132.method1561(-1) || (Class151.anInt1843 ^ 0xffffffff) == -10 && Class339_Sub2.anInt8653 == 42) {
				...
				if (Class218.aClass123_2560 != null) {
					...
					if ((Class218.aClass123_2560.anInt1579 ^ 0xffffffff) < -51) {
						Class365.anInt4524++;
						Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, Class224.OUTCOMMING_PACKET_16, Class218.aClass123_2560.isaacCipher);
	...
	final void method89(byte b) {
		...
		GlobalMessage.method299(false);
		KeyStrokes.method3451(1);
		Class93.method1042((byte) 48);
		Class102.method1096(15);
		MiniMap.method267((byte) -21);
		...
		IncomingPacketHolder.method1509(117);
		...
		AbstractFont.method532((byte) -72);
		...
		LoadingBarStage.method1134(97);
		Class286.method3394((byte) 49);
		Class274.method3324((byte) -127);
		LoadingBar.method1733(true);
		...
		KeyStrokeHandler.method3457(112);
		MouseHandler.method1063(true);
		...
		PlayerMasks.method1034((byte) -57);
		...
		ToolTips.method3473(-2594);
		Class246.method3074(-87);
		Class74.method757();
		Class350.method4000(-13);
		DeveloperConsole.method2933(-3239);
		...
		ClientBackground.method1974(16845);
	...
	static final InterfaceSettings method113(IComponentDefinitions widget) {
		InterfaceSettings node_sub35 = (InterfaceSettings) Class156.aHashTable1964.getNode(3512, ((long) widget.ihash << 32) + (long) widget.anInt4687);
		if (node_sub35 != null) {
			return node_sub35;
		}
	...
	static final void method114(byte b, CacheNode_Sub13 cachenode_sub13) {
		...
		if (cachenode_sub13 != null) {
			...
			if (cachenode_sub13.aBoolean9567 || "".equals(cachenode_sub13.aString9558)) {
				...
				for (cachenode_sub4 = (CacheNode_Sub4) Class261.aHashTable3306.getNode(3512, l); cachenode_sub4 != null; cachenode_sub4 = (CacheNode_Sub4) Class261.aHashTable3306.method1524((byte) 84)) {
		...
		for (/**/; (i_43_ ^ 0xffffffff) > (widgets.length ^ 0xffffffff); i_43_++) {
			...
			if (widget != null) {
				if (widget.type == 0) {
					...
					Node_Sub2 node_sub2 = (Node_Sub2) Class289.aHashTable3630.getNode(3512, (long) widget.ihash);
					if (node_sub2 != null) {
	...
	static final void method116() {
		...
		for (int i = 0; i < Node_Sub25_Sub3.localNPCsCount; i++) {
			NPC npc = ((Node_Sub41) Class12.aHashTable187.getNode(3512, (long) Class54.LocalNPCsIndexes[i])).aNpc7518;
			...
			try {
				...
				if ((Class151.anInt1843 ^ 0xffffffff) != -17) {
					...
					if (Class253.method3105(Class151.anInt1843, (byte) -25)) {
						...
						} else if (!Class93.graphicsToolkit.B() && Class169_Sub4.aBoolean8829) {
					...
					if (DrawableModel.aFrame907 == null) {
						...
						if ((Class36.anInt542 ^ 0xffffffff) != (i ^ 0xffffffff) || (i_50_ ^ 0xffffffff) != (CacheNode_Sub3.anInt9441 ^ 0xffffffff) || Class152.aBoolean1942) {
							if (Class93.graphicsToolkit != null && !Class93.graphicsToolkit.b()) {
								Class36.anInt542 = i;
					...
					if (Class93.graphicsToolkit != null && Class93.graphicsToolkit.B() || (Class188_Sub2_Sub1.getDisplayMode(3) ^ 0xffffffff) != -2) {
						Class320_Sub21.method3764(-102);
					}
					if (RuntimeException_Sub1.method4207(Class151.anInt1843, 19154)) {
						ClientBackground.method1976(bool_51_, 5);
						...
						if ((Class151.anInt1843 ^ 0xffffffff) != -12) {
							if (Class151.anInt1843 == 14) {
								Class169_Sub3.method1779(Class93.graphicsToolkit, GlobalMessage.aClass22_377.getMessage(Class35.language) + "<br>" + GlobalMessage.aClass22_378.getMessage(Class35.language), false, Class169_Sub3.aClass357_8820, StandardSprite.aClass52_8945, -16777216);
							} else if ((Class151.anInt1843 ^ 0xffffffff) == -16) {
								Class169_Sub3.method1779(Class93.graphicsToolkit, GlobalMessage.aClass22_394.getMessage(Class35.language), false, Class169_Sub3.aClass357_8820, StandardSprite.aClass52_8945, -16777216);
							}
						} else {
						...
						if ((Class118.anInt5407 ^ 0xffffffff) != -3) {
							Class169_Sub3.method1779(Class93.graphicsToolkit, GlobalMessage.LOADING_PLEASE_WAIT.getMessage(Class35.language), true, Class169_Sub3.aClass357_8820, StandardSprite.aClass52_8945, -16777216);
						} else {
							...
							Class169_Sub3.method1779(Class93.graphicsToolkit, GlobalMessage.LOADING_PLEASE_WAIT.getMessage(Class35.language) + "<br>(" + i + "%)", true, Class169_Sub3.aClass357_8820, StandardSprite.aClass52_8945, -16777216);
						}
					} else {
						...
						for (int i = 0; (i ^ 0xffffffff) > (Node_Sub11.anInt7105 ^ 0xffffffff); i++) {
							...
							if (!Class190.aBooleanArray2326[i]) {
								if (!Class320_Sub21.aBooleanArray8403[i]) {
									Class93.graphicsToolkit.method1234(rectangle.y, -16711936, rectangle.width, rectangle.height, (byte) -69, rectangle.x);
								} else {
									Class93.graphicsToolkit.method1234(rectangle.y, -65536, rectangle.width, rectangle.height, (byte) -57, rectangle.x);
								}
							} else {
								Class93.graphicsToolkit.method1234(rectangle.y, -65281, rectangle.width, rectangle.height, (byte) 108, rectangle.x);
							}
						}
					}
					if (DeveloperConsole.hasOpenedDevConsole())
						DeveloperConsole.displayConsoleSprites(Class93.graphicsToolkit, -49);
					if (Class240.aSignLink2946.aBoolean3985 && Class253.method3105(Class151.anInt1843, (byte) 80) && Class12.anInt193 == 0 && (Class188_Sub2_Sub1.getDisplayMode(3) ^ 0xffffffff) == -2 && !bool_51_) {
						...
						try {
							if (Class71.aBoolean967) {
								...
								Class93.graphicsToolkit.method1246(i, (byte) -120, Class134_Sub4.aRectangleArray9048);
							}
						...
						try {
							...
							ClanChat.method507(exception_sub1, exception_sub1.getMessage() + " (Recovered) " + sendDebugInformation(10), -122);
				...
				throw Commands.method1537(runtimeexception, "client.EA(" + b + ')');
			}
			break;
		} while (false);
	}
			...
			try {
				...
				if (Class213.aNode_Sub27_2512.aClass320_Sub29_7270.method3791(false) != 2) {
					...
					try {
						...
						ClanChat.method507(throwable, throwable.getMessage() + " (Recovered) " + sendDebugInformation(10), i ^ 0x5b88);
				...
				throw Commands.method1537(runtimeexception, "client.P(" + i + ')');
			}
			break;
		} while (false);
	}
	...
	private final void method120(int i) {
		...
		if ((Class151.anInt1843 ^ 0xffffffff) != -17) {
			...
			Class175.keyStrokes.method3452((byte) 45);
			Class106.aClass93_1356.method1038((byte) 26);
			if (Class93.graphicsToolkit != null) {
				Class93.graphicsToolkit.e((int) Class313.method3650(false));
			}
			Class378.method4134((byte) 94);
			Class357.anInt4429 = 0;
			Class320_Sub8.anInt8281 = 0;
			for (Interface21 interface21 = Class175.keyStrokes.method3449(-22959); interface21 != null; interface21 = Class175.keyStrokes.method3449(-22959)) {
				...
				if ((i_53_ ^ 0xffffffff) == -3 || (i_53_ ^ 0xffffffff) == -4) {
					...
					} else if (!DeveloperConsole.hasOpenedDevConsole() && Player.rights >= 2)
						DeveloperConsole.openDevConsole();
					else
						DeveloperConsole.closeDevConsole();
			...
			if (!Class26.method311(Class151.anInt1843, -5) || Class315.method3655(Class151.anInt1843, 128)) {
				if (Class329.method3833((byte) -61, Class151.anInt1843) && !Class315.method3655(Class151.anInt1843, 128)) {
					method110(0);
					Login.login((byte) 119);
				} else if ((Class151.anInt1843 ^ 0xffffffff) == -14) {
					Login.login((byte) 101);
				...
				Login.login((byte) 104);
			}
			Class201.method2023(Class93.graphicsToolkit, -22880);
			if (i > 49) {
	...
	final void method99(int i) {
		...
		Class175.keyStrokes = Class361.setKeyStrokeHandler(2, Node_Sub38_Sub20.aCanvas10309);
		...
		EntityNode_Sub6.loadingBarStageString = GlobalMessage.LOADING_PLEASE_WAIT.getMessage(Class35.language);
	}
				...
				if (widget.type != 0 && !widget.hasScripts && method113(widget).settingsHash == 0 && widget != Class186.aWidget2257 && widget.anInt4814 != Class264.anInt3355 && widget.anInt4814 != Class332.anInt4144 && widget.anInt4814 != Class200_Sub1.anInt5146 && widget.anInt4814 != Class107.anInt1366) {
					...
					if (widget.aBoolean4802 || i_71_ < i_73_ && i_72_ < i_74_) {
						...
						if (Class106.aClass93_1356.method1050((byte) -21) + i_77_ >= i_71_ && Class106.aClass93_1356.method1051(true) + i_78_ >= i_72_ && Class106.aClass93_1356.method1050((byte) -27) + i_77_ < i_73_ && Class106.aClass93_1356.method1051(true) + i_78_ < i_74_) {
							if (bool) {
								Class127 class127 = widget.method4145(Class93.graphicsToolkit, 1);
						...
						if (widget.aByteArray4806 != null && !DeveloperConsole.hasOpenedDevConsole()) {
							for (int i_88_ = 0; i_88_ < widget.aByteArray4806.length; i_88_++) {
								if (!Class175.keyStrokes.isKeyHeld(84, widget.aByteArray4806[i_88_])) {
									...
									if (b == 0 || ((b & 0x8) == 0 || !Class175.keyStrokes.isKeyHeld(110, 86) && !Class175.keyStrokes.isKeyHeld(-51, 82) && !Class175.keyStrokes.isKeyHeld(-72, 81)) && ((b & 0x2) == 0 || Class175.keyStrokes.isKeyHeld(-43, 86)) && ((b & 0x1) == 0 || Class175.keyStrokes.isKeyHeld(-79, 82)) && ((b & 0x4) == 0 || Class175.keyStrokes.isKeyHeld(121, 81))) {
										if (i_88_ < 10) {
							...
							if (widget.anInt4814 != 0) {
								if (widget.anInt4814 == Class200_Sub1.anInt5146 || widget.anInt4814 == Class107.anInt1366) {
									...
									if (Class245.aClass119_3085 != null) {
										Class245.aClass119_3085.method1225(Class213.aNode_Sub27_2512.aClass320_Sub2_7272.method3686(false), 51, widget.anInt4695, Class93.graphicsToolkit);
									}
									if (widget.anInt4814 == Class200_Sub1.anInt5146) {
										if (!Class213.aBoolean2510 && i_66_ >= i_71_ && i_67_ >= i_72_ && i_66_ < i_73_ && i_67_ < i_74_) {
											Class78.method776(i_65_, 0, i_64_, Class93.graphicsToolkit);
									...
									if (class127 != null && (Class262_Sub20.anInt7861 == 0 || Class262_Sub20.anInt7861 == 3) && !Class213.aBoolean2510 && i_66_ >= i_71_ && i_67_ >= i_72_ && i_66_ < i_73_ && i_67_ < i_74_) {
										...
										if (i_90_ >= i_92_ && i_90_ <= i_92_ + class127.anIntArray1635[i_91_]) {
											...
											if (Class320_Sub22.anInt8415 == 4) {
												...
												int i_100_ = (Player.get.getSize((byte) 83) - 1) * 256;
												i_98_ = (Player.get.anInt5934 - i_100_ >> 9) + (i_96_ >> 2);
												i_99_ = (Player.get.anInt5940 - i_100_ >> 9) - (i_97_ >> 2);
											}
											if (Class87.removeWalkHere && (Class200_Sub2.anInt4943 & 0x40) != 0) {
												...
												if (Class209.directory == Class169_Sub4.aClass353_8825) {
													Node_Sub32.method2731(false, -1, 1L, i_98_, i_99_, GlobalMessage.aClass22_390.getMessage(Class35.language), 11, true, -1, "", 0L, (byte) -18, true);
												}
								...
								if (widget.anInt4814 == Node_Sub38_Sub4.anInt10118) {
									...
									if (bool_84_) {
										...
										if (cachenode_sub11 != null) {
											...
											if (is != null) {
												if (Class175.keyStrokes.isKeyHeld(118, 82) && Player.rights > 0) {
													Class331.method3843(false, is[0], is[2], is[1]);
													System.out.println("Key held method here");
													continue;
												}
										...
										if (Class290_Sub6.anInt8116 > 0 && !aa.aBoolean104) {
											if ((Class121.anInt1521 == 1 || Node_Sub16.method2594(true)) && Class315.menuOptionCount > 2) {
						...
						if (widget.type == 5 && widget.anInt4848 != -1) {
							widget.method4157(-49253408, CacheNode_Sub6.aClass57_9480, Class171.aClass278_2062).method1225(Class213.aNode_Sub27_2512.aClass320_Sub2_7272.method3686(false), 83, widget.anInt4695, Class93.graphicsToolkit);
						}
						Class286.method3395(1, widget);
						if (widget.type == 0) {
							...
							Node_Sub2 node_sub2 = (Node_Sub2) Class289.aHashTable3630.getNode(3512, (long) widget.ihash);
							if (node_sub2 != null) {
								if (Class209.directory == Node_Sub38_Sub34.aClass353_10443 && node_sub2.cliped == 0 && !Class213.aBoolean2510 && bool_79_ && !Class54.aBoolean817) {
									Node_Sub7.method2421((byte) 98);
								}
	...
	public static int method44999() {
		return method3344;
	}
	public static int method3344 = 747272959;
	static final void method122(int i) {
		...
		for (int i_127_ = 0; i_127_ < i_126_; i_127_++) {
			...
			if (aa.anInt101 == 3) {
				...
				if (i_127_ < i_125_) {
					actor = Client.LOCAL_PLAYERS[is[i_127_]];
				} else {
					actor = ((Node_Sub41) Class12.aHashTable187.getNode(3512, (long) Class54.LocalNPCsIndexes[i_127_ - i_125_])).aNpc7518;
				}
	...
	@Override
	public final String sendDebugInformation(int i) {
		anInt5477++;
		String string = null;
		try {
			...
			if (Player.get != null) {
				string += "2)" + CacheNode_Sub20_Sub1.myPlayerPlane + "," + (Player.get.scenePositionXQueue[0] + Node_Sub53.gameSceneBaseX) + "," + (Class320_Sub4.gameSceneBaseY + Player.get.scenePositionYQueue[0]) + "|";
			}
	...
	public final void init() {
		try {
			...
			if (this.method95((byte) -45)) {
				...
				if (IncomingPacketHolder.aClass129_1564 != OutgoingPacket.aClass129_4051 && OutgoingPacket.aClass129_4051 != Node_Sub41.aClass129_7515 && ClientBackground.aClass129_6901 != OutgoingPacket.aClass129_4051) {
					OutgoingPacket.aClass129_4051 = ClientBackground.aClass129_6901;
				}
				try {
				...
				if (string_144_ == null || !string_144_.equals("1")) {
					LoadingBar.displayingAdvertisement = false;
				} else {
					LoadingBar.displayingAdvertisement = true;
				}
				String string_145_ = this.getParameter("game");
				if (string_145_ != null) {
					if (string_145_.equals("0")) {
						Class209.directory = Node_Sub38_Sub34.aClass353_10443;
					} else if (!string_145_.equals("1")) {
						if (!string_145_.equals("2")) {
							if (string_145_.equals("3")) {
								Class209.directory = Node_Sub25_Sub4.aClass353_10010;
							}
						} else {
							Class209.directory = Node_Sub38_Sub22.aClass353_10323;
						}
					} else {
						Class209.directory = Class169_Sub4.aClass353_8825;
					}
				}
				try {
				...
				Class191.aString2350 = Utils.QUIT_URL;
				...
				if (Node_Sub38_Sub34.aClass353_10443 != Class209.directory) {
					if (Class209.directory == Class169_Sub4.aClass353_8825) {
				...
				this.method92(-102, 667, Node_Sub38_Sub12.anInt10225, OutgoingPacket.aClass129_4051.method1554(false) + 32, Class209.directory.aString4341, Class150_Sub1.INDEXES_COUNT, Class257.anInt3244);
			}
		} catch(Exception e) {
			e.printStackTrace();
		}
		...
		try {
			...
			if (Class213.aNode_Sub27_2512.aClass320_Sub29_7270.method3791(false) == 2) {
				try {
					...
					ClanChat.method507(throwable, throwable.getMessage() + " (Recovered) " + sendDebugInformation(10), -118);
					Node_Sub12.aBoolean5456 = true;
					GlobalMessage.method300(0, true, false);
				}
			} else {
			...
			throw Commands.method1537(runtimeexception, "client.Q(" + i + ')');
		}
	}
