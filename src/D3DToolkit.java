...
public class D3DToolkit extends AbstractToolkit {
	...
	public static final GraphicsToolkit createToolkit(java.awt.Canvas canvas, d var_d, Index class302, Integer integer) {
		...
		try {
			...
			d3dtoolkit = new D3DToolkit(i, i_40_, canvas, var_ti, idirect3d, idirect3ddevice, class322,
					d3dpresent_parameters, d3dcaps, var_d, class302, integer.intValue());
	...
	private static final boolean method1387(D3DPRESENT_PARAMETERS d3dpresent_parameters, int i, IDirect3D idirect3d,
			int k, int l, int i1) {
		int j1;
		int k1;
		int l1;
		...
		try {
			...
			label0: for (; ~l <= -1; l--) {
				if (1 == l)
					continue;
				l1 = 0 - -l;
				label1: for (int i2 = 0; ~i2 > ~anIntArray9198.length; i2++) {
					if (-1 != ~idirect3d.CheckDeviceType(i, k, d3ddisplaymode.Format, anIntArray9198[i2], true)
							...
							|| -1 != ~l
									&& -1 != ~idirect3d.CheckDeviceMultiSampleType(i, k, anIntArray9198[i2], true, l1))
						continue;
					int j2 = 0;
					do {
						...
						if (idirect3d.CheckDeviceFormat(i, k, d3ddisplaymode.Format, 2, 1, anIntArray9192[j2]) == 0
								&& idirect3d.CheckDepthStencilMatch(i, k, d3ddisplaymode.Format, anIntArray9198[i2],
										anIntArray9192[j2]) == 0
								&& (0 == l || ~idirect3d.CheckDeviceMultiSampleType(i, k, anIntArray9192[i2], true,
										l1) == -1)) {
	...
	public static final int method1396(Class372 class372, Class68 class68, int i) {
		if (i > -23)
			return 83;
	...
	private D3DToolkit(int i, int i_12_, java.awt.Canvas canvas, ti var_ti, IDirect3D idirect3d,
			IDirect3DDevice idirect3ddevice, Class322 class322, D3DPRESENT_PARAMETERS d3dpresent_parameters,
			D3DCAPS d3dcaps, d var_d, Index class302, int i_13_) {
		...
		try {
			...
			aBoolean6342 = 0 < anInt6319 || -1 == (anIDirect3D9204.CheckDeviceMultiSampleType(anInt9194, anInt9182,
					aD3DPRESENT_PARAMETERS9178.BackBufferFormat, true, 2) ^ 0xffffffff);
	...
	@Override
	public final Class270 a(Class270 class270, Class270 class270_76_, float f, Class270 class270_77_) {
		if (f < 0.5F)
			return class270;
		return class270_76_;
	}
	...
	@Override
	public final void a(float f, float f_55_, float f_56_) {
		/* empty */
	}

	@Override
	public final Interface4 a(int i, int i_29_) {
		return null;
	}

	@Override
	public final void a(int i, int i_5_, int i_6_, int i_7_) {
		/* empty */
	}
	...
	@Override
	public final void a(Rectangle[] rectangles, int i, int i_68_, int i_69_) throws Exception_Sub1 {
		e(i_68_, i_69_);
	}
	...
	@Override
	public final void b(int i, int i_33_, int i_34_, int i_35_, double d) {
		/* empty */
	}
	...
	public final Renderer c() {
		...
		return new Renderer(d3dadapter_identifier.VendorID, "Direct3D", 9, d3dadapter_identifier.Description,
	...
	@Override
	public final Interface20 d(int i, int i_42_) {
		return null;
	}
	...
	@Override
	public final void e(int i, int i_61_) throws Exception_Sub1 {
	...
	@Override
	public final void F(int i, int i_49_) {
		/* empty */
	}
	...
	public final void method1273(int i) {
		...
		for (i_64_ = 0; anInt6358 > i_64_; i_64_++) {
			...
			aD3DLIGHT9193.SetPosition(node_sub29.method2705(32311), node_sub29.method2704(30),
					node_sub29.method2708(27433));
			aD3DLIGHT9193.SetDiffuse((0xff & i_66_ >> 16) * f, f * (0xff & i_66_ >> 8), f * (0xff & i_66_), 0.0F);
			aD3DLIGHT9193.SetAttenuation(0.0F, 0.0F, 1.0F / (node_sub29.method2711(123) * node_sub29.method2711(125)));
			aD3DLIGHT9193.SetRange(node_sub29.method2711(119));
	...
	@Override
	public final void method1276(int i, byte b, int i_72_, Interface15_Impl1 interface15_impl1, int i_73_, Class104 class104,
			int i_74_) {
	...
	@Override
	public final Interface13_Impl2 method1287(int i, int[][] is, boolean bool, int i_11_) {
		if (i_11_ != 0)
			aTi9201 = null;
	...
	@Override
	public final Interface13_Impl1 method1291(Class68 class68, Class372 class372, int i, int i_0_, int i_1_) {
	...
	public final boolean method1295(Class68 class68, Class372 class372, int i) {
		if (i != 1)
			return true;
		D3DDISPLAYMODE d3ddisplaymode = new D3DDISPLAYMODE();
		if (lh.a((byte) 98, anIDirect3D9204.a(anInt9194, d3ddisplaymode))
				&& lh.a((byte) 58, anIDirect3D9204.CheckDeviceFormat(anInt9194, anInt9182, d3ddisplaymode.Format, 0, 3,
						method1396(class372, class68, -29))))
			return true;
		return false;
	}
	...
	@Override
	public final void method1303(Class104 class104, int i, int i_62_, int i_63_) {
		if (i < 2)
			method1338(null, -36);
	...
	public final void method1310(byte b) {
		if (null == anIDirect3DVertexShader9197 && Class119.aClass346_1515 != aClass346Array6343[anInt6284]) {
			if (aClass346Array6343[anInt6284] != BufferedConnection.aClass346_615)
				anIDirect3DDevice9199.SetTransform(16 + anInt6284,
						aClass336_Sub1Array6327[anInt6284].method3884(true, aFloatArray9195));
			else
				anIDirect3DDevice9199.SetTransform(16 + anInt6284,
						aClass336_Sub1Array6327[anInt6284].method3874(5, aFloatArray9195));
	...
	@Override
	public final Class290 method1311(int i, int i_36_) {
		if (i != -22838)
			aBoolean9196 = false;
		int i_37_ = i_36_;
		while_25_: do {
	...
	@Override
	public final Interface13_Impl1 method1322(Class68 class68, boolean bool, int i, int i_30_, byte b, float[] fs, int i_31_,
			int i_32_) {
		if (b != 5)
			j();
		return null;
	...
	@Override
	public final Interface13_Impl1 method1327(Class68 class68, int i, boolean bool, int i_57_, int i_58_, int i_59_,
			boolean bool_60_, byte[] bs) {
		if (bool_60_ != true)
	...
	@Override
	public final void method1349(Class135 class135, byte b, boolean bool, boolean bool_78_, int i) {
		if (b != 19)
			method1351(null, 6);
		int i_79_ = i;
		int i_80_;
	...
	@Override
	public final void method1354(int i, int i_9_, Interface15_Impl2 interface15_impl2) {
		if (i_9_ == 32011) {
			Class80 class80 = (Class80) interface15_impl2;
			anIDirect3DDevice9199.SetStreamSource(i, class80.anIDirect3DVertexBuffer9080, 0,
					class80.method793(i_9_ ^ ~0x5344));
		}
	}
	...
	@Override
	public final Interface13_Impl1 method1367(int i, int i_50_, int[] is, int i_51_, int i_52_, boolean bool, int i_53_) {
		if (i != -6331)
			return null;
	...
	public final void method1374(byte b) {
		...
		aFloat6311 = -anInt6355 + aFloat6328;
		if (aFloat6311 < anInt6364)
	...
	public final boolean method1377(Class372 class372, Class68 class68, byte b) {
		...
		if (b != -72)
			aBooleanArray9189 = null;
		if (lh.a((byte) 75, anIDirect3D9204.a(anInt9194, d3ddisplaymode))
				&& lh.a((byte) 89, anIDirect3D9204.CheckDeviceFormat(anInt9194, anInt9182, d3ddisplaymode.Format, 0, 4,
						method1396(class372, class68, -54))))
			return true;
		return false;
	}
	...
	public final void method1384(byte b, IDirect3DVertexShader idirect3dvertexshader) {
		anIDirect3DVertexShader9197 = idirect3dvertexshader;
		anIDirect3DDevice9199.SetVertexShader(idirect3dvertexshader);
		method1310((byte) -113);
	}

	public final void method1386(int i, IDirect3DPixelShader idirect3dpixelshader) {
	...
	public final void method1392(int i, Class265_Sub3 class265_sub3) {
	...
	public final void method1394(Class265_Sub1 class265_sub1, int i) {
	...
	public final void method1395(Class265 class265, int i) {
		...
		if (class265.aClass228_3363 == aClass228Array9181[anInt6284]) {
			if (!class265.aBoolean3364 == aBooleanArray9180[anInt6284]) {
				anIDirect3DDevice9199.SetSamplerState(anInt6284, 7,
						!class265.aBoolean3364 ? 0 : method1388(97, class265.aClass228_3363));
			...
			if (!class265.aBoolean3364 == aBooleanArray9180[anInt6284]) {
				anIDirect3DDevice9199.SetSamplerState(anInt6284, 7,
						!class265.aBoolean3364 ? 0 : method1388(102, class265.aClass228_3363));
				aBooleanArray9180[anInt6284] = class265.aBoolean3364;
			}
		}
		if (i < 124)
	...
	@Override
	public final int[] na(int i, int i_43_, int i_44_, int i_45_) {
		int[] is = null;
		...
		if (lh.a((byte) 78,
				anIDirect3DDevice9199.StretchRect(idirect3dsurface, i, i_43_, i_44_, i_45_, idirect3dsurface_46_, 0, 0,
						i_44_, i_45_, 0))
				&& lh.a((byte) 65, idirect3dsurface_46_.LockRect(0, 0, i_44_, i_45_, 16, aPixelBuffer9187))) {
