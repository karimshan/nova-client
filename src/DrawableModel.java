...
public abstract class DrawableModel {
	...
	public static String[] aStringArray911 = new String[100];

	public static final void method616(int i, int i_33_, int i_34_, int i_35_, int i_36_, int i_37_, int i_38_, int i_39_,
			int i_40_, int i_41_) {
		anInt908++;
		if (i_34_ > -52)
			aStringArray911 = null;
		if (i >= Class262_Sub4.anInt7722 && i <= za_Sub2.anInt10513
				&& (Class262_Sub4.anInt7722 ^ 0xffffffff) >= (i_41_ ^ 0xffffffff) && za_Sub2.anInt10513 >= i_41_
				&& i_37_ >= Class262_Sub4.anInt7722 && (i_37_ ^ 0xffffffff) >= (za_Sub2.anInt10513 ^ 0xffffffff)
				&& Class262_Sub4.anInt7722 <= i_40_ && i_40_ <= za_Sub2.anInt10513
				&& (i_39_ ^ 0xffffffff) <= (Class384.anInt4906 ^ 0xffffffff) && i_39_ <= Node_Sub25_Sub1.anInt9936
				&& (i_33_ ^ 0xffffffff) <= (Class384.anInt4906 ^ 0xffffffff)
				&& (Node_Sub25_Sub1.anInt9936 ^ 0xffffffff) <= (i_33_ ^ 0xffffffff) && i_35_ >= Class384.anInt4906
				&& (i_35_ ^ 0xffffffff) >= (Node_Sub25_Sub1.anInt9936 ^ 0xffffffff)
				&& (i_38_ ^ 0xffffffff) <= (Class384.anInt4906 ^ 0xffffffff)
				&& (i_38_ ^ 0xffffffff) >= (Node_Sub25_Sub1.anInt9936 ^ 0xffffffff))
	...
	public static final void method638(int i, String[] strings, int[] is, int i_149_, int i_150_) {
		if (i != -20788)
			aFrame907 = null;
		if (i_150_ < i_149_) {
	...
	private final void method613(int i, int i_5_, int i_6_, int[] is, int[] is_7_, boolean bool, boolean bool_8_,
	...
	public final void method615(int i, int i_19_, CacheNode_Sub15 cachenode_sub15, int i_20_, int i_21_, int i_22_,
			CacheNode_Sub15 cachenode_sub15_23_, CacheNode_Sub15 cachenode_sub15_24_, int i_25_, boolean bool,
			int i_26_, CacheNode_Sub15 cachenode_sub15_27_, boolean[] bools, int i_28_, int i_29_) {
		anInt912++;
		if ((i_19_ ^ 0xffffffff) != 0)
			if (bools == null || (i_29_ ^ 0xffffffff) == 0)
				...
				if (!NA())
					...
					method635(class222_30_, bools, i_25_, false, (byte) 82, null, 0, i_28_, class222, node_sub40, 65535,
							bool);
					...
					method635(class222_32_, bools, i, true, (byte) 116, null, 0, i_26_, class222_31_,
							class222_31_.aNode_Sub40_2634, 65535, bool);
					wa();
					if (i_21_ >= -7)
						aBoolean913 = false;
					method632();
	...
	public final void method625(CacheNode_Sub15 cachenode_sub15, int i, int i_54_, CacheNode_Sub15 cachenode_sub15_55_,
			int i_56_, int i_57_, int i_58_, int i_59_, boolean bool) {
		anInt918++;
		if ((i_56_ ^ 0xffffffff) != 0) {
			...
			if (!NA())
				...
				method635(class222_60_, null, i, false, (byte) 121, null, i_58_, i_54_, class222, node_sub40, 65535,
						bool);
				if (i_59_ > -23)
					method620();
				wa();
	...
	public final void method628(int i, int i_66_, int i_67_, int i_68_, int i_69_, int i_70_, int i_71_, Plane plane,
			int i_72_) {
		anInt916++;
		if (i_68_ != -7024)
			aBoolean914 = true;
		...
		if (i_71_ != 0) {
			int i_91_ = 0x3fff & (int) (2607.5945876176133 * Math.atan2(i_87_ - i_88_, i_71_));
			if (i_91_ != 0) {
				if (i_66_ != 0)
					if (i_91_ > 8192) {
		...
		if (i_69_ != 0) {
			int i_94_ = (int) (2607.5945876176133 * Math.atan2(i_90_ - i_89_, i_69_)) & 0x3fff;
			if (i_94_ != 0) {
				if (i_72_ != 0)
					if (i_94_ > 8192) {
	...
	public final void method631(int i, int i_97_, CacheNode_Sub15 cachenode_sub15) {
		anInt915++;
		if ((i ^ 0xffffffff) != 0) {
			method629();
			if (!NA())
				...
				for (int i_99_ = 0; class222.anInt2642 > i_99_; i_99_++) {
					...
					if (node_sub40.aBooleanArray7502[s]) {
						if (class222.aShortArray2635[i_99_] != -1)
							P(0, 0, 0, 0);
						P(node_sub40.anIntArray7511[s], class222.aShortArray2648[i_99_],
								class222.aShortArray2649[i_99_], class222.aShortArray2643[i_99_]);
					}
				}
				wa();
				method632();
	...
	public final void method634(int i, CacheNode_Sub15 cachenode_sub15, CacheNode_Sub15 cachenode_sub15_100_, int i_101_,
			int i_102_, int[] is, byte b, int i_103_, boolean bool, int i_104_, int i_105_) {
		anInt909++;
		if (i_101_ != -1) {
			method629();
			if (!NA())
				...
				method635(class222_106_, null, i, false, (byte) 84, is, i_102_, i_103_, class222, node_sub40, i_105_,
						bool);
				wa();
				method632();
			}
	...
	private final void method635(Class222 class222, boolean[] bools, int i, boolean bool, byte b, int[] is, int i_107_,
			int i_108_, Class222 class222_109_, Node_Sub40 node_sub40, int i_110_, boolean bool_111_) {
		anInt910++;
		if (class222 == null || i == 0)
			for (int i_112_ = 0; (class222_109_.anInt2642 ^ 0xffffffff) < (i_112_ ^ 0xffffffff); i_112_++) {
				...
				if (bools == null || !bool != bools[s] || node_sub40.anIntArray7511[s] == 0) {
					...
					if ((s_113_ ^ 0xffffffff) != 0)
						method613(0, 0, i_110_ & node_sub40.anIntArray7510[s_113_],
								node_sub40.anIntArrayArray7499[s_113_], is, bool_111_, false, i_107_, 0, 0);
					method613(class222_109_.aShortArray2643[i_112_], node_sub40.anIntArray7511[s],
							i_110_ & node_sub40.anIntArray7510[s], node_sub40.anIntArrayArray7499[s], is, bool_111_,
							false, i_107_, class222_109_.aShortArray2648[i_112_],
			...
			if (b > 65)
				for (int i_116_ = 0; (node_sub40.anInt7503 ^ 0xffffffff) < (i_116_ ^ 0xffffffff); i_116_++) {
					...
					if ((class222_109_.anInt2642 ^ 0xffffffff) < (i_114_ ^ 0xffffffff)
							&& i_116_ == class222_109_.aShortArray2636[i_114_])
						bool_117_ = true;
					boolean bool_118_ = false;
					if (class222.anInt2642 > i_115_ && i_116_ == class222.aShortArray2636[i_115_])
						bool_118_ = true;
					if (bool_117_ || bool_118_)
						if (bools != null && !bools[i_116_] == bool
								&& (node_sub40.anIntArray7511[i_116_] ^ 0xffffffff) != -1) {
							if (bool_118_)
								i_115_++;
							if (bool_117_)
								i_114_++;
							...
							if ((s ^ 0xffffffff) == 0) {
								if ((s_128_ ^ 0xffffffff) != 0)
									method613(0, 0, i_110_ & node_sub40.anIntArray7510[s_128_],
											node_sub40.anIntArrayArray7499[s_128_], is, bool_111_, false, i_107_, 0, 0);
							} else
								method613(0, 0, i_110_ & node_sub40.anIntArray7510[s],
										node_sub40.anIntArrayArray7499[s], is, bool_111_, false, i_107_, 0, 0);
							int i_130_;
							int i_131_;
							int i_132_;
							...
							method613(i_132_, i_120_, node_sub40.anIntArray7510[i_116_] & i_110_,
									node_sub40.anIntArrayArray7499[i_116_], is, bool_111_, false, i_107_, i_131_,
									i_130_);
						}
				}
		}
