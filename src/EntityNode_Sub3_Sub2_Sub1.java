...
public class EntityNode_Sub3_Sub2_Sub1 extends EntityNode_Sub3_Sub2 {
	...
	EntityNode_Sub3_Sub2_Sub1(EntityNode_Sub7 entitynode_sub7, int i, int i_54_, int i_55_, int i_56_, int i_57_,
			int i_58_, int i_59_, int i_60_, int i_61_, int i_62_, int i_63_, boolean bool, boolean bool_64_) {
	...
	public final void method948(long l, int i) {
		aShort11026 -= i;
		if (aShort11026 <= 0)
			method951();
		else {
			...
			double d = aShort11021;
			double d_7_ = aShort11025;
			double d_8_ = aShort11024;
			boolean bool = false;
			if (class355.anInt4380 == 1) {
				...
				long l_13_ = class355.anInt4404 * i_12_ * i;
				anInt11028 -= anInt11028 * l_13_ >> 18;
				...
				long l_18_ = class355.anInt4404 * i_17_ * i;
				anInt11028 -= anInt11028 * l_18_ >> 28;
			}
			if (class355.anIntArray4362 != null) {
				...
				for (Node node_19_ = node.aNode2800; node_19_ != node; node_19_ = node_19_.aNode2800) {
					...
					if (class249.anInt3160 != 1) {
						...
						for (int element : class355.anIntArray4362)
							if (element == class249.anInt3158) {
								bool_20_ = true;
								break;
							}
						if (bool_20_) {
							double d_22_ = i_0_ - cachenode_sub5.anInt9475;
							double d_23_ = i_1_ - cachenode_sub5.anInt9471;
							double d_24_ = i_2_ - cachenode_sub5.anInt9468;
							double d_25_ = d_22_ * d_22_ + d_23_ * d_23_ + d_24_ * d_24_;
							if (!(d_25_ > class249.aLong3156)) {
								double d_26_ = Math.sqrt(d_25_);
								if (d_26_ == 0.0)
									d_26_ = 1.0;
								double d_27_ = (d_22_ * cachenode_sub5.anInt9472 + d_23_ * class249.anInt3166
										+ d_24_ * cachenode_sub5.anInt9470) * 65535.0 / (class249.anInt3164 * d_26_);
								if (!(d_27_ < class249.anInt3152)) {
									double d_28_ = 0.0;
									if (class249.anInt3163 == 1)
										d_28_ = d_26_ / 16.0 * class249.anInt3148;
									else if (class249.anInt3163 == 2)
										d_28_ = d_26_ / 16.0 * (d_26_ / 16.0) * class249.anInt3148;
									if (class249.anInt3162 == 0) {
										if (class249.anInt3155 == 0) {
											d += (cachenode_sub5.anInt9472 - d_28_) * i;
											d_7_ += (class249.anInt3166 - d_28_) * i;
											d_8_ += (cachenode_sub5.anInt9470 - d_28_) * i;
											bool = true;
										} else {
											anInt9174 += (cachenode_sub5.anInt9472 - d_28_) * i;
											anInt9171 += (class249.anInt3166 - d_28_) * i;
											anInt9173 += (cachenode_sub5.anInt9470 - d_28_) * i;
										}
									} else {
										double d_29_ = d_22_ / d_26_ * class249.anInt3164;
										double d_30_ = d_23_ / d_26_ * class249.anInt3164;
										double d_31_ = d_24_ / d_26_ * class249.anInt3164;
										if (class249.anInt3155 == 0) {
											d += d_29_ * i;
											d_7_ += d_30_ * i;
											d_8_ += d_31_ * i;
			...
			if (class355.anIntArray4371 != null)
				for (int element : class355.anIntArray4371) {
					CacheNode_Sub5 cachenode_sub5 = (CacheNode_Sub5) Node_Sub41.aClass114_7519.method1157(element, 1);
					while (cachenode_sub5 != null) {
						Class249 class249 = cachenode_sub5.aClass249_9473;
						double d_33_ = i_0_ - cachenode_sub5.anInt9475;
						double d_34_ = i_1_ - cachenode_sub5.anInt9471;
						double d_35_ = i_2_ - cachenode_sub5.anInt9468;
						double d_36_ = d_33_ * d_33_ + d_34_ * d_34_ + d_35_ * d_35_;
						if (d_36_ > class249.aLong3156)
							cachenode_sub5 = (CacheNode_Sub5) Node_Sub41.aClass114_7519.method1158(-1);
						else {
							double d_37_ = Math.sqrt(d_36_);
							if (d_37_ == 0.0)
								d_37_ = 1.0;
							double d_38_ = (d_33_ * cachenode_sub5.anInt9472 + d_34_ * class249.anInt3166
									+ d_35_ * cachenode_sub5.anInt9470) * 65535.0 / (class249.anInt3164 * d_37_);
							if (d_38_ < class249.anInt3152)
								cachenode_sub5 = (CacheNode_Sub5) Node_Sub41.aClass114_7519.method1158(-1);
							else {
								double d_39_ = 0.0;
								if (class249.anInt3163 == 1)
									d_39_ = d_37_ / 16.0 * class249.anInt3148;
								else if (class249.anInt3163 == 2)
									d_39_ = d_37_ / 16.0 * (d_37_ / 16.0) * class249.anInt3148;
								if (class249.anInt3162 == 0) {
									if (class249.anInt3155 == 0) {
										d += (cachenode_sub5.anInt9472 - d_39_) * i;
										d_7_ += (class249.anInt3166 - d_39_) * i;
										d_8_ += (cachenode_sub5.anInt9470 - d_39_) * i;
										bool = true;
									} else {
										anInt9174 += (cachenode_sub5.anInt9472 - d_39_) * i;
										anInt9171 += (class249.anInt3166 - d_39_) * i;
										anInt9173 += (cachenode_sub5.anInt9470 - d_39_) * i;
									}
								} else {
									double d_40_ = d_33_ / d_37_ * class249.anInt3164;
									double d_41_ = d_34_ / d_37_ * class249.anInt3164;
									double d_42_ = d_35_ / d_37_ * class249.anInt3164;
									if (class249.anInt3155 == 0) {
										d += d_40_ * i;
										d_7_ += d_41_ * i;
										d_8_ += d_42_ * i;
			...
			if (class355.anIntArray4414 != null) {
				if (class355.anIntArray4352 == null) {
					...
					for (int i_43_ = 0; i_43_ < class355.anIntArray4414.length; i_43_++) {
						...
						class355.anIntArray4352[i_43_] = ((Node_Sub32) Class269.aHashTable3465.getNode(3512,
								class355.anIntArray4414[i_43_])).anInt7381;
					}
				}
				for (int element : class355.anIntArray4352) {
					Class249 class249 = Class198.aClass249Array2428[element];
					if (class249.anInt3155 == 0) {
						d += class249.anInt3157 * i;
						d_7_ += class249.anInt3166 * i;
						d_8_ += class249.anInt3150 * i;
						bool = true;
					} else {
			...
			if (bool) {
				while (d > 32767.0 || d_7_ > 32767.0 || d_8_ > 32767.0 || d < -32767.0 || d_7_ < -32767.0
						|| d_8_ < -32767.0) {
					d /= 2.0;
					d_7_ /= 2.0;
					d_8_ /= 2.0;
			...
			anInt9174 += ((long) aShort11021 * (long) (anInt11028 << 2) >> 23) * i;
			anInt9171 += ((long) aShort11025 * (long) (anInt11028 << 2) >> 23) * i;
			anInt9173 += ((long) aShort11024 * (long) (anInt11028 << 2) >> 23) * i;
		}
	}

	public final void method949(GraphicsToolkit graphicstoolkit, long l) {
		int i = anInt9174 >> 12 + Class36.anInt549;
		int i_45_ = anInt9173 >> 12 + Class36.anInt549;
		int i_46_ = anInt9171 >> 12;
		if (i_46_ > 0 || i_46_ < -262144 || i < 0 || i >= Class328.anInt4115 || i_45_ < 0
				|| i_45_ >= GameMessage.anInt7623)
			method951();
		else {
			EntityNode_Sub4 entitynode_sub4 = anEntityNode_Sub7_11027.anEntityNode_Sub4_6009;
			Class355 class355 = anEntityNode_Sub7_11027.aClass355_6011;
			...
			if (class355.aBoolean4406) {
				...
				if (class355.anInt4374 >= 0
						&& i_46_ < planes[class355.anInt4374 + 1].method3251(i_45_, i, (byte) -118)) {
					method951();
					return;
				}
			}
			int i_50_;
			for (i_50_ = Class159.anInt1995 - 1; i_50_ > 0
					&& i_46_ > planes[i_50_].method3251(i_45_, i, (byte) -118); i_50_--) {
				/* empty */
			}
			if (class355.aBoolean4354 && i_50_ == 0 && i_46_ > planes[0].method3251(i_45_, i, (byte) -118))
				method951();
			else if (i_50_ == Class159.anInt1995 - 1
					&& planes[i_50_].method3251(i_45_, i, (byte) -118) - i_46_ > 8 << Class36.anInt549)
				method951();
			else {
	...
	public final void method950(EntityNode_Sub7 entitynode_sub7, int i, int i_65_, int i_66_, int i_67_, int i_68_, int i_69_,
			int i_70_, int i_71_, int i_72_, int i_73_, int i_74_, boolean bool, boolean bool_75_) {
		anEntityNode_Sub7_11027 = entitynode_sub7;
		anInt9174 = i << 12;
		anInt9171 = i_65_ << 12;
		anInt9173 = i_66_ << 12;
	...
	public final void method951() {
		...
		NPCMasks.anEntityNode_Sub3_Sub2_Sub1Array3596[Packet.anInt9386] = this;
