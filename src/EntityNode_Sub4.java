...
public class EntityNode_Sub4 extends EntityNode {
	...
	public static final EntityNode_Sub4 method963(int i, boolean bool) {
	...
	public final void method952(GraphicsToolkit graphicstoolkit, long l, Class300[] class300s, Class218[] class218s,
			boolean bool) {
		if (!aBoolean5972) {
	...
	public final Class198 method954() {
		return aClass198_5977;
	}

	public final void method955(GraphicsToolkit graphicstoolkit) {
		aClass198_5977.aClass87_2429.method1011(12077);
		for (EntityNode_Sub7 entitynode_sub7 = (EntityNode_Sub7) aClass103_5967.method1113(
				(byte) 112); entitynode_sub7 != null; entitynode_sub7 = (EntityNode_Sub7) aClass103_5967.method1108(82))
	...
	private final void method957(Class218[] class218s, boolean bool) {
		...
		while_138_: for (CacheNode_Sub5 cachenode_sub5 = (CacheNode_Sub5) aClass312_5976.method3613(
				65280); cachenode_sub5 != null; cachenode_sub5 = (CacheNode_Sub5) aClass312_5976.method3620(16776960)) {
			if (class218s != null)
				for (int i = 0; i < class218s.length; i++)
					if (cachenode_sub5.aClass218_9476 == class218s[i]
							|| cachenode_sub5.aClass218_9476 == class218s[i].aClass218_2561) {
			...
			for (int i = 0; i < class218s.length; i++) {
				...
				if (!aBooleanArray5966[i]) {
					...
					if (class218s[i].method2075((byte) -57).anInt3160 == 1 && Class51_Sub2.anInt9070 < 32) {
						...
						Node_Sub41.aClass114_7519.method1156((byte) 91, cachenode_sub5, class218s[i].anInt2555);
						Class51_Sub2.anInt9070++;
					}
	...
	public final void method958(long l) {
		aLong5973 = l;
	}

	public final Class198 method959() {
		aClass198_5977.aClass87_2429.method1011(12077);
		for (EntityNode_Sub3_Sub2_Sub1 element : anEntityNode_Sub3_Sub2_Sub1Array5970)
			if (element != null && element.anEntityNode_Sub7_11027 != null)
				aClass198_5977.aClass87_2429.method1012(127, element);
		return aClass198_5977;
	}
	...
	private final void method960(GraphicsToolkit graphicstoolkit, Class300[] class300s, boolean bool) {
		...
		while_140_: for (EntityNode_Sub7 entitynode_sub7 = (EntityNode_Sub7) aClass103_5967
				.method1113((byte) 125); entitynode_sub7 != null; entitynode_sub7 = (EntityNode_Sub7) aClass103_5967
						.method1108(117)) {
			if (class300s != null)
				for (int i = 0; i < class300s.length; i++)
					if (entitynode_sub7.aClass300_6003 == class300s[i]
							|| entitynode_sub7.aClass300_6003 == class300s[i].aClass300_3763) {
		...
		if (class300s != null)
			for (int i = 0; i < class300s.length; i++) {
				...
				if (!aBooleanArray5971[i]) {
					EntityNode_Sub7 entitynode_sub7 = new EntityNode_Sub7(graphicstoolkit, class300s[i], this,
							aLong5973);
	...
	public final void method961() {
		aBoolean5972 = true;
		for (CacheNode_Sub5 cachenode_sub5 = (CacheNode_Sub5) aClass312_5976.method3613(
				65280); cachenode_sub5 != null; cachenode_sub5 = (CacheNode_Sub5) aClass312_5976.method3620(16776960))
	...
	public final boolean method962(GraphicsToolkit graphicstoolkit, long l) {
		...
		if (aBoolean5980) {
			for (EntityNode_Sub7 entitynode_sub7 = (EntityNode_Sub7) aClass103_5967
					.method1113((byte) 112); entitynode_sub7 != null; entitynode_sub7 = (EntityNode_Sub7) aClass103_5967
							.method1108(127))
		...
		for (EntityNode_Sub7 entitynode_sub7 = (EntityNode_Sub7) aClass103_5967.method1113(
				(byte) 108); entitynode_sub7 != null; entitynode_sub7 = (EntityNode_Sub7) aClass103_5967.method1108(72))
	...
	public final void method967(int i, int i_1_, int i_2_, int i_3_, int i_4_) {
		anInt5979 = i;
	}
}
