...
public class EntityNode_Sub6 extends EntityNode {
	public static Class299 aClass299_5988;
	/* synthetic */static Class<?> aClass5996;
	public static int anInt5989;
	public static int anInt5992;
	public static int anInt5993;
	public static String loadingBarStageString = null;

	public static final boolean method969(GraphicsToolkit graphicstoolkit, int i, int i_0_) {
		anInt5989++;
		...
		if (i_0_ != 6400)
			return true;
		int i_8_ = 238 + (int) (Math.random() * 20.0) + (-10 + (-10 + (238 - -(int) (Math.random() * 20.0)) << 8)
				+ (-10 + ((int) (20.0 * Math.random()) + 238) << 16)) | ~0xffffff;
					...
					if (!Class320_Sub3.aBoolean8235)
						for (int i_22_ = -4; (Class111.anInt1415 ^ 0xffffffff) < (i_22_ ^ 0xffffffff); i_22_++)
							for (int i_23_ = -4; (i_23_ ^ 0xffffffff) > (Class111.anInt1415 ^ 0xffffffff); i_23_++) {
								...
								if ((i_1_ ^ 0xffffffff) >= (i_24_ ^ 0xffffffff) && i_25_ >= i_2_
										&& Class369.method4085(i_25_, i_0_ + -6400, i, i_24_, i_19_)) {
									int i_26_ = i_19_;
									if (Class238.method3021(i_25_, i_24_, -33))
										i_26_--;
									if (i_26_ >= 0)
										Class117_Sub1.method1170(graphicstoolkit, i_8_, i_24_, i_25_,
												i_13_ - -(i_22_ * 4), (-i_23_ + Class111.anInt1415) * 4 + i_14_ + -4,
												4827, i_26_, i_9_);
								}
							}
				}
					...
					for (int i_27_ = 0; (i_27_ ^ 0xffffffff) > (Class111.anInt1415 ^ 0xffffffff); i_27_++)
						for (int i_28_ = 0; (Class111.anInt1415 ^ 0xffffffff) < (i_28_ ^ 0xffffffff); i_28_++) {
							...
							if ((i_31_ & 0x40240000 ^ 0xffffffff) != -1)
								graphicstoolkit.method1239(4, 4, -4 + ((-i_28_ + Class111.anInt1415) * 4 + i_14_),
										(byte) 116, i_13_ + 4 * i_27_, -1713569622);
							else if ((i_31_ & 0x800000 ^ 0xffffffff) != -1)
								graphicstoolkit.method1242(-4 + (Class111.anInt1415 + -i_28_) * 4 + i_14_, -1713569622,
										i_13_ - -(i_27_ * 4), false, 4);
							else if ((0x2000000 & i_31_) != 0)
								graphicstoolkit.method1243(4, -4 + i_14_ + (-i_28_ + Class111.anInt1415) * 4,
										-1713569622, 3 + 4 * i_27_ + i_13_, i_0_ + -6398);
							else if ((0x8000000 & i_31_ ^ 0xffffffff) != -1)
								graphicstoolkit.method1242(3 + (-i_28_ + Class111.anInt1415) * 4 + (i_14_ + -4),
										-1713569622, 4 * i_27_ + i_13_, false, 4);
							else if ((i_31_ & 0x20000000) != 0)
								graphicstoolkit.method1243(4, -4 + (Class111.anInt1415 - i_28_) * 4 + i_14_,
										-1713569622, 4 * i_27_ + i_13_, 2);
						}
				}
				graphicstoolkit.aa(i_13_, i_14_, 4 * Class111.anInt1415, 4 * Class111.anInt1415, i_10_, 2);
				Class10.aGLSprite172.method1195(48 - -(4 * (i_11_ - i_1_)),
						-(4 * Class111.anInt1415) + (-((i_12_ + -i_2_) * 4) + 464), Class111.anInt1415 * 4,
						4 * Class111.anInt1415, i_13_, i_14_);
			}
		graphicstoolkit.la();
		...
		if (!Class320_Sub3.aBoolean8235) {
				...
				for (int i_33_ = i_2_; (i_33_ ^ 0xffffffff) > (i_2_ + 104 ^ 0xffffffff); i_33_++)
					for (int i_34_ = i; i_34_ <= i - -1; i_34_++) {
						...
						if (Class369.method4085(i_33_, 0, i, i_32_, i_34_)) {
							...
							if (interface19 == null)
								interface19 = (Interface19) Class262_Sub20.method3203(i_34_, i_32_, i_33_,
										aClass5996 != null ? aClass5996 : (aClass5996 = method972("Interface19")));
							if (interface19 == null)
							...
							if (interface19 != null) {
								ObjectDefinition objectdefinition = Class186.aClass112_2256
										.method1145(interface19.getObjectId(-32136), 100);
								if (!objectdefinition.aBoolean3002 || Class101.aBoolean1313) {
									...
									if (objectdefinition.objectWithSprite != null)
										for (int element : objectdefinition.objectWithSprite)
											if (element != -1) {
												ObjectDefinition objectdefinition_37_ = Class186.aClass112_2256
														.method1145(element, i_0_ ^ 0x1957);
										...
										if (bool_38_) {
											...
											for (int i_44_ = 0; i_44_ < 10; i_44_++) {
												...
												if ((i_45_ ^ 0xffffffff) == -1
														&& (i_1_ ^ 0xffffffff) > (i_39_ ^ 0xffffffff)
														&& (-3 + i_32_ ^ 0xffffffff) > (i_39_ ^ 0xffffffff)
														&& (is_41_[-1 + i_39_ + -i_42_][i_40_ + -i_43_]
																& 0x2c0108) == 0)
													i_39_--;
												if (i_45_ == 1 && -1 + i_1_ + 104 > i_39_
														&& (i_32_ - -3 ^ 0xffffffff) < (i_39_ ^ 0xffffffff)
														&& (is_41_[-i_42_ + i_39_ + 1][-i_43_ + i_40_] & 0x2c0180
																^ 0xffffffff) == -1)
													i_39_++;
												if ((i_45_ ^ 0xffffffff) == -3
														&& (i_40_ ^ 0xffffffff) < (i_2_ ^ 0xffffffff)
														&& (i_33_ + -3 ^ 0xffffffff) > (i_40_ ^ 0xffffffff)
														&& (is_41_[i_39_ - i_42_][-i_43_ + (-1 + i_40_)] & 0x2c0102
																^ 0xffffffff) == -1)
													i_40_--;
												if ((i_45_ ^ 0xffffffff) == -4
														&& (i_40_ ^ 0xffffffff) > (104 + (i_2_ + -1) ^ 0xffffffff)
														&& i_33_ + 3 > i_40_
														&& (0x2c0120 & is_41_[i_39_ - i_42_][1 + i_40_ - i_43_]) == 0)
													i_40_++;
											}
										}
			...
			if (Class262_Sub15_Sub1.aClass224_10520 != null) {
				MiniMapDots.index2.anInt3795 = 1;
				...
				for (int i_46_ = 0; i_46_ < Class262_Sub15_Sub1.aClass224_10520.anInt2670; i_46_++) {
					...
					if (Player.get.plane == i_47_ >> 28) {
						...
						if ((i_48_ ^ 0xffffffff) > -1
								|| (i_48_ ^ 0xffffffff) <= (Node_Sub54.GAME_SCENE_WDITH ^ 0xffffffff)
								|| (i_49_ ^ 0xffffffff) > -1 || i_49_ >= Class377_Sub1.GAME_SCENE_HEIGHT) {
							Class79 class79 = Class304.aClass215_3834.method2069((byte) 116,
									Class262_Sub15_Sub1.aClass224_10520.anIntArray2669[i_46_]);
							if (class79.anIntArray1049 != null && (class79.anInt1089 + i_48_ ^ 0xffffffff) <= -1
									&& (i_48_ - -class79.anInt1068 ^ 0xffffffff) > (Node_Sub54.GAME_SCENE_WDITH
											^ 0xffffffff)
									&& class79.anInt1060 + i_49_ >= 0 && (i_49_ + class79.anInt1051
											^ 0xffffffff) > (Class377_Sub1.GAME_SCENE_HEIGHT ^ 0xffffffff))
				...
				MiniMapDots.index2.method3521((byte) -18);
			}
		}
		return true;
	}
	...
	public final boolean method971(GraphicsToolkit graphicstoolkit, byte b, int i, int i_50_) {
		anInt5992++;
		...
		if (anEntityNode_Sub5Array5995 != null)
			for (int i_52_ = 0; i_52_ < anEntityNode_Sub5Array5995.length; i_52_++) {
				...
				if (anEntityNode_Sub5Array5995[i_52_].method968(i_50_, i)
						&& anAnimable5990.method810(i, i_50_, false, graphicstoolkit)) {
					anEntityNode_Sub5Array5995[i_52_].anInt5983 >>= i_51_;
					return true;
				}
				anEntityNode_Sub5Array5995[i_52_].anInt5983 >>= i_51_;
