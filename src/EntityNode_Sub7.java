...
public class EntityNode_Sub7 extends EntityNode {
	public static IncomingPacket aClass192_6008 = new IncomingPacket(116, -1);
	public static int anInt5997;
	public static int anInt6000;
	public static int anInt6001;
	public static int anInt6002;
	public static int anInt6007;
	public static int anInt6010;
	public static int anInt6013;

	public static final void method973(byte b, Player player, int i, int i_0_) {
		anInt5997++;
		int[] is = new int[4];
	...
	public static final void method978(int i, int i_45_) {
		anInt6002++;
	...
	public static final void method979(int i) {
	...
	public final void method974(int i, byte b, boolean bool, long l,
			...
			if ((aClass355_6011.anInt4379 ^ 0xffffffff) < (Node_Sub39.anInt7498 ^ 0xffffffff))
				...
				if (!aBoolean6020) {
					if ((aClass355_6011.anInt4411 ^ 0xffffffff) != 0) {
						...
						if (aClass355_6011.aBoolean4390
								|| aClass355_6011.anInt4411 >= i_1_)
							i_1_ %= aClass355_6011.anInt4411;
						else
							bool = false;
						if (!aClass355_6011.aBoolean4375
								&& i_1_ < aClass355_6011.anInt4361)
							bool = false;
						if (aClass355_6011.aBoolean4375
								&& (aClass355_6011.anInt4361 ^ 0xffffffff) >= (i_1_ ^ 0xffffffff))
							bool = false;
					}
				} else
					bool = false;
		...
		if (bool) {
			...
			if ((i_2_ ^ 0xffffffff) != (aClass143_6005.anInt1767 ^ 0xffffffff)
					|| i_3_ != aClass143_6005.anInt1776
					|| (aClass143_6005.anInt1769 ^ 0xffffffff) != (i_4_ ^ 0xffffffff)) {
				...
				for (anInt6021 = -(i_10_ * i_5_) + i_8_ * i_7_; (anInt6018 ^ 0xffffffff) < -32768
						|| (anInt6021 ^ 0xffffffff) < -32768
						|| (anInt6022 ^ 0xffffffff) < -32768
						|| anInt6018 < -32767
						|| anInt6021 < -32767
						|| (anInt6022 ^ 0xffffffff) > 32766; anInt6021 >>= 1) {
					anInt6022 >>= 1;
				anInt6018 >>= 1;
				}
				int i_11_ = (int) Math
						.sqrt(anInt6018
								* anInt6018
								- (-(anInt6021 * anInt6021) + -(anInt6022 * anInt6022)));
				if (i_11_ <= 0)
					i_11_ = 1;
				anInt6021 = anInt6021 * 32767 / i_11_;
				anInt6018 = anInt6018 * 32767 / i_11_;
				anInt6022 = anInt6022 * 32767 / i_11_;
				if (aClass355_6011.aShort4369 > 0
						|| (aClass355_6011.aShort4382 ^ 0xffffffff) < -1) {
					int i_12_ = (int) (2607.5945876176133 * Math.atan2(
							anInt6022, anInt6018));
					int i_13_ = (int) (Math.atan2(
							anInt6021,
							Math.sqrt(anInt6018 * anInt6018 + anInt6022
									* anInt6022)) * 2607.5945876176133);
					anInt6016 = aClass355_6011.aShort4369
							+ -aClass355_6011.aShort4357;
					anInt6015 = -(anInt6016 >> 1)
							+ (aClass355_6011.aShort4357 + i_12_);
					anInt6017 = -aClass355_6011.aShort4386
							+ aClass355_6011.aShort4382;
					anInt6019 = -(anInt6017 >> 1)
							+ (aClass355_6011.aShort4386 + i_13_);
				}
			}
			anInt5998 += (int) ((aClass355_6011.anInt4424 + Math.random()
					* (-aClass355_6011.anInt4424 + aClass355_6011.anInt4381)) * i);
			if (anInt5998 > 63) {
				...
				for (int i_15_ = 0; (i_14_ ^ 0xffffffff) < (i_15_ ^ 0xffffffff); i_15_++) {
					...
					int i_18_;
					if (aClass355_6011.aShort4369 > 0
							|| aClass355_6011.aShort4382 > 0) {
						int i_19_ = (int) (anInt6016 * Math.random())
								+ anInt6015;
						i_19_ &= 0x3fff;
						int i_20_ = Class335.anIntArray4167[i_19_];
						int i_21_ = Class335.anIntArray4165[i_19_];
						int i_22_ = anInt6019
								+ (int) (anInt6017 * Math.random());
						i_22_ &= 0x1fff;
					...
					int i_28_ = (int) (aClass143_6005.anInt1774 * f_27_ + (aClass143_6005.anInt1779
							* f_26_ + f * aClass143_6005.anInt1777));
					int i_29_ = (int) (aClass143_6005.anInt1781 * f_26_ + f
							* aClass143_6005.anInt1778 + f_27_
							* aClass143_6005.anInt1765);
					int i_30_ = (int) (aClass143_6005.anInt1766 * f
							+ aClass143_6005.anInt1775 * f_26_ + f_27_
							* aClass143_6005.anInt1772);
					int i_31_ = (int) (f_27_ * aClass143_6014.anInt1774 + (aClass143_6014.anInt1779
							* f_26_ + aClass143_6014.anInt1777 * f));
					int i_32_ = (int) (f_27_ * aClass143_6014.anInt1765 + (f_26_
							* aClass143_6014.anInt1781 + f
							* aClass143_6014.anInt1778));
					int i_33_ = (int) (f_26_ * aClass143_6014.anInt1775
							+ aClass143_6014.anInt1766 * f + aClass143_6014.anInt1772
							* f_27_);
					int i_34_ = -i_31_ + i_28_;
					int i_35_ = i_29_ - i_32_;
					int i_36_ = i_30_ + -i_33_;
					int i_37_ = (int) (i_34_ * Math.random() + i_31_);
					int i_38_ = (int) (i_32_ + i_35_ * Math.random());
					int i_39_ = (int) (i_33_ + Math.random() * i_36_);
					int i_40_ = (int) (Math.random() * (aClass355_6011.anInt4367 - aClass355_6011.anInt4377))
							+ aClass355_6011.anInt4377;
					int i_41_ = (int) (Math.random() * (aClass355_6011.anInt4388 + -aClass355_6011.anInt4401))
							+ aClass355_6011.anInt4401;
					int i_42_ = (int) (Math.random() * (aClass355_6011.anInt4408 + -aClass355_6011.anInt4360))
							+ aClass355_6011.anInt4360;
					int i_43_;
					if (aClass355_6011.aBoolean4391) {
						double d = Math.random();
						i_43_ = (int) (aClass355_6011.anInt4389 + aClass355_6011.anInt4402
								* d)
								| ((int) (aClass355_6011.anInt4403 + d
										* aClass355_6011.anInt4400) << 8 | (int) (aClass355_6011.anInt4383 + aClass355_6011.anInt4420
										* d) << 16)
								| (int) (Math.random()
										* aClass355_6011.anInt4349 + aClass355_6011.anInt4394) << 24;
					} else
						i_43_ = (int) (aClass355_6011.anInt4389 + Math.random()
								* aClass355_6011.anInt4402)
								| ((int) (aClass355_6011.anInt4403 + Math
										.random() * aClass355_6011.anInt4400) << 8 | (int) (Math
										.random() * aClass355_6011.anInt4420 + aClass355_6011.anInt4383) << 16)
								| (int) (aClass355_6011.anInt4394 + aClass355_6011.anInt4349
										* Math.random()) << 24;
					...
					if (Animable_Sub3_Sub1.anInt11012 == Packet.anInt9386) {
						...
						EntityNode_Sub3_Sub2_Sub1 entitynode_sub3_sub2_sub1 = new EntityNode_Sub3_Sub2_Sub1(
							this, i_37_, i_38_, i_39_, i_16_, i_18_, i_17_,
							i_40_, i_41_, i_43_, i_42_, i_44_,
							aClass355_6011.aBoolean4373,
							aClass355_6011.aBoolean4365);
					} else {
						EntityNode_Sub3_Sub2_Sub1 entitynode_sub3_sub2_sub1 = NPCMasks.anEntityNode_Sub3_Sub2_Sub1Array3596[Animable_Sub3_Sub1.anInt11012];
						Animable_Sub3_Sub1.anInt11012 = 1 + Animable_Sub3_Sub1.anInt11012 & 0x3ff;
						entitynode_sub3_sub2_sub1.method950(this, i_37_, i_38_,
								i_39_, i_16_, i_18_, i_17_, i_40_, i_41_,
								i_43_, i_42_, i_44_,
								aClass355_6011.aBoolean4373,
								aClass355_6011.aBoolean4365);
					}
		...
		anInt6004 = 0;
		if (b == 19) {
			for (EntityNode_Sub3_Sub2_Sub1 entitynode_sub3_sub2_sub1 = (EntityNode_Sub3_Sub2_Sub1) aClass103_6006
					.method1113((byte) 105); entitynode_sub3_sub2_sub1 != null; entitynode_sub3_sub2_sub1 = (EntityNode_Sub3_Sub2_Sub1) aClass103_6006
					.method1108(b ^ 0x60)) {
	...
	public final void method976(long l, GraphicsToolkit graphicstoolkit, int i) {
		anInt6000++;
		for (EntityNode_Sub3_Sub2_Sub1 entitynode_sub3_sub2_sub1 = (EntityNode_Sub3_Sub2_Sub1) aClass103_6006
				.method1113(
						(byte) 116); entitynode_sub3_sub2_sub1 != null; entitynode_sub3_sub2_sub1 = (EntityNode_Sub3_Sub2_Sub1) aClass103_6006
								.method1108(98))
	...
	public final void method977(byte b) {
		aClass143_6005.anInt1781 = aClass300_6003.anInt3756;
		aClass143_6005.anInt1772 = aClass300_6003.anInt3771;
		aClass143_6005.anInt1774 = aClass300_6003.anInt3761;
		aClass143_6005.anInt1778 = aClass300_6003.anInt3751;
		...
		aClass143_6005.anInt1777 = aClass300_6003.anInt3769;
		aClass143_6005.anInt1765 = aClass300_6003.anInt3752;
		if (aClass143_6005.anInt1779 != aClass143_6005.anInt1777 || aClass143_6005.anInt1774 != aClass143_6005.anInt1779
				|| aClass143_6005.anInt1778 != aClass143_6005.anInt1781
				|| (aClass143_6005.anInt1781 ^ 0xffffffff) != (aClass143_6005.anInt1765 ^ 0xffffffff)
				|| (aClass143_6005.anInt1766 ^ 0xffffffff) != (aClass143_6005.anInt1775 ^ 0xffffffff)
				|| aClass143_6005.anInt1772 != aClass143_6005.anInt1775) {
			if (aBoolean6020) {
				aClass143_6014.anInt1778 = aClass143_6005.anInt1778;
				aClass143_6014.anInt1766 = aClass143_6005.anInt1766;
				aClass143_6014.anInt1777 = aClass143_6005.anInt1777;
