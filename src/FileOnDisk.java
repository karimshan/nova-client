...
public class FileOnDisk {
	public static boolean aBoolean1319;
	public static boolean[] aBooleanArray1332;
	public static byte[][] aByteArrayArray1331;
	public static double aDouble1318;
	...
	public static int[] anIntArray1322 = new int[1000];
	public static int[] anIntArray1329 = new int[2];
	static {
		aBoolean1319 = false;
	}
	...
	FileOnDisk(File file, String string, long l) throws IOException {
		l = Long.MAX_VALUE;
		/*
		 * ffffffffffffffL) == 0L) { l = Long.MAX_VALUE; }
		 */
		if (file.length() > l)
			file.delete();
	...
	protected final void finalize() throws Throwable {
		...
		if (aRandomAccessFile1325 != null)
			// System.out.println("Warning! fileondisk " + aFile1330 +
			// " not closed correctly using close(). Auto-closing instead. ");
			method1098(true);
	}

	public final void method1098(boolean bool) throws IOException {
		anInt1327++;
		if (bool != true)
			anIntArray1329 = null;
		if (aRandomAccessFile1325 != null) {
	...
	public final void method1100(boolean bool, long l) throws IOException {
	...
	public final long method1101(int i) throws IOException {
		if (i != 0)
			aLong1334 = -18L;
		anInt1317++;
	...
	public final void method1102(byte b, byte[] bs, int i, int i_0_) throws IOException {
		anInt1324++;
		if (aLong1334 + i_0_ > aLong1328) {
	...
	public final int method1103(byte b, int i, byte[] bs, int i_1_) throws IOException {
		if (b != -115)
			method1104(true);
		anInt1323++;
	...
	public final File method1104(boolean bool) {
		anInt1320++;
		if (bool != false)
			method1099(-16);
		return aFile1330;
