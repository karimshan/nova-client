...
public class FixedAnimator extends Animator {
	...
	public static final boolean method257(Node_Sub4 node_sub4, int i) {
		anInt5504++;
		if (node_sub4 == null)
			return true;
		Player.aNode_Sub4_11155 = null;
		AbstractFont.anInt800 = i;
		...
		if (Class89.anInt1198 == 1) {
			if (!Class307.aNode_Sub9_Sub1_3902.method2467(Node_Sub21.aClass96_7183, Node_Sub38_Sub6.aClass302_10138,
					-101, 22050, node_sub4))
				return false;
	...
	public static final void method258(boolean bool, byte b, boolean bool_0_, int i, int i_1_, String string,
			String string_2_) {
		...
		for (int i_6_ = 0; EntityNode_Sub3_Sub1.aClass86_9166.anInt1175 > i_6_; i_6_++) {
			...
			if ((!bool_0_ || itemdefinition.aBoolean1933) && itemdefinition.anInt1857 == -1
					&& itemdefinition.anInt1852 == -1 && (itemdefinition.anInt1928 ^ 0xffffffff) == 0
					&& itemdefinition.anInt1877 == 0
					&& itemdefinition.aString1860.toLowerCase().indexOf(string) != -1) {
				if ((i_1_ ^ 0xffffffff) != 0)
					if (!bool) {
