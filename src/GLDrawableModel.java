...
public class GLDrawableModel extends DrawableModel {
	public static Class212 aClass212_5708;
	public static Color[] aColorArray5590;
	public static float[] aFloatArray5626 = new float[4];
	...
	public static int anInt5662;
	public static int anInt5663;
	...
	static {
		aColorArray5590 = new Color[] { new Color(9179409), new Color(16777215), new Color(16726277),
				new Color(16726277) };
		anInt5703 = 0;
	...
	GLDrawableModel(GLToolkit gltoolkit, Model model, int i, int i_663_, int i_664_, int i_665_) {
		...
		for (int i_666_ = 0; (model.anInt2572 ^ 0xffffffff) < (i_666_ ^ 0xffffffff); i_666_++)
			if (model.aByteArray2594 == null || model.aByteArray2594[i_666_] != 2) {
				if (model.aShortArray2587 != null && (model.aShortArray2587[i_666_] ^ 0xffffffff) != 0) {
					PlayerMasks class91 = var_d.method10(0xffff & model.aShortArray2587[i_666_], -8217);
		...
		for (int i_667_ = 0; i_667_ < anInt5709; i_667_++) {
				...
				for (Class17 class17 : model.aClass17Array2621) {
					if (class17.anInt273 == i_668_) {
						...
						if ((class352.anInt4330 ^ 0xffffffff) != 0) {
							PlayerMasks class91_675_ = var_d.method10(class352.anInt4330, -8217);
			...
			boolean bool_677_ = model.aByteArray2622 != null && model.aByteArray2622[i_668_] != 0
					|| class91 != null && class91.anInt1226 != 0;
			...
			gldrawablemodel_678_.aBoolean5670 = gldrawablemodel_678_.aBoolean5670
		...
		if (model.aClass17Array2621 != null) {
			...
			for (int i_679_ = 0; i_679_ < anInt5659; i_679_++) {
				...
				i_682_ = i_682_
						| 255 - (model.aByteArray2622 != null ? model.aByteArray2622[class17.anInt273] : 0) << 24;
				aClass72Array5627[i_679_] = new Class72(i_680_, model.aShortArray2600[class17.anInt273],
		...
		for (int i_687_ = 0; model.anInt2572 > i_687_; i_687_++) {
			...
			int i_698_;
			for (i_698_ = -(i_691_ * i_693_) + i_690_ * i_694_; (i_696_ ^ 0xffffffff) < -8193
					|| (i_697_ ^ 0xffffffff) < -8193 || i_698_ > 8192 || i_696_ < -8192 || i_697_ < -8192
					|| (i_698_ ^ 0xffffffff) > 8191; i_698_ >>= 1) {
				i_697_ >>= 1;
				i_696_ >>= 1;
			}
			int i_699_ = (int) Math.sqrt(i_697_ * i_697_ + i_696_ * i_696_ - -(i_698_ * i_698_));
			if (i_699_ <= 0)
				i_699_ = 1;
		...
		for (int i_700_ = 0; i_700_ < anInt5709; i_700_++) {
			...
			if ((s ^ 0xffffffff) != 0)
				if ((i_703_ ^ 0xffffffff) == 0) {
					...
					if (b != 0) {
						...
						float f_720_ = model.anIntArray2617[i_703_] / 256.0F;
						if (b != 1) {
							if (b != 2) {
								if (b == 3) {
									Class212.method2053(i_716_, model.anIntArray2574[s_713_],
											model.anIntArray2576[s_713_], Class223.aFloatArray2663, i_718_, f_720_, fs,
											b_719_, model.anIntArray2616[s_713_], -4, i_717_);
									f_705_ = Class223.aFloatArray2663[1];
									f = Class223.aFloatArray2663[0];
									Class212.method2053(i_716_, model.anIntArray2574[s_714_],
											model.anIntArray2576[s_714_], Class223.aFloatArray2663, i_718_, f_720_, fs,
											b_719_, model.anIntArray2616[s_714_], -4, i_717_);
									f_707_ = Class223.aFloatArray2663[1];
									f_706_ = Class223.aFloatArray2663[0];
									Class212.method2053(i_716_, model.anIntArray2574[s_715_],
											model.anIntArray2576[s_715_], Class223.aFloatArray2663, i_718_, f_720_, fs,
											b_719_, model.anIntArray2616[s_715_], -4, i_717_);
								...
								float f_721_ = model.anIntArray2615[i_703_] / 256.0F;
								float f_722_ = model.anIntArray2584[i_703_] / 256.0F;
								...
								float f_732_ = 64.0F / model.anIntArray2603[i_703_];
								float f_733_ = 64.0F / model.anIntArray2588[i_703_];
								float f_734_ = 64.0F / model.anIntArray2593[i_703_];
								float f_735_ = (i_729_ * fs[0] + fs[1] * i_730_ + fs[2] * i_731_) / f_732_;
								float f_736_ = (fs[5] * i_731_ + (fs[3] * i_729_ + i_730_ * fs[4])) / f_733_;
								float f_737_ = (i_731_ * fs[8] + (fs[7] * i_730_ + i_729_ * fs[6])) / f_734_;
								i_712_ = PlayerMasks.method1036(2, f_737_, f_735_, f_736_);
								Class39.method407(f_720_, i_712_, model.anIntArray2616[s_713_], f_721_, i_717_,
										Class223.aFloatArray2663, model.anIntArray2576[s_713_], 78,
										model.anIntArray2574[s_713_], i_716_, i_718_, f_722_, fs, b_719_);
								f_705_ = Class223.aFloatArray2663[1];
								f = Class223.aFloatArray2663[0];
								Class39.method407(f_720_, i_712_, model.anIntArray2616[s_714_], f_721_, i_717_,
										Class223.aFloatArray2663, model.anIntArray2576[s_714_], 126,
										model.anIntArray2574[s_714_], i_716_, i_718_, f_722_, fs, b_719_);
								f_706_ = Class223.aFloatArray2663[0];
								f_707_ = Class223.aFloatArray2663[1];
								Class39.method407(f_720_, i_712_, model.anIntArray2616[s_715_], f_721_, i_717_,
										Class223.aFloatArray2663, model.anIntArray2576[s_715_], 83,
										model.anIntArray2574[s_715_], i_716_, i_718_, f_722_, fs, b_719_);
								f_708_ = Class223.aFloatArray2663[0];
								f_709_ = Class223.aFloatArray2663[1];
							}
						} else {
							float f_738_ = model.anIntArray2593[i_703_] / 1024.0F;
							Class262_Sub1.method3151(fs, f_720_, i_718_, model.anIntArray2616[s_713_], b_719_,
									Class223.aFloatArray2663, f_738_, i_717_, -2356, model.anIntArray2576[s_713_],
									model.anIntArray2574[s_713_], i_716_);
							f = Class223.aFloatArray2663[0];
							f_705_ = Class223.aFloatArray2663[1];
							Class262_Sub1.method3151(fs, f_720_, i_718_, model.anIntArray2616[s_714_], b_719_,
									Class223.aFloatArray2663, f_738_, i_717_, -2356, model.anIntArray2576[s_714_],
									model.anIntArray2574[s_714_], i_716_);
							f_706_ = Class223.aFloatArray2663[0];
							f_707_ = Class223.aFloatArray2663[1];
							Class262_Sub1.method3151(fs, f_720_, i_718_, model.anIntArray2616[s_715_], b_719_,
									Class223.aFloatArray2663, f_738_, i_717_, -2356, model.anIntArray2576[s_715_],
									model.anIntArray2574[s_715_], i_716_);
							f_708_ = Class223.aFloatArray2663[0];
							f_709_ = Class223.aFloatArray2663[1];
						...
						float f_746_ = model.anIntArray2616[s_743_];
						float f_747_ = model.anIntArray2576[s_743_];
						float f_748_ = model.anIntArray2574[s_743_];
						float f_749_ = -f_746_ + model.anIntArray2616[s_744_];
						float f_750_ = model.anIntArray2576[s_744_] - f_747_;
						float f_751_ = -f_748_ + model.anIntArray2574[s_744_];
						float f_752_ = -f_746_ + model.anIntArray2616[s_745_];
						float f_753_ = -f_747_ + model.anIntArray2576[s_745_];
						float f_754_ = -f_748_ + model.anIntArray2574[s_745_];
						float f_755_ = -f_746_ + model.anIntArray2616[s_740_];
						float f_756_ = -f_747_ + model.anIntArray2576[s_740_];
						float f_757_ = model.anIntArray2574[s_740_] - f_748_;
						float f_758_ = -f_746_ + model.anIntArray2616[s_741_];
						float f_759_ = model.anIntArray2576[s_741_] - f_747_;
						float f_760_ = -f_748_ + model.anIntArray2574[s_741_];
						float f_761_ = -f_746_ + model.anIntArray2616[s_742_];
						float f_762_ = -f_747_ + model.anIntArray2576[s_742_];
						float f_763_ = -f_748_ + model.anIntArray2574[s_742_];
			...
			if ((b ^ 0xffffffff) != -1) {
				if (b == 1) {
					...
					long l = ((i_702_ << 8) + ((long) (i_712_ << 24) + (long) i_704_) << 32)
							+ (256 + class132.anInt1674 << 12)
							+ ((i_703_ << 2) - (-((class132.anInt1679 ^ 0xffffffff) >= -1 ? 2048 : 1024)
									+ -(256 + class132.anInt1683 << 22)));
					aShortArray5622[i_700_] = method651(l, class132.anInt1679, f, f_705_, 13, class132.anInt1674, 0,
							model, class132.anInt1683, model.aShortArray2600[i_701_]);
					aShortArray5683[i_700_] = method651(i_710_ + l, class132.anInt1679, f_706_, f_707_, 13,
							class132.anInt1674, 0, model, class132.anInt1683, model.aShortArray2583[i_701_]);
					aShortArray5706[i_700_] = method651(l + i_711_, class132.anInt1679, f_708_, f_709_, 13,
							class132.anInt1674, 0, model, class132.anInt1683, model.aShortArray2589[i_701_]);
				}
			} else {
				long l = ((long) i_704_ + (long) (i_702_ << 8) + (i_712_ << 24) << 32) + (i_703_ << 2);
				...
				aShortArray5622[i_700_] = method651(l, class152.anInt1937, f, f_705_, 13, class152.anInt1936,
						class152.anInt1934, model, class152.anInt1935, s_771_);
				class152 = class152s[s_772_];
				aShortArray5683[i_700_] = method651(l + i_710_, class152.anInt1937, f_706_, f_707_, 13,
						class152.anInt1936, class152.anInt1934, model, class152.anInt1935, s_772_);
				class152 = class152s[s_773_];
				aShortArray5706[i_700_] = method651(i_711_ + l, class152.anInt1937, f_708_, f_709_, 13,
						class152.anInt1936, class152.anInt1934, model, class152.anInt1935, s_773_);
			}
			if (model.aByteArray2622 != null)
	...
	@Override
	public final void aa(short s, short s_0_) {
		anInt5707++;
		...
		byte b_3_ = 0;
		if (s_0_ != -1) {
			PlayerMasks class91 = var_d.method10(s_0_ & 0xffff, -8217);
		...
		if (b_2_ != b | b_1_ != b_3_) {
			if (aClass72Array5627 != null)
				for (int i = 0; i < anInt5659; i++) {
					...
					class190.anInt2335 = ~0xffffff & class190.anInt2335
							| 0xffffff & Class85.anIntArray1158[aShortArray5693[class72.anInt975] & 0xffff];
				}
	...
	@Override
	public final void H(int i, int i_123_, int i_124_) {
		anInt5700++;
	...
	@Override
	public final void I(int i, int[] is, int i_266_, int i_267_, int i_268_, boolean bool, int i_269_, int[] is_270_) {
		anInt5673++;
		...
		if (i == 0) {
			...
			if (is_270_ != null) {
				...
				if (Animable_Sub1.aBoolean9105) {
					int i_292_ = Class378.anInt4676 * is_270_[0] + (Class297.anInt3702 * is_270_[3]
							+ Class270_Sub2_Sub1.anInt10546 * is_270_[6] - -8192) >> 14;
					int i_293_ = is_270_[7] * Class270_Sub2_Sub1.anInt10546 + is_270_[4] * Class297.anInt3702
							+ is_270_[1] * Class378.anInt4676 + 8192 >> 14;
					i_292_ += i_289_;
					i_293_ += i_290_;
					int i_294_ = Class378.anInt4676 * is_270_[2] - -(Class297.anInt3702 * is_270_[5])
							- -(is_270_[8] * Class270_Sub2_Sub1.anInt10546) - -8192 >> 14;
					i_294_ += i_291_;
				...
				is_295_[5] = -i_297_;
				int i_304_ = is_295_[1] * -Class297.anInt3702
						+ (-Class378.anInt4676 * is_295_[0] - -(-Class270_Sub2_Sub1.anInt10546 * is_295_[2]))
						+ 8192 >> 14;
				int i_305_ = -Class378.anInt4676 * is_295_[3] - (-(-Class297.anInt3702 * is_295_[4])
						+ (-(-Class270_Sub2_Sub1.anInt10546 * is_295_[5]) - 8192)) >> 14;
				int i_306_ = 8192 + (is_295_[6] * -Class378.anInt4676
						- (-(-Class297.anInt3702 * is_295_[7]) - -Class270_Sub2_Sub1.anInt10546 * is_295_[8])) >> 14;
					...
					if ((anIntArrayArray5684.length ^ 0xffffffff) < (i_327_ ^ 0xffffffff)) {
						...
						for (int i_329_ = 0; (is_328_.length ^ 0xffffffff) < (i_329_ ^ 0xffffffff); i_329_++) {
							...
							if (aShortArray5618 == null || (aShortArray5618[i_330_] & i_269_ ^ 0xffffffff) != -1) {
								int i_331_ = 8192
										+ (anIntArray5588[i_330_] * is_318_[1] + is_318_[0] * anIntArray5595[i_330_]
												+ anIntArray5637[i_330_] * is_318_[2]) >> 14;
								int i_332_ = is_318_[4] * anIntArray5588[i_330_] + is_318_[3] * anIntArray5595[i_330_]
										+ anIntArray5637[i_330_] * is_318_[5] + 8192 >> 14;
								i_332_ += i_324_;
								i_331_ += i_323_;
								int i_333_ = 8192
										+ (anIntArray5588[i_330_] * is_318_[7] + is_318_[6] * anIntArray5595[i_330_])
										+ is_318_[8] * anIntArray5637[i_330_] >> 14;
						...
						for (int element : is_336_) {
							...
							if (aShortArray5618 == null || (i_269_ & aShortArray5618[i_338_]) != 0) {
								...
								if (i_268_ != 0) {
									...
									int i_341_ = i_340_ * anIntArray5595[i_338_] + i_339_ * anIntArray5588[i_338_]
											+ 16383 >> 14;
									anIntArray5588[i_338_] = i_340_ * anIntArray5588[i_338_]
											+ (-(i_339_ * anIntArray5595[i_338_]) - -16383) >> 14;
								...
								if ((i_266_ ^ 0xffffffff) != -1) {
									...
									int i_344_ = i_343_ * anIntArray5588[i_338_] + -(i_342_ * anIntArray5637[i_338_])
											+ 16383 >> 14;
									anIntArray5637[i_338_] = 16383
											+ (anIntArray5637[i_338_] * i_343_ + i_342_ * anIntArray5588[i_338_]) >> 14;
									anIntArray5588[i_338_] = i_344_;
								}
								if (i_267_ != 0) {
									int i_345_ = Class335.anIntArray4167[i_267_];
									int i_346_ = Class335.anIntArray4165[i_267_];
									int i_347_ = anIntArray5595[i_338_] * i_346_ + i_345_ * anIntArray5637[i_338_]
											- -16383 >> 14;
									anIntArray5637[i_338_] = 16383 + -(i_345_ * anIntArray5595[i_338_])
											+ anIntArray5637[i_338_] * i_346_ >> 14;
								...
								if (aShortArray5618 == null || (aShortArray5618[i_352_] & i_269_) != 0) {
									...
									for (int i_355_ = i_353_; (i_355_ ^ 0xffffffff) > (i_354_ ^ 0xffffffff); i_355_++) {
										...
										if ((i_268_ ^ 0xffffffff) != -1) {
											...
											int i_359_ = 16383 + aShortArray5635[i_356_] * i_358_
													+ i_357_ * aShortArray5691[i_356_] >> 14;
											aShortArray5691[i_356_] = (short) (16383 + (i_358_ * aShortArray5691[i_356_]
													+ -(i_357_ * aShortArray5635[i_356_])) >> 14);
											aShortArray5635[i_356_] = (short) i_359_;
										}
										if (i_266_ != 0) {
											int i_360_ = Class335.anIntArray4167[i_266_];
											int i_361_ = Class335.anIntArray4165[i_266_];
											int i_362_ = -(aShortArray5685[i_356_] * i_360_)
													+ i_361_ * aShortArray5691[i_356_] + 16383 >> 14;
											aShortArray5685[i_356_] = (short) (aShortArray5685[i_356_] * i_361_
													+ (aShortArray5691[i_356_] * i_360_ - -16383) >> 14);
											aShortArray5691[i_356_] = (short) i_362_;
										}
										if (i_267_ != 0) {
											int i_363_ = Class335.anIntArray4167[i_267_];
											int i_364_ = Class335.anIntArray4165[i_267_];
											int i_365_ = aShortArray5635[i_356_] * i_364_
													+ i_363_ * aShortArray5685[i_356_] + 16383 >> 14;
											aShortArray5685[i_356_] = (short) (-(i_363_ * aShortArray5635[i_356_])
													+ aShortArray5685[i_356_] * i_364_ + 16383 >> 14);
			...
			if (is_270_ == null)
				...
				if (Animable_Sub1.aBoolean9105) {
					int i_377_ = 8192 + (Class297.anInt3702 * is_270_[3] + is_270_[0] * Class378.anInt4676
							+ is_270_[6] * Class270_Sub2_Sub1.anInt10546) >> 14;
					int i_378_ = is_270_[7] * Class270_Sub2_Sub1.anInt10546 + is_270_[1] * Class378.anInt4676
							- -(is_270_[4] * Class297.anInt3702) - -8192 >> 14;
					int i_379_ = 8192 + (Class270_Sub2_Sub1.anInt10546 * is_270_[8] + Class297.anInt3702 * is_270_[5]
							+ Class378.anInt4676 * is_270_[2]) >> 14;
					i_377_ += i_374_;
					i_378_ += i_375_;
					...
					if ((i_402_ ^ 0xffffffff) > (anIntArrayArray5684.length ^ 0xffffffff)) {
						...
						for (int i_404_ = 0; (i_404_ ^ 0xffffffff) > (is_403_.length ^ 0xffffffff); i_404_++) {
							...
							if (aShortArray5618 == null || (i_269_ & aShortArray5618[i_405_] ^ 0xffffffff) != -1) {
								int i_406_ = anIntArray5595[i_405_] * is_393_[0]
										+ (is_393_[1] * anIntArray5588[i_405_] - -(is_393_[2] * anIntArray5637[i_405_]))
										+ 8192 >> 14;
								int i_407_ = 8192
										+ (is_393_[3] * anIntArray5595[i_405_] - -(anIntArray5588[i_405_] * is_393_[4]))
										- -(anIntArray5637[i_405_] * is_393_[5]) >> 14;
								i_406_ += i_398_;
								i_407_ += i_399_;
								int i_408_ = is_393_[6] * anIntArray5595[i_405_]
										- -(anIntArray5588[i_405_] * is_393_[7])
										- -(anIntArray5637[i_405_] * is_393_[8]) - -8192 >> 14;
			...
			if (anIntArrayArray5591 != null) {
				...
				if (aClass72Array5627 != null)
					for (int i_415_ = 0; i_415_ < anInt5659; i_415_++) {
						...
						class190.anInt2335 = 255 + -(aByteArray5658[class72.anInt975] & 0xff) << 24
								| class190.anInt2335 & 0xffffff;
					}
			}
		} else if (i == 7) {
			if (anIntArrayArray5591 != null) {
						...
						for (int element : is_418_) {
							...
							if (aShortArray5629 == null || (aShortArray5629[i_420_] & i_269_) != 0) {
								...
								if (i_424_ < 0)
									...
									i_424_ = 127;
								aShortArray5693[i_420_] = (short) Node_Sub16
										.method2590(Node_Sub16.method2590(i_422_ << 10, i_423_ << 7), i_424_);
								if (aClass69_5604 != null)
									aClass69_5604.anInterface9_939 = null;
							}
						}
				...
				if (aClass72Array5627 != null)
					for (int i_425_ = 0; anInt5659 > i_425_; i_425_++) {
						...
						class190.anInt2335 = ~0xffffff & class190.anInt2335
								| Class85.anIntArray1158[0xffff & aShortArray5693[class72.anInt975]] & 0xffffff;
					}
			}
		} else if (i == 8) {
	...
	@Override
	public final void ia(short s, short s_526_) {
		...
		if (aClass72Array5627 != null)
			for (int i = 0; (anInt5659 ^ 0xffffffff) < (i ^ 0xffffffff); i++) {
				Class72 class72 = aClass72Array5627[i];
				Class190 class190 = aClass190Array5674[i];
				class190.anInt2335 = 0xffffff & Class85.anIntArray1158[0xffff & aShortArray5693[class72.anInt975]]
						| ~0xffffff & class190.anInt2335;
			}
		if (aClass69_5604 != null)
			aClass69_5604.anInterface9_939 = null;
	}
	...
	public final void k(int i) {
		...
		for (int i_442_ = 0; (anInt5665 ^ 0xffffffff) < (i_442_ ^ 0xffffffff); i_442_++) {
			...
			aShortArray5685[i_442_] = (short) (i_439_ * aShortArray5685[i_442_]
					+ -(aShortArray5635[i_442_] * i_438_) >> 14);
	...
	public final void method611(Class336 class336, EntityNode_Sub5 entitynode_sub5, int i) {
		...
		if ((anInt5665 ^ 0xffffffff) != -1) {
			...
			Class17.aFloat275 = class336_sub3.aFloat8615 + (class336_sub3.aFloat8593 * class336_sub3_142_.aFloat8609
					+ class336_sub3.aFloat8605 * class336_sub3_142_.aFloat8594
					+ class336_sub3_142_.aFloat8615 * class336_sub3.aFloat8604);
			float f = aShort5600 * Class200_Sub1.aFloat5140 + Class17.aFloat275;
			float f_143_ = Class17.aFloat275 + Class200_Sub1.aFloat5140 * aShort5671;
			float f_144_;
			float f_145_;
			if (f_143_ < f) {
				f_145_ = f + aShort5686;
				f_144_ = -aShort5686 + f_143_;
			} else {
				f_144_ = -aShort5686 + f;
				f_145_ = f_143_ + aShort5686;
			}
			if (!(f_144_ >= aGLToolkit5692.aFloat6710) && !(f_145_ <= aGLToolkit5692.anInt6693)) {
				MainFile.aFloat144 = class336_sub3.aFloat8608 * class336_sub3_142_.aFloat8609
						...
						+ class336_sub3.aFloat8617 * class336_sub3_142_.aFloat8615 + class336_sub3.aFloat8594;
				...
				float f_146_ = MainFile.aFloat144 + aShort5600 * Class129.aFloat1663;
				float f_147_ = aShort5671 * Class129.aFloat1663 + MainFile.aFloat144;
				float f_148_;
				float f_149_;
				if (!(f_146_ > f_147_)) {
					f_148_ = aGLToolkit5692.anInt6667 * (f_146_ - aShort5686);
					f_149_ = (aShort5686 + f_147_) * aGLToolkit5692.anInt6667;
				} else {
					f_148_ = aGLToolkit5692.anInt6667 * (-aShort5686 + f_147_);
					f_149_ = aGLToolkit5692.anInt6667 * (aShort5686 + f_146_);
				}
				if (!(aGLToolkit5692.aFloat6674 <= f_148_ / f_145_)
						&& !(f_149_ / f_145_ <= aGLToolkit5692.aFloat6711)) {
					Class116.aFloat5076 = class336_sub3_142_.aFloat8594 * class336_sub3.aFloat8625
							...
							+ class336_sub3_142_.aFloat8615 * class336_sub3.aFloat8591 + class336_sub3.aFloat8609;
					...
					float f_150_ = Class116.aFloat5076 + aShort5600 * Class51.aFloat5343;
					float f_151_ = Class51.aFloat5343 * aShort5671 + Class116.aFloat5076;
					float f_152_;
					float f_153_;
					if (!(f_150_ > f_151_)) {
						f_153_ = (f_150_ - aShort5686) * aGLToolkit5692.anInt6730;
						f_152_ = aGLToolkit5692.anInt6730 * (f_151_ + aShort5686);
					} else {
						f_152_ = aGLToolkit5692.anInt6730 * (f_150_ + aShort5686);
						f_153_ = (f_151_ - aShort5686) * aGLToolkit5692.anInt6730;
					}
					if (!(f_153_ / f_145_ >= aGLToolkit5692.aFloat6663)
							&& !(f_152_ / f_145_ <= aGLToolkit5692.aFloat6687)) {
						...
						if (entitynode_sub5 != null) {
							...
							int i_157_ = (int) (i_156_ * Class204.aFloat2459 + (aShort5600 * Class129.aFloat1663
									+ (i_155_ * Class210.aFloat2496 + MainFile.aFloat144)));
							int i_158_ = (int) (i_156_ * Node_Sub38_Sub19.aFloat10295 + (aShort5600 * Class51.aFloat5343
									+ (Class188_Sub1_Sub2.aFloat9346 * i_155_ + Class116.aFloat5076)));
							int i_159_ = (int) (aShort5600 * Class200_Sub1.aFloat5140
									+ (Class17.aFloat275 + i_155_ * Class155.aFloat1954)
									+ Class107.aFloat1361 * i_156_);
							if (i_159_ >= aGLToolkit5692.anInt6693) {
								entitynode_sub5.anInt5985 = i_157_ * aGLToolkit5692.anInt6667 / i_159_
										+ aGLToolkit5692.anInt6714;
								entitynode_sub5.anInt5986 = aGLToolkit5692.anInt6730 * i_158_ / i_159_
										+ aGLToolkit5692.anInt6702;
							} else
								bool = true;
							int i_160_ = (int) (i_156_ * Class204.aFloat2459 + (aShort5671 * Class129.aFloat1663
									+ (MainFile.aFloat144 + i_155_ * Class210.aFloat2496)));
							int i_161_ = (int) (Class51.aFloat5343 * aShort5671
									+ (Class116.aFloat5076 + Class188_Sub1_Sub2.aFloat9346 * i_155_)
									+ i_156_ * Node_Sub38_Sub19.aFloat10295);
							int i_162_ = (int) (Class17.aFloat275 + Class155.aFloat1954 * i_155_
									+ aShort5671 * Class200_Sub1.aFloat5140 + i_156_ * Class107.aFloat1361);
							if (aGLToolkit5692.anInt6693 <= i_162_) {
								entitynode_sub5.anInt5984 = aGLToolkit5692.anInt6730 * i_161_ / i_162_
										+ aGLToolkit5692.anInt6702;
								entitynode_sub5.anInt5982 = i_160_ * aGLToolkit5692.anInt6667 / i_162_
										+ aGLToolkit5692.anInt6714;
							} else
								bool = true;
							if (bool)
								if (aGLToolkit5692.anInt6693 <= i_159_ || i_162_ >= aGLToolkit5692.anInt6693) {
									if (aGLToolkit5692.anInt6693 <= i_159_) {
										if (aGLToolkit5692.anInt6693 > i_162_) {
											...
											entitynode_sub5.anInt5985 = aGLToolkit5692.anInt6714
													- -(aGLToolkit5692.anInt6667 * i_164_ / aGLToolkit5692.anInt6693);
											entitynode_sub5.anInt5986 = i_165_ * aGLToolkit5692.anInt6730
													/ aGLToolkit5692.anInt6693 + aGLToolkit5692.anInt6702;
										}
									} else {
										...
										entitynode_sub5.anInt5985 = i_167_ * aGLToolkit5692.anInt6667
												/ aGLToolkit5692.anInt6693 + aGLToolkit5692.anInt6714;
										entitynode_sub5.anInt5986 = aGLToolkit5692.anInt6702
												- -(aGLToolkit5692.anInt6730 * i_168_ / aGLToolkit5692.anInt6693);
									}
								} else
									bool_154_ = false;
							if (bool_154_) {
								if ((i_159_ ^ 0xffffffff) < (i_162_ ^ 0xffffffff))
									entitynode_sub5.anInt5983 = aGLToolkit5692.anInt6714
											- -(aGLToolkit5692.anInt6667 * (aShort5686 + i_157_) / i_159_)
											- entitynode_sub5.anInt5985;
								else
									entitynode_sub5.anInt5983 = aGLToolkit5692.anInt6714
											- (-((i_160_ - -aShort5686) * aGLToolkit5692.anInt6667 / i_162_)
	...
	public final void method614(Class336 class336) {
		...
		if (aClass300Array5681 != null)
			for (int i = 0; (aClass300Array5681.length ^ 0xffffffff) < (i ^ 0xffffffff); i++) {
				...
				class300_139_.anInt3769 = (int) (class336_sub3.aFloat8596 * anIntArray5595[class300.anInt3764]
						+ class336_sub3.aFloat8608 * anIntArray5588[class300.anInt3764]
						+ anIntArray5637[class300.anInt3764] * class336_sub3.aFloat8617 + class336_sub3.aFloat8594);
				class300_139_.anInt3751 = (int) (anIntArray5637[class300.anInt3764] * class336_sub3.aFloat8591
						+ (anIntArray5588[class300.anInt3764] * class336_sub3.aFloat8607
								+ class336_sub3.aFloat8625 * anIntArray5595[class300.anInt3764])
						+ class336_sub3.aFloat8609);
				class300_139_.anInt3753 = (int) (class336_sub3.aFloat8604 * anIntArray5637[class300.anInt3764]
						+ (anIntArray5595[class300.anInt3764] * class336_sub3.aFloat8605
								+ class336_sub3.aFloat8593 * anIntArray5588[class300.anInt3764])
						+ class336_sub3.aFloat8615);
				class300_139_.anInt3766 = (int) (class336_sub3.aFloat8617 * anIntArray5637[class300.anInt3757]
						+ (anIntArray5588[class300.anInt3757] * class336_sub3.aFloat8608
								+ anIntArray5595[class300.anInt3757] * class336_sub3.aFloat8596)
						+ class336_sub3.aFloat8594);
				class300_139_.anInt3756 = (int) (class336_sub3.aFloat8609
						+ (class336_sub3.aFloat8591 * anIntArray5637[class300.anInt3757]
								+ (anIntArray5595[class300.anInt3757] * class336_sub3.aFloat8625
										+ class336_sub3.aFloat8607 * anIntArray5588[class300.anInt3757])));
				class300_139_.anInt3758 = (int) (class336_sub3.aFloat8615
						+ (anIntArray5588[class300.anInt3757] * class336_sub3.aFloat8593
								+ class336_sub3.aFloat8605 * anIntArray5595[class300.anInt3757]
								+ class336_sub3.aFloat8604 * anIntArray5637[class300.anInt3757]));
				class300_139_.anInt3761 = (int) (class336_sub3.aFloat8594
						+ (class336_sub3.aFloat8617 * anIntArray5637[class300.anInt3754]
								+ (anIntArray5588[class300.anInt3754] * class336_sub3.aFloat8608
										+ anIntArray5595[class300.anInt3754] * class336_sub3.aFloat8596)));
				class300_139_.anInt3752 = (int) (anIntArray5595[class300.anInt3754] * class336_sub3.aFloat8625
						+ anIntArray5588[class300.anInt3754] * class336_sub3.aFloat8607
						+ anIntArray5637[class300.anInt3754] * class336_sub3.aFloat8591 + class336_sub3.aFloat8609);
				class300_139_.anInt3771 = (int) (class336_sub3.aFloat8615
						+ (class336_sub3.aFloat8604 * anIntArray5637[class300.anInt3754]
								+ (anIntArray5595[class300.anInt3754] * class336_sub3.aFloat8605
										+ class336_sub3.aFloat8593 * anIntArray5588[class300.anInt3754])));
			}
		if (aClass218Array5596 != null)
			for (int i = 0; (i ^ 0xffffffff) > (aClass218Array5596.length ^ 0xffffffff); i++) {
				...
				class218_140_.anInt2559 = (int) (class336_sub3.aFloat8608 * anIntArray5588[class218.anInt2554]
						+ anIntArray5595[class218.anInt2554] * class336_sub3.aFloat8596
						+ class336_sub3.aFloat8617 * anIntArray5637[class218.anInt2554] + class336_sub3.aFloat8594);
				class218_140_.anInt2557 = (int) (anIntArray5595[class218.anInt2554] * class336_sub3.aFloat8625
						+ anIntArray5588[class218.anInt2554] * class336_sub3.aFloat8607
						+ class336_sub3.aFloat8591 * anIntArray5637[class218.anInt2554] + class336_sub3.aFloat8609);
				class218_140_.anInt2556 = (int) (class336_sub3.aFloat8605 * anIntArray5595[class218.anInt2554]
						+ class336_sub3.aFloat8593 * anIntArray5588[class218.anInt2554]
						+ anIntArray5637[class218.anInt2554] * class336_sub3.aFloat8604 + class336_sub3.aFloat8615);
			}
	}
	...
	@Override
	public final void method619(DrawableModel drawablemodel, int i, int i_171_, int i_172_, boolean bool) {
		anInt5612++;
						...
						if ((i_198_ ^ 0xffffffff) <= (i_193_ ^ 0xffffffff) && i_198_ <= i_194_) {
							...
							if (i_199_ != -1)
								for (int i_203_ = 0; i_174_ > i_203_; i_203_++)
									if ((is[i_203_] ^ 0xffffffff) == (i_197_ ^ 0xffffffff) && is_176_[i_203_] == i_198_
											&& is_175_[i_203_] == i_196_) {
										...
										if (i_204_ != -1) {
											if (ses_181_ == null) {
												...
												ses_181_ = aClass319_5592.aShortArray4061 = Class39
														.method413(aShortArray5635, (byte) -32);
												ses_179_ = aClass319_5592.aShortArray4062 = Class39
														.method413(aShortArray5691, (byte) -32);
												ses_180_ = aClass319_5592.aShortArray4056 = Class39
														.method413(aShortArray5685, (byte) -32);
												bs_182_ = aClass319_5592.aByteArray4059 = Class270_Sub1
														.method3299(aByteArray5640, 0);
											}
											if (ses_183_ == null) {
												Class319 class319 = gldrawablemodel_173_.aClass319_5592 = new Class319();
												ses_183_ = class319.aShortArray4061 = Class39.method413(ses,
														(byte) -32);
												ses_185_ = class319.aShortArray4062 = Class39.method413(ses_177_,
														(byte) -32);
												ses_184_ = class319.aShortArray4056 = Class39.method413(ses_178_,
														(byte) -32);
											...
											i_201_ = is_187_[1 + i_203_];
											for (int i_208_ = i_200_; (i_201_ ^ 0xffffffff) < (i_208_
													^ 0xffffffff); i_208_++) {
											...
											s = ses[i_204_];
											for (int i_210_ = i_200_; (i_201_ ^ 0xffffffff) < (i_210_
													^ 0xffffffff); i_210_++) {
											...
											if (gldrawablemodel_173_.aClass69_5649 == null
													&& gldrawablemodel_173_.aClass69_5604 != null)
	...
	@Override
	public final boolean method621(int i, int i_646_, Class336 class336, boolean bool, int i_647_, int i_648_) {
		anInt5594++;
		return method639(class336, bool, 63, i_646_, i, i_648_, i_647_);
	}

	@Override
	public final void method622(Class336 class336, EntityNode_Sub5 entitynode_sub5, int i, int i_212_) {
		anInt5620++;
		if (anInt5665 != 0) {
			Class336_Sub3 class336_sub3 = aGLToolkit5692.aClass336_Sub3_6639;
			...
			Class17.aFloat275 = class336_sub3.aFloat8615 + (class336_sub3.aFloat8605 * class336_sub3_213_.aFloat8594
					+ class336_sub3_213_.aFloat8609 * class336_sub3.aFloat8593
					+ class336_sub3_213_.aFloat8615 * class336_sub3.aFloat8604);
			float f = aShort5600 * Class200_Sub1.aFloat5140 + Class17.aFloat275;
			float f_214_ = Class17.aFloat275 + aShort5671 * Class200_Sub1.aFloat5140;
			float f_215_;
			float f_216_;
			if (f > f_214_) {
				f_216_ = f_214_ - aShort5686;
				f_215_ = aShort5686 + f;
			} else {
				f_215_ = aShort5686 + f_214_;
				f_216_ = -aShort5686 + f;
			}
			if (!(aGLToolkit5692.aFloat6695 <= f_216_) && !(aGLToolkit5692.anInt6693 >= f_215_)) {
				...
				float f_217_ = aShort5600 * Class129.aFloat1663 + MainFile.aFloat144;
				float f_218_ = MainFile.aFloat144 + aShort5671 * Class129.aFloat1663;
				float f_219_;
				float f_220_;
				if (f_218_ < f_217_) {
					f_220_ = aGLToolkit5692.anInt6667 * (aShort5686 + f_217_);
					f_219_ = aGLToolkit5692.anInt6667 * (-aShort5686 + f_218_);
				} else {
					f_219_ = aGLToolkit5692.anInt6667 * (f_217_ - aShort5686);
					f_220_ = (aShort5686 + f_218_) * aGLToolkit5692.anInt6667;
				}
				if (!(f_219_ / i >= aGLToolkit5692.aFloat6674) && !(aGLToolkit5692.aFloat6711 >= f_220_ / i)) {
					...
					Class116.aFloat5076 = class336_sub3.aFloat8591 * class336_sub3_213_.aFloat8615
							...
							+ class336_sub3.aFloat8609;
					float f_221_ = Class116.aFloat5076 + aShort5600 * Class51.aFloat5343;
					float f_222_ = Class51.aFloat5343 * aShort5671 + Class116.aFloat5076;
					float f_223_;
					float f_224_;
					if (f_222_ < f_221_) {
						f_224_ = (f_222_ - aShort5686) * aGLToolkit5692.anInt6730;
						f_223_ = (f_221_ + aShort5686) * aGLToolkit5692.anInt6730;
					} else {
						f_223_ = aGLToolkit5692.anInt6730 * (aShort5686 + f_222_);
						f_224_ = (-aShort5686 + f_221_) * aGLToolkit5692.anInt6730;
					}
					if (!(f_224_ / i >= aGLToolkit5692.aFloat6663) && !(f_223_ / i <= aGLToolkit5692.aFloat6687)) {
						if (entitynode_sub5 != null || aClass72Array5627 != null) {
						...
						if (entitynode_sub5 != null) {
							...
							int i_227_ = (int) (aShort5600 * Class129.aFloat1663
									+ (Class210.aFloat2496 * i_225_ + MainFile.aFloat144)
									+ Class204.aFloat2459 * i_226_);
							int i_228_ = (int) (Class51.aFloat5343 * aShort5600
									+ (Class188_Sub1_Sub2.aFloat9346 * i_225_ + Class116.aFloat5076)
									+ Node_Sub38_Sub19.aFloat10295 * i_226_);
							int i_229_ = (int) (Class107.aFloat1361 * i_226_ + (Class200_Sub1.aFloat5140 * aShort5600
									+ (Class17.aFloat275 + i_225_ * Class155.aFloat1954)));
							int i_230_ = (int) (Class204.aFloat2459 * i_226_ + (Class129.aFloat1663 * aShort5671
									+ (MainFile.aFloat144 + Class210.aFloat2496 * i_225_)));
							int i_231_ = (int) (aShort5671 * Class51.aFloat5343
									+ (Class116.aFloat5076 + i_225_ * Class188_Sub1_Sub2.aFloat9346)
									+ Node_Sub38_Sub19.aFloat10295 * i_226_);
							int i_232_ = (int) (Class17.aFloat275 + Class155.aFloat1954 * i_225_
									+ Class200_Sub1.aFloat5140 * aShort5671 + i_226_ * Class107.aFloat1361);
							entitynode_sub5.anInt5984 = aGLToolkit5692.anInt6702
									- -(i_231_ * aGLToolkit5692.anInt6730 / i);
							entitynode_sub5.anInt5982 = aGLToolkit5692.anInt6667 * i_230_ / i
									+ aGLToolkit5692.anInt6714;
							entitynode_sub5.anInt5985 = aGLToolkit5692.anInt6714
									- -(aGLToolkit5692.anInt6667 * i_227_ / i);
							entitynode_sub5.anInt5986 = aGLToolkit5692.anInt6730 * i_228_ / i
									+ aGLToolkit5692.anInt6702;
							if ((i_229_ ^ 0xffffffff) <= (aGLToolkit5692.anInt6693 ^ 0xffffffff)
									|| (i_232_ ^ 0xffffffff) <= (aGLToolkit5692.anInt6693 ^ 0xffffffff)) {
								entitynode_sub5.aBoolean5987 = true;
								entitynode_sub5.anInt5983 = -entitynode_sub5.anInt5985
										+ (i_227_ - -aShort5686) * aGLToolkit5692.anInt6667 / i
										+ aGLToolkit5692.anInt6714;
							}
						}
						aGLToolkit5692.method1407((byte) 105, i);
	...
	@Override
	public final boolean method624(int i, int i_4_, Class336 class336, boolean bool, int i_5_) {
		anInt5701++;
		return method639(class336, bool, 96, i_4_, i, -1, i_5_);
	}

	@Override
	public final void method626(int i, int i_444_, int i_445_, int i_446_) {
		anInt5647++;
		for (int i_447_ = 0; (i_447_ ^ 0xffffffff) > (anInt5709 ^ 0xffffffff); i_447_++) {
			...
			aShortArray5693[i_447_] = (short) Node_Sub16.method2590(Node_Sub16.method2590(i_449_ << 10, i_450_ << 7),
					i_451_);
		}
		if (aClass72Array5627 != null)
			for (int i_452_ = 0; anInt5659 > i_452_; i_452_++) {
				...
				class190.anInt2335 = class190.anInt2335 & ~0xffffff
						| 0xffffff & Class85.anIntArray1158[aShortArray5693[class72.anInt975] & 0xffff];
			}
		if (aClass69_5604 != null)
			aClass69_5604.anInterface9_939 = null;
	...
	@Override
	public final void method637(int i, int[] is, int i_527_, int i_528_, int i_529_, int i_530_, boolean bool) {
		anInt5690++;
					...
					if ((i_530_ & 0x1) == 0)
						for (int i_546_ = 0; (is_545_.length ^ 0xffffffff) < (i_546_ ^ 0xffffffff); i_546_++) {
							...
							if ((i_529_ ^ 0xffffffff) != -1) {
								...
								int i_550_ = 16383
										+ (anIntArray5595[i_547_] * i_549_ + anIntArray5588[i_547_] * i_548_) >> 14;
								anIntArray5588[i_547_] = 16383 + -(anIntArray5595[i_547_] * i_548_)
										+ anIntArray5588[i_547_] * i_549_ >> 14;
							...
							if ((i_527_ ^ 0xffffffff) != -1) {
								...
								int i_553_ = i_552_ * anIntArray5588[i_547_]
										- (anIntArray5637[i_547_] * i_551_ + -16383) >> 14;
								anIntArray5637[i_547_] = 16383
										+ (i_551_ * anIntArray5588[i_547_] + i_552_ * anIntArray5637[i_547_]) >> 14;
							...
							if ((i_528_ ^ 0xffffffff) != -1) {
								...
								int i_556_ = 16383
										+ (i_555_ * anIntArray5595[i_547_] + i_554_ * anIntArray5637[i_547_]) >> 14;
								anIntArray5637[i_547_] = 16383
										+ (anIntArray5637[i_547_] * i_555_ + -(i_554_ * anIntArray5595[i_547_])) >> 14;
						...
						for (int i_557_ = 0; (is_545_.length ^ 0xffffffff) < (i_557_ ^ 0xffffffff); i_557_++) {
							...
							if ((i_527_ ^ 0xffffffff) != -1) {
								...
								int i_561_ = -(i_559_ * anIntArray5637[i_558_])
										+ (anIntArray5588[i_558_] * i_560_ - -16383) >> 14;
								anIntArray5637[i_558_] = 16383 + anIntArray5637[i_558_] * i_560_
										+ anIntArray5588[i_558_] * i_559_ >> 14;
								anIntArray5588[i_558_] = i_561_;
							}
							if ((i_529_ ^ 0xffffffff) != -1) {
								int i_562_ = Class335.anIntArray4167[i_529_];
								int i_563_ = Class335.anIntArray4165[i_529_];
								int i_564_ = i_563_ * anIntArray5595[i_558_]
										+ (anIntArray5588[i_558_] * i_562_ + 16383) >> 14;
								anIntArray5588[i_558_] = anIntArray5588[i_558_] * i_563_
										+ -(i_562_ * anIntArray5595[i_558_]) + 16383 >> 14;
							...
							if (i_528_ != 0) {
								...
								int i_567_ = 16383
										+ (anIntArray5637[i_558_] * i_565_ + i_566_ * anIntArray5595[i_558_]) >> 14;
								anIntArray5637[i_558_] = 16383 + -(i_565_ * anIntArray5595[i_558_])
										+ i_566_ * anIntArray5637[i_558_] >> 14;
						...
						for (int i_572_ : is_570_) {
							...
							for (int i_575_ = i_573_; (i_574_ ^ 0xffffffff) < (i_575_ ^ 0xffffffff); i_575_++) {
								...
								if ((i_529_ ^ 0xffffffff) != -1) {
									...
									int i_579_ = i_577_ * aShortArray5691[i_576_]
											- (-(aShortArray5635[i_576_] * i_578_) - 16383) >> 14;
									aShortArray5691[i_576_] = (short) (-(aShortArray5635[i_576_] * i_577_)
											+ (aShortArray5691[i_576_] * i_578_ + 16383) >> 14);
									aShortArray5635[i_576_] = (short) i_579_;
								}
								if ((i_527_ ^ 0xffffffff) != -1) {
									int i_580_ = Class335.anIntArray4167[i_527_];
									int i_581_ = Class335.anIntArray4165[i_527_];
									int i_582_ = 16383 + (i_581_ * aShortArray5691[i_576_]
											+ -(i_580_ * aShortArray5685[i_576_])) >> 14;
									aShortArray5685[i_576_] = (short) (16383 + (aShortArray5685[i_576_] * i_581_
											+ aShortArray5691[i_576_] * i_580_) >> 14);
									aShortArray5691[i_576_] = (short) i_582_;
								}
								if ((i_528_ ^ 0xffffffff) != -1) {
									int i_583_ = Class335.anIntArray4167[i_528_];
									int i_584_ = Class335.anIntArray4165[i_528_];
									int i_585_ = 16383 + i_584_ * aShortArray5635[i_576_]
											+ aShortArray5685[i_576_] * i_583_ >> 14;
									aShortArray5685[i_576_] = (short) (16383 + (aShortArray5685[i_576_] * i_584_
											+ -(i_583_ * aShortArray5635[i_576_])) >> 14);
			...
			if (anIntArrayArray5591 != null) {
				...
				if (aClass72Array5627 != null)
					for (int i_597_ = 0; (i_597_ ^ 0xffffffff) > (anInt5659 ^ 0xffffffff); i_597_++) {
						...
						class190.anInt2335 = 0xffffff & class190.anInt2335
								| 255 + -(0xff & aByteArray5658[class72.anInt975]) << 24;
					}
			}
		} else if (i == 7) {
			if (anIntArrayArray5591 != null) {
					...
					if (i_599_ < anIntArrayArray5591.length) {
						...
						for (int i_601_ = 0; (is_600_.length ^ 0xffffffff) < (i_601_ ^ 0xffffffff); i_601_++) {
							...
							if ((i_606_ ^ 0xffffffff) <= -1) {
								...
								i_606_ = 0;
							aShortArray5693[i_602_] = (short) Node_Sub16
									.method2590(Node_Sub16.method2590(i_604_ << 10, i_605_ << 7), i_606_);
						}
				...
				if (aClass72Array5627 != null)
					for (int i_607_ = 0; (i_607_ ^ 0xffffffff) > (anInt5659 ^ 0xffffffff); i_607_++) {
						...
						class190.anInt2335 = class190.anInt2335 & ~0xffffff
								| Class85.anIntArray1158[aShortArray5693[class72.anInt975] & 0xffff] & 0xffffff;
					}
			}
			...
			if (anIntArrayArray5615 != null)
				for (int i_612_ = 0; (i_612_ ^ 0xffffffff) > (i_531_ ^ 0xffffffff); i_612_++) {
					...
					if ((i_613_ ^ 0xffffffff) > (anIntArrayArray5615.length ^ 0xffffffff)) {
						...
						for (int element : is_614_) {
							Class190 class190 = aClass190Array5674[element];
	...
	private final boolean method639(Class336 class336, boolean bool, int i, int i_6_, int i_7_, int i_8_, int i_9_) {
		...
		float f = class336_sub3_10_.aFloat8594 + (class336_sub3.aFloat8609 * class336_sub3_10_.aFloat8608
				+ class336_sub3.aFloat8594 * class336_sub3_10_.aFloat8596
				+ class336_sub3_10_.aFloat8617 * class336_sub3.aFloat8615);
		float f_11_ = class336_sub3_10_.aFloat8609 + (class336_sub3_10_.aFloat8607 * class336_sub3.aFloat8609
		...
		float f_12_ = class336_sub3_10_.aFloat8615 + (class336_sub3_10_.aFloat8605 * class336_sub3.aFloat8594
		...
		KeyStrokeHandler.anIntArray8193[0] = i_28_;
		Class339_Sub4.anIntArray8668[1] = i_27_;
		KeyStrokeHandler.anIntArray8193[1] = i_28_;
		Class320_Sub18.anIntArray8382[2] = i_26_;
		Class339_Sub4.anIntArray8668[2] = i_30_;
		Class320_Sub18.anIntArray8382[3] = i_29_;
		KeyStrokeHandler.anIntArray8193[2] = i_28_;
		Class339_Sub4.anIntArray8668[3] = i_30_;
		Class320_Sub18.anIntArray8382[4] = i_26_;
		KeyStrokeHandler.anIntArray8193[3] = i_28_;
		Class339_Sub4.anIntArray8668[4] = i_27_;
		Class320_Sub18.anIntArray8382[5] = i_29_;
		KeyStrokeHandler.anIntArray8193[4] = i_31_;
		Class339_Sub4.anIntArray8668[5] = i_27_;
		Class320_Sub18.anIntArray8382[6] = i_26_;
		KeyStrokeHandler.anIntArray8193[5] = i_31_;
		Class339_Sub4.anIntArray8668[6] = i_30_;
		Class320_Sub18.anIntArray8382[7] = i_29_;
		KeyStrokeHandler.anIntArray8193[6] = i_31_;
		Class339_Sub4.anIntArray8668[7] = i_30_;
		KeyStrokeHandler.anIntArray8193[7] = i_31_;
		for (int i_32_ = 0; i_32_ < 8; i_32_++) {
			float f_33_ = Class320_Sub18.anIntArray8382[i_32_];
			float f_34_ = Class339_Sub4.anIntArray8668[i_32_];
			float f_35_ = KeyStrokeHandler.anIntArray8193[i_32_];
			float f_36_ = f + (f_33_ * Class210.aFloat2496 + Class129.aFloat1663 * f_34_ + f_35_ * Class204.aFloat2459);
			float f_37_ = Class200_Sub1.aFloat5140 * f_34_ + f_33_ * Class155.aFloat1954 + f_35_ * Class107.aFloat1361
					+ f_12_;
			float f_38_ = f_11_ + (f_35_ * Node_Sub38_Sub19.aFloat10295
					+ (Class188_Sub1_Sub2.aFloat9346 * f_33_ + Class51.aFloat5343 * f_34_));
			if (f_37_ >= aGLToolkit5692.anInt6693) {
				if (i_8_ > 0)
					f_37_ = i_8_;
				float f_39_ = aGLToolkit5692.anInt6714 + i_18_ * f_36_ / f_37_;
				float f_40_ = i_19_ * f_38_ / f_37_ + aGLToolkit5692.anInt6702;
				if (f_14_ > f_39_)
					f_14_ = f_39_;
				if (f_15_ < f_39_)
					f_15_ = f_39_;
		...
		if (bool_13_ && i_7_ > f_14_ && i_7_ < f_15_ && f_16_ < i_6_ && i_6_ < f_17_) {
			if (bool)
				return true;
			...
			for (int i_42_ = 0; i_42_ < anInt5672; i_42_++) {
				float f_43_ = anIntArray5595[i_42_];
				float f_44_ = anIntArray5637[i_42_];
				float f_45_ = anIntArray5588[i_42_];
				float f_46_ = f_12_ + (Class107.aFloat1361 * f_44_
						+ (f_45_ * Class200_Sub1.aFloat5140 + f_43_ * Class155.aFloat1954));
				float f_47_ = f_45_ * Class129.aFloat1663 + Class210.aFloat2496 * f_43_ + f_44_ * Class204.aFloat2459
						+ f;
				float f_48_ = Class188_Sub1_Sub2.aFloat9346 * f_43_ + Class51.aFloat5343 * f_45_
						+ f_44_ * Node_Sub38_Sub19.aFloat10295 + f_11_;
				if (f_46_ >= aGLToolkit5692.anInt6693) {
					if (i_8_ > 0)
						f_46_ = i_8_;
					int i_49_ = (int) (i_18_ * f_47_ / f_46_ + aGLToolkit5692.anInt6714);
					int i_50_ = (int) (aGLToolkit5692.anInt6702 + i_19_ * f_48_ / f_46_);
			...
			for (int i_59_ = 0; i_59_ < anInt5709; i_59_++)
				if ((is[aShortArray5622[i_59_]] ^ 0xffffffff) != 999998 && is[aShortArray5683[i_59_]] != -999999
						&& is[aShortArray5706[i_59_]] != -999999
						&& method647(is[aShortArray5683[i_59_]], is[aShortArray5622[i_59_]],
								is_41_[aShortArray5706[i_59_]], i_7_, 46, is_41_[aShortArray5683[i_59_]],
								is[aShortArray5706[i_59_]], is_41_[aShortArray5622[i_59_]], i_6_))
					return true;
		}
		return false;
	}
	...
	private final void method640(byte b) {
		...
		aShort5686 = (short) (int) (0.99 + Math.sqrt(i_66_));
		aShort5610 = (short) (int) (Math.sqrt(i_67_) + 0.99);
		aBoolean5698 = true;
	}
	...
	private final void method641(byte b) {
		...
		if (aBoolean5611) {
			aBoolean5611 = false;
			if (aClass300Array5681 == null && aClass218Array5596 == null && aClass72Array5627 == null
					&& !ProducingGraphicsBuffer.method2603(anInt5653, false, anInt5639)) {
				boolean bool = false;
			...
			if (aShortArray5622 != null && !Node_Sub25_Sub3.method2674(anInt5639, 393216, anInt5653))
				if ((aClass107_5675 == null || aClass107_5675.anInterface1_1365 != null)
						&& (aClass69_5604 == null || aClass69_5604.anInterface9_939 != null))
			...
			if (b == -122) {
				...
				if (anIntArray5687 != null && (anInt5639 & 0x800 ^ 0xffffffff) == -1
						&& (0x40000 & anInt5639 ^ 0xffffffff) == -1)
					anIntArray5687 = null;
			}
		}
	}
	...
	private final void method642(byte b) {
		...
		if (aClass72Array5627 != null) {
			...
			aGLToolkit5692.method1482((byte) 113, null, null, aGLToolkit5692.aClass69_6681,
					aGLToolkit5692.aClass69_6698);
			for (int i = 0; i < anInt5659; i++) {
				Class72 class72 = aClass72Array5627[i];
				Class190 class190 = aClass190Array5674[i];
				if (!class72.aBoolean978 || !aGLToolkit5692.w()) {
					float f = 0.3333333F * (anIntArray5595[class72.anInt979]
							+ (anIntArray5595[class72.anInt969] - -anIntArray5595[class72.anInt977]));
					float f_87_ = 0.3333333F * (anIntArray5588[class72.anInt969] + anIntArray5588[class72.anInt977]
							+ anIntArray5588[class72.anInt979]);
					float f_88_ = (anIntArray5637[class72.anInt969]
							- (-anIntArray5637[class72.anInt977] + -anIntArray5637[class72.anInt979])) * 0.3333333F;
					float f_89_ = MainFile.aFloat144
							+ (f_88_ * Class204.aFloat2459 + (Class210.aFloat2496 * f + f_87_ * Class129.aFloat1663));
					float f_90_ = Class116.aFloat5076 + (Node_Sub38_Sub19.aFloat10295 * f_88_
							+ (Class51.aFloat5343 * f_87_ + Class188_Sub1_Sub2.aFloat9346 * f));
					float f_91_ = f_87_ * Class200_Sub1.aFloat5140 + Class155.aFloat1954 * f
							+ Class107.aFloat1361 * f_88_ + Class17.aFloat275;
					float f_92_ = (float) (1.0 / Math.sqrt(f_91_ * f_91_ + (f_89_ * f_89_ + f_90_ * f_90_)))
							* class72.anInt976;
					class336_sub3.method3897((byte) 99, class190.anInt2339 * class72.aShort968 >> 7,
							-(f_92_ * f_89_) + (class190.anInt2337 + f_89_), class190.anInt2333,
							class72.aShort972 * class190.anInt2332 >> 7, f_92_ * f_91_ + -f_91_,
							f_90_ * f_92_ + (class190.anInt2329 - f_90_));
	...
	private final int method643(boolean bool, byte b, int i, int i_94_, short s) {
		...
		if ((s ^ 0xffffffff) != 0) {
			PlayerMasks class91 = aGLToolkit5692.aD1543.method10(0xffff & s, -8217);
			...
			if ((i_96_ ^ 0xffffffff) != -1) {
				...
				if (i_96_ == 256)
					...
					int i_98_ = i_96_;
					int i_99_ = -i_96_ + 256;
					i_95_ = (0xff0000 & (i_95_ & 0xff00) * i_99_ + i_98_ * (i_97_ & 0xff00))
							+ ((0xff00ff & i_95_) * i_99_ + (0xff00ff & i_97_) * i_98_ & ~0xff00ff) >> 8;
				}
			}
	...
	private final void method645(r_Sub2 var_r_Sub2, boolean bool) {
		...
		for (int i = 0; (anInt5672 ^ 0xffffffff) < (i ^ 0xffffffff); i++) {
			int i_109_ = -var_r_Sub2.anInt11064 + (anIntArray5595[i]
					- (anIntArray5588[i] * aGLToolkit5692.anInt6732 >> 8) >> aGLToolkit5692.anInt6611);
			int i_110_ = -var_r_Sub2.anInt11067 + (anIntArray5637[i]
					+ -(aGLToolkit5692.anInt6717 * anIntArray5588[i] >> 8) >> aGLToolkit5692.anInt6611);
			...
			if (aClass107_5675 != null) {
				...
				if (aClass107_5675.anInterface1_1365 != null) {
					...
					for (int i_126_ = 0; i_126_ < i; i_126_++) {
						...
						aGLToolkit5692.method1477((byte) 110, i_127_ * 3, 4, aClass107_5675.anInterface1_1365,
								3 * (i_128_ + -i_127_));
					}
				}
			}
	...
	private final boolean method647(int i, int i_130_, int i_131_, int i_132_, int i_133_, int i_134_, int i_135_,
			int i_136_, int i_137_) {
		anInt5623++;
		if ((i_136_ ^ 0xffffffff) < (i_137_ ^ 0xffffffff) && i_134_ > i_137_
				&& (i_137_ ^ 0xffffffff) > (i_131_ ^ 0xffffffff))
			return false;
		if ((i_136_ ^ 0xffffffff) > (i_137_ ^ 0xffffffff) && i_134_ < i_137_
				&& (i_137_ ^ 0xffffffff) < (i_131_ ^ 0xffffffff))
			return false;
		if ((i_130_ ^ 0xffffffff) < (i_132_ ^ 0xffffffff) && (i ^ 0xffffffff) < (i_132_ ^ 0xffffffff)
				&& (i_132_ ^ 0xffffffff) > (i_135_ ^ 0xffffffff))
			return false;
	...
	private final void method648(boolean bool, int i) {
		if ((6 * anInt5616 ^ 0xffffffff) >= (aGLToolkit5692.aFloatBuffer6661.buffer.length ^ 0xffffffff))
			...
			aGLToolkit5692.aFloatBuffer6661 = new PacketDecoder((anInt5616 - -100) * 6);
		anInt5632++;
		PacketDecoder floatbuffer = aGLToolkit5692.aFloatBuffer6661;
		...
		if ((floatbuffer.offset ^ 0xffffffff) != -1) {
			if (!bool)
				aClass107_5675.anInterface1_1365 = aGLToolkit5692.method1453(26099, false, floatbuffer.offset, 5123,
						floatbuffer.buffer);
			else {
				if (anInterface1_5643 != null)
					anInterface1_5643.method4(5123, floatbuffer.offset, floatbuffer.buffer, 2712);
				else
					anInterface1_5643 = aGLToolkit5692.method1453(26099, true, floatbuffer.offset, 5123,
							floatbuffer.buffer);
	...
	private final void method649(boolean bool, byte b) {
		...
		if (b_457_ != 0) {
			if (aGLToolkit5692.aFloatBuffer6661.buffer.length >= b_457_ * anInt5665)
				...
				aGLToolkit5692.aFloatBuffer6661 = new PacketDecoder(b_457_ * (anInt5665 + 100));
			PacketDecoder floatbuffer = aGLToolkit5692.aFloatBuffer6661;
			if (bool_455_)
				if (!aGLToolkit5692.aBoolean6736)
					for (int i = 0; (anInt5672 ^ 0xffffffff) < (i ^ 0xffffffff); i++) {
						int i_462_ = Stream.floatToRawIntBits(anIntArray5595[i]);
						int i_463_ = Stream.floatToRawIntBits(anIntArray5588[i]);
						int i_464_ = Stream.floatToRawIntBits(anIntArray5637[i]);
					...
					for (int i = 0; (anInt5672 ^ 0xffffffff) < (i ^ 0xffffffff); i++) {
						int i_469_ = Stream.floatToRawIntBits(anIntArray5595[i]);
						int i_470_ = Stream.floatToRawIntBits(anIntArray5588[i]);
						int i_471_ = Stream.floatToRawIntBits(anIntArray5637[i]);
			...
			if (bool_453_)
				if (aClass69_5649 == null) {
					...
					float f_481_ = aGLToolkit5692.aFloat6645 * 768.0F / aShort5664;
					float f_482_ = aGLToolkit5692.aFloat6648 * 768.0F / aShort5664;
					for (int i = 0; i < anInt5709; i++) {
						int i_483_ = method643(false, aByteArray5658[i], aShortArray5693[i], aShort5608,
								aShortArray5699[i]);
						int i_484_ = aShortArray5622[i];
						float f_485_ = ((0xff8c9e & i_483_) >> 16) * aGLToolkit5692.aFloat6707;
						float f_486_ = (0xff & i_483_ >> 8) * aGLToolkit5692.aFloat6672;
						float f_487_ = (i_483_ >>> 24) * aGLToolkit5692.aFloat6734;
						short s = bs[i_484_];
						float f_488_;
						if ((s ^ 0xffffffff) == -1)
							f_488_ = (f_479_ * ses[i_484_] + (f * ses_477_[i_484_] + f_478_ * ses_476_[i_484_]))
									* 0.0026041667F;
						else
							f_488_ = (f_479_ * ses[i_484_] + (f_478_ * ses_476_[i_484_] + ses_477_[i_484_] * f))
									/ (256 * s);
						...
						s = bs[i_484_];
						if ((s ^ 0xffffffff) == -1)
							f_488_ = 0.0026041667F
									* (f_479_ * ses[i_484_] + (ses_476_[i_484_] * f_478_ + ses_477_[i_484_] * f));
						else
							f_488_ = (f * ses_477_[i_484_] + ses_476_[i_484_] * f_478_ + f_479_ * ses[i_484_])
									/ (s * 256);
						...
						s = bs[i_484_];
						if (s != 0)
							f_488_ = (ses_477_[i_484_] * f + f_478_ * ses_476_[i_484_] + f_479_ * ses[i_484_])
									/ (s * 256);
						else
							f_488_ = 0.0026041667F
									* (f_479_ * ses[i_484_] + (ses_477_[i_484_] * f + f_478_ * ses_476_[i_484_]));
						f_489_ = f_480_ + (f_488_ < 0.0F ? f_482_ : f_481_) * f_488_;
						i_490_ = (int) (f_489_ * f_487_);
					...
					for (int i = 0; i < anInt5709; i++) {
						int i_493_ = method643(false, aByteArray5658[i], aShortArray5693[i], aShort5608,
								aShortArray5699[i]);
			...
			if (bool_454_) {
				...
				float f = 3.0F / aShort5664;
				floatbuffer.offset = b_460_;
				float f_496_ = 3.0F / (aShort5664 / 2 + aShort5664);
				if (aGLToolkit5692.aBoolean6736)
					for (int i = 0; (anInt5665 ^ 0xffffffff) < (i ^ 0xffffffff); i++) {
						int i_497_ = bs[i] & 0xff;
						if (i_497_ == 0) {
							floatbuffer.method2251(8, ses_494_[i] * f_496_);
							floatbuffer.method2251(8, f_496_ * ses[i]);
							floatbuffer.method2251(b + -33, f_496_ * ses_495_[i]);
						} else {
							float f_498_ = f / i_497_;
							floatbuffer.method2251(8, f_498_ * ses_494_[i]);
							floatbuffer.method2251(8, f_498_ * ses[i]);
							floatbuffer.method2251(8, ses_495_[i] * f_498_);
						}
					...
					for (int i = 0; (anInt5665 ^ 0xffffffff) < (i ^ 0xffffffff); i++) {
						...
						if ((i_499_ ^ 0xffffffff) != -1) {
							float f_500_ = f / i_499_;
							floatbuffer.method2252(-229385392, f_500_ * ses_494_[i]);
							floatbuffer.method2252(-229385392, f_500_ * ses[i]);
							floatbuffer.method2252(-229385392, f_500_ * ses_495_[i]);
						} else {
							floatbuffer.method2252(-229385392, f_496_ * ses_494_[i]);
							floatbuffer.method2252(-229385392, f_496_ * ses[i]);
							floatbuffer.method2252(-229385392, f_496_ * ses_495_[i]);
						}
			...
			if (bool) {
				if (anInterface9_5696 == null)
					anInterface9_5696 = aGLToolkit5692.method1467(true, floatbuffer.offset, floatbuffer.buffer, b_457_,
							b + -87);
				else
	...
	private final DrawableModel method650(GLDrawableModel gldrawablemodel_502_, int i, boolean bool, boolean bool_503_,
			int i_504_, GLDrawableModel gldrawablemodel_505_) {
		...
		if (!bool_509_) {
			...
			if (bool_506_) {
				if (gldrawablemodel_502_.anIntArray5595 != null
						&& (gldrawablemodel_502_.anIntArray5595.length ^ 0xffffffff) <= (anInt5644 ^ 0xffffffff))
			...
			if (!bool_507_)
				gldrawablemodel_505_.anIntArray5588 = anIntArray5588;
			else if (gldrawablemodel_502_.anIntArray5588 == null
					|| (anInt5644 ^ 0xffffffff) < (gldrawablemodel_502_.anIntArray5588.length ^ 0xffffffff))
			...
			if (!bool_508_)
				gldrawablemodel_505_.anIntArray5637 = anIntArray5637;
			else if (gldrawablemodel_502_.anIntArray5637 == null
					|| gldrawablemodel_502_.anIntArray5637.length < anInt5644)
		...
		if (Class320_Sub7.method3711((byte) 46, i_504_, anInt5653)) {
			if (gldrawablemodel_502_.aByteArray5658 == null
					|| (gldrawablemodel_502_.aByteArray5658.length ^ 0xffffffff) > (anInt5709 ^ 0xffffffff))
		...
		if (!LoadingBarStage.method1135(i_504_, anInt5653, false)) {
		...
		if (!Class73.method749((byte) -65, i_504_, anInt5653)) {
			...
			if (gldrawablemodel_502_.aShortArray5635 != null
					&& (anInt5665 ^ 0xffffffff) >= (gldrawablemodel_502_.aShortArray5635.length ^ 0xffffffff)) {
			...
			if (aClass319_5592 != null) {
				...
				if (class319.aShortArray4061 == null
						|| (anInt5665 ^ 0xffffffff) < (class319.aShortArray4061.length ^ 0xffffffff)) {
		...
		if (PacketDecoder.method2248(i_504_, anInt5653, 96)) {
		...
		if (Class377.method4127(anInt5653, i ^ ~0x7c03, i_504_)) {
			if (gldrawablemodel_502_.aFloatArray5609 != null
					&& anInt5709 <= gldrawablemodel_502_.aFloatArray5609.length) {
		...
		if (Class262_Sub16.method3193(anInt5653, i_504_, (byte) -61)) {
			if (gldrawablemodel_502_.aShortArray5622 == null
					|| (anInt5709 ^ 0xffffffff) < (gldrawablemodel_502_.aShortArray5622.length ^ 0xffffffff)) {
		...
		if (!Class150_Sub3.method1663((byte) -20, i_504_, anInt5653))
			...
			if (gldrawablemodel_502_.aShortArray5699 != null
					&& gldrawablemodel_502_.aShortArray5699.length >= anInt5709)
		...
		else if (gldrawablemodel_502_.aClass190Array5674 == null
				|| anInt5659 > gldrawablemodel_502_.aClass190Array5674.length) {
	...
	private final short method651(long l, int i, float f, float f_649_, int i_650_, int i_651_, int i_652_, Model model,
			int i_653_, int i_654_) {
		anInt5705++;
		if (i_650_ != 13)
	...
	@Override
	public final void O(int i, int i_73_, int i_74_) {
	...
	@Override
	public final void p(int i, int i_620_, Plane plane, Plane plane_621_, int i_622_, int i_623_, int i_624_) {
		anInt5638++;
		if (!aBoolean5698)
			method640((byte) 20);
		...
		if (i != 1 && i != 2 && (i ^ 0xffffffff) != -4 && (i ^ 0xffffffff) != -6 || i_625_ >= 0
				&& plane.anInt3408 > plane.anInt3398 + i_626_ >> plane.anInt3410 && (i_627_ ^ 0xffffffff) <= -1
			...
			if ((i ^ 0xffffffff) != -5 && (i ^ 0xffffffff) != -6) {
				...
				if (plane.method3251(i_627_, i_625_, (byte) -118) == i_623_
						&& i_623_ == plane.method3251(i_627_, i_626_, (byte) -118)
						&& (plane.method3251(i_628_, i_625_, (byte) -118) ^ 0xffffffff) == (i_623_ ^ 0xffffffff)
						&& (i_623_ ^ 0xffffffff) == (plane.method3251(i_628_, i_626_, (byte) -118) ^ 0xffffffff))
					return;
			} else if (plane_621_ == null || (i_625_ < 0
					|| plane_621_.anInt3408 <= i_626_ + plane_621_.anInt3398 >> plane_621_.anInt3410 || i_627_ < 0
					|| (plane_621_.anInt3404 ^ 0xffffffff) >= (plane_621_.anInt3398 + i_628_ >> plane_621_.anInt3410
							^ 0xffffffff)))
				return;
			if (i != 1) {
				if (i == 2) {
					...
					for (int i_630_ = 0; (anInt5672 ^ 0xffffffff) < (i_630_ ^ 0xffffffff); i_630_++) {
						...
						if (i_631_ < i_620_)
							anIntArray5588[i_630_] = anIntArray5588[i_630_]
									+ (-i_623_ + plane.method3260(anIntArray5637[i_630_] - -i_624_, -123,
											anIntArray5595[i_630_] + i_622_)) * (i_620_ - i_631_) / i_620_;
					}
				} else if (i == 3) {
					...
					if ((-(i_632_ >> 1) + i_622_ ^ 0xffffffff) > -1
							|| plane.anInt3408 << plane.anInt3410 <= (i_632_ >> 1) + i_622_ + plane.anInt3398
							|| -(i_633_ >> 1) + i_624_ < 0 || (i_624_ - -(i_633_ >> 1) - -plane.anInt3398
									^ 0xffffffff) <= (plane.anInt3404 << plane.anInt3410 ^ 0xffffffff))
						return;
					...
					if (i == 5) {
						...
						for (int i_637_ = 0; i_637_ < anInt5672; i_637_++) {
							...
							anIntArray5588[i_637_] = (i_642_ * ((anIntArray5588[i_637_] << 8) / i_636_) >> 8)
									+ (i_640_ + -i_623_);
						}
					}
				} else {
					...
					for (int i_644_ = 0; anInt5672 > i_644_; i_644_++)
						anIntArray5588[i_644_] = i_643_ + anIntArray5588[i_644_]
								- (-plane_621_.method3260(anIntArray5637[i_644_] + i_624_, -123,
										i_622_ + anIntArray5595[i_644_]) - -i_623_);
				}
			} else
				for (int i_645_ = 0; anInt5672 > i_645_; i_645_++)
					anIntArray5588[i_645_] = -i_623_ + anIntArray5588[i_645_]
							+ plane.method3260(i_624_ + anIntArray5637[i_645_], -109, i_622_ + anIntArray5595[i_645_]);
			aBoolean5698 = false;
			if (aClass69_5654 != null)
				aClass69_5654.anInterface9_939 = null;
		}
	...
	@Override
	public final void P(int i, int i_233_, int i_234_, int i_235_) {
		anInt5593++;
		if ((i ^ 0xffffffff) == -1) {
			Class270_Sub2_Sub1.anInt10546 = 0;
			int i_236_ = 0;
			...
			for (int i_239_ = 0; (anInt5672 ^ 0xffffffff) < (i_239_ ^ 0xffffffff); i_239_++) {
				...
				if (i_235_ != 0) {
					...
					anIntArray5588[i_239_] = -(anIntArray5595[i_239_] * i_240_) + i_241_ * anIntArray5588[i_239_]
							+ 16383 >> 14;
				...
				if (i_233_ != 0) {
					...
					anIntArray5637[i_239_] = i_244_ * anIntArray5637[i_239_] + anIntArray5588[i_239_] * i_243_
							- -16383 >> 14;
				...
				if (i_234_ != 0) {
					...
					anIntArray5637[i_239_] = anIntArray5637[i_239_] * i_247_ - i_246_ * anIntArray5595[i_239_]
							+ 16383 >> 14;
			...
			if (aClass72Array5627 != null)
				for (int i_252_ = 0; (i_252_ ^ 0xffffffff) > (anInt5659 ^ 0xffffffff); i_252_++) {
					...
					class190.anInt2335 = 0xffffff & class190.anInt2335
							| -(0xff & aByteArray5658[class72.anInt975]) + 255 << 24;
				}
			...
			for (int i_253_ = 0; (anInt5709 ^ 0xffffffff) < (i_253_ ^ 0xffffffff); i_253_++) {
				...
				if ((i_257_ ^ 0xffffffff) > -1)
					...
					i_257_ = 127;
				aShortArray5693[i_253_] = (short) Node_Sub16.method2590(i_257_,
						Node_Sub16.method2590(i_255_ << 10, i_256_ << 7));
			}
			if (aClass69_5604 != null)
				aClass69_5604.anInterface9_939 = null;
			if (aClass72Array5627 != null)
