...
public class GLPlane extends Plane {
	public static boolean[][] aBooleanArrayArray7950 = {
	...
	public static final char method3264(char c, boolean bool) {
		anInt7927++;
		if (c == 198)
			return 'E';
		if (c == 230)
	...
	GLPlane(GLToolkit gltoolkit, int i, int i_126_, int i_127_, int i_128_, int[][] is, int[][] is_129_, int i_130_) {
		...
		for (int i_131_ = 1; (anInt3404 ^ 0xffffffff) < (i_131_ ^ 0xffffffff); i_131_++)
			for (int i_132_ = 1; (i_132_ ^ 0xffffffff) > (anInt3408 ^ 0xffffffff); i_132_++) {
				...
				float f = (float) (1.0 / Math.sqrt(i_134_ * i_134_ + (i_130_ * (4 * i_130_) + i_133_ * i_133_)));
				aFloatArrayArray7946[i_132_][i_131_] = i_133_ * f;
				aFloatArrayArray7947[i_132_][i_131_] = -i_130_ * 2 * f;
				aFloatArrayArray7957[i_132_][i_131_] = f * i_134_;
			}
	...
	@Override
	public final void CA(r var_r, int i, int i_31_, int i_32_, int i_33_, boolean bool) {
		anInt7939++;
	...
	@Override
	public final r fa(int i, int i_172_, r var_r) {
		anInt7917++;
	...
	@Override
	public final void ka(int i, int i_114_, int i_115_) {
	...
	@Override
	public final void method3253(int i, int i_175_, int[] is, int[] is_176_, int[] is_177_, int[] is_178_, int[] is_179_,
			int[] is_180_, int[] is_181_, int[] is_182_, int[] is_183_, int[] is_184_, int[] is_185_, int i_186_,
			int i_187_, int i_188_, boolean bool) {
		anInt7935++;
		...
		U(i, i_175_, is_190_, is_196_, is_191_, is_197_, is_192_, is_193_, is_194_, is_195_, i_186_, i_187_, i_188_,
				bool);
	}

	@Override
	public final void method3255(int i, int i_16_, int i_17_, int i_18_, int i_19_, int i_20_, int i_21_, boolean[][] bools) {
		anInt7912++;
		if (anInt7948 > 0) {
			...
			Node_Sub9_Sub5.aFloatArray9765[5] = i_17_ / (128.0F * anInt3398 * aGLToolkit7926.anInt6567);
			Node_Sub9_Sub5.aFloatArray9765[0] = i_17_ / (aGLToolkit7926.anInt6474 * (128.0F * anInt3398));
			...
			Node_Sub9_Sub5.aFloatArray9765[13] = 1.0F - (i_17_ * i_21_ / 128.0F + i_16_ * 2) / aGLToolkit7926.anInt6567;
			...
			Node_Sub9_Sub5.aFloatArray9765[12] = -((-(2 * i) + i_17_ * i_18_ / 128.0F) / aGLToolkit7926.anInt6474)
					+ -1.0F;
			...
			if (aGLToolkit7926.aFloatBuffer6661.buffer.length >= 2 * anInt7919)
				...
				aGLToolkit7926.aFloatBuffer6661 = new PacketDecoder(anInt7919 * 2);
			int i_22_ = 0;
			PacketDecoder floatbuffer = aGLToolkit7926.aFloatBuffer6661;
			...
			if (i_22_ > 0) {
				Class200_Sub2 class200_sub2 = new Class200_Sub2(aGLToolkit7926, 5123, floatbuffer.buffer,
						floatbuffer.offset);
	...
	@Override
	public final boolean method3256(r var_r, int i, int i_121_, int i_122_, int i_123_, boolean bool) {
		anInt7940++;
		if (aClass137_7931 == null || var_r == null)
			return false;
	...
	@Override
	public final void method3257(int i, int i_113_) {
		anInt7942++;
	}

	@Override
	public final void method3259(int i, int i_149_, int i_150_, boolean[][] bools, boolean bool, int i_151_, int i_152_) {
		anInt7930++;
	...
	private final void method3262(boolean bool, boolean[][] bools, int i, int i_153_, int i_154_, int i_155_,
		...
		if (aNode_Sub33Array7955 != null) {
			...
			if ((i_154_ ^ 0xffffffff) == 0)
				...
				aGLToolkit7926.method1407((byte) -111, i_154_);
			...
			if (!aClass312_7914.method3616(0)) {
				...
				for (Node node = aClass312_7914.method3613(65280); node != null; node = aClass312_7914
						.method3620(16776960)) {
	...
	@Override
	public final void U(int i, int i_135_, int[] is, int[] is_136_, int[] is_137_, int[] is_138_, int[] is_139_, int[] is_140_,
			int[] is_141_, int[] is_142_, int i_143_, int i_144_, int i_145_, boolean bool) {
		anInt7922++;
		...
		for (int i_146_ = 0; i_146_ < is_139_.length; i_146_++) {
			...
			long l = i_147_ | ((long) i_145_ << 48 | (long) i_144_ << 42 | (long) i_143_ << 28 | i_148_ << 14);
			Node node;
			for (node = aHashTable7949.getNode(3512, l); node != null; node = aHashTable7949.method1524((byte) 84)) {
				Node_Sub33 node_sub33 = (Node_Sub33) node;
				if ((node_sub33.anInt7400 ^ 0xffffffff) == (i_147_ ^ 0xffffffff) && i_148_ == node_sub33.aFloat7389
						&& (i_143_ ^ 0xffffffff) == (node_sub33.anInt7401 ^ 0xffffffff)
						&& node_sub33.anInt7403 == i_144_
						&& (node_sub33.anInt7392 ^ 0xffffffff) == (i_145_ ^ 0xffffffff))
					break;
			}
			if (node != null)
	...
	@Override
	public final void wa(r var_r, int i, int i_116_, int i_117_, int i_118_, boolean bool) {
		anInt7928++;
		if (aClass137_7931 != null && var_r != null) {
		...
		if (anInt7948 <= 0)
			...
			for (int i = 1; i < anInt3408; i++)
				for (int i_36_ = 1; i_36_ < anInt3404; i_36_++)
					bs[i][i_36_] = (byte) ((aByteArrayArray7951[i][i_36_] >> 1)
							+ (aByteArrayArray7951[i + 1][i_36_] >> 3)
							+ ((aByteArrayArray7951[i - 1][i_36_] >> 2) + (aByteArrayArray7951[i][i_36_ + -1] >> 2))
							+ (aByteArrayArray7951[i][1 + i_36_] >> 3));
			...
			if ((0x7 & anInt7911 ^ 0xffffffff) != -1)
				i += 12;
			jaclib.memory.heap.NativeHeapBuffer nativeheapbuffer = aGLToolkit7926.aNativeHeap6609.a(anInt7948 * i,
					false);
			...
			for (int i_39_ = 0; anInt3408 > i_39_; i_39_++)
				for (int i_40_ = 0; (anInt3404 ^ 0xffffffff) < (i_40_ ^ 0xffffffff); i_40_++)
					if (anIntArrayArrayArray7934[i_39_][i_40_] != null) {
						...
						int i_62_ = 0;
						while_102_: for (int i_63_ = 0; i_63_ < is_44_.length; i_63_++) {
						...
						for (int i_65_ = 0; i_65_ < is_44_.length; i_65_++) {
							...
							long l = (long) i_71_ << 48 | (long) i_70_ << 32 | i_68_ << 16 | i_69_;
							int i_73_ = is[i_65_];
							...
							if (i_73_ != 0 || i_74_ != 0) {
								if ((i_73_ ^ 0xffffffff) == -1 && i_74_ == anInt3398) {
									...
									f_78_ = f_50_;
									f_80_ = f_49_;
								} else if ((anInt3398 ^ 0xffffffff) == (i_73_ ^ 0xffffffff)
										&& (anInt3398 ^ 0xffffffff) == (i_74_ ^ 0xffffffff)) {
									i_75_ -= i_60_;
									f_79_ = f_54_;
									f_78_ = f_53_;
									f_80_ = f_52_;
							...
							if ((i_70_ ^ 0xffffffff) != 0) {
								...
								if ((anInt7911 & 0x7 ^ 0xffffffff) == -1) {
									f_77_ = f_79_ * aGLToolkit7926.aFloatArray6664[2]
											+ (f_78_ * aGLToolkit7926.aFloatArray6664[1]
													+ f_80_ * aGLToolkit7926.aFloatArray6664[0]);
									f_77_ = aGLToolkit7926.aFloat6737 + f_77_
											* (!(f_77_ > 0.0F) ? aGLToolkit7926.aFloat6648 : aGLToolkit7926.aFloat6645);
								}
							}
							Node node = null;
							...
							if (node == null) {
								...
								if ((i_70_ ^ 0xffffffff) != (i_71_ ^ 0xffffffff)) {
									...
									if ((0x7 & anInt7911) == 0) {
										float f_95_ = aGLToolkit7926.aFloatArray6664[1] * f_78_
												+ f_80_ * aGLToolkit7926.aFloatArray6664[0]
												+ f_79_ * aGLToolkit7926.aFloatArray6664[2];
										f_95_ = (!(f_77_ > 0.0F) ? aGLToolkit7926.aFloat6648
												: aGLToolkit7926.aFloat6645) * f_77_ + aGLToolkit7926.aFloat6737;
					...
					if (ses != null) {
						...
						while (ses.length > i_104_) {
							...
							if (node_sub33_108_ != null) {
								...
								if (node_sub33_110_ == null || (node_sub33_110_.aLong2797
										^ 0xffffffffffffffffL) < (node_sub33_108_.aLong2797 ^ 0xffffffffffffffffL))
									node_sub33_110_ = node_sub33_108_;
							}
							if (node_sub33_109_ != null) {
								node_sub33_109_.method2738(i_101_, i_103_, true, i_102_);
								if (node_sub33_110_ == null || (node_sub33_110_.aLong2797
										^ 0xffffffffffffffffL) < (node_sub33_109_.aLong2797 ^ 0xffffffffffffffffL))
