...
public class GLSprite_Sub1 extends GLSprite {
	public static double aDouble8857 = -1.0;
	public static int anInt8851;
	...
	public static final void method1201(int i, int i_39_, int i_40_, int i_41_, int i_42_, int i_43_) {
		if (i_41_ == -12935) {
			if ((i_43_ ^ 0xffffffff) >= (Node_Sub25_Sub1.anInt9936 ^ 0xffffffff)
					&& (Class384.anInt4906 ^ 0xffffffff) >= (i ^ 0xffffffff)) {
				boolean bool;
	...
	public static final boolean method1202(byte b) {
		anInt8871++;
		if (Animable_Sub2_Sub1.aBoolean10628)
			try {
				if (((Boolean) Class2.displayApplet("showingVideoAd", Class96.mainGameApplet, (byte) -109)).booleanValue())
					return false;
				return true;
	...
	public static final void method1205(CacheNode_Sub4 cachenode_sub4, byte b) {
		anInt8866++;
		boolean bool = false;
		cachenode_sub4.method2275(-94);
		for (CacheNode_Sub4 cachenode_sub4_118_ = (CacheNode_Sub4) Class184.aClass158_2189.method1723(
				13); cachenode_sub4_118_ != null; cachenode_sub4_118_ = (CacheNode_Sub4) Class184.aClass158_2189
						.method1721(0))
			if (DeveloperConsole.method2935((byte) 69, cachenode_sub4.method2300((byte) 88),
					cachenode_sub4_118_.method2300((byte) 88))) {
				bool = true;
	...
	@Override
	public final void method1178(int i, int i_58_, int i_59_, int i_60_) {
		anInt8877++;
		anInt8865 = i_58_;
		anInt8879 = i;
		anInt8875 = i_59_;
	...
	@Override
	public final void method1183(int i, int i_89_, int i_90_, int i_91_, int i_92_, int i_93_, int i_94_) {
		anInt8874++;
		int i_95_ = i_90_ + i;
		...
		if (aClass169_Sub2_Sub1_8855.aBoolean10562 && !aBoolean8852) {
			float f = aClass169_Sub2_Sub1_8855.aFloat10568 * i_91_ / aClass169_Sub2_Sub1_8855.anInt10564;
			float f_97_ = aClass169_Sub2_Sub1_8855.aFloat10567 * i_90_ / aClass169_Sub2_Sub1_8855.anInt10566;
			OpenGL.glBegin(7);
			...
			OpenGL.glPushMatrix();
			OpenGL.glTranslatef(anInt8879, anInt8865, 0.0F);
			...
			while ((i_100_ ^ 0xffffffff) >= (i_96_ ^ 0xffffffff)) {
				...
				if (i_103_ < i_95_) {
					float f = (i_95_ + -i_103_) * aClass169_Sub2_Sub1_8855.aFloat10567
							/ aClass169_Sub2_Sub1_8855.anInt10566;
					OpenGL.glTexCoord2f(0.0F, aClass169_Sub2_Sub1_8855.aFloat10568);
					OpenGL.glVertex2i(i_103_, i_101_);
					OpenGL.glTexCoord2f(0.0F, 0.0F);
					OpenGL.glVertex2i(i_103_, i_100_);
			...
			if ((i_96_ ^ 0xffffffff) < (i_101_ ^ 0xffffffff)) {
				float f = aClass169_Sub2_Sub1_8855.aFloat10568
						* (aClass169_Sub2_Sub1_8855.anInt10564 - (-i_101_ + i_96_))
						/ aClass169_Sub2_Sub1_8855.anInt10564;
				...
				if (i_95_ > i_105_) {
					float f_106_ = aClass169_Sub2_Sub1_8855.aFloat10567 * (-i_105_ + i_95_)
							/ aClass169_Sub2_Sub1_8855.anInt10566;
					OpenGL.glTexCoord2f(0.0F, aClass169_Sub2_Sub1_8855.aFloat10568);
					OpenGL.glVertex2i(i_105_, i_101_);
					OpenGL.glTexCoord2f(0.0F, f);
	...
	@Override
	public final void method1184(int i, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_) {
		...
		if (aBoolean8852) {
			...
			float f_10_ = i + f * anInt8879;
			float f_11_ = f_9_ * anInt8865 + i_2_;
			float f_12_ = aClass169_Sub2_Sub1_8855.anInt10566 * f + f_10_;
			float f_13_ = aClass169_Sub2_Sub1_8855.anInt10564 * f_9_ + f_11_;
			if (aClass169_Sub2_Sub1_8854 != null) {
				...
				OpenGL.glMultiTexCoord2f(33985, aClass169_Sub2_Sub1_8855.aFloat10567,
						aClass169_Sub2_Sub1_8855.aFloat10568);
				OpenGL.glTexCoord2f(aClass169_Sub2_Sub1_8855.aFloat10567, aClass169_Sub2_Sub1_8855.aFloat10568);
	...
	@Override
	public final void method1188(float f, float f_14_, float f_15_, float f_16_, float f_17_, float f_18_, int i, aa var_aa,
			int i_19_, int i_20_) {
		anInt8862++;
		Class169_Sub2_Sub1 class169_sub2_sub1 = ((aa_Sub3) var_aa).aClass169_Sub2_Sub1_5494;
		if (aBoolean8852) {
			float f_21_ = method1197();
			float f_22_ = method1186();
			float f_23_ = (-f + f_15_) / f_21_;
			float f_24_ = (-f_14_ + f_16_) / f_21_;
			float f_25_ = (-f + f_17_) / f_22_;
			float f_26_ = (-f_14_ + f_18_) / f_22_;
			float f_27_ = f_25_ * anInt8865;
			float f_28_ = anInt8865 * f_26_;
			float f_29_ = anInt8879 * f_23_;
			float f_30_ = f_24_ * anInt8879;
			float f_31_ = -f_23_ * anInt8875;
			float f_32_ = anInt8875 * -f_24_;
			float f_33_ = anInt8878 * -f_25_;
			f_16_ = f_16_ + f_32_ + f_28_;
			f = f_27_ + (f_29_ + f);
			float f_34_ = -f_26_ * anInt8878;
		...
		float f_37_ = class169_sub2_sub1.aFloat10567 / class169_sub2_sub1.anInt10566;
		float f_38_ = class169_sub2_sub1.aFloat10568 / class169_sub2_sub1.anInt10564;
		OpenGL.glBegin(7);
		OpenGL.glColor3f(1.0F, 1.0F, 1.0F);
		OpenGL.glMultiTexCoord2f(33984, 0.0F, aClass169_Sub2_Sub1_8855.aFloat10568);
		OpenGL.glMultiTexCoord2f(33985, f_37_ * (f - i_19_), class169_sub2_sub1.aFloat10568 - (f_14_ - i_20_) * f_38_);
		OpenGL.glVertex2f(f, f_14_);
		OpenGL.glMultiTexCoord2f(33984, 0.0F, 0.0F);
		OpenGL.glMultiTexCoord2f(33985, (-i_19_ + f_17_) * f_37_,
				-(f_38_ * (-i_20_ + f_18_)) + class169_sub2_sub1.aFloat10568);
		OpenGL.glVertex2f(f_17_, f_18_);
		OpenGL.glMultiTexCoord2f(33984, aClass169_Sub2_Sub1_8855.aFloat10567, 0.0F);
		OpenGL.glMultiTexCoord2f(33985, (-i_19_ + f_35_) * f_37_,
				class169_sub2_sub1.aFloat10568 - (-i_20_ + f_36_) * f_38_);
		...
		OpenGL.glMultiTexCoord2f(33985, f_37_ * (-i_19_ + f_15_),
				-((f_16_ - i_20_) * f_38_) + class169_sub2_sub1.aFloat10568);
	...
	@Override
	public final void method1189(int i, int i_48_, aa var_aa, int i_49_, int i_50_) {
		anInt8868++;
		...
		float f_53_ = class169_sub2_sub1.aFloat10568 / class169_sub2_sub1.anInt10564;
		float f_54_ = f * (i - i_49_);
		float f_55_ = f * (-i_49_ + i_51_);
		float f_56_ = class169_sub2_sub1.aFloat10568 - (i_48_ - i_50_) * f_53_;
		float f_57_ = class169_sub2_sub1.aFloat10568 - f_53_ * (i_52_ - i_50_);
		OpenGL.glBegin(7);
		OpenGL.glColor3f(1.0F, 1.0F, 1.0F);
		OpenGL.glMultiTexCoord2f(33984, 0.0F, aClass169_Sub2_Sub1_8855.aFloat10568);
	...
	@Override
	public final void method1190(int i, int i_0_, int i_1_) {
		...
		aClass169_Sub2_Sub1_8854 = Class158.method1724(i, aClass169_Sub2_Sub1_8855.anInt10564,
				aClass169_Sub2_Sub1_8855.anInt10566, (byte) 83, i_0_, aGLToolkit8861);
		anInt8869 = i_1_;
	...
	@Override
	public final void method1191(int i, int i_61_, int i_62_, int i_63_, int i_64_) {
		anInt8859++;
		aClass169_Sub2_Sub1_8855.method1757(false, false);
		aGLToolkit8861.method1461(34962);
	...
	@Override
	public final void method1194(float f, float f_65_, float f_66_, float f_67_, float f_68_, float f_69_, int i, int i_70_,
			int i_71_, int i_72_) {
		if (aBoolean8852) {
			float f_73_ = method1197();
			float f_74_ = method1186();
			float f_75_ = (f_66_ - f) / f_73_;
			float f_76_ = (f_67_ - f_65_) / f_73_;
			float f_77_ = (-f + f_68_) / f_74_;
			float f_78_ = (-f_65_ + f_69_) / f_74_;
			float f_79_ = anInt8865 * f_77_;
			float f_80_ = anInt8865 * f_78_;
			float f_81_ = anInt8879 * f_75_;
			float f_82_ = f_76_ * anInt8879;
			float f_83_ = anInt8875 * -f_75_;
			float f_84_ = anInt8875 * -f_76_;
			float f_85_ = -f_77_ * anInt8878;
			f_65_ = f_65_ + f_82_ + f_80_;
			f_68_ = f_85_ + (f_81_ + f_68_);
			f_67_ = f_80_ + (f_67_ + f_84_);
			f = f_81_ + f + f_79_;
			f_66_ = f_83_ + f_66_ + f_79_;
			float f_86_ = -f_78_ * anInt8878;
	...
	@Override
	public final void method1195(int i, int i_107_, int i_108_, int i_109_, int i_110_, int i_111_) {
		anInt8872++;
