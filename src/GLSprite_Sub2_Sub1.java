...
public class GLSprite_Sub2_Sub1 extends GLSprite_Sub2 {
	...
	GLSprite_Sub2_Sub1(PureJavaToolkit purejavatoolkit, int[] is, int i, int i_1019_, int i_1020_, int i_1021_,
			boolean bool) {
	...
	@Override
	public final void method1184(int i, int i_1026_, int i_1027_, int i_1028_, int i_1029_, int i_1030_, int i_1031_,
			int i_1032_) {
						...
						for (int i_1087_ = -i_1028_; i_1087_ < 0; i_1087_++) {
							...
							for (int i_1089_ = -i_1027_; i_1089_ < 0; i_1089_++) {
								...
								if (i_1090_ != 0) {
									...
									is[i_1042_++] = ((i_1090_ & 0xff00ff) * i_1085_ + (i_1091_ & 0xff00ff) * i_1086_
											& ~0xff00ff)
											+ ((i_1090_ & 0xff00) * i_1085_ + (i_1091_ & 0xff00) * i_1086_
													& 0xff0000) >> 8;
								} else
									i_1042_++;
								i_1033_ += i_1038_;
							...
							for (int i_1099_ = -i_1027_; i_1099_ < 0; i_1099_++) {
								...
								if (i_1100_ != 0) {
									if (i_1095_ != 255) {
										...
										is[i_1042_++] = ((i_1100_ & 0xff00ff) * i_1095_ + (i_1104_ & 0xff00ff) * i_1096_
												& ~0xff00ff)
												+ ((i_1100_ & 0xff00) * i_1095_ + (i_1104_ & 0xff00) * i_1096_
														& 0xff0000) >> 8;
									} else {
					...
					for (int i_1111_ = -i_1028_; i_1111_ < 0; i_1111_++) {
						...
						for (int i_1113_ = -i_1027_; i_1113_ < 0; i_1113_++) {
							...
							if (i_1114_ == 0 && i_1109_ != 255) {
								i_1114_ = i_1117_;
								i_1117_ = is[i_1042_];
								i_1117_ = ((i_1114_ & 0xff00ff) * i_1109_ + (i_1117_ & 0xff00ff) * i_1110_ & ~0xff00ff)
										+ ((i_1114_ & 0xff00) * i_1109_ + (i_1117_ & 0xff00) * i_1110_ & 0xff0000) >> 8;
							}
							is[i_1042_++] = i_1117_;
							i_1033_ += i_1038_;
						}
	...
	@Override
	public final void method1189(int i, int i_298_, aa var_aa, int i_299_, int i_300_) {
		if (aPureJavaToolkit8886.method1492())
			throw new IllegalStateException();
		i += anInt8889;
		i_298_ += anInt8899;
	...
	@Override
	public final void method1190(int i, int i_152_, int i_153_) {
		throw new IllegalStateException("Can't capture alpha into a java_sprite_24");
	}

	@Override
	public final void method1191(int i, int i_1169_, int i_1170_, int i_1171_, int i_1172_) {
		if (aPureJavaToolkit8886.method1492())
			throw new IllegalStateException();
						...
						for (int i_1213_ = -i_1176_; i_1213_ < 0; i_1213_++) {
							for (int i_1214_ = -i_1177_; i_1214_ < 0; i_1214_++) {
								...
								if (i_1215_ != 0) {
									...
									is[i_1174_++] = ((i_1215_ & 0xff00ff) * i_1211_ + (i_1216_ & 0xff00ff) * i_1212_
											& ~0xff00ff)
											+ ((i_1215_ & 0xff00) * i_1211_ + (i_1216_ & 0xff00) * i_1212_
													& 0xff0000) >> 8;
								} else
									i_1174_++;
							}
							...
							for (int i_1223_ = -i_1177_; i_1223_ < 0; i_1223_++) {
								...
								if (i_1224_ != 0) {
									if (i_1220_ != 255) {
										...
										is[i_1174_++] = ((i_1224_ & 0xff00ff) * i_1220_ + (i_1228_ & 0xff00ff) * i_1221_
												& ~0xff00ff)
												+ ((i_1224_ & 0xff00) * i_1220_ + (i_1228_ & 0xff00) * i_1221_
														& 0xff0000) >> 8;
									} else {
					...
					for (int i_1234_ = -i_1176_; i_1234_ < 0; i_1234_++) {
						for (int i_1235_ = -i_1177_; i_1235_ < 0; i_1235_++) {
							...
							if (i_1236_ == 0 && i_1232_ != 255) {
								i_1236_ = i_1239_;
								i_1239_ = is[i_1174_];
								i_1239_ = ((i_1236_ & 0xff00ff) * i_1232_ + (i_1239_ & 0xff00ff) * i_1233_ & ~0xff00ff)
										+ ((i_1236_ & 0xff00) * i_1232_ + (i_1239_ & 0xff00) * i_1233_ & 0xff0000) >> 8;
							}
							is[i_1174_++] = i_1239_;
						}
						i_1174_ += i_1178_;
	...
	@Override
	public final void method1195(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_) {
		int[] is = aPureJavaToolkit8886.anIntArray6787;
	...
	@Override
	public final void method1207(int i, int i_9_, int i_10_, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_,
			int i_16_) {
		if (i_11_ > 0 && i_12_ > 0) {
			int i_17_ = 0;
			int i_18_ = 0;
						...
						for (int i_70_ = -i_12_; i_70_ < 0; i_70_++) {
							...
							for (int i_72_ = -i_11_; i_72_ < 0; i_72_++) {
								if (i_10_ < fs[i_25_]) {
									...
									if (i_73_ != 0) {
										int i_74_ = is[i_25_];
										is[i_25_] = ((i_73_ & 0xff00ff) * i_68_ + (i_74_ & 0xff00ff) * i_69_
												& ~0xff00ff)
												+ ((i_73_ & 0xff00) * i_68_ + (i_74_ & 0xff00) * i_69_ & 0xff0000) >> 8;
										fs[i_25_] = i_10_;
									}
								}
								i_17_ += i_21_;
								...
								if (i_10_ < fs[i_25_]) {
									...
									if (i_83_ != 0)
										if (i_78_ != 255) {
											...
											int i_87_ = is[i_25_];
											is[i_25_] = ((i_83_ & 0xff00ff) * i_78_ + (i_87_ & 0xff00ff) * i_79_
													& ~0xff00ff)
													+ ((i_83_ & 0xff00) * i_78_ + (i_87_ & 0xff00) * i_79_
															& 0xff0000) >> 8;
											fs[i_25_] = i_10_;
										} else {
						...
						for (int i_96_ = -i_11_; i_96_ < 0; i_96_++) {
							if (i_10_ < fs[i_25_]) {
								...
								if (i_97_ == 0 && i_92_ != 255) {
									i_97_ = i_100_;
									i_100_ = is[i_25_];
									i_100_ = ((i_97_ & 0xff00ff) * i_92_ + (i_100_ & 0xff00ff) * i_93_ & ~0xff00ff)
											+ ((i_97_ & 0xff00) * i_92_ + (i_100_ & 0xff00) * i_93_ & 0xff0000) >> 8;
								}
								is[i_25_] = i_100_;
								fs[i_25_] = i_10_;
							}
	...
	@Override
	public final void method1208(int i, int i_154_, int i_155_, int i_156_, int i_157_, int i_158_, int i_159_, int i_160_,
			int i_161_) {
							...
							for (int i_217_ = -i_156_; i_217_ < 0; i_217_++) {
								if (i_155_ < fs[i_170_]) {
									...
									if (i_218_ != 0) {
										...
										is[i_170_] = ((i_218_ & 0xff00ff) * i_213_ + (i_219_ & 0xff00ff) * i_214_
												& ~0xff00ff)
												+ ((i_218_ & 0xff00) * i_213_ + (i_219_ & 0xff00) * i_214_
														& 0xff0000) >> 8;
										fs[i_170_] = i_155_;
									}
								}
								...
								if (i_155_ < fs[i_170_]) {
									...
									if (i_228_ != 0)
										if (i_223_ != 255) {
											...
											is[i_170_] = ((i_228_ & 0xff00ff) * i_223_ + (i_232_ & 0xff00ff) * i_224_
													& ~0xff00ff)
													+ ((i_228_ & 0xff00) * i_223_ + (i_232_ & 0xff00) * i_224_
															& 0xff0000) >> 8;
											fs[i_170_] = i_155_;
										} else {
						...
						for (int i_241_ = -i_156_; i_241_ < 0; i_241_++) {
							if (i_155_ < fs[i_170_]) {
								...
								if (i_242_ == 0 && i_237_ != 255) {
									i_242_ = i_245_;
									i_245_ = is[i_170_];
									i_245_ = ((i_242_ & 0xff00ff) * i_237_ + (i_245_ & 0xff00ff) * i_238_ & ~0xff00ff)
											+ ((i_242_ & 0xff00) * i_237_ + (i_245_ & 0xff00) * i_238_ & 0xff0000) >> 8;
								}
								is[i_170_] = i_245_;
								fs[i_170_] = i_155_;
							}
	...
	@Override
	public final void method1209(int i, int i_324_) {
		int[] is = aPureJavaToolkit8886.anIntArray6787;
		if (GLSprite_Sub2.anInt8913 == 0) {
			if (GLSprite_Sub2.anInt8900 == 0) {
								...
								if (i_333_ == 1) {
									...
									if (i_348_ != 0)
										if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
											...
											is_332_[i_331_] = ((i_348_ & 0xff00ff) * i_349_
											...
											is_332_[i_331_] = ((i_348_ & 0xff00ff) * GLSprite_Sub2.anInt8895
													+ (i_355_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
													+ ((i_348_ & 0xff00) * GLSprite_Sub2.anInt8895
															+ (i_355_ & 0xff00) * GLSprite_Sub2.anInt8903
															& 0xff0000) >> 8;
										} else {
									...
									if (i_359_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
										...
										i_363_ = ((i_359_ & 0xff00ff) * GLSprite_Sub2.anInt8895
												+ (i_363_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
												+ ((i_359_ & 0xff00) * GLSprite_Sub2.anInt8895
														+ (i_363_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
									}
								...
								if (i_398_ == 1) {
									...
									if (i_413_ != 0)
										if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
											...
											is_397_[i_396_] = ((i_413_ & 0xff00ff) * i_414_
													+ (i_416_ & 0xff00ff) * i_415_ & ~0xff00ff)
													+ ((i_413_ & 0xff00) * i_414_ + (i_416_ & 0xff00) * i_415_
															& 0xff0000) >> 8;
										} else if (GLSprite_Sub2.anInt8895 != 255) {
											...
											is_397_[i_396_] = ((i_413_ & 0xff00ff) * GLSprite_Sub2.anInt8895
													+ (i_420_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
													+ ((i_413_ & 0xff00) * GLSprite_Sub2.anInt8895
															+ (i_420_ & 0xff00) * GLSprite_Sub2.anInt8903
															& 0xff0000) >> 8;
										} else {
									...
									if (i_424_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
										...
										i_428_ = ((i_424_ & 0xff00ff) * GLSprite_Sub2.anInt8895
												+ (i_428_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
												+ ((i_424_ & 0xff00) * GLSprite_Sub2.anInt8895
														+ (i_428_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
									}
				...
				while (i_454_ < 0) {
					...
					if (i_456_ >= 0 && i_456_ - (anInt8893 << 12) < 0) {
						...
						int i_460_;
						if ((i_460_ = (1 + i_457_ - (anInt8897 << 12) - GLSprite_Sub2.anInt8900)
								/ GLSprite_Sub2.anInt8900) > i_458_)
							i_458_ = i_460_;
						for (/**/; i_458_ < 0; i_458_++) {
								...
								if (i_464_ == 1) {
									...
									if (i_479_ != 0)
										if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
											...
											is_463_[i_462_] = ((i_479_ & 0xff00ff) * i_480_
													+ (i_482_ & 0xff00ff) * i_481_ & ~0xff00ff)
													+ ((i_479_ & 0xff00) * i_480_ + (i_482_ & 0xff00) * i_481_
															& 0xff0000) >> 8;
										} else if (GLSprite_Sub2.anInt8895 != 255) {
											...
											is_463_[i_462_] = ((i_479_ & 0xff00ff) * GLSprite_Sub2.anInt8895
													+ (i_486_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
													+ ((i_479_ & 0xff00) * GLSprite_Sub2.anInt8895
															+ (i_486_ & 0xff00) * GLSprite_Sub2.anInt8903
															& 0xff0000) >> 8;
										} else {
									...
									if (i_490_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
										...
										i_494_ = ((i_490_ & 0xff00ff) * GLSprite_Sub2.anInt8895
												+ (i_494_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
												+ ((i_490_ & 0xff00) * GLSprite_Sub2.anInt8895
														+ (i_494_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
									}
			...
			if (GLSprite_Sub2.anInt8900 == 0) {
								...
								if (i_529_ == 1) {
									...
									if (i_544_ != 0)
										if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
											...
											is_528_[i_527_] = ((i_544_ & 0xff00ff) * i_545_
													+ (i_547_ & 0xff00ff) * i_546_ & ~0xff00ff)
													+ ((i_544_ & 0xff00) * i_545_ + (i_547_ & 0xff00) * i_546_
															& 0xff0000) >> 8;
										} else if (GLSprite_Sub2.anInt8895 != 255) {
											...
											is_528_[i_527_] = ((i_544_ & 0xff00ff) * GLSprite_Sub2.anInt8895
													+ (i_551_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
													+ ((i_544_ & 0xff00) * GLSprite_Sub2.anInt8895
															+ (i_551_ & 0xff00) * GLSprite_Sub2.anInt8903
															& 0xff0000) >> 8;
										} else {
									...
									if (i_555_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
										...
										i_559_ = ((i_555_ & 0xff00ff) * GLSprite_Sub2.anInt8895
												+ (i_559_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
												+ ((i_555_ & 0xff00) * GLSprite_Sub2.anInt8895
														+ (i_559_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
									}
							...
							if (i_594_ == 1) {
								...
								if (i_609_ != 0)
									if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
										...
										is_593_[i_592_] = ((i_609_ & 0xff00ff) * i_610_ + (i_612_ & 0xff00ff) * i_611_
												& ~0xff00ff)
												+ ((i_609_ & 0xff00) * i_610_ + (i_612_ & 0xff00) * i_611_
														& 0xff0000) >> 8;
									} else if (GLSprite_Sub2.anInt8895 != 255) {
										...
										is_593_[i_592_] = ((i_609_ & 0xff00ff) * GLSprite_Sub2.anInt8895
												+ (i_616_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
												+ ((i_609_ & 0xff00) * GLSprite_Sub2.anInt8895
														+ (i_616_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
									} else {
								...
								if (i_620_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
									...
									i_624_ = ((i_620_ & 0xff00ff) * GLSprite_Sub2.anInt8895
											+ (i_624_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
											+ ((i_620_ & 0xff00) * GLSprite_Sub2.anInt8895
													+ (i_624_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
								}
				...
				while (i_650_ < 0) {
					...
					if ((i_655_ = (1 + i_653_ - (anInt8897 << 12) - GLSprite_Sub2.anInt8900)
							/ GLSprite_Sub2.anInt8900) > i_654_)
						i_654_ = i_655_;
					for (/**/; i_654_ < 0; i_654_++) {
							...
							if (i_659_ == 1) {
								...
								if (i_674_ != 0)
									if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
										...
										is_658_[i_657_] = ((i_674_ & 0xff00ff) * i_675_ + (i_677_ & 0xff00ff) * i_676_
												& ~0xff00ff)
												+ ((i_674_ & 0xff00) * i_675_ + (i_677_ & 0xff00) * i_676_
														& 0xff0000) >> 8;
									} else if (GLSprite_Sub2.anInt8895 != 255) {
										...
										is_658_[i_657_] = ((i_674_ & 0xff00ff) * GLSprite_Sub2.anInt8895
												+ (i_681_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
												+ ((i_674_ & 0xff00) * GLSprite_Sub2.anInt8895
														+ (i_681_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
									} else {
								...
								if (i_685_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
									...
									i_689_ = ((i_685_ & 0xff00ff) * GLSprite_Sub2.anInt8895
											+ (i_689_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
											+ ((i_685_ & 0xff00) * GLSprite_Sub2.anInt8895
													+ (i_689_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
								}
			...
			while (i_715_ < 0) {
				...
				if (i_718_ >= 0 && i_718_ - (anInt8897 << 12) < 0) {
					...
					int i_721_;
					if ((i_721_ = (1 + i_717_ - (anInt8893 << 12) - GLSprite_Sub2.anInt8913)
							/ GLSprite_Sub2.anInt8913) > i_719_)
						i_719_ = i_721_;
					for (/**/; i_719_ < 0; i_719_++) {
							...
							if (i_725_ == 1) {
								...
								if (i_740_ != 0)
									if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
										...
										is_724_[i_723_] = ((i_740_ & 0xff00ff) * i_741_ + (i_743_ & 0xff00ff) * i_742_
												& ~0xff00ff)
												+ ((i_740_ & 0xff00) * i_741_ + (i_743_ & 0xff00) * i_742_
														& 0xff0000) >> 8;
									} else if (GLSprite_Sub2.anInt8895 != 255) {
										...
										is_724_[i_723_] = ((i_740_ & 0xff00ff) * GLSprite_Sub2.anInt8895
												+ (i_747_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
												+ ((i_740_ & 0xff00) * GLSprite_Sub2.anInt8895
														+ (i_747_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
									} else {
								...
								if (i_751_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
									...
									i_755_ = ((i_751_ & 0xff00ff) * GLSprite_Sub2.anInt8895
											+ (i_755_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
											+ ((i_751_ & 0xff00) * GLSprite_Sub2.anInt8895
													+ (i_755_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
								}
			...
			for (int i_781_ = GLSprite_Sub2.anInt8888; i_781_ < 0; i_781_++) {
				...
				int i_787_;
				if ((i_787_ = (1 + i_783_ - (anInt8893 << 12) - GLSprite_Sub2.anInt8913)
						/ GLSprite_Sub2.anInt8913) > i_785_)
					i_785_ = i_787_;
						...
						if (i_791_ == 1) {
							...
							if (i_806_ != 0)
								if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
									...
									is_790_[i_789_] = ((i_806_ & 0xff00ff) * i_807_ + (i_809_ & 0xff00ff) * i_808_
											& ~0xff00ff)
											+ ((i_806_ & 0xff00) * i_807_ + (i_809_ & 0xff00) * i_808_ & 0xff0000) >> 8;
								} else if (GLSprite_Sub2.anInt8895 != 255) {
									...
									is_790_[i_789_] = ((i_806_ & 0xff00ff) * GLSprite_Sub2.anInt8895
											+ (i_813_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
											+ ((i_806_ & 0xff00) * GLSprite_Sub2.anInt8895
													+ (i_813_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
								} else {
							...
							if (i_817_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
								...
								i_821_ = ((i_817_ & 0xff00ff) * GLSprite_Sub2.anInt8895
										+ (i_821_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
										+ ((i_817_ & 0xff00) * GLSprite_Sub2.anInt8895
												+ (i_821_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
							}
			...
			for (int i_847_ = GLSprite_Sub2.anInt8888; i_847_ < 0; i_847_++) {
				...
				int i_853_;
				if ((i_853_ = (1 + i_849_ - (anInt8893 << 12) - GLSprite_Sub2.anInt8913)
						/ GLSprite_Sub2.anInt8913) > i_851_)
					i_851_ = i_853_;
				if (i_850_ < 0) {
				...
				if ((i_853_ = (1 + i_850_ - (anInt8897 << 12) - GLSprite_Sub2.anInt8900)
						/ GLSprite_Sub2.anInt8900) > i_851_)
					i_851_ = i_853_;
				for (/**/; i_851_ < 0; i_851_++) {
						...
						if (i_857_ == 1) {
							...
							if (i_872_ != 0)
								if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
									...
									is_856_[i_855_] = ((i_872_ & 0xff00ff) * i_873_ + (i_875_ & 0xff00ff) * i_874_
											& ~0xff00ff)
											+ ((i_872_ & 0xff00) * i_873_ + (i_875_ & 0xff00) * i_874_ & 0xff0000) >> 8;
								} else if (GLSprite_Sub2.anInt8895 != 255) {
									...
									is_856_[i_855_] = ((i_872_ & 0xff00ff) * GLSprite_Sub2.anInt8895
											+ (i_879_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
											+ ((i_872_ & 0xff00) * GLSprite_Sub2.anInt8895
													+ (i_879_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
								} else {
							...
							if (i_883_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
								...
								i_887_ = ((i_883_ & 0xff00ff) * GLSprite_Sub2.anInt8895
										+ (i_887_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
										+ ((i_883_ & 0xff00) * GLSprite_Sub2.anInt8895
												+ (i_887_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
							}
	...
	@Override
	public final void method1210(int[] is, int[] is_914_, int i, int i_915_) {
		...
		if (GLSprite_Sub2.anInt8913 == 0) {
			if (GLSprite_Sub2.anInt8900 == 0) {
				...
				while (i_917_ < 0) {
					...
					if (i_918_ >= 0) {
						...
						if (i_920_ >= 0 && i_921_ >= 0 && i_920_ - (anInt8893 << 12) < 0
								&& i_921_ - (anInt8897 << 12) < 0) {
				...
				while (i_938_ < 0) {
					...
					if (i_939_ >= 0) {
						...
						if (i_941_ >= 0 && i_941_ - (anInt8893 << 12) < 0) {
							...
							int i_945_;
							if ((i_945_ = (1 + i_942_ - (anInt8897 << 12) - GLSprite_Sub2.anInt8900)
									/ GLSprite_Sub2.anInt8900) > i_943_)
								i_943_ = i_945_;
			...
			if (GLSprite_Sub2.anInt8900 == 0) {
				...
				while (i_972_ < 0) {
					...
					if (i_973_ >= 0) {
						...
						if ((i_978_ = (1 + i_976_ - (anInt8897 << 12) - GLSprite_Sub2.anInt8900)
								/ GLSprite_Sub2.anInt8900) > i_977_)
							i_977_ = i_978_;
			...
			while (i_983_ < 0) {
				...
				if (i_984_ >= 0) {
					...
					if (i_987_ >= 0 && i_987_ - (anInt8897 << 12) < 0) {
						...
						int i_990_;
						if ((i_990_ = (1 + i_986_ - (anInt8893 << 12) - GLSprite_Sub2.anInt8913)
								/ GLSprite_Sub2.anInt8913) > i_988_)
							i_988_ = i_990_;
			...
			while (i_995_ < 0) {
				...
				if (i_996_ >= 0) {
					...
					int i_1002_;
					if ((i_1002_ = (1 + i_998_ - (anInt8893 << 12) - GLSprite_Sub2.anInt8913)
							/ GLSprite_Sub2.anInt8913) > i_1000_)
						i_1000_ = i_1002_;
			...
			while (i_1007_ < 0) {
				...
				if (i_1008_ >= 0) {
					...
					int i_1014_;
					if ((i_1014_ = (1 + i_1010_ - (anInt8893 << 12) - GLSprite_Sub2.anInt8913)
							/ GLSprite_Sub2.anInt8913) > i_1012_)
						i_1012_ = i_1014_;
					if (i_1011_ < 0) {
					...
					if ((i_1014_ = (1 + i_1011_ - (anInt8897 << 12) - GLSprite_Sub2.anInt8900)
							/ GLSprite_Sub2.anInt8900) > i_1012_)
						i_1012_ = i_1014_;
