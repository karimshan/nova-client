...
public class GLSprite_Sub2_Sub2 extends GLSprite_Sub2 {
	...
	GLSprite_Sub2_Sub2(PureJavaToolkit purejavatoolkit, int[] is, int i, int i_1116_, int i_1117_, int i_1118_,
			boolean bool) {
	...
	@Override
	public final void method1184(int i, int i_1123_, int i_1124_, int i_1125_, int i_1126_, int i_1127_, int i_1128_,
			int i_1129_) {
				...
				if (i_1126_ == 1) {
					...
					for (int i_1177_ = -i_1125_; i_1177_ < 0; i_1177_++) {
						...
						for (int i_1179_ = -i_1124_; i_1179_ < 0; i_1179_++) {
							...
							is[i_1139_++] = (((i_1180_ & 0xff00ff) * i_1181_ + (i_1183_ & 0xff00ff) * i_1182_
									& ~0xff00ff) >> 8)
									+ (((i_1180_ & ~0xff00ff) >>> 8) * i_1181_ + ((i_1183_ & ~0xff00ff) >>> 8) * i_1182_
											& ~0xff00ff);
							i_1130_ += i_1135_;
						}
						i_1131_ += i_1136_;
					...
					if ((i_1127_ & 0xffffff) == 16777215)
						for (int i_1185_ = -i_1125_; i_1185_ < 0; i_1185_++) {
							...
							for (int i_1187_ = -i_1124_; i_1187_ < 0; i_1187_++) {
								...
								is[i_1139_++] = ((i_1188_ & 0xff00ff) * i_1189_ + (i_1191_ & 0xff00ff) * i_1190_
										& ~0xff00ff)
										+ ((i_1188_ & 0xff00) * i_1189_ + (i_1191_ & 0xff00) * i_1190_ & 0xff0000) >> 8;
								i_1130_ += i_1135_;
							}
							i_1131_ += i_1136_;
							i_1130_ = i_1184_;
						...
						for (int i_1195_ = -i_1125_; i_1195_ < 0; i_1195_++) {
							...
							for (int i_1197_ = -i_1124_; i_1197_ < 0; i_1197_++) {
								...
								if (i_1199_ != 255) {
									...
									is[i_1139_++] = ((i_1198_ & 0xff00ff) * i_1199_ + (i_1204_ & 0xff00ff) * i_1200_
											& ~0xff00ff)
											+ ((i_1198_ & 0xff00) * i_1199_ + (i_1204_ & 0xff00) * i_1200_
													& 0xff0000) >> 8;
								} else {
					...
					for (int i_1209_ = -i_1125_; i_1209_ < 0; i_1209_++) {
						...
						for (int i_1211_ = -i_1124_; i_1211_ < 0; i_1211_++) {
							...
							if (i_1216_ != 255) {
								i_1212_ = i_1215_;
								i_1215_ = is[i_1139_];
								i_1215_ = ((i_1212_ & 0xff00ff) * i_1216_ + (i_1215_ & 0xff00ff) * i_1217_ & ~0xff00ff)
										+ ((i_1212_ & 0xff00) * i_1216_ + (i_1215_ & 0xff00) * i_1217_ & 0xff0000) >> 8;
							}
							is[i_1139_++] = i_1215_;
							i_1130_ += i_1135_;
						}
				...
				if (i_1126_ == 2) {
					...
					for (int i_1223_ = -i_1125_; i_1223_ < 0; i_1223_++) {
						...
						for (int i_1225_ = -i_1124_; i_1225_ < 0; i_1225_++) {
							...
							is[i_1139_++] = ((i_1226_ & 0xff00ff) * i_1227_ + (i_1229_ & 0xff00ff) * i_1228_
									& ~0xff00ff)
									+ ((i_1226_ & 0xff00) * i_1227_ + (i_1229_ & 0xff00) * i_1228_ & 0xff0000) >> 8;
							i_1130_ += i_1135_;
						}
						i_1131_ += i_1136_;
						i_1130_ = i_1222_;
	...
	@Override
	public final void method1189(int i, int i_1087_, aa var_aa, int i_1088_, int i_1089_) {
		if (aPureJavaToolkit8886.method1492())
			throw new IllegalStateException();
		i += anInt8889;
		i_1087_ += anInt8899;
		...
		if (i_1092_ > 0 && i_1093_ > 0) {
			...
			for (int i_1104_ = i_1102_; i_1104_ < i_1103_; i_1104_++) {
				...
				for (int i_1111_ = -i_1106_; i_1111_ < 0; i_1111_++) {
					...
					is_1101_[i_1096_++] = ((i_1112_ & 0xff00ff) * i_1113_ + (i_1115_ & 0xff00ff) * i_1114_ & ~0xff00ff)
							+ ((i_1112_ & 0xff00) * i_1113_ + (i_1115_ & 0xff00) * i_1114_ & 0xff0000) >> 8;
				}
	...
	@Override
	public final void method1190(int i, int i_928_, int i_929_) {
		if (i_929_ == 0) {
			int[] is = aPureJavaToolkit8886.anIntArray6787;
			for (int i_930_ = 0; i_930_ < anInt8897; i_930_++) {
				...
				for (int i_933_ = 0; i_933_ < anInt8893; i_933_++)
					anIntArray10570[i_931_ + i_933_] = anIntArray10570[i_931_ + i_933_] & 0xffffff
							| is[i_932_ + i_933_] << 8 & ~0xffffff;
			}
		} else if (i_929_ == 1) {
			int[] is = aPureJavaToolkit8886.anIntArray6787;
			for (int i_934_ = 0; i_934_ < anInt8897; i_934_++) {
				...
				for (int i_937_ = 0; i_937_ < anInt8893; i_937_++)
					anIntArray10570[i_935_ + i_937_] = anIntArray10570[i_935_ + i_937_] & 0xffffff
							| is[i_936_ + i_937_] << 16 & ~0xffffff;
			}
		} else if (i_929_ == 2) {
			int[] is = aPureJavaToolkit8886.anIntArray6787;
			for (int i_938_ = 0; i_938_ < anInt8897; i_938_++) {
				...
				for (int i_941_ = 0; i_941_ < anInt8893; i_941_++)
					anIntArray10570[i_939_ + i_941_] = anIntArray10570[i_939_ + i_941_] & 0xffffff
							| is[i_940_ + i_941_] << 24 & ~0xffffff;
			}
		} else if (i_929_ == 3) {
			int[] is = aPureJavaToolkit8886.anIntArray6787;
			for (int i_942_ = 0; i_942_ < anInt8897; i_942_++) {
				...
				for (int i_945_ = 0; i_945_ < anInt8893; i_945_++)
					anIntArray10570[i_943_ + i_945_] = anIntArray10570[i_943_ + i_945_] & 0xffffff
							| (is[i_944_ + i_945_] != 0 ? -16777216 : 0);
			}
		}
	}

	@Override
	public final void method1191(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
		if (aPureJavaToolkit8886.method1492())
			throw new IllegalStateException();
				...
				if (i_1_ == 1) {
					for (int i_38_ = -i_7_; i_38_ < 0; i_38_++) {
						for (int i_39_ = -i_8_; i_39_ < 0; i_39_++) {
							...
							int i_42_ = 256 - i_41_;
							int i_43_ = is[i_5_];
							is[i_5_++] = (((i_40_ & 0xff00ff) * i_41_ + (i_43_ & 0xff00ff) * i_42_ & ~0xff00ff) >> 8)
									+ (((i_40_ & ~0xff00ff) >>> 8) * i_41_ + ((i_43_ & ~0xff00ff) >>> 8) * i_42_
											& ~0xff00ff);
						}
						i_5_ += i_9_;
						i_6_ += i_10_;
					...
					if ((i_2_ & 0xffffff) == 16777215)
						for (int i_44_ = -i_7_; i_44_ < 0; i_44_++) {
							for (int i_45_ = -i_8_; i_45_ < 0; i_45_++) {
								...
								int i_48_ = 256 - i_47_;
								int i_49_ = is[i_5_];
								is[i_5_++] = ((i_46_ & 0xff00ff) * i_47_ + (i_49_ & 0xff00ff) * i_48_ & ~0xff00ff)
										+ ((i_46_ & 0xff00) * i_47_ + (i_49_ & 0xff00) * i_48_ & 0xff0000) >> 8;
							}
							i_5_ += i_9_;
							i_6_ += i_10_;
						}
						...
						for (int i_53_ = -i_7_; i_53_ < 0; i_53_++) {
							for (int i_54_ = -i_8_; i_54_ < 0; i_54_++) {
								...
								if (i_56_ != 255) {
									...
									int i_61_ = is[i_5_];
									is[i_5_++] = ((i_55_ & 0xff00ff) * i_56_ + (i_61_ & 0xff00ff) * i_57_ & ~0xff00ff)
											+ ((i_55_ & 0xff00) * i_56_ + (i_61_ & 0xff00) * i_57_ & 0xff0000) >> 8;
								} else {
					...
					for (int i_65_ = -i_7_; i_65_ < 0; i_65_++) {
						for (int i_66_ = -i_8_; i_66_ < 0; i_66_++) {
							...
							if (i_71_ != 255) {
								i_67_ = i_70_;
								i_70_ = is[i_5_];
								i_70_ = ((i_67_ & 0xff00ff) * i_71_ + (i_70_ & 0xff00ff) * i_72_ & ~0xff00ff)
										+ ((i_67_ & 0xff00) * i_71_ + (i_70_ & 0xff00) * i_72_ & 0xff0000) >> 8;
							}
							is[i_5_++] = i_70_;
						}
						i_5_ += i_9_;
				...
				if (i_1_ == 2) {
					...
					for (int i_77_ = -i_7_; i_77_ < 0; i_77_++) {
						for (int i_78_ = -i_8_; i_78_ < 0; i_78_++) {
							...
							int i_82_ = is[i_5_];
							is[i_5_++] = ((i_79_ & 0xff00ff) * i_80_ + (i_82_ & 0xff00ff) * i_81_ & ~0xff00ff)
									+ ((i_79_ & 0xff00) * i_80_ + (i_82_ & 0xff00) * i_81_ & 0xff0000) >> 8;
						}
						i_5_ += i_9_;
						i_6_ += i_10_;
					}
	...
	@Override
	public final void method1195(int i, int i_1078_, int i_1079_, int i_1080_, int i_1081_, int i_1082_) {
		int[] is = aPureJavaToolkit8886.anIntArray6787;
	...
	@Override
	public final void method1207(int i, int i_778_, int i_779_, int i_780_, int i_781_, int i_782_, int i_783_, int i_784_,
			int i_785_) {
					...
					for (int i_832_ = -i_781_; i_832_ < 0; i_832_++) {
						...
						for (int i_834_ = -i_780_; i_834_ < 0; i_834_++) {
							if (i_779_ < fs[i_794_]) {
								...
								is[i_794_] = (((i_835_ & 0xff00ff) * i_836_ + (i_838_ & 0xff00ff) * i_837_
										& ~0xff00ff) >> 8)
										+ (((i_835_ & ~0xff00ff) >>> 8) * i_836_ + ((i_838_ & ~0xff00ff) >>> 8) * i_837_
												& ~0xff00ff);
								fs[i_794_] = i_779_;
							}
							i_786_ += i_790_;
						...
						for (int i_840_ = -i_781_; i_840_ < 0; i_840_++) {
							...
							for (int i_842_ = -i_780_; i_842_ < 0; i_842_++) {
								if (i_779_ < fs[i_794_]) {
									...
									is[i_794_] = ((i_843_ & 0xff00ff) * i_844_ + (i_846_ & 0xff00ff) * i_845_
											& ~0xff00ff)
											+ ((i_843_ & 0xff00) * i_844_ + (i_846_ & 0xff00) * i_845_ & 0xff0000) >> 8;
									fs[i_794_] = i_779_;
								}
								i_786_ += i_790_;
								i_794_++;
							...
							for (int i_852_ = -i_780_; i_852_ < 0; i_852_++) {
								if (i_779_ < fs[i_794_]) {
									...
									if (i_854_ != 255) {
										...
										is[i_794_] = ((i_853_ & 0xff00ff) * i_854_ + (i_859_ & 0xff00ff) * i_855_
												& ~0xff00ff)
												+ ((i_853_ & 0xff00) * i_854_ + (i_859_ & 0xff00) * i_855_
														& 0xff0000) >> 8;
										fs[i_794_] = i_779_;
						...
						for (int i_867_ = -i_780_; i_867_ < 0; i_867_++) {
							if (i_779_ < fs[i_794_]) {
								...
								if (i_872_ != 255) {
									i_868_ = i_871_;
									i_871_ = is[i_794_];
									i_871_ = ((i_868_ & 0xff00ff) * i_872_ + (i_871_ & 0xff00ff) * i_873_ & ~0xff00ff)
											+ ((i_868_ & 0xff00) * i_872_ + (i_871_ & 0xff00) * i_873_ & 0xff0000) >> 8;
								}
								is[i_794_] = i_871_;
								fs[i_794_] = i_779_;
							}
					...
					for (int i_879_ = -i_781_; i_879_ < 0; i_879_++) {
						...
						for (int i_881_ = -i_780_; i_881_ < 0; i_881_++) {
							if (i_779_ < fs[i_794_]) {
								...
								is[i_794_] = ((i_882_ & 0xff00ff) * i_883_ + (i_885_ & 0xff00ff) * i_884_ & ~0xff00ff)
										+ ((i_882_ & 0xff00) * i_883_ + (i_885_ & 0xff00) * i_884_ & 0xff0000) >> 8;
								fs[i_794_] = i_779_;
							}
							i_786_ += i_790_;
							i_794_++;
	...
	@Override
	public final void method1208(int i, int i_1272_, int i_1273_, int i_1274_, int i_1275_, int i_1276_, int i_1277_,
			int i_1278_, int i_1279_) {
					...
					for (int i_1326_ = -i_1275_; i_1326_ < 0; i_1326_++) {
						...
						for (int i_1328_ = -i_1274_; i_1328_ < 0; i_1328_++) {
							if (i_1273_ < fs[i_1288_]) {
								...
								is[i_1288_] = (((i_1329_ & 0xff00ff) * i_1330_ + (i_1332_ & 0xff00ff) * i_1331_
										& ~0xff00ff) >> 8)
										+ (((i_1329_ & ~0xff00ff) >>> 8) * i_1330_
												+ ((i_1332_ & ~0xff00ff) >>> 8) * i_1331_ & ~0xff00ff);
								fs[i_1288_] = i_1273_;
							}
							i_1280_ += i_1284_;
							i_1288_++;
						...
						for (int i_1334_ = -i_1275_; i_1334_ < 0; i_1334_++) {
							...
							for (int i_1336_ = -i_1274_; i_1336_ < 0; i_1336_++) {
								if (i_1273_ < fs[i_1288_]) {
									...
									is[i_1288_] = ((i_1337_ & 0xff00ff) * i_1338_ + (i_1340_ & 0xff00ff) * i_1339_
											& ~0xff00ff)
											+ ((i_1337_ & 0xff00) * i_1338_ + (i_1340_ & 0xff00) * i_1339_
													& 0xff0000) >> 8;
									fs[i_1288_] = i_1273_;
								}
								i_1280_ += i_1284_;
							...
							for (int i_1346_ = -i_1274_; i_1346_ < 0; i_1346_++) {
								if (i_1273_ < fs[i_1288_]) {
									...
									if (i_1348_ != 255) {
										...
										is[i_1288_] = ((i_1347_ & 0xff00ff) * i_1348_ + (i_1353_ & 0xff00ff) * i_1349_
												& ~0xff00ff)
												+ ((i_1347_ & 0xff00) * i_1348_ + (i_1353_ & 0xff00) * i_1349_
														& 0xff0000) >> 8;
										fs[i_1288_] = i_1273_;
									} else {
						...
						for (int i_1360_ = -i_1274_; i_1360_ < 0; i_1360_++) {
							if (i_1273_ < fs[i_1288_]) {
								...
								if (i_1365_ != 255) {
									i_1361_ = i_1364_;
									i_1364_ = is[i_1288_];
									i_1364_ = ((i_1361_ & 0xff00ff) * i_1365_ + (i_1364_ & 0xff00ff) * i_1366_
											& ~0xff00ff)
											+ ((i_1361_ & 0xff00) * i_1365_ + (i_1364_ & 0xff00) * i_1366_
													& 0xff0000) >> 8;
								}
								is[i_1288_] = i_1364_;
								fs[i_1288_] = i_1273_;
					...
					for (int i_1372_ = -i_1275_; i_1372_ < 0; i_1372_++) {
						...
						for (int i_1374_ = -i_1274_; i_1374_ < 0; i_1374_++) {
							if (i_1273_ < fs[i_1288_]) {
								...
								is[i_1288_] = ((i_1375_ & 0xff00ff) * i_1376_ + (i_1378_ & 0xff00ff) * i_1377_
										& ~0xff00ff)
										+ ((i_1375_ & 0xff00) * i_1376_ + (i_1378_ & 0xff00) * i_1377_ & 0xff0000) >> 8;
								fs[i_1288_] = i_1273_;
							}
							i_1280_ += i_1284_;
							i_1288_++;
	...
	@Override
	public final void method1209(int i, int i_117_) {
		int[] is = aPureJavaToolkit8886.anIntArray6787;
		if (GLSprite_Sub2.anInt8913 == 0) {
			if (GLSprite_Sub2.anInt8900 == 0) {
						...
						for (/**/; i_122_ < 0; i_122_++) {
							...
							if (i_127_ == 0) {
								...
								if (i_126_ == 1) {
									...
									is_125_[i_124_] = ((i_140_ & 0xff00ff) * i_141_ + (i_143_ & 0xff00ff) * i_142_
											& ~0xff00ff)
											+ ((i_140_ & 0xff00) * i_141_ + (i_143_ & 0xff00) * i_142_ & 0xff0000) >> 8;
								} else if (i_126_ == 0) {
									...
									if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
										...
										is_125_[i_124_] = ((i_144_ & 0xff00ff) * i_145_ + (i_147_ & 0xff00ff) * i_146_
												& ~0xff00ff)
												+ ((i_144_ & 0xff00) * i_145_ + (i_147_ & 0xff00) * i_146_
														& 0xff0000) >> 8;
									} else if (i_145_ != 255) {
										...
										is_125_[i_124_] = ((i_144_ & 0xff00ff) * i_145_ + (i_151_ & 0xff00ff) * i_146_
												& ~0xff00ff)
												+ ((i_144_ & 0xff00) * i_145_ + (i_151_ & 0xff00) * i_146_
														& 0xff0000) >> 8;
									} else {
									...
									if (i_160_ != 255) {
										...
										i_159_ = ((i_155_ & 0xff00ff) * i_160_ + (i_159_ & 0xff00ff) * i_161_
												& ~0xff00ff)
												+ ((i_155_ & 0xff00) * i_160_ + (i_159_ & 0xff00) * i_161_
														& 0xff0000) >> 8;
									}
									...
									is_125_[i_124_] = ((i_162_ & 0xff00ff) * i_163_ + (i_167_ & 0xff00ff) * i_164_
											& ~0xff00ff)
											+ ((i_162_ & 0xff00) * i_163_ + (i_167_ & 0xff00) * i_164_ & 0xff0000) >> 8;
								} else
									throw new IllegalArgumentException();
							} else if (i_127_ == 2) {
								if (i_126_ == 1) {
						...
						for (/**/; i_194_ < 0; i_194_++) {
							...
							if (i_200_ == 0) {
								...
								if (i_199_ == 1) {
									...
									is_198_[i_197_] = ((i_213_ & 0xff00ff) * i_214_ + (i_216_ & 0xff00ff) * i_215_
											& ~0xff00ff)
											+ ((i_213_ & 0xff00) * i_214_ + (i_216_ & 0xff00) * i_215_ & 0xff0000) >> 8;
								} else if (i_199_ == 0) {
									...
									if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
										...
										is_198_[i_197_] = ((i_217_ & 0xff00ff) * i_218_ + (i_220_ & 0xff00ff) * i_219_
												& ~0xff00ff)
												+ ((i_217_ & 0xff00) * i_218_ + (i_220_ & 0xff00) * i_219_
														& 0xff0000) >> 8;
									} else if (i_218_ != 255) {
										...
										is_198_[i_197_] = ((i_217_ & 0xff00ff) * i_218_ + (i_224_ & 0xff00ff) * i_219_
												& ~0xff00ff)
												+ ((i_217_ & 0xff00) * i_218_ + (i_224_ & 0xff00) * i_219_
														& 0xff0000) >> 8;
									} else {
									...
									if (i_233_ != 255) {
										...
										i_232_ = ((i_228_ & 0xff00ff) * i_233_ + (i_232_ & 0xff00ff) * i_234_
												& ~0xff00ff)
												+ ((i_228_ & 0xff00) * i_233_ + (i_232_ & 0xff00) * i_234_
														& 0xff0000) >> 8;
									}
									...
									is_198_[i_197_] = ((i_235_ & 0xff00ff) * i_236_ + (i_240_ & 0xff00ff) * i_237_
											& ~0xff00ff)
											+ ((i_235_ & 0xff00) * i_236_ + (i_240_ & 0xff00) * i_237_ & 0xff0000) >> 8;
								} else
									throw new IllegalArgumentException();
							} else if (i_200_ == 2) {
								if (i_199_ == 1) {
				...
				while (i_263_ < 0) {
					...
					if (i_265_ >= 0 && i_265_ - (anInt8893 << 12) < 0) {
						...
						int i_269_;
						if ((i_269_ = (1 + i_266_ - (anInt8897 << 12) - GLSprite_Sub2.anInt8900)
								/ GLSprite_Sub2.anInt8900) > i_267_)
							i_267_ = i_269_;
						for (/**/; i_267_ < 0; i_267_++) {
							...
							if (i_274_ == 0) {
								...
								if (i_273_ == 1) {
									...
									is_272_[i_271_] = ((i_287_ & 0xff00ff) * i_288_ + (i_290_ & 0xff00ff) * i_289_
											& ~0xff00ff)
											+ ((i_287_ & 0xff00) * i_288_ + (i_290_ & 0xff00) * i_289_ & 0xff0000) >> 8;
								} else if (i_273_ == 0) {
									...
									if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
										...
										is_272_[i_271_] = ((i_291_ & 0xff00ff) * i_292_ + (i_294_ & 0xff00ff) * i_293_
												& ~0xff00ff)
												+ ((i_291_ & 0xff00) * i_292_ + (i_294_ & 0xff00) * i_293_
														& 0xff0000) >> 8;
									} else if (i_292_ != 255) {
										...
										is_272_[i_271_] = ((i_291_ & 0xff00ff) * i_292_ + (i_298_ & 0xff00ff) * i_293_
												& ~0xff00ff)
												+ ((i_291_ & 0xff00) * i_292_ + (i_298_ & 0xff00) * i_293_
														& 0xff0000) >> 8;
									} else {
									...
									if (i_307_ != 255) {
										...
										i_306_ = ((i_302_ & 0xff00ff) * i_307_ + (i_306_ & 0xff00ff) * i_308_
												& ~0xff00ff)
												+ ((i_302_ & 0xff00) * i_307_ + (i_306_ & 0xff00) * i_308_
														& 0xff0000) >> 8;
									}
									...
									is_272_[i_271_] = ((i_309_ & 0xff00ff) * i_310_ + (i_314_ & 0xff00ff) * i_311_
											& ~0xff00ff)
											+ ((i_309_ & 0xff00) * i_310_ + (i_314_ & 0xff00) * i_311_ & 0xff0000) >> 8;
								} else
									throw new IllegalArgumentException();
							} else if (i_274_ == 2) {
								if (i_273_ == 1) {
			...
			if (GLSprite_Sub2.anInt8900 == 0) {
						...
						for (/**/; i_341_ < 0; i_341_++) {
							...
							if (i_347_ == 0) {
								...
								if (i_346_ == 1) {
									...
									is_345_[i_344_] = ((i_360_ & 0xff00ff) * i_361_ + (i_363_ & 0xff00ff) * i_362_
											& ~0xff00ff)
											+ ((i_360_ & 0xff00) * i_361_ + (i_363_ & 0xff00) * i_362_ & 0xff0000) >> 8;
								} else if (i_346_ == 0) {
									...
									if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
										...
										is_345_[i_344_] = ((i_364_ & 0xff00ff) * i_365_ + (i_367_ & 0xff00ff) * i_366_
												& ~0xff00ff)
												+ ((i_364_ & 0xff00) * i_365_ + (i_367_ & 0xff00) * i_366_
														& 0xff0000) >> 8;
									} else if (i_365_ != 255) {
										...
										is_345_[i_344_] = ((i_364_ & 0xff00ff) * i_365_ + (i_371_ & 0xff00ff) * i_366_
												& ~0xff00ff)
												+ ((i_364_ & 0xff00) * i_365_ + (i_371_ & 0xff00) * i_366_
														& 0xff0000) >> 8;
									} else {
									...
									if (i_380_ != 255) {
										...
										i_379_ = ((i_375_ & 0xff00ff) * i_380_ + (i_379_ & 0xff00ff) * i_381_
												& ~0xff00ff)
												+ ((i_375_ & 0xff00) * i_380_ + (i_379_ & 0xff00) * i_381_
														& 0xff0000) >> 8;
									}
									...
									is_345_[i_344_] = ((i_382_ & 0xff00ff) * i_383_ + (i_387_ & 0xff00ff) * i_384_
											& ~0xff00ff)
											+ ((i_382_ & 0xff00) * i_383_ + (i_387_ & 0xff00) * i_384_ & 0xff0000) >> 8;
								} else
									throw new IllegalArgumentException();
							} else if (i_347_ == 2) {
								if (i_346_ == 1) {
					...
					for (/**/; i_414_ < 0; i_414_++) {
						...
						if (i_420_ == 0) {
							...
							if (i_419_ == 1) {
								...
								is_418_[i_417_] = ((i_433_ & 0xff00ff) * i_434_ + (i_436_ & 0xff00ff) * i_435_
										& ~0xff00ff)
										+ ((i_433_ & 0xff00) * i_434_ + (i_436_ & 0xff00) * i_435_ & 0xff0000) >> 8;
							} else if (i_419_ == 0) {
								...
								if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
									...
									is_418_[i_417_] = ((i_437_ & 0xff00ff) * i_438_ + (i_440_ & 0xff00ff) * i_439_
											& ~0xff00ff)
											+ ((i_437_ & 0xff00) * i_438_ + (i_440_ & 0xff00) * i_439_ & 0xff0000) >> 8;
								} else if (i_438_ != 255) {
									...
									is_418_[i_417_] = ((i_437_ & 0xff00ff) * i_438_ + (i_444_ & 0xff00ff) * i_439_
											& ~0xff00ff)
											+ ((i_437_ & 0xff00) * i_438_ + (i_444_ & 0xff00) * i_439_ & 0xff0000) >> 8;
								} else {
								...
								if (i_453_ != 255) {
									...
									i_452_ = ((i_448_ & 0xff00ff) * i_453_ + (i_452_ & 0xff00ff) * i_454_ & ~0xff00ff)
											+ ((i_448_ & 0xff00) * i_453_ + (i_452_ & 0xff00) * i_454_ & 0xff0000) >> 8;
								}
								...
								is_418_[i_417_] = ((i_455_ & 0xff00ff) * i_456_ + (i_460_ & 0xff00ff) * i_457_
										& ~0xff00ff)
										+ ((i_455_ & 0xff00) * i_456_ + (i_460_ & 0xff00) * i_457_ & 0xff0000) >> 8;
							} else
								throw new IllegalArgumentException();
						} else if (i_420_ == 2) {
							if (i_419_ == 1) {
				...
				while (i_483_ < 0) {
					...
					if ((i_488_ = (1 + i_486_ - (anInt8897 << 12) - GLSprite_Sub2.anInt8900)
							/ GLSprite_Sub2.anInt8900) > i_487_)
						i_487_ = i_488_;
					for (/**/; i_487_ < 0; i_487_++) {
						...
						if (i_493_ == 0) {
							...
							if (i_492_ == 1) {
								...
								is_491_[i_490_] = ((i_506_ & 0xff00ff) * i_507_ + (i_509_ & 0xff00ff) * i_508_
										& ~0xff00ff)
										+ ((i_506_ & 0xff00) * i_507_ + (i_509_ & 0xff00) * i_508_ & 0xff0000) >> 8;
							} else if (i_492_ == 0) {
								...
								if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
									...
									is_491_[i_490_] = ((i_510_ & 0xff00ff) * i_511_ + (i_513_ & 0xff00ff) * i_512_
											& ~0xff00ff)
											+ ((i_510_ & 0xff00) * i_511_ + (i_513_ & 0xff00) * i_512_ & 0xff0000) >> 8;
								} else if (i_511_ != 255) {
									...
									is_491_[i_490_] = ((i_510_ & 0xff00ff) * i_511_ + (i_517_ & 0xff00ff) * i_512_
											& ~0xff00ff)
											+ ((i_510_ & 0xff00) * i_511_ + (i_517_ & 0xff00) * i_512_ & 0xff0000) >> 8;
								} else {
								...
								if (i_526_ != 255) {
									...
									i_525_ = ((i_521_ & 0xff00ff) * i_526_ + (i_525_ & 0xff00ff) * i_527_ & ~0xff00ff)
											+ ((i_521_ & 0xff00) * i_526_ + (i_525_ & 0xff00) * i_527_ & 0xff0000) >> 8;
								}
								...
								is_491_[i_490_] = ((i_528_ & 0xff00ff) * i_529_ + (i_533_ & 0xff00ff) * i_530_
										& ~0xff00ff)
										+ ((i_528_ & 0xff00) * i_529_ + (i_533_ & 0xff00) * i_530_ & 0xff0000) >> 8;
							} else
								throw new IllegalArgumentException();
						} else if (i_493_ == 2) {
							if (i_492_ == 1) {
			...
			while (i_556_ < 0) {
				...
				if (i_559_ >= 0 && i_559_ - (anInt8897 << 12) < 0) {
					...
					int i_562_;
					if ((i_562_ = (1 + i_558_ - (anInt8893 << 12) - GLSprite_Sub2.anInt8913)
							/ GLSprite_Sub2.anInt8913) > i_560_)
						i_560_ = i_562_;
					for (/**/; i_560_ < 0; i_560_++) {
						...
						if (i_567_ == 0) {
							...
							if (i_566_ == 1) {
								...
								is_565_[i_564_] = ((i_580_ & 0xff00ff) * i_581_ + (i_583_ & 0xff00ff) * i_582_
										& ~0xff00ff)
										+ ((i_580_ & 0xff00) * i_581_ + (i_583_ & 0xff00) * i_582_ & 0xff0000) >> 8;
							} else if (i_566_ == 0) {
								...
								if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
									...
									is_565_[i_564_] = ((i_584_ & 0xff00ff) * i_585_ + (i_587_ & 0xff00ff) * i_586_
											& ~0xff00ff)
											+ ((i_584_ & 0xff00) * i_585_ + (i_587_ & 0xff00) * i_586_ & 0xff0000) >> 8;
								} else if (i_585_ != 255) {
									...
									is_565_[i_564_] = ((i_584_ & 0xff00ff) * i_585_ + (i_591_ & 0xff00ff) * i_586_
											& ~0xff00ff)
											+ ((i_584_ & 0xff00) * i_585_ + (i_591_ & 0xff00) * i_586_ & 0xff0000) >> 8;
								} else {
								...
								if (i_600_ != 255) {
									...
									i_599_ = ((i_595_ & 0xff00ff) * i_600_ + (i_599_ & 0xff00ff) * i_601_ & ~0xff00ff)
											+ ((i_595_ & 0xff00) * i_600_ + (i_599_ & 0xff00) * i_601_ & 0xff0000) >> 8;
								}
								...
								is_565_[i_564_] = ((i_602_ & 0xff00ff) * i_603_ + (i_607_ & 0xff00ff) * i_604_
										& ~0xff00ff)
										+ ((i_602_ & 0xff00) * i_603_ + (i_607_ & 0xff00) * i_604_ & 0xff0000) >> 8;
							} else
								throw new IllegalArgumentException();
						} else if (i_567_ == 2) {
							if (i_566_ == 1) {
			...
			for (int i_630_ = GLSprite_Sub2.anInt8888; i_630_ < 0; i_630_++) {
				...
				int i_636_;
				if ((i_636_ = (1 + i_632_ - (anInt8893 << 12) - GLSprite_Sub2.anInt8913)
						/ GLSprite_Sub2.anInt8913) > i_634_)
					i_634_ = i_636_;
				...
				for (/**/; i_634_ < 0; i_634_++) {
					...
					if (i_641_ == 0) {
						...
						if (i_640_ == 1) {
							...
							is_639_[i_638_] = ((i_654_ & 0xff00ff) * i_655_ + (i_657_ & 0xff00ff) * i_656_ & ~0xff00ff)
									+ ((i_654_ & 0xff00) * i_655_ + (i_657_ & 0xff00) * i_656_ & 0xff0000) >> 8;
						} else if (i_640_ == 0) {
							...
							if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
								...
								is_639_[i_638_] = ((i_658_ & 0xff00ff) * i_659_ + (i_661_ & 0xff00ff) * i_660_
										& ~0xff00ff)
										+ ((i_658_ & 0xff00) * i_659_ + (i_661_ & 0xff00) * i_660_ & 0xff0000) >> 8;
							} else if (i_659_ != 255) {
								...
								is_639_[i_638_] = ((i_658_ & 0xff00ff) * i_659_ + (i_665_ & 0xff00ff) * i_660_
										& ~0xff00ff)
										+ ((i_658_ & 0xff00) * i_659_ + (i_665_ & 0xff00) * i_660_ & 0xff0000) >> 8;
							} else {
							...
							if (i_674_ != 255) {
								...
								i_673_ = ((i_669_ & 0xff00ff) * i_674_ + (i_673_ & 0xff00ff) * i_675_ & ~0xff00ff)
										+ ((i_669_ & 0xff00) * i_674_ + (i_673_ & 0xff00) * i_675_ & 0xff0000) >> 8;
							}
							...
							is_639_[i_638_] = ((i_676_ & 0xff00ff) * i_677_ + (i_681_ & 0xff00ff) * i_678_ & ~0xff00ff)
									+ ((i_676_ & 0xff00) * i_677_ + (i_681_ & 0xff00) * i_678_ & 0xff0000) >> 8;
						} else
							throw new IllegalArgumentException();
					} else if (i_641_ == 2) {
						if (i_640_ == 1) {
			...
			for (int i_704_ = GLSprite_Sub2.anInt8888; i_704_ < 0; i_704_++) {
				...
				int i_710_;
				if ((i_710_ = (1 + i_706_ - (anInt8893 << 12) - GLSprite_Sub2.anInt8913)
						/ GLSprite_Sub2.anInt8913) > i_708_)
					i_708_ = i_710_;
				if (i_707_ < 0) {
				...
				if ((i_710_ = (1 + i_707_ - (anInt8897 << 12) - GLSprite_Sub2.anInt8900)
						/ GLSprite_Sub2.anInt8900) > i_708_)
					i_708_ = i_710_;
				for (/**/; i_708_ < 0; i_708_++) {
					...
					if (i_715_ == 0) {
						...
						if (i_714_ == 1) {
							...
							is_713_[i_712_] = ((i_728_ & 0xff00ff) * i_729_ + (i_731_ & 0xff00ff) * i_730_ & ~0xff00ff)
									+ ((i_728_ & 0xff00) * i_729_ + (i_731_ & 0xff00) * i_730_ & 0xff0000) >> 8;
						} else if (i_714_ == 0) {
							...
							if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
								...
								is_713_[i_712_] = ((i_732_ & 0xff00ff) * i_733_ + (i_735_ & 0xff00ff) * i_734_
										& ~0xff00ff)
										+ ((i_732_ & 0xff00) * i_733_ + (i_735_ & 0xff00) * i_734_ & 0xff0000) >> 8;
							} else if (i_733_ != 255) {
								...
								is_713_[i_712_] = ((i_732_ & 0xff00ff) * i_733_ + (i_739_ & 0xff00ff) * i_734_
										& ~0xff00ff)
										+ ((i_732_ & 0xff00) * i_733_ + (i_739_ & 0xff00) * i_734_ & 0xff0000) >> 8;
							} else {
							...
							if (i_748_ != 255) {
								...
								i_747_ = ((i_743_ & 0xff00ff) * i_748_ + (i_747_ & 0xff00ff) * i_749_ & ~0xff00ff)
										+ ((i_743_ & 0xff00) * i_748_ + (i_747_ & 0xff00) * i_749_ & 0xff0000) >> 8;
							}
							...
							is_713_[i_712_] = ((i_750_ & 0xff00ff) * i_751_ + (i_755_ & 0xff00ff) * i_752_ & ~0xff00ff)
									+ ((i_750_ & 0xff00) * i_751_ + (i_755_ & 0xff00) * i_752_ & 0xff0000) >> 8;
						} else
							throw new IllegalArgumentException();
					} else if (i_715_ == 2) {
						if (i_714_ == 1) {
	...
	@Override
	public final void method1210(int[] is, int[] is_946_, int i, int i_947_) {
		...
		if (GLSprite_Sub2.anInt8913 == 0) {
			if (GLSprite_Sub2.anInt8900 == 0) {
				...
				while (i_949_ < 0) {
					...
					if (i_950_ >= 0) {
						...
						if (i_952_ >= 0 && i_953_ >= 0 && i_952_ - (anInt8893 << 12) < 0
								&& i_953_ - (anInt8897 << 12) < 0) {
							...
							for (/**/; i_954_ < 0; i_954_++) {
								...
								is_948_[i_951_++] = ((i_958_ & 0xff00ff) * i_959_ + (i_961_ & 0xff00ff) * i_960_
										& ~0xff00ff)
										+ ((i_958_ & 0xff00) * i_959_ + (i_961_ & 0xff00) * i_960_ & 0xff0000) >> 8;
							}
						}
					}
					i_949_++;
					...
					if (i_963_ >= 0) {
						...
						if (i_965_ >= 0 && i_965_ - (anInt8893 << 12) < 0) {
							...
							for (/**/; i_967_ < 0; i_967_++) {
								...
								is_948_[i_964_++] = ((i_972_ & 0xff00ff) * i_973_ + (i_975_ & 0xff00ff) * i_974_
										& ~0xff00ff)
										+ ((i_972_ & 0xff00) * i_973_ + (i_975_ & 0xff00) * i_974_ & 0xff0000) >> 8;
				...
				while (i_976_ < 0) {
					...
					if (i_977_ >= 0) {
						...
						if (i_979_ >= 0 && i_979_ - (anInt8893 << 12) < 0) {
							...
							int i_983_;
							if ((i_983_ = (1 + i_980_ - (anInt8897 << 12) - GLSprite_Sub2.anInt8900)
									/ GLSprite_Sub2.anInt8900) > i_981_)
								i_981_ = i_983_;
							...
							for (/**/; i_981_ < 0; i_981_++) {
								...
								is_948_[i_978_++] = ((i_987_ & 0xff00ff) * i_988_ + (i_990_ & 0xff00ff) * i_989_
										& ~0xff00ff)
										+ ((i_987_ & 0xff00) * i_988_ + (i_990_ & 0xff00) * i_989_ & 0xff0000) >> 8;
			...
			if (GLSprite_Sub2.anInt8900 == 0) {
					...
					if (i_992_ >= 0) {
						...
						if (i_995_ >= 0 && i_995_ - (anInt8897 << 12) < 0) {
							...
							for (/**/; i_996_ < 0; i_996_++) {
								...
								is_948_[i_993_++] = ((i_1001_ & 0xff00ff) * i_1002_ + (i_1004_ & 0xff00ff) * i_1003_
										& ~0xff00ff)
										+ ((i_1001_ & 0xff00) * i_1002_ + (i_1004_ & 0xff00) * i_1003_ & 0xff0000) >> 8;
				...
				while (i_1005_ < 0) {
					...
					if (i_1006_ >= 0) {
						...
						for (/**/; i_1010_ < 0; i_1010_++) {
							...
							is_948_[i_1007_++] = ((i_1015_ & 0xff00ff) * i_1016_ + (i_1018_ & 0xff00ff) * i_1017_
									& ~0xff00ff)
									+ ((i_1015_ & 0xff00) * i_1016_ + (i_1018_ & 0xff00) * i_1017_ & 0xff0000) >> 8;
				...
				while (i_1019_ < 0) {
					...
					if (i_1020_ >= 0) {
						...
						if ((i_1025_ = (1 + i_1023_ - (anInt8897 << 12) - GLSprite_Sub2.anInt8900)
								/ GLSprite_Sub2.anInt8900) > i_1024_)
							i_1024_ = i_1025_;
						...
						for (/**/; i_1024_ < 0; i_1024_++) {
							...
							is_948_[i_1021_++] = ((i_1029_ & 0xff00ff) * i_1030_ + (i_1032_ & 0xff00ff) * i_1031_
									& ~0xff00ff)
									+ ((i_1029_ & 0xff00) * i_1030_ + (i_1032_ & 0xff00) * i_1031_ & 0xff0000) >> 8;
			...
			while (i_1033_ < 0) {
				...
				if (i_1034_ >= 0) {
					...
					if (i_1037_ >= 0 && i_1037_ - (anInt8897 << 12) < 0) {
						...
						int i_1040_;
						if ((i_1040_ = (1 + i_1036_ - (anInt8893 << 12) - GLSprite_Sub2.anInt8913)
								/ GLSprite_Sub2.anInt8913) > i_1038_)
							i_1038_ = i_1040_;
						...
						for (/**/; i_1038_ < 0; i_1038_++) {
							...
							is_948_[i_1035_++] = ((i_1044_ & 0xff00ff) * i_1045_ + (i_1047_ & 0xff00ff) * i_1046_
									& ~0xff00ff)
									+ ((i_1044_ & 0xff00) * i_1045_ + (i_1047_ & 0xff00) * i_1046_ & 0xff0000) >> 8;
			...
			while (i_1048_ < 0) {
				...
				if (i_1049_ >= 0) {
					...
					int i_1055_;
					if ((i_1055_ = (1 + i_1051_ - (anInt8893 << 12) - GLSprite_Sub2.anInt8913)
							/ GLSprite_Sub2.anInt8913) > i_1053_)
						i_1053_ = i_1055_;
					...
					for (/**/; i_1053_ < 0; i_1053_++) {
						...
						is_948_[i_1050_++] = ((i_1059_ & 0xff00ff) * i_1060_ + (i_1062_ & 0xff00ff) * i_1061_
								& ~0xff00ff)
								+ ((i_1059_ & 0xff00) * i_1060_ + (i_1062_ & 0xff00) * i_1061_ & 0xff0000) >> 8;
			...
			while (i_1063_ < 0) {
				...
				if (i_1064_ >= 0) {
					...
					int i_1070_;
					if ((i_1070_ = (1 + i_1066_ - (anInt8893 << 12) - GLSprite_Sub2.anInt8913)
							/ GLSprite_Sub2.anInt8913) > i_1068_)
						i_1068_ = i_1070_;
					if (i_1067_ < 0) {
					...
					if ((i_1070_ = (1 + i_1067_ - (anInt8897 << 12) - GLSprite_Sub2.anInt8900)
							/ GLSprite_Sub2.anInt8900) > i_1068_)
						i_1068_ = i_1070_;
					...
					for (/**/; i_1068_ < 0; i_1068_++) {
						...
						is_948_[i_1065_++] = ((i_1074_ & 0xff00ff) * i_1075_ + (i_1077_ & 0xff00ff) * i_1076_
								& ~0xff00ff)
								+ ((i_1074_ & 0xff00) * i_1075_ + (i_1077_ & 0xff00) * i_1076_ & 0xff0000) >> 8;
