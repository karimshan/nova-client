...
public class GLSprite_Sub2_Sub3 extends GLSprite_Sub2 {
	...
	@Override
	public final void method1184(int i, int i_1192_, int i_1193_, int i_1194_, int i_1195_, int i_1196_, int i_1197_,
			int i_1198_) {
						...
						for (int i_1253_ = -i_1194_; i_1253_ < 0; i_1253_++) {
							...
							for (int i_1255_ = -i_1193_; i_1255_ < 0; i_1255_++) {
								...
								if (i_1256_ != 0) {
									...
									is[i_1208_++] = ((i_1257_ & 0xff00ff) * i_1251_ + (i_1258_ & 0xff00ff) * i_1252_
											& ~0xff00ff)
											+ ((i_1257_ & 0xff00) * i_1251_ + (i_1258_ & 0xff00) * i_1252_
													& 0xff0000) >> 8;
								} else
									i_1208_++;
								i_1199_ += i_1204_;
							...
							for (int i_1266_ = -i_1193_; i_1266_ < 0; i_1266_++) {
								...
								if (i_1267_ != 0) {
									...
									if (i_1262_ != 255) {
										...
										is[i_1208_++] = ((i_1268_ & 0xff00ff) * i_1262_ + (i_1272_ & 0xff00ff) * i_1263_
												& ~0xff00ff)
												+ ((i_1268_ & 0xff00) * i_1262_ + (i_1272_ & 0xff00) * i_1263_
														& 0xff0000) >> 8;
									} else {
					...
					for (int i_1279_ = -i_1194_; i_1279_ < 0; i_1279_++) {
						...
						for (int i_1281_ = -i_1193_; i_1281_ < 0; i_1281_++) {
							...
							if (i_1282_ == 0 && i_1277_ != 255) {
								i_1282_ = i_1285_;
								i_1285_ = is[i_1208_];
								i_1285_ = ((i_1282_ & 0xff00ff) * i_1277_ + (i_1285_ & 0xff00ff) * i_1278_ & ~0xff00ff)
										+ ((i_1282_ & 0xff00) * i_1277_ + (i_1285_ & 0xff00) * i_1278_ & 0xff0000) >> 8;
							}
							is[i_1208_++] = i_1285_;
							i_1199_ += i_1204_;
						}
	...
	@Override
	public final void method1189(int i, int i_1166_, aa var_aa, int i_1167_, int i_1168_) {
		if (aPureJavaToolkit8886.method1492())
			throw new IllegalStateException();
		i += anInt8889;
		i_1166_ += anInt8899;
	...
	@Override
	public final void method1190(int i, int i_865_, int i_866_) {
		throw new IllegalStateException();
	}
					...
					for (int i_38_ = -i_7_; i_38_ < 0; i_38_++) {
						for (int i_39_ = -i_8_; i_39_ < 0; i_39_++) {
							...
							if (i_40_ != 0) {
								...
								int i_43_ = 0;
								int i_44_ = is[i_5_];
								is[i_5_++] = (((i_41_ & 0xff00ff) * i_42_ + (i_44_ & 0xff00ff) * i_43_
										& ~0xff00ff) >> 8)
										+ (((i_41_ & ~0xff00ff) >>> 8) * i_42_ + ((i_44_ & ~0xff00ff) >>> 8) * i_43_
												& ~0xff00ff);
							} else
								i_5_++;
						}
						...
						for (int i_47_ = -i_7_; i_47_ < 0; i_47_++) {
							for (int i_48_ = -i_8_; i_48_ < 0; i_48_++) {
								...
								if (i_49_ != 0) {
									...
									int i_51_ = is[i_5_];
									is[i_5_++] = ((i_50_ & 0xff00ff) * i_45_ + (i_51_ & 0xff00ff) * i_46_ & ~0xff00ff)
											+ ((i_50_ & 0xff00) * i_45_ + (i_51_ & 0xff00) * i_46_ & 0xff0000) >> 8;
								} else
									i_5_++;
							}
							i_5_ += i_9_;
							...
							for (int i_58_ = -i_8_; i_58_ < 0; i_58_++) {
								...
								if (i_59_ != 0) {
									...
									if (i_55_ != 255) {
										...
										int i_64_ = is[i_5_];
										is[i_5_++] = ((i_60_ & 0xff00ff) * i_55_ + (i_64_ & 0xff00ff) * i_56_
												& ~0xff00ff)
												+ ((i_60_ & 0xff00) * i_55_ + (i_64_ & 0xff00) * i_56_ & 0xff0000) >> 8;
									} else {
					...
					for (int i_70_ = -i_7_; i_70_ < 0; i_70_++) {
						for (int i_71_ = -i_8_; i_71_ < 0; i_71_++) {
							...
							if (i_72_ == 0 && i_68_ != 255) {
								i_72_ = i_75_;
								i_75_ = is[i_5_];
								i_75_ = ((i_72_ & 0xff00ff) * i_68_ + (i_75_ & 0xff00ff) * i_69_ & ~0xff00ff)
										+ ((i_72_ & 0xff00) * i_68_ + (i_75_ & 0xff00) * i_69_ & 0xff0000) >> 8;
							}
							is[i_5_++] = i_75_;
						}
						i_5_ += i_9_;
	...
	@Override
	public final void method1195(int i, int i_860_, int i_861_, int i_862_, int i_863_, int i_864_) {
		throw new IllegalStateException();
	}

	@Override
	public final void method1207(int i, int i_1017_, int i_1018_, int i_1019_, int i_1020_, int i_1021_, int i_1022_,
			int i_1023_, int i_1024_) {
							...
							for (int i_1080_ = -i_1019_; i_1080_ < 0; i_1080_++) {
								if (i_1018_ < fs[i_1033_]) {
									...
									if (i_1081_ != 0) {
										...
										is[i_1033_] = ((i_1082_ & 0xff00ff) * i_1076_ + (i_1083_ & 0xff00ff) * i_1077_
												& ~0xff00ff)
												+ ((i_1082_ & 0xff00) * i_1076_ + (i_1083_ & 0xff00) * i_1077_
														& 0xff0000) >> 8;
										fs[i_1033_] = i_1018_;
									}
								}
								...
								if (i_1018_ < fs[i_1033_]) {
									...
									if (i_1092_ != 0) {
										...
										if (i_1087_ != 255) {
											...
											is[i_1033_] = ((i_1093_ & 0xff00ff) * i_1087_
													+ (i_1097_ & 0xff00ff) * i_1088_ & ~0xff00ff)
													+ ((i_1093_ & 0xff00) * i_1087_ + (i_1097_ & 0xff00) * i_1088_
															& 0xff0000) >> 8;
											fs[i_1033_] = i_1018_;
										} else {
						...
						for (int i_1106_ = -i_1019_; i_1106_ < 0; i_1106_++) {
							if (i_1018_ < fs[i_1033_]) {
								...
								if (i_1107_ == 0 && i_1102_ != 255) {
									i_1107_ = i_1110_;
									i_1110_ = is[i_1033_];
									i_1110_ = ((i_1107_ & 0xff00ff) * i_1102_ + (i_1110_ & 0xff00ff) * i_1103_
											& ~0xff00ff)
											+ ((i_1107_ & 0xff00) * i_1102_ + (i_1110_ & 0xff00) * i_1103_
													& 0xff0000) >> 8;
								}
								is[i_1033_] = i_1110_;
								fs[i_1033_] = i_1018_;
	...
	@Override
	public final void method1208(int i, int i_867_, int i_868_, int i_869_, int i_870_, int i_871_, int i_872_, int i_873_,
			int i_874_) {
							...
							for (int i_930_ = -i_869_; i_930_ < 0; i_930_++) {
								if (i_868_ < fs[i_883_]) {
									...
									if (i_931_ != 0) {
										...
										is[i_883_] = ((i_932_ & 0xff00ff) * i_926_ + (i_933_ & 0xff00ff) * i_927_
												& ~0xff00ff)
												+ ((i_932_ & 0xff00) * i_926_ + (i_933_ & 0xff00) * i_927_
														& 0xff0000) >> 8;
										fs[i_883_] = i_868_;
									}
								}
								...
								if (i_868_ < fs[i_883_]) {
									...
									if (i_942_ != 0) {
										...
										if (i_937_ != 255) {
											...
											is[i_883_] = ((i_943_ & 0xff00ff) * i_937_ + (i_947_ & 0xff00ff) * i_938_
													& ~0xff00ff)
													+ ((i_943_ & 0xff00) * i_937_ + (i_947_ & 0xff00) * i_938_
															& 0xff0000) >> 8;
											fs[i_883_] = i_868_;
										} else {
						...
						for (int i_956_ = -i_869_; i_956_ < 0; i_956_++) {
							if (i_868_ < fs[i_883_]) {
								...
								if (i_957_ == 0 && i_952_ != 255) {
									i_957_ = i_960_;
									i_960_ = is[i_883_];
									i_960_ = ((i_957_ & 0xff00ff) * i_952_ + (i_960_ & 0xff00ff) * i_953_ & ~0xff00ff)
											+ ((i_957_ & 0xff00) * i_952_ + (i_960_ & 0xff00) * i_953_ & 0xff0000) >> 8;
								}
								is[i_883_] = i_960_;
								fs[i_883_] = i_868_;
							}
	...
	@Override
	public final void method1209(int i, int i_226_) {
		int[] is = aPureJavaToolkit8886.anIntArray6787;
		if (GLSprite_Sub2.anInt8913 == 0) {
			if (GLSprite_Sub2.anInt8900 == 0) {
							...
							if (i_236_ == 0) {
								...
								if (i_235_ == 1) {
									...
									if (i_250_ != 0) {
										...
										if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
											...
											is_234_[i_233_] = ((i_251_ & 0xff00ff) * i_252_
													+ (i_254_ & 0xff00ff) * i_253_ & ~0xff00ff)
													+ ((i_251_ & 0xff00) * i_252_ + (i_254_ & 0xff00) * i_253_
															& 0xff0000) >> 8;
											...
											is_234_[i_233_] = ((i_251_ & 0xff00ff) * GLSprite_Sub2.anInt8895
													+ (i_258_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
													+ ((i_251_ & 0xff00) * GLSprite_Sub2.anInt8895
															+ (i_258_ & 0xff00) * GLSprite_Sub2.anInt8903
															& 0xff0000) >> 8;
										} else {
									...
									if (i_262_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
										...
										i_266_ = ((i_262_ & 0xff00ff) * GLSprite_Sub2.anInt8895
												+ (i_266_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
												+ ((i_262_ & 0xff00) * GLSprite_Sub2.anInt8895
														+ (i_266_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
									}
								...
								if (i_235_ == 1) {
									...
									if (i_284_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
										...
										i_288_ = ((i_284_ & 0xff00ff) * GLSprite_Sub2.anInt8895
												+ (i_288_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
												+ ((i_284_ & 0xff00) * GLSprite_Sub2.anInt8895
														+ (i_288_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
									}
							...
							if (i_306_ == 0) {
								...
								if (i_305_ == 1) {
									...
									if (i_320_ != 0) {
										...
										if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
											...
											is_304_[i_303_] = ((i_321_ & 0xff00ff) * i_322_
													+ (i_324_ & 0xff00ff) * i_323_ & ~0xff00ff)
													+ ((i_321_ & 0xff00) * i_322_ + (i_324_ & 0xff00) * i_323_
															& 0xff0000) >> 8;
										} else if (GLSprite_Sub2.anInt8895 != 255) {
											...
											is_304_[i_303_] = ((i_321_ & 0xff00ff) * GLSprite_Sub2.anInt8895
													+ (i_328_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
													+ ((i_321_ & 0xff00) * GLSprite_Sub2.anInt8895
															+ (i_328_ & 0xff00) * GLSprite_Sub2.anInt8903
															& 0xff0000) >> 8;
										} else {
									...
									if (i_332_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
										...
										i_336_ = ((i_332_ & 0xff00ff) * GLSprite_Sub2.anInt8895
												+ (i_336_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
												+ ((i_332_ & 0xff00) * GLSprite_Sub2.anInt8895
														+ (i_336_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
									}
								...
								if (i_305_ == 1) {
									...
									if (i_354_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
										...
										i_358_ = ((i_354_ & 0xff00ff) * GLSprite_Sub2.anInt8895
												+ (i_358_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
												+ ((i_354_ & 0xff00) * GLSprite_Sub2.anInt8895
														+ (i_358_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
									}
				...
				while (i_366_ < 0) {
					...
					if (i_368_ >= 0 && i_368_ - (anInt8893 << 12) < 0) {
						...
						int i_372_;
						if ((i_372_ = (1 + i_369_ - (anInt8897 << 12) - GLSprite_Sub2.anInt8900)
								/ GLSprite_Sub2.anInt8900) > i_370_)
							i_370_ = i_372_;
						for (/**/; i_370_ < 0; i_370_++) {
							...
							if (i_377_ == 0) {
								...
								if (i_376_ == 1) {
									...
									if (i_391_ != 0) {
										...
										if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
											...
											is_375_[i_374_] = ((i_392_ & 0xff00ff) * i_393_
													+ (i_395_ & 0xff00ff) * i_394_ & ~0xff00ff)
													+ ((i_392_ & 0xff00) * i_393_ + (i_395_ & 0xff00) * i_394_
															& 0xff0000) >> 8;
										} else if (GLSprite_Sub2.anInt8895 != 255) {
											...
											is_375_[i_374_] = ((i_392_ & 0xff00ff) * GLSprite_Sub2.anInt8895
													+ (i_399_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
													+ ((i_392_ & 0xff00) * GLSprite_Sub2.anInt8895
															+ (i_399_ & 0xff00) * GLSprite_Sub2.anInt8903
															& 0xff0000) >> 8;
										} else {
									...
									if (i_403_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
										...
										i_407_ = ((i_403_ & 0xff00ff) * GLSprite_Sub2.anInt8895
												+ (i_407_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
												+ ((i_403_ & 0xff00) * GLSprite_Sub2.anInt8895
														+ (i_407_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
									}
								...
								if (i_376_ == 1) {
									...
									if (i_425_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
										...
										i_429_ = ((i_425_ & 0xff00ff) * GLSprite_Sub2.anInt8895
												+ (i_429_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
												+ ((i_425_ & 0xff00) * GLSprite_Sub2.anInt8895
														+ (i_429_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
									}
			...
			if (GLSprite_Sub2.anInt8900 == 0) {
							...
							if (i_447_ == 0) {
								...
								if (i_446_ == 1) {
									...
									if (i_461_ != 0) {
										...
										if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
											...
											is_445_[i_444_] = ((i_462_ & 0xff00ff) * i_463_
													+ (i_465_ & 0xff00ff) * i_464_ & ~0xff00ff)
													+ ((i_462_ & 0xff00) * i_463_ + (i_465_ & 0xff00) * i_464_
															& 0xff0000) >> 8;
										} else if (GLSprite_Sub2.anInt8895 != 255) {
											...
											is_445_[i_444_] = ((i_462_ & 0xff00ff) * GLSprite_Sub2.anInt8895
													+ (i_469_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
													+ ((i_462_ & 0xff00) * GLSprite_Sub2.anInt8895
															+ (i_469_ & 0xff00) * GLSprite_Sub2.anInt8903
															& 0xff0000) >> 8;
										} else {
									...
									if (i_473_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
										...
										i_477_ = ((i_473_ & 0xff00ff) * GLSprite_Sub2.anInt8895
												+ (i_477_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
												+ ((i_473_ & 0xff00) * GLSprite_Sub2.anInt8895
														+ (i_477_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
									}
								...
								if (i_446_ == 1) {
									...
									if (i_495_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
										...
										i_499_ = ((i_495_ & 0xff00ff) * GLSprite_Sub2.anInt8895
												+ (i_499_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
												+ ((i_495_ & 0xff00) * GLSprite_Sub2.anInt8895
														+ (i_499_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
									}
						...
						if (i_517_ == 0) {
							...
							if (i_516_ == 1) {
								...
								if (i_531_ != 0) {
									...
									if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
										...
										is_515_[i_514_] = ((i_532_ & 0xff00ff) * i_533_ + (i_535_ & 0xff00ff) * i_534_
												& ~0xff00ff)
												+ ((i_532_ & 0xff00) * i_533_ + (i_535_ & 0xff00) * i_534_
														& 0xff0000) >> 8;
									} else if (GLSprite_Sub2.anInt8895 != 255) {
										...
										is_515_[i_514_] = ((i_532_ & 0xff00ff) * GLSprite_Sub2.anInt8895
												+ (i_539_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
												+ ((i_532_ & 0xff00) * GLSprite_Sub2.anInt8895
														+ (i_539_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
									} else {
								...
								if (i_543_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
									...
									i_547_ = ((i_543_ & 0xff00ff) * GLSprite_Sub2.anInt8895
											+ (i_547_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
											+ ((i_543_ & 0xff00) * GLSprite_Sub2.anInt8895
													+ (i_547_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
								}
							...
							if (i_516_ == 1) {
								...
								if (i_565_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
									...
									i_569_ = ((i_565_ & 0xff00ff) * GLSprite_Sub2.anInt8895
											+ (i_569_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
											+ ((i_565_ & 0xff00) * GLSprite_Sub2.anInt8895
													+ (i_569_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
								}
				...
				while (i_577_ < 0) {
					...
					if ((i_582_ = (1 + i_580_ - (anInt8897 << 12) - GLSprite_Sub2.anInt8900)
							/ GLSprite_Sub2.anInt8900) > i_581_)
						i_581_ = i_582_;
					for (/**/; i_581_ < 0; i_581_++) {
						...
						if (i_587_ == 0) {
							...
							if (i_586_ == 1) {
								...
								if (i_601_ != 0) {
									...
									if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
										...
										is_585_[i_584_] = ((i_602_ & 0xff00ff) * i_603_ + (i_605_ & 0xff00ff) * i_604_
												& ~0xff00ff)
												+ ((i_602_ & 0xff00) * i_603_ + (i_605_ & 0xff00) * i_604_
														& 0xff0000) >> 8;
									} else if (GLSprite_Sub2.anInt8895 != 255) {
										...
										is_585_[i_584_] = ((i_602_ & 0xff00ff) * GLSprite_Sub2.anInt8895
												+ (i_609_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
												+ ((i_602_ & 0xff00) * GLSprite_Sub2.anInt8895
														+ (i_609_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
									} else {
								...
								if (i_613_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
									...
									i_617_ = ((i_613_ & 0xff00ff) * GLSprite_Sub2.anInt8895
											+ (i_617_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
											+ ((i_613_ & 0xff00) * GLSprite_Sub2.anInt8895
													+ (i_617_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
								}
							...
							if (i_586_ == 1) {
								...
								if (i_635_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
									...
									i_639_ = ((i_635_ & 0xff00ff) * GLSprite_Sub2.anInt8895
											+ (i_639_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
											+ ((i_635_ & 0xff00) * GLSprite_Sub2.anInt8895
													+ (i_639_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
								}
			...
			while (i_647_ < 0) {
				...
				if (i_650_ >= 0 && i_650_ - (anInt8897 << 12) < 0) {
					...
					int i_653_;
					if ((i_653_ = (1 + i_649_ - (anInt8893 << 12) - GLSprite_Sub2.anInt8913)
							/ GLSprite_Sub2.anInt8913) > i_651_)
						i_651_ = i_653_;
					for (/**/; i_651_ < 0; i_651_++) {
						...
						if (i_658_ == 0) {
							...
							if (i_657_ == 1) {
								...
								if (i_672_ != 0) {
									...
									if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
										...
										is_656_[i_655_] = ((i_673_ & 0xff00ff) * i_674_ + (i_676_ & 0xff00ff) * i_675_
												& ~0xff00ff)
												+ ((i_673_ & 0xff00) * i_674_ + (i_676_ & 0xff00) * i_675_
														& 0xff0000) >> 8;
									} else if (GLSprite_Sub2.anInt8895 != 255) {
										...
										is_656_[i_655_] = ((i_673_ & 0xff00ff) * GLSprite_Sub2.anInt8895
												+ (i_680_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
												+ ((i_673_ & 0xff00) * GLSprite_Sub2.anInt8895
														+ (i_680_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
									} else {
								...
								if (i_684_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
									...
									i_688_ = ((i_684_ & 0xff00ff) * GLSprite_Sub2.anInt8895
											+ (i_688_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
											+ ((i_684_ & 0xff00) * GLSprite_Sub2.anInt8895
													+ (i_688_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
								}
							...
							if (i_657_ == 1) {
								...
								if (i_706_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
									...
									i_710_ = ((i_706_ & 0xff00ff) * GLSprite_Sub2.anInt8895
											+ (i_710_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
											+ ((i_706_ & 0xff00) * GLSprite_Sub2.anInt8895
													+ (i_710_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
								}
			...
			for (int i_718_ = GLSprite_Sub2.anInt8888; i_718_ < 0; i_718_++) {
				...
				int i_724_;
				if ((i_724_ = (1 + i_720_ - (anInt8893 << 12) - GLSprite_Sub2.anInt8913)
						/ GLSprite_Sub2.anInt8913) > i_722_)
					i_722_ = i_724_;
					...
					if (i_729_ == 0) {
						...
						if (i_728_ == 1) {
							...
							if (i_743_ != 0) {
								...
								if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
									...
									is_727_[i_726_] = ((i_744_ & 0xff00ff) * i_745_ + (i_747_ & 0xff00ff) * i_746_
											& ~0xff00ff)
											+ ((i_744_ & 0xff00) * i_745_ + (i_747_ & 0xff00) * i_746_ & 0xff0000) >> 8;
								} else if (GLSprite_Sub2.anInt8895 != 255) {
									...
									is_727_[i_726_] = ((i_744_ & 0xff00ff) * GLSprite_Sub2.anInt8895
											+ (i_751_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
											+ ((i_744_ & 0xff00) * GLSprite_Sub2.anInt8895
													+ (i_751_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
								} else {
							...
							if (i_755_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
								...
								i_759_ = ((i_755_ & 0xff00ff) * GLSprite_Sub2.anInt8895
										+ (i_759_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
										+ ((i_755_ & 0xff00) * GLSprite_Sub2.anInt8895
												+ (i_759_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
							}
						...
						if (i_728_ == 1) {
							...
							if (i_777_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
								...
								i_781_ = ((i_777_ & 0xff00ff) * GLSprite_Sub2.anInt8895
										+ (i_781_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
										+ ((i_777_ & 0xff00) * GLSprite_Sub2.anInt8895
												+ (i_781_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
							}
			...
			for (int i_789_ = GLSprite_Sub2.anInt8888; i_789_ < 0; i_789_++) {
				...
				int i_795_;
				if ((i_795_ = (1 + i_791_ - (anInt8893 << 12) - GLSprite_Sub2.anInt8913)
						/ GLSprite_Sub2.anInt8913) > i_793_)
					i_793_ = i_795_;
				if (i_792_ < 0) {
				...
				if ((i_795_ = (1 + i_792_ - (anInt8897 << 12) - GLSprite_Sub2.anInt8900)
						/ GLSprite_Sub2.anInt8900) > i_793_)
					i_793_ = i_795_;
				for (/**/; i_793_ < 0; i_793_++) {
					...
					if (i_800_ == 0) {
						...
						if (i_799_ == 1) {
							...
							if (i_814_ != 0) {
								...
								if ((GLSprite_Sub2.anInt8904 & 0xffffff) == 16777215) {
									...
									is_798_[i_797_] = ((i_815_ & 0xff00ff) * i_816_ + (i_818_ & 0xff00ff) * i_817_
											& ~0xff00ff)
									...
									is_798_[i_797_] = ((i_815_ & 0xff00ff) * GLSprite_Sub2.anInt8895
											+ (i_822_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
											+ ((i_815_ & 0xff00) * GLSprite_Sub2.anInt8895
													+ (i_822_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
								} else {
							...
							if (i_826_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
								...
								i_830_ = ((i_826_ & 0xff00ff) * GLSprite_Sub2.anInt8895
										+ (i_830_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
										+ ((i_826_ & 0xff00) * GLSprite_Sub2.anInt8895
												+ (i_830_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
							}
						...
						if (i_799_ == 1) {
							...
							if (i_848_ == 0 && GLSprite_Sub2.anInt8895 != 255) {
								...
								i_852_ = ((i_848_ & 0xff00ff) * GLSprite_Sub2.anInt8895
										+ (i_852_ & 0xff00ff) * GLSprite_Sub2.anInt8903 & ~0xff00ff)
										+ ((i_848_ & 0xff00) * GLSprite_Sub2.anInt8895
												+ (i_852_ & 0xff00) * GLSprite_Sub2.anInt8903 & 0xff0000) >> 8;
							}
	...
	@Override
	public final void method1210(int[] is, int[] is_121_, int i, int i_122_) {
		...
		if (GLSprite_Sub2.anInt8913 == 0) {
			if (GLSprite_Sub2.anInt8900 == 0) {
				...
				while (i_124_ < 0) {
					...
					if (i_125_ >= 0) {
						...
						if (i_127_ >= 0 && i_128_ >= 0 && i_127_ - (anInt8893 << 12) < 0
								&& i_128_ - (anInt8897 << 12) < 0) {
				...
				while (i_145_ < 0) {
					...
					if (i_146_ >= 0) {
						...
						if (i_148_ >= 0 && i_148_ - (anInt8893 << 12) < 0) {
							...
							int i_152_;
							if ((i_152_ = (1 + i_149_ - (anInt8897 << 12) - GLSprite_Sub2.anInt8900)
									/ GLSprite_Sub2.anInt8900) > i_150_)
								i_150_ = i_152_;
			...
			if (GLSprite_Sub2.anInt8900 == 0) {
				...
				while (i_179_ < 0) {
					...
					if (i_180_ >= 0) {
						...
						if ((i_185_ = (1 + i_183_ - (anInt8897 << 12) - GLSprite_Sub2.anInt8900)
								/ GLSprite_Sub2.anInt8900) > i_184_)
							i_184_ = i_185_;
			...
			while (i_190_ < 0) {
				...
				if (i_191_ >= 0) {
					...
					if (i_194_ >= 0 && i_194_ - (anInt8897 << 12) < 0) {
						...
						int i_197_;
						if ((i_197_ = (1 + i_193_ - (anInt8893 << 12) - GLSprite_Sub2.anInt8913)
								/ GLSprite_Sub2.anInt8913) > i_195_)
							i_195_ = i_197_;
			...
			while (i_202_ < 0) {
				...
				if (i_203_ >= 0) {
					...
					int i_209_;
					if ((i_209_ = (1 + i_205_ - (anInt8893 << 12) - GLSprite_Sub2.anInt8913)
							/ GLSprite_Sub2.anInt8913) > i_207_)
						i_207_ = i_209_;
			...
			while (i_214_ < 0) {
				...
				if (i_215_ >= 0) {
					...
					int i_221_;
					if ((i_221_ = (1 + i_217_ - (anInt8893 << 12) - GLSprite_Sub2.anInt8913)
							/ GLSprite_Sub2.anInt8913) > i_219_)
						i_219_ = i_221_;
					if (i_218_ < 0) {
					...
					if ((i_221_ = (1 + i_218_ - (anInt8897 << 12) - GLSprite_Sub2.anInt8900)
							/ GLSprite_Sub2.anInt8900) > i_219_)
						i_219_ = i_221_;
