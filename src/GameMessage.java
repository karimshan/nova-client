...
public class GameMessage extends Node {
	
	public static int anInt7623;
	public static int anInt7625;
	public static int anInt7627;

	public static final void method2966(String string, String string_0_, int i, String string_1_, String string_2_,
			boolean bool, int i_3_, String string_4_, int i_5_) {
		// //System.out.print(""+string+", "+string_0_+", "+string_1_+",
		// "+string_2_+", "+string_4_+"\n");
