...
public abstract class GameStub extends Applet implements Runnable,
	...
	static {
		...
		for (int i = 0; i < 16384; i++) {
			aFloatArray42[i] = (float) Math.sin(d * i);
			aFloatArray39[i] = (float) Math.cos(i * d);
		}
	}
	...
	static final void method88(byte b) {
		...
		if (Class73.aCacheNode_Sub4_988 != null) {
			...
			Class310.method3589(CacheNode.anInt7033, Class367.anInt4539,
					(byte) 109, Class18.anInt309, ReferenceTable.anInt286);
		}
	}
	...
	public final AppletContext getAppletContext() {
		...
		if (Class96.mainGameApplet != null && this != Class96.mainGameApplet) {
			return Class96.mainGameApplet.getAppletContext();
		}
	...
	public final URL getCodeBase() {
		...
		if (Class96.mainGameApplet != null && this != Class96.mainGameApplet) {
			return Class96.mainGameApplet.getCodeBase();
		}
	...
	public final URL getDocumentBase() {
		...
		if (Class96.mainGameApplet != null && Class96.mainGameApplet != this) {
			return Class96.mainGameApplet.getDocumentBase();
		}
	...
	public final String getParameter(String string) {
		...
		if (Class96.mainGameApplet != null && this != Class96.mainGameApplet) {
			return Class96.mainGameApplet.getParameter(string);
		}
	...
	String sendDebugInformation(int i) {
		anInt17++;
		if (i != 10) {
			init();
		}
	...
	private final void method84(int i, boolean bool) {
		...
		if (Class96.mainGameApplet != null) {
			Class96.mainGameApplet.destroy();
		}
		try {
			method85(96);
		...
		if (Node_Sub38_Sub20.aCanvas10309 != null) {
			try {
				...
				Node_Sub38_Sub20.aCanvas10309.getParent().remove(
	...
	final void method87(int i, byte b, int i_0_, int i_1_, int i_2_,
			boolean bool, String string, int i_3_) {
		anInt20++;
		try {
			...
			Node_Sub29.aFrame7344.setTitle("Nova");
			...
			Node_Sub29.aFrame7344.setSize(Class36.anInt542 - -insets.left
					- -insets.right, insets.bottom + insets.top
					+ CacheNode_Sub3.anInt9441);
			Class152.aSignLink1940 = Class240.aSignLink2946 = new SignLink(
					i_1_, string, i, true);
			Class241 class241 = Class240.aSignLink2946.method3641((byte) 50,
					this, 1);
	...
	final void method90(String string, byte b) {
		...
		if (!aBoolean38) {
			...
			try {
				Class2.displayApplet("loggedout", Class96.mainGameApplet, (byte) -81);
			} catch (Throwable throwable) {
				/* empty */
			}
			do {
				try {
					getAppletContext().showDocument(
							new URL(getCodeBase(), "error_game_" + string
									+ ".ws"), "_top");
					if (b == 39) {
						break;
					}
	...
	private final void method91(int i) {
		...
		if (l_5_ != 0L
				&& (l_5_ ^ 0xffffffffffffffffL) > (l ^ 0xffffffffffffffffL)) {
			int i_6_ = (int) (l - l_5_);
			Node_Sub9_Sub4.framesPerSecond = (32000 - -(i_6_ >> 1)) / i_6_;
		}
		Class376.anInt4662 = 0x1f & 1 + Class376.anInt4662;
		if (Class339_Sub2.anInt8647++ > 50) {
			Class355.aBoolean4366 = true;
			Class339_Sub2.anInt8647 -= 50;
			Node_Sub38_Sub20.aCanvas10309.setSize(Class360.screenWidth,
					Class205.screenHeight);
			Node_Sub38_Sub20.aCanvas10309.setVisible(true);
			if (Node_Sub29.aFrame7344 != null
					&& DrawableModel.aFrame907 == null) {
				Insets insets = Node_Sub29.aFrame7344.getInsets();
				Node_Sub38_Sub20.aCanvas10309.setLocation(insets.left
						+ Class270_Sub1.anInt8033, Class131.anInt5447
						+ insets.top);
			} else {
				Node_Sub38_Sub20.aCanvas10309.setLocation(
						Class270_Sub1.anInt8033, Class131.anInt5447);
			}
		}
		method102(92);
	...
	final void method92(int i, int i_7_, int i_8_, int i_9_, String string,
			int i_10_, int i_11_) {
		anInt32++;
		try {
			if (Class82.aGameStub1123 != null) {
				...
				CacheNode_Sub16.anApplet9601 = Class96.mainGameApplet;
				...
				Class82.aGameStub1123 = this;
				Class152.aSignLink1940 = Class240.aSignLink2946 = new SignLink(
						i_9_, string, i_10_, Class96.mainGameApplet != null);
				Class241 class241 = Class240.aSignLink2946.method3641(
						(byte) 50, this, 1);
	...
	synchronized void method93(int i) {
		if (Node_Sub38_Sub20.aCanvas10309 != null) {
			Node_Sub38_Sub20.aCanvas10309.removeFocusListener(this);
			Node_Sub38_Sub20.aCanvas10309.getParent()
		...
		} else if (Class96.mainGameApplet == null) {
			container = Class82.aGameStub1123;
		} else {
			container = Class96.mainGameApplet;
		}
		container.setLayout(null);
		Node_Sub38_Sub20.aCanvas10309 = new RSCanvas(this);
		container.add(Node_Sub38_Sub20.aCanvas10309);
		Node_Sub38_Sub20.aCanvas10309.setSize(Class360.screenWidth,
				Class205.screenHeight);
		Node_Sub38_Sub20.aCanvas10309.setVisible(true);
		if (container != Node_Sub29.aFrame7344) {
			Node_Sub38_Sub20.aCanvas10309.setLocation(Class270_Sub1.anInt8033,
					Class131.anInt5447);
		} else {
			Insets insets = Node_Sub29.aFrame7344.getInsets();
			Node_Sub38_Sub20.aCanvas10309.setLocation(Class270_Sub1.anInt8033
					+ insets.left, insets.top + Class131.anInt5447);
		}
	...
	final boolean method95(byte b) {
		 ...
		 * return true; } if (string.equals("Nova.com") ||
		 * string.endsWith(".Nova.com")) { return true; } if
	...
	private final void method98(int i) {
		...
		if ((l_17_ ^ 0xffffffffffffffffL) != -1L
				&& (l_17_ ^ 0xffffffffffffffffL) > (l ^ 0xffffffffffffffffL)) {
			/* empty */
		}
	...
	public final synchronized void paint(Graphics graphics) {
		...
		if (Class82.aGameStub1123 == this && !Class137.aBoolean1715) {
			Class355.aBoolean4366 = true;
			if (Class250.aBoolean3175
					&& Class313.method3650(false) - Class82.aLong1112 > 1000L) {
				Rectangle rectangle = graphics.getClipBounds();
				if (rectangle == null || Class36.anInt542 <= rectangle.width
						&& rectangle.height >= CacheNode_Sub3.anInt9441) {
			...
			try {
				if (SignLink.aString3989 != null) {
					...
					if ((string.indexOf("sun") ^ 0xffffffff) != 0
						...
						if (string_13_.equals("1.1")
								|| string_13_.startsWith("1.1.")
								|| string_13_.equals("1.2")
								|| string_13_.startsWith("1.2.")) {
							method90("wrongjava", (byte) 39);
							break;
						}
					} else if (string.indexOf("ibm") != -1
							&& (SignLink.aString3995 == null || SignLink.aString3995
									.equals("1.4.2"))) {
						method90("wrongjava", (byte) 39);
						break;
					}
				}
				if (SignLink.aString3995 != null
						&& SignLink.aString3995.startsWith("1.")) {
					int i = 2;
					int i_14_ = 0;
				...
				while (Class321.aLong4068 == 0L
						|| Class313.method3650(false) < Class321.aLong4068) {
					GlobalMessage.anInt431 = Animable_Sub3_Sub1.aClass234_11017
							.method2147(Class171.aLong2071, 75);
					for (int i = 0; (i ^ 0xffffffff) > (GlobalMessage.anInt431 ^ 0xffffffff); i++)
						method98(-15337);
					method91(-74);
					ObjectDefinition.method3049(Class240.aSignLink2946,
							Node_Sub38_Sub20.aCanvas10309, (byte) 102);
				}
			} catch (Throwable throwable) {
				ClanChat.method507(throwable, sendDebugInformation(10), -117);
				method90("crash", (byte) 39);
			} finally {
				method84(16529, true);
			}
