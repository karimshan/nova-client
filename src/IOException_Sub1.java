...
public class IOException_Sub1 extends IOException {
	public static Class128 aClass128_85;
	public static int anInt84 = -1;
	public static int anInt86;
	public static int anInt87;

	public static final boolean method131(boolean bool, byte b) {
		if (bool != true)
	...
	public static final void method133(int i, Index index30, SignLink signlink) {
		...
		if (i == 255) {
			...
			if (!Animable_Sub1_Sub1.aSignLink10616.aBoolean3985) {
				...
				else if (Class223.aString2656.startsWith("i386") || Class223.aString2656.startsWith("i486")
						|| Class223.aString2656.startsWith("i586") || Class223.aString2656.startsWith("x86"))
