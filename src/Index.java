...
public class Index {
	...
	public static final void method3535(java.awt.Canvas canvas, boolean bool) {
		anInt3806++;
	...
	public final void method3504(boolean bool, byte b, boolean bool_0_) {
		anInt3810++;
		if (method3530(0)) {
			if (bool) {
	...
	public final int method3505(boolean bool) {
		if (bool != false)
			return 36;
		anInt3798++;
		if (!method3530(0))
	...
	public final boolean method3506(String string, boolean bool, String string_1_) {
		anInt3812++;
		if (!method3530(0))
			return false;
	...
	public final boolean method3507(byte b, String string) {
		anInt3791++;
		if (b >= -116)
			return true;
	...
	public final boolean method3510(int i, byte b) {
		anInt3788++;
		if (!method3530(b + -63))
			return false;
		if (anArchive3797.anIntArray285.length == 1)
			return requestDownload(i, 0, 0);
		if (!method3525((byte) -86, i))
			return false;
		if (anArchive3797.anIntArray285[i] == 1)
			return requestDownload(0, i, 0);
		if (b != 63)
			anObjectArray3783 = null;
		throw new RuntimeException();
	}

	public final int method3511(int i) {
		if (i != 19492)
			return 48;
		anInt3803++;
		if (!method3530(0))
	...
	public final byte[] method3512(int[] is, int i, int i_8_, int i_9_) {
		anInt3813++;
	...
	private final boolean method3513(int i, int i_11_, byte b) {
		...
		if (!method3530(0))
			return false;
		if (i_11_ < 0 || (i ^ 0xffffffff) > -1 || i_11_ >= anArchive3797.anIntArray285.length
				|| anArchive3797.anIntArray285[i_11_] <= i) {
	...
	public final boolean requestDownload(int i, int i_48_, int i_49_) {
		anInt3785++;
	...
	public final boolean method3516(String string, int i) {
		anInt3799++;
		if (!method3530(0))
			return false;
		if (i >= -72)
	...
	public final byte[] method3518(byte b, int i) {
		anInt3790++;
		if (!method3530(0))
			return null;
	...
	public final int method3519(String string, byte b) {
		anInt3787++;
		if (!method3530(0))
			return -1;
		if (b <= 4)
	...
	public final boolean method3520(byte b) {
		anInt3793++;
		if (!method3530(b ^ 0xf))
			return false;
		if (b != 15)
			aClass34_3804 = null;
		boolean bool = true;
		for (int i_53_ : anArchive3797.anIntArray300) {
	...
	public final void method3521(byte b) {
	...
	public final int method3522(byte b, String string) {
		anInt3789++;
		if (!method3530(0))
			return 0;
		if (b <= 26)
	...
	public final void method3523(byte b) {
		anInt3796++;
		if (b != -46)
			method3527(null, 1);
	...
	public final byte[] method3524(boolean bool, int i, int i_54_) {
		if (bool != false)
			aClass34_3804 = null;
		anInt3784++;
	...
	private final boolean method3525(byte b, int i) {
		...
		if (!method3530(0))
			return false;
		if ((i ^ 0xffffffff) > -1 || i >= anArchive3797.anIntArray285.length
				|| (anArchive3797.anIntArray285[i] ^ 0xffffffff) == -1) {
			if (!Class144_Sub3.aBoolean6833)
				return false;
	...
	public final int method3526(int i) {
		anInt3782++;
		if (i != -20871)
			method3532(-99, -38);
		if (!method3530(0))
	...
	public final boolean method3527(String string, int i) {
		anInt3800++;
		if (!method3530(i))
			return false;
		string = string.toLowerCase();
	...
	public final int method3528(byte b, int i) {
		anInt3815++;
		if (!method3530(0))
			return -1;
	...
	public final byte[] method3529(String string, String string_57_, int i) {
		anInt3820++;
		if (!method3530(0))
			return null;
		string = string.toLowerCase();
	...
	public final void method3531(String string, int i) {
		anInt3809++;
		if (method3530(0)) {
			string = string.toLowerCase();
			if (i != -18758)
	...
	public final int[] method3532(int i, int i_61_) {
		anInt3811++;
		if (!method3525((byte) -86, i))
			return null;
	...
	private final boolean method3533(boolean bool, String string, String string_63_) {
		...
		return requestDownload(i_64_, i, 0);
	}

	public final void method3534(byte b, int i) {
		anInt3805++;
		if (method3525((byte) -86, i))
			if (anObjectArrayArray3786 != null)
				anObjectArrayArray3786[i] = null;
	...
	public final boolean method3536(int i, int i_66_) {
		anInt3801++;
	...
	public final int method3537(int i, int i_67_) {
		if (i != -2)
			anInt3795 = 123;
		anInt3802++;
