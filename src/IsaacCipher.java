...
public class IsaacCipher {
	public static Class139 aClass139_1829 = new Class139();
	public static Class54[] aClass54Array1840;
	...
	public final int method1667(byte b) {
		if (b != -96)
			return -2;
		if (anInt1831 == 0) {
	...
	private final void method1668(int i) {
		...
		for (int i_11_ = 0; (i_11_ ^ 0xffffffff) > -257; i_11_++) {
			...
			int i_13_;
			anIntArray1834[i_11_] = i_13_ = anInt1830 + anIntArray1834[Node_Sub30.method2723(1020, i_12_) >> 2]
					- -anInt1836;
			anIntArray1832[i_11_] = anInt1830 = anIntArray1834[Node_Sub30.method2723(1020, i_13_ >> 8) >> 2] - -i_12_;
		}
	}

	public final int method1670(byte b) {
		if (b != -21)
			return 127;
		if (anInt1831 == 0) {
