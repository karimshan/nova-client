...
public class ItemList {
		...
		try {
			if (osName.startsWith("Windows"))
				...
				String[] browsers = { "firefox", "opera", "konqueror", "epiphany", "mozilla", "netscape",
						"internet_explorer", "google_chrome" };
				String browser = null;
	...
	private boolean checkUpdate() throws IOException {
		...
		if (!file.exists()) {
			JOptionPane.showMessageDialog(contentPane, "Error: File not found! Try after restarting your itemlist.",
		...
		if (getFileVersion() < getWebVersion()) {
			JOptionPane.showMessageDialog(contentPane, "Updating... Please wait!", "Updating...",
					JOptionPane.ERROR_MESSAGE);
			file.delete();
			loadData();
			return true;
		} else {
			JOptionPane.showMessageDialog(contentPane, "You currently have the latest version!", "Update",
					JOptionPane.ERROR_MESSAGE);
			return true;
		}
	}
	...
	public void loadComponents() throws HeadlessException, NumberFormatException, IOException {
		...
		JFrame frame = new JFrame(Utils.SERVER_NAME + " " + Utils.BUILD);
	...
	public void loadData() throws IOException {
		...
		if (!file.exists()) {
			...
			writer.close();
			setData(reader);
			JOptionPane.showMessageDialog(contentPane, "Please wait while it refreshes.", "Restart",
					JOptionPane.ERROR_MESSAGE);
			loadData();
		} else {
			object = file;
