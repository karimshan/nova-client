...
public class Login {
	...
	public static boolean[] aBooleanArray2387 = new boolean[100];
	public static Class299 aClass299_2380;
	public static double aDouble2401;
	...
	public static final void login(byte b) {
		anInt2397++;
		if (Node_Sub38_Sub8.anInt10163 != 0 && Node_Sub38_Sub8.anInt10163 != 10) {
			...
			try {
				...
				if (FixedAnimator.FACEBOOK_LOGIN && (Node_Sub38_Sub8.anInt10163 ^ 0xffffffff) <= -7)
					i = 6000;
				...
				if (Node_Sub38_Sub8.anInt10163 == 1) {
					if ((Class159.loginType ^ 0xffffffff) != -3)
						...
						Class320_Sub23.aClass123_8432.aClass241_1565 = Class181.aClass197_2155.method2000((byte) -103,
				...
				if ((Node_Sub38_Sub8.anInt10163 ^ 0xffffffff) == -3) {
					...
					if (FixedAnimator.FACEBOOK_LOGIN) {
						node_sub13.packet.writeByte(Plane.aClass133_3420.packetId);
						node_sub13.packet.writeShort(0);
						int i_33_ = node_sub13.packet.offset;
						node_sub13.packet.writeInt(667);
						if ((Class159.loginType ^ 0xffffffff) == -3)
							node_sub13.packet.writeByte(Class151.anInt1843 != 14 ? 0 : 1);
						...
						buffer.writeByte(Class209.directory.anInt4344);
						...
						node_sub13.packet.method2194(node_sub13.packet.offset - i_33_, -2887);
					} else
						node_sub13.packet.writeByte(Plane.aClass133_3406.packetId);
				...
				if (Node_Sub38_Sub8.anInt10163 == 5) {
					if (!Class320_Sub23.aClass123_8432.aClass365_1557
							.method4068(Class320_Sub23.aClass123_8432.aPacket1570.offset, 43))
						return;
					...
					if (!Animable_Sub2_Sub1.aBoolean10628 || (Class188_Sub2_Sub1.method1910((byte) 84,
							Class240.aSignLink2946, string, string_36_, 1).anInt2953 ^ 0xffffffff) == -3)
						Class140.method1610(0, string, string_36_, Class240.aSignLink2946,
								(Class213.aNode_Sub27_2512.aClass320_Sub29_7270.method3791(false) ^ 0xffffffff) == -2,
								true);
				...
				if (Node_Sub38_Sub8.anInt10163 == 7) {
					...
					Class243.username = Class188_Sub1_Sub1.aString9327 = Class154
							.method1699(Class320_Sub23.aClass123_8432.aPacket1570.readLong(), 25589);
				...
				if (Node_Sub38_Sub8.anInt10163 == 8) {
					...
					Node_Sub13 node_sub13 = Node_Sub25_Sub1.method2660(0);
					Packet packet = node_sub13.packet;
					if (Class159.loginType == 2) { // world login
						...
						if (!FixedAnimator.FACEBOOK_LOGIN) { // not social network
							packet.writeInt(Utils.REVISION);
							packet.writeInt(Loader.SUB_BUILD);
							packet.writeString(MACAddress.get());
							packet.writeByte((Class151.anInt1843 ^ 0xffffffff) == -15 ? 1 : 0);
							i_38_ = packet.offset;
							BufferedStream buffer = CacheNode_Sub17.method2397((byte) 27);
							packet.writeBytes(buffer.offset, buffer.buffer, 0);
							i_38_ = packet.offset;
							packet.writeString(Class243.username);
							Utils.displayedQuickLogin = false;
							System.out.println("Username: " + Class243.username);
						}
						...
						BufferedStream buffer_39_ = new BufferedStream(
								Node_Sub23.aNode_Sub39_7201.method2923((byte) 66));
						...
						packet.writeByte(Class209.directory.anInt4344); // game,
						// 0
						// =
						// Nova
					...
					Class320_Sub23.aClass123_8432.sendPacket(126, node_sub13);
					Class320_Sub23.aClass123_8432.method1512((byte) -89);
					Class320_Sub23.aClass123_8432.isaacCipher = new IsaacCipher(Class121.isaacKeys);
									...
									if ((opcode ^ 0xffffffff) == -16) {
										...
										if (opcode == 23 && Class45.anInt5264 < 3) {
											...
											if ((opcode ^ 0xffffffff) == -43) {
												...
												if (!Class296.aBoolean5428 || FixedAnimator.FACEBOOK_LOGIN
													...
													FixedAnimator.FACEBOOK_LOGIN = true;
													Node_Sub38_Sub8.anInt10163 = 1;
													Class262_Sub12.anInt7791 = 0;
													Class320_Sub23.aClass123_8432.aClass365_1557.method4062(-2);
													Class320_Sub23.aClass123_8432.aClass365_1557 = null;
				...
				if (Node_Sub38_Sub8.anInt10163 == 11) {
					...
					Node_Sub13 node_sub13 = Node_Sub25_Sub1.method2660(0);
					Packet packet = node_sub13.packet;
					packet.method2266(Class320_Sub23.aClass123_8432.isaacCipher, -47);
					...
					if (Node_Sub38_Sub8.anInt10163 == 14) {
						...
						if (Class159.loginType != 2) {
							...
							packet.offset = 0;
							Player.rights = packet.readUnsignedByte();
							...
							Node_Sub8.aLong7068 = Node_Sub32.aLong7382 + -Class313.method3650(false)
							...
							Player.get.realName = Player.get.displayName = Node_Sub40.myPlayerDisplayName = packet
									.method2180((byte) -55);
							...
							if (!Class320_Sub23.aClass123_8432.aClass365_1557.method4068(Node_Sub8.anInt7070, 63))
								return;
							Class320_Sub23.aClass123_8432.aClass365_1557.method4065((byte) -84, packet.buffer,
									Node_Sub8.anInt7070, 0);
							packet.offset = 0;
							Player.rights = packet.readUnsignedByte();
							Class25.anInt452 = packet.readUnsignedByte();
						...
						if (Node_Sub38_Sub18.aBoolean10282 && !ProducingGraphicsBuffer.aBoolean9900
							...
							try {
								Class2.displayApplet("zap", Class96.mainGameApplet, (byte) -110);
							} catch (Throwable throwable) {
								if (LoadingBar.displayingAdvertisement)
									try {
										// Class96.anApplet1270.getAppletContext().showDocument(new
										// URL("http://matrixforum.webatu.com/"),
							...
							try {
								Class2.displayApplet("unzap", Class96.mainGameApplet, (byte) -125);
							} catch (Throwable throwable) {
								/* empty */
							}
						if (Node_Sub38_Sub1.aClass329_10086 == Class240.aClass329_2943)
							try {
								Class2.displayApplet("loggedin", Class96.mainGameApplet, (byte) -122);
							} catch (Throwable throwable) {
								/* empty */
							}
						if (Class159.loginType != 2) {
					...
					if (Node_Sub38_Sub8.anInt10163 == 16) {
						if (!Class320_Sub23.aClass123_8432.aClass365_1557.method4068(3, 68))
							return;
						Class320_Sub23.aClass123_8432.aClass365_1557.method4065((byte) -73,
								Class320_Sub23.aClass123_8432.aPacket1570.buffer, 3, 0);
					...
					if (Node_Sub38_Sub8.anInt10163 == 17) {
						...
						Class320_Sub23.aClass123_8432.incomingPacket = Class310.getIncomingPackets()[packet.readPacket()];
					...
					if (Node_Sub38_Sub8.anInt10163 == 15) {
						if (Class320_Sub23.aClass123_8432.aClass365_1557
								.method4068(Class320_Sub23.aClass123_8432.anInt1581, 63)) {
							Class320_Sub23.aClass123_8432.aClass365_1557.method4065((byte) -86,
									Class320_Sub23.aClass123_8432.aPacket1570.buffer,
							...
							Player.anInt11178 = -1;
							if (Class320_Sub23.aClass123_8432.incomingPacket != Class156.aClass192_1962)
							...
							if (Class320_Sub23.aClass123_8432.aPacket1570.offset != i_46_)
								throw new RuntimeException("lswp pos:"
										+ Class320_Sub23.aClass123_8432.aPacket1570.offset + " psize:" + i_46_);
							Class320_Sub23.aClass123_8432.incomingPacket = null;
						}
						...
						if (Class320_Sub23.aClass123_8432.anInt1581 == -2) {
							if (!Class320_Sub23.aClass123_8432.aClass365_1557.method4068(2, 19))
								return;
							Class320_Sub23.aClass123_8432.aClass365_1557.method4065((byte) -91,
									Class320_Sub23.aClass123_8432.aPacket1570.buffer, 2, 0);
							Class320_Sub23.aClass123_8432.aPacket1570.offset = 0;
						...
						if (Class320_Sub23.aClass123_8432.aClass365_1557
								.method4068(Class320_Sub23.aClass123_8432.anInt1581, 47)) {
							Class320_Sub23.aClass123_8432.aClass365_1557.method4065((byte) -54,
									Class320_Sub23.aClass123_8432.aPacket1570.buffer,
									Class320_Sub23.aClass123_8432.anInt1581, 0);
							Class320_Sub23.aClass123_8432.aPacket1570.offset = 0;
							Node_Sub38_Sub8.anInt10163 = 0;
							...
							if (i_47_ != Class320_Sub23.aClass123_8432.aPacket1570.offset)
								throw new RuntimeException("lswpr pos:"
										+ Class320_Sub23.aClass123_8432.aPacket1570.offset + " psize:" + i_47_);
							Class320_Sub23.aClass123_8432.incomingPacket = null;
						}
					}
				}
	...
	public static final Node_Sub14 method1985(boolean bool) {
		anInt2383++;
	...
	public static final void method1988(int i, float f, float f_17_, int i_18_, Class328 class328, byte[] bs, float f_19_,
		...
		for (int i_27_ = 0; i_23_ > i_27_; i_27_++) {
			int i_28_ = i_24_;
			class328.method3826(f / i, 127.0F * f_25_, i_22_, fs, 0, f_21_ / i_20_, i_18_, f_17_ / i_22_, i_20_,
					(byte) 123, i);
	...
	public final void method1983(BufferedStream buffer, boolean bool) {
		anInt2391++;
		if (bool == true)
			for (;;) {
	...
	public final DrawableModel method1986(byte b, boolean bool, int i, Animator animator, Plane plane, byte b_0_, int i_1_,
		...
		synchronized (aClass101_2392.aClass61_1311) {
			drawablemodel = (DrawableModel) aClass101_2392.aClass61_1311
					.method607(anInt2378 |= graphicstoolkit.anInt1537 << 29, 0);
		...
		if (drawablemodel == null || graphicstoolkit.b(drawablemodel.ua(), i_5_) != 0) {
			...
			synchronized (aClass101_2392.aClass61_1311) {
				aClass101_2392.aClass61_1311.method601(drawablemodel, 25566,
						anInt2378 |= graphicstoolkit.anInt1537 << 29);
			}
		}
	...
	public final DrawableModel method1989(Animator animator, byte b, int i, byte b_32_, GraphicsToolkit graphicstoolkit) {
		if (b_32_ != 87)
			return null;
		anInt2398++;
