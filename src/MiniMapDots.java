...
public class MiniMapDots {
	...
	public static final void method171(byte b, int i, aa var_aa, GLSprite glsprite, int i_0_, int i_1_,
			IComponentDefinitions widget, int i_2_) {
		anInt125++;
		if (glsprite != null) {
			int i_3_;
			...
			if ((i_4_ * i_4_ ^ 0xffffffff) <= (i_5_ ^ 0xffffffff)) {
				...
				if (b == -116) {
					...
					glsprite.method1189(i_8_ + widget.anInt4809 / 2 + (i_2_ + -(glsprite.method1197() / 2)),
							widget.anInt4695 / 2 + (i - i_9_ + -(glsprite.method1186() / 2)), var_aa, i_2_, i);
				}
			}
		}
	}
