...
abstract class Mobile extends Animable {
	public static boolean aBoolean9118;
	public static BufferedStream aBuffer9128;
	public static int anInt9117;
	public static int anInt9123;
	public static int anInt9125;
	public static int anInt9126;
	public static int anInt9129;
	public static int[][] anIntArrayArray9122 = new int[6][];
	static {
		aBoolean9118 = false;
	}

	public static final String method844(CacheNode_Sub13 cachenode_sub13, byte b) {
		if (b < 125)
		...
		if (cachenode_sub13.aString9565 != null && (cachenode_sub13.aString9565.length() ^ 0xffffffff) != -1) {
			if (cachenode_sub13.aString9558 != null && (cachenode_sub13.aString9558.length() ^ 0xffffffff) < -1)
				return cachenode_sub13.aString9560 + GlobalMessage.NPC_HOVER_BLANK_SPACE.getMessage(Class35.language)
						+ cachenode_sub13.aString9558 + GlobalMessage.NPC_HOVER_BLANK_SPACE.getMessage(Class35.language)
	...
	Mobile(int i, int i_19_, int i_20_, int i_21_, int i_22_, int i_23_, int i_24_, int i_25_, int i_26_, boolean bool,
			byte b) {
		...
		for (int i_14_ = aShort9119; (aShort9130 ^ 0xffffffff) <= (i_14_ ^ 0xffffffff); i_14_++)
			for (int i_15_ = aShort9120; i_15_ <= aShort9124; i_15_++) {
				...
				if ((i_16_ ^ 0xffffffff) <= -1
						&& (i_16_ ^ 0xffffffff) > (Class139.aBooleanArrayArray1730.length ^ 0xffffffff)) {
					int i_17_ = Node_Sub9_Sub1.anInt9656 + -EntityNode_Sub7.anInt6013 + i_15_;
					if ((i_17_ ^ 0xffffffff) <= -1
							&& (i_17_ ^ 0xffffffff) > (Class139.aBooleanArrayArray1730.length ^ 0xffffffff)
							&& Class139.aBooleanArrayArray1730[i_16_][i_17_])
						return true;
				}
			}
		return false;
	...
	public final boolean method815(byte b, GraphicsToolkit graphicstoolkit) {
		...
		anInt9129++;
		return Node_Sub3.method2171(aShort9120, aShort9130, (byte) -127, this.method809(graphicstoolkit, -115),
				aShort9124, aShort9119, aByte5931);
	}
	...
	public final int method819(Node_Sub29[] node_sub29s, int i) {
		...
		if (i != 1)
			return -78;
		while_182_: for (int i_1_ = aShort9119; aShort9130 >= i_1_; i_1_++)
			for (int i_2_ = aShort9120; (i_2_ ^ 0xffffffff) >= (aShort9124 ^ 0xffffffff); i_2_++) {
				long l = PlayerMasks.aLongArrayArrayArray1228[plane][i_1_][i_2_];
				long l_3_ = 0L;
				while_181_: while (l_3_ <= 48L) {
		...
		if ((aByte9127 ^ 0xffffffff) != -1) {
			...
			int i_12_ = 0;
			while_184_: for (/**/; (i_0_ ^ 0xffffffff) < (i_12_ ^ 0xffffffff); i_12_++) {
				long l = PlayerMasks.aLongArrayArrayArray1228[plane][s][i_9_];
				while (l != 0L) {
				...
				l = PlayerMasks.aLongArrayArrayArray1228[plane][i_10_][s_11_];
