...
public class Mobile_Sub1 extends Mobile {
	public static boolean aBoolean10959 = true;
	public static boolean aBoolean10961 = false;
	public static Class104 aClass104_10947 = new Class104();
	public static int anInt10911;
	public static int anInt10913;
	public static int anInt10918;
	public static int anInt10922;
	public static int anInt10924;
	public static int anInt10926;
	public static int anInt10928;
	public static int anInt10929;
	public static int anInt10930 = 0;
	public static int anInt10932;
	public static int anInt10935;
	public static int anInt10936;
	public static int anInt10941;
	public static int anInt10944;
	public static int anInt10945;
	public static int anInt10946;
	public static int anInt10949;
	public static int anInt10952;
	public static int anInt10953;
	public static int anInt10954;
	public static int anInt10960 = 0;
	...
	Mobile_Sub1(int i, int i_19_, int i_20_, int i_21_, int i_22_, int i_23_, int i_24_, int i_25_, int i_26_,
			int i_27_, int i_28_, int i_29_, int i_30_, boolean bool, int i_31_) {
		super(i_19_, i_20_, i_21_, -i_23_ + Node_Sub38_Sub7.method2809(i_19_, -29754, i_22_, i_21_), i_22_, i_21_ >> 9,
				i_21_ >> 9, i_22_ >> 9, i_22_ >> 9, false, (byte) 0);
		anInt10956 = i_23_;
		anInt10948 = i;
		anInt10958 = i_24_;
		anInt10920 = i_31_;
	...
	@Override
	public final boolean method810(int i, int i_18_, boolean bool, GraphicsToolkit graphicstoolkit) {
		if (bool != false)
	...
	@Override
	public final void method816(int i, boolean bool, GraphicsToolkit graphicstoolkit, int i_6_, byte b, int i_7_,
			Animable animable) {
		if (b >= 101) {
			anInt10918++;
			throw new IllegalStateException();
	...
	public final void method895(int i, boolean bool, int i_0_, int i_1_, int i_2_) {
		if (!aBoolean10951) {
			double d = -anInt5934 + i_2_;
			double d_3_ = -anInt5940 + i_1_;
			double d_4_ = Math.sqrt(d_3_ * d_3_ + d * d);
			aDouble10921 = anInt10937 * d_3_ / d_4_ + anInt5940;
			aDouble10957 = anInt5934 + d * anInt10937 / d_4_;
			if (!aBoolean10915)
				aDouble10925 = anInt5937;
			else
				aDouble10925 = Node_Sub38_Sub7.method2809(plane, -29754, (int) aDouble10921, (int) aDouble10957)
						- anInt10956;
		}
		anInt10913++;
		double d = anInt10923 - -1 - i_0_;
		aDouble10916 = (i_1_ - aDouble10921) / d;
		aDouble10939 = (i_2_ - aDouble10957) / d;
		if (bool != false)
			anInt10942 = -124;
		aDouble10927 = Math.sqrt(aDouble10939 * aDouble10939 + aDouble10916 * aDouble10916);
		if ((anInt10933 ^ 0xffffffff) != 0) {
			if (!aBoolean10951)
				aDouble10912 = -aDouble10927 * Math.tan(0.02454369 * anInt10933);
			aDouble10917 = 2.0 * (-(d * aDouble10912) + (-aDouble10925 + i)) / (d * d);
		} else
			aDouble10912 = (-aDouble10925 + i) / d;
	}

	private final DrawableModel method896(int i, GraphicsToolkit graphicstoolkit, int i_8_) {
		anInt10952++;
		Login class195 = Class16.aClass101_228.method1090(116, anInt10948);
		return class195.method1989(anAnimator10955, (byte) 2, i, (byte) 87, graphicstoolkit);
	}

	public final void method897(int i) {
		if (i > -30)
			method807(18, null);
		anInt10953++;
		if (anEntityNode_Sub4_10943 != null)
	...
	public final void method898(boolean bool) {
		anInt10928++;
		if (bool != false)
			anInt10914 = -84;
		if (!aBoolean10951)
			if (anInt10934 != 0) {
				...
				if (aa.anInt101 != 3) {
					if (anInt10934 < 0) {
						...
						if (Class166.myPlayerIndex == i)
							...
							actor = Client.LOCAL_PLAYERS[i];
					} else {
						int i = anInt10934 + -1;
						Node_Sub41 node_sub41 = (Node_Sub41) Class12.aHashTable187.getNode(3512, i);
						if (node_sub41 != null)
				...
				if (actor != null) {
					...
					anInt5937 = Node_Sub38_Sub7.method2809(plane, -29754, actor.anInt5940, actor.anInt5934)
							- anInt10956;
					if (anInt10920 >= 0) {
	...
	private final void method899(byte b, GraphicsToolkit graphicstoolkit, Class336 class336,
		...
		if ((anEntityNode_Sub4_10943 == null || anEntityNode_Sub4_10943.aBoolean5972)
				&& (class300s != null || class218s != null))
			anEntityNode_Sub4_10943 = EntityNode_Sub4.method963(Class174.clientCycle, true);
		if (b == -75)
			if (anEntityNode_Sub4_10943 != null) {
				anEntityNode_Sub4_10943.method952(graphicstoolkit, Class174.clientCycle, class300s, class218s, false);
				anEntityNode_Sub4_10943.method967(plane, aShort9119, aShort9130, aShort9120, aShort9124);
			}
	}

	public final void method901(byte b, int i) {
		aDouble10957 += i * aDouble10939;
		aBoolean10951 = true;
		aDouble10921 += i * aDouble10916;
		anInt10911++;
		if (!aBoolean10915) {
			if ((anInt10933 ^ 0xffffffff) == 0)
				aDouble10925 += aDouble10912 * i;
			else {
				aDouble10925 += i * aDouble10912 + aDouble10917 * 0.5 * i * i;
				aDouble10912 += i * aDouble10917;
			}
		} else
			aDouble10925 = Node_Sub38_Sub7.method2809(plane, -29754, (int) aDouble10921, (int) aDouble10957)
					+ -anInt10956;
