...
public class Mobile_Sub2 extends Mobile implements Interface19 {
	...
	public static int anInt10705;
	public static int anInt10706;
	public static int anInt10707;
	public static int anInt10708;
	public static int anInt10709;
	public static int anInt10710;
	public static int anInt10712;
	public static int anInt10713;
	...
	public static int anInt10728;
	public static int anInt10730;
	public static int anInt10732;
	public static int anInt10733;
	public static int anInt10735;
	...
	Mobile_Sub2(GraphicsToolkit graphicstoolkit, ObjectDefinition objectdefinition, int i, int i_3_, int i_4_, int i_5_,
			int i_6_, boolean bool, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_, boolean bool_13_) {
		super(i, i_3_, i_4_, i_5_, i_6_, i_7_, i_8_, i_9_, i_10_, objectdefinition.anInt2970 == 1,
				Class320_Sub7.method3707(i_11_, (byte) 125, i_12_));
		...
		aBoolean10714 = graphicstoolkit.r() && objectdefinition.aBoolean2972 && !aBoolean10719
	...
	public final EntityNode_Sub6 method807(int i, GraphicsToolkit graphicstoolkit) {
		...
		if (!Node_Sub15_Sub10.aBoolean9850)
			...
			aDrawableModel10724.method622(class336, entitynode_sub6.anEntityNode_Sub5Array5995[0], Class308.anInt3912,
					0);
	...
	public final Class171 method809(GraphicsToolkit graphicstoolkit, int i) {
		...
		if (aClass171_10711 == null)
			aClass171_10711 = Class167.method1752(0, anInt5937, anInt5934, method902((byte) 69, graphicstoolkit, 0),
					anInt5940);
		anInt10728++;
	...
	@Override
	public final boolean method810(int i, int i_1_, boolean bool, GraphicsToolkit graphicstoolkit) {
		anInt10727++;
	...
	@Override
	public final void method816(int i, boolean bool, GraphicsToolkit graphicstoolkit, int i_16_, byte b, int i_17_,
			Animable animable) {
		anInt10717++;
	...
	public final int method903(int i) {
		anInt10706++;
		if (i >= -20)
			anInt10722 = 47;
		if (aDrawableModel10724 == null)
	...
	private final Class243 method904(GraphicsToolkit graphicstoolkit, byte b, boolean bool, int i) {
		...
		ObjectDefinition objectdefinition = Class186.aClass112_2256
				.method1145(/* 0xffff & */aShort10734, 73);
		if (b < 7)
			method811(111);
		Plane plane;
		Plane plane_19_;
		...
		return objectdefinition.method3046(aByte10731 == 11 ? (int) (aByte10725 + 4) : aByte10725, anInt5940, anInt5934,
				plane, bool, (byte) 0, anInt5937, (aByte10731 ^ 0xffffffff) != -12 ? aByte10731 : 10, graphicstoolkit,
				null, i, plane_19_);
	}
}
