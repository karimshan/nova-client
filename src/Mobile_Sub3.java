...
public class Mobile_Sub3 extends Mobile implements Interface19 {
	public static IncomingPacket aClass192_10778;
	public static int anInt10768;
	public static int anInt10769;
	public static int anInt10770;
	public static int anInt10771;
	public static int anInt10772;
	public static int anInt10773;
	public static int anInt10775;
	public static int anInt10776;
	public static int anInt10779;
	public static int anInt10781;
	public static int anInt10782;
	public static int anInt10783;
	public static int anInt10784 = 0;
	public static int anInt10785;
	public static int anInt10787;
	public static int anInt10788;
	public static int anInt10789;
	public static int anInt10790;
	public static int anInt10791;
	public static int anInt10792;
	static {
		aClass192_10778 = new IncomingPacket(12, -2);
	}
	...
	Mobile_Sub3(GraphicsToolkit graphicstoolkit, ObjectDefinition objectdefinition, int i, int i_6_, int i_7_, int i_8_,
			int i_9_, boolean bool, int i_10_, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_, int i_16_) {
		super(i, i_6_, i_7_, i_8_, i_9_, i_10_, i_11_, i_12_, i_13_, objectdefinition.anInt2970 == 1,
				PlayerUpdateReference.method3810(i_14_, false, i_15_));
	...
	public final EntityNode_Sub6 method807(int i, GraphicsToolkit graphicstoolkit) {
		...
		aClass310_10777.method3600(aShort9124, drawablemodel, true, -9827, graphicstoolkit, aShort9130, aShort9119,
				aShort9120, class336);
	...
	public final void method820(GraphicsToolkit graphicstoolkit, int i) {
		...
		if (i == -5)
			if (drawablemodel != null) {
				Class336 class336 = graphicstoolkit.A();
				class336.method3854(anInt5934, anInt5937, anInt5940);
				aClass310_10777.method3600(aShort9124, drawablemodel, false, -9827, graphicstoolkit, aShort9130,
						aShort9119, aShort9120, class336);
			}
	}
	...
	public final void method906(int i, Class121 class121) {
		anInt10771++;
