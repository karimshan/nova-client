...
public class Mobile_Sub4 extends Mobile {
	public static boolean aBoolean10988 = false;
	public static OutgoingPacket aClass318_10992 = new OutgoingPacket(62, 3);
	public static int anInt10962;
	public static int anInt10963;
	public static int anInt10964;
	public static int anInt10966;
	public static int anInt10967;
	public static int anInt10970;
	public static int anInt10971;
	public static int anInt10972;
	public static int anInt10973;
	public static int anInt10974;
	public static int anInt10975;
	public static int anInt10978;
	public static int anInt10980;
	public static int anInt10981 = 0;
	public static int anInt10982;
	public static int anInt10983;
	public static int anInt10984;
	public static int anInt10985;
	public static int anInt10986;
	...
	public static final void method911(byte b) {
		anInt10995++;
		if (b >= 2) {
			CacheNode_Sub17.anInt8835 = 0;
			int i = (Player.get.anInt5934 >> 9) + Node_Sub53.gameSceneBaseX;
			int i_3_ = Class320_Sub4.gameSceneBaseY + (Player.get.anInt5940 >> 9);
			...
			if (i >= 3072 && i <= 3118 && i_3_ >= 9492 && (i_3_ ^ 0xffffffff) >= -9536)
				CacheNode_Sub17.anInt8835 = 1;
			if (CacheNode_Sub17.anInt8835 == 1 && i >= 3139 && (i ^ 0xffffffff) >= -3200 && i_3_ >= 3008
					&& i_3_ <= 3062)
				CacheNode_Sub17.anInt8835 = 0;
		}
	}

	public static final void method913(int i, String string, boolean bool) {
		anInt10973++;
		string = string.toLowerCase();
		short[] ses = new short[16];
		int i_19_ = 0;
		int i_20_ = !bool ? 0 : 32768;
		int i_21_ = (bool ? Node_Sub36_Sub1.aClass109_10035.anInt1369 : Node_Sub36_Sub1.aClass109_10035.anInt1373)
				+ i_20_;
		for (int i_22_ = i_20_; i_22_ < i_21_; i_22_++) {
			...
			if (cachenode_sub10.aBoolean9521
					&& (cachenode_sub10.method2332(-19244).toLowerCase().indexOf(string) ^ 0xffffffff) != 0) {
	...
	public static final void method915(int i, Class54 class54, int i_27_, GraphicsToolkit graphicstoolkit) {
		anInt10971++;
		if (Class290_Sub11.anIntArray8180 != null && i <= class54.aByte824)
			for (int i_28_ = 0; (Class290_Sub11.anIntArray8180.length ^ 0xffffffff) < (i_28_ ^ 0xffffffff); i_28_++)
				if ((Class290_Sub11.anIntArray8180[i_28_] ^ 0xffffffff) != 999999
						&& (class54.anIntArray814[0] <= Class290_Sub11.anIntArray8180[i_28_]
								|| (Class290_Sub11.anIntArray8180[i_28_] ^ 0xffffffff) <= (class54.anIntArray814[1]
										^ 0xffffffff)
								|| (Class290_Sub11.anIntArray8180[i_28_] ^ 0xffffffff) <= (class54.anIntArray814[2]
										^ 0xffffffff)
								|| (Class290_Sub11.anIntArray8180[i_28_] ^ 0xffffffff) <= (class54.anIntArray814[3]
										^ 0xffffffff))
						&& ((EntityNode_Sub3_Sub1.anIntArray9161[i_28_] ^ 0xffffffff) <= (class54.anIntArray810[0]
								^ 0xffffffff) || class54.anIntArray810[1] <= EntityNode_Sub3_Sub1.anIntArray9161[i_28_]
						...
						&& ((class54.anIntArray810[0] ^ 0xffffffff) <= (aa_Sub3.anIntArray5490[i_28_] ^ 0xffffffff)
						...
						&& (class54.anIntArray820[0] <= Class121.anIntArray1528[i_28_]
								|| (class54.anIntArray820[1] ^ 0xffffffff) >= (Class121.anIntArray1528[i_28_]
										^ 0xffffffff)
								|| (Class121.anIntArray1528[i_28_] ^ 0xffffffff) <= (class54.anIntArray820[2]
										^ 0xffffffff)
								|| (Class121.anIntArray1528[i_28_] ^ 0xffffffff) <= (class54.anIntArray820[3]
										^ 0xffffffff))
						&& ((CacheNode_Sub18.anIntArray9605[i_28_] ^ 0xffffffff) >= (class54.anIntArray820[0]
								^ 0xffffffff)
								|| (CacheNode_Sub18.anIntArray9605[i_28_] ^ 0xffffffff) >= (class54.anIntArray820[1]
										^ 0xffffffff)
								|| (CacheNode_Sub18.anIntArray9605[i_28_] ^ 0xffffffff) >= (class54.anIntArray820[2]
										^ 0xffffffff)
								|| (CacheNode_Sub18.anIntArray9605[i_28_] ^ 0xffffffff) >= (class54.anIntArray820[3]
										^ 0xffffffff)))
					return;
		if ((class54.aByte822 ^ 0xffffffff) == -2) {
			...
			if ((i_29_ ^ 0xffffffff) <= -1 && i_29_ <= Node_Sub9_Sub1.anInt9656 + Node_Sub9_Sub1.anInt9656) {
				...
				if (bool) {
					float f = GLPlane.anInt7920 + -class54.anIntArray810[0];
					if (f < 0.0F)
						f *= -1.0F;
					if (!(Node_Sub38_Sub6.anInt10139 > f) && Class121.method1231(0, -51, class54)
							&& Class121.method1231(1, i_27_ ^ ~0x22, class54) && Class121.method1231(2, -51, class54)
			...
			if (i_32_ >= 0
					&& (i_32_ ^ 0xffffffff) >= (Node_Sub9_Sub1.anInt9656 + Node_Sub9_Sub1.anInt9656 ^ 0xffffffff)) {
				...
				if (bool) {
					float f = Class380.anInt4889 + -class54.anIntArray820[0];
					if (f < 0.0F)
						f *= -1.0F;
					if (!(f < Node_Sub38_Sub6.anInt10139) && Class121.method1231(0, -51, class54)
							&& Class121.method1231(1, i_27_ + -67, class54) && Class121.method1231(2, -51, class54)
							&& Class121.method1231(3, i_27_ ^ ~0x22, class54))
						Node_Sub44.aClass54Array7548[Class320_Sub21.anInt8406++] = class54;
				}
			}
			...
			if ((i_35_ ^ 0xffffffff) <= -1 && Node_Sub9_Sub1.anInt9656 + Node_Sub9_Sub1.anInt9656 >= i_35_) {
				...
				if (i_36_ >= 0 && Node_Sub9_Sub1.anInt9656 + Node_Sub9_Sub1.anInt9656 >= i_36_
						&& Class139.aBooleanArrayArray1730[i_35_][i_36_]) {
					float f = GLPlane.anInt7920 - class54.anIntArray810[0];
					if (f < 0.0F)
						f *= -1.0F;
					float f_37_ = -class54.anIntArray820[0] + Class380.anInt4889;
					if (f_37_ < 0.0F)
						f_37_ *= -1.0F;
					if ((!(Node_Sub38_Sub6.anInt10139 > f) || !(Node_Sub38_Sub6.anInt10139 > f_37_))
							&& Class121.method1231(0, -51, class54) && Class121.method1231(1, -51, class54)
							&& Class121.method1231(2, i_27_ ^ ~0x22, class54) && Class121.method1231(3, -51, class54))
						Node_Sub44.aClass54Array7548[Class320_Sub21.anInt8406++] = class54;
				}
			}
		} else if (class54.aByte822 == 4) {
			float f = class54.anIntArray814[0] - ClientBackground.anInt6900;
			if (!(f <= Class134_Sub4.anInt9047)) {
				...
				if (Node_Sub9_Sub1.anInt9656 + Node_Sub9_Sub1.anInt9656 < i_41_)
					...
					return;
				boolean bool = false;
				while_221_: for (int i_42_ = i_40_; i_41_ >= i_42_; i_42_++)
					for (int i_43_ = i_38_; (i_39_ ^ 0xffffffff) <= (i_43_ ^ 0xffffffff); i_43_++)
						if (Class139.aBooleanArrayArray1730[i_42_][i_43_]) {
							bool = true;
							break while_221_;
						}
				if (bool && Class121.method1231(0, -51, class54) && Class121.method1231(1, i_27_ ^ ~0x22, class54)
						&& Class121.method1231(2, -51, class54) && Class121.method1231(3, i_27_ ^ ~0x22, class54))
					Node_Sub44.aClass54Array7548[Class320_Sub21.anInt8406++] = class54;
			}
		}
	}
	...
	Mobile_Sub4(int i, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_, int i_13_, int i_14_,
		...
		anInt10979 = i;
		anInt10976 = i_16_;
		Login class195 = Class16.aClass101_228.method1090(-122, anInt10979);
	...
	public final EntityNode_Sub6 method807(int i, GraphicsToolkit graphicstoolkit) {
		anInt10990++;
		DrawableModel drawablemodel = method908(14437, anInt10979, graphicstoolkit,
				((anInt10976 ^ 0xffffffff) == -1 ? 0 : 5) | 0x800);
	...
	@Override
	public final boolean method810(int i, int i_5_, boolean bool, GraphicsToolkit graphicstoolkit) {
		anInt10989++;
		if (bool != false)
			method817(-24);
		return false;
	...
	@Override
	public final void method816(int i, boolean bool, GraphicsToolkit graphicstoolkit, int i_44_, byte b, int i_45_,
			Animable animable) {
		if (b < 101)
			method807(35, null);
		anInt10962++;
	...
	private final void method907(Class336 class336, DrawableModel drawablemodel, int i,
		...
		if ((anEntityNode_Sub4_10965 == null || anEntityNode_Sub4_10965.aBoolean5972)
				&& (class300s != null || class218s != null))
			anEntityNode_Sub4_10965 = EntityNode_Sub4.method963(Class174.clientCycle, true);
		if (anEntityNode_Sub4_10965 != null) {
			anEntityNode_Sub4_10965.method952(graphicstoolkit, Class174.clientCycle, class300s, class218s, false);
	...
	private final DrawableModel method908(int i, int i_0_, GraphicsToolkit graphicstoolkit, int i_1_) {
		anInt10984++;
		Login class195 = Class16.aClass101_228.method1090(-81, i_0_);
		if (i != 14437)
			method823((byte) 29);
		...
		if (anAnimator10968 == null || anAnimator10968.method238(-18))
			return class195.method1986((byte) 2, true, anInt5940, null, plane_2_, (byte) 104, anInt5934, plane, i_1_,
					anInt5937, graphicstoolkit);
		return class195.method1986((byte) 2, true, anInt5940, anAnimator10968, plane_2_, (byte) -122, anInt5934, plane,
				i_1_, anInt5937, graphicstoolkit);
	}

	public final boolean method909(int i) {
		anInt10980++;
		if (i != 16)
			anInt10987 = -4;
	...
	public final void method912(int i, int i_4_) {
	...
	public final void method914(int i) {
		anInt10970++;
		if (anEntityNode_Sub4_10965 != null)
			anEntityNode_Sub4_10965.method953();
		if (i >= -76)
	...
	public final boolean method917(int i) {
		anInt10967++;
		if (i != -12978)
			return false;
