...
public class Model {
	...
	public static final void method2092(int i, byte b, int i_191_, int i_192_) {
		anInt2595++;
		Class343 class343 = CacheNode_Sub18.aClass343ArrayArray9608[i_191_][i_192_];
		if (b == 8)
			Class84.method985(i, class343 == null ? ToolTips.aClass343_3695 : class343, b ^ 0x9);
	}
		...
		for (int i_211_ = 0; (i ^ 0xffffffff) < (i_211_ ^ 0xffffffff); i_211_++) {
			...
			if (model_212_ != null) {
				...
				for (int i_214_ = 0; i_214_ < model_212_.anInt2572; i_214_++) {
					...
					aShortArray2600[anInt2572] = (short) method2093(model_212_, 0, model_212_.aShortArray2600[i_214_],
							s);
					aShortArray2583[anInt2572] = (short) method2093(model_212_, 0, model_212_.aShortArray2583[i_214_],
							s);
					aShortArray2589[anInt2572] = (short) method2093(model_212_, 0, model_212_.aShortArray2589[i_214_],
							s);
				...
				if (model_212_.aClass300Array2590 != null)
					for (int i_215_ = 0; model_212_.aClass300Array2590.length > i_215_; i_215_++) {
						...
						aClass300Array2590[i_201_] = model_212_.aClass300Array2590[i_215_].method3502(false, i_216_,
								i_217_, i_218_);
						i_201_++;
					}
				if (model_212_.aClass218Array2620 != null)
					for (int i_219_ = 0; (i_219_ ^ 0xffffffff) > (model_212_.aClass218Array2620.length
							^ 0xffffffff); i_219_++) {
		...
		for (int i_222_ = 0; i_222_ < i; i_222_++) {
			...
			if (model_223_ != null) {
				for (int i_224_ = 0; i_224_ < model_223_.anInt2572; i_224_++)
					if (bool_206_)
						aByteArray2610[i_221_++] = (byte) (model_223_.aByteArray2610 == null
								|| (model_223_.aByteArray2610[i_224_] ^ 0xffffffff) == 0 ? -1
										: model_223_.aByteArray2610[i_224_] + anInt2611);
				for (int i_225_ = 0; (model_223_.anInt2611 ^ 0xffffffff) < (i_225_ ^ 0xffffffff); i_225_++) {
					...
					if (b == 0) {
						aShortArray2613[anInt2611] = (short) method2093(model_223_, 0,
								model_223_.aShortArray2613[i_225_], s);
						aShortArray2577[anInt2611] = (short) method2093(model_223_, 0,
								model_223_.aShortArray2577[i_225_], s);
						aShortArray2604[anInt2611] = (short) method2093(model_223_, 0,
								model_223_.aShortArray2604[i_225_], s);
					}
	...
	public final int method2079(int i, int i_0_, int i_1_, int i_2_) {
		anInt2578++;
		if (i > -79)
			anIntArray2615 = null;
		for (int i_3_ = 0; i_3_ < anInt2599; i_3_++)
			if ((i_2_ ^ 0xffffffff) == (anIntArray2616[i_3_] ^ 0xffffffff) && i_1_ == anIntArray2576[i_3_]
					&& i_0_ == anIntArray2574[i_3_])
				return i_3_;
	...
	public final int method2080(boolean bool, int i, int i_4_, int i_5_, short s, short s_6_, byte b, byte b_7_, byte b_8_) {
	...
	public final void method2081(int i, int i_9_) {
	...
	public final void method2082(int i, int i_12_, int i_13_, int i_14_) {
		anInt2571++;
	...
	public final int[][] method2083(int i, boolean bool) {
		anInt2581++;
		int[] is = new int[256];
		int i_17_ = 0;
				...
				if (i_89_ > 0) {
					...
					for (int i_90_ = 0; (i_90_ ^ 0xffffffff) > (i_89_ ^ 0xffffffff); i_90_++) {
						...
						if (i_35_ == 255)
							...
							b = (byte) i_35_;
						aClass300Array2590[i_90_] = new Class300(i_91_, aShortArray2600[i_92_], aShortArray2583[i_92_],
								aShortArray2589[i_92_], b);
					}
				}
	...
	public final void method2085(int i, int i_102_, int i_103_, int i_104_) {
		if (i != 0) {
	...
	public final byte method2086(byte b, byte b_117_, byte b_118_, short s, short s_119_, short s_120_, short s_121_,
			short s_122_, short s_123_, byte b_124_) {
		if (b_118_ != -66)
			anIntArray2603 = null;
		anInt2606++;
		if (anInt2611 >= 255)
	...
	public final void method2087(short s, short s_125_, int i) {
		anInt2596++;
	...
	public final int[][] method2088(byte b) {
		anInt2592++;
		int[] is = new int[256];
		int i = 0;
	...
	public final void method2089(short s, short s_134_, int i) {
		anInt2618++;
		int i_135_ = 0;
	...
	public final int[][] method2090(byte b) {
		anInt2608++;
		if (b != 73)
			anIntArray2602 = null;
		int[] is = new int[256];
		...
		if (i < -18) {
			...
			if (aByteArray2610 != null) {
				...
				for (int i_189_ = 0; i_189_ < anInt2572; i_189_++) {
					...
					if (i_190_ != 255)
						if ((aShortArray2613[i_190_] & 0xffff) != aShortArray2600[i_189_]
								|| aShortArray2583[i_189_] != (aShortArray2577[i_190_] & 0xffff)
								|| aShortArray2589[i_189_] != (aShortArray2604[i_190_] & 0xffff))
							bool_188_ = true;
						else
	...
	private final int method2093(Model model_193_, int i, int i_194_, short s) {
		...
		for (int i_198_ = i; anInt2599 > i_198_; i_198_++)
			if ((anIntArray2616[i_198_] ^ 0xffffffff) == (i_195_ ^ 0xffffffff)
					&& (anIntArray2576[i_198_] ^ 0xffffffff) == (i_196_ ^ 0xffffffff)
					&& i_197_ == anIntArray2574[i_198_]) {
