...
public class MouseHandler extends Class93 implements MouseListener, MouseMotionListener {
	
	public static Index aClass302_6049;
	...
	public static final void method1061(GraphicsToolkit graphicstoolkit, boolean bool) {
		if (!Class213.aBoolean2510)
			ToolTips.method3470(graphicstoolkit, 117);
		else
	...
	public final synchronized void mouseMoved(MouseEvent mouseevent) {
		MouseHandler.mouseX = mouseevent.getX();
		MouseHandler.mouseY = mouseevent.getY();
		method1062(mouseevent.getX(), (byte) 36, mouseevent.getY());
		anInt6051++;
	}
