...
public class Node_Sub10 extends Node {
	...
	public static int anInt7089;
	public static int anInt7097;
	public static String aString7081 = "";

	public static final void method2537(int i, boolean bool) {
		anInt7097++;
		...
		if (bool == false)
			if ((i_0_ ^ 0xffffffff) <= -101) {
				...
				Node_Sub23.method2624(i_1_, (i_1_ >> 3) * 3 + 600 << 2, i, 127, Mobile_Sub4.anInt10987, i_2_,
						Class25.anInt444, Node_Sub38_Sub7.method2809(CacheNode_Sub20_Sub1.myPlayerPlane, -29754,
								Player.get.anInt5940, Player.get.anInt5934) - 200);
				float f = 1.0F - (100 - i_0_) * ((100 + -i_0_) * (-i_0_ + 100)) / 1000000.0F;
				Class98.anInt5061 = (int) (Class328_Sub1.anInt8501
						+ (-Class328_Sub1.anInt8501 + Class98.anInt5061) * f);
				Class190.anInt2331 = (int) ((Class190.anInt2331 + -Node_Sub38_Sub12.anInt10228) * f
						+ Node_Sub38_Sub12.anInt10228);
				anInt7079 = (int) (f * (-Class320_Sub17.anInt8371 + anInt7079) + Class320_Sub17.anInt8371);
				OutgoingPacket.anInt4050 = (int) ((-Class179.anInt2127 + OutgoingPacket.anInt4050) * f
						+ Class179.anInt2127);
				int i_3_ = -IncomingPacketHolder.anInt1568 + Class170.anInt2053;
				if ((i_3_ ^ 0xffffffff) < -8193)
					i_3_ -= 16384;
				else if (i_3_ < -8192)
					i_3_ += 16384;
				Class170.anInt2053 = (int) (IncomingPacketHolder.anInt1568 + i_3_ * f);
	...
	public static final void method2539(Index class302, int i) {
		if (i >= -127)
			aString7081 = null;
		anInt7086++;
	...
	public static final void method2540(AbstractFont class52) {
	...
	public final void method2541(int i) {
