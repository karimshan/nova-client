...
public class Node_Sub15_Sub1 extends Node_Sub15 {
	...
	public static final boolean method2557(int i, int i_0_, int i_1_) {
		if (i_0_ != 1024)
			return false;
		anInt9771++;
	...
	public static final void method2558(int i) {
		anInt9772++;
		if (i != -1)
			method2557(-79, 88, -65);
		int[] is = Class66_Sub1.LOCAL_PLAYERS_INDEXES;
		for (int i_2_ = 0; Class178.LOCAL_PLAYERS_INDEXES_COUNT > i_2_; i_2_++) {
			Player player = Client.LOCAL_PLAYERS[is[i_2_]];
			if (player != null)
				player.method847(i);
		}
		for (int i_3_ = 0; i_3_ < Node_Sub25_Sub3.localNPCsCount; i_3_++) {
			long l = Class54.LocalNPCsIndexes[i_3_];
			Node_Sub41 node_sub41 = (Node_Sub41) Class12.aHashTable187.getNode(i + 3513, l);
			if (node_sub41 != null)
