...
public class Node_Sub15_Sub11 extends Node_Sub15 {
	public static Index aClass302_9859;
	public static int anInt9855;
	public static int anInt9856 = 4;
	public static int anInt9857;
	public static int anInt9858;

	public static final void method2580(byte b, int i, int i_0_) {
		anInt9855++;
		if (b != -114)
			aClass302_9859 = null;
		if (Class20.aFloat329 > Class20.aFloat327) {
			Class20.aFloat327 += Class20.aFloat327 / 30.0;
			if (Class20.aFloat329 < Class20.aFloat327)
		...
		if (Class336_Sub1.aBoolean8543 && Node_Sub43.aClass312_7541 != null)
			for (Node_Sub31 node_sub31 = (Node_Sub31) Node_Sub43.aClass312_7541
					.method3613(65280); node_sub31 != null; node_sub31 = (Node_Sub31) Node_Sub43.aClass312_7541
							.method3620(16776960)) {
				...
				if (node_sub31.method2728(i, (byte) 36, i_0_)) {
					if (class79.aStringArray1065 != null) {
						if (class79.aStringArray1065[4] != null)
							Node_Sub32.method2731(false, -1, node_sub31.aNode_Sub14_7375.anInt7128, class79.anInt1067,
									0, class79.aStringArray1065[4], 1004, true, -1, class79.aString1045,
									node_sub31.aNode_Sub14_7375.anInt7128, (byte) -18, false);
						if (class79.aStringArray1065[3] != null)
							Node_Sub32.method2731(false, -1, node_sub31.aNode_Sub14_7375.anInt7128, class79.anInt1067,
									0, class79.aStringArray1065[3], 1009, true, -1, class79.aString1045,
									node_sub31.aNode_Sub14_7375.anInt7128, (byte) -18, false);
						if (class79.aStringArray1065[2] != null)
							Node_Sub32.method2731(false, -1, node_sub31.aNode_Sub14_7375.anInt7128, class79.anInt1067,
									0, class79.aStringArray1065[2], 1006, true, -1, class79.aString1045,
									node_sub31.aNode_Sub14_7375.anInt7128, (byte) -18, false);
						if (class79.aStringArray1065[1] != null)
							Node_Sub32.method2731(false, -1, node_sub31.aNode_Sub14_7375.anInt7128, class79.anInt1067,
									0, class79.aStringArray1065[1], 1001, true, -1, class79.aString1045,
									node_sub31.aNode_Sub14_7375.anInt7128, (byte) -18, false);
						if (class79.aStringArray1065[0] != null)
							Node_Sub32.method2731(false, -1, node_sub31.aNode_Sub14_7375.anInt7128, class79.anInt1067,
									0, class79.aStringArray1065[0], 1003, true, -1, class79.aString1045,
									node_sub31.aNode_Sub14_7375.anInt7128, (byte) -18, false);
					}
					if (!node_sub31.aNode_Sub14_7375.aBoolean7127) {
						node_sub31.aNode_Sub14_7375.aBoolean7127 = true;
						ClientScriptsExecutor.method3565(Class3.aClass212_5159, node_sub31.aNode_Sub14_7375.anInt7128,
								class79.anInt1067);
					}
					if (node_sub31.aNode_Sub14_7375.aBoolean7127)
						ClientScriptsExecutor.method3565(Node_Sub38_Sub29.aClass212_10406,
								node_sub31.aNode_Sub14_7375.anInt7128, class79.anInt1067);
				} else if (node_sub31.aNode_Sub14_7375.aBoolean7127) {
					node_sub31.aNode_Sub14_7375.aBoolean7127 = false;
					ClientScriptsExecutor.method3565(CacheNode_Sub11.aClass212_9548,
							node_sub31.aNode_Sub14_7375.anInt7128, class79.anInt1067);
				}
			}
	}
