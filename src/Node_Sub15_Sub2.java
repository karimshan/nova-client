...
public class Node_Sub15_Sub2 extends Node_Sub15 {
	...
	public static Class104 aClass104_9779;
	public static Class138[] aClass138Array9784;
	public static int anInt9775;
	public static int anInt9777;
	...
	public static final boolean method2559(int i, int i_0_, int i_1_, int i_2_, byte[] bs, int i_3_, int i_4_) {
		anInt9775++;
		int i_5_ = i_3_ % i_1_;
		int i_6_;
		if (i_5_ != 0)
	...
	public static final short method2560(int i, int i_11_) {
		anInt9777++;
	...
	public static final void method2561(int i) {
		anInt9783++;
		...
		if (i == 1993405383)
			for (EntityNode_Sub4 entitynode_sub4 = (EntityNode_Sub4) Animable_Sub2.aClass103_9116.method1113(
					(byte) -114); entitynode_sub4 != null; entitynode_sub4 = (EntityNode_Sub4) Animable_Sub2.aClass103_9116
							.method1108(74))
	...
	public final void method2554(int i, BufferedStream buffer) {
		...
		if (i == 29147)
			if (Class79.aBoolean1052) {
				// System.out.println("memberhash:" + aLong9778 + " membername:"
				// + aString9776);
			}
	}
