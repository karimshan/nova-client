...
public class Node_Sub15_Sub8 extends Node_Sub15 {
	public static int anInt9829;
	public static int anInt9830;
	public static int anInt9832;

	public static final void method2575(int i, int i_0_, int i_1_) {
		anInt9832++;
		if (Class44.aGraphicsToolkit668 != null) {
			...
			if (i_1_ >= 82) {
				...
				if ((Class320_Sub20.anInt8397 ^ 0xffffffff) == -1) {
					...
					Node_Sub15_Sub9.anInterface6_9843 = Class44.aGraphicsToolkit668.a(
				...
				} else if ((Class320_Sub20.anInt8397 ^ 0xffffffff) == -2 && (Class352.anInterface6Array4332 == null
						|| (i_2_ ^ 0xffffffff) != (Class117.anInt1479 ^ 0xffffffff)
						|| (i_3_ ^ 0xffffffff) != (Class290_Sub11.anInt8181 ^ 0xffffffff))) {
					...
					for (int i_4_ = 0; i_4_ < Class352.anInterface6Array4332.length; i_4_++)
						Class352.anInterface6Array4332[i_4_] = Class44.aGraphicsToolkit668.a(
