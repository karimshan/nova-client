...
public class Node_Sub16 extends Node {
	public static Class124 aClass124_7132 = new Class124(22);
	public static Class312 aClass312_7139 = new Class312();
	public static int anInt7130;
	public static int anInt7131;
	...
	public static final void method2589(Index class302, int i) {
		...
		LoadingBar.anInt2019 = class302.method3519("scrollbar", (byte) 117);
		if (i != 1)
			method2589(null, 94);
	...
	public static int method2590(int i, int i_23_) {
		return i | i_23_;
	}

	public static final int method2591(byte b, char c) {
		if (b != -115)
			return -13;
		anInt7134++;
	...
	public static final boolean method2593(int i, int i_24_, int i_25_, int i_26_, int i_27_, int i_28_, int i_29_, int i_30_,
			boolean bool, int i_31_, Class84 class84) {
		anInt7130++;
		int i_32_ = i_24_;
		int i_33_ = i_31_;
		int i_34_ = 64;
		...
		while ((i_38_ ^ 0xffffffff) != (i_39_ ^ 0xffffffff)) {
									...
									if ((i_42_ ^ 0xffffffff) != 2) {
										if (i_42_ != -2) {
											if ((i_42_ ^ 0xffffffff) != 0) {
												if (i_42_ == 0 || (i_42_ ^ 0xffffffff) == -2
														|| (i_42_ ^ 0xffffffff) == -3 || (i_42_ ^ 0xffffffff) == -4
														|| i_42_ == 9)
													break while_98_;
												break while_99_;
											}
			...
			if ((i_34_ ^ 0xffffffff) < -1 && Node_Sub36_Sub2.anIntArrayArray10047[-1 + i_34_][i_35_] == 0
					&& (0x43a40000 & is[-1 + i_40_][i_41_]) == 0
					&& (is[i_40_ + -1][1 + i_41_] & 0x4e240000 ^ 0xffffffff) == -1) {
			...
			if ((i_34_ ^ 0xffffffff) > -127 && Node_Sub36_Sub2.anIntArrayArray10047[1 + i_34_][i_35_] == 0
					&& (0x60e40000 & is[2 + i_40_][i_41_] ^ 0xffffffff) == -1
					&& (0x78240000 & is[2 + i_40_][i_41_ + 1]) == 0) {
				Node_Sub39.routeFinderXArray[i_38_] = 1 + i_32_;
				Class339_Sub6.routeFinderYArray[i_38_] = i_33_;
			...
			if (i_35_ > 0 && (Node_Sub36_Sub2.anIntArrayArray10047[i_34_][-1 + i_35_] ^ 0xffffffff) == -1
					&& (is[i_40_][-1 + i_41_] & 0x43a40000) == 0 && (0x60e40000 & is[1 + i_40_][-1 + i_41_]) == 0) {
				Node_Sub39.routeFinderXArray[i_38_] = i_32_;
			...
			if ((i_35_ ^ 0xffffffff) > -127
					&& (Node_Sub36_Sub2.anIntArrayArray10047[i_34_][i_35_ - -1] ^ 0xffffffff) == -1
					&& (is[i_40_][i_41_ - -2] & 0x4e240000 ^ 0xffffffff) == -1
					&& (is[1 + i_40_][2 + i_41_] & 0x78240000) == 0) {
				Node_Sub39.routeFinderXArray[i_38_] = i_32_;
			...
			if (i_34_ > 0 && i_35_ > 0 && Node_Sub36_Sub2.anIntArrayArray10047[-1 + i_34_][-1 + i_35_] == 0
					&& (0x4fa40000 & is[-1 + i_40_][i_41_] ^ 0xffffffff) == -1
					&& (0x43a40000 & is[i_40_ - 1][i_41_ + -1]) == 0 && (is[i_40_][i_41_ - 1] & 0x63e40000) == 0) {
			...
			if ((i_34_ ^ 0xffffffff) > -127 && i_35_ > 0
					&& Node_Sub36_Sub2.anIntArrayArray10047[i_34_ - -1][i_35_ + -1] == 0
					&& (is[i_40_ - -1][-1 + i_41_] & 0x63e40000) == 0
					&& (is[2 + i_40_][i_41_ - 1] & 0x60e40000 ^ 0xffffffff) == -1
					&& (is[i_40_ + 2][i_41_] & 0x78e40000) == 0) {
				Node_Sub39.routeFinderXArray[i_38_] = i_32_ - -1;
				Class339_Sub6.routeFinderYArray[i_38_] = -1 + i_33_;
				i_38_ = 0xfff & i_38_ - -1;
			...
			if ((i_34_ ^ 0xffffffff) < -1 && i_35_ < 126
					&& (Node_Sub36_Sub2.anIntArrayArray10047[i_34_ + -1][1 + i_35_] ^ 0xffffffff) == -1
					&& (is[-1 + i_40_][i_41_ + 1] & 0x4fa40000 ^ 0xffffffff) == -1
					&& (is[-1 + i_40_][i_41_ + 2] & 0x4e240000 ^ 0xffffffff) == -1
					&& (0x7e240000 & is[i_40_][2 + i_41_]) == 0) {
				Node_Sub39.routeFinderXArray[i_38_] = -1 + i_32_;
				Class339_Sub6.routeFinderYArray[i_38_] = i_33_ + 1;
				i_38_ = 0xfff & i_38_ + 1;
			...
			if (i_34_ < 126 && i_35_ < 126
					&& (Node_Sub36_Sub2.anIntArrayArray10047[1 + i_34_][i_35_ - -1] ^ 0xffffffff) == -1
					&& (is[1 + i_40_][2 + i_41_] & 0x7e240000) == 0
					&& (is[i_40_ - -2][i_41_ - -2] & 0x78240000 ^ 0xffffffff) == -1
					&& (is[i_40_ + 2][1 + i_41_] & 0x78e40000) == 0) {
				Node_Sub39.routeFinderXArray[i_38_] = i_32_ - -1;
				Class339_Sub6.routeFinderYArray[i_38_] = i_33_ - -1;
	...
	public static final boolean method2594(boolean bool) {
		anInt7135++;
		if (AbstractFont.aCacheNode_Sub13_788 == null)
			return false;
		if ((AbstractFont.aCacheNode_Sub13_788.anInt9562 ^ 0xffffffff) <= -2001)
			AbstractFont.aCacheNode_Sub13_788.anInt9562 -= 2000;
		if (bool != true)
			method2589(null, -33);
		if (AbstractFont.aCacheNode_Sub13_788.anInt9562 == 1002)
			return true;
		return false;
	}
	...
	private final long method2587(boolean bool, int i, int[] is, int[] is_0_, boolean bool_1_) {
		...
		long l = -1L;
		l = ls[(int) ((l ^ i >> 8) & 0xffL)] ^ l >>> 8;
		l = ls[(int) ((l ^ i) & 0xffL)] ^ l >>> 8;
		for (int element : is) {
			l = l >>> 8 ^ ls[(int) ((l ^ element >> 24) & 0xffL)];
			l = ls[(int) (0xffL & (l ^ element >> 16))] ^ l >>> 8;
			l = l >>> 8 ^ ls[(int) (0xffL & (element >> 8 ^ l))];
			l = l >>> 8 ^ ls[(int) (0xffL & (element ^ l))];
		}
		if (is_0_ != null)
			for (int i_3_ = 0; (i_3_ ^ 0xffffffff) > -6; i_3_++)
				l = l >>> 8 ^ ls[(int) (0xffL & (l ^ is_0_[i_3_]))];
		l = ls[(int) ((l ^ (!bool ? 0 : 1)) & 0xffL)] ^ l >>> 8;
		if (bool_1_ != true)
			method2593(87, 65, 50, -18, -126, 94, 103, -128, false, -37, null);
		return l;
	}

	public final DrawableModel method2588(int i, int i_4_, GraphicsToolkit graphicstoolkit, int i_5_, boolean bool,
			Animator animator, PlayerDefinition playerdefinition) {
		anInt7140++;
		...
		if (drawablemodel == null || (graphicstoolkit.b(drawablemodel.ua(), i_6_) ^ 0xffffffff) != -1) {
			...
			for (int i_11_ = 0; (i_11_ ^ 0xffffffff) > (is.length ^ 0xffffffff); i_11_++)
				if (is[i_11_] != -1 && !EntityNode_Sub3_Sub1.aClass86_9166.method1010(is[i_11_], 14434).method1686(bool,
						null, i_4_ + -50))
					bool_10_ = true;
			if (bool_10_)
				return null;
			...
			for (int i_12_ = 0; i_12_ < is.length; i_12_++)
				if ((is[i_12_] ^ 0xffffffff) != 0)
					models[i_12_] = EntityNode_Sub3_Sub1.aClass86_9166.method1010(is[i_12_], i_4_ + 14433)
							.method1683(null, bool, Node_Sub19.method2612(i_4_, -52));
				...
				for (int i_20_ = 0; i_20_ < 10; i_20_++)
					for (int i_21_ = 0; i_21_ < Class45.aShortArrayArray5265[i_20_].length; i_21_++)
						if (Class117_Sub2.aShortArrayArrayArray5151[i_20_][i_21_].length > playerdefinition.anIntArray3430[i_20_])
							drawablemodel.ia(Class45.aShortArrayArray5265[i_20_][i_21_],
