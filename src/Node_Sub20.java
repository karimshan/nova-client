...
public class Node_Sub20 extends Node {
	public static Class151 aClass151_7178 = new Class151(14, 0, 4, 1);
	public static int anInt7176;
	public static int anInt7179;
	public static int anInt7180;
	public static short[] aShortArray7175;

	public static final GraphicsToolkit method2613(int i, int i_0_, Index class302, d var_d, java.awt.Canvas canvas) {
		anInt7176++;
	...
	public static final void method2614(boolean bool, Actor actor, boolean bool_1_) {
		anInt7180++;
		...
		if ((actor.anInt10904 ^ 0xffffffff) == -1) {
			...
			for (int i = 0; (actor.aClass165Array10886.length ^ 0xffffffff) < (i ^ 0xffffffff); i++)
				if ((actor.aClass165Array10886[i].graphicsId ^ 0xffffffff) != 0
						&& actor.aClass165Array10886[i].anAnimator2026.method242((byte) -77)) {
			...
			if (!bool_1_ && (i_3_ - i > 1024 || i_3_ - i < -1024 || (-i_2_ + i_4_ ^ 0xffffffff) < -1025
					|| (i_4_ + -i_2_ ^ 0xffffffff) > 1023)) {
				...
				if (actor instanceof NPC)
					bool_6_ = ((NPC) actor).defs.aBoolean2817;
				if (!bool_6_) {
				...
				if (class259.anInt3256 != -1) {
					...
					if (actor.anInt10904 != 1) {
						...
						int i_9_ = ((i_3_ ^ 0xffffffff) <= (actor.anInt5934 ^ 0xffffffff) ? i_3_ - actor.anInt5934
								: actor.anInt5934 - i_3_) << 9;
	...
	public static final void method2615(AbstractFont class52, String string, Class357 class357, int i, int i_13_, int i_14_,
			boolean bool, IComponentDefinitions widget, aa var_aa, int i_15_, int i_16_, int i_17_) {
		anInt7179++;
		int i_18_;
		...
		if ((i_19_ * i_19_ ^ 0xffffffff) <= (i_20_ ^ 0xffffffff)) {
			...
			if (i_23_ >= -widget.anInt4809 && (widget.anInt4809 ^ 0xffffffff) <= (i_23_ ^ 0xffffffff)
					&& i_24_ >= -widget.anInt4695 && (widget.anInt4695 ^ 0xffffffff) <= (i_24_ ^ 0xffffffff))
				class52.method535(i_16_, null, i_13_, string, var_aa, null,
						-i_24_ + (widget.anInt4695 / 2 + (i_16_ + -i_14_ + -i_26_)), 0, 101, i, 1,
						widget.anInt4809 / 2 + (i_23_ - -i), 0, 0, i_25_, 50);
		}
	}
