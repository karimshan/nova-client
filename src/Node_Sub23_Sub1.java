...
public class Node_Sub23_Sub1 extends Node_Sub23 {
	public static OutgoingPacket aClass318_9920 = new OutgoingPacket(58, 2);
	public static int anInt9902;
	public static int anInt9908;
	public static int anInt9910;
	...
	public static int anInt9923;
	public static int anInt9926 = 0;
	public static int anInt9927;
	public static int anInt9929;
	public static int[] DECODE_MASKS_PLAYERS_INDEXES_LIST = new int[2048];

	public static final void method2637(int i, int i_0_, boolean bool) {
		anInt9910++;
		if (bool != false)
			method2637(-62, -22, true);
		CacheNode_Sub2 cachenode_sub2 = Class320_Sub19.method3754(3, 18, (long) i_0_ << 32 | i);
		cachenode_sub2.method2291((byte) 121);
	}

	public static final Class371 method2638(int i, byte b) {
		anInt9919++;
	...
	public static final boolean method2640(int i, int i_1_) {
		anInt9918++;
		for (CacheNode_Sub13 cachenode_sub13 = (CacheNode_Sub13) Class368.aClass312_4549
				.method3613(65280); cachenode_sub13 != null; cachenode_sub13 = (CacheNode_Sub13) Class368.aClass312_4549
						.method3620(16776960))
			if (OutgoingPacket.method3666(cachenode_sub13.anInt9562, (byte) 120) && cachenode_sub13.aLong9563 == i)
				return true;
		return false;
	}
	...
	@Override
	public final void method2625(byte b, int i) {
	...
	@Override
	public final void method2626(byte b) {
	...
	@Override
	public final boolean method2627(byte b) {
		if (b >= -115)
			return false;
		anInt9902++;
	...
	@Override
	public final void method2629(Class169_Sub2 class169_sub2, Class169_Sub2 class169_sub2_3_, int i, int i_4_) {
		anInt9927++;
		...
		if (aClass169_Sub2Array9921 == null) {
			...
			OpenGL.glTexCoord2f(anInt9914, 0.0F);
			OpenGL.glVertex2i(1, 0);
			OpenGL.glTexCoord2f(anInt9914, anInt9904);
			OpenGL.glVertex2i(1, 1);
			OpenGL.glTexCoord2f(0.0F, anInt9904);
		...
		OpenGL.glUniform3fARB(OpenGL.glGetUniformLocationARB(l_8_, "params"), EntityNode_Sub3_Sub2.aFloat9168,
				Class333.aFloat4152, 0.0F);
		aGLToolkit7197.method1457(33984, 1);
		aGLToolkit7197.method1444(-2, aClass169_Sub2_9925);
		aGLToolkit7197.method1457(33984, 0);
		aGLToolkit7197.method1444(-2, class169_sub2_3_);
	...
	@Override
	public final int method2630(int i) {
		anInt9908++;
		if (i != 1)
			aClass145_9911 = null;
		return 1;
	...
	@Override
	public final void method2632(int i, int i_10_, int i_11_) {
		anInt9914 = i;
		anInt9922++;
		if (i_10_ != 0)
			method2626((byte) 91);
	...
	@Override
	public final boolean method2635(byte b) {
		anInt9912++;
		if (aGLToolkit7197.aBoolean6719 && aGLToolkit7197.aBoolean6738 && aGLToolkit7197.aBoolean6665) {
			...
			aClass145_9903 = Class290_Sub4.method3431(aGLToolkit7197, 0,
					new Class210[] { Class134.method1568(
							"#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n",
							aGLToolkit7197, -399874888, 35632) });
			aClass145_9915 = Class290_Sub4.method3431(aGLToolkit7197, 0,
					new Class210[] { Class134.method1568(
							"uniform vec3 params;\nuniform sampler2D sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2D(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n",
							aGLToolkit7197, -399874888, 35632) });
			aClass145_9907 = Class290_Sub4.method3431(aGLToolkit7197, 0,
					new Class210[] { Class134.method1568(
							"#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform vec3 dimScale;\nuniform sampler2D bloomTex;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n\t vec4 bloomCol = texture2D(bloomTex, gl_TexCoord[1].xy);\n\t vec4 sceneCol = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n\t float preLum = 0.99*dot(lumCoef, sceneCol.rgb)+0.01;\n    float postLum = preLum*(1.0+(preLum/params.y))/(preLum+1.0);\n\t gl_FragColor = sceneCol*(postLum/preLum)+bloomCol*params.x;\n}\n",
							aGLToolkit7197, b + -399874975, 35632) });
			aClass145_9911 = Class290_Sub4.method3431(aGLToolkit7197, 0,
					new Class210[] { Class134.method1568(
	...
	public final boolean method2641(int i) {
		if (i <= 19)
			aClass169_Sub2_9924 = null;
		anInt9923++;
		if (!aGLToolkit7197.aBoolean6719 || !aGLToolkit7197.aBoolean6738 || !aGLToolkit7197.aBoolean6665)
