...
public class Node_Sub24 extends Node {
	public static IncomingPacket aClass192_7214 = new IncomingPacket(27, 0);
	public static int anInt7207;
	...
	public static final void method2642(byte b) {
		anInt7225++;
	...
	public static final void method2644(byte b) {
		anInt7224++;
		if (Node_Sub38_Sub1.aClass329_10086 != CacheNode_Sub2.aClass329_9436)
			do {
				try {
					Class2.displayApplet("tbrefresh", Class158.aClient1983, (byte) -85);
					if (b == -42)
						break;
					method2647((byte) -4, -0.23702288F, -0.5243241F, 2.32522F, 0.43047276F, 76, null, -8, 103,
							-0.710538F, 110, null, 59);
	...
	public static final void method2647(byte b, float f, float f_38_, float f_39_, float f_40_, int i, byte[] bs, int i_41_,
			int i_42_, float f_43_, int i_44_, Class328 class328, int i_45_) {
		anInt7216++;
		for (int i_46_ = 0; i > i_46_; i_46_++) {
			Login.method1988(i_41_, f, f_40_, i_46_, class328, bs, f_43_, i, (byte) -125, f_38_, i_44_, i_45_, i_42_,
					f_39_);
			i_42_ += i_41_ * i_44_;
		}
	...
	public static final void method2649(boolean bool) {
		anInt7222++;
	...
	public static final void method2650(boolean bool, int i) {
		anInt7228++;
		...
		if (Class58.method577(Class151.anInt1843, -22906)) {
			...
			for (int i_48_ = 0; (class123s.length ^ 0xffffffff) < (i_48_ ^ 0xffffffff); i_48_++) {
				IncomingPacketHolder class123 = class123s[i_48_];
				class123.anInt1579++;
				...
				if (!class123.aBoolean1580 && class123.aClass365_1557 != null) {
					Class365.anInt4524++;
					Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, Class224.OUTCOMMING_PACKET_16,
	...
	Node_Sub24(AbstractToolkit abstracttoolkit, StandardPlane standardplane, Node_Sub29 node_sub29, int[] is) {
		try {
				...
				if ((i_52_ ^ 0xffffffff) < -1 && i_52_ < aStandardPlane7217.anInt3404 + -1)
					for (int i_53_ = 0; i_49_ >= i_53_; i_53_++) {
						...
						if (i_54_ > 0 && (i_54_ ^ 0xffffffff) > (aStandardPlane7217.anInt3408 - 1 ^ 0xffffffff)) {
							int i_55_ = standardplane.method3251(i_52_, 1 + i_54_, (byte) -118)
									+ -standardplane.method3251(i_52_, i_54_ - 1, (byte) -118);
							int i_56_ = standardplane.method3251(1 + i_52_, i_54_, (byte) -118)
									+ -standardplane.method3251(-1 + i_52_, i_54_, (byte) -118);
							float f = (float) (1.0 / Math.sqrt(i_56_ * i_56_ + (i_55_ * i_55_ + 65536)));
							aFloatArrayArray7227[i_53_][i_51_] = i_55_ * f;
							aFloatArrayArray7220[i_53_][i_51_] = f * -256.0F;
							aFloatArrayArray7206[i_53_][i_51_] = f * i_56_;
						}
					}
			}
			int i_57_ = 0;
				...
				if ((i_58_ ^ 0xffffffff) <= -1 && (i_58_ ^ 0xffffffff) > (standardplane.anInt3404 ^ 0xffffffff))
					for (int i_59_ = anInt7210; i_59_ <= anInt7215; i_59_++) {
						if ((i_59_ ^ 0xffffffff) <= -1
								&& (standardplane.anInt3408 ^ 0xffffffff) < (i_59_ ^ 0xffffffff)) {
							int i_60_ = is[i_57_];
							...
							if (is_61_ != null && i_60_ != 0)
								if (i_60_ == 1) {
									...
									while (is_61_.length > i_62_)
										if (is_61_[i_62_++] != -1 && (is_61_[i_62_++] ^ 0xffffffff) != 0
												&& (is_61_[i_62_++] ^ 0xffffffff) != 0)
											anInt7212 += 3;
								} else
									anInt7212 += 3;
						}
			...
			if ((anInt7212 ^ 0xffffffff) >= -1) {
				...
				jaclib.memory.heap.NativeHeapBuffer nativeheapbuffer = anAbstractToolkit7230.method1330(false, 84,
						anInt7212 * 16);
				aStream7232 = new Stream(nativeheapbuffer);
				for (;;) {
					Buffer buffer = anInterface15_Impl1_7208.method54(true, (byte) 119);
					if (buffer != null) {
							...
							if (i_64_ < 0 || (i_64_ ^ 0xffffffff) <= (standardplane.anInt3404 ^ 0xffffffff))
								...
								for (int i_66_ = anInt7210; i_66_ <= anInt7215; i_66_++) {
									if ((i_66_ ^ 0xffffffff) <= -1
											&& (standardplane.anInt3408 ^ 0xffffffff) < (i_66_ ^ 0xffffffff)) {
										int i_67_ = is[i_57_];
										...
										if (is_68_ != null && i_67_ != 0)
											if ((i_67_ ^ 0xffffffff) != -2) {
												if (i_67_ == 3) {
													...
													method2645(14195, i_65_, i_64_, 0, i_66_, standardplane.anInt3398,
															i_63_);
													method2645(14195, i_65_, i_64_, standardplane.anInt3398, i_66_, 0,
															i_63_);
												} else if ((i_67_ ^ 0xffffffff) == -3) {
													method2645(14195, i_65_, i_64_, 0, i_66_, standardplane.anInt3398,
															i_63_);
													method2645(14195, i_65_, i_64_, standardplane.anInt3398, i_66_,
															standardplane.anInt3398, i_63_);
													method2645(14195, i_65_, i_64_, 0, i_66_, 0, i_63_);
												...
												while (is_68_.length > i_71_)
													if (is_68_[i_71_] == -1 || is_68_[1 + i_71_] == -1
															|| is_68_[i_71_ - -2] == -1)
														i_71_ += 3;
													else {
														method2645(14195, i_65_, i_64_, is_70_[i_71_], i_66_,
																is_69_[i_71_], i_63_);
														i_71_++;
														method2645(14195, i_65_, i_64_, is_70_[i_71_], i_66_,
																is_69_[i_71_], i_63_);
			...
			throw Commands.method1537(runtimeexception,
					"jw.<init>(" + (abstracttoolkit != null ? "{...}" : "null") + ','
							+ (standardplane != null ? "{...}" : "null") + ',' + (node_sub29 != null ? "{...}" : "null")
							+ ',' + (is != null ? "{...}" : "null") + ')');
		}
	}
	...
	private final void method2645(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_) {
		...
		if ((0x7f & i_4_) == 0 || (i_2_ & 0x7f ^ 0xffffffff) == -1) {
			l = i_6_ & 0xffffL | 65535L << 16 & (long) i_7_ << 16;
			Node node = aHashTable7209.getNode(3512, l);
			if (node != null) {
		...
		} else if (aStandardPlane7217.anInt3398 != i_4_
				|| (i_2_ ^ 0xffffffff) != (aStandardPlane7217.anInt3398 ^ 0xffffffff)) {
		...
		float f_19_ = aNode_Sub29_7231.method2705(32311) + -i_6_;
		float f_20_ = aNode_Sub29_7231.method2704(i + -14165) - i_8_;
		float f_21_ = -i_7_ + aNode_Sub29_7231.method2708(27433);
		float f_22_ = (float) Math.sqrt(f_20_ * f_20_ + f_19_ * f_19_ + f_21_ * f_21_);
		float f_23_ = 1.0F / f_22_;
		f_19_ *= f_23_;
		f_20_ *= f_23_;
		f_21_ *= f_23_;
		float f_24_ = f_22_ / aNode_Sub29_7231.method2711(117);
		...
		int i_29_ = (int) ((i_28_ >> 16 & 0xff) * f_27_);
		if (i_29_ > 255)
			i_29_ = 255;
		int i_30_ = (int) ((i_28_ >> 8 & 0xff) * f_27_);
		if ((i_30_ ^ 0xffffffff) < -256)
			i_30_ = 255;
		int i_31_ = (int) ((i_28_ & 0xff) * f_27_);
		if (Stream.b()) {
	...
	public final void method2646(int i, int i_32_, byte b, int i_33_, boolean[][] bools) {
		anInt7223++;
		if (anInterface15_Impl1_7208 != null && (i_33_ + i ^ 0xffffffff) <= (anInt7210 ^ 0xffffffff)
				&& (-i_33_ + i ^ 0xffffffff) >= (anInt7215 ^ 0xffffffff) && i_32_ - -i_33_ >= anInt7213
				&& i_32_ + -i_33_ <= anInt7219) {
			for (int i_34_ = anInt7213; anInt7219 >= i_34_; i_34_++)
				for (int i_35_ = anInt7210; i_35_ <= anInt7215; i_35_++) {
					int i_36_ = i_35_ + -i;
					int i_37_ = -i_32_ + i_34_;
					if (-i_33_ < i_36_ && (i_36_ ^ 0xffffffff) > (i_33_ ^ 0xffffffff)
							&& (-i_33_ ^ 0xffffffff) > (i_37_ ^ 0xffffffff)
							&& (i_37_ ^ 0xffffffff) > (i_33_ ^ 0xffffffff) && bools[i_33_ + i_36_][i_37_ - -i_33_]) {
						...
						anAbstractToolkit7230.method1276(0, (byte) -113, 0, anInterface15_Impl1_7208, anInt7221,
								Class55.aClass104_833, anInt7212 / 3);
						return;
					}
				}
			if (b <= 43)
