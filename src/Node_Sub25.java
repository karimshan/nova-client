...
abstract class Node_Sub25 extends Node {
	public static byte[] aByteArray7239;
	public static float aFloat7236;
	...
	static {
		...
		for (int i_12_ = 0; i_12_ < 256; i_12_++)
			for (int i_13_ = 0; i_13_ <= i_12_; i_13_++)
				aByteArray7239[i++] = (byte) (int) (255.0
						/ Math.sqrt((65535 + (i_12_ * i_12_ + i_13_ * i_13_)) / 65535.0F));
	}

	public static final int method2651(int i, int i_0_, boolean bool, int i_1_) {
		if (bool != false)
	...
	public static final boolean method2653(int i, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_) {
		anInt7238++;
		int i_9_ = i_4_ - -i;
		int i_10_ = i_3_ + i_7_;
		int i_11_ = i_8_ + i_6_;
	...
	public final void method2652(int i, OggPacket oggpacket) {
		anInt7233++;
