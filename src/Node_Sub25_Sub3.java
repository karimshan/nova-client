...
public class Node_Sub25_Sub3 extends Node_Sub25 {
	public static IncomingPacket aClass192_9978;
	public static Class299 aClass299_9980;
	...
	public static int anInt9976;
	public static int anInt9977;
	public static int anInt9979;
	public static int anInt9982;
	public static int anInt9984;
	public static int anInt9985;
	public static int anInt9988;
	public static int[] anIntArray9966 = { 1, 4, 1, 2, 1 };
	public static IComponentDefinitions aWidget9990 = null;
	public static int localNPCsCount = 0;
	static {
		aClass192_9978 = new IncomingPacket(53, -1);
	}
	...
	public static final String method2671(int i, String string) {
		anInt9985++;
		if (string == null)
			return null;
		int i_1_ = 0;
	...
	public static final Class299 method2672(boolean bool, int i) {
		if (bool != true)
			anIntArray9966 = null;
		anInt9977++;
		if (i != 0) {
			if (i == 1) {
				if (Class20.aFloat327 == 3.0)
					return Class75.aClass299_1007;
				if (Class20.aFloat327 == 4.0)
					return Class352.aClass299_4329;
				if (Class20.aFloat327 == 6.0)
					return Class150_Sub2.aClass299_8962;
				if (Class20.aFloat327 >= 8.0)
	...
	public static final int method2673(int i, boolean bool, int i_6_, boolean bool_7_, int i_8_) {
		if (i <= 54)
			method2674(100, -17, 53);
		anInt9976++;
		Node_Sub16 node_sub16 = ToolTips.method3472(i_8_, (byte) 18, bool_7_);
		if (node_sub16 == null)
			return 0;
		int i_9_ = 0;
		for (int i_10_ = 0; (i_10_ ^ 0xffffffff) > (node_sub16.anIntArray7137.length ^ 0xffffffff); i_10_++)
			if (node_sub16.anIntArray7137[i_10_] >= 0 && (node_sub16.anIntArray7137[i_10_]
					^ 0xffffffff) > (EntityNode_Sub3_Sub1.aClass86_9166.anInt1175 ^ 0xffffffff)) {
				ItemDefinitions itemdefinition = EntityNode_Sub3_Sub1.aClass86_9166
						.method1010(node_sub16.anIntArray7137[i_10_], 14434);
				int i_11_ = itemdefinition.method1678(i_6_,
						Class188_Sub2_Sub2.aClass36_9366.method394(i_6_, -78).anInt3443, 10247);
				if (bool)
	...
	public static final boolean method2674(int i, int i_12_, int i_13_) {
		anInt9982++;
		if (i_12_ != 393216)
			aWidget9990 = null;
		if (!(Class262_Sub16.method3193(i_13_, i, (byte) -109) | (i & 0x60000 ^ 0xffffffff) != -1)
				&& !LoadingBarStage.method1135(i, i_13_, false) && !Class188_Sub1_Sub1.method1894(i, (byte) -29, i_13_))
			return false;
		return true;
	}
	...
	public final float method2667(int i) {
		anInt9960++;
	...
	public final GLSprite method2670(GraphicsToolkit graphicstoolkit, int i) {
		anInt9979++;
		if (i != -10171)
			return null;
		if (aFrame9986 == null)
	...
	public final long method2675(int i) {
		if (i != -3744)
			localNPCsCount = -126;
		anInt9984++;
		return aLong9973;
	...
	public final double method2676(int i) {
		anInt9971++;
		return aDouble9983;
	}

	public final boolean method2677(byte b) {
		if (b < 82)
			return true;
		anInt9962++;
		return aBoolean9991;
