...
public class Node_Sub26 extends Node {
	...
	public static int[] anIntArray7255 = new int[2];
	...
	private PacketDecoder aFloatBuffer7246;
	...
	Node_Sub26(GLToolkit gltoolkit, GLPlane glplane, Node_Sub29 node_sub29, int[] is) {
			...
			if ((i_42_ ^ 0xffffffff) < -1 && (i_42_ ^ 0xffffffff) > (-1 + aGLPlane7262.anInt3404 ^ 0xffffffff))
				for (int i_43_ = 0; i_39_ >= i_43_; i_43_++) {
					...
					if ((i_44_ ^ 0xffffffff) < -1 && aGLPlane7262.anInt3408 - 1 > i_44_) {
						int i_45_ = glplane.method3251(i_42_, i_44_ - -1, (byte) -118)
								- glplane.method3251(i_42_, -1 + i_44_, (byte) -118);
						int i_46_ = glplane.method3251(i_42_ + 1, i_44_, (byte) -118)
								+ -glplane.method3251(i_42_ + -1, i_44_, (byte) -118);
						float f = (float) (1.0 / Math.sqrt(i_45_ * i_45_ - (-65536 + -(i_46_ * i_46_))));
						aFloatArrayArray7257[i_43_][i_41_] = i_45_ * f;
						aFloatArrayArray7241[i_43_][i_41_] = f * -256.0F;
						aFloatArrayArray7250[i_43_][i_41_] = f * i_46_;
					}
				}
		}
		int i_47_ = 0;
		...
		if ((anInt7243 ^ 0xffffffff) >= -1) {
			...
			aFloatBuffer7246 = new PacketDecoder(16 * anInt7243);
								...
								if ((i_57_ ^ 0xffffffff) != -2) {
									if ((i_57_ ^ 0xffffffff) != -4) {
										if ((i_57_ ^ 0xffffffff) == -3) {
											...
											method2684(glplane.anInt3398, glplane.anInt3398, i_54_, 111, i_53_, i_56_,
													i_55_);
											method2684(0, 0, i_54_, -124, i_53_, i_56_, i_55_);
										} else if (i_57_ == 5) {
											method2684(glplane.anInt3398, glplane.anInt3398, i_54_, 118, i_53_, i_56_,
													i_55_);
											...
											method2684(0, 0, i_54_, -124, i_53_, i_56_, i_55_);
											method2684(glplane.anInt3398, glplane.anInt3398, i_54_, 109, i_53_, i_56_,
													i_55_);
										}
									} else {
			...
			anInterface9_7254 = aGLToolkit7240.method1467(false, aFloatBuffer7246.offset, aFloatBuffer7246.buffer, 16,
					-53);
	...
	private final void method2684(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_) {
		...
		if ((0x7f & i_0_ ^ 0xffffffff) == -1 || (0x7f & i ^ 0xffffffff) == -1) {
			...
			Node node = aHashTable7253.getNode(3512, l);
			if (node != null) {
		...
		float f_19_ = aNode_Sub29_7247.method2705(32311) + -i_6_;
		float f_20_ = aNode_Sub29_7247.method2704(30) + -i_8_;
		float f_21_ = -i_7_ + aNode_Sub29_7247.method2708(27433);
		float f_22_ = (float) Math.sqrt(f_21_ * f_21_ + (f_19_ * f_19_ + f_20_ * f_20_));
		float f_23_ = 1.0F / f_22_;
		f_20_ *= f_23_;
		f_21_ *= f_23_;
		f_19_ *= f_23_;
		float f_24_ = f_22_ / aNode_Sub29_7247.method2711(122);
		...
		int i_30_ = (int) (f_28_ * ((i_29_ & 0xffbaea) >> 16));
		if (i_30_ > 255)
			i_30_ = 255;
		int i_31_ = (int) (((0xffef & i_29_) >> 8) * f_28_);
		if (i_31_ > 255)
			i_31_ = 255;
		int i_32_ = (int) (f_28_ * (0xff & i_29_));
		if (!aGLToolkit7240.aBoolean6736) {
			aFloatBuffer7246.method2252(-229385392, i_6_);
			aFloatBuffer7246.method2252(-229385392, i_8_);
			aFloatBuffer7246.method2252(-229385392, i_7_);
		} else {
			aFloatBuffer7246.method2251(8, i_6_);
			aFloatBuffer7246.method2251(8, i_8_);
			aFloatBuffer7246.method2251(8, i_7_);
		}
	...
	public final void method2685(int i, boolean[][] bools, byte b, int i_33_, int i_34_) {
		anInt7245++;
		if (anInterface1_7256 != null && (i_33_ + i ^ 0xffffffff) <= (anInt7258 ^ 0xffffffff)
				&& (anInt7242 ^ 0xffffffff) <= (i - i_33_ ^ 0xffffffff)
				&& (anInt7249 ^ 0xffffffff) >= (i_33_ + i_34_ ^ 0xffffffff) && -i_33_ + i_34_ <= anInt7261) {
			if (b >= -104)
				anInt7243 = -112;
			for (int i_35_ = anInt7249; i_35_ <= anInt7261; i_35_++)
				for (int i_36_ = anInt7258; (i_36_ ^ 0xffffffff) >= (anInt7242 ^ 0xffffffff); i_36_++) {
					...
					if ((i_37_ ^ 0xffffffff) < (-i_33_ ^ 0xffffffff) && (i_33_ ^ 0xffffffff) < (i_37_ ^ 0xffffffff)
							&& -i_33_ < i_38_ && i_38_ < i_33_ && bools[i_37_ + i_33_][i_38_ + i_33_]) {
