...
public class Node_Sub27 extends Node {
	...
	public static int anInt7314;
	public static int[] anIntArray7296 = { 4, 2, 1, 1, 2, 2, 3, 1, 3, 3, 3, 2, 0 };
	...
	public static final void method2693(int i) {
		anInt7294++;
	...
	public static final boolean method2699(int i, int i_8_) {
		if (i != 18)
			aFloat7310 = -1.5500692F;
		anInt7281++;
		if (i_8_ != 21 && i_8_ != 60 && i_8_ != 23 && (i_8_ ^ 0xffffffff) != -18 && (i_8_ ^ 0xffffffff) != -45
				&& (i_8_ ^ 0xffffffff) != -5 && i_8_ != 18)
			return false;
		return true;
	}
	...
	Node_Sub27(BufferedStream buffer, Class353 class353, int i) {
		...
		aClass187_7292 = new Class187(Class240.aSignLink2946.aBoolean4005, Class201.anInt2446, Class263.anInt3336,
				(SignLink.aString3984.indexOf("arm") ^ 0xffffffff) != 0);
	...
	Node_Sub27(Class353 class353, int i) {
		aClass353_7263 = class353;
		aClass187_7292 = new Class187(Class240.aSignLink2946.aBoolean4005, Class201.anInt2446, Class263.anInt3336,
				(SignLink.aString3984.toLowerCase().indexOf("arm") ^ 0xffffffff) != 0);
		aClass320_Sub29_7270 = new Class320_Sub29(i, this);
	...
	public final void method2690(int i, int i_0_, Class320 class320) {
	...
	public final Class353 method2691(int i) {
		if (i != 3)
			return null;
		anInt7288++;
	...
	public final Class187 method2694(int i) {
		anInt7289++;
		if (i != -13725)
			return null;
	...
	private final void method2695(int i) {
		...
		try {
			...
			for (int i_2_ = 0; (i_2_ ^ 0xffffffff) > (fields_1_.length ^ 0xffffffff); i_2_++) {
				...
				if ((aClass7318 == null ? aClass7318 = method2700("Class320") : aClass7318)
	...
	public final BufferedStream method2696(int i) {
		anInt7279++;
	...
	public final boolean method2697(int i) {
		anInt7314++;
		if (i >= -64)
			aClass320_Sub19_7277 = null;
		if (!aClass320_Sub29_7270.method3789(-1) || aClass320_Sub29_7270.method3791(false) != 0
				|| aClass187_7292.method1877((byte) 71) >= 96)
			return false;
		return true;
	}
