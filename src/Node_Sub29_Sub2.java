...
public class Node_Sub29_Sub2 extends Node_Sub29 {
	...
	public static final String method2715(byte b, boolean bool, int i) {
		anInt10018++;
		if (!bool || i < 0)
	...
	public static final int method2716(int i, int i_7_) {
		anInt10016++;
		if (i != 0)
			anInt10015 = -93;
		return i_7_ >>> 8;
	...
	@Override
	public final void method2706(int i, int i_4_, int i_5_, int i_6_) {
		if (i != 4752)
			method2716(61, -81);
		anInt10019++;
		anInt7340 = i_5_;
