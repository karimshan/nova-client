...
public class Node_Sub29_Sub3 extends Node_Sub29 {
	...
	public static int anInt10022;
	public static int anInt10023;
	public static int anInt10024;
	public static int anInt10025;
	public static short aShort10026;
	public static short aShort10027 = 256;

	static {
		aShort10026 = (short) 205;
	}

	public static final void method2717(int i, boolean bool) {
	...
	public static final Class371 method2718(int i) {
		anInt10025++;
		if (i != -27615)
			return null;
	...
	public static final byte[][][] method2719(int i, int i_4_) {
		anInt10022++;
	...
	@Override
	public final void method2706(int i, int i_73_, int i_74_, int i_75_) {
		anInt7342 = i_73_;
		anInt7340 = i_74_;
		if (i != 4752)
	...
	@Override
	public final void method2712(byte b, float f) {
		aFloat7339 = f;
		if (b > 55)
			anInt10024++;
	}
