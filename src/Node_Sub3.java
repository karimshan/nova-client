...
public class Node_Sub3 extends Node {
	public static boolean aBoolean6948 = false;
	public static int anInt6938;
	public static int anInt6939;
	public static int anInt6940;
	public static int anInt6944;

	public static final IComponentDefinitions method2169(int i, int i_0_, int i_1_) {
		anInt6940++;
		if (i != -101)
		...
		if ((i_0_ ^ 0xffffffff) == 0)
			return widget;
		if (widget == null || widget.aWidgetArray4804 == null
				|| (i_0_ ^ 0xffffffff) <= (widget.aWidgetArray4804.length ^ 0xffffffff))
			return null;
		return widget.aWidgetArray4804[i_0_];
	}

	public static final void method2170(int i, long[] ls, int[] is) {
	...
	public static final boolean method2171(int i, int i_4_, byte b, Class171 class171, int i_5_, int i_6_, int i_7_) {
		anInt6939++;
	...
	public static final String method2172(byte b, BufferedStream buffer) {
		anInt6944++;
		if (b != -72)
			return null;
