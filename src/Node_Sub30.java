...
public class Node_Sub30 extends Node {
	public static OutgoingPacket aClass318_7360 = new OutgoingPacket(20, 8);
	public static int anInt7351;
	public static int anInt7353;
	public static int anInt7357;
	public static int anInt7359;
	public static Node_Sub13[] aNode_Sub13Array7362 = new Node_Sub13[300];

	public static final int method2720(int i, int i_0_, int i_1_) {
		anInt7359++;
	...
	public static final int method2721(boolean bool, boolean bool_3_) {
		if (bool_3_ != false)
		...
		if (!bool && Node_Sub5_Sub2.aClass49Array9413 != null)
			return KeyStrokes.anIntArray3665.length * 2;
		int i = 0;
		for (int i_5_ : KeyStrokes.anIntArray3665) {
	...
	public static final int method2722(int i, IComponentDefinitions widget, int i_6_) {
		anInt7357++;
		if (!ConnectionDecoder.method113(widget).method2748((byte) -96, i) && widget.anObjectArray4770 == null)
			return -1;
		if (i_6_ != 7113)
			return 116;
	...
	public static int method2723(int i, int i_7_) {
		return i & i_7_;
	}
