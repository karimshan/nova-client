...
public class Node_Sub33 extends Node {
	public static boolean[][] aBooleanArrayArray7406 = { new boolean[4], new boolean[4], { false, false, true, false },
			{ false, false, true, false }, { false, false, true, false }, { false, false, true, false },
			{ true, false, true, false }, { true, false, false, true }, { true, false, false, true }, new boolean[4],
	...
	public static final void method2733(int i, int i_12_) {
		anInt7396++;
		CacheNode_Sub2 cachenode_sub2 = Class320_Sub19.method3754(3, i, i_12_);
	...
	public final void method2732(int i, int[] is, int i_0_) {
		anInt7394++;
		int i_1_ = 0;
		PacketDecoder floatbuffer = aGLToolkit7407.aFloatBuffer6661;
		...
		if (i < i_1_) {
			...
			aGLToolkit7407.method1482((byte) -108, aClass69_7386, aGLPlane7390.aClass69_7953,
					aGLPlane7390.aClass69_7945, aGLPlane7390.aClass69_7954);
			aGLToolkit7407.method1458(anInt7400, (aGLPlane7390.anInt7911 & 0x7 ^ 0xffffffff) != -1,
					(aGLPlane7390.anInt7911 & 0x8 ^ 0xffffffff) != -1, false);
			...
			aGLToolkit7407.method1482((byte) -29, aClass69_7386, aGLPlane7390.aClass69_7953, aGLPlane7390.aClass69_7945,
					aGLPlane7390.aClass69_7954);
	...
	public final void method2734(int i, int i_13_, float f, int i_14_, int i_15_) {
		anInt7393++;
		if (anInt7400 != -1) {
			PlayerMasks class91 = aGLToolkit7407.aD1543.method10(anInt7400, i_15_ ^ 0x4fee);
			...
			if (i_16_ != 0 && (class91.aByte1214 ^ 0xffffffff) != -5) {
				...
				if ((i_16_ ^ 0xffffffff) != -257) {
					int i_18_ = i_16_;
					int i_19_ = 256 - i_16_;
					i = (i_18_ * (i_17_ & 0xff00ff) + i_19_ * (0xff00ff & i) & ~0xff00ff)
							- -(0xff0000 & (i & 0xff00) * i_19_ + (i_17_ & 0xff00) * i_18_) >> 8;
				} else
					i = i_17_;
			}
	...
	public final void method2735(byte b, int i) {
		try {
			if (b == -92) {
				anInt7395++;
				aStream7391.c();
			...
			throw Commands.method1537(runtimeexception, "nm.F(" + b + ',' + i + ')');
		}
	}

	public final void method2737(byte b, int i) {
		aStream7391.f(3 + 4 * i);
		if (b <= 62)
			anInt7402 = 27;
		anInt7404++;
	...
	public final void method2738(int i, int i_27_, boolean bool, int i_28_) {
		anInt7397++;
		if (bool != true)
			method2734(-29, 2, -0.39897218F, 119, -87);
		anIntArray7398[aGLPlane7390.anInt3408 * i_28_ + i] = Node_Sub16
				.method2590(anIntArray7398[aGLPlane7390.anInt3408 * i_28_ + i], 1 << i_27_);
	}

	public final void method2739(int i, int i_29_) {
		if (i < 44)
