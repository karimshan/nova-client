...
public class Node_Sub34 extends Node {
	public static Class115 aClass115_7410 = Class262_Sub22.method3209(true);
	...
	public static final void method2741(boolean bool) {
		anInt7408++;
		if ((Class320_Sub15.WINDOWS_PANE_ID ^ 0xffffffff) != 0) {
			...
			if (bool == false) {
				...
				BufferedConnection.method422(i_2_ - -Class205.screenHeight, i_2_, -1, i_2_, i_0_, i_0_ + i_2_,
						i_1_ + Class360.screenWidth, i_1_, Class320_Sub15.WINDOWS_PANE_ID, i, i_1_ + i, i_1_);
	...
	public static final String method2742(IComponentDefinitions widget, int i, int i_3_) {
		anInt7409++;
		if (!ConnectionDecoder.method113(widget).method2748((byte) -57, i) && widget.anObjectArray4770 == null)
			return null;
		if (i_3_ != -27187)
			aClass115_7410 = null;
		if (widget.aStringArray4686 == null || (i ^ 0xffffffff) <= (widget.aStringArray4686.length ^ 0xffffffff)
				|| widget.aStringArray4686[i] == null
				|| (widget.aStringArray4686[i].trim().length() ^ 0xffffffff) == -1) {
