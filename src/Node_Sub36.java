...
abstract class Node_Sub36 extends Node {
	public static IncomingPacket aClass192_7428 = new IncomingPacket(77, -2);
	public static Animable[] anAnimableArray7429;
	public static int anInt7422;
	public static int anInt7423;
	public static int anInt7424;
	public static int anInt7425;
	public static int anInt7426;
	public static int anInt7427;

	public static final void method2750(boolean bool, int i, int i_0_, int i_1_) {
		anInt7422++;
		int i_2_ = i_1_ - -Node_Sub53.gameSceneBaseX;
		int i_3_ = Class320_Sub4.gameSceneBaseY + i_0_;
		if (Class175.aClass261ArrayArrayArray2099 != null && (i_1_ ^ 0xffffffff) <= -1 && (i_0_ ^ 0xffffffff) <= -1
				&& i_1_ < Node_Sub54.GAME_SCENE_WDITH && Class377_Sub1.GAME_SCENE_HEIGHT > i_0_
				&& ((Class213.aNode_Sub27_2512.aClass320_Sub19_7301.method3751(bool) ^ 0xffffffff) != -1
						|| i == Player.get.plane)) {
			long l = i_3_ << 14 | i << 28 | i_2_;
			Node_Sub11 node_sub11 = (Node_Sub11) Class266.aHashTable3380.getNode(3512, l);
			if (node_sub11 == null)
				...
				if (node_sub8 == null)
					...
					Animable_Sub3_Sub1 animable_sub3_sub1 = (Animable_Sub3_Sub1) Class262_Sub22.method3211(i, i_1_,
							i_0_);
					if (animable_sub3_sub1 != null)
						animable_sub3_sub1.anInt11010 = animable_sub3_sub1.anInt11007 = -1;
					else
						animable_sub3_sub1 = new Animable_Sub3_Sub1(i_1_ << 9,
								Class320_Sub10.aPlaneArray8300[i].method3251(i_0_, i_1_, (byte) -118), i_0_ << 9, i, i);
					...
					while_204_: do {
						...
						for (;;) {
							...
							if (node_sub8_5_ == null)
								break;
							if (animable_sub3_sub1.anInt10996 != node_sub8_5_.anInt7065
									&& node_sub8_5_.anInt7065 != animable_sub3_sub1.anInt11010) {
	...
	public static final void method2752(boolean bool, boolean bool_7_) {
		anInt7424++;
	...
	public static final int method2753(byte b, Class68 class68) {
		anInt7426++;
	...
	public static final void method2754(Animator animator, DrawableModel drawablemodel, Animator animator_8_, byte b) {
		if (animator.method247(29340) && animator_8_.method247(29340)) {
			...
			drawablemodel.method615(animator_8_.anInt247, animator.aClass226_270.anInt2685,
					animator.aClass226_270.aCacheNode_Sub15_2687, animator_8_.aClass226_270.anInt2688, -65,
					animator.aClass226_270.anInt2688, animator_8_.aClass226_270.aCacheNode_Sub15_2687,
					animator.aClass226_270.aCacheNode_Sub15_2683, animator.anInt247,
					class48.aBoolean691 | class48_9_.aBoolean691, class48_9_.anIntArray707[animator_8_.anInt259],
					animator_8_.aClass226_270.aCacheNode_Sub15_2683, class48.aBooleanArray703,
					class48.anIntArray707[animator.anInt259], animator_8_.aClass226_270.anInt2685);
		}
		anInt7427++;
		if (b > -7)
	...
	public static final int method2757(int i, int i_10_, byte b) {
		anInt7425++;
