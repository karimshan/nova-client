...
public class Node_Sub38_Sub11 extends Node_Sub38 {
	public static OutgoingPacket aClass318_10221 = new OutgoingPacket(36, -1);
	public static long aLong10215;
	public static int anInt10200;
	public static int anInt10202;
	public static int anInt10207;
	public static int anInt10212;
	public static int anInt10214;
	public static int anInt10216;
	public static int[] anIntArray10217 = new int[32];
	public static int[] anIntArray10218 = new int[4096];

	public static final void method2826(boolean bool, double d) {
		anInt10214++;
	...
	public static final boolean method2828(int i, int i_9_) {
		if (i_9_ != 0)
			method2828(116, -108);
		anInt10207++;
		if (i != 0 && i != 1 && i != 2)
	...
	@Override
	public final int[] method2775(int i, int i_10_) {
		anInt10212++;
		if (i < 107)
			anIntArray10217 = null;
		...
		if (aClass146_7460.aBoolean1819) {
			...
			if ((anInt10211 + i_15_ ^ 0xffffffff) > (i_12_ ^ 0xffffffff) && i_12_ < -anInt10211 + i_14_)
				for (int i_16_ = 0; (i_16_ ^ 0xffffffff) > (Class339_Sub7.anInt8728 ^ 0xffffffff); i_16_++) {
					...
					int i_19_;
					for (i_19_ = CacheNode_Sub3.anIntArray9442[i_16_]
							+ (i_18_ * anInt10206 >> 12); (i_19_ ^ 0xffffffff) > -1; i_19_ += 4096) {
						/* empty */
					}
	...
	private final void method2827(int i) {
		anInt10202++;
		Random random = new Random(anInt10204);
		...
		for (int i_2_ = 0; anInt10204 > i_2_; i_2_++) {
			...
			for (int i_5_ = 0; (anInt10222 ^ 0xffffffff) < (i_5_ ^ 0xffffffff); i_5_++) {
				...
				anIntArrayArray10223[i_2_][i_5_] = anInt10209 > 0
						? 4096 - Class330.method3838(Node_Sub19.method2612(i, -30468), anInt10209, random) : 4096;
			}
