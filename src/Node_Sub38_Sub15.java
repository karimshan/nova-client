...
public class Node_Sub38_Sub15 extends Node_Sub38 {
	public static byte[][][] aByteArrayArrayArray10261;
	public static Class257 aClass257_10262 = new Class257(4, 3);
	public static int anInt10255;
	public static int anInt10257;
	public static int anInt10259 = Node_Sub38_Sub20.method2855(1600, (byte) -103);
	public static int anInt10260;
	...
	public final int[] method2775(int i, int i_1_) {
		...
		if (aClass146_7460.aBoolean1819) {
			...
			Random random = new Random(anInt10253);
			for (int i_4_ = 0; anInt10254 > i_4_; i_4_++) {
				int i_5_ = (anInt10258 ^ 0xffffffff) < -1
						? anInt10252 - -Class330.method3838(-5208, anInt10258, random) - i_2_ : anInt10252;
				i_5_ = 0xff & i_5_ >> 4;
