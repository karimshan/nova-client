...
public class Node_Sub38_Sub16 extends Node_Sub38 {
	public static Class335 aClass335_10268 = new Class335(64);
	public static int anInt10264;
	public static int anInt10265;
	public static int anInt10266;
	public static int anInt10267;
	public static int[][] anIntArrayArray10269;
	...
	public static final void method2840(int i) {
		if (i == 0) {
	...
	public static final void method2841(boolean bool, int i, int i_11_, int i_12_, int i_13_, int i_14_) {
		anInt10267++;
		if (i <= -119) {
			long l = (bool ? -2147483648 : 0) | i_14_;
			Node_Sub16 node_sub16 = (Node_Sub16) Class153.aHashTable1947.getNode(3512, l);
			if (node_sub16 == null) {
			...
			if (i_12_ >= node_sub16.anIntArray7137.length) {
				...
				for (int i_17_ = node_sub16.anIntArray7137.length; (i_17_ ^ 0xffffffff) > (i_12_
						^ 0xffffffff); i_17_++) {
					is[i_17_] = -1;
					is_15_[i_17_] = 0;
				}
