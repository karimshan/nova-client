...
public class Node_Sub38_Sub18 extends Node_Sub38 {
	public static boolean aBoolean10282 = false;
	public static IncomingPacket aClass192_10277 = new IncomingPacket(121, 6);
	public static int anInt10275;
	public static int anInt10276;
	public static int anInt10279;
	public static int anInt10280;
	public static int anInt10281;
	public static String aString10283 = null;

	public static final boolean method2844(int i, boolean bool) {
		if (bool != true)
	...
	public static final void method2846(int i, byte b, IComponentDefinitions widget, int i_65_) {
		anInt10275++;
		if (widget != null) {
						...
						while_167_: do {
							while_166_: do {
									...
									while_164_: do {
										while_163_: do {
											while_162_: do {
												while_161_: do {
													do {
														if (i_4_ != 1) {
															...
															for (i_4_ = 0; (i_4_
																	^ 0xffffffff) > (Class339_Sub7.anInt8728
																			^ 0xffffffff); i_4_++)
												...
												for (i_4_ = 0; (i_4_ ^ 0xffffffff) > (Class339_Sub7.anInt8728
														^ 0xffffffff); i_4_++) {
													int i_5_ = is_3_[i_4_];
											...
											for (i_4_ = 0; (i_4_ ^ 0xffffffff) > (Class339_Sub7.anInt8728
													^ 0xffffffff); i_4_++)
												is[i_4_] = -((4096 + -is_3_[i_4_]) * (-is_2_[i_4_] + 4096) >> 12)
														+ 4096;
											break while_170_;
										} while (false);
										for (i_4_ = 0; (i_4_ ^ 0xffffffff) > (Class339_Sub7.anInt8728
												^ 0xffffffff); i_4_++) {
											int i_6_ = is_3_[i_4_];
											is[i_4_] = (i_6_ ^ 0xffffffff) > -2049 ? i_6_ * is_2_[i_4_] >> 11
													: 4096 - ((-i_6_ + 4096) * (-is_2_[i_4_] + 4096) >> 11);
										}
										break while_170_;
									} while (false);
									for (i_4_ = 0; Class339_Sub7.anInt8728 > i_4_; i_4_++) {
								...
								for (i_4_ = 0; i_4_ < Class339_Sub7.anInt8728; i_4_++) {
									int i_8_ = is_2_[i_4_];
									is[i_4_] = (i_8_ ^ 0xffffffff) == -1 ? 0
											: 4096 - (4096 + -is_3_[i_4_] << 12) / i_8_;
								}
								break while_170_;
							} while (false);
								...
								while_175_: do {
									while_174_: do {
										while_173_: do {
											while_172_: do {
												while_171_: do {
													do {
														...
														for (i_28_ = 0; (Class339_Sub7.anInt8728 ^ 0xffffffff) < (i_28_
																^ 0xffffffff); i_28_++) {
															is_19_[i_28_] = -is_25_[i_28_] + is_22_[i_28_];
											...
											for (i_28_ = 0; i_28_ < Class339_Sub7.anInt8728; i_28_++) {
												is_19_[i_28_] = -((4096 - is_25_[i_28_])
														* (-is_22_[i_28_] + 4096) >> 12) + 4096;
												is_20_[i_28_] = -((4096 - is_26_[i_28_]) * (4096 - is_23_[i_28_]) >> 12)
														+ 4096;
												is_21_[i_28_] = 4096
														+ -((-is_24_[i_28_] + 4096) * (-is_27_[i_28_] + 4096) >> 12);
											}
											break while_180_;
										} while (false);
										for (i_28_ = 0; Class339_Sub7.anInt8728 > i_28_; i_28_++) {
											...
											is_19_[i_28_] = i_32_ >= 2048
													? -((-i_32_ + 4096) * (4096 + -is_22_[i_28_]) >> 11) + 4096
													: i_32_ * is_22_[i_28_] >> 11;
											is_20_[i_28_] = i_34_ < 2048 ? is_23_[i_28_] * i_34_ >> 11
													: -((-i_34_ + 4096) * (-is_23_[i_28_] + 4096) >> 11) + 4096;
											is_21_[i_28_] = (i_33_ ^ 0xffffffff) <= -2049
													? -((4096 - i_33_) * (4096 + -is_24_[i_28_]) >> 11) + 4096
													: i_33_ * is_24_[i_28_] >> 11;
										}
										break while_180_;
									} while (false);
									for (i_28_ = 0; i_28_ < Class339_Sub7.anInt8728; i_28_++) {
										...
										is_19_[i_28_] = (i_37_ ^ 0xffffffff) != -4097
												? (is_25_[i_28_] << 12) / (4096 + -i_37_) : 4096;
										is_20_[i_28_] = i_36_ == 4096 ? 4096 : (is_26_[i_28_] << 12) / (4096 - i_36_);
										is_21_[i_28_] = (i_35_ ^ 0xffffffff) == -4097 ? 4096
												: (is_27_[i_28_] << 12) / (4096 - i_35_);
									}
									break while_180_;
								} while (false);
								for (i_28_ = 0; (i_28_ ^ 0xffffffff) > (Class339_Sub7.anInt8728
										^ 0xffffffff); i_28_++) {
									int i_38_ = is_24_[i_28_];
									int i_39_ = is_22_[i_28_];
									int i_40_ = is_23_[i_28_];
									is_19_[i_28_] = i_39_ == 0 ? 0 : -((-is_25_[i_28_] + 4096 << 12) / i_39_) + 4096;
									is_20_[i_28_] = (i_40_ ^ 0xffffffff) != -1
											? 4096 + -((-is_26_[i_28_] + 4096 << 12) / i_40_) : 0;
									is_21_[i_28_] = (i_38_ ^ 0xffffffff) != -1
											? -((4096 + -is_27_[i_28_] << 12) / i_38_) + 4096 : 0;
								}
								break while_180_;
							} while (false);
