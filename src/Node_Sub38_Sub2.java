...
public class Node_Sub38_Sub2 extends Node_Sub38 {
	...
	public static IncomingPacket aClass192_10092 = new IncomingPacket(64, 3);
	public static int anInt10091;
	public static int anInt10093;
	public static int anInt10094;
	public static int anInt10095;
	public static int[] anIntArray10096 = { 36064, 36065, 36066, 36067, 36068, 36069, 36070, 36071, 36096 };

	public static final boolean method2793(int i, String string) {
		anInt10094++;
		if (i != 1)
			return true;
		return Animable_Sub1_Sub1.method830(aClass10097 == null ? aClass10097 = method2795("Class304") : aClass10097,
				true, string);
	}
	...
	@Override
	public final int[] method2775(int i, int i_15_) {
		anInt10091++;
