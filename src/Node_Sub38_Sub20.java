...
public class Node_Sub38_Sub20 extends Node_Sub38 {
	...
	public static java.awt.Canvas aCanvas10309;
	public static int anInt10297;
	...
	public static int anInt10308;
	public static int anInt10310;
	public static int anInt10313;

	public static final void decodeReceivedMapRegions(int i) {
		anInt10310++;
		Class61.anInt898 = 0;
		...
		// System.out.println(gameSceneBaseRegionX+", "+gameSceneBaseRegionY+",
		// "+gameSceneSize+", "+i_50_);
		...
		i_50_ = 0;
		for (int thisRegionX = (-(Node_Sub54.GAME_SCENE_WDITH >> 4) + gameSceneBaseRegionX)
				/ 8; ((Node_Sub54.GAME_SCENE_WDITH >> 4) + gameSceneBaseRegionX) / 8 >= thisRegionX; thisRegionX++)
			for (int thisRegionY = (-(Class377_Sub1.GAME_SCENE_HEIGHT >> 4) + gameSceneBaseRegionY) / 8; (thisRegionY
					^ 0xffffffff) >= ((gameSceneBaseRegionY + (Class377_Sub1.GAME_SCENE_HEIGHT >> 4)) / 8
							^ 0xffffffff); thisRegionY++) {
				Class262_Sub1.MAP_REGION_HASHES[i_50_] = (thisRegionX << 8) + thisRegionY;
				StandardPlane.anIntArray7980[i_50_] = Animable_Sub1_Sub1.aClass302_10618
						.method3519("m" + thisRegionX + "_" + thisRegionY, (byte) 33);
				Class144.anIntArray1789[i_50_] = Animable_Sub1_Sub1.aClass302_10618
						.method3519("l" + thisRegionX + "_" + thisRegionY, (byte) 19);
				Class42.anIntArray645[i_50_] = Animable_Sub1_Sub1.aClass302_10618
						.method3519("um" + thisRegionX + "_" + thisRegionY, (byte) 87);
				ProducingGraphicsBuffer.anIntArray9895[i_50_] = Animable_Sub1_Sub1.aClass302_10618
						.method3519("ul" + thisRegionX + "_" + thisRegionY, (byte) 109);
				i_50_++;
			}
	...
	public static final int method2855(int i, byte b) {
		anInt10301++;
		int i_17_ = 0;
	...
	public static final boolean method2856(int i, Class84 class84, int i_18_, int i_19_, int routeType, int i_21_, int i_22_,
		...
		while_203_: while ((i_34_ ^ 0xffffffff) != (i_35_ ^ 0xffffffff)) {
					...
					while_193_: do {
						while_192_: do {
							do {
									...
									if ((i_38_ ^ 0xffffffff) != 2) {
										if (i_38_ != -2) {
											if ((i_38_ ^ 0xffffffff) != 0) {
												if (i_38_ == 0 || i_38_ == 1 || (i_38_ ^ 0xffffffff) == -3
														|| (i_38_ ^ 0xffffffff) == -4 || (i_38_ ^ 0xffffffff) == -10)
													break while_193_;
												break while_194_;
											}
										} else
								...
								if (Class150_Sub2.method1659(i_23_, i_25_, i_28_, i_26_ ^ 0x11, i_19_, i_27_, i_29_,
										i_24_, i_25_)) {
									Class219.anInt2623 = i_29_;
									Class315.anInt4033 = i_28_;
									return true;
							...
							if (class84.method984(i_25_, i_24_, (byte) -93, i_25_, i_28_, i_23_, i_22_, i_27_, i_29_,
									i_19_)) {
								Class219.anInt2623 = i_29_;
								Class315.anInt4033 = i_28_;
								return true;
			...
			while_196_: do
				if ((i_30_ ^ 0xffffffff) < -1
						&& (Node_Sub36_Sub2.anIntArrayArray10047[-1 + i_30_][i_31_] ^ 0xffffffff) == -1
						&& (0x43a40000 & is[i_36_ + -1][i_37_] ^ 0xffffffff) == -1
						&& (0x4e240000 & is[i_36_ - 1][-1 + (i_25_ + i_37_)] ^ 0xffffffff) == -1) {
			...
			while (false);
			while_197_: do
				if (128 - i_25_ > i_30_ && (Node_Sub36_Sub2.anIntArrayArray10047[i_30_ - -1][i_31_] ^ 0xffffffff) == -1
						&& (is[i_36_ - -i_25_][i_37_] & 0x60e40000 ^ 0xffffffff) == -1
						&& (0x78240000 & is[i_36_ - -i_25_][-1 + (i_37_ + i_25_)]) == 0) {
			...
			while (false);
			while_198_: do
				if ((i_31_ ^ 0xffffffff) < -1 && Node_Sub36_Sub2.anIntArrayArray10047[i_30_][i_31_ - 1] == 0
						&& (0x43a40000 & is[i_36_][-1 + i_37_]) == 0
						&& (is[i_36_ + (i_25_ - 1)][-1 + i_37_] & 0x60e40000) == 0) {
			...
			while (false);
			while_199_: do
				if (128 - i_25_ > i_31_ && Node_Sub36_Sub2.anIntArrayArray10047[i_30_][1 + i_31_] == 0
						&& (is[i_36_][i_37_ - -i_25_] & 0x4e240000 ^ 0xffffffff) == -1
						&& (is[i_36_ - (-i_25_ + 1)][i_25_ + i_37_] & 0x78240000 ^ 0xffffffff) == -1) {
			...
			while_200_: do
				if (i_30_ > 0 && i_31_ > 0
						&& (Node_Sub36_Sub2.anIntArrayArray10047[i_30_ + -1][-1 + i_31_] ^ 0xffffffff) == -1
						&& (is[-1 + i_36_][i_37_ + -1] & 0x43a40000) == 0) {
					for (int i_43_ = 1; i_43_ < i_25_; i_43_++)
						if ((0x4fa40000 & is[-1 + i_36_][i_43_ + (i_37_ + -1)] ^ 0xffffffff) != -1
								|| (0x63e40000 & is[i_36_ + -1 - -i_43_][i_37_ - 1]) != 0)
							break while_200_;
					Node_Sub39.routeFinderXArray[i_34_] = i_28_ + -1;
					Class339_Sub6.routeFinderYArray[i_34_] = -1 + i_29_;
			...
			while (false);
			while_201_: do
				if ((128 - i_25_ ^ 0xffffffff) < (i_30_ ^ 0xffffffff) && (i_31_ ^ 0xffffffff) < -1
						&& (Node_Sub36_Sub2.anIntArrayArray10047[1 + i_30_][i_31_ + -1] ^ 0xffffffff) == -1
						&& (0x60e40000 & is[i_36_ + i_25_][i_37_ + -1] ^ 0xffffffff) == -1) {
					for (int i_44_ = 1; i_44_ < i_25_; i_44_++)
						if ((0x78e40000 & is[i_36_ + i_25_][i_44_ + (-1 + i_37_)]) != 0
								|| (is[i_44_ + i_36_][i_37_ - 1] & 0x63e40000) != 0)
							break while_201_;
					Node_Sub39.routeFinderXArray[i_34_] = 1 + i_28_;
					Class339_Sub6.routeFinderYArray[i_34_] = -1 + i_29_;
			...
			while (false);
			while_202_: do
				if (i_30_ > 0 && i_31_ < 128 + -i_25_ && Node_Sub36_Sub2.anIntArrayArray10047[i_30_ - 1][1 + i_31_] == 0
						&& (0x4e240000 & is[-1 + i_36_][i_25_ + i_37_] ^ 0xffffffff) == -1) {
					for (int i_45_ = 1; (i_45_ ^ 0xffffffff) > (i_25_ ^ 0xffffffff); i_45_++)
						if ((is[i_36_ - 1][i_37_ + i_45_] & 0x4fa40000) != 0
								|| (is[i_45_ + (i_36_ - 1)][i_25_ + i_37_] & 0x7e240000) != 0)
							break while_202_;
					Node_Sub39.routeFinderXArray[i_34_] = i_28_ - 1;
					Class339_Sub6.routeFinderYArray[i_34_] = i_29_ + 1;
			...
			while (false);
			if (i_30_ < -i_25_ + 128 && (i_31_ ^ 0xffffffff) > (-i_25_ + 128 ^ 0xffffffff)
					&& Node_Sub36_Sub2.anIntArrayArray10047[1 + i_30_][1 + i_31_] == 0
					&& (is[i_25_ + i_36_][i_25_ + i_37_] & 0x78240000 ^ 0xffffffff) == -1) {
				for (int i_46_ = 1; i_25_ > i_46_; i_46_++)
					if ((0x7e240000 & is[i_46_ + i_36_][i_37_ - -i_25_] ^ 0xffffffff) != -1
							|| (0x78e40000 & is[i_36_ - -i_25_][i_37_ - -i_46_]) != 0)
						continue while_203_;
				Node_Sub39.routeFinderXArray[i_34_] = 1 + i_28_;
				Class339_Sub6.routeFinderYArray[i_34_] = i_29_ + 1;
	...
	@Override
	public final int[] method2775(int i, int i_5_) {
		if (i < 107)
			return null;
		anInt10302++;
	...
	private final boolean method2854(int i, int i_13_, int i_14_) {
		...
		if ((-i_13_ + i_14_ ^ 0xffffffff) <= (i_16_ ^ 0xffffffff)
				|| (-i_16_ ^ 0xffffffff) <= (-i_13_ + i_14_ ^ 0xffffffff))
			return false;
		return true;
	}
}
