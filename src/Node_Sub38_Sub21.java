...
public class Node_Sub38_Sub21 extends Node_Sub38 {
	public static boolean aBoolean10320;
	public static IncomingPacket aClass192_10316;
	public static int anInt10315;
	public static int anInt10317;
	public static int anInt10319;
	public static int[] anIntArray10318 = { -1, 8192, 0, -1, 12288, 10240, 14336, -1, 4096, 6144, 2048 };

	static {
		aClass192_10316 = new IncomingPacket(45, 2);
		aBoolean10320 = false;
	}
	...
	public static final Class235_Sub1 method2859(BufferedStream buffer, boolean bool) {
		anInt10319++;
		if (bool != false)
			method2859(null, false);
		Class235 class235 = Node_Sub40.method2928(buffer, (byte) -24);
		int i = buffer.read24BitInteger((byte) 99);
		return new Class235_Sub1(class235.anInt5125, class235.aClass379_5118, class235.aClass77_5123,
				class235.anInt5124, class235.anInt5116, i);
	}
