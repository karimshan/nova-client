...
public class Node_Sub38_Sub22 extends Node_Sub38 {
	public static Class353 aClass353_10323 = new Class353("game3", "Game 3", 2);
	public static int anInt10322;
	public static int anInt10324;
	public static short aShort10325;
	...
	public final int[] method2775(int i, int i_0_) {
		...
		if (aClass146_7460.aBoolean1819) {
			...
			for (int i_4_ = 0; (i_4_ ^ 0xffffffff) > (Class339_Sub7.anInt8728 ^ 0xffffffff); i_4_++) {
				...
				int i_11_ = (int) (Math.sqrt((4096 + i_9_ - -i_10_) / 4096.0F) * 4096.0);
