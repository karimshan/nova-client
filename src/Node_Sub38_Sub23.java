...
public class Node_Sub38_Sub23 extends Node_Sub38 {
	public static CacheNode_Sub13 aCacheNode_Sub13_10343;
	public static Class124 aClass124_10344;
	public static OutgoingPacket aClass318_10329 = new OutgoingPacket(19, 3);
	public static int anInt10326;
	public static int anInt10328;
	public static int anInt10330;
	...
	public static int anInt10346 = -1;
	public static int anInt10347;
	public static short aShort10345;
	static {
		aClass124_10344 = new Class124(50);
		anInt10347 = -1;
	}

	public static final void method2862(IComponentDefinitions widget, int i, int i_0_, int i_1_) {
		if (i_1_ != -8525)
			method2864(22);
		anInt10336++;
		...
		if (Class54.aBoolean817 && (ConnectionDecoder.method113(widget).settingsHash != 0 || widget.type == 0)) {
	...
	public static final void method2863(int i) {
		anInt10328++;
		if (Class87.removeWalkHere) {
			IComponentDefinitions widget = Node_Sub3.method2169(i ^ 0x4b17, Class46.anInt681,
	...
	public static final void method2865(byte b) {
		anInt10342++;
		if (!Node_Sub3.aBoolean6948) {
			@SuppressWarnings("unused")
			int i = -80 / ((b - -18) / 46);
			KeyStrokes.aFloat3666 += (-KeyStrokes.aFloat3666 + -24.0F) / 2.0F;
			Node_Sub3.aBoolean6948 = true;
			Node_Sub25_Sub1.aBoolean9950 = true;
		}
	}

	public static final boolean method2866(boolean bool) {
		anInt10331++;
		if ((Class151.anInt1843 ^ 0xffffffff) != -4)
			return false;
		if (Node_Sub38_Sub8.anInt10163 != 0 || (MiniMapDots.anInt124 ^ 0xffffffff) != -1)
			return false;
		if (bool != false)
			aClass124_10344 = null;
		return true;
	...
	public final int[] method2775(int i, int i_3_) {
		...
		if (aClass146_7460.aBoolean1819) {
			...
			int i_6_ = i_5_ - -1;
			int i_7_ = 0;
			while_217_: for (/**/; (Class339_Sub7.anInt8728 ^ 0xffffffff) < (i_7_ ^ 0xffffffff); i_7_++) {
				...
				for (int i_11_ = -1 + i_5_; (i_11_ ^ 0xffffffff) >= (i_6_ ^ 0xffffffff); i_11_++) {
					...
					for (int i_13_ = -1 + i_9_; (i_10_ ^ 0xffffffff) <= (i_13_ ^ 0xffffffff); i_13_++) {
						int i_14_ = 2 * (0xff & aByteArray10341[i_12_
								+ ((i_13_ ^ 0xffffffff) <= (anInt10334 ^ 0xffffffff) ? -anInt10334 + i_13_ : i_13_)
								& 0xff]);
							...
							while_212_: do {
								while_211_: do {
									while_210_: do {
										...
										i_15_ = (int) (4096.0
												* Math.sqrt(((i_15_ ^ 0xffffffff) > -1 ? -i_15_ : i_15_) / 4096.0F));
										i_16_ = (int) (4096.0 * Math.sqrt((i_16_ < 0 ? -i_16_ : i_16_) / 4096.0F));
										i_18_ = i_16_ + i_15_;
									...
									i_16_ *= i_16_;
									i_15_ *= i_15_;
									i_18_ = (int) (Math.sqrt(Math.sqrt((i_16_ + i_15_) / 1.6777216E7F)) * 4096.0);
									break while_213_;
								} while (false);
								i_18_ = (i_15_ >= 0 ? i_15_ : -i_15_) + ((i_16_ ^ 0xffffffff) > -1 ? -i_16_ : i_16_);
								break while_213_;
							} while (false);
							i_18_ = (int) (Math.sqrt((i_16_ * i_16_ + i_15_ * i_15_) / 1.6777216E7F) * 4096.0);
						} while (false);
	...
	private final void method2861(byte b) {
		anInt10338++;
		Random random = new Random(anInt10335);
		if (b < 97)
