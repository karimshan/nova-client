...
public class Node_Sub38_Sub25 extends Node_Sub38 {
	...
	public static int[] anIntArray10358;
	public static int CURRENT_GAME_SCENE_SIZE = -1;

	public static final ClientScript method2871(Class212 class212, int i, int i_0_, int i_1_) {
		anInt10359++;
		...
		if (bs != null) {
			if ((bs.length ^ 0xffffffff) >= -2)
				return null;
			try {
				cachenode_sub9 = CS2Definition.method356(bs, false);
