...
public class Node_Sub38_Sub26 extends Node_Sub38 {
	public static IncomingPacket aClass192_10368 = new IncomingPacket(25, 0);
	public static int anInt10361;
	public static int anInt10362;
	public static int anInt10366;
	public static int anInt10367;
	public static int anInt10369;
	public static int[] anIntArray10370 = new int[6];
	...
	public static final byte[] method2875(byte[] bs, byte b) {
		anInt10362++;
	...
	public static final void method2876(Animable[] animables, int i, int i_11_) {
		if (i < i_11_) {
			int i_12_ = (i + i_11_) / 2;
			int i_13_ = i;
	...
	public static final boolean method2877(int i, int i_17_, int i_18_) {
		anInt10366++;
		if (i_18_ < 82)
			aClass192_10368 = null;
