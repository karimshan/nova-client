...
public class Node_Sub38_Sub27 extends Node_Sub38 {
	public static int anInt10373;
	public static int anInt10375;
	public static int anInt10376;
	public static int anInt10379;
	public static int anInt10380;
	public static int anInt10381;
	public static int anInt10383;
	public static int anInt10385;
	public static int anInt10387;
	public static int anInt10388;
	public static int[] anIntArray10372 = new int[1];

	public static final void method2878(int i, String string, boolean bool, int i_0_) {
		Class94.method1065(-81);
		anInt10379++;
		if ((i_0_ ^ 0xffffffff) == -1) {
			Class93.graphicsToolkit = Class262_Sub9.method3171(Class262_Sub2.index31, (byte) 55,
					TemporaryItemDefinition.aD565, 0, Node_Sub38_Sub20.aCanvas10309,
			...
			if (string != null) {
				...
				AbstractFont class52 = Class93.graphicsToolkit.a(class357,
						Class383.method4187(Node_Sub38_Sub39.aClass302_10500, Class285.anInt3600, 0), true);
				Node_Sub36_Sub1.method2758(-80);
				Class169_Sub3.method1779(Class93.graphicsToolkit, string, true, class357, class52, -16777216);
			}
		} else {
			GraphicsToolkit graphicstoolkit = null;
			if (string != null) {
				graphicstoolkit = Class262_Sub9.method3171(Class262_Sub2.index31, (byte) -82,
						TemporaryItemDefinition.aD565, 0, Node_Sub38_Sub20.aCanvas10309, 0);
				graphicstoolkit.GA(0);
				Class357 class357 = Class44.method461(0, -30, Class285.anInt3600, AnimableAnimator_Sub1.aClass302_9091);
				AbstractFont class52 = graphicstoolkit.a(class357,
						Class383.method4187(Node_Sub38_Sub39.aClass302_10500, Class285.anInt3600, 0), true);
				Node_Sub36_Sub1.method2758(109);
				Class169_Sub3.method1779(graphicstoolkit, string, true, class357, class52, -16777216);
			}
			try {
				Class93.graphicsToolkit = Class262_Sub9.method3171(Class262_Sub2.index31, (byte) -113,
						TemporaryItemDefinition.aD565, i_0_, Node_Sub38_Sub20.aCanvas10309,
						2 * Class213.aNode_Sub27_2512.aClass320_Sub13_7283.method3734(false));
				if (string != null) {
					graphicstoolkit.GA(0);
					Class357 class357 = Class44.method461(0, -5, Class285.anInt3600,
				...
				if (Class93.graphicsToolkit.k()) {
					...
					za var_za;
					if (bool_1_)
						var_za = Class93.graphicsToolkit.a(146800640);
					else
						var_za = Class93.graphicsToolkit.a(104857600);
					Class93.graphicsToolkit.a(var_za);
				}
			} catch (Throwable throwable) {
		...
		Class93.graphicsToolkit.b(10000);
		Class93.graphicsToolkit.X(32);
		Class290_Sub6.aClass336_8114 = Class93.graphicsToolkit.y();
		Node_Sub5.aClass336_7032 = Class93.graphicsToolkit.y();
		Class116.method1163(2);
		Class93.graphicsToolkit.a(Class213.aNode_Sub27_2512.aClass320_Sub9_7315.method3715(false) == 1);
		if (Class93.graphicsToolkit.o())
			Node_Sub19.method2610((byte) -58,
					(Class213.aNode_Sub27_2512.aClass320_Sub20_7306.method3758(false) ^ 0xffffffff) == -2);
		if (i <= 54)
	...
	public static final void method2881(int i, byte b, int i_52_, int i_53_, int i_54_) {
		anInt10385++;
	...
	public static final TemporaryItemDefinition method2882(BufferedStream buffer, ItemDefinitions itemdefinition, int i) {
		anInt10373++;
	...
	@Override
	public final int[] method2775(int i, int i_50_) {
		anInt10380++;
	...
	public final void method2880(int i, int[] is, int i_3_) {
		if (i_3_ <= -32) {
			anInt10387++;
				...
				for (int i_34_ = 1; i_34_ < anInt10382; i_34_++) {
					...
					if ((i_21_ ^ 0xffffffff) < -9 || (i_21_ ^ 0xffffffff) > 7) {
						...
						if (!aBoolean10377 || -1 + anInt10382 != i_34_)
							for (int i_44_ = 0; (i_44_ ^ 0xffffffff) > (Class339_Sub7.anInt8728
									^ 0xffffffff); i_44_++) {
							...
							for (int i_47_ = 0; (i_47_ ^ 0xffffffff) > (Class339_Sub7.anInt8728
									^ 0xffffffff); i_47_++) {
	...
	private final void method2884(int i) {
		if (i > (anInt10378 ^ 0xffffffff)) {
			...
			for (int i_81_ = 0; i_81_ < anInt10382; i_81_++) {
				aShortArray10386[i_81_] = (short) (int) (4096.0 * Math.pow(anInt10378 / 4096.0F, i_81_));
				aShortArray10374[i_81_] = (short) (int) Math.pow(2.0, i_81_);
			}
		} else if (aShortArray10386 != null && anInt10382 == aShortArray10386.length) {
			aShortArray10374 = new short[anInt10382];
			for (int i_82_ = 0; i_82_ < anInt10382; i_82_++)
				aShortArray10374[i_82_] = (short) (int) Math.pow(2.0, i_82_);
		}
		anInt10376++;
	}
}
