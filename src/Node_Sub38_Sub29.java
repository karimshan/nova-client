...
public class Node_Sub38_Sub29 extends Node_Sub38 {
	public static Class212 aClass212_10406 = new Class212("", 17);
	public static int anInt10405;
	public static int anInt10407;
	public static int anInt10408;
	public static int anInt10409;

	public static final int method2889(Class377_Sub1 class377_sub1, int i, int i_9_, boolean bool, int i_10_,
			Class377_Sub1 class377_sub1_11_, boolean bool_12_) {
		anInt10408++;
		if (i_10_ < 14)
	...
	public final int[] method2775(int i, int i_1_) {
		...
		if (aClass146_7460.aBoolean1819) {
			...
			for (int i_3_ = 0; (i_3_ ^ 0xffffffff) > (Class339_Sub7.anInt8728 ^ 0xffffffff); i_3_++) {
				...
				if ((i_4_ ^ 0xffffffff) < (anInt10410 ^ 0xffffffff) && i_4_ < 4096 + -anInt10410
						&& i_2_ > 2048 + -anInt10410 && i_2_ < anInt10410 + 2048) {
					int i_5_ = 2048 + -i_4_;
				...
				} else if ((anInt10410 ^ 0xffffffff) < (i_4_ ^ 0xffffffff)
						|| (i_4_ ^ 0xffffffff) < (-anInt10410 + 4096 ^ 0xffffffff)) {
					int i_8_ = 2048 - i_2_;
