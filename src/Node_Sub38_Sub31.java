...
public class Node_Sub38_Sub31 extends Node_Sub38 {
	public static boolean aBoolean10418 = false;
	public static Index aClass302_10422;
	public static long aLong10420;
	public static int anInt10416;
	public static int anInt10417;
	public static int anInt10419;
	public static int anInt10421;
	public static int anInt10423;
	...
	public static final void displayMode(int i) {
		anInt10419++;
	...
	@Override
	public final int[] method2775(int i, int i_8_) {
		if (i <= 107)
			displayMode(90);
		anInt10423++;
	...
	private final void method2891(int i, int i_0_, byte b) {
		...
		float f = (float) Math.atan2(-2048 + i_1_, -2048 + i_2_);
