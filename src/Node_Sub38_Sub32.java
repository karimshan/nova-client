...
public class Node_Sub38_Sub32 extends Node_Sub38 {
	public static BigInteger aBigInteger10430 = new BigInteger(
			...
			16);
	public static IncomingPacket aClass192_10433 = new IncomingPacket(29, 6);
	public static int anInt10427;
	public static int anInt10428;
	public static int anInt10429;
	public static int anInt10431;
	public static int anInt10434;
	public static int anInt10435;
	public static int anInt10436;

	public static final int method2894(int i, int i_15_, int i_16_, int i_17_) {
		anInt10435++;
		if (i_16_ != 929798380)
			return 77;
	...
	public static final void method2897(int i) {
	...
	private final void method2896(byte b) {
		anInt10434++;
		double d = Math.cos(anInt10426 / 4096.0F);
		anIntArray10432[0] = (int) (d * Math.sin(anInt10425 / 4096.0F) * 4096.0);
		if (b > -113)
			method2895(true);
		anIntArray10432[1] = (int) (4096.0 * (d * Math.cos(anInt10425 / 4096.0F)));
		anIntArray10432[2] = (int) (4096.0 * Math.sin(anInt10426 / 4096.0F));
