...
public class Node_Sub38_Sub33 extends Node_Sub38 {
	public static BufferedConnection aBufferedConnection10440;
	public static Class151 aClass151_10439 = new Class151(2, 4, 4, 0);
	public static long aLong10441;
	public static int anInt10437;
	public static int anInt10438;

	public static final void method2898(int i, int i_0_, int i_1_, byte[] bs, int i_2_, byte[] bs_3_, int i_4_, int i_5_,
			int i_6_) {
		anInt10437++;
		int i_7_ = -(i_5_ >> 2);
		i_5_ = -(i_5_ & 0x3);
	...
	@Override
	public final int[] method2775(int i, int i_11_) {
		anInt10438++;
		if (i <= 107)
			method2775(49, -21);
