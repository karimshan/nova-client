...
public class Node_Sub38_Sub36 extends Node_Sub38 {
	public static long aLong10462;
	public static int anInt10456;
	public static int anInt10460;
	public static int anInt10463;

	public static final void method2904(int i, BufferedStream buffer) {
	...
	@Override
	public final int[] method2775(int i, int i_4_) {
		anInt10460++;
		...
		if (aClass146_7460.aBoolean1819)
			for (int i_5_ = 0; Class339_Sub7.anInt8728 > i_5_; i_5_++) {
				...
				int i_14_;
				for (i_14_ = 0; i_12_ + i_13_ < 16384
						&& (anInt10457 ^ 0xffffffff) < (i_14_ ^ 0xffffffff); i_13_ = i_11_ * i_11_ >> 12) {
