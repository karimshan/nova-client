...
public class Node_Sub38_Sub37 extends Node_Sub38 {
	public static IncomingPacket aClass192_10465 = new IncomingPacket(105, -1);
	public static float aFloat10464;
	public static int anInt10467;
	public static int anInt10468;
	public static int anInt10469;
	public static int anInt10470;
	public static int anInt10471;
	public static int anInt10472;
	public static int anInt10473;
	public static int anInt10474;
	public static int anInt10475;
	public static int anInt10478;
	public static int anInt10481;
	public static Plane[] aPlaneArray10466;
	...
	public static final void method2907(int i, int i_7_, Class121 class121, int i_8_, int i_9_, int i_10_) {
		if (i_7_ != -14347)
			method2906((byte) -91);
		anInt10467++;
		if ((i_10_ ^ 0xffffffff) <= -2 && i_8_ >= 1
				&& (i_10_ ^ 0xffffffff) >= (Node_Sub54.GAME_SCENE_WDITH - 2 ^ 0xffffffff)
	...
	public static final void method2908(byte b, Node_Sub4 node_sub4, int i) {
		anInt10470++;
	...
	public static final boolean method2911(int i, byte b, int i_43_, int i_44_) {
		anInt10481++;
		...
		if ((i_45_ ^ 0xffffffff) > -51)
			return false;
		Node_Sub9_Sub1.anIntArray9686[0] = Node_Sub9_Sub1.anIntArray9686[0] * aa.anInt100 / i_45_
				+ Class290_Sub6.anInt8124;
		if (b != 1)
			return false;
		Node_Sub9_Sub1.anIntArray9686[2] = i_45_;
		Node_Sub9_Sub1.anIntArray9686[1] = Class219.anInt2624
				+ OutputStream_Sub2.anInt96 * Node_Sub9_Sub1.anIntArray9686[1] / i_45_;
		return true;
	}

	public static final void method2912(String string, boolean bool) {
		anInt10474++;
		if (string != null)
			if ((Node_Sub38_Sub14.anInt10242 ^ 0xffffffff) <= -201 && !Class64.aBoolean5046
					|| Node_Sub38_Sub14.anInt10242 >= 200)
				Class41.sendGameMessage(29459, GlobalMessage.aClass22_374.getMessage(Class35.language), 4);
			else {
				...
				if (string_46_ != null) {
					for (int i = 0; (Node_Sub38_Sub14.anInt10242 ^ 0xffffffff) < (i ^ 0xffffffff); i++) {
						...
						if (string_47_ != null && string_47_.equals(string_46_)) {
							Class41.sendGameMessage(29459, string + GlobalMessage.aClass22_401.getMessage(Class35.language), 4);
							return;
						}
					...
					for (int i = 0; (i ^ 0xffffffff) > (Class235.anInt5122 ^ 0xffffffff); i++) {
						...
						if (string_49_ != null && string_49_.equals(string_46_)) {
							Class41.sendGameMessage(29459, GlobalMessage.aClass22_406.getMessage(Class35.language) + string
									+ GlobalMessage.aClass22_407.getMessage(Class35.language), 4);
							return;
						}
					...
					if (Node_Sub25_Sub3.method2671(-13472, Player.get.realName).equals(string_46_))
						Class41.sendGameMessage(29459, GlobalMessage.aClass22_404.getMessage(Class35.language), 4);
					else {
						Class76.anInt1013++;
						if (bool != true)
							aFloat10464 = -0.48604336F;
						IncomingPacketHolder class123 = Class262_Sub23.method3213((byte) -100);
						Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, Node_Sub51.aClass318_7630,
	...
	@Override
	public final int[] method2775(int i, int i_3_) {
		anInt10475++;
