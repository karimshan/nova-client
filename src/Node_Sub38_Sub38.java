...
public class Node_Sub38_Sub38 extends Node_Sub38 {
	...
	public static Index index36;

	public static final Class169_Sub2_Sub1 method2913(int i, boolean bool, int i_0_, int i_1_, GLToolkit gltoolkit) {
		if (bool != false)
			return null;
		anInt10487++;
		...
		if (!gltoolkit.aBoolean6649)
			return new Class169_Sub2_Sub1(gltoolkit, i_1_, i_0_, i, Class320_Sub19.method3753(i_0_, -729073628),
					Class320_Sub19.method3753(i, -729073628));
		return new Class169_Sub2_Sub1(gltoolkit, 34037, i_1_, i_0_, i);
	}

	public static final void method2914(int i) {
		if (Node_Sub25_Sub4.aClass110Array10006 == null) {
			Node_Sub25_Sub4.aClass110Array10006 = LoadingBarStage.setStage((byte) 118);
			Class252.loadingBar = Node_Sub25_Sub4.aClass110Array10006[0];
			Class43.aLong663 = Class313.method3650(false);
		}
		anInt10491++;
		if (Class243.aClass340_3069 == null)
			Class124.method1525(53);
		LoadingBarStage class110 = Class252.loadingBar;
		if (i == -15103) {
			int i_2_ = ClientBackground.method1977(1);
			if (Class252.loadingBar == class110) {
				Node_Sub15_Sub12.aString9867 = Class252.loadingBar.aClass22_1379.getMessage(Class35.language);
				if (Class252.loadingBar.aBoolean1393)
					Class204.anInt2453 = Class252.loadingBar.anInt1383
							- -(i_2_ * (Class252.loadingBar.anInt1382 - Class252.loadingBar.anInt1383) / 100);
				if (Class252.loadingBar.aBoolean1387)
					Node_Sub15_Sub12.aString9867 += Class204.anInt2453 + "%";
			} else if (LoadingBarStage.aClass110_1411 == Class252.loadingBar) {
				Class243.aClass340_3069 = null;
				Class48.method478(3, (byte) 127);
			} else {
				Node_Sub15_Sub12.aString9867 = class110.aClass22_1389.getMessage(Class35.language);
				if (Class252.loadingBar.aBoolean1387)
					Node_Sub15_Sub12.aString9867 += class110.anInt1382 + "%";
				Class204.anInt2453 = class110.anInt1382;
				if (Class252.loadingBar.aBoolean1393 || class110.aBoolean1393)
					Class43.aLong663 = Class313.method3650(false);
			}
			if (Class243.aClass340_3069 != null) {
				Class243.aClass340_3069.method3954(Class204.anInt2453, Node_Sub15_Sub12.aString9867,
						Class252.loadingBar, 121, Class43.aLong663);
				if (Class235_Sub1.anInterface16Array8978 != null)
					for (int i_3_ = Class51_Sub1.anInt9064
							- -1; Class235_Sub1.anInterface16Array8978.length > i_3_; i_3_++)
						if (Class235_Sub1.anInterface16Array8978[i_3_].method58(27285) >= 100
								&& Class51_Sub1.anInt9064 == -1 + i_3_ && (Class151.anInt1843 ^ 0xffffffff) <= -2
							...
							if (Class51_Sub1.anInt9064 >= -1 + Class235_Sub1.anInterface16Array8978.length
									&& Class235_Sub1.anInterface16Array8978.length > 1)
								Class51_Sub1.anInt9064 = Class174.class250.method3092(false) ? 0 : -1;
						}
			}
		}
	}
	...
	public static final void method2916(int i) {
		anInt10489++;
		...
		if (Class218.aClass123_2566.aBoolean1580) {
			...
			if ((Class151.anInt1843 ^ 0xffffffff) == -12) {
				while (IComponentDefinitions.method4152(i ^ 0x6f753f36)) {
					Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(i ^ ~0x397f, Class338.aClass318_4184,
							Class218.aClass123_2566.isaacCipher);
					node_sub13.packet.writeByte(0);
					int i_6_ = node_sub13.packet.offset;
					StandardSprite.method1213(-2, node_sub13.packet);
					node_sub13.packet.method2217(node_sub13.packet.offset + -i_6_);
				...
				if (Class117.aNode_Sub7_1472 != null) {
					if (Class117.aNode_Sub7_1472.anInt7060 != -1) {
						Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, Class34.aClass318_528,
								Class218.aClass123_2566.isaacCipher);
						node_sub13.packet.writeShort(Class117.aNode_Sub7_1472.anInt7060);
						if (!Loader.DISABLE_USELESS_PACKETS)
					...
					Class117.aNode_Sub7_1472 = Animable.aClass193_5936.method1959((byte) -60,
							Class181.aClass197_2155.ipadress);
				...
				if (node_sub5 != null || TemporaryItemDefinition.aLong562 < Class313.method3650(false) + -2000L) {
					...
					int i_7_ = 0;
					for (Node_Sub5 node_sub5_8_ = (Node_Sub5) Node_Sub38_Sub35.aClass312_10452.method3613(
							65280); node_sub5_8_ != null; node_sub5_8_ = (Node_Sub5) Node_Sub38_Sub35.aClass312_10452
									.method3620(16776960)) {
						if (node_sub13 != null && (-i_7_ + node_sub13.packet.offset ^ 0xffffffff) <= -241)
							break;
						...
						if (Class99.anInt1283 != i_10_ || (i_9_ ^ 0xffffffff) != (Class340.anInt4217 ^ 0xffffffff)) {
							if (node_sub13 == null) {
								Class57.anInt842++;
								node_sub13 = PacketDecoder.sendOutgoingOPCode(i + -14976, Class277_Sub1.aClass318_8050,
										Class218.aClass123_2566.isaacCipher);
								node_sub13.packet.writeByte(0);
								i_7_ = node_sub13.packet.offset;
							}
							int i_11_ = -Class99.anInt1283 + i_10_;
							Class99.anInt1283 = i_10_;
							int i_12_ = i_9_ - Class340.anInt4217;
							Class340.anInt4217 = i_9_;
							int i_13_ = (int) ((node_sub5_8_.method2273((byte) -69) + -TemporaryItemDefinition.aLong562)
									/ 20L);
							if (i_13_ >= 8 || i_11_ < -32 || i_11_ > 31 || (i_12_ ^ 0xffffffff) > 31 || i_12_ > 31) {
								if (i_13_ < 32 && i_11_ >= -128 && i_11_ <= 127 && i_12_ >= -128
										&& (i_12_ ^ 0xffffffff) >= -128) {
									node_sub13.packet.writeByte(128 - -i_13_);
									i_11_ += 128;
									i_12_ += 128;
									node_sub13.packet.writeShort(i_12_ + (i_11_ << 8));
								} else if (i_13_ >= 32) {
									node_sub13.packet.writeShort(57344 - -i_13_);
									if ((i_10_ ^ 0xffffffff) == -2 || i_9_ == -1)
										node_sub13.packet.writeInt(-2147483648);
									else
										node_sub13.packet.writeInt(i_10_ | i_9_ << 16);
								} else {
									node_sub13.packet.writeByte(i_13_ + 192);
									if ((i_10_ ^ 0xffffffff) != -2 && (i_9_ ^ 0xffffffff) != 0)
										node_sub13.packet.writeInt(i_9_ << 16 | i_10_);
									else
										node_sub13.packet.writeInt(-2147483648);
								}
							} else {
								i_11_ += 32;
								i_12_ += 32;
								node_sub13.packet.writeShort((i_13_ << 12) + (i_11_ << 6) + i_12_);
							}
							TemporaryItemDefinition.aLong562 = node_sub5_8_.method2273((byte) -69);
						}
					}
					if (node_sub13 != null) {
						node_sub13.packet.method2217(-i_7_ + node_sub13.packet.offset);
						if (!Loader.DISABLE_USELESS_PACKETS)
				...
				if (node_sub5 != null) {
					...
					Animable.anInt5942++;
					int i_17_ = (int) l;
					Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, za_Sub2.aClass318_10512,
							Class218.aClass123_2566.isaacCipher);
					node_sub13.packet.writeShortLE128(i_16_ << 15 | i_17_);
					node_sub13.packet.writeIntV1(i_15_ | i_14_ << 16);
					if (!Loader.DISABLE_USELESS_PACKETS)
						Class218.aClass123_2566.sendPacket(126, node_sub13);
				}
				if (Class320_Sub8.anInt8281 > 0) {
					Animable_Sub2.anInt9111++;
					Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, Node_Sub38_Sub9.KEY_TYPED,
							Class218.aClass123_2566.isaacCipher);
					node_sub13.packet.writeByte(Class320_Sub8.anInt8281 * 3);
					for (int i_18_ = 0; i_18_ < Class320_Sub8.anInt8281; i_18_++) {
						...
						node_sub13.packet.writeByte(interface21.method75(-29764));
						node_sub13.packet.writeShort((int) l);
					}
					if (!Loader.DISABLE_USELESS_PACKETS)
				...
				if (Node_Sub25_Sub1.aBoolean9950 && IComponentDefinitions.anInt4725 <= 0) {
					...
					Class148.anInt1826++;
					Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, Class128.aClass318_1651,
							Class218.aClass123_2566.isaacCipher);
					node_sub13.packet.writeShort((int) Class257.aFloat3243 >> 3);
					node_sub13.packet.writeShort((int) Node_Sub12.aFloat5450 >> 3);
					if (!Loader.DISABLE_USELESS_PACKETS)
						Class218.aClass123_2566.sendPacket(126, node_sub13);
				}
				if (Class51.aBoolean5331 == !Class34.aBoolean531) {
					...
					Class240.anInt2939++;
					Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, Client.aClass318_8037,
							Class218.aClass123_2566.isaacCipher);
					node_sub13.packet.writeByte(Class51.aBoolean5331 ? 1 : 0);
					if (!Loader.DISABLE_USELESS_PACKETS)
						Class218.aClass123_2566.sendPacket(127, node_sub13);
				}
				if (!Class269.aBoolean3472) {
					Class243.anInt3071++;
					Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(i ^ ~0x397f, Animable_Sub3_Sub1.aClass318_11004,
							Class218.aClass123_2566.isaacCipher);
					node_sub13.packet.writeByte(0);
					int i_19_ = node_sub13.packet.offset;
					BufferedStream buffer = Class213.aNode_Sub27_2512.method2696(i ^ 0x156f);
					node_sub13.packet.writeBytes(buffer.offset, buffer.buffer, 0);
					node_sub13.packet.method2217(-i_19_ + node_sub13.packet.offset);
					if (!Loader.DISABLE_USELESS_PACKETS)
						Class218.aClass123_2566.sendPacket(127, node_sub13);
				...
				if (Class151.anInt1843 == 11) {
					...
					if ((Class218.aClass123_2566.anInt1578 ^ 0xffffffff) < -751)
						...
						if (aa.anInt101 != 0) {
							if ((aa.anInt101 ^ 0xffffffff) == -2
									&& Class191.method1944(Class200_Sub2.anInt4935, i ^ 0x38b7)) {
							...
							if (aa.anInt101 == 3) {
								...
								if ((Class214.aClass262Array2528.length ^ 0xffffffff) < (Class320_Sub19.anInt8385
										^ 0xffffffff))
									do {
										...
										if ((aa.anInt101 ^ 0xffffffff) != -4)
											break;
									} while ((++Class320_Sub19.anInt8385
											^ 0xffffffff) > (Class214.aClass262Array2528.length ^ 0xffffffff));
								if ((aa.anInt101 ^ 0xffffffff) == -4)
									for (Class206 class206 : Class121.aClass206Array1529) {
						...
						for (int i_22_ = Class24.aClass275_442.method3334(-114, true); (i_22_
								^ 0xffffffff) != 0; i_22_ = Class24.aClass275_442.method3334(i ^ ~0x3891, false)) {
							Class188_Sub2_Sub1.method1907(i_22_, (byte) 108);
							Class75.anIntArray1005[Node_Sub30.method2723(Class341.anInt4231++, 31)] = i_22_;
						}
						for (CacheNode_Sub2 cachenode_sub2 = Class48
								.method479(1); cachenode_sub2 != null; cachenode_sub2 = Class48.method479(1)) {
									...
									if (i_23_ != 3) {
										if ((i_23_ ^ 0xffffffff) != -5) {
											if (i_23_ == 5) {
												...
												if ((widget.anInt4773 ^ 0xffffffff) != (cachenode_sub2.itemId
														^ 0xffffffff)) {
													if ((cachenode_sub2.itemId ^ 0xffffffff) == 0)
														widget.anAnimator4755 = null;
													else {
														if (widget.anAnimator4755 == null)
															widget.anAnimator4755 = new FixedAnimator();
														widget.anAnimator4755.method249(true, cachenode_sub2.itemId);
													}
													widget.anInt4773 = cachenode_sub2.itemId;
												...
												if (i_23_ != 7) {
													if ((i_23_ ^ 0xffffffff) != -9) {
														if ((i_23_ ^ 0xffffffff) == -10) {
															IComponentDefinitions widget = Class76.method771((byte) 107,
																	(int) l);
															if ((cachenode_sub2.itemId
																	^ 0xffffffff) != (widget.anInt4718 ^ 0xffffffff)
																	|| cachenode_sub2.itemAmount != widget.anInt4831) {
																widget.anInt4831 = cachenode_sub2.itemAmount;
																widget.anInt4718 = cachenode_sub2.itemId;
																ClientScript.method2321(i ^ ~0x38fe, widget);
															}
														} else if ((i_23_ ^ 0xffffffff) == -11) {
															IComponentDefinitions widget = Class76.method771((byte) 107,
																	(int) l);
															if (cachenode_sub2.itemId != widget.anInt4681
																	|| (widget.anInt4811
																			^ 0xffffffff) != (cachenode_sub2.itemAmount
																					^ 0xffffffff)
																	|| cachenode_sub2.anInt9429 != widget.anInt4682) {
																widget.anInt4681 = cachenode_sub2.itemId;
																widget.anInt4811 = cachenode_sub2.itemAmount;
																widget.anInt4682 = cachenode_sub2.anInt9429;
																ClientScript.method2321(i + -14591, widget);
															}
														} else if ((i_23_ ^ 0xffffffff) != -12) {
															if (i_23_ == 12) {
																IComponentDefinitions widget = Class76
																		.method771((byte) 107, (int) l);
																int i_24_ = cachenode_sub2.itemId;
																if (widget != null
																		&& (widget.type ^ 0xffffffff) == -1) {
																	if ((i_24_ ^ 0xffffffff) < (widget.anInt4691
																			- widget.anInt4695 ^ 0xffffffff))
																...
																if ((i_23_ ^ 0xffffffff) == -16) {
																	Node_Sub15_Sub4.anInt9798 = cachenode_sub2.itemAmount;
																	Class144.aBoolean1791 = true;
																	Class359.anInt4467 = cachenode_sub2.itemId;
																} else if (i_23_ == 16) {
																	IComponentDefinitions widget = Class76
																			.method771((byte) 107, (int) l);
																	widget.anInt4759 = cachenode_sub2.itemId;
																} else if (i_23_ != 20) {
																	if (i_23_ != 21) {
																		if (i_23_ != 17) {
																			if ((i_23_ ^ 0xffffffff) != -19) {
																				if (i_23_ == 19) {
																					...
																					int i_25_ = (int) (l >> 32);
																					widget.method4140(
																							(short) cachenode_sub2.itemId,
																							-48, i_25_,
																							(short) cachenode_sub2.itemAmount);
																				}
																			} else {
																				IComponentDefinitions widget = Class76
																						.method771((byte) 107, (int) l);
																			...
																			IComponentDefinitions widget = Class76
																					.method771((byte) 107, (int) l);
																			widget.anInt4694 = cachenode_sub2.itemId;
																		}
																	} else {
																		IComponentDefinitions widget = Class76
																				.method771((byte) 107, (int) l);
																		widget.aBoolean4782 = (cachenode_sub2.itemId
																				^ 0xffffffff) == -2;
																	}
																} else {
																	IComponentDefinitions widget = Class76
																			.method771((byte) 107, (int) l);
																	widget.aBoolean4832 = cachenode_sub2.itemId == 1;
																}
															} else {
																IComponentDefinitions widget = Class76
																		.method771((byte) 107, (int) l);
																widget.anInt4820 = cachenode_sub2.itemId;
															}
														} else {
															IComponentDefinitions widget = Class76.method771((byte) 107,
																	(int) l);
															widget.aByte4851 = (byte) 0;
															widget.anInt4762 = widget.anInt4816 = cachenode_sub2.itemAmount;
															widget.anInt4679 = widget.anInt4850 = cachenode_sub2.itemId;
														...
														IComponentDefinitions widget = Class76.method771((byte) 107,
																(int) l);
														if ((cachenode_sub2.itemId ^ 0xffffffff) != (widget.anInt4815
																^ 0xffffffff)
																|| cachenode_sub2.itemAmount != widget.anInt4821
																|| (widget.anInt4787
																		^ 0xffffffff) != (cachenode_sub2.anInt9429
																				^ 0xffffffff)) {
															widget.anInt4815 = cachenode_sub2.itemId;
															widget.anInt4821 = cachenode_sub2.itemAmount;
															widget.anInt4787 = cachenode_sub2.anInt9429;
															if ((widget.anInt4718 ^ 0xffffffff) != 0)
																if ((widget.anInt4800 ^ 0xffffffff) < -1)
																	widget.anInt4787 = widget.anInt4787 * 32
																			/ widget.anInt4800;
																else if ((widget.anInt4693 ^ 0xffffffff) < -1)
																	widget.anInt4787 = 32 * widget.anInt4787
																			/ widget.anInt4693;
															ClientScript.method2321(i ^ ~0x38fe, widget);
														}
													}
													...
													IComponentDefinitions widget = Class76.method771((byte) 107,
															(int) l);
													boolean bool = (cachenode_sub2.itemId ^ 0xffffffff) == -2;
												...
												int i_27_ = cachenode_sub2.itemId;
											...
											IComponentDefinitions widget = Class76.method771((byte) 107, (int) l);
											int i_32_ = cachenode_sub2.itemId;
											int i_33_ = cachenode_sub2.itemAmount;
											int i_34_ = cachenode_sub2.anInt9429;
											if (i_32_ != widget.modelType || i_33_ != widget.anInt4864
													|| i_34_ != widget.anInt4683) {
										...
										IComponentDefinitions widget = Class76.method771((byte) 107, (int) l);
										if (!cachenode_sub2.text.equals(widget.aString4790)) {
											widget.aString4790 = cachenode_sub2.text;
											ClientScript.method2321(i ^ ~0x38fe, widget);
										}
									}
								} else {
									Node_Sub38_Sub3.aStringArray10105[(int) l] = cachenode_sub2.text;
									CacheNode_Sub10.anIntArray9520[Node_Sub30.method2723(31,
											Class244.anInt3083++)] = (int) l;
								}
							} else {
								Class320_Sub22.anIntArray8417[(int) l] = cachenode_sub2.itemId;
								Class331.aBoolean4129 |= FileOnDisk.aBooleanArray1332[(int) l];
								Node_Sub38_Sub11.anIntArray10217[Node_Sub30.method2723(Class36.anInt548++,
										31)] = (int) l;
							}
						}
						...
						if (FileOnDisk.aBoolean1319) {
							Class314.anInt4016++;
							Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(i ^ ~0x397f, Class69.aClass318_941,
									Class218.aClass123_2566.isaacCipher);
							node_sub13.packet.writeIntV2(Class326.anInt4098
									| (CacheNode_Sub16_Sub2.anInt11087 << 28 | Class269.anInt3473 << 14));
						...
						for (;;) {
							...
							if ((widget.anInt4687 ^ 0xffffffff) <= -1) {
								...
								if (widget_35_ == null || widget_35_.aWidgetArray4804 == null
						...
						for (;;) {
							...
							if ((widget.anInt4687 ^ 0xffffffff) <= -1) {
								...
								if (widget_36_ == null || widget_36_.aWidgetArray4804 == null
										|| (widget.anInt4687 ^ 0xffffffff) <= (widget_36_.aWidgetArray4804.length
												^ 0xffffffff)
						...
						for (;;) {
							...
							if (widget.anInt4687 >= 0) {
								...
								if (widget_37_ == null || widget_37_.aWidgetArray4804 == null
										|| (widget_37_.aWidgetArray4804.length ^ 0xffffffff) >= (widget.anInt4687
												^ 0xffffffff)
						...
						if ((Player.rights ^ 0xffffffff) < -1
								&& Class175.keyStrokes.isKeyHeld(i ^ 0x38a0, 82)
								&& Class175.keyStrokes.isKeyHeld(-71, 81)
								&& (Class339_Sub8.anInt8739 ^ 0xffffffff) != -1) {
							int i_38_ = -Class339_Sub8.anInt8739 + Player.get.plane;
							if (i_38_ >= 0) {
								if (i_38_ > 3)
									i_38_ = 3;
							} else
								i_38_ = 0;
							Class331.method3843(false, i_38_,
									Player.get.scenePositionYQueue[0] + Class320_Sub4.gameSceneBaseY,
									Node_Sub53.gameSceneBaseX - -Player.get.scenePositionXQueue[0]);
						}
						...
						if (Class331.aBoolean4129
								&& Animable_Sub2_Sub1.aLong10630 < Class313.method3650(false) - 60000L)
							Class144.method1631((byte) 123);
						for (EntityNode_Sub3_Sub1 entitynode_sub3_sub1 = (EntityNode_Sub3_Sub1) Class97.aClass103_1277
								.method1113(
										(byte) 100); entitynode_sub3_sub1 != null; entitynode_sub3_sub1 = (EntityNode_Sub3_Sub1) Class97.aClass103_1277
												.method1108(73))
							if (Class313.method3650(false) / 1000L + -5L > entitynode_sub3_sub1.anInt9162) {
								if ((entitynode_sub3_sub1.aShort9164 ^ 0xffffffff) < -1)
									Class28.method331(
											entitynode_sub3_sub1.aString9156
													+ GlobalMessage.aClass22_382.getMessage(Class35.language),
											"", -37, 0, "", "", 5);
								if (entitynode_sub3_sub1.aShort9164 == 0)
									Class28.method331(
											entitynode_sub3_sub1.aString9156
													+ GlobalMessage.aClass22_383.getMessage(Class35.language),
											"", 99, 0, "", "", 5);
						...
						if ((Class218.aClass123_2566.anInt1579 ^ 0xffffffff) < -51) {
							Class365.anInt4524++;
							Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(i + -14976, Class224.OUTCOMMING_PACKET_16,
									Class218.aClass123_2566.isaacCipher);
							Class218.aClass123_2566.sendPacket(126, node_sub13);
						}
	...
	@Override
	public final int[] method2775(int i, int i_51_) {
		anInt10488++;
	...
	@Override
	public final int[][] method2778(int i, boolean bool) {
		anInt10493++;
		if (bool != true)
			anInt10492 = 36;
