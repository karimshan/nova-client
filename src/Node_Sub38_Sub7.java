...
public class Node_Sub38_Sub7 extends Node_Sub38 {
	...
	public static int anInt10152;
	public static int anInt10153 = 0;
	public static int anInt10154;
	public static int anInt10158;
	public static int anInt10159;
	public static int[] anIntArray10143;
	public static int[] anIntArray10150;
	static {
	...
	public static final void method2806(byte b) {
		anInt10152++;
	...
	public static final int method2809(int i, int i_75_, int i_76_, int i_77_) {
		if (i_75_ != -29754)
		...
		int i_78_ = i_77_ >> 9;
		int i_79_ = i_76_ >> 9;
		if ((i_78_ ^ 0xffffffff) > -1 || (i_79_ ^ 0xffffffff) > -1 || -1 + Node_Sub54.GAME_SCENE_WDITH < i_78_
				|| Class377_Sub1.GAME_SCENE_HEIGHT + -1 < i_79_)
			return 0;
		int i_80_ = i;
	...
	public static final boolean method2810(Mobile mobile, boolean bool) {
		boolean bool_81_ = Class320_Sub10.aPlaneArray8300 == Class368.aPlaneArray4548;
		int i = 0;
		short s = 0;
		byte b = 0;
		mobile.method845(86);
		if (mobile.aShort9119 < 0 || mobile.aShort9120 < 0 || mobile.aShort9130 >= Class328.anInt4115
				|| mobile.aShort9124 >= GameMessage.anInt7623)
			return false;
		short s_82_ = 0;
		for (int i_83_ = mobile.aShort9119; i_83_ <= mobile.aShort9130; i_83_++)
			for (int i_84_ = mobile.aShort9120; i_84_ <= mobile.aShort9124; i_84_++) {
				...
				if (class261 != null) {
					...
					if (!bool && class261.anAnimable_Sub1_3317 != null
							&& class261.anAnimable_Sub1_3317.aShort9102 > s_82_)
	...
	public static final String method2811(boolean bool, int i, int i_90_, boolean bool_91_) {
		anInt10154++;
	...
	@Override
	public final int[] method2775(int i, int i_1_) {
		anInt10159++;
		...
		if (aClass146_7460.aBoolean1819) {
			...
			Random random = new Random(anInt10147);
			for (;;) {
					...
					if ((i_22_ ^ 0xffffffff) != (i_7_ ^ 0xffffffff)) {
						...
						for (int i_30_ = 0; i_24_ >= i_30_; i_30_++) {
							...
							if ((i_32_ ^ 0xffffffff) != (i_21_ ^ 0xffffffff)) {
								...
								method2807(is_2_, i_21_ + -i_32_, random, i_32_, i_5_ + i_35_, -i_35_ + i_36_,
										(byte) -58);
							}
						}
					}
					...
					if ((i_58_ ^ 0xffffffff) > (i_55_ ^ 0xffffffff)) {
						...
						if (anInt10140 == 0)
							for (int i_61_ = 0; i_54_ > i_61_; i_61_++) {
								...
								is_59_[Node_Sub30.method2723(i_61_ + i_43_,
										Class303.anInt3824)] = is_59_[Node_Sub30.method2723(Class303.anInt3824,
												i_44_ + (i_43_ - i_61_) - 1)] = i_62_ * i_60_ >> 12;
							}
						else
							for (int i_63_ = 0; i_54_ > i_63_; i_63_++) {
								int i_64_ = i_63_ * i_45_ / i_54_;
								is_59_[Node_Sub30.method2723(Class303.anInt3824,
										i_63_ + i_43_)] = is_59_[Node_Sub30.method2723(Class303.anInt3824,
												-i_63_ + i_43_ - (-i_44_ - -1))] = i_60_ > i_64_ ? i_64_ : i_60_;
							}
						...
						if ((i_66_ ^ 0xffffffff) > (i_55_ ^ 0xffffffff)) {
							...
							if (anInt10140 != 0)
								for (int i_68_ = 0; (i_54_ ^ 0xffffffff) < (i_68_ ^ 0xffffffff); i_68_++) {
									...
									is_59_[Node_Sub30.method2723(Class303.anInt3824,
											i_43_ + i_68_)] = is_59_[Node_Sub30.method2723(
													i_43_ + i_44_ + (-i_68_ + -1), Class303.anInt3824)] = i_67_ > i_69_
															? i_69_ : i_67_;
								}
							else
								for (int i_70_ = 0; i_70_ < i_54_; i_70_++) {
									int i_71_ = i_45_ * i_70_ / i_54_;
									is_59_[Node_Sub30.method2723(i_43_ - -i_70_,
											Class303.anInt3824)] = is_59_[Node_Sub30.method2723(
													-1 + (-i_70_ + (i_44_ + i_43_)),
													Class303.anInt3824)] = i_67_ * i_71_ >> 12;
								}
							...
							for (int i_73_ = 0; (i_73_ ^ 0xffffffff) > (i_54_ ^ 0xffffffff); i_73_++)
								is_59_[Node_Sub30.method2723(Class303.anInt3824,
										i_43_ - -i_73_)] = is_59_[Node_Sub30.method2723(Class303.anInt3824,
												-1 + (-i_73_ + (i_44_ + i_43_)))] = i_73_ * i_45_ / i_54_;
