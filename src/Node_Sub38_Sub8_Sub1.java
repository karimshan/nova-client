...
public class Node_Sub38_Sub8_Sub1 extends Node_Sub38_Sub8 {
	public static int anInt11095;
	public static int anInt11096;
	public static int anInt11097;

	public static final void method2817(int[] is, byte b, int[] is_6_) {
	...
	public static final void method2818(int i, String string) {
		anInt11097++;
		if (string != null) {
			...
			if (i >= 2 && string_8_ != null)
				for (int i_9_ = 0; i_9_ < Node_Sub38_Sub14.anInt10242; i_9_++) {
					...
					if (Class310.method3601(string, string_11_, 30195, string_10_, string_8_)) {
						...
						for (int i_12_ = i_9_; (Node_Sub38_Sub14.anInt10242 ^ 0xffffffff) < (i_12_
								^ 0xffffffff); i_12_++) {
							...
							EntityNode_Sub3_Sub1.aStringArray9157[i_12_] = EntityNode_Sub3_Sub1.aStringArray9157[i_12_
									+ 1];
						...
						Class18.anInt305++;
						IncomingPacketHolder class123 = Class262_Sub23.method3213((byte) -76);
						Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, Node_Sub38_Sub6.aClass318_10135,
