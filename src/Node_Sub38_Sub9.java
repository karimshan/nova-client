...
public class Node_Sub38_Sub9 extends Node_Sub38 {
	public static boolean aBoolean10191;
	public static OutgoingPacket KEY_TYPED;
	public static int anInt10177;
	public static int anInt10178;
	public static int anInt10179;
	public static int anInt10181;
	public static int anInt10187;
	public static int anInt10189;
	public static int anInt10192;
	public static short[] aShortArray10186 = { 2, 22, 52, 30, 53, 9, 51, 15 };
	static {
		KEY_TYPED = new OutgoingPacket(68, -1);
		aBoolean10191 = false;
		anInt10192 = 0;
	}

	public static final void method2820(boolean bool) {
		anInt10177++;
	...
	public static final void method2822(Index class302, int i) {
		anInt10189++;
		Packet.anInt9386 = i;
		Animable_Sub3_Sub1.anInt11012 = 0;
		Animable_Sub2.aClass103_9116 = new Class103();
		NPCMasks.anEntityNode_Sub3_Sub2_Sub1Array3596 = new EntityNode_Sub3_Sub2_Sub1[1024];
