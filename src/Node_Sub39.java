...
public class Node_Sub39 extends Node {
	public static Class151 aClass151_7493;
	public static OutgoingPacket aClass318_7486 = new OutgoingPacket(44, -1);
	public static Class369[] aClass369Array7497;
	public static int anInt7471;
	...
	public static int[] routeFinderXArray = new int[4096];
	static {
	...
	public static final void method2921(boolean bool, int i, int i_0_, int i_1_, IComponentDefinitions widget) {
		anInt7471++;
		...
		if (Class54.aBoolean817 && ((ConnectionDecoder.method113(widget).settingsHash ^ 0xffffffff) != -1 || widget.type == 0))
		...
		if (bool && widget.anObjectArray4777 != null
				&& ((i_2_ ^ 0xffffffff) != (widget.anInt4809 ^ 0xffffffff) || i_3_ != widget.anInt4695)) {
	...
	public static final void method2922(boolean bool) {
		anInt7473++;
		if (bool == false)
			for (Node_Sub3 node_sub3 = (Node_Sub3) Class56.aHashTable839
					.method1516(bool); node_sub3 != null; node_sub3 = (Node_Sub3) Class56.aHashTable839.method1520(71))
	...
	public final void method2920(BufferedStream buffer, int i) {
		buffer.writeByte(5);
		anInt7479++;
	...
	public final int method2923(byte b) {
		anInt7472++;
		if (b != 66)
			return 15;
		int i = 23;
