...
public class Node_Sub4 extends Node {
	public static final Node_Sub4 method2173(Index class302, int i, int i_0_) {
				...
				while (class27.anIntArray459[i_3_] == i_4_) {
					...
					if (i_6_ == 144) {
						...
						if (i_14_ > 0) {
							...
							Node_Sub51 node_sub51 = (Node_Sub51) aHashTable6950.getNode(3512, i_15_);
							if (node_sub51 == null) {
								node_sub51 = new Node_Sub51(new byte[128]);
								aHashTable6950.put(i_15_, node_sub51, -123);
							}
