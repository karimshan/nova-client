...
public class Node_Sub41 extends Node {
	public static Class114 aClass114_7519 = new Class114(8);
	public static Class129 aClass129_7515 = new Class129("RC", 1);
	public static int anInt7516;
	public static int anInt7517;
	...
	public static final int method2931(byte b) {
		anInt7516++;
		boolean bool = false;
		...
		if (Class240.aSignLink2946.aBoolean4005 && !Class240.aSignLink2946.aBoolean3985) {
			bool = true;
			if (Node_Sub23.aNode_Sub39_7201.anInt7484 < 512
		...
		if ((i_4_ ^ 0xffffffff) < (i_3_ ^ 0xffffffff))
			return RSCanvas.method125(3, i_4_, (byte) -45);
		return RSCanvas.method125(1, i_3_, (byte) -45);
	}

	public static final boolean method2932(int i, int i_6_, int i_7_) {
		anInt7517++;
		if (i > -59)
			method2932(111, -62, 11);
		if (!CacheNode_Sub11.method2336(-1, i_7_, i_6_))
			return false;
		if (Class46.method470(i_7_, -77, i_6_) | (0x9000 & i_6_ ^ 0xffffffff) != -1
				| Class234.method2150(i_7_, 256, i_6_))
			return true;
		return (0x37 & i_7_ ^ 0xffffffff) == -1 & (Class278.method3367(i_7_, i_6_, (byte) -119)
				| (0x2000 & i_6_ ^ 0xffffffff) != -1 | Class320_Sub9.method3713(122, i_6_, i_7_));
	}
