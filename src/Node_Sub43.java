...
public class Node_Sub43 extends Node {
	public static Class312 aClass312_7541;
	public static int anInt7528;
	public static int anInt7529;
	public static int anInt7530;
	...
	public static int[][] anIntArrayArray7538 = { { 6, 6 }, { 6, 6 }, { 6, 5, 5 }, { 5, 6, 5 }, { 5, 5, 6 }, { 6, 5, 5 },
			{ 5, 0, 4, 1 }, { 7, 7, 1, 2 }, { 7, 1, 2, 7 }, { 8, 9, 4, 0, 8, 9 }, { 0, 8, 9, 8, 9, 4 },
			{ 11, 0, 10, 11, 4, 2 }, { 6, 6 }, { 7, 7, 1, 2 }, { 7, 7, 1, 2 } };

	public static final void method2941(int i, long l) {
		anInt7536++;
		if (i == 6)
	...
	public final int[] method2937(int i) {
		if (i != 8669)
			return null;
	...
	public final void method2938(byte b, Class24 class24) {
		anInt7543++;
		if (b >= -69)
			aByte7540 = (byte) 51;
	...
	public final void method2942(int i, int i_4_) {
		anInt7534++;
		anInt7531--;
		if (anInt7531 == 0)
	...
	public final int method2943(String string, byte b) {
		anInt7529++;
