...
public class Node_Sub47 extends Node {
	public static Class312 aClass312_7558 = new Class312();
	public static int anInt7557;
	...
	public static final int method2952(boolean bool, int i) {
		anInt7585++;
		if (bool != false)
			return -87;
		return 0x7f & i;
	...
	public static final void method2953(int i, int i_2_, boolean bool, int i_3_, int i_4_, float[] fs, int i_5_) {
		anInt7557++;
	...
	public final void method2951(int i) {
		anInt7577++;
		if (i == 918119625) {
			int i_0_ = anInt7564;
			...
			if (anObjectDefinition7562 == null) {
				if (aNpc7583 != null) {
					...
					if (i_1_ != i_0_) {
						anInt7564 = i_1_;
						NPCDefinition npcdefinition = aNpc7583.defs;
						...
						if (npcdefinition != null) {
							...
							aBoolean7580 = aNpc7583.defs.aBoolean2883;
							anInt7571 = 256;
							anInt7572 = 256;
				...
				ObjectDefinition objectdefinition = anObjectDefinition7562.method3038(13, aa.anInt101 != 3
			...
			if (((anInt7564 ^ 0xffffffff) != (i_0_ ^ 0xffffffff) || !aBoolean7580 == bool)
