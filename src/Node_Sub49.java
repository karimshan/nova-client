...
public class Node_Sub49 extends Node {
	...
	public static Class242[] aClass242Array7611;
	...
	public static final Node_Sub49 method2954(Index class302, int i) {
	...
	public static final int method2956(int i) {
		int i_4_ = 0;
		int i_5_ = 0;
		int i_6_;
	...
	public static final Node_Sub49 method2962(Index class302, int i, int i_110_) {
		if (!method2961(class302)) {
			class302.requestDownload(i_110_, i, 0);
			return null;
		}
	...
	public static final float method2963(int i) {
		int i_111_ = i & 0x1fffff;
		int i_112_ = i & ~0x7fffffff;
		int i_113_ = (i & 0x7fe00000) >> 21;
		if (i_112_ != 0)
			i_111_ = -i_111_;
		return (float) (i_111_ * Math.pow(2.0, i_113_ - 788));
	}
	...
	public static final int method2965() {
	...
	public final Node_Sub45_Sub1 method2958(int[] is) {
		if (is != null && is[0] <= 0)
			return null;
	...
	private final float[] method2959(int i) {
		...
		if (bool_24_)
			...
			for (int i_75_ = 0; i_75_ < i_31_; i_75_++) {
				fs[i_75_] = fs[2 * i_75_ + i_30_] * fs_36_[2 * i_75_]
						+ fs[2 * i_75_ + 1 + i_30_] * fs_36_[2 * i_75_ + 1];
				fs[i_30_ - 1 - i_75_] = fs[2 * i_75_ + i_30_] * fs_36_[2 * i_75_ + 1]
						- fs[2 * i_75_ + 1 + i_30_] * fs_36_[2 * i_75_];
			}
			...
			for (int i_80_ = i_16_; i_80_ < i_17_; i_80_++) {
				float f = (float) Math.sin((i_80_ - i_16_ + 0.5) / i_18_ * 0.5 * 3.141592653589793);
				aFloatArray7601[i_80_] *= (float) Math.sin(1.5707963267948966 * f * f);
			}
			for (int i_81_ = i_19_; i_81_ < i_20_; i_81_++) {
				float f = (float) Math
						.sin((i_81_ - i_19_ + 0.5) / i_21_ * 0.5 * 3.141592653589793 + 1.5707963267948966);
				aFloatArray7601[i_81_] *= (float) Math.sin(1.5707963267948966 * f * f);
			}
		}
		float[] fs = null;
		if (anInt7619 > 0) {
