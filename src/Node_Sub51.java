...
public class Node_Sub51 extends Node {
	public static OutgoingPacket aClass318_7630 = new OutgoingPacket(51, -1);
	public static Class61 aClass61_7628 = new Class61(4);
	public static int anInt7629;
	public static int anInt7632;
	public static int anInt7633 = -1;
	...
	public static final void method2968(int i, int i_0_) {
	...
	public static final int method2969(Class377_Sub1 class377_sub1, boolean bool, Class377_Sub1 class377_sub1_1_, int i,
			int i_2_) {
		anInt7632++;
		if ((i ^ 0xffffffff) == -2) {
		...
		if (i == 2)
			return r.method2359(class377_sub1.method4131((byte) -97).aString678, (byte) -4, Class35.language,
					class377_sub1_1_.method4131((byte) -97).aString678);
		if ((i ^ 0xffffffff) == -4) {
