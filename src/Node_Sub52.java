...
public class Node_Sub52 extends Node {
	public static IncomingPacket aClass192_7650 = new IncomingPacket(63, 5);
	public static Class244[] aClass244Array7654;
	public static Class68 aClass68_7639 = new Class68(1);
	public static GLSprite[] aGLSpriteArray7655;
	public static Mobile[] aMobileArray7648;
	public static int anInt7634;
	public static int anInt7637;
	public static int anInt7638;
	public static int anInt7640;
	public static int anInt7644;
	...
	public static final int method2972(boolean bool) {
		if (bool != false)
			aClass244Array7654 = null;
		anInt7638++;
		if (Class58.aWidget861 == null) {
			...
			if (!Class194_Sub3_Sub1.aBoolean9375) {
				if (i > Node_Sub6.anInt7043 && Node_Sub6.anInt7043 + Class362.anInt4492 > i) {
					int i_3_ = -1;
					for (int i_4_ = 0; i_4_ < Class315.menuOptionCount; i_4_++)
						if (!Node_Sub38_Sub5.aBoolean10130) {
							int i_5_ = ConnectionDecoder.anInt5481 + 31 + 16 * (-i_4_ + (Class315.menuOptionCount + -1));
							if (i_2_ > -13 + i_5_ && i_5_ + 3 >= i_2_)
								i_3_ = i_4_;
						} else {
							int i_6_ = 16 * (-1 + (Class315.menuOptionCount - i_4_)) + 33 + ConnectionDecoder.anInt5481;
					...
					if ((i_3_ ^ 0xffffffff) != 0) {
						...
						for (CacheNode_Sub13 cachenode_sub13 = (CacheNode_Sub13) class157
								.method1714(2); cachenode_sub13 != null; cachenode_sub13 = (CacheNode_Sub13) class157
										.method1713((byte) -34))
							if (i_3_ == i_7_++)
								return cachenode_sub13.anInt9570;
					}
				}
			} else if ((Node_Sub6.anInt7043 ^ 0xffffffff) <= (i ^ 0xffffffff)
					|| Node_Sub6.anInt7043 + Class362.anInt4492 <= i) {
				if (Class73.aCacheNode_Sub4_988 != null && Class367.anInt4539 < i
						&& i < CacheNode.anInt7033 + Class367.anInt4539) {
					int i_8_ = -1;
					...
					if ((i_8_ ^ 0xffffffff) != 0) {
						...
						for (CacheNode_Sub13 cachenode_sub13 = (CacheNode_Sub13) class269
								.method3295(16); cachenode_sub13 != null; cachenode_sub13 = (CacheNode_Sub13) class269
										.method3294(16))
							if (i_12_++ == i_8_)
								return cachenode_sub13.anInt9570;
					}
				...
				for (int i_14_ = 0; Class21.anInt355 > i_14_; i_14_++)
					if (!Node_Sub38_Sub5.aBoolean10130) {
						int i_15_ = ConnectionDecoder.anInt5481 - -31 - -(i_14_ * 16);
						if ((i_2_ ^ 0xffffffff) < (i_15_ + -13 ^ 0xffffffff) && 3 + i_15_ >= i_2_)
							i_13_ = i_14_;
					} else {
						int i_16_ = 33 + (ConnectionDecoder.anInt5481 - -(16 * i_14_));
				...
				if (i_13_ != -1) {
					...
					for (CacheNode_Sub4 cachenode_sub4 = (CacheNode_Sub4) class269.method3295(
							16); cachenode_sub4 != null; cachenode_sub4 = (CacheNode_Sub4) class269.method3294(16))
	...
	public static final void method2974(int i, CacheNode_Sub13 cachenode_sub13) {
		anInt7656++;
			...
			if (cachenode_sub13.aBoolean9567) {
				for (CacheNode_Sub4 cachenode_sub4 = (CacheNode_Sub4) Class184.aClass158_2189.method1723(
					...
					if (cachenode_sub4.aString9458.equals(cachenode_sub13.aString9558)) {
						boolean bool = false;
						for (CacheNode_Sub13 cachenode_sub13_20_ = (CacheNode_Sub13) cachenode_sub4.aClass158_9457
								.method1723(
										13); cachenode_sub13_20_ != null; cachenode_sub13_20_ = (CacheNode_Sub13) cachenode_sub4.aClass158_9457
												.method1721(0))
				...
				for (cachenode_sub4 = (CacheNode_Sub4) Class261.aHashTable3306.getNode(3512,
						l); cachenode_sub4 != null; cachenode_sub4 = (CacheNode_Sub4) Class261.aHashTable3306
								.method1524((byte) 84))
					if (cachenode_sub4.aString9458.equals(cachenode_sub13.aString9558))
						break;
	...
	public final void method2970(int[] is, int i, int i_0_, int i_1_) {
	...
	public final boolean method2973(int i, int i_18_, int i_19_) {
		if (i_19_ != 10598)
			anInt7651 = -60;
		anInt7637++;
		if ((i_18_ ^ 0xffffffff) <= (anInt7636 ^ 0xffffffff) && (i_18_ ^ 0xffffffff) >= (anInt7641 ^ 0xffffffff)
				&& (i ^ 0xffffffff) <= (anInt7646 ^ 0xffffffff) && (i ^ 0xffffffff) >= (anInt7635 ^ 0xffffffff))
			return true;
		return false;
	}

	public final boolean method2975(int i, byte b, int i_21_, int i_22_) {
		anInt7640++;
		if (b < 29)
			aGLSpriteArray7655 = null;
		if ((anInt7645 ^ 0xffffffff) != (i_21_ ^ 0xffffffff) || (i_22_ ^ 0xffffffff) > (anInt7653 ^ 0xffffffff)
				|| i_22_ > anInt7643 || i < anInt7642 || i > anInt7649)
			return false;
		return true;
	}

	public final void method2976(int i, int[] is, int i_23_, int i_24_) {
	...
	public final boolean method2977(int i, byte b, int i_25_) {
		anInt7647++;
		if (b >= -19)
			anInt7651 = -85;
		if ((i ^ 0xffffffff) <= (anInt7653 ^ 0xffffffff) && i <= anInt7643 && i_25_ >= anInt7642
				&& (i_25_ ^ 0xffffffff) >= (anInt7649 ^ 0xffffffff))
			return true;
		return false;
	}
}
