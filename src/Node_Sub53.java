...
public class Node_Sub53 extends Node {
	public static Class176 aClass176_7667;
	public static GLSprite[] aGLSpriteArray7666;
	public static int anInt7662;
	public static int anInt7669 = 0;
	public static int gameSceneBaseX;

	public static final DrawableModel method2978(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_,
		...
		if (drawablemodel == null) {
			Model model = Renderer.method3448(i_2_, 7, 0, Class107.INDEX);
			if (model == null)
				return null;
