...
public class Node_Sub54 extends Node {
	public static Class338 aClass338_7671;
	public static int anInt7673;
	public static int anInt7674;
	public static int anInt7678;
	...
	public static int anInt7693;
	public static int GAME_SCENE_WDITH = 104;

	public static final void method2981(int i, Node_Sub14 node_sub14, int i_1_, Class79 class79, Class299 class299, int i_2_,
			byte b, GraphicsToolkit graphicstoolkit, int i_3_) {
		anInt7674++;
		int i_4_ = i_1_ + -(i_2_ / 2) + -5;
		int i_5_ = 2 + i_3_;
		if (class79.anInt1077 != 0)
			graphicstoolkit.method1239(10 + i_2_, 1 + i * class299.method3487() + i_3_ + -i_5_, i_5_, (byte) 116, i_4_,
					class79.anInt1077);
		if (class79.anInt1081 != 0)
			graphicstoolkit.method1234(i_5_, class79.anInt1081, 10 + i_2_,
					1 + (class299.method3487() * i + (i_3_ + -i_5_)), (byte) -88, i_4_);
	...
	public static final void method2982(int i, java.awt.Canvas canvas) {
		if (i >= -18)
			method2982(-128, null);
		anInt7682++;
	...
	public static final Node_Sub27 method2983(int i) {
		anInt7678++;
		if (i != -17555)
			return null;
		FileOnDisk fileondisk = null;
		Node_Sub27 node_sub27 = new Node_Sub27(Class209.directory, 0);
		try {
			...
			if (class241.anInt2953 == 1) {
				...
				node_sub27 = new Node_Sub27(new BufferedStream(bs), Class209.directory, 0);
			}
	...
	public final void method2980(int i, int i_0_) {
		anInt7693++;
		aStream7687.f(3 + i * 4);
		if (i_0_ == 1)
			aStream7687.d(-1);
	...
	public final void method2984(byte b, int i) {
	...
	public final void method2985(byte b, int[] is, int i) {
		anInt7685++;
		Interface15_Impl1 interface15_impl1 = anAbstractToolkit7672.method1298(0, anInt7692 * 3);
		Buffer buffer = interface15_impl1.method54(true, (byte) 126);
		if (buffer != null) {
			...
			if (interface15_impl1.method53(-3308) && i_11_ > 0) {
				anAbstractToolkit7672.method1332(3, (0x7 & aStandardPlane7681.anInt7981 ^ 0xffffffff) != -1, anInt7689,
						(0x8 & aStandardPlane7681.anInt7981) != 0);
				...
				anAbstractToolkit7672.method1276(i_12_, (byte) -114, 0, interface15_impl1, i_13_ + -i_12_ - -1,
						Class55.aClass104_833, i_11_);
				anAbstractToolkit7672.method1255((byte) -12);
			}
		}
	}

	public final void method2986(int i, int i_28_, int i_29_, int i_30_) {
		if (i_28_ != 21883)
			method2989(-45, -114, 0.5913439F, 73, -48);
		anIntArray7677[aStandardPlane7681.anInt3408 * i_30_ + i] = Node_Sub16
				.method2590(anIntArray7677[aStandardPlane7681.anInt3408 * i_30_ + i], 1 << i_29_);
		anInt7684++;
		anInt7692++;
	}

	public final void method2988(byte b, int i) {
		anInt7673++;
		aStream7687.c();
	...
	public final void method2989(int i, int i_31_, float f, int i_32_, int i_33_) {
		anInt7688++;
		if (i_32_ <= 28)
			anInt7686 = 93;
		if ((anInt7689 ^ 0xffffffff) != 0) {
			PlayerMasks class91 = anAbstractToolkit7672.aD1543.method10(anInt7689, -8217);
			...
			if ((i_34_ ^ 0xffffffff) != -1 && (class91.aByte1214 ^ 0xffffffff) != -5) {
				...
				if ((i_34_ ^ 0xffffffff) == -257)
					...
					int i_36_ = i_34_;
					int i_37_ = -i_34_ + 256;
					i = (0xff0000 & i_36_ * (i_35_ & 0xff00) + i_37_ * (0xff00 & i))
							+ (i_36_ * (i_35_ & 0xff00ff) - -((i & 0xff00ff) * i_37_) & ~0xff00ff) >> 8;
				}
			}
