...
public class Node_Sub9_Sub1 extends Node_Sub9 {
	...
	public static int anInt9682;
	private Node_Sub10[][] aNode_Sub10ArrayArray9683;
	public static int anInt9684;
	protected int[] anIntArray9685;
	public static int[] anIntArray9686 = new int[3];
	public static int anInt9687;
	public static int anInt9688;
	public static int anInt9689;
	public static int anInt9690;
	public static int anInt9691;
	public static int anInt9692;
	public static int anInt9693;
	public static int anInt9694;
	public static int anInt9695;
	public static int anInt9696;
	...
	@Override
	public final synchronized void method2427(int[] is, int i, int i_4_) {
		if (aClass27_9666.method315()) {
			...
			do {
				...
				int i_6_ = (int) ((-1L + (aLong9697 - aLong9701 - -(long) i_5_)) / i_5_);
	...
	@Override
	public final synchronized Node_Sub9 method2429() {
		anInt9658++;
		return aNode_Sub9_Sub4_9698;
	}

	public final synchronized void method2435(boolean bool) {
		anInt9694++;
		if (bool == false)
	...
	private final int method2437(int i, Node_Sub10 node_sub10) {
		...
		if ((class240.anInt2938 ^ 0xffffffff) < -1 && ((class240.anInt2937 ^ 0xffffffff) < -1
				|| (anIntArray9668[node_sub10.anInt7080] ^ 0xffffffff) < -1)) {
			...
			double d = Math.sin((0x1ff & node_sub10.anInt7082) * 0.01227184630308513);
			i_10_ += (int) (d * i_11_);
		}
		int i_13_ = (int) (0.5 + 256 * node_sub10.aNode_Sub45_Sub1_7087.anInt10502
				* Math.pow(2.0, i_10_ * 3.255208333333333E-4) / Class365.anInt4523);
		if (i != -27954)
			return -119;
		if (i_13_ >= 1)
			return i_13_;
	...
	private final void method2438(int i, int i_14_, int i_15_, int i_16_) {
		...
		if (node_sub10 != null) {
			...
			if ((0x2 & anIntArray9680[i_15_] ^ 0xffffffff) == -1)
				...
				for (Node_Sub10 node_sub10_17_ = (Node_Sub10) aNode_Sub9_Sub4_9698.aClass312_9739.method3613(
						65280); node_sub10_17_ != null; node_sub10_17_ = (Node_Sub10) aNode_Sub9_Sub4_9698.aClass312_9739
								.method3620(16776960))
					if ((node_sub10.anInt7080 ^ 0xffffffff) == (node_sub10_17_.anInt7080 ^ 0xffffffff)
							&& (node_sub10_17_.anInt7100 ^ 0xffffffff) > -1 && node_sub10 != node_sub10_17_) {
						node_sub10.anInt7100 = 0;
						break;
					}
			if (i_14_ > -34)
	...
	public final synchronized void method2439(int i, int i_18_) {
		anInt9667++;
		if (i == -12651)
			anInt9655 = i_18_;
	}
	...
	private final void method2440(int i, int i_19_) {
		...
		if ((0x4 & anIntArray9680[i_19_] ^ 0xffffffff) != -1)
			for (Node_Sub10 node_sub10 = (Node_Sub10) aNode_Sub9_Sub4_9698.aClass312_9739.method3613(
					i + 65280); node_sub10 != null; node_sub10 = (Node_Sub10) aNode_Sub9_Sub4_9698.aClass312_9739
							.method3620(16776960))
	...
	public static final void method2441(int i) {
		anInt9692++;
				...
				if ((class78.anInt1022 ^ 0xffffffff) > ((class78.method777((byte) -9) ? -1500 : -10) ^ 0xffffffff))
					...
					if ((class78.anInt1022 ^ 0xffffffff) > -1) {
						...
						if (class78.anInt1036 == 0)
							...
							if (i_23_ == Player.get.plane) {
								int i_24_ = (0xff & class78.anInt1036) << 9;
								int i_25_ = Player.get.getSize((byte) 126) << 8;
								int i_26_ = class78.anInt1036 >> 16 & 0xff;
								int i_27_ = -Player.get.anInt5934 + 256 + (i_26_ << 9) + i_25_;
								int i_28_ = (class78.anInt1036 & 0xff65) >> 8;
								int i_29_ = i_25_ + -Player.get.anInt5940 + ((i_28_ << 9) + 256);
								...
								if ((i_27_ ^ 0xffffffff) != -1 || (i_29_ ^ 0xffffffff) != -1) {
									int i_32_ = -Class170.anInt2053 + (-(int) (Math.atan2(i_27_, i_29_) * 2607.5945876176133) + -4096) & 0x3fff;
									if (i_32_ > 8192)
										i_32_ = -i_32_ + 16384;
									int i_33_;
									if (i_30_ > 0) {
		...
		if (Class377_Sub1.aBoolean8775 && !Class36.method390(126)) {
			...
			KeyStrokes.anInt3668++;
			Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, Class128.aClass318_1660, Class218.aClass123_2566.isaacCipher);
			node_sub13.packet.writeInt(Class313.anInt4013);
	...
	private final int method2443(Node_Sub10 node_sub10, byte b) {
		...
		if ((class240.anInt2933 ^ 0xffffffff) < -1)
			i = (int) (i * Math.pow(0.5, node_sub10.anInt7102 * 1.953125E-5 * class240.anInt2933) + 0.5);
		if (class240.aByteArray2944 != null) {
			...
			if ((-2 + class240.aByteArray2944.length ^ 0xffffffff) < (node_sub10.anInt7078 ^ 0xffffffff)) {
				...
				i_36_ += (-i_36_ + class240.aByteArray2944[3 + node_sub10.anInt7078]) * (-i_37_ + i_35_)
						/ (i_38_ - i_37_);
			}
			i = i_36_ * i + 32 >> 6;
		}
		if ((node_sub10.anInt7100 ^ 0xffffffff) < -1 && class240.aByteArray2942 != null) {
			...
			if ((class240.aByteArray2942.length + -2 ^ 0xffffffff) < (node_sub10.anInt7090 ^ 0xffffffff)) {
				...
				i_40_ += (i_39_ - i_41_) * (class240.aByteArray2942[3 + node_sub10.anInt7090] - i_40_)
						/ (i_42_ - i_41_);
			}
			i = i_40_ * i + 32 >> 6;
		}
	...
	@Override
	public final synchronized int method2428() {
		anInt9647++;
		return 0;
	}

	public final boolean method2444(Node_Sub10 node_sub10, byte b) {
		anInt9688++;
		if (node_sub10.aNode_Sub9_Sub2_7095 == null) {
			if (node_sub10.anInt7100 >= 0) {
				node_sub10.method2160((byte) 50);
				if ((node_sub10.anInt7093 ^ 0xffffffff) < -1
						&& aNode_Sub10ArrayArray9683[node_sub10.anInt7080][node_sub10.anInt7093] == node_sub10)
	...
	@Override
	public final synchronized Node_Sub9 method2431() {
		anInt9657++;
		return null;
	}

	public final synchronized boolean method2445(byte b) {
		anInt9682++;
		if (b > -25)
			aLong9701 = 28L;
	...
	public final synchronized void method2448(Node_Sub4 node_sub4, boolean bool, int i, long l, boolean bool_66_) {
		anInt9674++;
		if (i != -128)
			method2433(-70, 6L);
		method2436(bool, bool_66_, node_sub4, 18429);
		method2433(0, l * aClass27_9666.anInt463);
	}

	public final synchronized void method2449(int i, boolean bool, int i_67_) {
		if (bool != false)
			method2445((byte) -88);
		if (i_67_ < 0)
	...
	public final synchronized void method2450(byte b) {
		for (Node_Sub6 node_sub6 = (Node_Sub6) aHashTable9636
				.method1516(false); node_sub6 != null; node_sub6 = (Node_Sub6) aHashTable9636.method1520(96))
	...
	private final void method2451(int i, int i_69_, byte b) {
		...
		anInt9653++;
		anIntArray9685[i_69_] = (int) (Math.pow(2.0, i * 5.4931640625E-4) * 2097152.0 + 0.5);
	}

	public final synchronized void method2452(int i, int i_70_, byte b) {
	...
	private final void method2453(int i, int i_72_) {
		if (i != 15)
			aClass27_9666 = null;
		for (Node_Sub10 node_sub10 = (Node_Sub10) aNode_Sub9_Sub4_9698.aClass312_9739
				.method3613(65280); node_sub10 != null; node_sub10 = (Node_Sub10) aNode_Sub9_Sub4_9698.aClass312_9739
						.method3620(i ^ 0xffff0f))
	...
	public final synchronized void method2456(int i) {
	...
	public final synchronized void method2457(int i, Node_Sub4 node_sub4, boolean bool) {
		method2436(bool, true, node_sub4, 18429);
		if (i == 197984776)
			anInt9689++;
	}

	public static final Class205 method2458(BufferedStream buffer, int i) {
		anInt9630++;
	...
	private final void method2459(int i, int i_83_, int i_84_, boolean bool) {
		...
		if ((0x2 & anIntArray9680[i]) != 0)
			for (Node_Sub10 node_sub10 = (Node_Sub10) aNode_Sub9_Sub4_9698.aClass312_9739.method3622(
					(byte) -60); node_sub10 != null; node_sub10 = (Node_Sub10) aNode_Sub9_Sub4_9698.aClass312_9739
							.method3623((byte) 106))
				if ((i ^ 0xffffffff) == (node_sub10.anInt7080 ^ 0xffffffff)
						&& (node_sub10.anInt7100 ^ 0xffffffff) > -1) {
		...
		Node_Sub6 node_sub6 = (Node_Sub6) aHashTable9636.getNode(3512, anIntArray9675[i]);
		if (node_sub6 != null) {
			...
			if (node_sub45_sub1 != null) {
				...
				node_sub10.anInt7091 = i_83_;
				node_sub10.anInt7096 = node_sub6.aByteArray7057[i_83_] * (i_84_ * (i_84_ * node_sub6.anInt7052))
						- -1024 >> 11;
				...
				if (anIntArray9659[i] == 0)
					node_sub10.aNode_Sub9_Sub2_7095 = Node_Sub9_Sub2.method2509(node_sub45_sub1,
							method2437(-27954, node_sub10), method2443(node_sub10, (byte) -118),
							method2446(128, node_sub10));
				else {
					node_sub10.aNode_Sub9_Sub2_7095 = Node_Sub9_Sub2.method2509(node_sub45_sub1,
							method2437(-27954, node_sub10), 0, method2446(128, node_sub10));
	...
	private final void method2461(int i, int i_89_) {
		...
		if (i != 15025)
			anIntArray9646 = null;
		for (/**/; node_sub10 != null; node_sub10 = (Node_Sub10) aNode_Sub9_Sub4_9698.aClass312_9739
				.method3620(i ^ 0xffc5b1))
			if (((i_89_ ^ 0xffffffff) > -1 || i_89_ == node_sub10.anInt7080)
					&& (node_sub10.anInt7100 ^ 0xffffffff) > -1) {
				aNode_Sub10ArrayArray9679[node_sub10.anInt7080][node_sub10.anInt7091] = null;
				node_sub10.anInt7100 = 0;
			}
	...
	private final void method2464(byte b, int i) {
		...
		if ((0x2 & anIntArray9680[i] ^ 0xffffffff) != -1)
			for (Node_Sub10 node_sub10 = (Node_Sub10) aNode_Sub9_Sub4_9698.aClass312_9739.method3613(
					65280); node_sub10 != null; node_sub10 = (Node_Sub10) aNode_Sub9_Sub4_9698.aClass312_9739
							.method3620(16776960))
				if (i == node_sub10.anInt7080 && aNode_Sub10ArrayArray9679[i][node_sub10.anInt7091] == null
						&& node_sub10.anInt7100 < 0)
					node_sub10.anInt7100 = 0;
	}
	...
	public final void method2466(boolean bool, Node_Sub10 node_sub10, int i) {
		if (i == -26045) {
			anInt9676++;
	...
	public final synchronized boolean method2467(Class96 class96, Index class302, int i, int i_101_, Node_Sub4 node_sub4) {
		anInt9670++;
		...
		if ((i_101_ ^ 0xffffffff) < -1)
			is = new int[] { i_101_ };
		for (Node_Sub51 node_sub51 = (Node_Sub51) node_sub4.aHashTable6950.method1516(
				false); node_sub51 != null; node_sub51 = (Node_Sub51) node_sub4.aHashTable6950.method1520(70)) {
			int i_103_ = (int) node_sub51.aLong2797;
			Node_Sub6 node_sub6 = (Node_Sub6) aHashTable9636.getNode(3512, i_103_);
			if (node_sub6 == null) {
				...
				aHashTable9636.put(i_103_, node_sub6, -128);
			}
	...
	public final synchronized void method2426(int i) {
		...
		if (aClass27_9666.method315()) {
			...
			do {
				...
				int i_105_ = (int) ((-1L + -aLong9701 + (aLong9697 + i_104_)) / i_104_);
	...
	public final boolean method2468(Node_Sub10 node_sub10, int i, int[] is, int i_106_, int i_107_) {
		node_sub10.anInt7077 = Class365.anInt4523 / 100;
		anInt9632++;
		if (i <= 25)
			return false;
		if ((node_sub10.anInt7100 ^ 0xffffffff) <= -1
				&& (node_sub10.aNode_Sub9_Sub2_7095 == null || node_sub10.aNode_Sub9_Sub2_7095.method2474())) {
		...
		if ((i_108_ ^ 0xffffffff) < -1) {
			i_108_ -= (int) (Math.pow(2.0, anIntArray9652[node_sub10.anInt7080] * 4.921259842519685E-4) * 16.0 + 0.5);
			if ((i_108_ ^ 0xffffffff) > -1)
				i_108_ = 0;
		...
		double d = 5.086263020833333E-6
				* ((-60 + node_sub10.anInt7091 << 8) - -(node_sub10.anInt7092 * node_sub10.anInt7101 >> 12));
		if (class240.anInt2933 > 0) {
			if ((class240.anInt2934 ^ 0xffffffff) < -1)
				node_sub10.anInt7102 += (int) (0.5 + 128.0 * Math.pow(2.0, class240.anInt2934 * d));
			else
		...
		if (class240.aByteArray2944 != null) {
			if (class240.anInt2940 <= 0)
				...
				node_sub10.anInt7084 += (int) (128.0 * Math.pow(2.0, d * class240.anInt2940) + 0.5);
			for (/**/; node_sub10.anInt7078 < class240.aByteArray2944.length - 2; node_sub10.anInt7078 += 2)
				if (node_sub10.anInt7084 <= (class240.aByteArray2944[2 + node_sub10.anInt7078] & 0xff) << 8)
					break;
			if ((node_sub10.anInt7078 ^ 0xffffffff) == (-2 + class240.aByteArray2944.length ^ 0xffffffff)
					&& (class240.aByteArray2944[node_sub10.anInt7078 + 1] ^ 0xffffffff) == -1)
				bool = true;
		}
		if ((node_sub10.anInt7100 ^ 0xffffffff) <= -1 && class240.aByteArray2942 != null
				&& (anIntArray9680[node_sub10.anInt7080] & 0x1) == 0 && ((node_sub10.anInt7093 ^ 0xffffffff) > -1
						|| node_sub10 != aNode_Sub10ArrayArray9683[node_sub10.anInt7080][node_sub10.anInt7093])) {
			if (class240.anInt2941 <= 0)
				node_sub10.anInt7100 += 128;
			else
				node_sub10.anInt7100 += (int) (0.5 + 128.0 * Math.pow(2.0, d * class240.anInt2941));
			for (/**/; -2 + class240.aByteArray2942.length > node_sub10.anInt7090; node_sub10.anInt7090 += 2)
				if ((node_sub10.anInt7100
						^ 0xffffffff) >= ((class240.aByteArray2942[node_sub10.anInt7090 + 2] & 0xff) << 8 ^ 0xffffffff))
					break;
		...
		node_sub10.aNode_Sub9_Sub2_7095.method2501(node_sub10.anInt7077, method2443(node_sub10, (byte) -107),
				method2446(128, node_sub10));
		return false;
	}
	...
	public final int method2471(int i) {
		anInt9643++;
		if (i != 15)
			return 114;
		return anInt9655;
