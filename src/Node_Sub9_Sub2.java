...
public class Node_Sub9_Sub2 extends Node_Sub9 {
	private static final int method2473(byte[] bs, int[] is, int i, int i_12_, int i_13_, int i_14_, int i_15_,
			int i_16_, Node_Sub9_Sub2 node_sub9_sub2) {
		i >>= 8;
		i_16_ >>= 8;
		i_13_ <<= 2;
	...
	private static final int method2475(int i, int i_17_, byte[] bs, int[] is, int i_18_, int i_19_, int i_20_,
			int i_21_, int i_22_, int i_23_, int i_24_, Node_Sub9_Sub2 node_sub9_sub2, int i_25_, int i_26_) {
	...
	private static final int method2476(int i, int i_27_, byte[] bs, int[] is, int i_28_, int i_29_, int i_30_,
			int i_31_, int i_32_, int i_33_, int i_34_, int i_35_, int i_36_, Node_Sub9_Sub2 node_sub9_sub2, int i_37_,
			int i_38_) {
	...
	private static final int method2479(int i, int i_40_, byte[] bs, int[] is, int i_41_, int i_42_, int i_43_,
			int i_44_, int i_45_, int i_46_, Node_Sub9_Sub2 node_sub9_sub2, int i_47_, int i_48_) {
	...
	private static final int method2484(byte[] bs, int[] is, int i, int i_54_, int i_55_, int i_56_, int i_57_,
			int i_58_, int i_59_, Node_Sub9_Sub2 node_sub9_sub2) {
		i >>= 8;
		i_59_ >>= 8;
		i_55_ <<= 2;
		i_56_ <<= 2;
	...
	private static final int method2487(int i, int i_60_, byte[] bs, int[] is, int i_61_, int i_62_, int i_63_,
			int i_64_, int i_65_, int i_66_, int i_67_, Node_Sub9_Sub2 node_sub9_sub2, int i_68_, int i_69_) {
	...
	private static final int method2488(int i, byte[] bs, int[] is, int i_70_, int i_71_, int i_72_, int i_73_,
			int i_74_, int i_75_, int i_76_, int i_77_, int i_78_, Node_Sub9_Sub2 node_sub9_sub2) {
		i_70_ >>= 8;
		i_78_ >>= 8;
		i_72_ <<= 2;
		i_73_ <<= 2;
	...
	private static final int method2489(int i, int i_79_, byte[] bs, int[] is, int i_80_, int i_81_, int i_82_,
			int i_83_, int i_84_, int i_85_, int i_86_, int i_87_, int i_88_, Node_Sub9_Sub2 node_sub9_sub2, int i_89_,
			int i_90_) {
	...
	private static final int method2491(int i, int i_91_) {
		if (i_91_ < 0)
			return -i;
		return (int) (i * Math.sqrt(i_91_ * 1.220703125E-4) + 0.5);
	}

	private static final int method2492(int i, byte[] bs, int[] is, int i_92_, int i_93_, int i_94_, int i_95_,
			int i_96_, int i_97_, int i_98_, Node_Sub9_Sub2 node_sub9_sub2) {
		i_92_ >>= 8;
		i_98_ >>= 8;
		i_94_ <<= 2;
		i_95_ <<= 2;
	...
	private static final int method2493(int i, int i_99_) {
		if (i_99_ < 0)
			return i;
		return (int) (i * Math.sqrt((16384 - i_99_) * 1.220703125E-4) + 0.5);
	}

	private static final int method2494(int i, int i_100_, byte[] bs, int[] is, int i_101_, int i_102_, int i_103_,
			int i_104_, int i_105_, int i_106_, int i_107_, Node_Sub9_Sub2 node_sub9_sub2, int i_108_, int i_109_) {
	...
	private static final int method2495(byte[] bs, int[] is, int i, int i_110_, int i_111_, int i_112_, int i_113_,
			int i_114_, int i_115_, Node_Sub9_Sub2 node_sub9_sub2) {
		i >>= 8;
		i_115_ >>= 8;
		i_111_ <<= 2;
		i_112_ <<= 2;
	...
	private static final int method2497(int i, byte[] bs, int[] is, int i_116_, int i_117_, int i_118_, int i_119_,
			int i_120_, int i_121_, int i_122_, Node_Sub9_Sub2 node_sub9_sub2) {
		i_116_ >>= 8;
		i_122_ >>= 8;
		i_118_ <<= 2;
		i_119_ <<= 2;
	...
	private static final int method2502(int i, int i_129_, byte[] bs, int[] is, int i_130_, int i_131_, int i_132_,
			int i_133_, int i_134_, int i_135_, Node_Sub9_Sub2 node_sub9_sub2, int i_136_, int i_137_) {
	...
	private static final int method2505(int i, byte[] bs, int[] is, int i_138_, int i_139_, int i_140_, int i_141_,
			int i_142_, int i_143_, int i_144_, int i_145_, int i_146_, Node_Sub9_Sub2 node_sub9_sub2) {
		i_138_ >>= 8;
		i_146_ >>= 8;
		i_140_ <<= 2;
		i_141_ <<= 2;
	...
	private static final int method2506(byte[] bs, int[] is, int i, int i_153_, int i_154_, int i_155_, int i_156_,
			int i_157_, Node_Sub9_Sub2 node_sub9_sub2) {
		i >>= 8;
		i_157_ >>= 8;
		i_154_ <<= 2;
	...
	public static final Node_Sub9_Sub2 method2509(Node_Sub45_Sub1 node_sub45_sub1, int i, int i_161_, int i_162_) {
	...
	private static final int method2510(int i, int i_163_, byte[] bs, int[] is, int i_164_, int i_165_, int i_166_,
			int i_167_, int i_168_, int i_169_, int i_170_, Node_Sub9_Sub2 node_sub9_sub2, int i_171_, int i_172_) {
	...
	private final int method2472(int[] is, int i, int i_0_, int i_1_, int i_2_) {
		while (anInt9715 > 0) {
			...
			if (anInt9710 == -256 && (anInt9718 & 0xff) == 0) {
				if (DrawableModel.aBoolean913)
					i = method2505(0, ((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9711,
							anInt9708, anInt9714, anInt9719, 0, i_3_, i_0_, this);
				else
					i = method2495(((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9707,
							anInt9709, 0, i_3_, i_0_, this);
			} else if (DrawableModel.aBoolean913)
				i = method2489(0, 0, ((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9711,
						anInt9708, anInt9714, anInt9719, 0, i_3_, i_0_, this, anInt9710, i_2_);
			else
				i = method2510(0, 0, ((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9707,
						anInt9709, 0, i_3_, i_0_, this, anInt9710, i_2_);
			anInt9715 -= i;
			if (anInt9715 != 0)
				return i;
			if (method2508())
		...
		if (anInt9710 == -256 && (anInt9718 & 0xff) == 0) {
			if (DrawableModel.aBoolean913)
				return method2497(0, ((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9711,
						anInt9708, 0, i_1_, i_0_, this);
			return method2506(((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9707, 0,
					i_1_, i_0_, this);
		}
		if (DrawableModel.aBoolean913)
			return method2487(0, 0, ((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9711,
					anInt9708, 0, i_1_, i_0_, this, anInt9710, i_2_);
		return method2502(0, 0, ((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9707, 0,
				i_1_, i_0_, this, anInt9710, i_2_);
	}

	public final boolean method2474() {
	...
	public final synchronized void method2478(int i, int i_39_) {
	...
	private final int method2480(int[] is, int i, int i_49_, int i_50_, int i_51_) {
		while (anInt9715 > 0) {
			...
			if (anInt9710 == 256 && (anInt9718 & 0xff) == 0) {
				if (DrawableModel.aBoolean913)
					i = method2488(0, ((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9711,
							anInt9708, anInt9714, anInt9719, 0, i_52_, i_49_, this);
				else
					i = method2484(((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9707,
							anInt9709, 0, i_52_, i_49_, this);
			} else if (DrawableModel.aBoolean913)
				i = method2476(0, 0, ((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9711,
						anInt9708, anInt9714, anInt9719, 0, i_52_, i_49_, this, anInt9710, i_51_);
			else
				i = method2494(0, 0, ((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9707,
						anInt9709, 0, i_52_, i_49_, this, anInt9710, i_51_);
			anInt9715 -= i;
			if (anInt9715 != 0)
				return i;
			if (method2508())
		...
		if (anInt9710 == 256 && (anInt9718 & 0xff) == 0) {
			if (DrawableModel.aBoolean913)
				return method2492(0, ((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9711,
						anInt9708, 0, i_50_, i_49_, this);
			return method2473(((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9707, 0,
					i_50_, i_49_, this);
		}
		if (DrawableModel.aBoolean913)
			return method2475(0, 0, ((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9711,
					anInt9708, 0, i_50_, i_49_, this, anInt9710, i_51_);
		return method2479(0, 0, ((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9707, 0,
				i_50_, i_49_, this, anInt9710, i_51_);
	}

	public final synchronized void method2481(int i) {
		anInt9720 = i;
	}

	public final synchronized void method2482(int i) {
		if (anInt9710 < 0)
			anInt9710 = -i;
		else
			anInt9710 = i;
	...
	public final synchronized void method2483(int i) {
		if (i == 0) {
			method2485(0);
	...
	public final synchronized void method2486(boolean bool) {
		anInt9710 = (anInt9710 ^ anInt9710 >> 31) + (anInt9710 >>> 31);
		if (bool)
			anInt9710 = -anInt9710;
	}

	public final synchronized void method2490(int i) {
		method2500(i << 6, method2511());
	}

	public final synchronized void method2496(int i) {
	...
	public final boolean method2499() {
		if (anInt9715 == 0)
			return false;
		return true;
	}
	...
	public final synchronized void method2501(int i, int i_124_, int i_125_) {
		if (i == 0)
	...
	public final synchronized int method2503() {
		if (anInt9710 < 0)
			return -anInt9710;
		return anInt9710;
	}

	public final synchronized int method2504() {
		if (anInt9716 == -2147483648)
			return 0;
		return anInt9716;
	}

	public final synchronized void method2507(int i) {
	...
	public final synchronized int method2511() {
		if (anInt9713 < 0)
			return -1;
		return anInt9713;
	}
