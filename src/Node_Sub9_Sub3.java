...
public class Node_Sub9_Sub3 extends Node_Sub9 {
	...
	@Override
	public final synchronized void method2427(int[] is, int i, int i_0_) {
		do {
			if (anInt9724 < 0) {
	...
	public final synchronized int method2512() {
		return aClass312_9721.method3615(-128);
	}

	public final synchronized void method2513(Node_Sub9 node_sub9) {
		aClass312_9721.method3611(node_sub9, -91);
	}

	public final synchronized void method2514(Node_Sub9 node_sub9) {
		node_sub9.method2160((byte) 50);
	}

	private final void method2515(int i) {
		for (Node_Sub9 node_sub9 = (Node_Sub9) aClass312_9721
				.method3613(65280); node_sub9 != null; node_sub9 = (Node_Sub9) aClass312_9721.method3620(16776960))
	...
	private final void method2517(Node node, Node_Sub1 node_sub1) {
		for (/**/; node != aClass312_9722.aNode3958
				&& ((Node_Sub1) node).anInt6931 <= node_sub1.anInt6931; node = node.aNode2800) {
			/* empty */
		}
	...
	private final void method2518() {
		if (anInt9723 > 0) {
			for (Node_Sub1 node_sub1 = (Node_Sub1) aClass312_9722
					.method3613(65280); node_sub1 != null; node_sub1 = (Node_Sub1) aClass312_9722.method3620(16776960))
