...
public class ObjectDefinition {
	...
	public static final void method3036(int i, int i_29_, int i_30_, Animable_Sub1 animable_sub1) {
	...
	public static final void method3045(long[] ls, Object[] objects, boolean bool) {
		anInt3046++;
	...
	public static final int method3047(int i, int i_54_) {
		if (i_54_ != -1)
	...
	public static final void method3049(SignLink signlink, Object object, byte b) {
		anInt3001++;
		if (b <= 63)
	...
	public static final int method3050(byte b, int i) {
		anInt3041++;
		if (b > -122)
			return -61;
		return 0xff & i;
	...
	protected int[] objectWithSprite;
	...
	public final boolean method3032(byte b) {
		anInt3022++;
											...
											if ((opcode ^ 0xffffffff) != -41) {
												if (opcode != 41) {
													if ((opcode ^ 0xffffffff) == -43) {
														...
														for (int i_6_ = 0; (i_5_ ^ 0xffffffff) < (i_6_
																^ 0xffffffff); i_6_++)
																		...
																		if (opcode == 74)
																			...
																			if (opcode != 77
																													...
																													if ((opcode
																														...
																														if (opcode == 101)
																															...
																															if (opcode == 106) {
																																...
																																for (int i_11_ = 0; (i_9_
																																		^ 0xffffffff) < (i_11_
																																				^ 0xffffffff); i_11_++) {
																																	anIntArray3019[i_11_] = buffer
																																			.readBigSmart();
																																	if ((anIntArray3019[i_11_]
																																			^ 0xffffffff) == -65536)
																				...
																				if ((opcode ^ 0xffffffff) == -93) {
																					i_19_ = buffer.readBigSmart();
																					if ((i_19_ ^ 0xffffffff) == -65536)
																						i_19_ = -1;
																				}
																				int i_20_ = buffer.readUnsignedByte();
																				objectWithSprite = new int[i_20_ + 2];
																				for (int i_21_ = 0; i_20_ >= i_21_; i_21_++) {
																					objectWithSprite[i_21_] = buffer
																							.readBigSmart();
																					if ((objectWithSprite[i_21_]
																							^ 0xffffffff) == -65536)
																						objectWithSprite[i_21_] = -1;
																				}
																				objectWithSprite[1 + i_20_] = i_19_;
																			}
																		} else
	...
	public final String method3034(String string, int i, boolean bool) {
		anInt3005++;
		if (aHashTable3014 == null)
			return string;
		if (bool != false)
			anInt3035 = 79;
		Node_Sub18 node_sub18 = (Node_Sub18) aHashTable3014.getNode(3512, i);
		if (node_sub18 == null)
			return string;
		return node_sub18.aString7149;
	}

	public final boolean method3035(int i, int i_27_) {
		anInt3048++;
		if (i_27_ != -166)
			objectWithSprite = null;
		if (anIntArray3019 != null && i != -1)
			for (int element : anIntArray3019)
				if (i == element)
					return true;
		return false;
	}

	public final boolean method3037(int i) {
		if (i != 0)
			aHashTable3014 = null;
		anInt2965++;
	...
	public final ObjectDefinition method3038(int i, Interface17 interface17) {
		anInt2991++;
		int i_32_ = -1;
		if (i != 13)
			method3032((byte) -109);
		...
		if ((i_32_ ^ 0xffffffff) > -1 || (-1 + objectWithSprite.length ^ 0xffffffff) >= (i_32_ ^ 0xffffffff)
				|| objectWithSprite[i_32_] == -1) {
			int i_33_ = objectWithSprite[-1 + objectWithSprite.length];
			if (i_33_ != -1)
				return aClass112_3028.method1145(i_33_, i + 99);
			return null;
		}
		return aClass112_3028.method1145(objectWithSprite[i_32_], 81);
	}

	public final boolean method3039(int i) {
		anInt2978++;
		if (modelIds == null)
			return true;
		boolean bool = true;
		synchronized (aClass112_3028.aClass302_1433) {
			for (int i_34_ = 0; (modelIds.length ^ 0xffffffff) < (i_34_ ^ 0xffffffff); i_34_++)
				for (int i_35_ = 0; (i_35_ ^ 0xffffffff) > (modelIds[i_34_].length ^ 0xffffffff); i_35_++)
					bool &= aClass112_3028.aClass302_1433.requestDownload(0, modelIds[i_34_][i_35_], 0);
		}
		if (i <= 76)
			anInt3023 = -86;
		return bool;
	...
	public final boolean method3040(int i) {
		anInt2976++;
		if (objectWithSprite == null) {
		...
		for (int element : objectWithSprite)
			if ((element ^ 0xffffffff) != 0) {
				ObjectDefinition objectdefinition_37_ = aClass112_3028.method1145(element, 59);
	...
	public final boolean method3041(int i, int i_38_) {
		anInt3043++;
		if (modelIds == null)
			return true;
		synchronized (aClass112_3028.aClass302_1433) {
			...
			for (int i_39_ = 0; (i_39_ ^ 0xffffffff) > (aByteArray2967.length ^ 0xffffffff); i_39_++)
				if (i == aByteArray2967[i_39_]) {
					for (int i_40_ = 0; (i_40_ ^ 0xffffffff) > (modelIds[i_39_].length ^ 0xffffffff); i_40_++)
						if (!aClass112_3028.aClass302_1433.requestDownload(0, modelIds[i_39_][i_40_], 0))
							return false;
					return true;
				}
		}
	...
	public final void method3042(byte b, BufferedStream buffer) {
		for (;;) {
	...
	public final void method3043(int i) {
		if (i == 5) {
			anInt2979++;
			...
			if (method3037(0) || aBoolean2998 || objectWithSprite != null)
				aBoolean2992 = true;
		}
	}

	public final int method3044(int i) {
		anInt2966++;
		if (i != -16828)
			anInt3012 = 11;
		if (anIntArray3019 != null) {
	...
	public final Class243 method3046(int i, int i_44_, int i_45_, Plane plane, boolean bool, byte b, int i_46_, int i_47_,
			GraphicsToolkit graphicstoolkit, Class121 class121, int i_48_, Plane plane_49_) {
		anInt3003++;
		if (Class243.method3062(i_47_, (byte) 51))
			i_47_ = 4;
		long l = i + ((objectId << 10) + (i_47_ << 3));
		l |= graphicstoolkit.anInt1537 << 29;
		if (class121 != null)
	...
	public final DrawableModel method3048(int i, int i_58_, int i_59_, int i_60_, Plane plane, Animator animator, int i_61_,
			GraphicsToolkit graphicstoolkit, Plane plane_62_, Class121 class121, int i_63_, int i_64_) {
		anInt3021++;
		if (Class243.method3062(i_59_, (byte) 46))
			i_59_ = 4;
		long l = (objectId << 10) + ((i_59_ << 3) - -i);
		int i_65_ = i_63_;
		l |= graphicstoolkit.anInt1537 << 29;
		if (class121 != null)
			l |= class121.aLong1522 << 32;
	...
	private final DrawableModel method3051(GraphicsToolkit graphicstoolkit, int i, Class121 class121, byte b, int i_66_,
			int i_67_) {
		anInt3054++;
		...
		if ((i_73_ ^ 0xffffffff) < -1) {
			long l = graphicstoolkit.anInt1537;
		...
		if (aShortArray3047 != null) {
			...
			for (int i_78_ = 0; (i_78_ ^ 0xffffffff) > (aShortArray3047.length ^ 0xffffffff); i_78_++)
				if (aByteArray2996 != null && aByteArray2996.length > i_78_)
					drawablemodel_77_.ia(aShortArray3047[i_78_],
	...
	public final int method3053(int i, int i_82_, int i_83_) {
		anInt3029++;
		if (aHashTable3014 == null)
			return i;
		Node_Sub32 node_sub32 = (Node_Sub32) aHashTable3014.getNode(3512, i_83_);
		if (i_82_ < 6)
