...
public class OutputStream_Sub2 extends OutputStream {
	...
	public static final void method138(int i, int i_0_, int i_1_, byte b, int i_2_, int i_3_, int i_4_) {
		anInt92++;
		@SuppressWarnings("unused")
		int i_5_ = 101 % ((b - -46) / 57);
		if (-i_0_ + i_3_ >= Class262_Sub4.anInt7722 && (i_0_ + i_3_ ^ 0xffffffff) >= (za_Sub2.anInt10513 ^ 0xffffffff)
				&& (Class384.anInt4906 ^ 0xffffffff) >= (i_2_ - i_0_ ^ 0xffffffff)
	...
	public static final void method139(byte b) {
		anInt94++;
