...
public abstract class Plane {
	...
	public static boolean[] aBooleanArray3401;
	public static Class133 aClass133_3406;
	public static Class133 aClass133_3409;
	public static Class133 aClass133_3411;
	public static Class133 aClass133_3412;
	public static Class133 aClass133_3413;
	public static Class133 aClass133_3414;
	public static Class133 aClass133_3415;
	public static Class133 aClass133_3416;
	public static Class133 aClass133_3417;
	public static Class133 aClass133_3418;
	public static Class133 aClass133_3419;
	public static Class133 aClass133_3420;
	public static Class133 aClass133_3421;
	...
	public static String[] aStringArray3403 = new String[200];
	static {
	...
	public static final int method3249(int i, int i_6_, int i_7_, int i_8_) {
		if (i_6_ < 18)
			anInt3423 = 33;
		anInt3405++;
		int i_9_ = -i_8_ + 255;
	...
	public static final void method3258(int i, int i_55_, int i_56_) {
		anInt3402++;
		int i_57_ = Class262_Sub15_Sub1.aClass357_10524.method4033((byte) -6,
				GlobalMessage.CHOOSE_OPTION.getMessage(Class35.language));
		int i_58_;
		if (Class194_Sub3_Sub1.aBoolean9375) {
			for (CacheNode_Sub4 cachenode_sub4 = (CacheNode_Sub4) Class184.aClass158_2189
				...
				if (cachenode_sub4.anInt9462 != 1)
					...
					i_59_ = Node_Sub19.method2609((byte) -88,
			...
			i_57_ += 8;
			Class219.anInt2627 = (Node_Sub38_Sub5.aBoolean10130 ? 26 : 22) + 16 * Class315.menuOptionCount;
			i_58_ = Class315.menuOptionCount * 16 + 21;
		}
		...
		ConnectionDecoder.anInt5481 = i_63_;
	...
	public final int method3251(int i, int i_10_, byte b) {
		if (b != -118)
	...
	abstract void method3253(int i, int i_14_, int[] is, int[] is_15_, int[] is_16_, int[] is_17_, int[] is_18_,
			int[] is_19_, int[] is_20_, int[] is_21_, int[] is_22_, int[] is_23_, int[] is_24_, int i_25_, int i_26_,
			int i_27_, boolean bool);

	abstract void method3255(int i, int i_28_, int i_29_, int i_30_, int i_31_, int i_32_, int i_33_,
			boolean[][] bools);
	...
	public final int method3260(int i, int i_68_, int i_69_) {
		anInt3399++;
		int i_70_ = i_69_ >> anInt3410;
		int i_71_ = i >> anInt3410;
		if ((i_70_ ^ 0xffffffff) > -1 || i_71_ < 0 || (anInt3408 + -1 ^ 0xffffffff) > (i_70_ ^ 0xffffffff)
				|| -1 + anInt3404 < i_71_)
			return 0;
		...
		int i_74_ = i_72_ * anIntArrayArray3407[1 + i_70_][i_71_]
				+ (anInt3398 - i_72_) * anIntArrayArray3407[i_70_][i_71_] >> anInt3410;
		int i_75_ = anIntArrayArray3407[i_70_][i_71_ + 1] * (anInt3398 + -i_72_)
				- -(i_72_ * anIntArrayArray3407[i_70_ - -1][i_71_ + 1]) >> anInt3410;
		return (-i_73_ + anInt3398) * i_74_ - -(i_73_ * i_75_) >> anInt3410;
	}

	abstract void U(int i, int i_40_, int[] is, int[] is_41_, int[] is_42_, int[] is_43_, int[] is_44_, int[] is_45_,
			int[] is_46_, int[] is_47_, int i_48_, int i_49_, int i_50_, boolean bool);
