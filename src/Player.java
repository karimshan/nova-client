...
public class Player extends Actor {
	public static int anInt11133;
	public static int anInt11136;
	public static int anInt11138;
	public static int anInt11143;
	public static int anInt11144;
	public static int anInt11146;
	public static int anInt11148;
	public static int anInt11158;
	public static int anInt11159;
	public static int anInt11161;
	public static int anInt11162;
	public static int anInt11163;
	public static int anInt11165;
	public static int anInt11166;
	public static int anInt11168;
	public static int anInt11170;
	public static int anInt11171;
	public static int anInt11174;
	public static int anInt11175;
	public static int anInt11176;
	public static int anInt11177;
	public static int anInt11178;
	public static int anInt11179;
	public static int anInt11181;
	public static int anInt11183;
	public static int[][] anIntArrayArray11128;
	public static Node_Sub4 aNode_Sub4_11140 = null;
	public static Node_Sub4 aNode_Sub4_11155;
	...
	public static final void method892(int i, int i_77_) {
		anInt11166++;
	...
	protected PlayerDefinition playerDefs;
	...
	public final void decodeAppearence(BufferedStream stream, int i) {
		stream.offset = 0;
		anInt11181++;
		...
		isSuffix = stream.readByte() == 1;
		skullId = stream.readByte();
		prayIconId = stream.readByte();
		aBoolean11131 = (stream.readByte() ^ 0xffffffff) == -2;
		if (Class240.aClass329_2943 == Node_Sub38_Sub1.aClass329_10086 && rights >= 2)
			aBoolean11131 = false;
		anInt11134 = 0;
		int npcId = -1;
			...
			if (Class63.aClass363_922.anIntArray4508[i_49_] != 1) {
				...
				if ((i_50_ ^ 0xffffffff) == -1)
					...
					if (i_52_ >= 32768) {
						...
						equipIds[i_49_] = Node_Sub16.method2590(1073741824, i_52_);
						...
						equipIds[i_49_] = Node_Sub16.method2590(i_52_ + -256, -2147483648);
				}
			}
		if (npcId == -1) {
			int flagHash = stream.readUnsignedShort();
			int slotId = 0;
			for (int i_56_ = 0; (Class63.aClass363_922.anIntArray4508.length ^ 0xffffffff) < (i_56_
					^ 0xffffffff); i_56_++)
		...
		for (int i_58_ = i; (i_58_ ^ 0xffffffff) > -11; i_58_++) {
			...
			if ((i_58_ ^ 0xffffffff) <= (Class117_Sub2.aShortArrayArrayArray5151.length ^ 0xffffffff) || i_59_ < 0
		...
		if (anInt11164 == 0)
			...
			if (hasDisplayName == !bool || (anInt11164 ^ 0xffffffff) != (i_60_ ^ 0xffffffff) || i_61_ != anInt11167
					|| (i_62_ ^ 0xffffffff) != (anInt11172 ^ 0xffffffff) || anInt11153 != i_63_
					|| (anInt11182 ^ 0xffffffff) != (i_64_ ^ 0xffffffff) || i_65_ != anInt11173)
				Class135.method1587(113, this);
		}
		if (playerDefs == null)
			playerDefs = new PlayerDefinition();
		int i_66_ = playerDefs.toNPCId;
		int[] is_67_ = playerDefs.anIntArray3430;
		playerDefs.method3278(colorIds, equipIds, class38s, npcId, method871(0),
				(genderId ^ 0xffffffff) == -2, (byte) -110);
		if (npcId != i_66_) {
			anInt5934 = (scenePositionXQueue[0] << 9) - -(getSize((byte) 83) << 8);
			anInt5940 = (scenePositionYQueue[0] << 9) + (getSize((byte) 45) << 8);
		}
	...
	public final String fixedName(boolean bool, boolean bool_79_) {
		anInt11136++;
		String string = "";
	...
	@Override
	public final int getSize(byte b) {
		if (playerDefs != null && (playerDefs.toNPCId ^ 0xffffffff) != 0)
			return Class366.aClass279_4526.getNPCDefinitions(playerDefs.toNPCId).anInt2811;
	...
	public final EntityNode_Sub6 method807(int i, GraphicsToolkit graphicstoolkit) {
		anInt11171++;
		if (playerDefs == null || !method890(2048, -112, graphicstoolkit))
			return null;
		...
		if ((Class213.aNode_Sub27_2512.aClass320_Sub7_7308.method3708(false) ^ 0xffffffff) == -2) {
			...
			if (class259.aBoolean3267 && (playerDefs.toNPCId == -1 || Class366.aClass279_4526
					.getNPCDefinitions(playerDefs.toNPCId).aBoolean2875)) {
				Animator animator = !anAnimator10876.method245(-125) || !anAnimator10876.method242((byte) -77) ? null
						: anAnimator10876;
				Animator animator_32_ = anAnimator10860.method245(-128) && (!aBoolean10867 || animator == null)
						? anAnimator10860 : null;
				DrawableModel drawablemodel = CacheNode_Sub14_Sub2.method2356(240, aDrawableModelArray10909[0],
						anInt10862, 0, anInt10832, 1, true, graphicstoolkit, 160,
						animator_32_ != null ? animator_32_ : animator, anInt10872, i_29_, 0);
			...
			for (int i_33_ = Class320_Sub24.cachedHintIcons.length + -1; (i_33_ ^ 0xffffffff) <= -1; i_33_--) {
				...
				if (class223 != null && (class223.anInt2666 ^ 0xffffffff) != 0) {
					if (class223.anInt2654 == 1) {
						Node_Sub41 node_sub41 = (Node_Sub41) Class12.aHashTable187.getNode(3512, class223.anInt2658);
						if (node_sub41 != null) {
							NPC npc = node_sub41.aNpc7518;
							int i_34_ = -Player.get.anInt5934 + npc.anInt5934;
							int i_35_ = npc.anInt5940 - Player.get.anInt5940;
							if (Node_Sub15_Sub10.aBoolean9850)
								method885(aDrawableModelArray10909[0], 92160000, (byte) -57, graphicstoolkit,
										class223.anInt2666, i_34_, class336, Class308.anInt3912, i_35_);
							else
								method883((byte) -74, i_34_, 92160000, class223.anInt2666, aDrawableModelArray10909[0],
										class336, graphicstoolkit, i_35_);
						}
					}
					if (class223.anInt2654 == 2) {
						int i_36_ = -Player.get.anInt5934 + class223.anInt2662;
						int i_37_ = -Player.get.anInt5940 + class223.anInt2653;
						int i_38_ = class223.anInt2655 << 9;
						i_38_ *= i_38_;
						if (!Node_Sub15_Sub10.aBoolean9850)
							method883((byte) -74, i_36_, i_38_, class223.anInt2666, aDrawableModelArray10909[0],
									class336, graphicstoolkit, i_37_);
						else
							method885(aDrawableModelArray10909[0], i_38_, (byte) -36, graphicstoolkit,
									class223.anInt2666, i_36_, class336, Class308.anInt3912, i_37_);
					}
					if (class223.anInt2654 == 10 && class223.anInt2658 >= 0
							&& class223.anInt2658 < Client.LOCAL_PLAYERS.length) {
						Player player_39_ = Client.LOCAL_PLAYERS[class223.anInt2658];
						if (player_39_ != null) {
							int i_40_ = player_39_.anInt5934 - Player.get.anInt5934;
							int i_41_ = -Player.get.anInt5940 + player_39_.anInt5940;
							if (Node_Sub15_Sub10.aBoolean9850)
								method885(aDrawableModelArray10909[0], 92160000, (byte) -23, graphicstoolkit,
										class223.anInt2666, i_40_, class336, Class308.anInt3912, i_41_);
							else
								method883((byte) -74, i_40_, 92160000, class223.anInt2666, aDrawableModelArray10909[0],
										class336, graphicstoolkit, i_41_);
						}
					}
				}
			}
			...
			for (int i_42_ = 0; i_42_ < aDrawableModelArray10909.length; i_42_++)
				if (aDrawableModelArray10909[i_42_] != null)
					aDrawableModelArray10909[i_42_].method622(class336,
							entitynode_sub6.anEntityNode_Sub5Array5995[i_42_], Class308.anInt3912,
							this == Player.get ? 1 : 0);
		} else
			for (int i_43_ = 0; i_43_ < aDrawableModelArray10909.length; i_43_++)
				if (aDrawableModelArray10909[i_43_] != null)
					aDrawableModelArray10909[i_43_].method611(class336,
							entitynode_sub6.anEntityNode_Sub5Array5995[i_43_], Player.get == this ? 1 : 0);
		if (anEntityNode_Sub4_10902 != null) {
	...
	public final boolean method810(int i, int i_9_, boolean bool, GraphicsToolkit graphicstoolkit) {
		anInt11170++;
		if (playerDefs == null || !method890(131072, -113, graphicstoolkit))
			return false;
		Class336 class336 = graphicstoolkit.A();
		...
		for (int i_12_ = 0; (i_12_ ^ 0xffffffff) > (aDrawableModelArray10909.length ^ 0xffffffff); i_12_++)
			if (aDrawableModelArray10909[i_12_] != null && (!Node_Sub15_Sub10.aBoolean9850
					? aDrawableModelArray10909[i_12_].method624(i_9_, i, class336, true, 0)
					: aDrawableModelArray10909[i_12_].method621(i_9_, i, class336, true, 0, Class308.anInt3912))) {
				bool_11_ = true;
				break;
			}
	...
	@Override
	public final void method816(int i, boolean bool, GraphicsToolkit graphicstoolkit, int i_14_, byte b, int i_15_,
			Animable animable) {
		if (b >= 101) {
			anInt11133++;
			throw new IllegalStateException();
	...
	public final void method820(GraphicsToolkit graphicstoolkit, int i) {
		anInt11158++;
		if (playerDefs != null && (aBoolean10906 || method890(0, -119, graphicstoolkit))) {
			Class336 class336 = graphicstoolkit.A();
	...
	public final Class59 method869(int i) {
		...
		if (aClass59_10861 != null) {
			if (aClass59_10861.aString877 == null)
				return null;
			if ((Class69.anInt943 ^ 0xffffffff) == -1 || (Class69.anInt943 ^ 0xffffffff) == -4
					|| Class69.anInt943 == 1 && Class193.method1955(i + 3109, realName))
	...
	public final void method882(int i, int i_1_, String string, byte b) {
		this.method864(Node_Sub15_Sub10.method2578((byte) 124) * CacheNode_Sub4.aClass1_9466.anInt118, string, false,
				i_1_, i);
		anInt11183++;
	}

	private final void method883(byte b, int i, int i_3_, int i_4_, DrawableModel drawablemodel, Class336 class336,
		...
		if ((i_6_ ^ 0xffffffff) <= -262145 && (i_6_ ^ 0xffffffff) >= (i_3_ ^ 0xffffffff)) {
			int i_7_ = (int) (2607.5945876176133 * Math.atan2(i, i_5_) - aClass99_10893.method1086(16383)) & 0x3fff;
			DrawableModel drawablemodel_8_ = Node_Sub53.method2978(anInt10872, anInt10862, 76, i_4_, anInt10832, i_7_,
					graphicstoolkit);
	...
	private final void method885(DrawableModel drawablemodel, int i, byte b, GraphicsToolkit graphicstoolkit, int i_16_,
			int i_17_, Class336 class336, int i_18_, int i_19_) {
		anInt11174++;
		int i_20_ = i_17_ * i_17_ - -(i_19_ * i_19_);
		if ((i_20_ ^ 0xffffffff) <= -262145 && (i_20_ ^ 0xffffffff) >= (i ^ 0xffffffff)) {
			if (b > -15)
				anInt11172 = -60;
			int i_21_ = (int) (Math.atan2(i_17_, i_19_) * 2607.5945876176133 - aClass99_10893.method1086(16383))
					& 0x3fff;
			DrawableModel drawablemodel_22_ = Node_Sub53.method2978(anInt10872, anInt10862, 104, i_16_, anInt10832,
					i_21_, graphicstoolkit);
	...
	public final boolean method886(byte b) {
		anInt11165++;
		if (playerDefs == null)
			return false;
		return true;
	...
	public final void method887(int i, int i_23_, int i_24_, byte b) {
	...
	public final void method888(int i, int i_26_, int i_27_) {
		anInt10904 = 0;
	...
	private final boolean method890(int i, int i_69_, GraphicsToolkit graphicstoolkit) {
		...
		Animator animator = !anAnimator10876.method245(-125) || anAnimator10876.method242((byte) -77) ? null
				: anAnimator10876;
		Animator animator_71_ = anAnimator10860.method245(-127) && !aBoolean11169
				&& (!aBoolean10867 || animator == null) ? anAnimator10860 : null;
		...
		boolean bool = aByte10888 != 0 && (Class174.clientCycle ^ 0xffffffff) <= (anInt10895 ^ 0xffffffff)
				&& Class174.clientCycle < anInt10882;
		if (bool)
			i |= 0x80000;
		DrawableModel drawablemodel = aDrawableModelArray10909[0] = playerDefs.method3279(
				EntityNode_Sub3_Sub1.aClass86_9166, animator, 77, true, InputStream_Sub2.aClass281_83,
				Class18.aClass37_306, i, anIntArray10881, Class63.aClass363_922, Class42.aClass181_643, graphicstoolkit,
				Class366.aClass279_4526, anAnimableAnimator_Sub1Array10894, i_74_, animator_71_, Class24.aClass275_442);
	...
	public final String method891(boolean bool, int i) {
		if (i != 1)
			return null;
		anInt11179++;
		if (!bool)
	...
	public final String method893(boolean bool, boolean bool_79_) {
		anInt11136++;
		String string = "";
		if (CacheNode_Sub19.aStringArray9622 != null)
			string += CacheNode_Sub19.aStringArray9622[aByte11145];
		...
		String nameToDisplay = bool_79_ ? displayName : realName;
		string += isSuffix ? nameToDisplay + title : nameToDisplay;
		if (Class320_Sub15.aStringArray8354 != null)
			string += Class320_Sub15.aStringArray8354[aByte11145];
		return string;
	}

	public final void method894(int i, int i_80_, int i_81_, byte b) {
		...
		for (int i_82_ = 0; (i_82_ ^ 0xffffffff) > (aClass165Array10886.length ^ 0xffffffff); i_82_++)
			if ((aClass165Array10886[i_82_].graphicsId ^ 0xffffffff) != 0) {
				Login class195 = Class16.aClass101_228.method1090(i_81_ ^ ~0x24c3,
						aClass165Array10886[i_82_].graphicsId);
				if (class195.aBoolean2402 && (class195.anInt2394 ^ 0xffffffff) != 0
						&& Class18.aClass37_306.method395(class195.anInt2394, (byte) -107).anInt718 == 1) {
		...
		if (i_81_ != -9380)
			getSize((byte) -74);
		anInt11180 = -1;
		if (i_80_ >= 0 && (Node_Sub54.GAME_SCENE_WDITH ^ 0xffffffff) < (i_80_ ^ 0xffffffff) && (i ^ 0xffffffff) <= -1
