...
public class PlayerDefinition {
	...
	public static final Class77[] method3277(int i) {
		anInt3432++;
		if (i != 12247)
			return null;
	...
	private final void method3276(int i) {
		...
		aLong3440 = -1L;
		aLong3440 = ls[(int) ((aLong3440 ^ anInt3429 >> 8) & 0xffL)] ^ aLong3440 >>> 8;
		aLong3440 = aLong3440 >>> 8 ^ ls[(int) ((anInt3429 ^ aLong3440) & 0xffL)];
		if (i != 21428)
			anIntArray3430 = null;
		for (int element : anIntArray3435) {
			aLong3440 = ls[(int) (0xffL & (aLong3440 ^ element >> 24))] ^ aLong3440 >>> 8;
			aLong3440 = ls[(int) (0xffL & (element >> 16 ^ aLong3440))] ^ aLong3440 >>> 8;
			aLong3440 = aLong3440 >>> 8 ^ ls[(int) (0xffL & (aLong3440 ^ element >> 8))];
			aLong3440 = aLong3440 >>> 8 ^ ls[(int) ((aLong3440 ^ element) & 0xffL)];
		}
				...
				if (aClass38Array3431[i_1_] != null) {
					...
					if (is_2_ != null)
						for (int element : is_2_) {
							aLong3440 = aLong3440 >>> 8 ^ ls[(int) (0xffL & (element >> 8 ^ aLong3440))];
							aLong3440 = ls[(int) ((element ^ aLong3440) & 0xffL)] ^ aLong3440 >>> 8;
						}
					if (is != null)
						for (int i_4_ = 0; (i_4_ ^ 0xffffffff) > (is.length ^ 0xffffffff); i_4_++) {
							aLong3440 = aLong3440 >>> 8 ^ ls[(int) (0xffL & (aLong3440 ^ is[i_4_] >> 8))];
							aLong3440 = aLong3440 >>> 8 ^ ls[(int) ((aLong3440 ^ is[i_4_]) & 0xffL)];
						}
					if (aClass38Array3431[i_1_].modifiedModelColors != null)
						for (int i_5_ = 0; (aClass38Array3431[i_1_].modifiedModelColors.length ^ 0xffffffff) < (i_5_
								^ 0xffffffff); i_5_++) {
							aLong3440 = aLong3440 >>> 8
									^ ls[(int) ((aClass38Array3431[i_1_].modifiedModelColors[i_5_] >> 8 ^ aLong3440)
											& 0xffL)];
							aLong3440 = aLong3440 >>> 8 ^ ls[(int) (0xffL
									& (aClass38Array3431[i_1_].modifiedModelColors[i_5_] ^ aLong3440))];
						}
					if (aClass38Array3431[i_1_].modifiedTextureColors != null)
						for (int i_6_ = 0; (aClass38Array3431[i_1_].modifiedTextureColors.length ^ 0xffffffff) < (i_6_
								^ 0xffffffff); i_6_++) {
							aLong3440 = aLong3440 >>> 8 ^ ls[(int) (0xffL
									& (aLong3440 ^ aClass38Array3431[i_1_].modifiedTextureColors[i_6_] >> 8))];
							aLong3440 = ls[(int) ((aClass38Array3431[i_1_].modifiedTextureColors[i_6_] ^ aLong3440)
									& 0xffL)] ^ aLong3440 >>> 8;
						}
				}
		for (int i_7_ = 0; (i_7_ ^ 0xffffffff) > -11; i_7_++)
			aLong3440 = aLong3440 >>> 8 ^ ls[(int) (0xffL & (anIntArray3430[i_7_] ^ aLong3440))];
		aLong3440 = ls[(int) (0xffL & ((aBoolean3434 ? 1 : 0) ^ aLong3440))] ^ aLong3440 >>> 8;
	}

	public final void method3278(int[] is, int[] is_8_, TemporaryItemDefinition[] class38s, int i, int i_9_, boolean bool,
			byte b) {
	...
	public final DrawableModel method3279(Class86 class86, Animator animator, int i, boolean bool, Class281 class281,
			Class37 class37, int i_11_, int[] is, Class363 class363, Class181 class181, GraphicsToolkit graphicstoolkit,
			Class279 class279, Animator[] animators, int i_12_, Animator animator_13_, Interface17 interface17) {
		anInt3438++;
		if (toNPCId != -1)
			return class279.getNPCDefinitions(toNPCId).prepareModel(interface17, graphicstoolkit, class281,
					(byte) -115, animator, i_12_, is, null, animator_13_, i_11_, animators);
		int i_14_ = i_11_;
		long l = aLong3440;
			...
			if (class48 != null && (class48.anInt716 >= 0 || (class48.anInt713 ^ 0xffffffff) <= -1)) {
				...
				if (class48.anInt716 >= 0 && (class363.anInt4506 ^ 0xffffffff) != 0) {
					if ((class48.anInt716 ^ 0xffffffff) == -65536) {
						...
						for (int i_19_ = 0; (class363.anIntArray4501.length ^ 0xffffffff) < (i_19_
								^ 0xffffffff); i_19_++)
				...
				if ((class48.anInt713 ^ 0xffffffff) <= -1 && class363.anInt4504 != -1) {
					...
					if (class48.anInt713 != 65535) {
						...
						l ^= is_15_[class363.anInt4504];
					} else {
						is_15_[class363.anInt4504] = 0;
						for (int i_22_ = 0; (class363.anIntArray4507.length ^ 0xffffffff) < (i_22_
								^ 0xffffffff); i_22_++)
			...
			for (int i_30_ = 0; (i_30_ ^ 0xffffffff) > (is_15_.length ^ 0xffffffff); i_30_++) {
				...
				if (bool_16_)
					if (class363.anInt4506 != i_30_) {
						for (int i_33_ = 0; (class363.anIntArray4501.length ^ 0xffffffff) < (i_33_
								^ 0xffffffff); i_33_++)
				...
				if (bool_17_)
					if (class363.anInt4504 != i_30_) {
						for (int i_34_ = 0; (class363.anIntArray4507.length ^ 0xffffffff) < (i_34_
								^ 0xffffffff); i_34_++)
				...
				if ((i_31_ & 0x40000000) == 0) {
					if ((~0x7fffffff & i_31_) != 0
							&& !class181.method1825(i_31_ & 0x3fffffff, (byte) 119).method3229(0))
						bool_29_ = true;
				} else {
			...
			if (bool_29_) {
				...
				for (int i_35_ = 0; (is_15_.length ^ 0xffffffff) < (i_35_ ^ 0xffffffff); i_35_++) {
					...
					if ((i_36_ & 0x40000000) == 0) {
						...
						Model model = class86.method1010(0x3fffffff & i_36_, 14434).method1683(class38, aBoolean3434,
								-114);
						if (model != null)
							models[i_35_] = model;
					}
				...
				for (int i_45_ = 0; i_45_ < 10; i_45_++)
					for (int i_46_ = 0; (i_46_ ^ 0xffffffff) > (Class45.aShortArrayArray5265[i_45_].length
							^ 0xffffffff); i_46_++)
						if (Class117_Sub2.aShortArrayArrayArray5151[i_45_][i_46_].length > anIntArray3430[i_45_])
							drawablemodel.ia(Class45.aShortArrayArray5265[i_45_][i_46_],
									Class117_Sub2.aShortArrayArrayArray5151[i_45_][i_46_][anIntArray3430[i_45_]]);
				if (bool) {
	...
	public final void method3280(int i, boolean bool) {
		aBoolean3434 = bool;
		anInt3441++;
		if (i == 26328)
			method3276(21428);
	...
	public final void method3281(int i, byte b, Class181 class181, int i_54_) {
		anInt3424++;
	...
	public final void method3282(int i, int i_56_, byte b) {
		anInt3433++;
		if (b < -35) {
	...
	public final DrawableModel method3283(Animator animator, int i, int i_57_, Class37 class37,
			GraphicsToolkit graphicstoolkit, byte b, Class181 class181, int i_58_, int i_59_) {
		anInt3427++;
		int i_60_ = animator == null ? i_59_ : i_59_ | animator.method237((byte) -127);
		long l = i | ((long) i_57_ << 32 | i_58_ << 16);
		DrawableModel drawablemodel;
			...
			for (int i_63_ = 0; (i_63_ ^ 0xffffffff) > -11; i_63_++)
				for (int i_64_ = 0; Class45.aShortArrayArray5265[i_63_].length > i_64_; i_64_++)
					if (anIntArray3430[i_63_] < Class117_Sub2.aShortArrayArrayArray5151[i_63_][i_64_].length)
						drawablemodel.ia(Class45.aShortArrayArray5265[i_63_][i_64_],
								Class117_Sub2.aShortArrayArrayArray5151[i_63_][i_64_][anIntArray3430[i_63_]]);
	...
	public final void method3284(byte b, int i, int i_66_, Class86 class86) {
		anInt3426++;
		if (i == -1)
	...
	public final DrawableModel prepareModelToInterface(Class181 class181, byte b, Class37 class37, Interface17 interface17,
			Animator animator, Class86 class86, Class279 class279, GraphicsToolkit graphicstoolkit, int i) {
		anInt3428++;
		if ((toNPCId ^ 0xffffffff) != 0)
			return class279.getNPCDefinitions(toNPCId).prepareModelToInterface(i, animator, null, 412761072,
					graphicstoolkit, interface17);
			...
			for (int i_70_ = 0; anIntArray3435.length > i_70_; i_70_++) {
				...
				if ((i_71_ & 0x40000000 ^ 0xffffffff) != -1) {
					...
					if (!class86.method1010(0x3fffffff & i_71_, 14434).method1692(b ^ ~0x51, class38, aBoolean3434))
						bool = true;
				} else if ((~0x7fffffff & i_71_) != 0
						&& !class181.method1825(0x3fffffff & i_71_, (byte) 109).method3228(true))
					bool = true;
			}
			if (bool)
				return null;
			...
			for (int i_75_ = 0; i_75_ < 10; i_75_++)
				for (int i_76_ = 0; i_76_ < Class45.aShortArrayArray5265[i_75_].length; i_76_++)
					if (anIntArray3430[i_75_] < Class117_Sub2.aShortArrayArrayArray5151[i_75_][i_76_].length)
						drawablemodel.ia(Class45.aShortArrayArray5265[i_75_][i_76_],
								Class117_Sub2.aShortArrayArrayArray5151[i_75_][i_76_][anIntArray3430[i_75_]]);
