...
public class PlayerMasks {
	public static IncomingPacket aClass192_1218 = new IncomingPacket(22, 10);
	public static OutgoingPacket aClass318_1220 = new OutgoingPacket(33, 0);
	public static long[][][] aLongArrayArrayArray1228;
	public static int anInt1208;
	public static int anInt1209;
	public static int anInt1219;
	public static int anInt1224;
	public static int devConsoleSprite;

	public static final void decodePlayerMasks(int i, Player player, int playerIndex, Packet packet, int mask) {
		anInt1209++;
		...
		if ((mask & 0x20000 ^ 0xffffffff) != -1) { // Body glow
			...
			// System.out.println("Packet received "+player.aByte10896+",
			// "+player.aByte10878+", "+player.aByte10884+", "+
			// player.aByte10888+", "+player.anInt10895+", "+player.anInt10882);
		}
		if ((0x200 & mask) != 0)
		...
		if ((0x4 & mask ^ 0xffffffff) != -1) { // send hits
			...
			if ((hitsCount ^ 0xffffffff) < -1)
				for (int i_21_ = 0; i_21_ < hitsCount; i_21_++) {
					...
					player.method852(soakingDamage, delay, currentHp, (byte) -122, damage, Class174.clientCycle,
							soakingMark, type);
				}
		}
		...
		if ((mask & 0x4000 ^ 0xffffffff) != -1) { // force talk
			...
			if (string.charAt(0) == '~') {
				...
				Class28.method331(string, player.method893(false, true), -110, 0, player.displayName,
						player.method891(false, i + 2), 2);
			} else if (player == Player.get)
				Class28.method331(string, player.method893(false, true), i + -62, 0, player.displayName,
						player.method891(false, 1), 2);
	...
	public static final void method1033(int i, int i_46_, int i_47_, int i_48_, int i_49_, int i_50_) {
		anInt1224++;
		if (i_50_ != Class213.aNode_Sub27_2512.aClass320_Sub25_7295.method3776(false) && i_48_ != 0
				&& (Class23.anInt434 ^ 0xffffffff) > -51 && (i_47_ ^ 0xffffffff) != 0)
			Node_Sub38_Sub19.aClass78Array10284[Class23.anInt434++] = new Class78((byte) 1, i_47_, i_48_, i_46_, i_49_,
					0, i, null);
	}
	...
	public static final void method1035(int i) {
		anInt1219++;
		...
		while ((packet.method2264(Class218.aClass123_2566.anInt1581, -92) ^ 0xffffffff) <= -16) {
			...
			if ((index ^ 0xffffffff) == -32768)
				break;
			boolean bool = false;
			Node_Sub41 node_sub41 = (Node_Sub41) Class12.aHashTable187.getNode(3512, index);
			if (node_sub41 == null) {
				NPC npc = new NPC();
				npc.index = index;
				node_sub41 = new Node_Sub41(npc);
				Class12.aHashTable187.put(index, node_sub41, -123);
			...
			if (npc.defs != null && npc.defs.method2998((byte) 91))
			...
			npc.setDefs(Class366.aClass279_4526.getNPCDefinitions(packet.readBits(15)), true);
			...
			npc.method877(-15694, i_57_ == 1, i_54_ + Player.get.scenePositionYQueue[0],
					i_56_ + Player.get.scenePositionXQueue[0], i_55_, npc.getSize((byte) 91));
			if (npc.defs.method2998((byte) 91))
				Class262_Sub1.method3150(npc.plane, null, npc.scenePositionXQueue[0], npc.scenePositionYQueue[0], npc,
						null, (byte) -8, 0);
		}
	...
	public static final int method1036(int i, float f, float f_58_, float f_59_) {
		anInt1208++;
		if (i != 2)
			method1034((byte) -50);
