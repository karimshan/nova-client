...
public class PlayerUpdateReference {
	public static Class151 aClass151_4080 = new Class151(12, 0, 1, 0);
	public static int anInt4075;
	public static int anInt4078;
	public static int anInt4081;
	public static int[] anIntArray4083 = { 0, -1, 0, 1 };
	public static int[] anIntArray4084 = new int[256];

	public static final void method3807(int i, int i_0_, int i_1_) {
	...
	public static final void method3808(boolean bool, int i) {
		anInt4075++;
		for (Node_Sub47 node_sub47 = (Node_Sub47) Class290_Sub6.aClass312_8122
				.method3613(65280); node_sub47 != null; node_sub47 = (Node_Sub47) Class290_Sub6.aClass312_8122
						.method3620(16776960)) {
		...
		if (i == -1)
			if (bool) {
				...
				for (Node_Sub47 node_sub47 = (Node_Sub47) Class320_Sub3.aHashTable8234
						.method1516(false); node_sub47 != null; node_sub47 = (Node_Sub47) Class320_Sub3.aHashTable8234
								.method1520(i + 125)) {
					if (node_sub47.aNode_Sub9_Sub2_7568 != null) {
						Class176.aNode_Sub9_Sub3_2106.method2514(node_sub47.aNode_Sub9_Sub2_7568);
						node_sub47.aNode_Sub9_Sub2_7568 = null;
	...
	public static final void method3809(int i, int i_2_, int i_3_, CacheNode_Sub4 cachenode_sub4) {
		anInt4081++;
		if (Class213.aBoolean2510) {
			int i_4_ = 0;
			for (CacheNode_Sub13 cachenode_sub13 = (CacheNode_Sub13) cachenode_sub4.aClass158_9457.method1723(
					13); cachenode_sub13 != null; cachenode_sub13 = (CacheNode_Sub13) cachenode_sub4.aClass158_9457
							.method1721(0)) {
	...
	public static final byte method3810(int i, boolean bool, int i_10_) {
		if (bool != false)
			return (byte) 71;
		anInt4078++;
		if ((i ^ 0xffffffff) != -10)
