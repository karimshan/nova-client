...
public class ProducingGraphicsBuffer extends GraphicsBuffer implements ImageProducer {
	public static boolean aBoolean9900 = false;
	public static Class212 aClass212_9894;
	...
	public static int[] anIntArray9881;
	public static int[] anIntArray9895;
	public static Interface17 anInterface17_9901;
	static {
	...
	public static final void method2601(int i) {
		...
		if (i < -33) {
			...
			if (Class186.aBoolean2255) {
				...
				KeyStrokes.aShort3667 = Node_Sub38_Sub23.aShort10345;
	...
	public static final boolean method2603(int i, boolean bool, int i_9_) {
		if (bool != false)
	...
	public static final void method2604(int i, int i_10_) {
		anInt9885++;
	...
	@Override
	public final void method2595(boolean bool, int i, int i_5_, java.awt.Canvas canvas) {
		anInt7142 = i_5_;
		aCanvas9889 = canvas;
		anInt9884++;
		anInt7146 = i;
	...
	@Override
	public final void method2597(int i, int i_0_, int i_1_, boolean bool, Graphics graphics, int i_2_, int i_3_, int i_4_) {
		if (bool == false) {
	...
	private final synchronized void method2599(int i, int i_6_, int i_7_, boolean bool, int i_8_) {
		...
		if (anImageConsumer9899 != null) {
			anImageConsumer9899.setPixels(i, i_6_, i_8_, i_7_, aColorModel9892, anIntArray7145, i + i_6_ * anInt7146,
					anInt7146);
			if (bool != false)
				method2601(112);
