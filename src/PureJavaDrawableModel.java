...
public class PureJavaDrawableModel extends DrawableModel {
	public static int anInt5724 = 4096;
	public static int anInt5742 = 4096;
	...
	PureJavaDrawableModel(PureJavaToolkit purejavatoolkit, Model model, int i, int i_850_, int i_851_, int i_852_) {
		...
		for (int i_854_ = 0; i_854_ < anInt5711; i_854_++) {
			...
			if (model.aClass17Array2621 != null) {
				...
				for (Class17 class17 : model.aClass17Array2621) {
					if (i_855_ == class17.anInt273) {
						...
						if (class352.anInt4330 != -1) {
							PlayerMasks class91_862_ = var_d.method10(class352.anInt4330, -8217);
			...
			boolean bool_864_ = aByteArray5784 != null && aByteArray5784[i_855_] != 0
					|| class91 != null && class91.anInt1226 == 2;
			...
			ls[i_854_] = ((long) i_856_ << 32) + i_857_;
		...
		if (model.aClass17Array2621 != null) {
			...
			for (int i_865_ = 0; i_865_ < model.aClass17Array2621.length; i_865_++) {
				...
				i_866_ = i_866_ | 255
						- (model.aByteArray2622 != null ? model.aByteArray2622[class17.anInt273] & 0xff : 0) << 24;
				aClass209Array5790[i_865_] = new Class209(class17.anInt273, model.aShortArray2600[class17.anInt273],
						model.aShortArray2583[class17.anInt273], model.aShortArray2589[class17.anInt273],
						class352.anInt4334, class352.anInt4326, class352.anInt4330, class352.anInt4336,
						class352.anInt4324, class352.aBoolean4325, class17.anInt278);
		...
		for (int i_868_ = 0; i_868_ < anInt5711; i_868_++) {
			...
			if (i_871_ != -1 && (i_852_ & 0x40) != 0) {
				PlayerMasks class91 = var_d.method10(i_871_ & 0xffff, -8217);
			...
			if (i_871_ != -1) {
				...
				if (i_870_ == -1) {
					...
					if (b == 0) {
						...
						float f = anIntArray5748[s_877_];
						float f_880_ = anIntArray5772[s_877_];
						float f_881_ = anIntArray5717[s_877_];
						float f_882_ = anIntArray5748[s_878_] - f;
						float f_883_ = anIntArray5772[s_878_] - f_880_;
						float f_884_ = anIntArray5717[s_878_] - f_881_;
						float f_885_ = anIntArray5748[s_879_] - f;
						float f_886_ = anIntArray5772[s_879_] - f_880_;
						float f_887_ = anIntArray5717[s_879_] - f_881_;
						float f_888_ = anIntArray5748[s] - f;
						float f_889_ = anIntArray5772[s] - f_880_;
						float f_890_ = anIntArray5717[s] - f_881_;
						float f_891_ = anIntArray5748[s_875_] - f;
						float f_892_ = anIntArray5772[s_875_] - f_880_;
						float f_893_ = anIntArray5717[s_875_] - f_881_;
						float f_894_ = anIntArray5748[s_876_] - f;
						float f_895_ = anIntArray5772[s_876_] - f_880_;
						float f_896_ = anIntArray5717[s_876_] - f_881_;
						...
						float f = model.anIntArray2617[i_870_] / 256.0F;
						if (b == 1) {
							float f_911_ = model.anIntArray2593[i_870_] / 1024.0F;
							Class262_Sub1.method3151(fs_909_, f, i_908_, anIntArray5748[s], b_910_, fs, f_911_, i_907_,
									-2356, anIntArray5772[s], anIntArray5717[s], i_906_);
							fs_872_[0] = fs[0];
							fs_873_[0] = fs[1];
							Class262_Sub1.method3151(fs_909_, f, i_908_, anIntArray5748[s_904_], b_910_, fs, f_911_,
									i_907_, -2356, anIntArray5772[s_904_], anIntArray5717[s_904_], i_906_);
							fs_872_[1] = fs[0];
							fs_873_[1] = fs[1];
							Class262_Sub1.method3151(fs_909_, f, i_908_, anIntArray5748[s_905_], b_910_, fs, f_911_,
									i_907_, -2356, anIntArray5772[s_905_], anIntArray5717[s_905_], i_906_);
							fs_872_[2] = fs[0];
							fs_873_[2] = fs[1];
							...
							float f_913_ = model.anIntArray2615[i_870_] / 256.0F;
							float f_914_ = model.anIntArray2584[i_870_] / 256.0F;
							...
							float f_924_ = 64.0F / model.anIntArray2603[i_870_];
							float f_925_ = 64.0F / model.anIntArray2588[i_870_];
							float f_926_ = 64.0F / model.anIntArray2593[i_870_];
							float f_927_ = (i_921_ * fs_909_[0] + i_922_ * fs_909_[1] + i_923_ * fs_909_[2]) / f_924_;
							float f_928_ = (i_921_ * fs_909_[3] + i_922_ * fs_909_[4] + i_923_ * fs_909_[5]) / f_925_;
							float f_929_ = (i_921_ * fs_909_[6] + i_922_ * fs_909_[7] + i_923_ * fs_909_[8]) / f_926_;
							int i_930_ = PlayerMasks.method1036(2, f_929_, f_927_, f_928_);
							Class39.method407(f, i_930_, anIntArray5748[s], f_913_, i_907_, fs, anIntArray5772[s], 99,
									anIntArray5717[s], i_906_, i_908_, f_914_, fs_909_, b_910_);
							fs_872_[0] = fs[0];
							fs_873_[0] = fs[1];
							Class39.method407(f, i_930_, anIntArray5748[s_904_], f_913_, i_907_, fs,
									anIntArray5772[s_904_], 108, anIntArray5717[s_904_], i_906_, i_908_, f_914_,
									fs_909_, b_910_);
							fs_872_[1] = fs[0];
							fs_873_[1] = fs[1];
							Class39.method407(f, i_930_, anIntArray5748[s_905_], f_913_, i_907_, fs,
									anIntArray5772[s_905_], 75, anIntArray5717[s_905_], i_906_, i_908_, f_914_, fs_909_,
									b_910_);
							fs_872_[2] = fs[0];
							fs_873_[2] = fs[1];
						} else if (b == 3) {
							Class212.method2053(i_906_, anIntArray5717[s], anIntArray5772[s], fs, i_908_, f, fs_909_,
									b_910_, anIntArray5748[s], -4, i_907_);
							fs_872_[0] = fs[0];
							fs_873_[0] = fs[1];
							Class212.method2053(i_906_, anIntArray5717[s_904_], anIntArray5772[s_904_], fs, i_908_, f,
									fs_909_, b_910_, anIntArray5748[s_904_], -4, i_907_);
							fs_872_[1] = fs[0];
							fs_873_[1] = fs[1];
							Class212.method2053(i_906_, anIntArray5717[s_905_], anIntArray5772[s_905_], fs, i_908_, f,
									fs_909_, b_910_, anIntArray5748[s_905_], -4, i_907_);
							fs_872_[2] = fs[0];
							fs_873_[2] = fs[1];
							if ((b_910_ & 0x1) == 0) {
		...
		if (model.aShortArray2587 != null) {
			...
			for (int i_932_ = 0; i_932_ < anInt5711; i_932_++) {
				...
				if (s != -1) {
					PlayerMasks class91 = aPureJavaToolkit5770.aD1543.method10(s, -8217);
					if ((i_852_ & 0x40) == 0 || !class91.aBoolean1223) {
	...
	@Override
	public final void aa(short s, short s_721_) {
		if (aShortArray5773 != null) {
			if (!aBoolean5788 && s_721_ >= 0) {
				PlayerMasks class91 = aPureJavaToolkit5770.aD1543.method10(s_721_ & 0xffff, -8217);
				if (class91.aByte1211 != 0 || class91.aByte1203 != 0)
					aBoolean5788 = true;
			}
	...
	@Override
	public final void H(int i, int i_297_, int i_298_) {
	...
	@Override
	public final void I(int i, int[] is, int i_31_, int i_32_, int i_33_, boolean bool, int i_34_, int[] is_35_) {
		int i_36_ = is.length;
		if (i == 0) {
			i_31_ <<= 4;
			i_32_ <<= 4;
			...
			if (is_35_ != null) {
				...
				for (int i_94_ = 0; i_94_ < i_36_; i_94_++) {
					...
					if (i_95_ < anIntArrayArray5722.length) {
						...
						for (int element : is_96_) {
							int i_98_ = element;
							if (aShortArray5747 == null || (i_34_ & aShortArray5747[i_98_]) != 0) {
								int i_99_ = is_86_[0] * anIntArray5748[i_98_] + is_86_[1] * anIntArray5772[i_98_]
										+ is_86_[2] * anIntArray5717[i_98_] + 8192 >> 14;
								int i_100_ = is_86_[3] * anIntArray5748[i_98_] + is_86_[4] * anIntArray5772[i_98_]
										+ is_86_[5] * anIntArray5717[i_98_] + 8192 >> 14;
								int i_101_ = is_86_[6] * anIntArray5748[i_98_] + is_86_[7] * anIntArray5772[i_98_]
										+ is_86_[8] * anIntArray5717[i_98_] + 8192 >> 14;
								i_99_ += i_91_;
								i_100_ += i_92_;
								i_101_ += i_93_;
						...
						for (int element : is_104_) {
							...
							if (aShortArray5747 == null || (i_34_ & aShortArray5747[i_106_]) != 0) {
								...
								if (i_33_ != 0) {
									...
									int i_109_ = anIntArray5772[i_106_] * i_107_ + anIntArray5748[i_106_] * i_108_
											+ 16383 >> 14;
									anIntArray5772[i_106_] = anIntArray5772[i_106_] * i_108_
											- anIntArray5748[i_106_] * i_107_ + 16383 >> 14;
									anIntArray5748[i_106_] = i_109_;
								}
								if (i_31_ != 0) {
									int i_110_ = Class335.anIntArray4167[i_31_];
									int i_111_ = Class335.anIntArray4165[i_31_];
									int i_112_ = anIntArray5772[i_106_] * i_111_ - anIntArray5717[i_106_] * i_110_
											+ 16383 >> 14;
									anIntArray5717[i_106_] = anIntArray5772[i_106_] * i_110_
											+ anIntArray5717[i_106_] * i_111_ + 16383 >> 14;
									anIntArray5772[i_106_] = i_112_;
								}
								if (i_32_ != 0) {
									int i_113_ = Class335.anIntArray4167[i_32_];
									int i_114_ = Class335.anIntArray4165[i_32_];
									int i_115_ = anIntArray5717[i_106_] * i_113_ + anIntArray5748[i_106_] * i_114_
											+ 16383 >> 14;
									anIntArray5717[i_106_] = anIntArray5717[i_106_] * i_114_
											- anIntArray5748[i_106_] * i_113_ + 16383 >> 14;
			...
			if (is_35_ != null) {
				...
				for (int i_147_ = 0; i_147_ < i_36_; i_147_++) {
					...
					if (i_148_ < anIntArrayArray5722.length) {
						...
						for (int element : is_149_) {
							int i_151_ = element;
							if (aShortArray5747 == null || (i_34_ & aShortArray5747[i_151_]) != 0) {
								int i_152_ = is_139_[0] * anIntArray5748[i_151_] + is_139_[1] * anIntArray5772[i_151_]
										+ is_139_[2] * anIntArray5717[i_151_] + 8192 >> 14;
								int i_153_ = is_139_[3] * anIntArray5748[i_151_] + is_139_[4] * anIntArray5772[i_151_]
										+ is_139_[5] * anIntArray5717[i_151_] + 8192 >> 14;
								int i_154_ = is_139_[6] * anIntArray5748[i_151_] + is_139_[7] * anIntArray5772[i_151_]
										+ is_139_[8] * anIntArray5717[i_151_] + 8192 >> 14;
								i_152_ += i_144_;
								i_153_ += i_145_;
								i_154_ += i_146_;
			...
			if (anIntArrayArray5725 != null && aByteArray5784 != null) {
				...
				if (aClass209Array5790 != null)
					for (int i_166_ = 0; i_166_ < anInt5762; i_166_++) {
						...
						class214.anInt2519 = class214.anInt2519 & 0xffffff
								| 255 - (aByteArray5784[class209.anInt2485] & 0xff) << 24;
					}
			}
		} else if (i == 7) {
			if (anIntArrayArray5725 != null) {
				...
				if (aClass209Array5790 != null)
					for (int i_176_ = 0; i_176_ < anInt5762; i_176_++) {
						...
						class214.anInt2519 = class214.anInt2519 & ~0xffffff | Class170.anIntArray2054[Node_Sub15_Sub2
								.method2560(5310, aShortArray5740[class209.anInt2485] & 0xffff) & 0xffff] & 0xffffff;
					}
			}
		} else if (i == 8) {
			if (anIntArrayArray5783 != null)
				for (int i_177_ = 0; i_177_ < i_36_; i_177_++) {
					...
					if (i_178_ < anIntArrayArray5783.length) {
						...
						for (int element : is_179_) {
							Class214 class214 = aClass214Array5765[element];
	...
	@Override
	public final void ia(short s, short s_262_) {
		for (int i = 0; i < anInt5711; i++)
		...
		if (aClass209Array5790 != null)
			for (int i = 0; i < anInt5762; i++) {
				...
				class214.anInt2519 = class214.anInt2519 & ~0xffffff
						| Class170.anIntArray2054[Node_Sub15_Sub2.method2560(5310, aShortArray5740[class209.anInt2485])
								& 0xffff] & 0xffffff;
			}
		if (anInt5744 == 2)
			anInt5744 = 1;
			...
			if (i == 4096)
				...
				synchronized (this) {
					for (int i_490_ = 0; i_490_ < anInt5753; i_490_++) {
						...
						anIntArray5717[i_490_] = anIntArray5717[i_490_] * i_489_
								- anIntArray5748[i_490_] * i_488_ >> 14;
						anIntArray5748[i_490_] = i_491_;
						if (aClass354Array5774[i_490_] != null) {
							i_491_ = aClass354Array5774[i_490_].anInt4346 * i_488_
									+ aClass354Array5774[i_490_].anInt4347 * i_489_ >> 14;
							aClass354Array5774[i_490_].anInt4346 = aClass354Array5774[i_490_].anInt4346 * i_489_
									- aClass354Array5774[i_490_].anInt4347 * i_488_ >> 14;
					...
					if (aClass272Array5775 != null)
						for (int i_492_ = 0; i_492_ < anInt5711; i_492_++)
							if (aClass272Array5775[i_492_] != null) {
								int i_493_ = aClass272Array5775[i_492_].anInt3483 * i_488_
										+ aClass272Array5775[i_492_].anInt3484 * i_489_ >> 14;
								aClass272Array5775[i_492_].anInt3483 = aClass272Array5775[i_492_].anInt3483 * i_489_
										- aClass272Array5775[i_492_].anInt3484 * i_488_ >> 14;
					...
					for (int i_494_ = anInt5753; i_494_ < anInt5718; i_494_++) {
						...
						anIntArray5717[i_494_] = anIntArray5717[i_494_] * i_489_
								- anIntArray5748[i_494_] * i_488_ >> 14;
	...
	public final void method614(Class336 class336) {
		...
		if (aClass300Array5782 != null)
			for (Class300 class300 : aClass300Array5782) {
				Class300 class300_239_ = class300;
				if (class300.aClass300_3763 != null)
					class300_239_ = class300.aClass300_3763;
				class300_239_.anInt3769 = (int) (class336_sub2.aFloat8583
						+ (class336_sub2.aFloat8580 * anIntArray5748[class300.anInt3764]
								+ class336_sub2.aFloat8571 * anIntArray5772[class300.anInt3764]
								+ class336_sub2.aFloat8566 * anIntArray5717[class300.anInt3764]));
				class300_239_.anInt3751 = (int) (class336_sub2.aFloat8579
						+ (class336_sub2.aFloat8578 * anIntArray5748[class300.anInt3764]
								+ class336_sub2.aFloat8561 * anIntArray5772[class300.anInt3764]
								+ class336_sub2.aFloat8558 * anIntArray5717[class300.anInt3764]));
				class300_239_.anInt3753 = (int) (class336_sub2.aFloat8589
						+ (class336_sub2.aFloat8577 * anIntArray5748[class300.anInt3764]
								+ class336_sub2.aFloat8567 * anIntArray5772[class300.anInt3764]
								+ class336_sub2.aFloat8584 * anIntArray5717[class300.anInt3764]));
				class300_239_.anInt3766 = (int) (class336_sub2.aFloat8583
						+ (class336_sub2.aFloat8580 * anIntArray5748[class300.anInt3757]
								+ class336_sub2.aFloat8571 * anIntArray5772[class300.anInt3757]
								+ class336_sub2.aFloat8566 * anIntArray5717[class300.anInt3757]));
				class300_239_.anInt3756 = (int) (class336_sub2.aFloat8579
						+ (class336_sub2.aFloat8578 * anIntArray5748[class300.anInt3757]
								+ class336_sub2.aFloat8561 * anIntArray5772[class300.anInt3757]
								+ class336_sub2.aFloat8558 * anIntArray5717[class300.anInt3757]));
				class300_239_.anInt3758 = (int) (class336_sub2.aFloat8589
						+ (class336_sub2.aFloat8577 * anIntArray5748[class300.anInt3757]
								+ class336_sub2.aFloat8567 * anIntArray5772[class300.anInt3757]
								+ class336_sub2.aFloat8584 * anIntArray5717[class300.anInt3757]));
				class300_239_.anInt3761 = (int) (class336_sub2.aFloat8583
						+ (class336_sub2.aFloat8580 * anIntArray5748[class300.anInt3754]
								+ class336_sub2.aFloat8571 * anIntArray5772[class300.anInt3754]
								+ class336_sub2.aFloat8566 * anIntArray5717[class300.anInt3754]));
				class300_239_.anInt3752 = (int) (class336_sub2.aFloat8579
						+ (class336_sub2.aFloat8578 * anIntArray5748[class300.anInt3754]
								+ class336_sub2.aFloat8561 * anIntArray5772[class300.anInt3754]
								+ class336_sub2.aFloat8558 * anIntArray5717[class300.anInt3754]));
				class300_239_.anInt3771 = (int) (class336_sub2.aFloat8589
						+ (class336_sub2.aFloat8577 * anIntArray5748[class300.anInt3754]
								+ class336_sub2.aFloat8567 * anIntArray5772[class300.anInt3754]
								+ class336_sub2.aFloat8584 * anIntArray5717[class300.anInt3754]));
			}
		if (aClass218Array5764 != null)
			for (Class218 element : aClass218Array5764) {
				...
				class218_240_.anInt2559 = (int) (class336_sub2.aFloat8583
						+ (class336_sub2.aFloat8580 * anIntArray5748[class218.anInt2554]
								+ class336_sub2.aFloat8571 * anIntArray5772[class218.anInt2554]
								+ class336_sub2.aFloat8566 * anIntArray5717[class218.anInt2554]));
				class218_240_.anInt2557 = (int) (class336_sub2.aFloat8579
						+ (class336_sub2.aFloat8578 * anIntArray5748[class218.anInt2554]
								+ class336_sub2.aFloat8561 * anIntArray5772[class218.anInt2554]
								+ class336_sub2.aFloat8558 * anIntArray5717[class218.anInt2554]));
				class218_240_.anInt2556 = (int) (class336_sub2.aFloat8589
						+ (class336_sub2.aFloat8577 * anIntArray5748[class218.anInt2554]
								+ class336_sub2.aFloat8567 * anIntArray5772[class218.anInt2554]
								+ class336_sub2.aFloat8584 * anIntArray5717[class218.anInt2554]));
			}
	}
	...
	@Override
	public final void method619(DrawableModel drawablemodel, int i, int i_282_, int i_283_, boolean bool) {
		...
		for (int i_287_ = 0; i_287_ < anInt5753; i_287_++) {
			...
			if (class354.anInt4345 != 0) {
				...
				if (i_288_ >= purejavadrawablemodel_284_.aShort5759
						&& i_288_ <= purejavadrawablemodel_284_.aShort5751) {
					int i_289_ = anIntArray5748[i_287_] - i;
					if (i_289_ >= purejavadrawablemodel_284_.aShort5757
							&& i_289_ <= purejavadrawablemodel_284_.aShort5766) {
						int i_290_ = anIntArray5717[i_287_] - i_283_;
						if (i_290_ >= purejavadrawablemodel_284_.aShort5732
								&& i_290_ <= purejavadrawablemodel_284_.aShort5730)
							for (int i_291_ = 0; i_291_ < i_286_; i_291_++) {
								Class354 class354_292_ = purejavadrawablemodel_284_.aClass354Array5774[i_291_];
								if (i_289_ == is[i_291_] && i_290_ == purejavadrawablemodel_284_.anIntArray5717[i_291_]
									...
									if (class354_294_ == null)
										class354_294_ = purejavadrawablemodel_284_.aClass354Array5735[i_291_] = new Class354(
												class354_292_);
		...
		if (i_285_ >= 3 && bool) {
			for (int i_295_ = 0; i_295_ < anInt5711; i_295_++)
				if (anIntArray5771[aShortArray5767[i_295_]] == anInt5780
						&& anIntArray5771[aShortArray5731[i_295_]] == anInt5780
						&& anIntArray5771[aShortArray5789[i_295_]] == anInt5780) {
			...
			for (int i_296_ = 0; i_296_ < purejavadrawablemodel_284_.anInt5711; i_296_++)
				if (anIntArray5749[purejavadrawablemodel_284_.aShortArray5767[i_296_]] == anInt5780
						&& anIntArray5749[purejavadrawablemodel_284_.aShortArray5731[i_296_]] == anInt5780
						&& anIntArray5749[purejavadrawablemodel_284_.aShortArray5789[i_296_]] == anInt5780) {
	...
	@Override
	public final boolean method621(int i, int i_263_, Class336 class336, boolean bool, int i_264_, int i_265_) {
		return method665(i, i_263_, class336, bool, i_264_, i_265_);
	}

	@Override
	public final void method622(Class336 class336, EntityNode_Sub5 entitynode_sub5, int i, int i_278_) {
		method680(class336, entitynode_sub5, i, i_278_);
	}

	@Override
	public final boolean method624(int i, int i_189_, Class336 class336, boolean bool, int i_190_) {
		return method665(i, i_189_, class336, bool, i_190_, -1);
	}

	@Override
	public final void method626(int i, int i_22_, int i_23_, int i_24_) {
	...
	@Override
	public final void method637(int i, int[] is, int i_300_, int i_301_, int i_302_, int i_303_, boolean bool) {
					...
					if ((i_303_ & 0x1) == 0)
						for (int element : is_320_) {
							...
							if (i_302_ != 0) {
								...
								int i_325_ = anIntArray5772[i_322_] * i_323_ + anIntArray5748[i_322_] * i_324_
										+ 16383 >> 14;
								anIntArray5772[i_322_] = anIntArray5772[i_322_] * i_324_
										- anIntArray5748[i_322_] * i_323_ + 16383 >> 14;
								anIntArray5748[i_322_] = i_325_;
							}
							if (i_300_ != 0) {
								int i_326_ = Class335.anIntArray4167[i_300_];
								int i_327_ = Class335.anIntArray4165[i_300_];
								int i_328_ = anIntArray5772[i_322_] * i_327_ - anIntArray5717[i_322_] * i_326_
										+ 16383 >> 14;
								anIntArray5717[i_322_] = anIntArray5772[i_322_] * i_326_
										+ anIntArray5717[i_322_] * i_327_ + 16383 >> 14;
								anIntArray5772[i_322_] = i_328_;
							}
							if (i_301_ != 0) {
								int i_329_ = Class335.anIntArray4167[i_301_];
								int i_330_ = Class335.anIntArray4165[i_301_];
								int i_331_ = anIntArray5717[i_322_] * i_329_ + anIntArray5748[i_322_] * i_330_
										+ 16383 >> 14;
								anIntArray5717[i_322_] = anIntArray5717[i_322_] * i_330_
										- anIntArray5748[i_322_] * i_329_ + 16383 >> 14;
						...
						for (int element : is_320_) {
							...
							if (i_300_ != 0) {
								...
								int i_336_ = anIntArray5772[i_333_] * i_335_ - anIntArray5717[i_333_] * i_334_
										+ 16383 >> 14;
								anIntArray5717[i_333_] = anIntArray5772[i_333_] * i_334_
										+ anIntArray5717[i_333_] * i_335_ + 16383 >> 14;
								anIntArray5772[i_333_] = i_336_;
							}
							if (i_302_ != 0) {
								int i_337_ = Class335.anIntArray4167[i_302_];
								int i_338_ = Class335.anIntArray4165[i_302_];
								int i_339_ = anIntArray5772[i_333_] * i_337_ + anIntArray5748[i_333_] * i_338_
										+ 16383 >> 14;
								anIntArray5772[i_333_] = anIntArray5772[i_333_] * i_338_
										- anIntArray5748[i_333_] * i_337_ + 16383 >> 14;
								anIntArray5748[i_333_] = i_339_;
							}
							if (i_301_ != 0) {
								int i_340_ = Class335.anIntArray4167[i_301_];
								int i_341_ = Class335.anIntArray4165[i_301_];
								int i_342_ = anIntArray5717[i_333_] * i_340_ + anIntArray5748[i_333_] * i_341_
										+ 16383 >> 14;
								anIntArray5717[i_333_] = anIntArray5717[i_333_] * i_341_
										- anIntArray5748[i_333_] * i_340_ + 16383 >> 14;
	...
	private final void method654(int i) {
		if (!aClass374_5741.aBoolean4617) {
				...
				if (i_12_ == 0)
					...
					if (aShortArray5773 == null || aShortArray5773[i] == -1) {
						if (anIntArray5761[i] == -1)
							aClass185_5712.method1852(anIntArray5716[s], anIntArray5716[s_7_], anIntArray5716[s_8_],
									anIntArray5713[s], anIntArray5713[s_7_], anIntArray5713[s_8_], anIntArray5758[s],
									anIntArray5758[s_7_], anIntArray5758[s_8_],
									Class249.method3086(i_9_ << 24 | aClass374_5741.anInt4611,
											Class170.anIntArray2054[anIntArray5754[i] & 0xffff], (byte) -56),
									Class249.method3086(i_10_ << 24 | aClass374_5741.anInt4611,
											Class170.anIntArray2054[anIntArray5754[i] & 0xffff], (byte) -56),
									Class249.method3086(i_11_ << 24 | aClass374_5741.anInt4611,
											Class170.anIntArray2054[anIntArray5754[i] & 0xffff], (byte) -56));
						else
							aClass185_5712.method1852(anIntArray5716[s], anIntArray5716[s_7_], anIntArray5716[s_8_],
									anIntArray5713[s], anIntArray5713[s_7_], anIntArray5713[s_8_], anIntArray5758[s],
									...
									Class249.method3086(i_9_ << 24 | aClass374_5741.anInt4611,
											Class170.anIntArray2054[anIntArray5754[i] & 0xffff], (byte) -56),
									Class249.method3086(i_10_ << 24 | aClass374_5741.anInt4611,
											Class170.anIntArray2054[anIntArray5739[i] & 0xffff], (byte) -56),
									Class249.method3086(i_11_ << 24 | aClass374_5741.anInt4611,
						...
						if (anIntArray5761[i] == -1) {
							...
							aClass185_5712.method1863(anIntArray5716[s], anIntArray5716[s_7_], anIntArray5716[s_8_],
									anIntArray5713[s], anIntArray5713[s_7_], anIntArray5713[s_8_], anIntArray5758[s],
									anIntArray5758[s_7_], anIntArray5758[s_8_], aFloatArrayArray5763[i][0],
									aFloatArrayArray5763[i][1], aFloatArrayArray5763[i][2], aFloatArrayArray5776[i][0],
									aFloatArrayArray5776[i][1], aFloatArrayArray5776[i][2], i_14_, i_14_, i_14_,
									aClass374_5741.anInt4611, i_9_, i_10_, i_11_, aShortArray5773[i]);
						} else
							aClass185_5712.method1863(anIntArray5716[s], anIntArray5716[s_7_], anIntArray5716[s_8_],
									anIntArray5713[s], anIntArray5713[s_7_], anIntArray5713[s_8_], anIntArray5758[s],
									anIntArray5758[s_7_], anIntArray5758[s_8_], aFloatArrayArray5763[i][0],
									aFloatArrayArray5763[i][1], aFloatArrayArray5763[i][2], aFloatArrayArray5776[i][0],
									aFloatArrayArray5776[i][1], aFloatArrayArray5776[i][2],
									i_13_ | anIntArray5754[i] & 0xffffff, i_13_ | anIntArray5739[i] & 0xffffff,
									i_13_ | anIntArray5761[i] & 0xffffff, aClass374_5741.anInt4611, i_9_, i_10_, i_11_,
									aShortArray5773[i]);
					}
				}
		} else {
			...
			if (anIntArray5769[s] > aClass374_5741.anInt4620)
				...
				i_17_ = (aClass374_5741.anInt4624 - anIntArray5769[s]) * 255
						/ (aClass374_5741.anInt4624 - aClass374_5741.anInt4620);
			if (anIntArray5769[s_15_] > aClass374_5741.anInt4620)
				i_18_ = 255;
			else if (anIntArray5769[s_15_] > aClass374_5741.anInt4624)
				i_18_ = (aClass374_5741.anInt4624 - anIntArray5769[s_15_]) * 255
						/ (aClass374_5741.anInt4624 - aClass374_5741.anInt4620);
			if (anIntArray5769[s_16_] > aClass374_5741.anInt4620)
				i_19_ = 255;
			else if (anIntArray5769[s_16_] > aClass374_5741.anInt4624)
				i_19_ = (aClass374_5741.anInt4624 - anIntArray5769[s_16_]) * 255
						/ (aClass374_5741.anInt4624 - aClass374_5741.anInt4620);
			if (aByteArray5784 == null)
				aClass185_5712.anInt2220 = 0;
			else
			...
			if (aShortArray5773 == null || aShortArray5773[i] == -1) {
				if (anIntArray5761[i] == -1)
					aClass185_5712.method1852(anIntArray5716[s], anIntArray5716[s_15_], anIntArray5716[s_16_],
							anIntArray5713[s], anIntArray5713[s_15_], anIntArray5713[s_16_], anIntArray5758[s],
							anIntArray5758[s_15_], anIntArray5758[s_16_],
							Class249.method3086(i_17_ << 24 | aClass374_5741.anInt4611,
									Class170.anIntArray2054[anIntArray5754[i] & 0xffff], (byte) -56),
							Class249.method3086(i_18_ << 24 | aClass374_5741.anInt4611,
									Class170.anIntArray2054[anIntArray5754[i] & 0xffff], (byte) -56),
							Class249.method3086(i_19_ << 24 | aClass374_5741.anInt4611,
									Class170.anIntArray2054[anIntArray5754[i] & 0xffff], (byte) -56));
				else
					aClass185_5712.method1852(anIntArray5716[s], anIntArray5716[s_15_], anIntArray5716[s_16_],
							anIntArray5713[s], anIntArray5713[s_15_], anIntArray5713[s_16_], anIntArray5758[s],
				...
				if (anIntArray5761[i] == -1) {
					...
					aClass185_5712.method1863(anIntArray5716[s], anIntArray5716[s_15_], anIntArray5716[s_16_],
							anIntArray5713[s], anIntArray5713[s_15_], anIntArray5713[s_16_], anIntArray5758[s],
							anIntArray5758[s_15_], anIntArray5758[s_16_], aFloatArrayArray5763[i][0],
							aFloatArrayArray5763[i][1], aFloatArrayArray5763[i][2], aFloatArrayArray5776[i][0],
							aFloatArrayArray5776[i][1], aFloatArrayArray5776[i][2], i_21_, i_21_, i_21_,
							aClass374_5741.anInt4611, i_17_, i_18_, i_19_, aShortArray5773[i]);
				} else
					aClass185_5712.method1863(anIntArray5716[s], anIntArray5716[s_15_], anIntArray5716[s_16_],
							anIntArray5713[s], anIntArray5713[s_15_], anIntArray5713[s_16_], anIntArray5758[s],
							anIntArray5758[s_15_], anIntArray5758[s_16_], aFloatArrayArray5763[i][0],
							aFloatArrayArray5763[i][1], aFloatArrayArray5763[i][2], aFloatArrayArray5776[i][0],
							aFloatArrayArray5776[i][1], aFloatArrayArray5776[i][2],
							i_20_ | anIntArray5754[i] & 0xffffff, i_20_ | anIntArray5739[i] & 0xffffff,
							i_20_ | anIntArray5761[i] & 0xffffff, aClass374_5741.anInt4611, i_17_, i_18_, i_19_,
							aShortArray5773[i]);
			}
		}
	}
		...
		if (!aClass374_5741.aBoolean4617) {
			...
			if (i_197_ != 765)
				if (i_197_ == 0)
					...
					if (aShortArray5773 == null || aShortArray5773[i] == -1) {
						if (anIntArray5761[i] == -1)
							aClass185_5712.method1850(anIntArray5716[s], anIntArray5716[s_192_], anIntArray5716[s_193_],
									anIntArray5713[s], anIntArray5713[s_192_], anIntArray5713[s_193_],
									anIntArray5758[s], anIntArray5758[s_192_], anIntArray5758[s_193_],
									Class249.method3086(i_194_ << 24 | aClass374_5741.anInt4611,
											Class170.anIntArray2054[anIntArray5754[i] & 0xffff], (byte) -56),
									Class249.method3086(i_195_ << 24 | aClass374_5741.anInt4611,
											Class170.anIntArray2054[anIntArray5754[i] & 0xffff], (byte) -56),
									Class249.method3086(i_196_ << 24 | aClass374_5741.anInt4611,
											Class170.anIntArray2054[anIntArray5754[i] & 0xffff], (byte) -56));
						else
							aClass185_5712.method1850(anIntArray5716[s], anIntArray5716[s_192_], anIntArray5716[s_193_],
									anIntArray5713[s], anIntArray5713[s_192_], anIntArray5713[s_193_],
						...
						if (anIntArray5761[i] == -1) {
							...
							aClass185_5712.method1859(anIntArray5716[s], anIntArray5716[s_192_], anIntArray5716[s_193_],
									anIntArray5713[s], anIntArray5713[s_192_], anIntArray5713[s_193_],
									anIntArray5758[s], anIntArray5758[s_192_], anIntArray5758[s_193_],
									aFloatArrayArray5763[i][0], aFloatArrayArray5763[i][1], aFloatArrayArray5763[i][2],
									aFloatArrayArray5776[i][0], aFloatArrayArray5776[i][1], aFloatArrayArray5776[i][2],
									i_199_, i_199_, i_199_, aClass374_5741.anInt4611, i_194_, i_195_, i_196_,
									aShortArray5773[i]);
						} else
							aClass185_5712.method1859(anIntArray5716[s], anIntArray5716[s_192_], anIntArray5716[s_193_],
									anIntArray5713[s], anIntArray5713[s_192_], anIntArray5713[s_193_],
									...
									aFloatArrayArray5763[i][0], aFloatArrayArray5763[i][1], aFloatArrayArray5763[i][2],
									aFloatArrayArray5776[i][0], aFloatArrayArray5776[i][1], aFloatArrayArray5776[i][2],
									i_198_ | anIntArray5754[i] & 0xffffff, i_198_ | anIntArray5739[i] & 0xffffff,
									i_198_ | anIntArray5761[i] & 0xffffff, aClass374_5741.anInt4611, i_194_, i_195_,
									i_196_, aShortArray5773[i]);
					}
				}
		} else {
			short s = aShortArray5767[i];
			...
			if (aShortArray5773 == null || aShortArray5773[i] == -1) {
				if (anIntArray5761[i] == -1)
					aClass185_5712.method1850(anIntArray5716[s], anIntArray5716[s_200_], anIntArray5716[s_201_],
							anIntArray5713[s], anIntArray5713[s_200_], anIntArray5713[s_201_], anIntArray5758[s],
							anIntArray5758[s_200_], anIntArray5758[s_201_],
							Class249.method3086(i_202_ << 24 | aClass374_5741.anInt4611,
									Class170.anIntArray2054[anIntArray5754[i] & 0xffff], (byte) -56),
							Class249.method3086(i_203_ << 24 | aClass374_5741.anInt4611,
									Class170.anIntArray2054[anIntArray5754[i] & 0xffff], (byte) -56),
							Class249.method3086(i_204_ << 24 | aClass374_5741.anInt4611,
									Class170.anIntArray2054[anIntArray5754[i] & 0xffff], (byte) -56));
				else
					aClass185_5712.method1850(anIntArray5716[s], anIntArray5716[s_200_], anIntArray5716[s_201_],
							anIntArray5713[s], anIntArray5713[s_200_], anIntArray5713[s_201_], anIntArray5758[s],
				...
				if (anIntArray5761[i] == -1) {
					...
					aClass185_5712.method1859(anIntArray5716[s], anIntArray5716[s_200_], anIntArray5716[s_201_],
							anIntArray5713[s], anIntArray5713[s_200_], anIntArray5713[s_201_], anIntArray5758[s],
							anIntArray5758[s_200_], anIntArray5758[s_201_], aFloatArrayArray5763[i][0],
							aFloatArrayArray5763[i][1], aFloatArrayArray5763[i][2], aFloatArrayArray5776[i][0],
							aFloatArrayArray5776[i][1], aFloatArrayArray5776[i][2], i_206_, i_206_, i_206_,
							aClass374_5741.anInt4611, i_202_, i_203_, i_204_, aShortArray5773[i]);
				} else
					aClass185_5712.method1859(anIntArray5716[s], anIntArray5716[s_200_], anIntArray5716[s_201_],
							anIntArray5713[s], anIntArray5713[s_200_], anIntArray5713[s_201_], anIntArray5758[s],
							anIntArray5758[s_200_], anIntArray5758[s_201_], aFloatArrayArray5763[i][0],
							aFloatArrayArray5763[i][1], aFloatArrayArray5763[i][2], aFloatArrayArray5776[i][0],
							aFloatArrayArray5776[i][1], aFloatArrayArray5776[i][2],
							i_205_ | anIntArray5754[i] & 0xffffff, i_205_ | anIntArray5739[i] & 0xffffff,
							i_205_ | anIntArray5761[i] & 0xffffff, aClass374_5741.anInt4611, i_202_, i_203_, i_204_,
							aShortArray5773[i]);
			}
		}
	}
		...
		if (anIntArray5761[i] != -2) {
			...
			if (bool && (i_244_ == -5000 || i_245_ == -5000 || i_246_ == -5000)) {
				...
				if (i_248_ * i_256_ + i_251_ * i_257_ + i_254_ * i_258_ > 0)
					method670(i);
			} else if (anIntArray5756[i] != -1 || (i_244_ - i_245_) * (anIntArray5716[s_243_] - anIntArray5716[s_242_])
					- (anIntArray5716[s] - anIntArray5716[s_242_]) * (i_246_ - i_245_) > 0) {
				if (i_244_ < 0 || i_245_ < 0 || i_246_ < 0 || i_244_ > aClass374_5741.anInt4635
						|| i_245_ > aClass374_5741.anInt4635 || i_246_ > aClass374_5741.anInt4635)
				...
				if (bool_241_) {
					...
					if (i_260_ != -1) {
						...
						if (!class209.aBoolean2495)
							method669(i);
						aPureJavaToolkit5770.method1504(class214.anInt2515, class214.anInt2521, class214.anInt2518,
								class214.anInt2526, class214.anInt2514, class214.anInt2525,
								class209.aShort2488 & 0xffff, class214.anInt2519, class209.aByte2489,
								class209.aByte2487);
					} else
						method669(i);
				}
	...
	private final void method662() {
		...
		for (int i = 0; i < anInt5711; i++) {
			...
			int i_276_;
			for (i_276_ = i_268_ * i_272_ - i_271_ * i_269_; i_274_ > 8192 || i_275_ > 8192 || i_276_ > 8192
					|| i_274_ < -8192 || i_275_ < -8192 || i_276_ < -8192; i_276_ >>= 1) {
				i_274_ >>= 1;
				i_275_ >>= 1;
			}
			int i_277_ = (int) Math.sqrt(i_274_ * i_274_ + i_275_ * i_275_ + i_276_ * i_276_);
			if (i_277_ <= 0)
				i_277_ = 1;
			...
			for (int i_382_ = 0; i_382_ < anInt5711; i_382_++) {
				...
				if (s == -1) {
					if (b == 0) {
						...
						int i_387_ = (i * class354.anInt4347 + i_377_ * class354.anInt4348
								+ i_378_ * class354.anInt4346) / class354.anInt4345 >> 16;
						...
						i_387_ = (i * class354.anInt4347 + i_377_ * class354.anInt4348 + i_378_ * class354.anInt4346)
								/ class354.anInt4345 >> 16;
						...
						int i_393_ = i * class272.anInt3484 + i_377_ * class272.anInt3485
								+ i_378_ * class272.anInt3483 >> 16;
					...
					if (b == 0) {
						...
						if (aClass354Array5735 != null && aClass354Array5735[aShortArray5767[i_382_]] != null)
							...
							class354 = aClass354Array5774[aShortArray5767[i_382_]];
						int i_397_ = (i * class354.anInt4347 + i_377_ * class354.anInt4348
								+ i_378_ * class354.anInt4346) / class354.anInt4345 >> 16;
						...
						if (aClass354Array5735 != null && aClass354Array5735[aShortArray5731[i_382_]] != null)
							...
							class354 = aClass354Array5774[aShortArray5731[i_382_]];
						i_397_ = (i * class354.anInt4347 + i_377_ * class354.anInt4348 + i_378_ * class354.anInt4346)
								/ class354.anInt4345 >> 16;
						...
						Class272 class272 = aClass272Array5775[i_382_];
						int i_400_ = i * class272.anInt3484 + i_377_ * class272.anInt3485
								+ i_378_ * class272.anInt3483 >> 16;
	...
	private final boolean method665(int i, int i_403_, Class336 class336, boolean bool, int i_404_, int i_405_) {
		...
		float f = class336_sub2.aFloat8583 + (class336_sub2.aFloat8580 * aClass336_Sub2_5778.aFloat8583
				+ class336_sub2.aFloat8571 * aClass336_Sub2_5778.aFloat8579
				+ class336_sub2.aFloat8566 * aClass336_Sub2_5778.aFloat8589);
		float f_406_ = class336_sub2.aFloat8579 + (class336_sub2.aFloat8578 * aClass336_Sub2_5778.aFloat8583
				+ class336_sub2.aFloat8561 * aClass336_Sub2_5778.aFloat8579
				+ class336_sub2.aFloat8558 * aClass336_Sub2_5778.aFloat8589);
		float f_407_ = class336_sub2.aFloat8589 + (class336_sub2.aFloat8577 * aClass336_Sub2_5778.aFloat8583
				+ class336_sub2.aFloat8567 * aClass336_Sub2_5778.aFloat8579
				+ class336_sub2.aFloat8584 * aClass336_Sub2_5778.aFloat8589);
		float f_408_ = class336_sub2.aFloat8580 * aClass336_Sub2_5778.aFloat8580
				+ class336_sub2.aFloat8571 * aClass336_Sub2_5778.aFloat8578
				+ class336_sub2.aFloat8566 * aClass336_Sub2_5778.aFloat8577;
		float f_409_ = class336_sub2.aFloat8580 * aClass336_Sub2_5778.aFloat8571
				+ class336_sub2.aFloat8571 * aClass336_Sub2_5778.aFloat8561
				+ class336_sub2.aFloat8566 * aClass336_Sub2_5778.aFloat8567;
		float f_410_ = class336_sub2.aFloat8580 * aClass336_Sub2_5778.aFloat8566
				+ class336_sub2.aFloat8571 * aClass336_Sub2_5778.aFloat8558
				+ class336_sub2.aFloat8566 * aClass336_Sub2_5778.aFloat8584;
		float f_411_ = class336_sub2.aFloat8578 * aClass336_Sub2_5778.aFloat8580
				+ class336_sub2.aFloat8561 * aClass336_Sub2_5778.aFloat8578
				+ class336_sub2.aFloat8558 * aClass336_Sub2_5778.aFloat8577;
		float f_412_ = class336_sub2.aFloat8578 * aClass336_Sub2_5778.aFloat8571
				+ class336_sub2.aFloat8561 * aClass336_Sub2_5778.aFloat8561
				+ class336_sub2.aFloat8558 * aClass336_Sub2_5778.aFloat8567;
		float f_413_ = class336_sub2.aFloat8578 * aClass336_Sub2_5778.aFloat8566
				+ class336_sub2.aFloat8561 * aClass336_Sub2_5778.aFloat8558
				+ class336_sub2.aFloat8558 * aClass336_Sub2_5778.aFloat8584;
		float f_414_ = class336_sub2.aFloat8577 * aClass336_Sub2_5778.aFloat8580
				+ class336_sub2.aFloat8567 * aClass336_Sub2_5778.aFloat8578
				+ class336_sub2.aFloat8584 * aClass336_Sub2_5778.aFloat8577;
		float f_415_ = class336_sub2.aFloat8577 * aClass336_Sub2_5778.aFloat8571
				+ class336_sub2.aFloat8567 * aClass336_Sub2_5778.aFloat8561
				+ class336_sub2.aFloat8584 * aClass336_Sub2_5778.aFloat8567;
		float f_416_ = class336_sub2.aFloat8577 * aClass336_Sub2_5778.aFloat8566
				+ class336_sub2.aFloat8567 * aClass336_Sub2_5778.aFloat8558
				+ class336_sub2.aFloat8584 * aClass336_Sub2_5778.aFloat8584;
		...
		for (int i_438_ = 0; i_438_ < 8; i_438_++) {
			...
			float f_442_ = f + (f_408_ * i_439_ + f_409_ * i_440_ + f_410_ * i_441_);
			float f_443_ = f_406_ + (f_411_ * i_439_ + f_412_ * i_440_ + f_413_ * i_441_);
			float f_444_ = f_407_ + (f_414_ * i_439_ + f_415_ * i_440_ + f_416_ * i_441_);
			if (f_444_ >= aPureJavaToolkit5770.anInt6798) {
				if (i_405_ > 0)
					f_444_ = i_405_;
				int i_445_ = i_418_ + (int) (f_442_ * i_420_ / f_444_);
				int i_446_ = i_419_ + (int) (f_443_ * i_421_ / f_444_);
				if (i_445_ < i_422_)
					i_422_ = i_445_;
				if (i_445_ > i_423_)
					i_423_ = i_445_;
		...
		if (bool_417_ && i > i_422_ && i < i_423_ && i_403_ > i_424_ && i_403_ < i_425_) {
			...
			for (int i_447_ = 0; i_447_ < anInt5718; i_447_++) {
				...
				float f_451_ = f + (f_408_ * i_448_ + f_409_ * i_449_ + f_410_ * i_450_);
				float f_452_ = f_406_ + (f_411_ * i_448_ + f_412_ * i_449_ + f_413_ * i_450_);
				float f_453_ = f_407_ + (f_414_ * i_448_ + f_415_ * i_449_ + f_416_ * i_450_);
				if (f_453_ >= aPureJavaToolkit5770.anInt6798) {
					if (i_405_ > 0)
						f_453_ = i_405_;
					anIntArray5713[i_447_] = i_418_ + (int) (f_451_ * i_420_ / f_453_);
					anIntArray5716[i_447_] = i_419_ + (int) (f_452_ * i_421_ / f_453_);
				} else
					anIntArray5713[i_447_] = -999999;
			}
			for (int i_454_ = 0; i_454_ < anInt5711; i_454_++)
				if (anIntArray5713[aShortArray5767[i_454_]] != -999999
						&& anIntArray5713[aShortArray5731[i_454_]] != -999999
						&& anIntArray5713[aShortArray5789[i_454_]] != -999999
						&& method672(i, i_403_, anIntArray5716[aShortArray5767[i_454_]],
								anIntArray5716[aShortArray5731[i_454_]], anIntArray5716[aShortArray5789[i_454_]],
								anIntArray5713[aShortArray5767[i_454_]], anIntArray5713[aShortArray5731[i_454_]],
								anIntArray5713[aShortArray5789[i_454_]]))
					return true;
		}
		return false;
	}

	private final DrawableModel method666(PureJavaDrawableModel purejavadrawablemodel_455_,
			PureJavaDrawableModel purejavadrawablemodel_456_, int i, boolean bool, boolean bool_457_) {
		...
		if (bool_459_ || bool_460_ || bool_461_) {
			if (bool_459_) {
				if (purejavadrawablemodel_456_.anIntArray5748 == null
						|| purejavadrawablemodel_456_.anIntArray5748.length < anInt5718)
			...
			if (bool_460_) {
				if (purejavadrawablemodel_456_.anIntArray5772 == null
						|| purejavadrawablemodel_456_.anIntArray5772.length < anInt5718)
			...
			if (bool_461_) {
				if (purejavadrawablemodel_456_.anIntArray5717 == null
						|| purejavadrawablemodel_456_.anIntArray5717.length < anInt5718)
		...
		if ((i & 0x84080) != 0) {
			if (purejavadrawablemodel_456_.aShortArray5740 == null
					|| purejavadrawablemodel_456_.aShortArray5740.length < anInt5711) {
		...
		if ((i & 0x97018) != 0) {
			...
			if (bool_457_)
				method655(false);
			if (anIntArray5754 != null) {
				if (purejavadrawablemodel_456_.anIntArray5754 == null
						|| purejavadrawablemodel_456_.anIntArray5754.length < anInt5711) {
		...
		if ((i & 0x100) != 0) {
			if (purejavadrawablemodel_456_.aByteArray5784 == null
					|| purejavadrawablemodel_456_.aByteArray5784.length < anInt5711) {
		...
		if ((i & 0x8) != 0 || (i & 0x10) != 0) {
			if (purejavadrawablemodel_456_.aClass354Array5774 == null
					|| purejavadrawablemodel_456_.aClass354Array5774.length < anInt5753) {
			...
			if (aClass272Array5775 != null) {
				if (purejavadrawablemodel_456_.aClass272Array5775 == null
						|| purejavadrawablemodel_456_.aClass272Array5775.length < anInt5711) {
				...
				for (int i_475_ = 0; i_475_ < anInt5711; i_475_++)
					purejavadrawablemodel_455_.aClass272Array5775[i_475_] = aClass272Array5775[i_475_] != null
							? new Class272(aClass272Array5775[i_475_]) : null;
			} else
		...
		if ((i & 0x8000) != 0) {
			if (aShortArray5773 == null)
				...
				if (purejavadrawablemodel_456_.aShortArray5773 == null
						|| purejavadrawablemodel_456_.aShortArray5773.length < anInt5711) {
		...
		if ((i & 0x10000) != 0) {
			if (aByteArray5736 == null)
				...
				if (purejavadrawablemodel_456_.aByteArray5736 == null
						|| purejavadrawablemodel_456_.aByteArray5736.length < anInt5711) {
		...
		if ((i & 0xc580) != 0) {
			if (purejavadrawablemodel_456_.aClass214Array5765 == null
					|| purejavadrawablemodel_456_.aClass214Array5765.length < anInt5762) {
				...
				for (int i_481_ = 0; i_481_ < anInt5762; i_481_++)
					purejavadrawablemodel_455_.aClass214Array5765[i_481_] = aClass214Array5765[i_481_]
							.method2059((byte) -90);
			} else {
		...
		if (aFloatArrayArray5763 != null && (i & 0x10) != 0) {
			if (purejavadrawablemodel_456_.aFloatArrayArray5763 == null
					|| purejavadrawablemodel_456_.aFloatArrayArray5763.length < anInt5711) {
			...
			if (purejavadrawablemodel_456_.aFloatArrayArray5776 == null
					|| purejavadrawablemodel_456_.aFloatArrayArray5776.length < anInt5711) {
	...
	private final void method669(int i) {
		...
		if (aShortArray5773 == null || aShortArray5773[i] == -1) {
			if (aByteArray5784 == null)
				...
				aClass185_5712.anInt2220 = aByteArray5784[i] & 0xff;
			if (anIntArray5761[i] == -1)
				aClass185_5712.method1853(anIntArray5716[s], anIntArray5716[s_505_], anIntArray5716[s_506_],
						anIntArray5713[s], anIntArray5713[s_505_], anIntArray5713[s_506_], anIntArray5758[s],
						anIntArray5758[s_505_], anIntArray5758[s_506_],
						Class170.anIntArray2054[anIntArray5754[i] & 0xffff]);
			else
				aClass185_5712.method1862(anIntArray5716[s], anIntArray5716[s_505_], anIntArray5716[s_506_],
						anIntArray5713[s], anIntArray5713[s_505_], anIntArray5713[s_506_], anIntArray5758[s],
						anIntArray5758[s_505_], anIntArray5758[s_506_], anIntArray5754[i] & 0xffff,
						anIntArray5739[i] & 0xffff, anIntArray5761[i] & 0xffff);
		} else {
			int i_507_ = -16777216;
			if (aByteArray5784 != null)
			...
			if (anIntArray5761[i] == -1) {
				...
				aClass185_5712.method1863(anIntArray5716[s], anIntArray5716[s_505_], anIntArray5716[s_506_],
						anIntArray5713[s], anIntArray5713[s_505_], anIntArray5713[s_506_], anIntArray5758[s],
						anIntArray5758[s_505_], anIntArray5758[s_506_], aFloatArrayArray5763[i][0],
						aFloatArrayArray5763[i][1], aFloatArrayArray5763[i][2], aFloatArrayArray5776[i][0],
						aFloatArrayArray5776[i][1], aFloatArrayArray5776[i][2], i_508_, i_508_, i_508_,
						aClass374_5741.anInt4611, 0, 0, 0, aShortArray5773[i]);
			} else
				aClass185_5712.method1863(anIntArray5716[s], anIntArray5716[s_505_], anIntArray5716[s_506_],
						anIntArray5713[s], anIntArray5713[s_505_], anIntArray5713[s_506_], anIntArray5758[s],
						anIntArray5758[s_505_], anIntArray5758[s_506_], aFloatArrayArray5763[i][0],
						aFloatArrayArray5763[i][1], aFloatArrayArray5763[i][2], aFloatArrayArray5776[i][0],
						aFloatArrayArray5776[i][1], aFloatArrayArray5776[i][2], i_507_ | anIntArray5754[i] & 0xffffff,
						i_507_ | anIntArray5739[i] & 0xffffff, i_507_ | anIntArray5761[i] & 0xffffff,
						aClass374_5741.anInt4611, 0, 0, 0, aShortArray5773[i]);
		}
	}
	...
	private final void method670(int i) {
		...
		if (i_513_ >= i_510_) {
			...
			if (i_515_ >= i_510_) {
				...
				anIntArray5738[i_509_] = aClass374_5741.anInt4633
						+ (i_516_ + ((anIntArray5714[s_512_] - i_516_) * i_519_ >> 16)) * aPureJavaToolkit5770.anInt6785
								/ i_510_;
				anIntArray5781[i_509_] = aClass374_5741.anInt4653
						+ (i_517_ + ((anIntArray5728[s_512_] - i_517_) * i_519_ >> 16)) * aPureJavaToolkit5770.anInt6763
								/ i_510_;
			...
			if (i_514_ >= i_510_) {
				...
				anIntArray5738[i_509_] = aClass374_5741.anInt4633
						+ (i_516_ + ((anIntArray5714[s_511_] - i_516_) * i_520_ >> 16)) * aPureJavaToolkit5770.anInt6785
								/ i_510_;
				anIntArray5781[i_509_] = aClass374_5741.anInt4653
						+ (i_517_ + ((anIntArray5728[s_511_] - i_517_) * i_520_ >> 16)) * aPureJavaToolkit5770.anInt6763
								/ i_510_;
				anIntArray5760[i_509_] = i_510_;
		...
		if (i_514_ >= i_510_) {
			...
			if (i_513_ >= i_510_) {
				...
				anIntArray5738[i_509_] = aClass374_5741.anInt4633
						+ (i_521_ + ((anIntArray5714[s] - i_521_) * i_524_ >> 16)) * aPureJavaToolkit5770.anInt6785
								/ i_510_;
				anIntArray5781[i_509_] = aClass374_5741.anInt4653
						+ (i_522_ + ((anIntArray5728[s] - i_522_) * i_524_ >> 16)) * aPureJavaToolkit5770.anInt6763
								/ i_510_;
				anIntArray5760[i_509_] = i_510_;
			...
			if (i_515_ >= i_510_) {
				...
				anIntArray5738[i_509_] = aClass374_5741.anInt4633
						+ (i_521_ + ((anIntArray5714[s_512_] - i_521_) * i_525_ >> 16)) * aPureJavaToolkit5770.anInt6785
								/ i_510_;
				anIntArray5781[i_509_] = aClass374_5741.anInt4653
						+ (i_522_ + ((anIntArray5728[s_512_] - i_522_) * i_525_ >> 16)) * aPureJavaToolkit5770.anInt6763
								/ i_510_;
				anIntArray5760[i_509_] = i_510_;
		...
		if (i_515_ >= i_510_) {
			...
			if (i_514_ >= i_510_) {
				...
				anIntArray5738[i_509_] = aClass374_5741.anInt4633
						+ (i_526_ + ((anIntArray5714[s_511_] - i_526_) * i_529_ >> 16)) * aPureJavaToolkit5770.anInt6785
								/ i_510_;
				anIntArray5781[i_509_] = aClass374_5741.anInt4653
						+ (i_527_ + ((anIntArray5728[s_511_] - i_527_) * i_529_ >> 16)) * aPureJavaToolkit5770.anInt6763
								/ i_510_;
				anIntArray5760[i_509_] = i_510_;
			...
			if (i_513_ >= i_510_) {
				...
				anIntArray5738[i_509_] = aClass374_5741.anInt4633
						+ (i_526_ + ((anIntArray5714[s] - i_526_) * i_530_ >> 16)) * aPureJavaToolkit5770.anInt6785
								/ i_510_;
				anIntArray5781[i_509_] = aClass374_5741.anInt4653
						+ (i_527_ + ((anIntArray5728[s] - i_527_) * i_530_ >> 16)) * aPureJavaToolkit5770.anInt6763
								/ i_510_;
				anIntArray5760[i_509_] = i_510_;
		...
		aClass185_5712.aBoolean2217 = false;
		if (i_509_ == 3) {
			if (i_531_ < 0 || i_532_ < 0 || i_533_ < 0 || i_531_ > aClass374_5741.anInt4635
					|| i_532_ > aClass374_5741.anInt4635 || i_533_ > aClass374_5741.anInt4635)
				aClass185_5712.aBoolean2217 = true;
			if (aShortArray5773 == null || aShortArray5773[i] == -1) {
				if (anIntArray5761[i] == -1)
					aClass185_5712.method1853(i_534_, i_535_, i_536_, i_531_, i_532_, i_533_, i_513_, i_514_, i_515_,
							Class170.anIntArray2054[anIntArray5754[i] & 0xffff]);
				else
					aClass185_5712.method1862(i_534_, i_535_, i_536_, i_531_, i_532_, i_533_, i_513_, i_514_, i_515_,
							anIntArray5785[0], anIntArray5785[1], anIntArray5785[2]);
			} else {
				int i_537_ = -16777216;
				if (aByteArray5784 != null)
				...
				if (anIntArray5761[i] == -1)
					aClass185_5712.method1863(i_534_, i_535_, i_536_, i_531_, i_532_, i_533_, i_513_, i_514_, i_515_,
							aFloatArrayArray5763[i][0], aFloatArrayArray5763[i][1], aFloatArrayArray5763[i][2],
							aFloatArrayArray5776[i][0], aFloatArrayArray5776[i][1], aFloatArrayArray5776[i][2], i_538_,
							i_538_, i_538_, aClass374_5741.anInt4611, 0, 0, 0, aShortArray5773[i]);
				else
					aClass185_5712.method1863(i_534_, i_535_, i_536_, i_531_, i_532_, i_533_, i_513_, i_514_, i_515_,
							aFloatArrayArray5763[i][0], aFloatArrayArray5763[i][1], aFloatArrayArray5763[i][2],
							aFloatArrayArray5776[i][0], aFloatArrayArray5776[i][1], aFloatArrayArray5776[i][2], i_538_,
		...
		if (i_509_ == 4) {
			if (i_531_ < 0 || i_532_ < 0 || i_533_ < 0 || i_531_ > aClass374_5741.anInt4635
					|| i_532_ > aClass374_5741.anInt4635 || i_533_ > aClass374_5741.anInt4635 || anIntArray5738[3] < 0
					|| anIntArray5738[3] > aClass374_5741.anInt4635)
				aClass185_5712.aBoolean2217 = true;
			if (aShortArray5773 == null || aShortArray5773[i] == -1) {
				if (anIntArray5761[i] == -1) {
					...
					aClass185_5712.method1853(i_534_, i_535_, i_536_, i_531_, i_532_, i_533_, i_513_, i_514_, i_515_,
							i_539_);
					aClass185_5712.method1853(i_534_, i_536_, anIntArray5781[3], i_531_, i_533_, anIntArray5738[3],
							i_513_, i_514_, anIntArray5760[3], i_539_);
				} else {
					aClass185_5712.method1862(i_534_, i_535_, i_536_, i_531_, i_532_, i_533_, i_513_, i_514_, i_515_,
							anIntArray5785[0], anIntArray5785[1], anIntArray5785[2]);
					aClass185_5712.method1862(i_534_, i_536_, anIntArray5781[3], i_531_, i_533_, anIntArray5738[3],
							i_513_, i_514_, anIntArray5760[3], anIntArray5785[0], anIntArray5785[2], anIntArray5785[3]);
				}
			} else {
				int i_540_ = -16777216;
				if (aByteArray5784 != null)
				...
				if (anIntArray5761[i] == -1) {
					aClass185_5712.method1863(i_534_, i_535_, i_536_, i_531_, i_532_, i_533_, i_513_, i_514_, i_515_,
							aFloatArrayArray5763[i][0], aFloatArrayArray5763[i][1], aFloatArrayArray5763[i][2],
							aFloatArrayArray5776[i][0], aFloatArrayArray5776[i][1], aFloatArrayArray5776[i][2], i_541_,
							i_541_, i_541_, aClass374_5741.anInt4611, 0, 0, 0, aShortArray5773[i]);
					aClass185_5712.method1863(i_534_, i_536_, anIntArray5781[3], i_531_, i_533_, anIntArray5738[3],
							i_513_, i_515_, anIntArray5760[3], aFloatArrayArray5763[i][0], aFloatArrayArray5763[i][1],
							aFloatArrayArray5763[i][2], aFloatArrayArray5776[i][0], aFloatArrayArray5776[i][1],
							aFloatArrayArray5776[i][2], i_541_, i_541_, i_541_, aClass374_5741.anInt4611, 0, 0, 0,
							aShortArray5773[i]);
				} else {
					aClass185_5712.method1863(i_534_, i_535_, i_536_, i_531_, i_532_, i_533_, i_513_, i_514_, i_515_,
							aFloatArrayArray5763[i][0], aFloatArrayArray5763[i][1], aFloatArrayArray5763[i][2],
	...
	private final boolean method672(int i, int i_542_, int i_543_, int i_544_, int i_545_, int i_546_, int i_547_,
			int i_548_) {
	...
	private final void method673(int i) {
		...
		if (i_554_ >= i_551_) {
			...
			if (i_556_ >= i_551_) {
				...
				anIntArray5738[i_550_] = aClass374_5741.anInt4633
						+ (i_557_ + ((anIntArray5714[s_553_] - i_557_) * i_560_ >> 16)) * aPureJavaToolkit5770.anInt6785
								/ i_551_;
				anIntArray5781[i_550_] = aClass374_5741.anInt4653
						+ (i_558_ + ((anIntArray5728[s_553_] - i_558_) * i_560_ >> 16)) * aPureJavaToolkit5770.anInt6763
								/ i_551_;
			...
			if (i_555_ >= i_551_) {
				...
				anIntArray5738[i_550_] = aClass374_5741.anInt4633
						+ (i_557_ + ((anIntArray5714[s_552_] - i_557_) * i_561_ >> 16)) * aPureJavaToolkit5770.anInt6785
								/ i_551_;
				anIntArray5781[i_550_] = aClass374_5741.anInt4653
						+ (i_558_ + ((anIntArray5728[s_552_] - i_558_) * i_561_ >> 16)) * aPureJavaToolkit5770.anInt6763
								/ i_551_;
				anIntArray5760[i_550_] = i_551_;
		...
		if (i_555_ >= i_551_) {
			...
			if (i_554_ >= i_551_) {
				...
				anIntArray5738[i_550_] = aClass374_5741.anInt4633
						+ (i_562_ + ((anIntArray5714[s] - i_562_) * i_565_ >> 16)) * aPureJavaToolkit5770.anInt6785
								/ i_551_;
				anIntArray5781[i_550_] = aClass374_5741.anInt4653
						+ (i_563_ + ((anIntArray5728[s] - i_563_) * i_565_ >> 16)) * aPureJavaToolkit5770.anInt6763
								/ i_551_;
				anIntArray5760[i_550_] = i_551_;
			...
			if (i_556_ >= i_551_) {
				...
				anIntArray5738[i_550_] = aClass374_5741.anInt4633
						+ (i_562_ + ((anIntArray5714[s_553_] - i_562_) * i_566_ >> 16)) * aPureJavaToolkit5770.anInt6785
								/ i_551_;
				anIntArray5781[i_550_] = aClass374_5741.anInt4653
						+ (i_563_ + ((anIntArray5728[s_553_] - i_563_) * i_566_ >> 16)) * aPureJavaToolkit5770.anInt6763
								/ i_551_;
				anIntArray5760[i_550_] = i_551_;
		...
		if (i_556_ >= i_551_) {
			...
			if (i_555_ >= i_551_) {
				...
				anIntArray5738[i_550_] = aClass374_5741.anInt4633
						+ (i_567_ + ((anIntArray5714[s_552_] - i_567_) * i_570_ >> 16)) * aPureJavaToolkit5770.anInt6785
								/ i_551_;
				anIntArray5781[i_550_] = aClass374_5741.anInt4653
						+ (i_568_ + ((anIntArray5728[s_552_] - i_568_) * i_570_ >> 16)) * aPureJavaToolkit5770.anInt6763
								/ i_551_;
				anIntArray5760[i_550_] = i_551_;
			...
			if (i_554_ >= i_551_) {
				...
				anIntArray5738[i_550_] = aClass374_5741.anInt4633
						+ (i_567_ + ((anIntArray5714[s] - i_567_) * i_571_ >> 16)) * aPureJavaToolkit5770.anInt6785
								/ i_551_;
				anIntArray5781[i_550_] = aClass374_5741.anInt4653
						+ (i_568_ + ((anIntArray5728[s] - i_568_) * i_571_ >> 16)) * aPureJavaToolkit5770.anInt6763
								/ i_551_;
				anIntArray5760[i_550_] = i_551_;
		...
		aClass185_5712.aBoolean2217 = false;
		if (i_550_ == 3) {
			if (i_572_ < 0 || i_573_ < 0 || i_574_ < 0 || i_572_ > aClass374_5741.anInt4635
					|| i_573_ > aClass374_5741.anInt4635 || i_574_ > aClass374_5741.anInt4635)
				aClass185_5712.aBoolean2217 = true;
			if (aShortArray5773 == null || aShortArray5773[i] == -1) {
				if (anIntArray5761[i] == -1)
					aClass185_5712.method1867(i_575_, i_576_, i_577_, i_572_, i_573_, i_574_, i_554_, i_555_, i_556_,
							Class170.anIntArray2054[anIntArray5754[i] & 0xffff]);
				else
					aClass185_5712.method1865(i_575_, i_576_, i_577_, i_572_, i_573_, i_574_, i_554_, i_555_, i_556_,
							anIntArray5785[0], anIntArray5785[1], anIntArray5785[2]);
			} else {
				int i_578_ = -16777216;
				if (aByteArray5784 != null)
				...
				if (anIntArray5761[i] == -1)
					aClass185_5712.method1859(i_575_, i_576_, i_577_, i_572_, i_573_, i_574_, i_554_, i_555_, i_556_,
							aFloatArrayArray5763[i][0], aFloatArrayArray5763[i][1], aFloatArrayArray5763[i][2],
							aFloatArrayArray5776[i][0], aFloatArrayArray5776[i][1], aFloatArrayArray5776[i][2], i_579_,
							i_579_, i_579_, aClass374_5741.anInt4611, 0, 0, 0, aShortArray5773[i]);
				else
					aClass185_5712.method1859(i_575_, i_576_, i_577_, i_572_, i_573_, i_574_, i_554_, i_555_, i_556_,
							aFloatArrayArray5763[i][0], aFloatArrayArray5763[i][1], aFloatArrayArray5763[i][2],
							aFloatArrayArray5776[i][0], aFloatArrayArray5776[i][1], aFloatArrayArray5776[i][2], i_579_,
		...
		if (i_550_ == 4) {
			if (i_572_ < 0 || i_573_ < 0 || i_574_ < 0 || i_572_ > aClass374_5741.anInt4635
					|| i_573_ > aClass374_5741.anInt4635 || i_574_ > aClass374_5741.anInt4635 || anIntArray5738[3] < 0
					|| anIntArray5738[3] > aClass374_5741.anInt4635)
				aClass185_5712.aBoolean2217 = true;
			if (aShortArray5773 == null || aShortArray5773[i] == -1) {
				if (anIntArray5761[i] == -1) {
					...
					aClass185_5712.method1867(i_575_, i_576_, i_577_, i_572_, i_573_, i_574_, i_554_, i_555_, i_556_,
							i_580_);
					aClass185_5712.method1867(i_575_, i_577_, anIntArray5781[3], i_572_, i_574_, anIntArray5738[3],
							i_554_, i_555_, anIntArray5760[3], i_580_);
				} else {
					aClass185_5712.method1865(i_575_, i_576_, i_577_, i_572_, i_573_, i_574_, i_554_, i_555_, i_556_,
							anIntArray5785[0], anIntArray5785[1], anIntArray5785[2]);
					aClass185_5712.method1865(i_575_, i_577_, anIntArray5781[3], i_572_, i_574_, anIntArray5738[3],
							i_554_, i_555_, anIntArray5760[3], anIntArray5785[0], anIntArray5785[2], anIntArray5785[3]);
				}
			} else {
				int i_581_ = -16777216;
				if (aByteArray5784 != null)
				...
				if (anIntArray5761[i] == -1) {
					aClass185_5712.method1859(i_575_, i_576_, i_577_, i_572_, i_573_, i_574_, i_554_, i_555_, i_556_,
							aFloatArrayArray5763[i][0], aFloatArrayArray5763[i][1], aFloatArrayArray5763[i][2],
							aFloatArrayArray5776[i][0], aFloatArrayArray5776[i][1], aFloatArrayArray5776[i][2], i_582_,
							i_582_, i_582_, aClass374_5741.anInt4611, 0, 0, 0, aShortArray5773[i]);
					aClass185_5712.method1859(i_575_, i_577_, anIntArray5781[3], i_572_, i_574_, anIntArray5738[3],
							i_554_, i_556_, anIntArray5760[3], aFloatArrayArray5763[i][0], aFloatArrayArray5763[i][1],
							aFloatArrayArray5763[i][2], aFloatArrayArray5776[i][0], aFloatArrayArray5776[i][1],
							aFloatArrayArray5776[i][2], i_582_, i_582_, i_582_, aClass374_5741.anInt4611, 0, 0, 0,
							aShortArray5773[i]);
				} else {
					aClass185_5712.method1859(i_575_, i_576_, i_577_, i_572_, i_573_, i_574_, i_554_, i_555_, i_556_,
							aFloatArrayArray5763[i][0], aFloatArrayArray5763[i][1], aFloatArrayArray5763[i][2],
		...
		if (anIntArray5761[i] != -2) {
			...
			if (bool && (i_586_ == -5000 || i_587_ == -5000 || i_588_ == -5000)) {
				...
				if (i_590_ * i_598_ + i_593_ * i_599_ + i_596_ * i_600_ > 0)
					method673(i);
			} else if (anIntArray5756[i] != -1 || (i_586_ - i_587_) * (anIntArray5716[s_585_] - anIntArray5716[s_584_])
					- (anIntArray5716[s] - anIntArray5716[s_584_]) * (i_588_ - i_587_) > 0) {
				if (i_586_ < 0 || i_587_ < 0 || i_588_ < 0 || i_586_ > aClass374_5741.anInt4635
						|| i_587_ > aClass374_5741.anInt4635 || i_588_ > aClass374_5741.anInt4635)
					aClass185_5712.aBoolean2217 = true;
				else
					aClass185_5712.aBoolean2217 = false;
				if (bool_583_) {
					...
					if (i_602_ != -1) {
						...
						if (!class209.aBoolean2495)
							method685(i);
						aPureJavaToolkit5770.method1498(class214.anInt2515, class214.anInt2521, class214.anInt2518,
								class214.anInt2526, class214.anInt2514, class214.anInt2525,
								class209.aShort2488 & 0xffff, class214.anInt2519, class209.aByte2489,
								class209.aByte2487);
					} else
	...
	private final void method677() {
		if (!aBoolean5792) {
			...
			aShort5777 = (short) (int) (Math.sqrt(i) + 0.99);
			aShort5755 = (short) (int) (Math.sqrt(i_607_) + 0.99);
			aBoolean5792 = true;
		}
	}
	...
	private final void method680(Class336 class336, EntityNode_Sub5 entitynode_sub5, int i, int i_624_) {
		if (anInt5753 >= 1) {
			...
			if (!aBoolean5792)
				method677();
			boolean bool = false;
			if (aClass336_Sub2_5778.aFloat8580 == 16384.0F && aClass336_Sub2_5778.aFloat8571 == 0.0F
					&& aClass336_Sub2_5778.aFloat8566 == 0.0F && aClass336_Sub2_5778.aFloat8578 == 0.0F
					&& aClass336_Sub2_5778.aFloat8561 == 16384.0F && aClass336_Sub2_5778.aFloat8558 == 0.0F
					&& aClass336_Sub2_5778.aFloat8577 == 0.0F && aClass336_Sub2_5778.aFloat8567 == 0.0F
					&& aClass336_Sub2_5778.aFloat8584 == 16384.0F)
				bool = true;
			float f = class336_sub2.aFloat8589 + class336_sub2.aFloat8577 * aClass336_Sub2_5778.aFloat8583
					+ class336_sub2.aFloat8567 * aClass336_Sub2_5778.aFloat8579
					+ class336_sub2.aFloat8584 * aClass336_Sub2_5778.aFloat8589;
			float f_625_ = bool ? class336_sub2.aFloat8567
					: class336_sub2.aFloat8577 * aClass336_Sub2_5778.aFloat8571
							+ class336_sub2.aFloat8567 * aClass336_Sub2_5778.aFloat8561
							+ class336_sub2.aFloat8584 * aClass336_Sub2_5778.aFloat8567;
			int i_626_ = (int) (f + aShort5759 * f_625_);
			int i_627_ = (int) (f + aShort5751 * f_625_);
			int i_628_;
			int i_629_;
			if (i_626_ > i_627_) {
			...
			if (i_628_ < aPureJavaToolkit5770.anInt6776 && i_629_ > aPureJavaToolkit5770.anInt6798) {
				float f_630_ = class336_sub2.aFloat8583 + class336_sub2.aFloat8580 * aClass336_Sub2_5778.aFloat8583
						+ class336_sub2.aFloat8571 * aClass336_Sub2_5778.aFloat8579
						+ class336_sub2.aFloat8566 * aClass336_Sub2_5778.aFloat8589;
				float f_631_ = bool ? class336_sub2.aFloat8571
						: class336_sub2.aFloat8580 * aClass336_Sub2_5778.aFloat8571
								+ class336_sub2.aFloat8571 * aClass336_Sub2_5778.aFloat8561
								+ class336_sub2.aFloat8566 * aClass336_Sub2_5778.aFloat8567;
				int i_632_ = (int) (f_630_ + aShort5759 * f_631_);
				int i_633_ = (int) (f_630_ + aShort5751 * f_631_);
				int i_634_;
				int i_635_;
				if (i_632_ > i_633_) {
				...
				if (i == -1) {
					if (i_634_ / i_629_ >= aPureJavaToolkit5770.anInt6768
							|| i_635_ / i_629_ <= aPureJavaToolkit5770.anInt6793)
						return;
				} else if (i_634_ / i >= aPureJavaToolkit5770.anInt6768 || i_635_ / i <= aPureJavaToolkit5770.anInt6793)
					return;
				float f_636_ = class336_sub2.aFloat8579 + class336_sub2.aFloat8578 * aClass336_Sub2_5778.aFloat8583
						+ class336_sub2.aFloat8561 * aClass336_Sub2_5778.aFloat8579
						+ class336_sub2.aFloat8558 * aClass336_Sub2_5778.aFloat8589;
				float f_637_ = bool ? class336_sub2.aFloat8561
						: class336_sub2.aFloat8578 * aClass336_Sub2_5778.aFloat8571
								+ class336_sub2.aFloat8561 * aClass336_Sub2_5778.aFloat8561
								+ class336_sub2.aFloat8558 * aClass336_Sub2_5778.aFloat8567;
				int i_638_ = (int) (f_636_ + aShort5759 * f_637_);
				int i_639_ = (int) (f_636_ + aShort5751 * f_637_);
				int i_640_;
				int i_641_;
				if (i_638_ > i_639_) {
				...
				if (i == -1) {
					if (i_640_ / i_629_ >= aPureJavaToolkit5770.anInt6779
							|| i_641_ / i_629_ <= aPureJavaToolkit5770.anInt6790)
						return;
				...
				if (bool) {
					...
					f_642_ = class336_sub2.aFloat8580 * aClass336_Sub2_5778.aFloat8580
							+ class336_sub2.aFloat8571 * aClass336_Sub2_5778.aFloat8578
							+ class336_sub2.aFloat8566 * aClass336_Sub2_5778.aFloat8577;
					f_643_ = class336_sub2.aFloat8578 * aClass336_Sub2_5778.aFloat8580
							+ class336_sub2.aFloat8561 * aClass336_Sub2_5778.aFloat8578
							+ class336_sub2.aFloat8558 * aClass336_Sub2_5778.aFloat8577;
					f_644_ = class336_sub2.aFloat8577 * aClass336_Sub2_5778.aFloat8580
							+ class336_sub2.aFloat8567 * aClass336_Sub2_5778.aFloat8578
							+ class336_sub2.aFloat8584 * aClass336_Sub2_5778.aFloat8577;
					f_645_ = class336_sub2.aFloat8580 * aClass336_Sub2_5778.aFloat8566
							+ class336_sub2.aFloat8571 * aClass336_Sub2_5778.aFloat8558
							+ class336_sub2.aFloat8566 * aClass336_Sub2_5778.aFloat8584;
					f_646_ = class336_sub2.aFloat8578 * aClass336_Sub2_5778.aFloat8566
							+ class336_sub2.aFloat8561 * aClass336_Sub2_5778.aFloat8558
							+ class336_sub2.aFloat8558 * aClass336_Sub2_5778.aFloat8584;
					f_647_ = class336_sub2.aFloat8577 * aClass336_Sub2_5778.aFloat8566
							+ class336_sub2.aFloat8567 * aClass336_Sub2_5778.aFloat8558
							+ class336_sub2.aFloat8584 * aClass336_Sub2_5778.aFloat8584;
				}
				if (aPureJavaToolkit5770.anInt6795 > 1)
				...
				if (i == -1) {
					for (int i_654_ = 0; i_654_ < anInt5718; i_654_++) {
						...
						float f_658_ = f_630_ + f_642_ * i_655_ + f_631_ * i_656_ + f_645_ * i_657_;
						float f_659_ = f_636_ + f_643_ * i_655_ + f_637_ * i_656_ + f_646_ * i_657_;
						float f_660_ = f + f_644_ * i_655_ + f_625_ * i_656_ + f_647_ * i_657_;
						anIntArray5758[i_654_] = (int) f_660_;
						if (f_660_ >= i_653_) {
							anIntArray5713[i_654_] = aClass374_5741.anInt4633 + (int) (f_658_ * i_651_ / f_660_);
							anIntArray5716[i_654_] = aClass374_5741.anInt4653 + (int) (f_659_ * i_652_ / f_660_);
						} else {
						...
						if (aClass374_5741.aBoolean4617)
							anIntArray5769[i_654_] = (int) (aClass336_Sub2_5778.aFloat8579
									+ (aClass336_Sub2_5778.aFloat8578 * i_655_ + aClass336_Sub2_5778.aFloat8561 * i_656_
											+ aClass336_Sub2_5778.aFloat8558 * i_657_));
					}
					if (aClass209Array5790 != null)
						for (int i_661_ = 0; i_661_ < anInt5762; i_661_++) {
							...
							float f_667_ = class214.anInt2516
									+ (f_630_ + f_642_ * i_664_ + f_631_ * i_665_ + f_645_ * i_666_);
							float f_668_ = class214.anInt2523
									+ (f_636_ + f_643_ * i_664_ + f_637_ * i_665_ + f_646_ * i_666_);
							float f_669_ = f + f_644_ * i_664_ + f_625_ * i_665_ + f_647_ * i_666_;
							if (f_669_ > aPureJavaToolkit5770.anInt6798) {
								class214.anInt2515 = aPureJavaToolkit5770.anInt6786 + (int) (f_667_ * i_651_ / f_669_);
								class214.anInt2521 = aPureJavaToolkit5770.anInt6769 + (int) (f_668_ * i_652_ / f_669_);
								class214.anInt2518 = (int) f_669_ - class209.anInt2486;
								class214.anInt2526 = (int) (class214.anInt2517 * class209.aShort2484 * i_651_
										/ (f_669_ * 128.0F));
								class214.anInt2514 = (int) (class214.anInt2520 * class209.aShort2494 * i_652_
										/ (f_669_ * 128.0F));
							} else
					...
					for (int i_670_ = 0; i_670_ < anInt5718; i_670_++) {
						...
						float f_674_ = f_630_ + f_642_ * i_671_ + f_631_ * i_672_ + f_645_ * i_673_;
						float f_675_ = f_636_ + f_643_ * i_671_ + f_637_ * i_672_ + f_646_ * i_673_;
						float f_676_ = f + f_644_ * i_671_ + f_625_ * i_672_ + f_647_ * i_673_;
						anIntArray5758[i_670_] = (int) f_676_;
						anIntArray5713[i_670_] = aClass374_5741.anInt4633 + (int) (f_674_ * i_651_ / i);
						anIntArray5716[i_670_] = aClass374_5741.anInt4653 + (int) (f_675_ * i_652_ / i);
						if (bool_650_) {
						...
						if (aClass374_5741.aBoolean4617)
							anIntArray5769[i_670_] = (int) (aClass336_Sub2_5778.aFloat8579
									+ (aClass336_Sub2_5778.aFloat8578 * i_671_ + aClass336_Sub2_5778.aFloat8561 * i_672_
											+ aClass336_Sub2_5778.aFloat8558 * i_673_));
					}
					if (aClass209Array5790 != null)
						for (int i_677_ = 0; i_677_ < anInt5762; i_677_++) {
							...
							float f_683_ = f_630_ + f_642_ * i_680_ + f_631_ * i_681_ + f_645_ * i_682_;
							float f_684_ = f_636_ + f_643_ * i_680_ + f_637_ * i_681_ + f_646_ * i_682_;
							class214.anInt2515 = aPureJavaToolkit5770.anInt6786 + (int) (f_683_ * i_651_ / i);
							class214.anInt2521 = aPureJavaToolkit5770.anInt6769 + (int) (f_684_ * i_652_ / i);
				...
				if (entitynode_sub5 != null) {
					...
					short s = aShort5759;
					int i_691_ = i_689_;
					float f_692_ = f_630_ + f_642_ * i_690_ + f_631_ * s + f_645_ * i_691_;
					float f_693_ = f_636_ + f_643_ * i_690_ + f_637_ * s + f_646_ * i_691_;
					float f_694_ = f + f_644_ * i_690_ + f_625_ * s + f_647_ * i_691_;
					if (f_694_ >= i_653_) {
						int i_695_ = (int) f_694_;
						if (i != -1)
							i_695_ = i;
						entitynode_sub5.anInt5985 = aPureJavaToolkit5770.anInt6786 + (int) (f_692_ * i_651_ / i_695_);
						entitynode_sub5.anInt5986 = aPureJavaToolkit5770.anInt6769 + (int) (f_693_ * i_652_ / i_695_);
					} else
						bool_686_ = true;
					i_690_ = i_688_;
					s = aShort5751;
					i_691_ = i_689_;
					float f_696_ = f_630_ + f_642_ * i_690_ + f_631_ * s + f_645_ * i_691_;
					float f_697_ = f_636_ + f_643_ * i_690_ + f_637_ * s + f_646_ * i_691_;
					float f_698_ = f + f_644_ * i_690_ + f_625_ * s + f_647_ * i_691_;
					if (f_698_ >= i_653_) {
						int i_699_ = (int) f_698_;
						if (i != -1)
							i_699_ = i;
						entitynode_sub5.anInt5982 = aPureJavaToolkit5770.anInt6786 + (int) (f_696_ * i_651_ / i_699_);
						entitynode_sub5.anInt5984 = aPureJavaToolkit5770.anInt6769 + (int) (f_697_ * i_652_ / i_699_);
					} else
						bool_686_ = true;
					if (bool_686_)
						if (f_694_ < i_653_ && f_698_ < i_653_)
							bool_687_ = false;
						else if (f_694_ < i_653_) {
							float f_700_ = (f_698_ - aPureJavaToolkit5770.anInt6798) / (f_698_ - f_694_);
						...
						} else if (f_698_ < i_653_) {
							float f_704_ = (f_694_ - i_653_) / (f_694_ - f_698_);
					...
					if (bool_687_) {
						if (f_694_ > f_698_) {
							...
							if (i != -1)
								i_708_ = i;
							entitynode_sub5.anInt5983 = aPureJavaToolkit5770.anInt6786
									+ (int) ((f_692_ + aShort5777) * i_651_ / i_708_) - entitynode_sub5.anInt5985;
						} else {
							int i_709_ = (int) f_698_;
							if (i != -1)
								i_709_ = i;
							entitynode_sub5.anInt5983 = aPureJavaToolkit5770.anInt6786
									+ (int) ((f_696_ + aShort5777) * i_651_ / i_709_) - entitynode_sub5.anInt5982;
						}
				...
				try {
					...
					if (bool_710_)
						method668(bool_648_, aClass374_5741.aBoolean4621 && i_629_ > aClass374_5741.anInt4618
								|| aClass374_5741.aBoolean4617, i_628_, i_629_ - i_628_);
					else
						method681(bool_648_, aClass374_5741.aBoolean4621 && i_629_ > aClass374_5741.anInt4618
								|| aClass374_5741.aBoolean4617, i_628_, i_629_ - i_628_);
	...
	private final int method683(int i, short s, int i_722_) {
		...
		PlayerMasks class91 = aPureJavaToolkit5770.aD1543.method10(s & 0xffff, -8217);
		...
		if (i_724_ != 0) {
			...
			if (i_724_ == 256)
				...
				i_723_ = ((i_725_ & 0xff00ff) * i_726_ + (i_723_ & 0xff00ff) * i_727_ & ~0xff00ff)
						+ ((i_725_ & 0xff00) * i_726_ + (i_723_ & 0xff00) * i_727_ & 0xff0000) >> 8;
			}
		}
	...
	private final void method685(int i) {
		...
		if (aShortArray5773 == null || aShortArray5773[i] == -1) {
			if (aByteArray5784 == null)
				...
				aClass185_5712.anInt2220 = aByteArray5784[i] & 0xff;
			if (anIntArray5761[i] == -1)
				aClass185_5712.method1867(anIntArray5716[s], anIntArray5716[s_739_], anIntArray5716[s_740_],
						anIntArray5713[s], anIntArray5713[s_739_], anIntArray5713[s_740_], anIntArray5758[s],
						anIntArray5758[s_739_], anIntArray5758[s_740_],
						Class170.anIntArray2054[anIntArray5754[i] & 0xffff]);
			else
				aClass185_5712.method1865(anIntArray5716[s], anIntArray5716[s_739_], anIntArray5716[s_740_],
						anIntArray5713[s], anIntArray5713[s_739_], anIntArray5713[s_740_], anIntArray5758[s],
						anIntArray5758[s_739_], anIntArray5758[s_740_], anIntArray5754[i] & 0xffff,
						anIntArray5739[i] & 0xffff, anIntArray5761[i] & 0xffff);
		} else {
			int i_741_ = -16777216;
			if (aByteArray5784 != null)
			...
			if (anIntArray5761[i] == -1) {
				...
				aClass185_5712.method1859(anIntArray5716[s], anIntArray5716[s_739_], anIntArray5716[s_740_],
						anIntArray5713[s], anIntArray5713[s_739_], anIntArray5713[s_740_], anIntArray5758[s],
						anIntArray5758[s_739_], anIntArray5758[s_740_], aFloatArrayArray5763[i][0],
						aFloatArrayArray5763[i][1], aFloatArrayArray5763[i][2], aFloatArrayArray5776[i][0],
						aFloatArrayArray5776[i][1], aFloatArrayArray5776[i][2], i_742_, i_742_, i_742_,
						aClass374_5741.anInt4611, 0, 0, 0, aShortArray5773[i]);
			} else
				aClass185_5712.method1859(anIntArray5716[s], anIntArray5716[s_739_], anIntArray5716[s_740_],
						anIntArray5713[s], anIntArray5713[s_739_], anIntArray5713[s_740_], anIntArray5758[s],
						anIntArray5758[s_739_], anIntArray5758[s_740_], aFloatArrayArray5763[i][0],
						aFloatArrayArray5763[i][1], aFloatArrayArray5763[i][2], aFloatArrayArray5776[i][0],
						aFloatArrayArray5776[i][1], aFloatArrayArray5776[i][2], i_741_ | anIntArray5754[i] & 0xffffff,
						i_741_ | anIntArray5739[i] & 0xffffff, i_741_ | anIntArray5761[i] & 0xffffff,
						aClass374_5741.anInt4611, 0, 0, 0, aShortArray5773[i]);
		}
	}
	...
	@Override
	public final void O(int i, int i_0_, int i_1_) {
	...
	@Override
	public final void p(int i, int i_743_, Plane plane, Plane plane_744_, int i_745_, int i_746_, int i_747_) {
		if (i == 3) {
			if ((anInt5746 & 0x7) != 7)
				throw new IllegalStateException();
		...
		if (i == 4 || i_748_ >= 0 && i_749_ + plane.anInt3398 >> plane.anInt3410 < plane.anInt3408 && i_750_ >= 0
			...
			if (i == 4 || i == 5) {
				if (plane_744_ == null || (i_748_ < 0
						|| i_749_ + plane_744_.anInt3398 >> plane_744_.anInt3410 >= plane_744_.anInt3408 || i_750_ < 0
				...
				if (is[i_748_][i_750_] == i_746_ && is[i_749_][i_750_] == i_746_ && is[i_748_][i_751_] == i_746_
						&& is[i_749_][i_751_] == i_746_)
					return;
			}
			synchronized (this) {
				if (i == 1) {
					...
					for (int i_754_ = 0; i_754_ < anInt5753; i_754_++) {
						...
						int i_761_ = is[i_759_][i_760_] * (plane.anInt3398 - i_757_)
								+ is[i_759_ + 1][i_760_] * i_757_ >> plane.anInt3410;
						int i_762_ = is[i_759_][i_760_ + 1] * (plane.anInt3398 - i_757_)
								+ is[i_759_ + 1][i_760_ + 1] * i_757_ >> plane.anInt3410;
					...
					for (int i_764_ = anInt5753; i_764_ < anInt5718; i_764_++) {
						...
						if (i_769_ >= 0 && i_769_ < is.length - 1 && i_770_ >= 0 && i_770_ < is[0].length - 1) {
							int i_771_ = is[i_769_][i_770_] * (plane.anInt3398 - i_767_)
									+ is[i_769_ + 1][i_770_] * i_767_ >> plane.anInt3410;
							int i_772_ = is[i_769_][i_770_ + 1] * (plane.anInt3398 - i_767_)
									+ is[i_769_ + 1][i_770_ + 1] * i_767_ >> plane.anInt3410;
					...
					for (int i_775_ = 0; i_775_ < anInt5753; i_775_++) {
						...
						if (i_776_ < i_743_) {
							...
							int i_783_ = is[i_781_][i_782_] * (plane.anInt3398 - i_779_)
									+ is[i_781_ + 1][i_782_] * i_779_ >> plane.anInt3410;
							int i_784_ = is[i_781_][i_782_ + 1] * (plane.anInt3398 - i_779_)
									+ is[i_781_ + 1][i_782_ + 1] * i_779_ >> plane.anInt3410;
							int i_785_ = i_783_ * (plane.anInt3398 - i_780_) + i_784_ * i_780_ >> plane.anInt3410;
							anIntArray5772[i_775_] = anIntArray5772[i_775_]
									+ (i_785_ - i_746_) * (i_743_ - i_776_) / i_743_;
						} else
							anIntArray5772[i_775_] = anIntArray5772[i_775_];
					}
					for (int i_786_ = anInt5753; i_786_ < anInt5718; i_786_++) {
						...
						if (i_787_ < i_743_) {
							...
							if (i_792_ >= 0 && i_792_ < plane.anInt3408 - 1 && i_793_ >= 0
									&& i_793_ < plane.anInt3404 - 1) {
								int i_794_ = is[i_792_][i_793_] * (plane.anInt3398 - i_790_)
										+ is[i_792_ + 1][i_793_] * i_790_ >> plane.anInt3410;
								int i_795_ = is[i_792_][i_793_ + 1] * (plane.anInt3398 - i_790_)
										+ is[i_792_ + 1][i_793_ + 1] * i_790_ >> plane.anInt3410;
								int i_796_ = i_794_ * (plane.anInt3398 - i_791_) + i_795_ * i_791_ >> plane.anInt3410;
								anIntArray5772[i_786_] = anIntArray5772[i_786_]
										+ (i_796_ - i_746_) * (i_743_ - i_787_) / i_743_;
							}
						} else
							anIntArray5772[i_786_] = anIntArray5772[i_786_];
					}
					...
					for (int i_803_ = 0; i_803_ < anInt5753; i_803_++) {
						...
						int i_810_ = is_752_[i_808_][i_809_] * (plane_744_.anInt3398 - i_806_)
								+ is_752_[i_808_ + 1][i_809_] * i_806_ >> plane_744_.anInt3410;
						int i_811_ = is_752_[i_808_][i_809_ + 1] * (plane_744_.anInt3398 - i_806_)
								+ is_752_[i_808_ + 1][i_809_ + 1] * i_806_ >> plane_744_.anInt3410;
					...
					for (int i_813_ = anInt5753; i_813_ < anInt5718; i_813_++) {
						...
						if (i_818_ >= 0 && i_818_ < plane_744_.anInt3408 - 1 && i_819_ >= 0
								&& i_819_ < plane_744_.anInt3404 - 1) {
							int i_820_ = is_752_[i_818_][i_819_] * (plane_744_.anInt3398 - i_816_)
									+ is_752_[i_818_ + 1][i_819_] * i_816_ >> plane_744_.anInt3410;
							int i_821_ = is_752_[i_818_][i_819_ + 1] * (plane_744_.anInt3398 - i_816_)
									+ is_752_[i_818_ + 1][i_819_ + 1] * i_816_ >> plane_744_.anInt3410;
							int i_822_ = i_820_ * (plane_744_.anInt3398 - i_817_)
									+ i_821_ * i_817_ >> plane_744_.anInt3410;
					...
					for (int i_825_ = 0; i_825_ < anInt5753; i_825_++) {
						...
						int i_832_ = is[i_830_][i_831_] * (plane.anInt3398 - i_828_)
								+ is[i_830_ + 1][i_831_] * i_828_ >> plane.anInt3410;
						int i_833_ = is[i_830_][i_831_ + 1] * (plane.anInt3398 - i_828_)
								+ is[i_830_ + 1][i_831_ + 1] * i_828_ >> plane.anInt3410;
						int i_834_ = i_832_ * (plane.anInt3398 - i_829_) + i_833_ * i_829_ >> plane.anInt3410;
						i_832_ = is_752_[i_830_][i_831_] * (plane_744_.anInt3398 - i_828_)
								+ is_752_[i_830_ + 1][i_831_] * i_828_ >> plane_744_.anInt3410;
						i_833_ = is_752_[i_830_][i_831_ + 1] * (plane_744_.anInt3398 - i_828_)
								+ is_752_[i_830_ + 1][i_831_ + 1] * i_828_ >> plane_744_.anInt3410;
						int i_835_ = i_832_ * (plane_744_.anInt3398 - i_829_) + i_833_ * i_829_ >> plane_744_.anInt3410;
						int i_836_ = i_834_ - i_835_ - i_743_;
						anIntArray5772[i_825_] = ((anIntArray5772[i_825_] << 8) / i_824_ * i_836_ >> 8)
								- (i_746_ - i_834_);
					}
					for (int i_837_ = anInt5753; i_837_ < anInt5718; i_837_++) {
						...
						if (i_842_ >= 0 && i_842_ < plane.anInt3408 - 1 && i_842_ < plane_744_.anInt3408 - 1
								&& i_843_ >= 0 && i_843_ < plane.anInt3404 - 1 && i_843_ < plane_744_.anInt3404 - 1) {
							int i_844_ = is[i_842_][i_843_] * (plane.anInt3398 - i_840_)
									+ is[i_842_ + 1][i_843_] * i_840_ >> plane.anInt3410;
							int i_845_ = is[i_842_][i_843_ + 1] * (plane.anInt3398 - i_840_)
									+ is[i_842_ + 1][i_843_ + 1] * i_840_ >> plane.anInt3410;
							int i_846_ = i_844_ * (plane.anInt3398 - i_841_) + i_845_ * i_841_ >> plane.anInt3410;
							i_844_ = is_752_[i_842_][i_843_] * (plane_744_.anInt3398 - i_840_)
									+ is_752_[i_842_ + 1][i_843_] * i_840_ >> plane_744_.anInt3410;
							i_845_ = is_752_[i_842_][i_843_ + 1] * (plane_744_.anInt3398 - i_840_)
									+ is_752_[i_842_ + 1][i_843_ + 1] * i_840_ >> plane_744_.anInt3410;
							int i_847_ = i_844_ * (plane_744_.anInt3398 - i_841_)
									+ i_845_ * i_841_ >> plane_744_.anInt3410;
							int i_848_ = i_846_ - i_847_ - i_743_;
							anIntArray5772[i_837_] = ((anIntArray5772[i_837_] << 8) / i_824_ * i_848_ >> 8)
									- (i_746_ - i_846_);
						}
					}
				}
	...
	@Override
	public final void P(int i, int i_210_, int i_211_, int i_212_) {
		if (i == 0) {
			int i_213_ = 0;
			anInt5779 = 0;
			anInt5752 = 0;
			...
			for (int i_216_ = 0; i_216_ < anInt5718; i_216_++) {
				...
				if (i_212_ != 0) {
					...
					anIntArray5772[i_216_] = anIntArray5772[i_216_] * i_218_ - anIntArray5748[i_216_] * i_217_
							+ 16383 >> 14;
				...
				if (i_210_ != 0) {
					...
					anIntArray5717[i_216_] = anIntArray5772[i_216_] * i_220_ + anIntArray5717[i_216_] * i_221_
							+ 16383 >> 14;
				...
				if (i_211_ != 0) {
					...
					anIntArray5717[i_216_] = anIntArray5717[i_216_] * i_224_ - anIntArray5748[i_216_] * i_223_
							+ 16383 >> 14;
