...
public class RSCanvas extends java.awt.Canvas {
	...
	public static Color[] aColorArray73 = { new Color(16777215), new Color(16777215), new Color(16741381),
			new Color(16741381) };
	public static int anInt68;
	public static int anInt69 = 255;
	public static int anInt71;
	public static int anInt72;
	public static int anInt74;
	public static int[] anIntArray70 = new int[8];
	...
	public static final int method125(int i, int i_0_, byte b) {
		if (b != -45)
			method124(52);
		anInt71++;
		int i_1_;
		...
		if (i != Class213.aNode_Sub27_2512.aClass320_Sub29_7270.method3791(false)) {
			...
			GlobalMessage.method300(i, true, false);
		}
		Node_Sub38_Sub31.displayMode(1);
		return i_1_;
	}

	public static final boolean method126(int i, int i_2_, int i_3_) {
		anInt72++;
		if (i <= 15)
			return true;
