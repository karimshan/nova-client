...
public class RuntimeException_Sub1 extends RuntimeException {
	public static OutgoingPacket aClass318_4920 = new OutgoingPacket(39, 12);
	...
	public static final boolean method4207(int i, int i_0_) {
		anInt4917++;
		if (i_0_ != 19154)
			aClass318_4920 = null;
	...
	public static final void method4209(int i, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_,
			int i_9_) {
		anInt4915++;
		if (i_3_ > -41)
			method4207(38, 72);
		if ((i_8_ ^ 0xffffffff) == (i_5_ ^ 0xffffffff) && i_1_ == i && i_4_ == i_9_
	...
	public static final void method4210(byte b) {
		anInt4918++;
		...
		for (int i = 0; Class290_Sub11.anInt8181 > i; i++) {
			...
			for (int i_36_ = 0; i_36_ < Class117.anInt1479; i_36_++) {
				...
				Class352.anInterface6Array4332[i_37_].method18(i_36_ * StandardSprite.anInt8946, aa_Sub3.anInt5493 * i,
						StandardSprite.anInt8946, aa_Sub3.anInt5493, 0, 0, true, true);
			}
		}
	}
