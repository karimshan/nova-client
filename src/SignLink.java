...
public class SignLink implements Runnable {
	...
	public static Method aMethod4000;
	public static Method aMethod4004;
	private static int anInt3978;
	public static String aString3981;
	public static String aString3982;
	public static String aString3984;
	private static String aString3987;
	public static String aString3989;
	public static String aString3995;
	...
	private static final FileOnDisk method3630(String string, int i, String string_5_, int i_6_) {
		...
		String string_7_;
		if (i == 33)
			string_7_ = "preferences" + string_5_ + "_rc.dat";
		else if (i != 34)
			string_7_ = "preferences" + string_5_ + ".dat";
		else
			string_7_ = "preferences" + string_5_ + "_wip.dat";
	...
	public static final FileOnDisk method3633(int i, String string) {
		if (i != -15)
			method3633(-39, null);
	...
	SignLink(int i, String string, int i_20_, boolean bool) throws Exception {
		...
		if (!aBoolean3985) {
			try {
				aMethod4004 = Class.forName("java.awt.Component").getDeclaredMethod("setFocusTraversalKeysEnabled",
						new Class[] { Boolean.TYPE });
			} catch (Exception exception) {
				/* empty */
			}
			try {
				aMethod4000 = Class.forName("java.awt.Container").getDeclaredMethod("setFocusCycleRoot",
						new Class[] { Boolean.TYPE });
			} catch (Exception exception) {
				/* empty */
			}
		...
		if (aBoolean4005) {
			...
			for (int i_21_ = 0; i_21_ < i_20_; i_21_++)
				aFileOnDiskArray4003[i_21_] = new FileOnDisk(Class351.method4003("main_file_cache.idx" + i_21_, 66),
						"rw", 1048576L);
			if (aBoolean3985)
				try {
		...
		if (aBoolean4005 && !aBoolean3985) {
			...
			for (ThreadGroup threadgroup_22_ = threadgroup
					.getParent(); threadgroup_22_ != null; threadgroup_22_ = threadgroup.getParent())
	...
	public final Object method3626(byte b) {
		if (b != 94)
			method3640(15);
		return anObject3991;
	}

	public final Class241 method3627(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
		if (i_1_ != -1071975440)
			return null;
		return method3643((i << 16) - -i_3_, 6, null, 9, (i_2_ << 16) + i_0_);
	}

	public final Class241 method3628(Class<?> var_class, String string, int i) {
		if (i != 0)
			anInt3978 = -83;
		return method3643(0, 9, new Object[] { var_class, string }, i + 9, 0);
	}

	public final Class241 method3629(String string, boolean bool, boolean bool_4_, int i) {
		if (bool != true)
			return null;
		return method3643(0, bool_4_ ? 22 : 1, string, 9, i);
	}

	public final Class241 method3631(boolean bool, String string, byte b) {
		if (b <= 70)
			aString3987 = null;
		if (!bool)
	...
	public final Class241 method3632(byte b, int i) {
		if (b != -78)
			run();
		return method3643(0, 3, null, b ^ ~0x44, i);
	}

	public final Class241 method3634(byte b) {
		if (b != 25)
			method3638(null, null, null, false);
		return method3643(0, 5, null, 9, 0);
	}

	public final void method3635(int i) {
		if (i != 0)
			aMethod4004 = null;
		synchronized (this) {
			aBoolean3993 = true;
	...
	public final Class241 method3636(String string, byte b) {
		if (b != 95)
			return null;
		return method3643(0, 16, string, b + -86, 0);
	}

	public final boolean method3637(File file, int i, byte[] bs) {
		try {
	...
	public final Class241 method3638(Class<?> var_class, @SuppressWarnings("rawtypes") Class[] var_classes, String string,
			boolean bool) {
		if (bool != false)
			method3635(-84);
	...
	public final Class241 method3639(Frame frame, int i) {
		if (i != 14438)
			method3629(null, false, true, -92);
		return method3643(0, 7, frame, i ^ 0x386f, 0);
	}

	public final boolean method3640(int i) {
		if (i < 118)
			aClass241_3983 = null;
		if (!aBoolean4005)
			return false;
	...
	public final Class241 method3641(byte b, Runnable runnable, int i) {
		if (b != 50)
			aBoolean3993 = false;
		return method3643(0, 2, runnable, 9, i);
	}

	public final Class241 method3642(byte b, URL url) {
		if (b != -80)
			method3640(111);
	...
	public final void method3644(byte b) {
		aLong3999 = Class313.method3650(false) + 5000L;
	}

	public final Class241 method3645(int i, byte b, int[] is, Component component, Point point, int i_14_) {
			...
			try {
				...
				if ((i ^ 0xffffffff) == -2) {
						...
						if (i != 4) {
							if (i != 8) {
								if ((i ^ 0xffffffff) == -10) {
									...
									class241.anObject2956 = ((Class<?>) objects[0])
									...
									if ((i ^ 0xffffffff) == -4) {
										...
										String string = String.valueOf(class241.anInt2952 >> 24 & 0xff) + "."
												+ ((0xffd9e4 & class241.anInt2952) >> 16) + "."
												+ (class241.anInt2952 >> 8 & 0xff) + "." + (0xff & class241.anInt2952);
										...
										if ((i ^ 0xffffffff) == -7) {
											...
											if (aBoolean3985)
												aClass11_3997.method191(frame, class241.anInt2951 >> 16,
														0xffff & class241.anInt2951, 0xffff & class241.anInt2952, 106,
														class241.anInt2952 >>> 16);
											else
												Class.forName("Display").getMethod("enter", new Class[] {
														aClass4006 == null ? aClass4006 = method3646("java.awt.Frame")
																: aClass4006,
														Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE })
														.invoke(anObject3980,
																new Object[] { frame,
																		new Integer(class241.anInt2952 >>> 16),
																		new Integer(0xffff & class241.anInt2952),
																		new Integer(class241.anInt2951 >> 16),
																		new Integer(0xffff & class241.anInt2951) });
										} else if (i == 7) {
											if (aBoolean3985)
												aClass11_3997.method192((Frame) class241.anObject2954, 8);
											else
												Class.forName("Display").getMethod("exit", new Class[0])
														.invoke(anObject3980, new Object[0]);
										} else if ((i ^ 0xffffffff) == -13) {
											FileOnDisk fileondisk = method3630(aString3987, anInt3978,
													(String) class241.anObject2954, 19613);
											...
											if (aBoolean4005 && (i ^ 0xffffffff) == -15) {
												...
												if (aBoolean3985)
													...
													Class.forName("Class208")
															.getDeclaredMethod("method2046",
																	new Class[] { Integer.TYPE, Integer.TYPE })
															.invoke(anObject3990, new Object[] { new Integer(i_16_),
																	new Integer(i_17_) });
												...
												if (aBoolean3985)
													...
													Class.forName("Class208").getDeclaredMethod("method2045",
															new Class[] { aClass4007 == null
																	? aClass4007 = method3646("java.awt.Component")
																	: aClass4007, Boolean.TYPE })
															.invoke(anObject3990,
																	new Object[] { component, new Boolean(bool) });
											} else if (!aBoolean3985 && (i ^ 0xffffffff) == -18) {
												Object[] objects = (Object[]) class241.anObject2954;
												Class.forName("Class208")
														.getDeclaredMethod("method2047",
																new Class[] {
																		aClass4007 == null
																				? aClass4007 = method3646(
																						"java.awt.Component")
																				: aClass4007,
																		aClass4008 == null
																				? aClass4008 = method3646("[I")
																				: aClass4008,
																		Integer.TYPE, Integer.TYPE,
																		aClass4009 == null
																				? aClass4009 = method3646(
																						"java.awt.Point")
																				: aClass4009 })
														.invoke(anObject3990, new Object[] { (Component) objects[0],
																(int[]) objects[1], new Integer(class241.anInt2952),
																new Integer(class241.anInt2951), (Point) objects[2] });
											} else if (i == 16)
												try {
											...
											FileOnDisk fileondisk = method3630("", anInt3978,
													(String) class241.anObject2954, 19613);
											class241.anObject2956 = fileondisk;
										}
									} else if (!aBoolean3985)
										class241.anObject2956 = Class.forName("Display")
								...
								if (aBoolean4005 && ((Class<?>) objects[0]).getClassLoader() == null)
									throw new SecurityException();
								class241.anObject2956 = ((Class<?>) objects[0]).getDeclaredMethod((String) objects[1],
										(Class[]) objects[2]);
							}
						} else {
					...
					if (aLong3999 > Class313.method3650(false))
						throw new IOException();
					try {
						class241.anObject2956 = Node_Sub38_Sub14
								.method2834((byte) -117, (String) class241.anObject2954, class241.anInt2952)
								.method435(30749);
