...
public class StandardDrawableModel extends DrawableModel {
	public static IncomingPacket aClass192_5878 = new IncomingPacket(46, 3);
	...
	public static final void method700(int i) {
		anInt5907++;
	...
	public static final void method704(int i, int i_715_, int i_716_, int i_717_, Animable_Sub3 animable_sub3) {
	...
	private NPCMasks aClass284_5867;
	...
	StandardDrawableModel(AbstractToolkit abstracttoolkit, Model model, int i, int i_8_, int i_9_, int i_10_) {
		...
		for (int i_11_ = 0; i_11_ < model.anInt2572; i_11_++)
			if (model.aByteArray2594 == null || (model.aByteArray2594[i_11_] ^ 0xffffffff) != -3) {
				if (model.aShortArray2587 != null && (model.aShortArray2587[i_11_] ^ 0xffffffff) != 0) {
					PlayerMasks class91 = var_d.method10(model.aShortArray2587[i_11_] & 0xffff, -8217);
		...
		for (int i_12_ = 0; (i_12_ ^ 0xffffffff) > (anInt5813 ^ 0xffffffff); i_12_++) {
				...
				for (Class17 class17 : model.aClass17Array2621) {
					if ((class17.anInt273 ^ 0xffffffff) == (i_13_ ^ 0xffffffff)) {
						...
						if ((class352.anInt4330 ^ 0xffffffff) != 0) {
							PlayerMasks class91_20_ = var_d.method10(class352.anInt4330, -8217);
			...
			boolean bool_22_ = model.aByteArray2622 != null && (model.aByteArray2622[i_13_] ^ 0xffffffff) != -1
					|| class91 != null && (class91.anInt1226 ^ 0xffffffff) != -1;
			...
			i_15_ += 0xffff & i_12_;
			ls[i_12_] = ((long) i_14_ << 32) + i_15_;
			aBoolean5819 |= bool_22_;
			StandardDrawableModel standarddrawablemodel_23_ = this;
			standarddrawablemodel_23_.aBoolean5866 = standarddrawablemodel_23_.aBoolean5866
					| (class91 != null && ((class91.aByte1211 ^ 0xffffffff) != -1 || class91.aByte1203 != 0));
		}
		...
		if (model.aClass17Array2621 != null) {
			...
			for (int i_24_ = 0; anInt5811 > i_24_; i_24_++) {
				...
				i_27_ = i_27_ | -(model.aByteArray2622 == null ? (int) 0 : model.aByteArray2622[class17.anInt273])
						+ 255 << 24;
				aClass268Array5856[i_24_] = new Class268(i_25_, model.aShortArray2600[class17.anInt273],
						...
						class352.anInt4324, class352.aBoolean4325, class352.aBoolean4335, class17.anInt278);
		...
		for (int i_32_ = 0; model.anInt2572 > i_32_; i_32_++) {
			...
			int i_43_;
			for (i_43_ = i_39_ * i_35_ - i_38_ * i_36_; (i_41_ ^ 0xffffffff) < -8193 || i_42_ > 8192
					|| (i_43_ ^ 0xffffffff) < -8193 || i_41_ < -8192 || (i_42_ ^ 0xffffffff) > 8191
					|| i_43_ < -8192; i_42_ >>= 1) {
				i_41_ >>= 1;
				i_43_ >>= 1;
			}
			int i_44_ = (int) Math.sqrt(i_42_ * i_42_ + i_41_ * i_41_ - -(i_43_ * i_43_));
			if (i_44_ <= 0)
				i_44_ = 1;
		...
		for (int i_45_ = 0; (i_45_ ^ 0xffffffff) > (anInt5813 ^ 0xffffffff); i_45_++) {
			...
			if (s != -1 && (0x40 & anInt5896) != 0) {
				PlayerMasks class91 = var_d.method10(s & 0xffff, -8217);
			...
			if (s != -1)
				if (i_48_ != -1) {
					...
					if ((b ^ 0xffffffff) == -1) {
						...
						float f_64_ = model.anIntArray2616[s_61_];
						float f_65_ = model.anIntArray2576[s_61_];
						float f_66_ = model.anIntArray2574[s_61_];
						float f_67_ = -f_64_ + model.anIntArray2616[s_62_];
						float f_68_ = -f_65_ + model.anIntArray2576[s_62_];
						float f_69_ = model.anIntArray2574[s_62_] - f_66_;
						float f_70_ = model.anIntArray2616[s_63_] - f_64_;
						float f_71_ = -f_65_ + model.anIntArray2576[s_63_];
						float f_72_ = -f_66_ + model.anIntArray2574[s_63_];
						float f_73_ = model.anIntArray2616[s_58_] - f_64_;
						float f_74_ = -f_65_ + model.anIntArray2576[s_58_];
						float f_75_ = -f_66_ + model.anIntArray2574[s_58_];
						float f_76_ = -f_64_ + model.anIntArray2616[s_59_];
						float f_77_ = model.anIntArray2576[s_59_] - f_65_;
						float f_78_ = -f_66_ + model.anIntArray2574[s_59_];
						float f_79_ = model.anIntArray2616[s_60_] - f_64_;
						float f_80_ = -f_65_ + model.anIntArray2576[s_60_];
						float f_81_ = model.anIntArray2574[s_60_] - f_66_;
						...
						float f_96_ = model.anIntArray2617[i_48_] / 256.0F;
						if ((b ^ 0xffffffff) == -2) {
							float f_97_ = model.anIntArray2593[i_48_] / 1024.0F;
							Class262_Sub1.method3151(fs, f_96_, i_94_, model.anIntArray2616[s_89_], b_95_,
									Class20_Sub1.aFloatArray5507, f_97_, i_93_, -2356, model.anIntArray2576[s_89_],
									model.anIntArray2574[s_89_], i_92_);
							f = Class20_Sub1.aFloatArray5507[0];
							f_50_ = Class20_Sub1.aFloatArray5507[1];
							Class262_Sub1.method3151(fs, f_96_, i_94_, model.anIntArray2616[s_90_], b_95_,
									Class20_Sub1.aFloatArray5507, f_97_, i_93_, -2356, model.anIntArray2576[s_90_],
									model.anIntArray2574[s_90_], i_92_);
							f_51_ = Class20_Sub1.aFloatArray5507[0];
							f_52_ = Class20_Sub1.aFloatArray5507[1];
							Class262_Sub1.method3151(fs, f_96_, i_94_, model.anIntArray2616[s_91_], b_95_,
									Class20_Sub1.aFloatArray5507, f_97_, i_93_, -2356, model.anIntArray2576[s_91_],
									model.anIntArray2574[s_91_], i_92_);
							...
							float f_99_ = model.anIntArray2615[i_48_] / 256.0F;
							float f_100_ = model.anIntArray2584[i_48_] / 256.0F;
							...
							float f_110_ = 64.0F / model.anIntArray2603[i_48_];
							float f_111_ = 64.0F / model.anIntArray2588[i_48_];
							float f_112_ = 64.0F / model.anIntArray2593[i_48_];
							float f_113_ = (fs[1] * i_108_ + fs[0] * i_107_ + i_109_ * fs[2]) / f_110_;
							float f_114_ = (i_108_ * fs[4] + fs[3] * i_107_ + fs[5] * i_109_) / f_111_;
							float f_115_ = (i_109_ * fs[8] + (i_107_ * fs[6] + i_108_ * fs[7])) / f_112_;
							i_57_ = PlayerMasks.method1036(2, f_115_, f_113_, f_114_);
							Class39.method407(f_96_, i_57_, model.anIntArray2616[s_89_], f_99_, i_93_,
									Class20_Sub1.aFloatArray5507, model.anIntArray2576[s_89_], 101,
									model.anIntArray2574[s_89_], i_92_, i_94_, f_100_, fs, b_95_);
							f = Class20_Sub1.aFloatArray5507[0];
							f_50_ = Class20_Sub1.aFloatArray5507[1];
							Class39.method407(f_96_, i_57_, model.anIntArray2616[s_90_], f_99_, i_93_,
									Class20_Sub1.aFloatArray5507, model.anIntArray2576[s_90_], 77,
									model.anIntArray2574[s_90_], i_92_, i_94_, f_100_, fs, b_95_);
							f_51_ = Class20_Sub1.aFloatArray5507[0];
							f_52_ = Class20_Sub1.aFloatArray5507[1];
							Class39.method407(f_96_, i_57_, model.anIntArray2616[s_91_], f_99_, i_93_,
									Class20_Sub1.aFloatArray5507, model.anIntArray2576[s_91_], 105,
									model.anIntArray2574[s_91_], i_92_, i_94_, f_100_, fs, b_95_);
							f_53_ = Class20_Sub1.aFloatArray5507[0];
							f_54_ = Class20_Sub1.aFloatArray5507[1];
						} else if ((b ^ 0xffffffff) == -4) {
							Class212.method2053(i_92_, model.anIntArray2574[s_89_], model.anIntArray2576[s_89_],
									Class20_Sub1.aFloatArray5507, i_94_, f_96_, fs, b_95_, model.anIntArray2616[s_89_],
									-4, i_93_);
							f = Class20_Sub1.aFloatArray5507[0];
							f_50_ = Class20_Sub1.aFloatArray5507[1];
							Class212.method2053(i_92_, model.anIntArray2574[s_90_], model.anIntArray2576[s_90_],
									Class20_Sub1.aFloatArray5507, i_94_, f_96_, fs, b_95_, model.anIntArray2616[s_90_],
									-4, i_93_);
							f_51_ = Class20_Sub1.aFloatArray5507[0];
							f_52_ = Class20_Sub1.aFloatArray5507[1];
							Class212.method2053(i_92_, model.anIntArray2574[s_91_], model.anIntArray2576[s_91_],
									Class20_Sub1.aFloatArray5507, i_94_, f_96_, fs, b_95_, model.anIntArray2616[s_91_],
									-4, i_93_);
							f_54_ = Class20_Sub1.aFloatArray5507[1];
							f_53_ = Class20_Sub1.aFloatArray5507[0];
							if ((b_95_ & 0x1) != 0) {
			...
			if (b == 0) {
				long l = (i_49_ + ((long) (i_57_ << 24) + (long) (i_47_ << 8)) << 32) + (i_48_ << 2);
				...
				aShortArray5841[i_45_] = method695(class344.anInt4263, class344.anInt4264, f, s_116_,
						class344.anInt4260, i_45_, 2971, f_50_, l, class344.anInt4262, model);
				class344 = class344s[s_117_];
				aShortArray5846[i_45_] = method695(class344.anInt4263, class344.anInt4264, f_51_, s_117_,
						class344.anInt4260, i_45_, 2971, f_52_, i_55_ + l, class344.anInt4262, model);
				class344 = class344s[s_118_];
				aShortArray5906[i_45_] = method695(class344.anInt4263, class344.anInt4264, f_53_, s_118_,
						class344.anInt4260, i_45_, 2971, f_54_, i_56_ + l, class344.anInt4262, model);
			} else if ((b ^ 0xffffffff) == -2) {
				Class221 class221 = class221s[i_46_];
				long l = (i_49_ + ((i_57_ << 24) - -(long) (i_47_ << 8)) << 32) + (class221.anInt2629 + 256 << 12)
						+ (((class221.anInt2631 ^ 0xffffffff) >= -1 ? 2048 : 1024) + (i_48_ << 2)
								- -(256 + class221.anInt2632 << 22));
				aShortArray5841[i_45_] = method695(class221.anInt2632, 0, f, model.aShortArray2600[i_46_],
						class221.anInt2631, i_45_, 2971, f_50_, l, class221.anInt2629, model);
				aShortArray5846[i_45_] = method695(class221.anInt2632, 0, f_51_, model.aShortArray2583[i_46_],
						class221.anInt2631, i_45_, 2971, f_52_, l + i_55_, class221.anInt2629, model);
				aShortArray5906[i_45_] = method695(class221.anInt2632, 0, f_53_, model.aShortArray2589[i_46_],
						class221.anInt2631, i_45_, 2971, f_54_, l + i_56_, class221.anInt2629, model);
			}
			if (model.aByteArray2622 != null)
	...
	@Override
	public final void aa(short s, short s_633_) {
		anInt5901++;
		...
		byte b_634_ = 0;
		if (s != -1) {
			PlayerMasks class91 = var_d.method10(0xffff & s, -8217);
		...
		if ((s_633_ ^ 0xffffffff) != 0) {
			PlayerMasks class91 = var_d.method10(s_633_ & 0xffff, -8217);
		...
		if (b != b_635_ | b_634_ != b_636_) {
			if (aClass268Array5856 != null)
				for (int i = 0; anInt5811 > i; i++) {
					...
					class14.anInt220 = Class85.anIntArray1158[aShortArray5802[class268.anInt3456] & 0xffff] & 0xffffff
							| class14.anInt220 & ~0xffffff;
				}
			method703(0);
		}
	}
	...
	@Override
	public final void H(int i, int i_738_, int i_739_) {
	...
	@Override
	public final void I(int i, int[] is, int i_357_, int i_358_, int i_359_, boolean bool, int i_360_, int[] is_361_) {
		anInt5798++;
		...
		if (i == 0) {
			...
			if (is_361_ != null) {
				...
				if (Class146.aBoolean1814) {
					int i_383_ = Class210.anInt2498 * is_361_[6] + Class270_Sub2_Sub2.anInt10557 * is_361_[3]
							+ is_361_[0] * Class146.anInt1817 - -8192 >> 14;
					int i_384_ = 8192 + (is_361_[1] * Class146.anInt1817 + is_361_[4] * Class270_Sub2_Sub2.anInt10557
							+ Class210.anInt2498 * is_361_[7]) >> 14;
					int i_385_ = Class210.anInt2498 * is_361_[8]
							+ (is_361_[5] * Class270_Sub2_Sub2.anInt10557 + Class146.anInt1817 * is_361_[2])
							+ 8192 >> 14;
					i_383_ += i_380_;
					i_384_ += i_381_;
					i_385_ += i_382_;
				...
				int i_395_ = is_386_[2] * -Class210.anInt2498 + (is_386_[1] * -Class270_Sub2_Sub2.anInt10557
						+ (is_386_[0] * -Class146.anInt1817 + 8192)) >> 14;
				int i_396_ = 8192 + -Class146.anInt1817 * is_386_[3]
						- (-(-Class270_Sub2_Sub2.anInt10557 * is_386_[4]) - -Class210.anInt2498 * is_386_[5]) >> 14;
				int i_397_ = -Class270_Sub2_Sub2.anInt10557 * is_386_[7] + -Class146.anInt1817 * is_386_[6]
						- (-(-Class210.anInt2498 * is_386_[8]) + -8192) >> 14;
					...
					if (i_418_ < anIntArrayArray5847.length) {
						...
						for (int i_420_ = 0; (is_419_.length ^ 0xffffffff) < (i_420_ ^ 0xffffffff); i_420_++) {
							...
							if (aShortArray5814 == null || (aShortArray5814[i_421_] & i_360_) != 0) {
								int i_422_ = is_409_[2] * anIntArray5913[i_421_]
										+ (is_409_[1] * anIntArray5897[i_421_] + anIntArray5879[i_421_] * is_409_[0])
										+ 8192 >> 14;
								int i_423_ = 8192
										+ (anIntArray5897[i_421_] * is_409_[4] + is_409_[3] * anIntArray5879[i_421_])
										- -(anIntArray5913[i_421_] * is_409_[5]) >> 14;
								i_423_ += i_415_;
								i_422_ += i_414_;
								int i_424_ = anIntArray5879[i_421_] * is_409_[6]
										- (-(anIntArray5897[i_421_] * is_409_[7]) - anIntArray5913[i_421_] * is_409_[8]
												- 8192) >> 14;
						...
						for (int i_428_ = 0; (i_428_ ^ 0xffffffff) > (is_427_.length ^ 0xffffffff); i_428_++) {
							...
							if (aShortArray5814 == null || (i_360_ & aShortArray5814[i_429_] ^ 0xffffffff) != -1) {
								...
								if (i_359_ != 0) {
									...
									int i_432_ = anIntArray5897[i_429_] * i_430_ - -(i_431_ * anIntArray5879[i_429_])
											+ 16383 >> 14;
									anIntArray5897[i_429_] = -(anIntArray5879[i_429_] * i_430_)
											+ anIntArray5897[i_429_] * i_431_ + 16383 >> 14;
									anIntArray5879[i_429_] = i_432_;
								}
								if (i_357_ != 0) {
									int i_433_ = Class335.anIntArray4167[i_357_];
									int i_434_ = Class335.anIntArray4165[i_357_];
									int i_435_ = 16383 + i_434_ * anIntArray5897[i_429_]
											+ -(i_433_ * anIntArray5913[i_429_]) >> 14;
									anIntArray5913[i_429_] = 16383
											+ (i_433_ * anIntArray5897[i_429_] + i_434_ * anIntArray5913[i_429_]) >> 14;
								...
								if ((i_358_ ^ 0xffffffff) != -1) {
									...
									int i_438_ = 16383
											+ (anIntArray5913[i_429_] * i_436_ + i_437_ * anIntArray5879[i_429_]) >> 14;
									anIntArray5913[i_429_] = 16383 + (-(i_436_ * anIntArray5879[i_429_])
											+ anIntArray5913[i_429_] * i_437_) >> 14;
								...
								if (aShortArray5814 == null || (i_360_ & aShortArray5814[i_443_] ^ 0xffffffff) != -1) {
									...
									for (int i_446_ = i_444_; i_445_ > i_446_; i_446_++) {
										...
										if (i_359_ != 0) {
											...
											int i_450_ = i_449_ * aShortArray5889[i_447_]
													+ i_448_ * aShortArray5898[i_447_] + 16383 >> 14;
											aShortArray5898[i_447_] = (short) (-(aShortArray5889[i_447_] * i_448_)
													+ i_449_ * aShortArray5898[i_447_] - -16383 >> 14);
											aShortArray5889[i_447_] = (short) i_450_;
										}
										if (i_357_ != 0) {
											int i_451_ = Class335.anIntArray4167[i_357_];
											int i_452_ = Class335.anIntArray4165[i_357_];
											int i_453_ = aShortArray5898[i_447_] * i_452_
													- i_451_ * aShortArray5794[i_447_] + 16383 >> 14;
											aShortArray5794[i_447_] = (short) (16383 + aShortArray5898[i_447_] * i_451_
													+ aShortArray5794[i_447_] * i_452_ >> 14);
											aShortArray5898[i_447_] = (short) i_453_;
										}
										if (i_358_ != 0) {
											int i_454_ = Class335.anIntArray4167[i_358_];
											int i_455_ = Class335.anIntArray4165[i_358_];
											int i_456_ = i_454_ * aShortArray5794[i_447_]
													- -(i_455_ * aShortArray5889[i_447_]) + 16383 >> 14;
											aShortArray5794[i_447_] = (short) (aShortArray5794[i_447_] * i_455_
													+ -(i_454_ * aShortArray5889[i_447_]) - -16383 >> 14);
			...
			if (is_361_ != null) {
				...
				if (Class146.aBoolean1814) {
					int i_463_ = is_361_[6] * Class210.anInt2498 + (is_361_[0] * Class146.anInt1817
							+ (Class270_Sub2_Sub2.anInt10557 * is_361_[3] - -8192)) >> 14;
					int i_464_ = 8192 + is_361_[4] * Class270_Sub2_Sub2.anInt10557
							+ (Class146.anInt1817 * is_361_[1] - -(Class210.anInt2498 * is_361_[7])) >> 14;
					i_463_ += i_460_;
					i_464_ += i_461_;
					int i_465_ = 8192 + (Class210.anInt2498 * is_361_[8]
							+ (is_361_[5] * Class270_Sub2_Sub2.anInt10557 + Class146.anInt1817 * is_361_[2])) >> 14;
				...
				for (int i_487_ = 0; i_487_ < i_362_; i_487_++) {
					...
					if ((anIntArrayArray5847.length ^ 0xffffffff) < (i_488_ ^ 0xffffffff)) {
						...
						for (int element : is_489_) {
							int i_491_ = element;
							if (aShortArray5814 == null || (i_360_ & aShortArray5814[i_491_] ^ 0xffffffff) != -1) {
								int i_492_ = anIntArray5913[i_491_] * is_479_[2] + (anIntArray5879[i_491_] * is_479_[0]
										- -(is_479_[1] * anIntArray5897[i_491_]) - -8192) >> 14;
								int i_493_ = 8192
										+ (is_479_[4] * anIntArray5897[i_491_] + anIntArray5879[i_491_] * is_479_[3])
										+ anIntArray5913[i_491_] * is_479_[5] >> 14;
								i_492_ += i_484_;
								i_493_ += i_485_;
								int i_494_ = is_479_[8] * anIntArray5913[i_491_] + is_479_[6] * anIntArray5879[i_491_]
										+ anIntArray5897[i_491_] * is_479_[7] + 8192 >> 14;
				...
				if (bool_500_) {
					if (aClass268Array5856 != null)
						for (int i_507_ = 0; (i_507_ ^ 0xffffffff) > (anInt5811 ^ 0xffffffff); i_507_++) {
							...
							class14.anInt220 = -(0xff & aByteArray5886[class268.anInt3456]) + 255 << 24
									| class14.anInt220 & 0xffffff;
						}
					method703(0);
				}
						...
						for (int i_512_ = 0; (is_511_.length ^ 0xffffffff) < (i_512_ ^ 0xffffffff); i_512_++) {
							...
							if (aShortArray5861 == null || (aShortArray5861[i_513_] & i_360_ ^ 0xffffffff) != -1) {
								...
								if ((i_517_ ^ 0xffffffff) <= -1) {
									...
									i_517_ = 0;
								aShortArray5802[i_513_] = (short) Node_Sub16
										.method2590(Node_Sub16.method2590(i_516_ << 7, i_515_ << 10), i_517_);
							}
						}
				...
				if (bool_508_) {
					if (aClass268Array5856 != null)
						for (int i_518_ = 0; (anInt5811 ^ 0xffffffff) < (i_518_ ^ 0xffffffff); i_518_++) {
							...
							class14.anInt220 = ~0xffffff & class14.anInt220
									| Class85.anIntArray1158[aShortArray5802[class268.anInt3456] & 0xffff] & 0xffffff;
						}
					method703(0);
				}
			}
			...
			if (anIntArrayArray5892 != null)
				for (int i_523_ = 0; i_523_ < i_362_; i_523_++) {
					...
					if ((i_524_ ^ 0xffffffff) > (anIntArrayArray5892.length ^ 0xffffffff)) {
						...
						for (int element : is_525_) {
							Class14 class14 = aClass14Array5872[element];
	...
	@Override
	public final void ia(short s, short s_637_) {
		anInt5809++;
		...
		if (aClass268Array5856 != null)
			for (int i = 0; anInt5811 > i; i++) {
				Class268 class268 = aClass268Array5856[i];
				Class14 class14 = aClass14Array5872[i];
				class14.anInt220 = class14.anInt220 & ~0xffffff
						| Class85.anIntArray1158[aShortArray5802[class268.anInt3456] & 0xffff] & 0xffffff;
			}
		method703(0);
	}
	...
	public final void k(int i) {
		...
		for (int i_578_ = 0; anInt5885 > i_578_; i_578_++) {
			...
			aShortArray5794[i_578_] = (short) (aShortArray5794[i_578_] * i_575_
					+ -(i_574_ * aShortArray5889[i_578_]) >> 14);
	...
	public final void method611(Class336 class336, EntityNode_Sub5 entitynode_sub5, int i) {
		...
		if (anInt5885 != 0) {
			...
			float f = Class60.aFloat883 + Class331.aFloat4140 * anInt5903;
			float f_581_ = Class60.aFloat883 + anInt5821 * Class331.aFloat4140;
			float f_582_;
			float f_583_;
			if (!(f_581_ < f)) {
				f_582_ = f - anInt5797;
				f_583_ = anInt5797 + f_581_;
			} else {
				f_582_ = -anInt5797 + f_581_;
				f_583_ = f + anInt5797;
			}
			if (!(f_582_ >= anAbstractToolkit5916.aFloat6302) && !(anAbstractToolkit5916.anInt6364 >= f_583_)) {
				...
				float f_584_ = Class147.aFloat1824 + Class12.aFloat199 * anInt5903;
				float f_585_ = Class147.aFloat1824 + anInt5821 * Class12.aFloat199;
				float f_586_;
				float f_587_;
				if (f_584_ > f_585_) {
					f_587_ = anAbstractToolkit5916.anInt6289 * (f_585_ - anInt5797);
					f_586_ = (f_584_ + anInt5797) * anAbstractToolkit5916.anInt6289;
				} else {
					f_586_ = anAbstractToolkit5916.anInt6289 * (anInt5797 + f_585_);
					f_587_ = anAbstractToolkit5916.anInt6289 * (f_584_ - anInt5797);
				}
				if (!(f_587_ / f_583_ >= anAbstractToolkit5916.aFloat6317)
						&& !(anAbstractToolkit5916.aFloat6298 >= f_586_ / f_583_)) {
					...
					float f_588_ = Node_Sub38_Sub37.aFloat10464 + Node_Sub36_Sub4.aFloat10072 * anInt5903;
					float f_589_ = anInt5821 * Node_Sub36_Sub4.aFloat10072 + Node_Sub38_Sub37.aFloat10464;
					float f_590_;
					float f_591_;
					if (f_589_ < f_588_) {
						f_591_ = anAbstractToolkit5916.anInt6362 * (f_589_ - anInt5797);
						f_590_ = anAbstractToolkit5916.anInt6362 * (anInt5797 + f_588_);
					} else {
						f_590_ = anAbstractToolkit5916.anInt6362 * (f_589_ + anInt5797);
						f_591_ = anAbstractToolkit5916.anInt6362 * (f_588_ - anInt5797);
					}
					if (!(f_591_ / f_583_ >= anAbstractToolkit5916.aFloat6308)
							&& !(f_590_ / f_583_ <= anAbstractToolkit5916.aFloat6282)) {
						if (entitynode_sub5 != null || aClass268Array5856 != null) {
							...
							LoadingBar.aFloat2013 = class336_sub1_580_.aFloat8544 * class336_sub1.aFloat8531
						...
						if (entitynode_sub5 != null) {
							...
							int i_595_ = (int) (i_593_ * LoadingBar.aFloat2013 + Class147.aFloat1824
									+ anInt5903 * Class12.aFloat199 + Class37.aFloat558 * i_594_);
							int i_596_ = (int) (i_593_ * Node_Sub27.aFloat7310 + Node_Sub38_Sub37.aFloat10464
									+ Node_Sub36_Sub4.aFloat10072 * anInt5903 + Class51_Sub2.aFloat9074 * i_594_);
							int i_597_ = (int) (Class262_Sub14.aFloat7810 * i_594_
									+ (i_593_ * Node_Sub15_Sub7.aFloat9821 + Class60.aFloat883
											+ Class331.aFloat4140 * anInt5903));
							if ((anAbstractToolkit5916.anInt6364 ^ 0xffffffff) >= (i_597_ ^ 0xffffffff)) {
								entitynode_sub5.anInt5986 = i_596_ * anAbstractToolkit5916.anInt6362 / i_597_
										+ anAbstractToolkit5916.anInt6331;
								entitynode_sub5.anInt5985 = anAbstractToolkit5916.anInt6341
										- -(anAbstractToolkit5916.anInt6289 * i_595_ / i_597_);
							} else
								bool = true;
							int i_598_ = (int) (Class37.aFloat558 * i_594_ + (LoadingBar.aFloat2013 * i_593_
									+ Class147.aFloat1824 + Class12.aFloat199 * anInt5821));
							int i_599_ = (int) (anInt5821 * Node_Sub36_Sub4.aFloat10072
									+ (Node_Sub27.aFloat7310 * i_593_ + Node_Sub38_Sub37.aFloat10464)
									+ Class51_Sub2.aFloat9074 * i_594_);
							int i_600_ = (int) (Class331.aFloat4140 * anInt5821
									+ (Node_Sub15_Sub7.aFloat9821 * i_593_ + Class60.aFloat883)
									+ i_594_ * Class262_Sub14.aFloat7810);
							if ((anAbstractToolkit5916.anInt6364 ^ 0xffffffff) >= (i_600_ ^ 0xffffffff)) {
								entitynode_sub5.anInt5982 = anAbstractToolkit5916.anInt6341
										- -(i_598_ * anAbstractToolkit5916.anInt6289 / i_600_);
								entitynode_sub5.anInt5984 = i_599_ * anAbstractToolkit5916.anInt6362 / i_600_
										+ anAbstractToolkit5916.anInt6331;
							} else
								bool = true;
							if (bool)
								if ((i_597_ ^ 0xffffffff) <= (anAbstractToolkit5916.anInt6364 ^ 0xffffffff)
										|| (i_600_ ^ 0xffffffff) <= (anAbstractToolkit5916.anInt6364 ^ 0xffffffff)) {
									if (i_597_ >= anAbstractToolkit5916.anInt6364) {
										if ((anAbstractToolkit5916.anInt6364 ^ 0xffffffff) < (i_600_ ^ 0xffffffff)) {
											int i_601_ = (-anAbstractToolkit5916.anInt6364 + i_597_ << 16)
													/ (i_597_ - i_600_);
											int i_602_ = i_595_ + (i_601_ * (-i_598_ + i_595_) >> 16);
											int i_603_ = ((i_596_ + -i_599_) * i_601_ >> 16) + i_596_;
											entitynode_sub5.anInt5985 = anAbstractToolkit5916.anInt6341
													- -(i_602_ * anAbstractToolkit5916.anInt6289
															/ anAbstractToolkit5916.anInt6364);
											entitynode_sub5.anInt5986 = anAbstractToolkit5916.anInt6362 * i_603_
													/ anAbstractToolkit5916.anInt6364 + anAbstractToolkit5916.anInt6331;
										}
									} else {
										int i_604_ = (-anAbstractToolkit5916.anInt6364 + i_600_ << 16)
												/ (-i_597_ + i_600_);
										int i_605_ = i_598_ + ((-i_595_ + i_598_) * i_604_ >> 16);
										int i_606_ = (i_604_ * (i_599_ - i_596_) >> 16) + i_599_;
										entitynode_sub5.anInt5985 = i_605_ * anAbstractToolkit5916.anInt6289
												/ anAbstractToolkit5916.anInt6364 + anAbstractToolkit5916.anInt6341;
										entitynode_sub5.anInt5986 = anAbstractToolkit5916.anInt6331
												+ anAbstractToolkit5916.anInt6362 * i_606_
														/ anAbstractToolkit5916.anInt6364;
									}
								} else
									bool_592_ = false;
							if (bool_592_) {
								if (i_600_ >= i_597_)
									entitynode_sub5.anInt5983 = (anInt5797 + i_598_) * anAbstractToolkit5916.anInt6289
											/ i_600_ + (anAbstractToolkit5916.anInt6341 - entitynode_sub5.anInt5982);
								else
									entitynode_sub5.anInt5983 = anAbstractToolkit5916.anInt6341
											- -(anAbstractToolkit5916.anInt6289 * (anInt5797 + i_595_) / i_597_)
	...
	public final void method614(Class336 class336) {
		...
		if (aClass300Array5905 != null)
			for (int i = 0; (i ^ 0xffffffff) > (aClass300Array5905.length ^ 0xffffffff); i++) {
				...
				class300_200_.anInt3769 = (int) (class336_sub1.aFloat8550
						+ (class336_sub1.aFloat8529 * anIntArray5913[class300.anInt3764]
								+ (anIntArray5897[class300.anInt3764] * class336_sub1.aFloat8531
										+ class336_sub1.aFloat8530 * anIntArray5879[class300.anInt3764])));
				class300_200_.anInt3751 = (int) (class336_sub1.aFloat8521
						+ (class336_sub1.aFloat8535 * anIntArray5913[class300.anInt3764]
								+ (anIntArray5897[class300.anInt3764] * class336_sub1.aFloat8538
										+ class336_sub1.aFloat8544 * anIntArray5879[class300.anInt3764])));
				class300_200_.anInt3753 = (int) (anIntArray5879[class300.anInt3764] * class336_sub1.aFloat8547
						+ anIntArray5897[class300.anInt3764] * class336_sub1.aFloat8508
						+ anIntArray5913[class300.anInt3764] * class336_sub1.aFloat8556 + class336_sub1.aFloat8542);
				class300_200_.anInt3766 = (int) (anIntArray5913[class300.anInt3757] * class336_sub1.aFloat8529
						+ (anIntArray5879[class300.anInt3757] * class336_sub1.aFloat8530
								+ class336_sub1.aFloat8531 * anIntArray5897[class300.anInt3757])
						+ class336_sub1.aFloat8550);
				class300_200_.anInt3756 = (int) (class336_sub1.aFloat8535 * anIntArray5913[class300.anInt3757]
						+ (anIntArray5897[class300.anInt3757] * class336_sub1.aFloat8538
								+ class336_sub1.aFloat8544 * anIntArray5879[class300.anInt3757])
						+ class336_sub1.aFloat8521);
				class300_200_.anInt3758 = (int) (class336_sub1.aFloat8508 * anIntArray5897[class300.anInt3757]
						+ class336_sub1.aFloat8547 * anIntArray5879[class300.anInt3757]
						+ class336_sub1.aFloat8556 * anIntArray5913[class300.anInt3757] + class336_sub1.aFloat8542);
				class300_200_.anInt3761 = (int) (class336_sub1.aFloat8550
						+ (class336_sub1.aFloat8529 * anIntArray5913[class300.anInt3754]
								+ (anIntArray5879[class300.anInt3754] * class336_sub1.aFloat8530
										+ class336_sub1.aFloat8531 * anIntArray5897[class300.anInt3754])));
				class300_200_.anInt3752 = (int) (class336_sub1.aFloat8521
						+ (anIntArray5879[class300.anInt3754] * class336_sub1.aFloat8544
								+ class336_sub1.aFloat8538 * anIntArray5897[class300.anInt3754]
								+ anIntArray5913[class300.anInt3754] * class336_sub1.aFloat8535));
				class300_200_.anInt3771 = (int) (class336_sub1.aFloat8542
						+ (anIntArray5879[class300.anInt3754] * class336_sub1.aFloat8547
								+ class336_sub1.aFloat8508 * anIntArray5897[class300.anInt3754]
								+ anIntArray5913[class300.anInt3754] * class336_sub1.aFloat8556));
			}
		if (aClass218Array5817 != null)
			for (int i = 0; (i ^ 0xffffffff) > (aClass218Array5817.length ^ 0xffffffff); i++) {
				...
				class218_201_.anInt2559 = (int) (anIntArray5913[class218.anInt2554] * class336_sub1.aFloat8529
						+ (class336_sub1.aFloat8530 * anIntArray5879[class218.anInt2554]
								+ anIntArray5897[class218.anInt2554] * class336_sub1.aFloat8531)
						+ class336_sub1.aFloat8550);
				class218_201_.anInt2557 = (int) (anIntArray5913[class218.anInt2554] * class336_sub1.aFloat8535
						+ (class336_sub1.aFloat8538 * anIntArray5897[class218.anInt2554]
								+ class336_sub1.aFloat8544 * anIntArray5879[class218.anInt2554])
						+ class336_sub1.aFloat8521);
				class218_201_.anInt2556 = (int) (anIntArray5897[class218.anInt2554] * class336_sub1.aFloat8508
						+ anIntArray5879[class218.anInt2554] * class336_sub1.aFloat8547
						+ class336_sub1.aFloat8556 * anIntArray5913[class218.anInt2554] + class336_sub1.aFloat8542);
			}
	}
	...
	@Override
	public final void method619(DrawableModel drawablemodel, int i, int i_644_, int i_645_, boolean bool) {
		anInt5921++;
						...
						if (i_671_ >= i_666_ && i_667_ >= i_671_) {
							...
							if (i_672_ != -1)
								for (int i_676_ = 0; i_647_ > i_676_; i_676_++)
									if ((is[i_676_] ^ 0xffffffff) == (i_670_ ^ 0xffffffff) && is_649_[i_676_] == i_671_
											&& i_669_ == is_648_[i_676_]) {
										...
										if ((i_677_ ^ 0xffffffff) != 0) {
											if (ses_655_ == null) {
												aClass284_5867 = new NPCMasks();
												ses_655_ = aClass284_5867.aShortArray3595 = Class39
														.method413(aShortArray5889, (byte) -32);
												ses_652_ = aClass284_5867.aShortArray3592 = Class39
														.method413(aShortArray5898, (byte) -32);
												ses_654_ = aClass284_5867.aShortArray3593 = Class39
														.method413(aShortArray5794, (byte) -32);
												bs_653_ = aClass284_5867.aByteArray3598 = Class270_Sub1
														.method3299(aByteArray5834, 0);
											}
											if (ses_656_ == null) {
												NPCMasks class284 = standarddrawablemodel_646_.aClass284_5867 = new NPCMasks();
												ses_656_ = class284.aShortArray3595 = Class39.method413(ses,
														(byte) -32);
												ses_659_ = class284.aShortArray3592 = Class39.method413(ses_650_,
														(byte) -32);
												ses_658_ = class284.aShortArray3593 = Class39.method413(ses_651_,
														(byte) -32);
											...
											for (int i_681_ = i_673_; (i_681_ ^ 0xffffffff) > (i_674_
													^ 0xffffffff); i_681_++) {
	...
	@Override
	public final boolean method621(int i, int i_685_, Class336 class336, boolean bool, int i_686_, int i_687_) {
		anInt5827++;
		return method693(i_687_, class336, i_686_, i_685_, false, bool, i);
	}

	@Override
	public final void method622(Class336 class336, EntityNode_Sub5 entitynode_sub5, int i, int i_531_) {
		anInt5914++;
		if (anInt5885 != 0) {
			Class336_Sub1 class336_sub1 = anAbstractToolkit5916.aClass336_Sub1_6267;
			if (!aBoolean5891)
			...
			float f = Class331.aFloat4140 * anInt5903 + Class60.aFloat883;
			float f_533_ = Class60.aFloat883 + anInt5821 * Class331.aFloat4140;
			float f_534_;
			float f_535_;
			if (f_533_ < f) {
				f_535_ = -anInt5797 + f_533_;
				f_534_ = anInt5797 + f;
			} else {
				f_534_ = f_533_ + anInt5797;
				f_535_ = f - anInt5797;
			}
			if (!(anAbstractToolkit5916.aFloat6371 <= f_535_) && !(f_534_ <= anAbstractToolkit5916.anInt6364)) {
				...
				float f_536_ = Class12.aFloat199 * anInt5903 + Class147.aFloat1824;
				float f_537_ = Class147.aFloat1824 + anInt5821 * Class12.aFloat199;
				float f_538_;
				float f_539_;
				if (!(f_536_ > f_537_)) {
					f_538_ = (f_536_ - anInt5797) * anAbstractToolkit5916.anInt6289;
					f_539_ = anAbstractToolkit5916.anInt6289 * (f_537_ + anInt5797);
				} else {
					f_538_ = (-anInt5797 + f_537_) * anAbstractToolkit5916.anInt6289;
					f_539_ = anAbstractToolkit5916.anInt6289 * (anInt5797 + f_536_);
				}
				if (!(f_538_ / i >= anAbstractToolkit5916.aFloat6317)
						&& !(f_539_ / i <= anAbstractToolkit5916.aFloat6298)) {
					...
					float f_540_ = Node_Sub38_Sub37.aFloat10464 + anInt5903 * Node_Sub36_Sub4.aFloat10072;
					float f_541_ = anInt5821 * Node_Sub36_Sub4.aFloat10072 + Node_Sub38_Sub37.aFloat10464;
					float f_542_;
					float f_543_;
					if (f_540_ > f_541_) {
						f_543_ = (f_540_ + anInt5797) * anAbstractToolkit5916.anInt6362;
						f_542_ = anAbstractToolkit5916.anInt6362 * (-anInt5797 + f_541_);
					} else {
						f_542_ = anAbstractToolkit5916.anInt6362 * (-anInt5797 + f_540_);
						f_543_ = (f_541_ + anInt5797) * anAbstractToolkit5916.anInt6362;
					}
					if (!(anAbstractToolkit5916.aFloat6308 <= f_542_ / i)
							&& !(anAbstractToolkit5916.aFloat6282 >= f_543_ / i)) {
						if (entitynode_sub5 != null || aClass268Array5856 != null) {
							...
							LoadingBar.aFloat2013 = class336_sub1.aFloat8531 * class336_sub1_532_.aFloat8544
						...
						if (entitynode_sub5 != null) {
							...
							int i_546_ = (int) (i_545_ * Class37.aFloat558 + (i_544_ * LoadingBar.aFloat2013
									+ Class147.aFloat1824 + Class12.aFloat199 * anInt5903));
							int i_547_ = (int) (i_544_ * Node_Sub27.aFloat7310 + Node_Sub38_Sub37.aFloat10464
									+ anInt5903 * Node_Sub36_Sub4.aFloat10072 + Class51_Sub2.aFloat9074 * i_545_);
							int i_548_ = (int) (Class60.aFloat883 + Node_Sub15_Sub7.aFloat9821 * i_544_
									+ anInt5903 * Class331.aFloat4140 + Class262_Sub14.aFloat7810 * i_545_);
							int i_549_ = (int) (Class147.aFloat1824 + i_544_ * LoadingBar.aFloat2013
									+ anInt5821 * Class12.aFloat199 + Class37.aFloat558 * i_545_);
							int i_550_ = (int) (Class51_Sub2.aFloat9074 * i_545_ + (i_544_ * Node_Sub27.aFloat7310
									+ Node_Sub38_Sub37.aFloat10464 + Node_Sub36_Sub4.aFloat10072 * anInt5821));
							entitynode_sub5.anInt5982 = anAbstractToolkit5916.anInt6341
									+ anAbstractToolkit5916.anInt6289 * i_549_ / i;
							entitynode_sub5.anInt5984 = anAbstractToolkit5916.anInt6331
									- -(i_550_ * anAbstractToolkit5916.anInt6362 / i);
							entitynode_sub5.anInt5986 = anAbstractToolkit5916.anInt6331
									- -(anAbstractToolkit5916.anInt6362 * i_547_ / i);
							int i_551_ = (int) (anInt5821 * Class331.aFloat4140
									+ (Class60.aFloat883 + Node_Sub15_Sub7.aFloat9821 * i_544_)
									+ Class262_Sub14.aFloat7810 * i_545_);
							entitynode_sub5.anInt5985 = i_546_ * anAbstractToolkit5916.anInt6289 / i
									+ anAbstractToolkit5916.anInt6341;
							if ((i_548_ ^ 0xffffffff) <= (anAbstractToolkit5916.anInt6364 ^ 0xffffffff)
									|| anAbstractToolkit5916.anInt6364 <= i_551_) {
								entitynode_sub5.aBoolean5987 = true;
								entitynode_sub5.anInt5983 = -entitynode_sub5.anInt5985 + anAbstractToolkit5916.anInt6341
										+ (anInt5797 + i_546_) * anAbstractToolkit5916.anInt6289 / i;
							}
						}
						anAbstractToolkit5916.method1270((byte) -123, i);
	...
	@Override
	public final boolean method624(int i, int i_642_, Class336 class336, boolean bool, int i_643_) {
		anInt5793++;
		return method693(-1, class336, i_643_, i_642_, false, bool, i);
	}

	@Override
	public final void method626(int i, int i_706_, int i_707_, int i_708_) {
		anInt5836++;
		for (int i_709_ = 0; anInt5813 > i_709_; i_709_++) {
			...
			aShortArray5802[i_709_] = (short) Node_Sub16.method2590(Node_Sub16.method2590(i_712_ << 7, i_711_ << 10),
					i_713_);
		}
		if (aClass268Array5856 != null)
			for (int i_714_ = 0; i_714_ < anInt5811; i_714_++) {
				...
				class14.anInt220 = 0xffffff & Class85.anIntArray1158[0xffff & aShortArray5802[class268.anInt3456]]
						| ~0xffffff & class14.anInt220;
			}
		method703(0);
	}
	...
	public final DrawableModel method633(byte b, int i, boolean bool) {
		...
		if (b <= 0 || b > 7)
			standarddrawablemodel_720_ = standarddrawablemodel_721_ = new StandardDrawableModel(anAbstractToolkit5916,
					0, 0, true, false);
		else {
	...
	@Override
	public final void method637(int i, int[] is, int i_262_, int i_263_, int i_264_, int i_265_, boolean bool) {
		anInt5831++;
					...
					if ((0x1 & i_265_ ^ 0xffffffff) != -1)
						for (int i_281_ = 0; (is_280_.length ^ 0xffffffff) < (i_281_ ^ 0xffffffff); i_281_++) {
							...
							if (i_262_ != 0) {
								...
								int i_285_ = -(anIntArray5913[i_282_] * i_283_)
										+ (i_284_ * anIntArray5897[i_282_] - -16383) >> 14;
								anIntArray5913[i_282_] = 16383
										+ (anIntArray5913[i_282_] * i_284_ + anIntArray5897[i_282_] * i_283_) >> 14;
							...
							if ((i_264_ ^ 0xffffffff) != -1) {
								...
								int i_288_ = 16383 + i_286_ * anIntArray5897[i_282_]
										- -(anIntArray5879[i_282_] * i_287_) >> 14;
								anIntArray5897[i_282_] = -(i_286_ * anIntArray5879[i_282_])
										+ i_287_ * anIntArray5897[i_282_] - -16383 >> 14;
							...
							if ((i_263_ ^ 0xffffffff) != -1) {
								...
								int i_291_ = i_290_ * anIntArray5879[i_282_]
										+ (anIntArray5913[i_282_] * i_289_ - -16383) >> 14;
								anIntArray5913[i_282_] = -(anIntArray5879[i_282_] * i_289_)
										+ anIntArray5913[i_282_] * i_290_ + 16383 >> 14;
						...
						for (int element : is_280_) {
							...
							if ((i_264_ ^ 0xffffffff) != -1) {
								...
								int i_296_ = i_294_ * anIntArray5897[i_293_] - -(anIntArray5879[i_293_] * i_295_)
										+ 16383 >> 14;
								anIntArray5897[i_293_] = 16383 + i_295_ * anIntArray5897[i_293_]
										+ -(i_294_ * anIntArray5879[i_293_]) >> 14;
								anIntArray5879[i_293_] = i_296_;
							}
							if (i_262_ != 0) {
								int i_297_ = Class335.anIntArray4167[i_262_];
								int i_298_ = Class335.anIntArray4165[i_262_];
								int i_299_ = 16383 + i_298_ * anIntArray5897[i_293_]
										- anIntArray5913[i_293_] * i_297_ >> 14;
								anIntArray5913[i_293_] = 16383 + anIntArray5897[i_293_] * i_297_
										- -(anIntArray5913[i_293_] * i_298_) >> 14;
								anIntArray5897[i_293_] = i_299_;
							}
							if ((i_263_ ^ 0xffffffff) != -1) {
								int i_300_ = Class335.anIntArray4167[i_263_];
								int i_301_ = Class335.anIntArray4165[i_263_];
								int i_302_ = i_300_ * anIntArray5913[i_293_]
										+ (anIntArray5879[i_293_] * i_301_ - -16383) >> 14;
								anIntArray5913[i_293_] = i_301_ * anIntArray5913[i_293_]
										- i_300_ * anIntArray5879[i_293_] + 16383 >> 14;
						...
						for (int i_307_ : is_305_) {
							...
							for (int i_310_ = i_308_; (i_310_ ^ 0xffffffff) > (i_309_ ^ 0xffffffff); i_310_++) {
								...
								if ((i_264_ ^ 0xffffffff) != -1) {
									...
									int i_314_ = 16383 + aShortArray5898[i_311_] * i_312_
											- -(aShortArray5889[i_311_] * i_313_) >> 14;
									aShortArray5898[i_311_] = (short) (16383 + (-(aShortArray5889[i_311_] * i_312_)
											+ aShortArray5898[i_311_] * i_313_) >> 14);
								...
								if ((i_262_ ^ 0xffffffff) != -1) {
									...
									int i_317_ = 16383 + -(aShortArray5794[i_311_] * i_315_)
											+ aShortArray5898[i_311_] * i_316_ >> 14;
									aShortArray5794[i_311_] = (short) (i_315_ * aShortArray5898[i_311_]
											+ (i_316_ * aShortArray5794[i_311_] + 16383) >> 14);
									aShortArray5898[i_311_] = (short) i_317_;
								}
								if ((i_263_ ^ 0xffffffff) != -1) {
									int i_318_ = Class335.anIntArray4167[i_263_];
									int i_319_ = Class335.anIntArray4165[i_263_];
									int i_320_ = i_319_ * aShortArray5889[i_311_]
											+ (aShortArray5794[i_311_] * i_318_ - -16383) >> 14;
									aShortArray5794[i_311_] = (short) (-(i_318_ * aShortArray5889[i_311_])
											+ i_319_ * aShortArray5794[i_311_] - -16383 >> 14);
				...
				if (bool_326_) {
					if (aClass268Array5856 != null)
						for (int i_333_ = 0; (anInt5811 ^ 0xffffffff) < (i_333_ ^ 0xffffffff); i_333_++) {
							...
							class14.anInt220 = class14.anInt220 & 0xffffff
									| -(0xff & aByteArray5886[class268.anInt3456]) + 255 << 24;
						}
					method703(0);
				}
			}
					...
					if ((i_336_ ^ 0xffffffff) > (anIntArrayArray5900.length ^ 0xffffffff)) {
						...
						for (int i_338_ = 0; (is_337_.length ^ 0xffffffff) < (i_338_ ^ 0xffffffff); i_338_++) {
							...
							if (i_343_ >= 0) {
								...
								i_343_ = 0;
							aShortArray5802[i_339_] = (short) Node_Sub16
									.method2590(Node_Sub16.method2590(i_342_ << 7, i_341_ << 10), i_343_);
						}
				...
				if (bool_334_) {
					if (aClass268Array5856 != null)
						for (int i_344_ = 0; (i_344_ ^ 0xffffffff) > (anInt5811 ^ 0xffffffff); i_344_++) {
							...
							class14.anInt220 = Class85.anIntArray1158[aShortArray5802[class268.anInt3456] & 0xffff]
									& 0xffffff | ~0xffffff & class14.anInt220;
						}
					method703(0);
				}
			}
	...
	private final boolean method688(byte b) {
		...
		if (bool_1_) {
			...
			Buffer buffer = interface15_impl2.method40(8, true);
			if (buffer == null)
				bool_3_ = false;
			else {
				anAbstractToolkit5916.aNativeInterface6193.copyPositions(anIntArray5879, anIntArray5897, anIntArray5913,
						aShortArray5890, 0, 12, anInt5885, buffer.getAddress());
		...
		if (bool) {
			...
			Buffer buffer = interface15_impl2.method40(-91, true);
			if (buffer != null) {
				if ((0x37 & anInt5896 ^ 0xffffffff) != -1)
					anAbstractToolkit5916.aNativeInterface6193.copyColours(aShortArray5802, aByteArray5886,
							aShortArray5862, aShort5868, aShortArray5832, 0, 4, anInt5885, buffer.getAddress());
				else {
					byte[] bs;
					short[] ses;
					short[] ses_4_;
					...
					anAbstractToolkit5916.aNativeInterface6193.copyLighting(aShortArray5802, aByteArray5886,
							aShortArray5862, ses_5_, ses_4_, ses, bs, aShort5868, aShort5843, aShortArray5832, 0, 4,
							anInt5885, buffer.getAddress());
				}
		...
		if (bool_0_) {
			...
			Buffer buffer = interface15_impl2.method40(118, true);
			if (buffer == null)
				bool_3_ = false;
			else {
				short[] ses;
				...
				anAbstractToolkit5916.aNativeInterface6193.copyNormals(ses_6_, ses_7_, ses, bs, 3.0F / aShort5843,
						3.0F / (aShort5843 + aShort5843 / 2), 0, 12, anInt5885, buffer.getAddress());
		...
		if (bool_2_) {
			...
			Buffer buffer = interface15_impl2.method40(-106, true);
			if (buffer != null) {
				anAbstractToolkit5916.aNativeInterface6193.copyTexCoords(aFloatArray5875, aFloatArray5860, 0, 8,
						anInt5885, buffer.getAddress());
				if (!interface15_impl2.method39(119))
					bool_3_ = false;
				else {
	...
	public final void method690(int i) {
		anInt5796++;
		if (aClass347_5828 != null)
	...
	private final boolean method691(int i) {
		...
		Buffer buffer = interface15_impl1.method54(true, (byte) 119);
		if (i != 0)
			...
			if (aClass268Array5856 != null) {
				...
				for (int i_163_ = 0; i_163_ < anInt5811; i_163_++) {
					...
					if (!class268.aBoolean3451 || !anAbstractToolkit5916.w()) {
						float f = (anIntArray5879[class268.anInt3453] - -anIntArray5879[class268.anInt3454]
								- -anIntArray5879[class268.anInt3461]) * 0.3333333F;
						float f_164_ = (anIntArray5897[class268.anInt3461] + anIntArray5897[class268.anInt3453]
								- -anIntArray5897[class268.anInt3454]) * 0.3333333F;
						float f_165_ = 0.3333333F * (anIntArray5913[class268.anInt3453]
								+ anIntArray5913[class268.anInt3454] + anIntArray5913[class268.anInt3461]);
						float f_166_ = f_165_ * Class37.aFloat558
								+ (f_164_ * Class12.aFloat199 + f * LoadingBar.aFloat2013) + Class147.aFloat1824;
						float f_167_ = Node_Sub38_Sub37.aFloat10464 + (Class51_Sub2.aFloat9074 * f_165_
								+ (Node_Sub27.aFloat7310 * f + f_164_ * Node_Sub36_Sub4.aFloat10072));
						float f_168_ = f_165_ * Class262_Sub14.aFloat7810
								+ (Class331.aFloat4140 * f_164_ + f * Node_Sub15_Sub7.aFloat9821) + Class60.aFloat883;
						float f_169_ = (float) (1.0 / Math.sqrt(f_168_ * f_168_ + (f_167_ * f_167_ + f_166_ * f_166_)))
								* class268.anInt3459;
						Class336_Sub1 class336_sub1 = anAbstractToolkit5916.method1264(false);
						class336_sub1.method3886(f_168_ - f_168_ * f_169_, class14.anInt216 * class268.aShort3457 >> 7,
								class14.anInt218 * class268.aShort3458 >> 7, 16383,
								class14.anInt213 + f_167_ - f_167_ * f_169_,
								class14.anInt212 + f_166_ - f_166_ * f_169_, class14.anInt217);
	...
	private final boolean method693(int i, Class336 class336, int i_202_, int i_203_, boolean bool, boolean bool_204_,
			int i_205_) {
		anInt5893++;
		Class336_Sub1 class336_sub1 = (Class336_Sub1) class336;
		Class336_Sub1 class336_sub1_206_ = anAbstractToolkit5916.aClass336_Sub1_6267;
		float f = class336_sub1_206_.aFloat8550 + (class336_sub1_206_.aFloat8529 * class336_sub1.aFloat8542
				+ (class336_sub1.aFloat8550 * class336_sub1_206_.aFloat8530
						+ class336_sub1_206_.aFloat8531 * class336_sub1.aFloat8521));
		float f_207_ = class336_sub1_206_.aFloat8521 + (class336_sub1_206_.aFloat8535 * class336_sub1.aFloat8542
		...
		LoadingBar.aFloat2013 = class336_sub1_206_.aFloat8531 * class336_sub1.aFloat8544
				+ class336_sub1.aFloat8530 * class336_sub1_206_.aFloat8530
				+ class336_sub1_206_.aFloat8529 * class336_sub1.aFloat8547;
		float f_208_ = class336_sub1_206_.aFloat8542 + (class336_sub1.aFloat8542 * class336_sub1_206_.aFloat8556
		...
		RSCanvas.anIntArray70[0] = i_224_;
		GLPlane.anIntArray7918[1] = i_225_;
		Class99.anIntArray1292[1] = i_223_;
		RSCanvas.anIntArray70[1] = i_224_;
		GLPlane.anIntArray7918[2] = i_222_;
		Class99.anIntArray1292[2] = i_226_;
		RSCanvas.anIntArray70[2] = i_224_;
		GLPlane.anIntArray7918[3] = i_225_;
		Class99.anIntArray1292[3] = i_226_;
		GLPlane.anIntArray7918[4] = i_222_;
		RSCanvas.anIntArray70[3] = i_224_;
		Class99.anIntArray1292[4] = i_223_;
		RSCanvas.anIntArray70[4] = i_227_;
		GLPlane.anIntArray7918[5] = i_225_;
		Class99.anIntArray1292[5] = i_223_;
		GLPlane.anIntArray7918[6] = i_222_;
		RSCanvas.anIntArray70[5] = i_227_;
		Class99.anIntArray1292[6] = i_226_;
		RSCanvas.anIntArray70[6] = i_227_;
		GLPlane.anIntArray7918[7] = i_225_;
		Class99.anIntArray1292[7] = i_226_;
		RSCanvas.anIntArray70[7] = i_227_;
		for (int i_228_ = 0; (i_228_ ^ 0xffffffff) > -9; i_228_++) {
			float f_229_ = GLPlane.anIntArray7918[i_228_];
			float f_230_ = RSCanvas.anIntArray70[i_228_];
			float f_231_ = Class99.anIntArray1292[i_228_];
			float f_232_ = f_230_ * Class37.aFloat558 + (f_229_ * LoadingBar.aFloat2013 + Class12.aFloat199 * f_231_) + f;
			float f_233_ = Node_Sub15_Sub7.aFloat9821 * f_229_ + Class331.aFloat4140 * f_231_
					+ f_230_ * Class262_Sub14.aFloat7810 + f_208_;
			float f_234_ = Class51_Sub2.aFloat9074 * f_230_
					+ (f_229_ * Node_Sub27.aFloat7310 + f_231_ * Node_Sub36_Sub4.aFloat10072) + f_207_;
			if (f_233_ >= anAbstractToolkit5916.anInt6364) {
				if ((i ^ 0xffffffff) < -1)
					f_233_ = i;
				float f_235_ = anAbstractToolkit5916.anInt6341 + f_232_ * i_214_ / f_233_;
				if (f_211_ < f_235_)
					f_211_ = f_235_;
				float f_236_ = i_215_ * f_234_ / f_233_ + anAbstractToolkit5916.anInt6331;
				if (f_235_ < f_210_)
					f_210_ = f_235_;
				if (f_212_ > f_236_)
					f_212_ = f_236_;
		...
		if (bool_209_ && f_210_ < i_205_ && i_205_ < f_211_ && f_212_ < i_203_ && f_213_ > i_203_) {
			if (bool_204_)
				return true;
			...
			for (int i_237_ = 0; i_237_ < anInt5912; i_237_++) {
				float f_238_ = anIntArray5913[i_237_];
				float f_239_ = anIntArray5879[i_237_];
				float f_240_ = anIntArray5897[i_237_];
				float f_241_ = f_207_ + (Node_Sub27.aFloat7310 * f_239_ + Node_Sub36_Sub4.aFloat10072 * f_240_
						+ f_238_ * Class51_Sub2.aFloat9074);
				float f_242_ = f_239_ * LoadingBar.aFloat2013 + Class12.aFloat199 * f_240_ + Class37.aFloat558 * f_238_
						+ f;
				float f_243_ = f_208_ + (f_240_ * Class331.aFloat4140 + Node_Sub15_Sub7.aFloat9821 * f_239_
						+ Class262_Sub14.aFloat7810 * f_238_);
				if (!(anAbstractToolkit5916.anInt6364 <= f_243_)) {
					...
					if (i > 0)
						f_243_ = i;
					int i_248_ = (int) (anAbstractToolkit5916.anInt6341 + f_242_ * i_214_ / f_243_);
					int i_249_ = (int) (anAbstractToolkit5916.anInt6331 + f_241_ * i_215_ / f_243_);
			...
			for (int i_254_ = 0; (anInt5813 ^ 0xffffffff) < (i_254_ ^ 0xffffffff); i_254_++)
				if ((Class107.anIntArray1363[aShortArray5841[i_254_]] ^ 0xffffffff) != 999998
						&& Class107.anIntArray1363[aShortArray5846[i_254_]] != -999999
						&& (Class107.anIntArray1363[aShortArray5906[i_254_]] ^ 0xffffffff) != 999998
						&& method696(Class365.anIntArray4525[aShortArray5846[i_254_]], i_205_,
								Class365.anIntArray4525[aShortArray5841[i_254_]], (byte) 37,
								Class107.anIntArray1363[aShortArray5906[i_254_]], i_203_,
								Class107.anIntArray1363[aShortArray5846[i_254_]],
								Class107.anIntArray1363[aShortArray5841[i_254_]],
								Class365.anIntArray4525[aShortArray5906[i_254_]]))
					return true;
		}
		return false;
	}
	...
	private final short method695(int i, int i_552_, float f, int i_553_, int i_554_, int i_555_, int i_556_,
			float f_557_, long l, int i_558_, Model model) {
		anInt5801++;
	...
	private final boolean method696(int i, int i_563_, int i_564_, byte b, int i_565_, int i_566_, int i_567_,
			int i_568_, int i_569_) {
		anInt5904++;
		...
		if (b != 37)
			return false;
		if (i_568_ < i_563_ && (i_567_ ^ 0xffffffff) > (i_563_ ^ 0xffffffff)
				&& (i_565_ ^ 0xffffffff) > (i_563_ ^ 0xffffffff))
			return false;
		return true;
	}

	private final DrawableModel method697(int i, StandardDrawableModel standarddrawablemodel_607_, boolean bool,
			boolean bool_608_, StandardDrawableModel standarddrawablemodel_609_, int i_610_) {
		...
		if (bool_614_) {
			if (bool_611_) {
				if (standarddrawablemodel_607_.anIntArray5879 == null
						|| (standarddrawablemodel_607_.anIntArray5879.length ^ 0xffffffff) > (anInt5902 ^ 0xffffffff))
			...
			if (bool_612_) {
				if (standarddrawablemodel_607_.anIntArray5897 == null
						|| anInt5902 > standarddrawablemodel_607_.anIntArray5897.length)
			...
			if (bool_613_) {
				if (standarddrawablemodel_607_.anIntArray5913 != null
						&& (standarddrawablemodel_607_.anIntArray5913.length ^ 0xffffffff) <= (anInt5902 ^ 0xffffffff))
		...
		if (!Class46.method470(anInt5896, -10, i))
			...
			if (standarddrawablemodel_607_.aShortArray5802 != null
					&& anInt5813 <= standarddrawablemodel_607_.aShortArray5802.length)
		...
		if (Class234.method2150(anInt5896, i_610_ ^ ~0x100, i)) {
			if (standarddrawablemodel_607_.aByteArray5886 == null
					|| (anInt5813 ^ 0xffffffff) < (standarddrawablemodel_607_.aByteArray5886.length ^ 0xffffffff))
		...
		if (!Class278.method3367(anInt5896, i, (byte) -105)) {
			...
			if (standarddrawablemodel_607_.aShortArray5889 != null
					&& anInt5885 <= standarddrawablemodel_607_.aShortArray5889.length) {
			...
			if (aClass284_5867 == null) {
				...
				if (standarddrawablemodel_607_.aClass284_5867 == null)
					standarddrawablemodel_607_.aClass284_5867 = new NPCMasks();
				NPCMasks class284 = standarddrawablemodel_609_.aClass284_5867 = standarddrawablemodel_607_.aClass284_5867;
				if (class284.aShortArray3595 == null
						|| (anInt5885 ^ 0xffffffff) < (class284.aShortArray3595.length ^ 0xffffffff)) {
		...
		if (Class219.method2094(i, anInt5896, i_610_ + -97)) {
			if (standarddrawablemodel_607_.aFloatArray5875 == null
					|| (standarddrawablemodel_607_.aFloatArray5875.length ^ 0xffffffff) > (anInt5813 ^ 0xffffffff)) {
		...
		if (Class144_Sub2.method1634(anInt5896, i, false)) {
			if (standarddrawablemodel_607_.aShortArray5841 != null
					&& (anInt5813 ^ 0xffffffff) >= (standarddrawablemodel_607_.aShortArray5841.length ^ 0xffffffff)) {
		...
		if (!Class294.method3466(i, i_610_, anInt5896))
			...
			if (standarddrawablemodel_607_.aShortArray5862 != null
					&& standarddrawablemodel_607_.aShortArray5862.length >= anInt5813)
		...
		if (Class320_Sub10.method3720(50560, i, anInt5896)) {
			if (standarddrawablemodel_607_.aClass14Array5872 == null
					|| anInt5811 > standarddrawablemodel_607_.aClass14Array5872.length) {
				...
				for (int i_629_ = 0; anInt5811 > i_629_; i_629_++)
					standarddrawablemodel_609_.aClass14Array5872[i_629_] = aClass14Array5872[i_629_]
							.method214((byte) -116);
			} else {
	...
	private final void method698(int i) {
		...
		if (aBoolean5826) {
			aBoolean5826 = false;
			if (aClass300Array5905 == null && aClass218Array5817 == null && aClass268Array5856 == null
					&& !Node_Sub38_Sub1.method2792(anInt5896, anInt5881, i ^ ~0x40000)) {
				boolean bool = false;
			...
			if (aByteArray5834 != null && !Node_Sub38_Sub8.method2812(anInt5881, false, anInt5896))
				if (!((0x37 & anInt5896 ^ 0xffffffff) == -1
						? aClass347_5852 == null || aClass347_5852.method3979((byte) -94)
						: aClass347_5908 == null || aClass347_5908.method3979((byte) -52)))
					aBoolean5826 = true;
				else {
					aByteArray5834 = null;
			...
			if (aByteArray5886 != null && !za_Sub2.method2994(anInt5881, (byte) 123, anInt5896))
				if (aClass347_5852 == null || aClass347_5852.method3979((byte) -87))
					...
					aBoolean5826 = true;
			if (aFloatArray5875 != null && !RSCanvas.method126(127, anInt5881, anInt5896))
			...
			if (aShortArray5841 != null && !CacheNode_Sub14_Sub2.method2352(i + -262144, anInt5881, anInt5896))
				if (aClass333_5808 != null && !aClass333_5808.method3847(i + -254147)
						|| aClass347_5852 != null && !aClass347_5852.method3979((byte) -101))
					aBoolean5826 = true;
				else
	...
	private final void method701(byte b) {
		...
		anInt5909 = i_692_;
		anInt5883 = i_689_;
		anInt5797 = (int) (Math.sqrt(i_693_) + 0.99);
		anInt5805 = (int) (0.99 + Math.sqrt(i_694_));
		aBoolean5891 = true;
	}
	...
	private final void method705(int i, r_Sub1 var_r_Sub1) {
		...
		for (int i_722_ = 0; i_722_ < anInt5912; i_722_++) {
			int i_723_ = -var_r_Sub1.anInt11050 + (anIntArray5879[i_722_] - (anIntArray5897[i_722_]
					* anAbstractToolkit5916.anInt6337 >> 8) >> anAbstractToolkit5916.anInt6350);
			int i_724_ = (anIntArray5913[i_722_] + -(anIntArray5897[i_722_]
					* anAbstractToolkit5916.anInt6286 >> 8) >> anAbstractToolkit5916.anInt6350) - var_r_Sub1.anInt11052;
		...
		for (int i_729_ = 0; anInt5859 > i_729_; i_729_++)
			if (aByteArray5886 == null || aByteArray5886[i_729_] <= 128) {
				...
				if ((-((-i_735_ + i_736_) * (-i_733_ + i_734_)) + (i_732_ - i_733_) * (-i_737_ + i_736_)
						^ 0xffffffff) < -1)
		...
		if (anInt5859 != 0) {
			...
			if (method688((byte) 60) && method691(0)) {
				...
				for (int i_744_ = 0; anIntArray5884.length > i_744_; i_744_++) {
					...
					anAbstractToolkit5916.method1276(anIntArray5884[i_744_], (byte) -114, i_745_ * 3,
							aClass333_5808.anInterface15_Impl1_4151, anIntArray5838[i_744_], Class55.aClass104_833,
							i_746_ + -i_745_);
				}
			}
			method698(262144);
	...
	@Override
	public final void O(int i, int i_259_, int i_260_) {
		anInt5848++;
	...
	@Override
	public final void p(int i, int i_134_, Plane plane, Plane plane_135_, int i_136_, int i_137_, int i_138_) {
		if (!aBoolean5891)
			method701((byte) 91);
		anInt5882++;
		...
		if (i != 1 && i != 2 && i != 3 && (i ^ 0xffffffff) != -6 || (i_139_ ^ 0xffffffff) <= -1
				&& (plane.anInt3408 ^ 0xffffffff) < (plane.anInt3398 + i_140_ >> plane.anInt3410 ^ 0xffffffff)
				&& (i_141_ ^ 0xffffffff) <= -1 && i_142_ + plane.anInt3398 >> plane.anInt3410 < plane.anInt3404) {
			if (i != 4 && i != 5) {
				...
				if (plane.method3251(i_141_, i_139_, (byte) -118) == i_137_
						&& plane.method3251(i_141_, i_140_, (byte) -118) == i_137_
						&& (i_137_ ^ 0xffffffff) == (plane.method3251(i_142_, i_139_, (byte) -118) ^ 0xffffffff)
						&& plane.method3251(i_142_, i_140_, (byte) -118) == i_137_)
					return;
			} else if (plane_135_ == null || ((i_139_ ^ 0xffffffff) > -1
					|| (plane_135_.anInt3408 ^ 0xffffffff) >= (plane_135_.anInt3398 + i_140_ >> plane_135_.anInt3410
							^ 0xffffffff)
					|| i_141_ < 0 || (plane_135_.anInt3398 + i_142_ >> plane_135_.anInt3410
							^ 0xffffffff) <= (plane_135_.anInt3404 ^ 0xffffffff)))
				return;
			if (i == 1)
				for (int i_143_ = 0; anInt5912 > i_143_; i_143_++)
					anIntArray5897[i_143_] = -i_137_ + (anIntArray5897[i_143_]
							+ plane.method3260(i_138_ + anIntArray5913[i_143_], -117, anIntArray5879[i_143_] + i_136_));
			else if (i != 2) {
				if ((i ^ 0xffffffff) != -4) {
					if (i != 4) {
						if (i == 5) {
							...
							for (int i_145_ = 0; i_145_ < anInt5912; i_145_++) {
								...
								anIntArray5897[i_145_] = (i_150_ * ((anIntArray5897[i_145_] << 8) / i_144_) >> 8)
										+ i_148_ + -i_137_;
							}
						}
					} else {
						...
						for (int i_152_ = 0; (anInt5912 ^ 0xffffffff) < (i_152_ ^ 0xffffffff); i_152_++)
							anIntArray5897[i_152_] = i_151_ + anIntArray5897[i_152_]
									+ (plane_135_.method3260(i_138_ + anIntArray5913[i_152_], -110,
											anIntArray5879[i_152_] + i_136_) - i_137_);
					}
				} else {
					...
					if ((-(i_153_ >> 1) + i_136_ ^ 0xffffffff) > -1
							|| (plane.anInt3408 << plane.anInt3410
									^ 0xffffffff) >= ((i_153_ >> 1) + (i_136_ + plane.anInt3398) ^ 0xffffffff)
							|| -(i_154_ >> 1) + i_138_ < 0
				...
				for (int i_158_ = 0; i_158_ < anInt5912; i_158_++) {
					...
					if (i_159_ < i_134_)
						anIntArray5897[i_158_] = anIntArray5897[i_158_]
								- -((-i_159_ + i_134_) * (plane.method3260(anIntArray5913[i_158_] - -i_138_, -120,
										anIntArray5879[i_158_] - -i_136_) + -i_137_) / i_134_);
				}
			}
			method689(4259);
			aBoolean5891 = false;
	...
	@Override
	public final void P(int i, int i_171_, int i_172_, int i_173_) {
		anInt5829++;
		if ((i ^ 0xffffffff) == -1) {
			Class270_Sub2_Sub2.anInt10557 = 0;
			Class146.anInt1817 = 0;
			...
			for (int i_177_ = 0; anInt5912 > i_177_; i_177_++) {
				...
				if ((i_173_ ^ 0xffffffff) != -1) {
					...
					anIntArray5897[i_177_] = 16383 + i_179_ * anIntArray5897[i_177_]
							- anIntArray5879[i_177_] * i_178_ >> 14;
				...
				if ((i_171_ ^ 0xffffffff) != -1) {
					...
					anIntArray5913[i_177_] = 16383
							+ (i_182_ * anIntArray5913[i_177_] + i_181_ * anIntArray5897[i_177_]) >> 14;
				...
				if ((i_172_ ^ 0xffffffff) != -1) {
					...
					anIntArray5913[i_177_] = i_185_ * anIntArray5913[i_177_] + -(i_184_ * anIntArray5879[i_177_])
							+ 16383 >> 14;
			...
			for (int i_191_ = 0; i_191_ < anInt5813; i_191_++) {
				...
				if (i_195_ >= 0) {
					...
					i_195_ = 0;
				aShortArray5802[i_191_] = (short) Node_Sub16
						.method2590(Node_Sub16.method2590(i_194_ << 7, i_193_ << 10), i_195_);
			}
			if (aClass268Array5856 != null)
				for (int i_196_ = 0; i_196_ < anInt5811; i_196_++) {
					...
					class14.anInt220 = 0xffffff & Class85.anIntArray1158[aShortArray5802[class268.anInt3456] & 0xffff]
							| ~0xffffff & class14.anInt220;
				}
			method703(0);
