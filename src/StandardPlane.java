...
public class StandardPlane extends Plane {
	...
	public static int anInt8012;
	public static int anInt8014;
	public static int anInt8015;
	public static int[] anIntArray7980;
	public static short aShort7990;
	...
	StandardPlane(AbstractToolkit abstracttoolkit, int i, int i_123_, int i_124_, int i_125_, int[][] is,
			int[][] is_126_, int i_127_) {
		...
		for (int i_128_ = 0; i_128_ <= anInt3404; i_128_++)
			for (int i_129_ = 0; (i_129_ ^ 0xffffffff) >= (anInt3408 ^ 0xffffffff); i_129_++) {
				...
				if (aFloat7988 > i_130_)
					aFloat7988 = i_130_;
				if (i_130_ > aFloat7987)
					aFloat7987 = i_130_;
				if (i_129_ > 0 && (i_128_ ^ 0xffffffff) < -1 && i_129_ < anInt3408
						&& (i_128_ ^ 0xffffffff) > (anInt3404 ^ 0xffffffff)) {
					...
					aFloatArrayArray8019[i_129_][i_128_] = f * i_131_;
					aFloatArrayArray8021[i_129_][i_128_] = f * (2 * -i_127_);
					aFloatArrayArray8025[i_129_][i_128_] = f * i_132_;
				}
			}
		aFloat7988--;
		aFloat7987++;
	...
	@Override
	public final void CA(r var_r, int i, int i_203_, int i_204_, int i_205_, boolean bool) {
		anInt7999++;
	...
	@Override
	public final r fa(int i, int i_208_, r var_r) {
		anInt7998++;
	...
	@Override
	public final void ka(int i, int i_21_, int i_22_) {
		anInt7994++;
	...
	@Override
	public final void method3253(int i, int i_163_, int[] is, int[] is_164_, int[] is_165_, int[] is_166_, int[] is_167_,
			int[] is_168_, int[] is_169_, int[] is_170_, int[] is_171_, int[] is_172_, int[] is_173_, int i_174_,
		...
		U(i, i_163_, is_178_, is_184_, is_179_, is_185_, is_180_, is_181_, is_182_, is_183_, i_174_, i_175_, i_176_,
				bool);
	}

	@Override
	public final void method3255(int i, int i_138_, int i_139_, int i_140_, int i_141_, int i_142_, int i_143_,
			boolean[][] bools) {
		anInt8001++;
		if ((anInt8023 ^ 0xffffffff) < -1) {
			...
			for (int i_147_ = 0; i_147_ < 4; i_147_++) {
				i_144_ = 0;
				Buffer buffer = interface15_impl1.method54(true, (byte) 82);
				if (buffer != null) {
						...
						for (int i_148_ = i_141_; i_143_ > i_148_; i_148_++) {
							...
							for (int i_150_ = i_140_; (i_142_ ^ 0xffffffff) < (i_150_ ^ 0xffffffff); i_150_++) {
								if (bools[-i_140_ + i_150_][-i_141_ + i_148_]) {
									...
									if (ses != null)
										for (int i_151_ = 0; (i_151_ ^ 0xffffffff) > (ses.length
												^ 0xffffffff); i_151_++) {
						...
						for (int i_153_ = i_141_; i_153_ < i_143_; i_153_++) {
							...
							for (int i_155_ = i_140_; i_155_ < i_142_; i_155_++) {
								if (bools[i_155_ + -i_140_][-i_141_ + i_153_]) {
									...
									if (ses != null)
										for (int i_156_ = 0; (ses.length ^ 0xffffffff) < (i_156_
												^ 0xffffffff); i_156_++) {
			...
			if ((i_144_ ^ 0xffffffff) < -1) {
				...
				fs[13] = 1.0F - (i_138_ * 2 + i_139_ * i_143_ / 128.0F) / anAbstractToolkit8004.anInt6124;
				fs[2] = 0.0F;
				fs[4] = 0.0F;
				fs[9] = 0.0F;
				fs[8] = 0.0F;
				fs[7] = 0.0F;
				fs[11] = 0.0F;
				fs[5] = i_139_ / (128.0F * anInt3398 * anAbstractToolkit8004.anInt6124);
				fs[0] = i_139_ / (anInt3398 * 128.0F * anAbstractToolkit8004.anInt6239);
				fs[12] = -1.0F - (i_140_ * i_139_ / 128.0F - i * 2) / anAbstractToolkit8004.anInt6239;
				fs[1] = 0.0F;
				...
				anAbstractToolkit8004.method1276(i_145_, (byte) -68, 0, interface15_impl1, 1 + (-i_145_ + i_146_),
						Class55.aClass104_833, i_144_ / 3);
	...
	@Override
	public final boolean method3256(r var_r, int i, int i_158_, int i_159_, int i_160_, boolean bool) {
		anInt8014++;
		if (aClass263_8008 == null || var_r == null)
			return false;
	...
	@Override
	public final void method3257(int i, int i_122_) {
		anInt7992++;
	}

	@Override
	public final void method3259(int i, int i_17_, int i_18_, boolean[][] bools, boolean bool, int i_19_, int i_20_) {
		method3273(bools, bool, i_17_, i_19_, 1, i_18_, i_20_, i);
		anInt7983++;
	}

	private final void method3273(boolean[][] bools, boolean bool, int i, int i_23_, int i_24_, int i_25_, int i_26_,
			int i_27_) {
		anInt8012++;
		if (i_24_ != 1)
		...
		if (aNode_Sub54Array8024 != null) {
			...
			if (i_23_ != -1) {
				anAbstractToolkit8004.method1270((byte) -126, i_23_);
			...
			if (!aClass312_7989.method3616(i_24_ ^ 0x1)) {
				...
				for (Node node = aClass312_7989.method3613(i_24_ + 65279); node != null; node = aClass312_7989
						.method3620(16776960)) {
	...
	private final void method3275(int i, int i_191_, r_Sub1 var_r_Sub1, int i_192_) {
		...
		while (i_194_ > i_196_) {
			...
			if ((-((-i_199_ + i_201_) * (-i_198_ + i_200_)) + (-i_199_ + i_197_) * (i_200_ + -i_202_)
					^ 0xffffffff) < -1)
	...
	@Override
	public final void U(int i, int i_3_, int[] is, int[] is_4_, int[] is_5_, int[] is_6_, int[] is_7_, int[] is_8_,
			int[] is_9_, int[] is_10_, int i_11_, int i_12_, int i_13_, boolean bool) {
		anInt8003++;
		...
		for (int i_14_ = 0; (i_14_ ^ 0xffffffff) > (is_7_.length ^ 0xffffffff); i_14_++) {
			...
			if ((0x20 & anInt7981 ^ 0xffffffff) != -1 && (i_15_ ^ 0xffffffff) != 0
					&& var_d.method10(i_15_, -8217).aBoolean1223) {
				i_16_ = 128;
				i_15_ = -1;
			}
			long l = i_15_ | ((long) i_11_ << 28 | ((long) i_13_ << 48 | (long) i_12_ << 42) | i_16_ << 14);
			Node node;
			for (node = aHashTable8022.getNode(3512, l); node != null; node = aHashTable8022.method1524((byte) 84)) {
				Node_Sub54 node_sub54 = (Node_Sub54) node;
				if ((node_sub54.anInt7689 ^ 0xffffffff) == (i_15_ ^ 0xffffffff) && i_16_ == node_sub54.aFloat7690
						&& (node_sub54.anInt7680 ^ 0xffffffff) == (i_11_ ^ 0xffffffff) && i_12_ == node_sub54.anInt7676
	...
	@Override
	public final void wa(r var_r, int i, int i_133_, int i_134_, int i_135_, boolean bool) {
		anInt8005++;
		if (aClass263_8008 != null && var_r != null) {
		...
		if ((anInt8023 ^ 0xffffffff) >= -1)
			...
			for (int i = 1; (i ^ 0xffffffff) > (anInt3408 ^ 0xffffffff); i++)
				for (int i_41_ = 1; i_41_ < anInt3404; i_41_++)
					bs[i][i_41_] = (byte) ((aByteArrayArray8026[i][i_41_ - -1] >> 3)
							+ ((aByteArrayArray8026[-1 + i][i_41_] >> 2) + ((aByteArrayArray8026[i - -1][i_41_] >> 3)
									+ ((aByteArrayArray8026[i][i_41_ - 1] >> 2)
											+ (aByteArrayArray8026[i][i_41_] >> 1)))));
			...
			if ((anInt7981 & 0x7 ^ 0xffffffff) != -1)
				i += 12;
			jaclib.memory.heap.NativeHeapBuffer nativeheapbuffer = anAbstractToolkit8004.aNativeHeap6084
					.a(anInt8023 * 4, false);
			jaclib.memory.heap.NativeHeapBuffer nativeheapbuffer_42_ = anAbstractToolkit8004.aNativeHeap6084
					.a(anInt8023 * i, false);
			...
			for (int i_47_ = 0; anInt3408 > i_47_; i_47_++)
				for (int i_48_ = 0; anInt3404 > i_48_; i_48_++)
					if (anIntArrayArrayArray8006[i_47_][i_48_] != null) {
						...
						int i_70_ = 0;
						while_236_: for (int i_71_ = 0; i_71_ < is_52_.length; i_71_++) {
						...
						for (int i_73_ = 0; (i_73_ ^ 0xffffffff) > (is_52_.length ^ 0xffffffff); i_73_++) {
							...
							long l = (long) i_79_ << 48 | (long) i_78_ << 32 | i_76_ << 16 | i_77_;
							int i_81_ = is[i_73_];
							...
							if ((i_78_ ^ 0xffffffff) != 0) {
								...
								if ((anInt7981 & 0x7 ^ 0xffffffff) == -1) {
									f_85_ = anAbstractToolkit8004.aFloatArray6292[0] * f_87_
											+ f_86_ * anAbstractToolkit8004.aFloatArray6292[1]
											+ anAbstractToolkit8004.aFloatArray6292[2] * f_88_;
									f_85_ = f_85_
											* (f_85_ > 0.0F ? anAbstractToolkit8004.aFloat6274
													: anAbstractToolkit8004.aFloat6272)
											+ anAbstractToolkit8004.aFloat6300;
								}
							}
							Node node = null;
							if ((-1 + anInt7982 & i_74_ ^ 0xffffffff) == -1
									&& (-1 + anInt7982 & i_75_ ^ 0xffffffff) == -1)
								node = hashtable.getNode(3512, l);
							int i_100_;
							if (node != null) {
								ses[i_73_] = ((Node_Sub46) node).aShort7554;
								i_100_ = 0xffff & ses[i_73_];
								if (i_78_ != -1 && (node_sub54s_44_[i_100_].aLong2797
										^ 0xffffffffffffffffL) < (node_sub54s_49_[i_73_].aLong2797
												^ 0xffffffffffffffffL))
								...
								if ((i_79_ ^ 0xffffffff) == (i_78_ ^ 0xffffffff))
									...
									if ((0x7 & anInt7981) == 0) {
										float f_103_ = anAbstractToolkit8004.aFloatArray6292[2] * f_88_
												+ (anAbstractToolkit8004.aFloatArray6292[1] * f_86_
														+ f_87_ * anAbstractToolkit8004.aFloatArray6292[0]);
										f_103_ = anAbstractToolkit8004.aFloat6300
												+ (!(f_85_ > 0.0F) ? anAbstractToolkit8004.aFloat6272
														: anAbstractToolkit8004.aFloat6274) * f_85_;
			...
			if ((anInt7981 & 0x7) == 0) {
				if (anIntArrayArrayArray8002 == null)
					aClass213_8017 = anAbstractToolkit8004.method1372((byte) -120,
							new Class207[] {
									new Class207(new Commands[] { Commands.aClass126_1620, Commands.aClass126_1628 }),
									new Class207(Commands.aClass126_1626) });
				else
					aClass213_8017 = anAbstractToolkit8004.method1372((byte) -119,
							new Class207[] { new Class207(new Commands[] { Commands.aClass126_1620,
									Commands.aClass126_1628, Commands.aClass126_1627 }),
									new Class207(Commands.aClass126_1626) });
			} else if (anIntArrayArrayArray8002 != null)
				aClass213_8017 = anAbstractToolkit8004.method1372((byte) -119,
						new Class207[] {
								new Class207(new Commands[] { Commands.aClass126_1620, Commands.aClass126_1628,
										Commands.aClass126_1627, Commands.aClass126_1625 }),
								new Class207(Commands.aClass126_1626) });
			else
				aClass213_8017 = anAbstractToolkit8004.method1372((byte) -121, new Class207[] { new Class207(
						new Commands[] { Commands.aClass126_1620, Commands.aClass126_1628, Commands.aClass126_1625 }),
						new Class207(Commands.aClass126_1626) });
			int i_119_ = 0;
