...
public class StandardSprite extends GLSprite {
	public static Class104 aClass104_8926 = new Class104();
	public static AbstractFont aClass52_8945;
	public static int anInt8914;
	public static int anInt8917;
	public static int anInt8918;
	public static int anInt8919;
	public static int anInt8920;
	public static int anInt8921;
	public static int anInt8923;
	public static int anInt8924;
	public static int anInt8927;
	public static int anInt8928;
	public static int anInt8930;
	public static int anInt8931;
	public static int anInt8932;
	public static int anInt8934;
	public static int anInt8937;
	public static int anInt8938;
	public static int anInt8943;
	public static int anInt8946;

	public static final void method1213(int i, Packet packet) {
		anInt8919++;
							...
							if ((i_58_ ^ 0xffffffff) != -4) {
								...
								for (int i_62_ = 0; bs.length > i_62_; i_62_++) {
									ObjectInputStream objectinputstream = new ObjectInputStream(
											new ByteArrayInputStream(bs[i_62_]));
	...
	public static final boolean method1215(int i, int i_86_, int i_87_) {
		if (i != -30061)
			method1215(88, -128, -104);
		anInt8917++;
		if (!((0x70000 & i_87_) != 0 | Class349.method3988((byte) -104, i_86_, i_87_))
				&& !OutgoingPacket.method3669(i_87_, (byte) 112, i_86_))
			return false;
		return true;
	}
	...
	StandardSprite(AbstractToolkit abstracttoolkit, int i, int i_99_, boolean bool) {
		...
		anInterface13_Impl1_8925 = abstracttoolkit.method1291(
	...
	@Override
	public final void method1178(int i, int i_5_, int i_6_, int i_7_) {
		anInt8939 = i_5_;
		anInt8938++;
		anInt8940 = i_6_;
		anInt8922 = i_7_;
	...
	@Override
	public final void method1183(int i, int i_24_, int i_25_, int i_26_, int i_27_, int i_28_, int i_29_) {
		anInt8921++;
		...
		if (bool_31_ & bool) {
			class336_sub1_30_.method3877(1.0F, (byte) -112, anInterface13_Impl1_8925.method49(i_26_, (byte) -22),
					anInterface13_Impl1_8925.method45(i_25_, -74));
			class336_sub1.method3877(0.0F, (byte) -112, i_26_, i_25_);
			...
			class336_sub1_30_.method3877(1.0F, (byte) -112, anInterface13_Impl1_8925.method49(anInt8915, (byte) -94),
					anInterface13_Impl1_8925.method45(i_25_, 118));
			anAbstractToolkit8935.method1297(-21029, BufferedConnection.aClass346_615);
			int i_34_ = anInt8939 + i_24_;
			int i_35_ = i_34_ - -anInt8915;
			while ((i_35_ ^ 0xffffffff) >= (i_32_ ^ 0xffffffff)) {
				class336_sub1.method3877(0.0F, (byte) -112, anInt8915, i_25_);
			...
			if ((i_32_ ^ 0xffffffff) < (i_34_ ^ 0xffffffff)) {
				...
				class336_sub1_30_.method3877(1.0F, (byte) -112, anInterface13_Impl1_8925.method49(i_36_, (byte) -102),
						anInterface13_Impl1_8925.method45(i_25_, 98));
				anAbstractToolkit8935.method1297(-21029, BufferedConnection.aClass346_615);
				class336_sub1.method3877(0.0F, (byte) -112, i_36_, i_25_);
				class336_sub1.method3863(i, i_34_, 0);
			...
			for (int i_42_ = i_41_ - -anInt8915; (i_37_ ^ 0xffffffff) <= (i_42_ ^ 0xffffffff); i_42_ += i_40_) {
				class336_sub1_30_.method3877(1.0F, (byte) -112,
						anInterface13_Impl1_8925.method49(anInt8915, (byte) -102),
						anInterface13_Impl1_8925.method45(anInt8942, -98));
				anAbstractToolkit8935.method1297(-21029, BufferedConnection.aClass346_615);
				int i_43_ = i + anInt8929;
				for (int i_44_ = anInt8942 + i_43_; i_44_ <= i_38_; i_44_ += i_39_) {
					class336_sub1.method3877(0.0F, (byte) -112, anInt8915, anInt8942);
				...
				if (i_38_ > i_43_) {
					...
					class336_sub1_30_.method3877(1.0F, (byte) -112,
							anInterface13_Impl1_8925.method49(anInt8915, (byte) -124),
							anInterface13_Impl1_8925.method45(i_45_, -69));
					anAbstractToolkit8935.method1297(-21029, BufferedConnection.aClass346_615);
					class336_sub1.method3877(0.0F, (byte) -112, anInt8915, i_45_);
					class336_sub1.method3863(i_43_, i_41_, 0);
			...
			if (i_37_ > i_41_) {
				...
				class336_sub1_30_.method3877(1.0F, (byte) -112, anInterface13_Impl1_8925.method49(i_46_, (byte) -119),
						anInterface13_Impl1_8925.method45(anInt8942, 83));
				anAbstractToolkit8935.method1297(-21029, BufferedConnection.aClass346_615);
				int i_47_ = anInt8929 + i;
				int i_48_ = anInt8942 + i_47_;
				while (i_38_ >= i_48_) {
					class336_sub1.method3877(0.0F, (byte) -112, i_46_, anInt8942);
				...
				if ((i_38_ ^ 0xffffffff) < (i_47_ ^ 0xffffffff)) {
					...
					class336_sub1_30_.method3877(1.0F, (byte) -112,
							anInterface13_Impl1_8925.method49(i_46_, (byte) -30),
							anInterface13_Impl1_8925.method45(i_49_, 108));
					anAbstractToolkit8935.method1297(-21029, BufferedConnection.aClass346_615);
					class336_sub1.method3877(0.0F, (byte) -112, i_46_, i_49_);
					class336_sub1.method3863(i_47_, i_41_, 0);
			...
			class336_sub1_30_.method3877(1.0F, (byte) -112, anInterface13_Impl1_8925.method49(i_26_, (byte) -73),
					anInterface13_Impl1_8925.method45(anInt8942, 110));
			anAbstractToolkit8935.method1297(-21029, BufferedConnection.aClass346_615);
			int i_52_ = i + anInt8929;
			int i_53_ = anInt8942 + i_52_;
			while ((i_53_ ^ 0xffffffff) >= (i_50_ ^ 0xffffffff)) {
				class336_sub1.method3877(0.0F, (byte) -112, i_26_, anInt8942);
			...
			if ((i_52_ ^ 0xffffffff) > (i_50_ ^ 0xffffffff)) {
				...
				class336_sub1_30_.method3877(1.0F, (byte) -112, anInterface13_Impl1_8925.method49(i_26_, (byte) -107),
						anInterface13_Impl1_8925.method45(i_54_, -64));
				anAbstractToolkit8935.method1297(-21029, BufferedConnection.aClass346_615);
				class336_sub1.method3877(0.0F, (byte) -112, i_26_, i_54_);
				class336_sub1.method3863(i_52_, i_24_, 0);
	...
	@Override
	public final void method1184(int i, int i_63_, int i_64_, int i_65_, int i_66_, int i_67_, int i_68_, int i_69_) {
		anInt8930++;
		Class336_Sub1 class336_sub1 = anAbstractToolkit8935.method1264(false);
		Class336_Sub1 class336_sub1_70_ = anAbstractToolkit8935.method1306(7);
		anInterface13_Impl1_8925.method41((byte) -106, aBoolean8936 || aBoolean8941 || (i_69_ & 0x1) == 0
				? Class194.aClass228_2377 : Node_Sub38_Sub5.aClass228_10123);
		anAbstractToolkit8935.method1323((byte) 28);
		anAbstractToolkit8935.method1312((byte) -21, anInterface13_Impl1_8925);
		...
		class336_sub1_70_.method3877(1.0F, (byte) -112, anInterface13_Impl1_8925.method49(anInt8915, (byte) -20),
				anInterface13_Impl1_8925.method45(anInt8942, -99));
		if (aBoolean8933) {
		...
		class336_sub1.method3877(0.0F, (byte) -112, i_65_, i_64_);
	...
	@Override
	public final void method1187(int[] is) {
		anInt8937++;
		is[2] = anInt8940;
		is[0] = anInt8929;
		is[3] = anInt8922;
	...
	@Override
	public final void method1188(float f, float f_88_, float f_89_, float f_90_, float f_91_, float f_92_, int i, aa var_aa,
			int i_93_, int i_94_) {
		anInt8920++;
		Class336_Sub1 class336_sub1 = anAbstractToolkit8935.method1264(false);
		...
		anInterface13_Impl1_8925.method41((byte) -117, aBoolean8936 || aBoolean8941 || (0x1 & i ^ 0xffffffff) == -1
				? Class194.aClass228_2377 : Node_Sub38_Sub5.aClass228_10123);
		anAbstractToolkit8935.method1323((byte) 28);
		anAbstractToolkit8935.method1312((byte) -21, anInterface13_Impl1_8925);
		...
		if (aBoolean8933) {
			...
			class336_sub1.method3880(f_97_ * (-f + f_91_), (byte) 118, (f_90_ - f_88_) * f_96_, 1.0F,
					f_96_ * (f_89_ - f), 0.0F, 0.0F, 0.0F, 0.0F, f_97_ * (-f_88_ + f_92_));
			class336_sub1.method3875(0.0F, (f_88_ + anInt8939) * f_97_, (byte) 103, f_96_ * (anInt8929 + f));
		} else {
			class336_sub1.method3880(f_91_ - f, (byte) 94, -f_88_ + f_90_, 1.0F, -f + f_89_, 0.0F, 0.0F, 0.0F, 0.0F,
					f_92_ - f_88_);
			class336_sub1.method3875(0.0F, f_88_, (byte) 103, f);
		}
		class336_sub1_95_.method3877(1.0F, (byte) -112, anInterface13_Impl1_8925.method49(anInt8915, (byte) -125),
				anInterface13_Impl1_8925.method45(anInt8942, 109));
		anAbstractToolkit8935.method1297(-21029, BufferedConnection.aClass346_615);
		...
		class336_sub1_98_.method3889(interface13_impl1.method49(1.0F, (byte) -86), (byte) 111,
				interface13_impl1.method45(1.0F, -57), 1.0F);
		anAbstractToolkit8935.method1297(-21029, BufferedConnection.aClass346_615);
	...
	@Override
	public final void method1189(int i, int i_8_, aa var_aa, int i_9_, int i_10_) {
		anInt8931++;
		aa_Sub2 var_aa_Sub2 = (aa_Sub2) var_aa;
		Interface13_Impl1 interface13_impl1 = var_aa_Sub2.anInterface13_Impl1_5489;
		i += anInt8929;
		...
		class336_sub1_11_.method3877(1.0F, (byte) -112, anInterface13_Impl1_8925.method49(anInt8915, (byte) -116),
				anInterface13_Impl1_8925.method45(anInt8942, 105));
		anAbstractToolkit8935.method1297(-21029, BufferedConnection.aClass346_615);
		anAbstractToolkit8935.method1362(255, 1);
		anAbstractToolkit8935.method1312((byte) -21, interface13_impl1);
		anAbstractToolkit8935.method1318(-30, Class116.aClass94_5075, Class117_Sub1.aClass94_4924);
		...
		class336_sub1_12_.method3877(1.0F, (byte) -112, interface13_impl1.method49(anInt8915, (byte) -121),
				interface13_impl1.method45(anInt8942, -79));
		class336_sub1_12_.method3875(0.0F, interface13_impl1.method49(-i_10_ + i_8_, (byte) -40), (byte) 103,
				interface13_impl1.method45(-i_9_ + i, -109));
		anAbstractToolkit8935.method1297(-21029, BufferedConnection.aClass346_615);
		anAbstractToolkit8935.method1283((byte) -128);
		anAbstractToolkit8935.method1255((byte) -12);
		anAbstractToolkit8935.method1304(0, 0, Class106.aClass135_1354);
	...
	@Override
	public final void method1190(int i, int i_71_, int i_72_) {
		anInt8923++;
			...
			if (i_72_ == 1)
				for (int i_74_ = 0; i_74_ < anInt8915; i_74_++) {
					...
					for (int i_76_ = 0; (i_76_ ^ 0xffffffff) > (anInt8942 ^ 0xffffffff); i_76_++)
						is_73_[i_75_ + i_76_] = Node_Sub16.method2590(
								Node_Sub30.method2723(is[i_75_ - -i_76_], -1962803456) << 16,
								Node_Sub30.method2723(is_73_[i_76_ + i_75_], 16777215));
				}
				...
				for (int i_77_ = 0; i_77_ < anInt8915; i_77_++) {
					...
					for (int i_79_ = 0; (i_79_ ^ 0xffffffff) > (anInt8942 ^ 0xffffffff); i_79_++)
						is_73_[i_78_ - -i_79_] = Node_Sub16.method2590(
								Node_Sub30.method2723(is[i_78_ + i_79_], -1816447489) << 24,
								Node_Sub30.method2723(16777215, is_73_[i_79_ + i_78_]));
				}
				...
				for (int i_80_ = 0; (i_80_ ^ 0xffffffff) > (anInt8915 ^ 0xffffffff); i_80_++) {
					...
					for (int i_82_ = 0; (anInt8942 ^ 0xffffffff) < (i_82_ ^ 0xffffffff); i_82_++)
						is_73_[i_82_ + i_81_] = Node_Sub16.method2590(
								Node_Sub30.method2723(is_73_[i_81_ + i_82_], 16777215),
								is[i_82_ + i_81_] == 0 ? 0 : -16777216);
				}
		} else
			for (int i_83_ = 0; i_83_ < anInt8915; i_83_++) {
				...
				for (int i_85_ = 0; i_85_ < anInt8942; i_85_++)
					is_73_[i_85_ + i_84_] = Node_Sub16.method2590(
							Node_Sub30.method2723(-369164288, is[i_84_ - -i_85_]) << 8,
							Node_Sub30.method2723(16777215, is_73_[i_84_ - -i_85_]));
			}
		method1212(0, 0, anInt8942, anInt8915, is_73_, 0, anInt8942);
	}

	@Override
	public final void method1191(int i, int i_13_, int i_14_, int i_15_, int i_16_) {
		anInt8934++;
		Class336_Sub1 class336_sub1 = anAbstractToolkit8935.method1264(false);
		...
		class336_sub1_17_.method3877(1.0F, (byte) -112, anInterface13_Impl1_8925.method49(anInt8915, (byte) -56),
				anInterface13_Impl1_8925.method45(anInt8942, 98));
		anAbstractToolkit8935.method1297(-21029, BufferedConnection.aClass346_615);
		anAbstractToolkit8935.method1266((byte) 108);
		anAbstractToolkit8935.method1283((byte) -128);
	...
	@Override
	public final int method1193() {
		anInt8932++;
		return anInt8942;
	}

	@Override
	public final void method1194(float f, float f_100_, float f_101_, float f_102_, float f_103_, float f_104_, int i,
			int i_105_, int i_106_, int i_107_) {
		anInt8928++;
		Class336_Sub1 class336_sub1 = anAbstractToolkit8935.method1264(false);
		Class336_Sub1 class336_sub1_108_ = anAbstractToolkit8935.method1306(7);
		anInterface13_Impl1_8925.method41((byte) -124, aBoolean8936 || aBoolean8941 || (i_107_ & 0x1 ^ 0xffffffff) == -1
				? Class194.aClass228_2377 : Node_Sub38_Sub5.aClass228_10123);
		anAbstractToolkit8935.method1323((byte) 28);
		anAbstractToolkit8935.method1312((byte) -21, anInterface13_Impl1_8925);
		...
		if (aBoolean8933) {
			float f_109_ = method1197();
			float f_110_ = method1186();
			...
			float f_115_ = f_113_ * anInt8939;
			float f_116_ = anInt8939 * f_114_;
			float f_117_ = f_111_ * anInt8929;
			float f_118_ = f_112_ * anInt8929;
			float f_119_ = anInt8940 * -f_111_;
			float f_120_ = -f_112_ * anInt8940;
			float f_121_ = -f_113_ * anInt8922;
			float f_122_ = anInt8922 * -f_114_;
			f = f + f_117_ + f_115_;
		...
		class336_sub1.method3880(-f + f_103_, (byte) -45, -f_100_ + f_102_, 1.0F, -f + f_101_, 0.0F, 0.0F, 0.0F, 0.0F,
				-f_100_ + f_104_);
		class336_sub1.method3875(0.0F, f_100_, (byte) 103, f);
		class336_sub1_108_.method3877(1.0F, (byte) -112, anInterface13_Impl1_8925.method49(anInt8915, (byte) -78),
				anInterface13_Impl1_8925.method45(anInt8942, 98));
		anAbstractToolkit8935.method1297(-21029, BufferedConnection.aClass346_615);
	...
	@Override
	public final void method1195(int i, int i_18_, int i_19_, int i_20_, int i_21_, int i_22_) {
		anInt8943++;
