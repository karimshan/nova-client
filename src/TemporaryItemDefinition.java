...
public class TemporaryItemDefinition {
	public static d aD565;
	public static long aLong562 = -1L;
	...
	public static final void method403(int i) {
		anInt569++;
	...
	TemporaryItemDefinition(ItemDefinitions itemdefinition) {
		...
		if (itemdefinition.modifiedTextureColors != null) {
			...
			Class311.method3606(itemdefinition.modifiedTextureColors, 0, modifiedTextureColors, 0,
					modifiedTextureColors.length);
		}
	}
}
