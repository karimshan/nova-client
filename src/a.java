...
public class a implements Interface3 {
	...
	public final void method143(Plane plane, int i, int i_14_) {
		H(nativeid, ((t) plane).nativeid, i, i_14_);
	}

	public final DrawableModel method144(i var_i, byte b, int i, boolean bool) {
	...
	public final void method145(GraphicsToolkit graphicstoolkit, int[] is, int[] is_29_, int[] is_30_, short[] ses, int i) {
		O(nativeid, graphicstoolkit, is, is_29_, is_30_, ses, i);
	}

	public final boolean method146(DrawableModel drawablemodel, int i, int i_31_, Class336 class336, boolean bool, int i_32_) {
		return n(nativeid, ((i) drawablemodel).nativeid, i, i_31_, ((ja) class336).nativeid, bool, i_32_);
	}

	public final void method147(Plane plane, int i, int i_37_, int i_38_) {
	...
	public final void method149(DrawableModel drawablemodel, Class336 class336, int[] is, int i) {
		UA(nativeid, ((i) drawablemodel).nativeid, ((ja) class336).nativeid, is, i);
	}

	public final void method150(DrawableModel drawablemodel, Class336 class336, int[] is, int i, int i_39_) {
		f(nativeid, ((i) drawablemodel).nativeid, ((ja) class336).nativeid, is, i, i_39_);
	}

	public final void method151(DrawableModel drawablemodel, DrawableModel drawablemodel_40_, int i, int i_41_, int i_42_,
			boolean bool) {
		r(nativeid, ((i) drawablemodel).nativeid, ((i) drawablemodel_40_).nativeid, i, i_41_, i_42_, bool);
	}

	public final boolean method152(DrawableModel drawablemodel, int i, int i_47_, Class336 class336, boolean bool) {
	...
	public final void method154(Plane plane, int i, int i_53_, int i_54_, int i_55_, int i_56_, int i_57_, int i_58_,
			boolean[][] bools) {
	...
	public final void method156(DrawableModel drawablemodel, int[] is, Class336 class336) {
		e(nativeid, ((i) drawablemodel).nativeid, is, ((ja) class336).nativeid);
	}

	public final void method157(GraphicsToolkit graphicstoolkit, int i, int i_62_, int i_63_, int i_64_, int i_65_, int i_66_,
			int i_67_) {
	...
	private final native void na(long l, GraphicsToolkit graphicstoolkit, int i, int i_0_, int i_1_, int i_2_, int i_3_,
			int i_4_, int i_5_);

	private final native void O(long l, GraphicsToolkit graphicstoolkit, int[] is, int[] is_6_, int[] is_7_,
			short[] ses, int i);
	...
	private final native void ta(long l, long l_19_, int i, int i_20_, int i_21_, int i_22_, int i_23_, int i_24_,
			int i_25_, boolean[][] bools);
