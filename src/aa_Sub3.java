...
public class aa_Sub3 extends aa {
	...
	public static int[] anIntArray5490;

	public static final int method160(int i) {
		anInt5491++;
		if (KeyStrokes.anIntArray3665 == null)
			return 0;
		if (i != -5573)
			return 103;
		return 2 * KeyStrokes.anIntArray3665.length;
	}
	...
	public static final void method162(int i, int i_0_, byte[] bs, int i_1_, int i_2_, int i_3_, byte[] bs_4_, int i_5_,
			int i_6_) {
		anInt5492++;
		int i_7_ = -(i_5_ >> 2);
		i_5_ = -(i_3_ & i_5_);
