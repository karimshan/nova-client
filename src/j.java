...
public class j extends GLSprite implements Interface3 {
	...
	private final native void b(long l, float f, float f_37_, float f_38_, float f_39_, float f_40_, float f_41_, int i,
	...
	@Override
	public final void method1178(int i, int i_72_, int i_73_, int i_74_) {
	...
	@Override
	public final void method1184(int i, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_, int i_13_) {
	...
	@Override
	public final void method1188(float f, float f_0_, float f_1_, float f_2_, float f_3_, float f_4_, int i, aa var_aa,
			int i_5_, int i_6_) {
		UA(nativeid, f, f_0_, f_1_, f_2_, f_3_, f_4_, i, ((na) var_aa).nativeid, i_5_, i_6_);
	}

	@Override
	public final void method1189(int i, int i_96_, aa var_aa, int i_97_, int i_98_) {
		V(nativeid, i, i_96_, ((na) var_aa).nativeid, i_97_, i_98_);
	}

	@Override
	public final void method1190(int i, int i_94_, int i_95_) {
		N(nativeid, i, i_94_, i_95_);
	}

	@Override
	public final void method1191(int i, int i_68_, int i_69_, int i_70_, int i_71_) {
	...
	@Override
	public final void method1194(float f, float f_51_, float f_52_, float f_53_, float f_54_, float f_55_, int i, int i_56_,
			int i_57_, int i_58_) {
		b(nativeid, f, f_51_, f_52_, f_53_, f_54_, f_55_, i, i_56_, i_57_, i_58_);
	}

	@Override
	public final void method1195(int i, int i_75_, int i_76_, int i_77_, int i_78_, int i_79_) {
	...
	private final native void RA(long l, int i, int i_30_, int i_31_, int i_32_, int i_33_, int i_34_, int i_35_,
			int i_36_);

	private final native void ua(oa var_oa, int[] is, int i, int i_59_, int i_60_, int i_61_, boolean bool);

	private final native void UA(long l, float f, float f_81_, float f_82_, float f_83_, float f_84_, float f_85_,
			int i, long l_86_, int i_87_, int i_88_);
