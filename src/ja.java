...
public class ja extends Class336 implements Interface3 {
	...
	@Override
	public final void method3853(int i, int i_21_, int i_22_, int[] is) {
		b(nativeid, i, i_21_, i_22_, is);
	}

	@Override
	public final void method3854(int i, int i_2_, int i_3_) {
	...
	@Override
	public final void method3863(int i, int i_25_, int i_26_) {
		a(nativeid, i, i_25_, i_26_);
	}

	@Override
	public final void method3864(int i, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_) {
	...
	@Override
	public final void method3867(int i, int i_10_, int i_11_, int[] is) {
	...
	@Override
	public final void method3869(int i, int i_23_, int i_24_, int[] is) {
