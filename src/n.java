...
public class n extends AbstractFont implements Interface3 {
	...
	@Override
	public final native void fa(char c, int i, int i_0_, int i_1_, boolean bool);
	...
	@Override
	public final void method526(char c, int i, int i_13_, int i_14_, boolean bool, aa var_aa, int i_15_, int i_16_) {
	...
	private final native void S(oa var_oa, ya var_ya, byte[][] bs, int[] is, int[] is_9_, int[] is_10_, int[] is_11_,
			int[] is_12_);
