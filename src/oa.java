...
public class oa extends GraphicsToolkit implements Interface3 {
	...
	public final void a(Class198 class198) {
		if (class198.aClass87_2429.method1013(119) != 0) {
			a(class198, false);
			C().method145(this, anIntArray4996, anIntArray4999, anIntArray4995, aShortArray5002,
					class198.aClass87_2429.method1013(124));
		}
	}
	...
	private final void a(Class198 class198, boolean bool) {
		...
		int i_12_ = 0;
		int i_13_ = 0;
		for (EntityNode_Sub3_Sub2 entitynode_sub3_sub2 = (EntityNode_Sub3_Sub2) class198.aClass87_2429.method1015(
				0); entitynode_sub3_sub2 != null; entitynode_sub3_sub2 = (EntityNode_Sub3_Sub2) class198.aClass87_2429
						.method1014(true)) {
	...
	public final void a(Class198 class198, int i) {
		a(class198, false);
		C().method145(this, anIntArray4996, anIntArray4999, anIntArray4995, aShortArray5002,
				class198.aClass87_2429.method1013(125));
	}
	...
	@Override
	public final Class270 a(Class270 class270, Class270 class270_27_, float f, Class270 class270_28_) {
		return null;
	}
	...
	public final GLSprite a(Class383 class383, boolean bool) {
		j var_j = new j(this, class383.anIntArray4904, class383.aByteArray4903, class383.aByteArray4905, 0,
				class383.anInt4897, class383.anInt4897, class383.anInt4900);
		var_j.method1178(class383.anInt4902, class383.anInt4898, class383.anInt4901, class383.anInt4899);
		return var_j;
	}

	@Override
	public final void a(float f, float f_216_, float f_217_) {
		/* empty */
	}
	...
	@Override
	public final Interface4 a(int i, int i_14_) {
		return a(i, i_14_, false);
	}

	@Override
	public final GLSprite a(int i, int i_145_, boolean bool) {
		return new j(this, i, i_145_);
	}

	@Override
	public final void a(int i, int i_58_, int i_59_, int i_60_) {
		/* empty */
	}

	@Override
	public final GLSprite a(int i, int i_141_, int i_142_, int i_143_, boolean bool) {
		return new j(this, i, i_141_, i_142_, i_143_, !bool);
	}

	@Override
	public final Node_Sub29 a(int i, int i_43_, int i_44_, int i_45_, int i_46_, float f) {
		return new Node_Sub29_Sub3(i, i_43_, i_44_, i_45_, i_46_, f);
	}

	@Override
	public final void a(int i, int i_146_, int i_147_, int i_148_, int i_149_, int i_150_) {
		wa(i, i_146_, i_147_, i_148_, i_149_, i_150_);
	}

	@Override
	public final void a(int i, int i_51_, int i_52_, int i_53_, int i_54_, int i_55_, aa var_aa, int i_56_, int i_57_) {
		Z(i, i_51_, i_52_, i_53_, i_54_, i_55_, var_aa, i_56_, i_57_);
	}

	@Override
	public final void a(int i, int i_94_, int i_95_, int i_96_, int i_97_, int i_98_, aa var_aa, int i_99_, int i_100_,
			int i_101_, int i_102_, int i_103_) {
		/* empty */
	}

	@Override
	public final void a(int i, int i_29_, int i_30_, int i_31_, int i_32_, int i_33_, int i_34_) {
		C().method157(this, i, i_29_, i_30_, i_31_, i_32_, i_33_, i_34_);
	}

	@Override
	public final void a(int i, int i_17_, int i_18_, int i_19_, int i_20_, int i_21_, int i_22_, int i_23_, int i_24_) {
		/* empty */
	}

	@Override
	public final void a(int i, int i_120_, int i_121_, int i_122_, int i_123_, int i_124_, int i_125_, int i_126_, int i_127_,
			int i_128_, int i_129_, int i_130_, int i_131_) {
		/* empty */
	}

	@Override
	public final aa a(int i, int i_139_, int[] is, int[] is_140_) {
		return new na(this, aYa4998, i, i_139_, is, is_140_);
	}

	@Override
	public final Plane a(int i, int i_186_, int[][] is, int[][] is_187_, int i_188_, int i_189_, int i_190_) {
	...
	@Override
	public final GLSprite a(int[] is, int i, int i_5_, int i_6_, int i_7_, boolean bool) {
	...
	public final void a(java.awt.Canvas canvas) {
		if (canvas != null) {
			p var_p = (p) aHashTable5007.getNode(3512, canvas.hashCode());
			aP5009 = var_p;
			t(var_p);
		} else {
			aP5009 = null;
	...
	@Override
	public final void a(java.awt.Canvas canvas, int i, int i_15_) {
		p var_p = (p) aHashTable5007.getNode(3512, canvas.hashCode());
	...
	@Override
	public final DrawableModel a(Model model, int i, int i_132_, int i_133_, int i_134_) {
		return new i(this, aYa4998, model, i, i_132_, i_133_, i_134_);
	}

	@Override
	public final void a(Rectangle[] rectangles, int i, int i_184_, int i_185_) throws Exception_Sub1 {
		if (aP5009 == null)
	...
	@Override
	public final native void A(int i, aa var_aa, int i_224_, int i_225_);

	@Override
	public final native void aa(int i, int i_219_, int i_220_, int i_221_, int i_222_, int i_223_);

	private final native void AA(short s, short s_74_, int i, byte b, byte b_75_, int i_76_, boolean bool, byte b_77_,
			byte b_78_, byte b_79_, byte b_80_, boolean bool_81_, boolean bool_82_, boolean bool_83_, boolean bool_84_,
			boolean bool_85_, byte b_86_, boolean bool_87_, boolean bool_88_, int i_89_);
	...
	@Override
	public final int b(int i, int i_181_) {
	...
	@Override
	public final native void b(int i, int i_136_, int i_137_, int i_138_, double d);
	...
	@Override
	public final void b(java.awt.Canvas canvas, int i, int i_135_) {
		p var_p = (p) aHashTable5007.getNode(3512, canvas.hashCode());
		if (var_p == null) {
			try {
			...
			aHashTable5007.put(canvas.hashCode(), var_p, -124);
	...
	@Override
	public final int c(int i, int i_16_) {
		return i | i_16_;
	}

	@Override
	public final Class270 c(int i, int i_174_, int i_175_, int i_176_, int i_177_, int i_178_) {
		return null;
	}

	private final boolean c(short s) {
		synchronized (this) {
			PlayerMasks class91 = aD1543.method10(s, -8217);
			if (class91 == null)
				return false;
			AA(s, class91.aShort1221, class91.anInt1226, class91.aByte1214, class91.aByte1213, class91.anInt1206,
					class91.aBoolean1204, class91.aByte1225, class91.aByte1217, class91.aByte1211, class91.aByte1203,
					class91.aBoolean1223, class91.aBoolean1205, class91.aBoolean1222, class91.aBoolean1212,
					class91.aBoolean1210, class91.aByte1207, class91.aBoolean1215, class91.aBoolean1216,
					class91.anInt1202);
		}
		return true;
	}
	...
	@Override
	public final native void C(boolean bool);

	private final native void CA(short s, int[] is, short s_158_, int i, byte b, byte b_159_, int i_160_, boolean bool,
			byte b_161_, byte b_162_, byte b_163_, byte b_164_, boolean bool_165_, boolean bool_166_, boolean bool_167_,
			boolean bool_168_, boolean bool_169_, byte b_170_, boolean bool_171_, boolean bool_172_, int i_173_);
	...
	@Override
	public final Interface20 d(int i, int i_218_) {
		return new xa(i, i_218_);
	}

	@Override
	public final void d(int i, int i_66_, int i_67_, int i_68_, int i_69_, int i_70_) {
	...
	@Override
	public final native void da(int i, int i_118_, int i_119_, int[] is);

	@Override
	public final native void DA(int i, int i_71_, int i_72_, int i_73_);
	...
	public final void e(int i) {
		...
		d(i);
		for (ya var_ya = (ya) aClass312_4991.method3613(65280); var_ya != null; var_ya = (ya) aClass312_4991
				.method3620(16776960))
			var_ya.r();
	}

	@Override
	public final void e(int i, int i_208_) throws Exception_Sub1 {
		if (aP5009 == null)
			throw new IllegalStateException("off");
	...
	@Override
	public final native void EA(int i, int i_195_, int i_196_, int i_197_);
	...
	@Override
	public final native void f(int i, int i_0_);

	@Override
	public final native void F(int i, int i_50_);
	...
	@Override
	public final native void GA(int i);
	...
	@Override
	public final native void H(int i, int i_35_, int i_36_, int[] is);

	@Override
	public final native void HA(int i, int i_108_, int i_109_, int i_110_, int[] is);
	...
	@Override
	public final native int JA(int i, int i_61_, int i_62_, int i_63_, int i_64_, int i_65_);
	...
	@Override
	public final native void K(int[] is);

	@Override
	public final native void KA(int i, int i_47_, int i_48_, int i_49_);
	...
	@Override
	public final native void L(int i, int i_151_, int i_152_);
	...
	@Override
	public final native int[] na(int i, int i_198_, int i_199_, int i_200_);
	...
	@Override
	public final native void P(int i, int i_204_, int i_205_, int i_206_, int i_207_);
	...
	@Override
	public final native void Q(int i, int i_111_, int i_112_, int i_113_, int i_114_, int i_115_, byte[] bs, int i_116_,
			int i_117_);
	...
	@Override
	public final native int r(int i, int i_37_, int i_38_, int i_39_, int i_40_, int i_41_, int i_42_);

	@Override
	public final native void ra(int i, int i_2_, int i_3_, int i_4_);
	...
	@Override
	public final native void T(int i, int i_201_, int i_202_, int i_203_);
	...
	@Override
	public final native void U(int i, int i_191_, int i_192_, int i_193_, int i_194_);
	...
	private final boolean WA(short s) {
		synchronized (aD1543) {
			...
			CA(s, is, class91.aShort1221, class91.anInt1226, class91.aByte1214, class91.aByte1213, class91.anInt1206,
					class91.aBoolean1204, class91.aByte1225, class91.aByte1217, class91.aByte1211, class91.aByte1203,
					class91.aBoolean1223, class91.aBoolean1205, class91.aBoolean1222, class91.aBoolean1212,
					class91.aBoolean1210, class91.aByte1207, class91.aBoolean1215, class91.aBoolean1216,
					class91.anInt1202);
	...
	@Override
	public final native void X(int i);

	@Override
	public final native void xa(float f);

	@Override
	public final native int XA();
	...
	private final native void Z(int i, int i_209_, int i_210_, int i_211_, int i_212_, int i_213_, aa var_aa,
			int i_214_, int i_215_);

	@Override
	public final native void za(int i, int i_104_, int i_105_, int i_106_, int i_107_);

	@Override
	public final native void ZA(int i, float f, float f_90_, float f_91_, float f_92_, float f_93_);
}
