...
public class p extends Node implements Interface3 {
	...
	public java.awt.Canvas aCanvas5018;
	...
	public final void method2767(int i, int i_0_) {
		try {
	...
	public final void method2768(java.awt.Canvas canvas, int i, int i_9_) {
		anInt5015 = i;
		anInt5016 = i_9_;
		oa(canvas, i, i_9_);
	}
	...
	public final void method2770(Rectangle[] rectangles, int i, int i_10_, int i_11_) {
		try {
			synchronized (aCanvas5018.getTreeLock()) {
