...
public abstract class r extends CacheNode {
	
	public static Class58 aClass58_9578;
	public static int anInt9579;
	public static int anInt9581;
	public static int anInt9582;
	public static int anInt9583;
	public static int anInt9584;
	public static int[] anIntArray9580 = { 7, 8, 9, 10, 11, 12, 13, 15 };

	public static final boolean method2357(byte b, char c) {
		anInt9581++;
		if (b != -117)
			anIntArray9580 = null;
	...
	public static final void method2358(int i, byte b, int i_3_) {
		anInt9582++;
		if (b == -106) {
			CacheNode_Sub2 cachenode_sub2 = Class320_Sub19.method3754(b ^ ~0x6a, 1, i_3_);
			cachenode_sub2.method2288(0);
			cachenode_sub2.itemId = i;
		}
	}

	public static final int method2359(String string, byte b, int i, String string_4_) {
		anInt9583++;
		...
		while_224_: do {
			...
			for (;;) {
				...
				if ((c_10_ ^ 0xffffffff) != (c_11_ ^ 0xffffffff)
						&& (Character.toUpperCase(c_10_) ^ 0xffffffff) != (Character.toUpperCase(c_11_) ^ 0xffffffff)) {
		...
		for (int i_13_ = 0; (i_12_ ^ 0xffffffff) < (i_13_ ^ 0xffffffff); i_13_++) {
			...
			if ((c_14_ ^ 0xffffffff) != (c_15_ ^ 0xffffffff)
					&& (Character.toUpperCase(c_14_) ^ 0xffffffff) != (Character.toUpperCase(c_15_) ^ 0xffffffff)) {
				c_14_ = Character.toLowerCase(c_14_);
				c_15_ = Character.toLowerCase(c_15_);
				if ((c_14_ ^ 0xffffffff) != (c_15_ ^ 0xffffffff))
					return Class320_Sub22.method3766((byte) 106, i, c_14_)
							- Class320_Sub22.method3766((byte) 109, i, c_15_);
			}
		}
		int i_16_ = -i_6_ + i_5_;
		if (i_16_ != 0)
		...
		for (int i_17_ = 0; i_17_ < i_12_; i_17_++) {
			...
			if (c_18_ != c_19_)
				return Class320_Sub22.method3766((byte) 103, i, c_18_)
						+ -Class320_Sub22.method3766((byte) 105, i, c_19_);
		}
		return 0;
	}

	public static final boolean method2361(int i, int i_26_) {
		if (i_26_ < 1)
			method2361(-95, -35);
		anInt9584++;
	...
	public static final void sendMessageOnTile(int junk, int plane, int delayCycles, String message, int i_22_, int height,
			int x, int y) {
		anInt9579++;
