...
public class r_Sub1 extends r {
	public static Index aClass302_11047;
	public static int anInt11041;
	public static int anInt11043;
	public static int anInt11045;
	public static int anInt11046;
	public static int anInt11048;
	public static int anInt11051;

	public static final void method2364(int i, int i_1_, int i_2_, String string, int i_3_) {
		anInt11043++;
		...
		if (widget != null) {
			...
			if ((Class151.anInt1843 ^ 0xffffffff) == -12
					&& ConnectionDecoder.method113(widget).method2748((byte) -98, -1 + i_3_)) {
				if (i_3_ == 1) {
					Class188_Sub2_Sub1.anInt9350++;
					Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, DeveloperConsole.aClass318_7526,
				...
				if ((i_3_ ^ 0xffffffff) == -3) {
					...
					Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, Class170.aClass318_2051,
							Class218.aClass123_2566.isaacCipher);
				...
				if (i_3_ == 3) {
					Class279.anInt3550++;
					Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, Class262_Sub9.aClass318_7765,
							Class218.aClass123_2566.isaacCipher);
				...
				if ((i_3_ ^ 0xffffffff) == -5) {
					Class385.anInt4912++;
					Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, Class377.aClass318_4663,
							Class218.aClass123_2566.isaacCipher);
					Animable_Sub4_Sub1.method927(i_1_, widget.anInt4718, -127, node_sub13, i_2_);
					Class218.aClass123_2566.sendPacket(127, node_sub13);
				}
				if (i_3_ == 5) {
					...
					Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, Class368.aClass318_4544,
							Class218.aClass123_2566.isaacCipher);
				...
				if ((i_3_ ^ 0xffffffff) == -7) {
					...
					Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, Class64.aClass318_5048,
							Class218.aClass123_2566.isaacCipher);
				...
				if (i_3_ == 7) {
					...
					Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, Class189.aClass318_2295,
							Class218.aClass123_2566.isaacCipher);
					Animable_Sub4_Sub1.method927(i_1_, widget.anInt4718, -127, node_sub13, i_2_);
					Class218.aClass123_2566.sendPacket(126, node_sub13);
				}
				if (i_3_ == 8) {
					...
					Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, Class371.aClass318_4586,
							Class218.aClass123_2566.isaacCipher);
					Animable_Sub4_Sub1.method927(i_1_, widget.anInt4718, -127, node_sub13, i_2_);
					Class218.aClass123_2566.sendPacket(127, node_sub13);
				}
				if ((i_3_ ^ 0xffffffff) == -10) {
					Class300.anInt3767++;
					Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, Node_Sub30.aClass318_7360,
							Class218.aClass123_2566.isaacCipher);
				...
				if (i_3_ == 10) {
					Class161.anInt2002++;
					Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, Class379.aClass318_4869,
							Class218.aClass123_2566.isaacCipher);
					Animable_Sub4_Sub1.method927(i_1_, widget.anInt4718, -128, node_sub13, i_2_);
					Class218.aClass123_2566.sendPacket(127, node_sub13);
				}
	...
	public static final String method2369(boolean bool, int i, long l, int i_20_) {
		anInt11051++;
		Calendar calendar;
		if (bool) {
		...
		return Integer.toString(i_21_ / 10) + i_21_ % 10 + "/" + i_22_ / 10 + i_22_ % 10 + "/" + i_24_ % 100 / 10
				+ i_24_ % 10 + " " + i_25_ / 10 + i_25_ % 10 + ":" + i_26_ / 10 + i_26_ % 10;
	}
	...
	public final boolean method2363(int i, boolean bool, int i_0_) {
		if (bool != false)
			method2367((byte) 76);
		anInt11041++;
	...
	public final void method2365(int i, int i_5_, int i_6_, int i_7_, int i_8_) {
		if (i_8_ >= 70) {
			anInt11050 = i_7_;
			anInt11049 = -i + i_5_;
			anInt11046++;
	...
	public final void method2367(byte b) {
		if (b == 0) {
			anInt11045++;
			int i = -1;
	...
	public final void method2368(int i, int i_10_, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_) {
		anInt11048++;
		int i_16_ = 0;
		if (i_14_ != i_13_)
			...
			if ((i_14_ ^ 0xffffffff) < (i_13_ ^ 0xffffffff) || i_14_ > i_15_) {
				if (i_15_ >= i_13_) {
					if ((i_14_ ^ 0xffffffff) < (i_15_ ^ 0xffffffff)) {
						...
						if ((i_15_ ^ 0xffffffff) != (i_13_ ^ 0xffffffff) && i_16_ < i_17_
								|| i_15_ == i_13_ && i_18_ < i_16_) {
							i_14_ -= i_15_;
							i_15_ -= i_13_;
				...
				if ((i_13_ == i_14_ || i_18_ >= i_16_)
						&& (i_13_ != i_14_ || (i_17_ ^ 0xffffffff) <= (i_18_ ^ 0xffffffff))) {
					i_15_ -= i_13_;
					i_13_ -= i_14_;
				...
				if (((i_14_ ^ 0xffffffff) == (i_15_ ^ 0xffffffff) || i_16_ <= i_18_)
						&& ((i_14_ ^ 0xffffffff) != (i_15_ ^ 0xffffffff) || i_17_ <= i_16_)) {
					i_13_ -= i_15_;
					i_15_ -= i_14_;
					i_14_ = anInt11042 * i_14_;
					while ((--i_15_ ^ 0xffffffff) <= -1) {
