...
public class r_Sub2 extends r {
	public static IncomingPacket SEND_SCROLL_ICOMPONENT;
	public static Class253[] aClass253Array11063 = new Class253[100];
	public static int anInt11053;
	public static int anInt11054;
	public static int anInt11059;
	public static int anInt11060;
	public static int anInt11061;
	public static int anInt11062;
	public static int anInt11065;
	public static int anInt11066;
	static {
		SEND_SCROLL_ICOMPONENT = new IncomingPacket(8, 6);
	}

	public static final Frame method2371(int i, SignLink signlink, int i_9_, int i_10_, int i_11_, int i_12_) {
		anInt11060++;
		...
		if (i == 0) {
			...
			for (int i_13_ = 0; (i_13_ ^ 0xffffffff) > (class244s.length ^ 0xffffffff); i_13_++)
				if (class244s[i_13_].anInt3084 == i_11_ && class244s[i_13_].anInt3078 == i_10_
	...
	public static final void method2375(boolean bool, byte b, Actor actor) {
		anInt11059++;
		int i = -1;
		if (b != -49)
			SEND_SCROLL_ICOMPONENT = null;
		int i_22_ = 0;
		...
		if ((actor.anInt5934 ^ 0xffffffff) > -513 || (actor.anInt5940 ^ 0xffffffff) > -513
				|| (Node_Sub54.GAME_SCENE_WDITH * 512 + -512 ^ 0xffffffff) >= (actor.anInt5934 ^ 0xffffffff)
				|| (actor.anInt5940 ^ 0xffffffff) <= (Class377_Sub1.GAME_SCENE_HEIGHT * 512 - 512 ^ 0xffffffff)) {
		...
		if (actor == Player.get && ((actor.anInt5934 ^ 0xffffffff) > -6145 || actor.anInt5940 < 6144
				|| (actor.anInt5934 ^ 0xffffffff) <= (-6144 + 512 * Node_Sub54.GAME_SCENE_WDITH ^ 0xffffffff)
				|| (-6144 + Class377_Sub1.GAME_SCENE_HEIGHT * 512 ^ 0xffffffff) >= (actor.anInt5940 ^ 0xffffffff))) {
			actor.anAnimator10876.method249(true, -1);
	...
	public static final void method2376(int i) {
		Node_Sub24.method2650(false, -14651);
		anInt11066++;
		Node_Sub29_Sub2.anInt10015 = 0;
		boolean bool = true;
		for (int i_26_ = 0; (Class188_Sub1_Sub1.aByteArrayArray9334.length ^ 0xffffffff) < (i_26_
				^ 0xffffffff); i_26_++) {
			if (StandardPlane.anIntArray7980[i_26_] != -1 && Class188_Sub1_Sub1.aByteArrayArray9334[i_26_] == null) {
				Class188_Sub1_Sub1.aByteArrayArray9334[i_26_] = Animable_Sub1_Sub1.aClass302_10618.method3524(false, 0,
						StandardPlane.anIntArray7980[i_26_]);
			...
			if (Class144.anIntArray1789[i_26_] != -1 && FileOnDisk.aByteArrayArray1331[i_26_] == null) {
				FileOnDisk.aByteArrayArray1331[i_26_] = Animable_Sub1_Sub1.aClass302_10618
						.method3512(Class15.XTEA_KEYS[i_26_], 0, -114, Class144.anIntArray1789[i_26_]);
			...
			if (Class42.anIntArray645[i_26_] != -1 && Class320_Sub6.aByteArrayArray8263[i_26_] == null) {
				Class320_Sub6.aByteArrayArray8263[i_26_] = Animable_Sub1_Sub1.aClass302_10618.method3524(false, 0,
						Class42.anIntArray645[i_26_]);
			...
			if (ProducingGraphicsBuffer.anIntArray9895[i_26_] != -1
				...
				Class320_Sub18.aByteArrayArray8378[i_26_] = Animable_Sub1_Sub1.aClass302_10618.method3524(false, 0,
						ProducingGraphicsBuffer.anIntArray9895[i_26_]);
				if (Class320_Sub18.aByteArrayArray8378[i_26_] == null) {
					Node_Sub29_Sub2.anInt10015++;
					bool = false;
				}
			}
			if (Class204.anIntArray2460 != null && Class194.aByteArrayArray2373[i_26_] == null
					&& (Class204.anIntArray2460[i_26_] ^ 0xffffffff) != 0) {
				Class194.aByteArrayArray2373[i_26_] = Animable_Sub1_Sub1.aClass302_10618
						.method3512(Class15.XTEA_KEYS[i_26_], 0, 118, Class204.anIntArray2460[i_26_]);
		...
		if (Class262_Sub15_Sub1.aClass224_10520 == null)
			if (Class92.aCacheNode_Sub11_1233 != null && r_Sub1.aClass302_11047
					.method3516(Class92.aCacheNode_Sub11_1233.aString9537 + "_staticelements", -73)) {
				if (r_Sub1.aClass302_11047.method3527(Class92.aCacheNode_Sub11_1233.aString9537 + "_staticelements", 0))
					Class262_Sub15_Sub1.aClass224_10520 = Class152.method1695(Class101.aBoolean1313, 0,
							r_Sub1.aClass302_11047, Class92.aCacheNode_Sub11_1233.aString9537 + "_staticelements");
				else {
					bool = false;
					Node_Sub29_Sub2.anInt10015++;
				}
		...
		if (!bool)
			...
			for (int i_27_ = 0; (Class188_Sub1_Sub1.aByteArrayArray9334.length ^ 0xffffffff) < (i_27_
					^ 0xffffffff); i_27_++) {
				...
				if (bs != null) {
					...
					bool &= Class118.method1175(bs, -1, i_28_, Node_Sub54.GAME_SCENE_WDITH, i_29_,
				...
				if (bs != null) {
					...
					bool &= Class118.method1175(bs, -1, i_30_, Node_Sub54.GAME_SCENE_WDITH, i_31_,
							Class377_Sub1.GAME_SCENE_HEIGHT);
				}
			}
			if (!bool)
				...
				if ((Class118.anInt5407 ^ 0xffffffff) != -1)
					Class169_Sub3.method1779(Class93.graphicsToolkit,
							GlobalMessage.LOADING_PLEASE_WAIT.getMessage(Class35.language) + "<br>(100%)", true,
				...
				if (Class93.graphicsToolkit.z()
						&& Class213.aNode_Sub27_2512.aClass320_Sub26_7269.method3779(false) == 2)
					for (int i_34_ = 0; (Class188_Sub1_Sub1.aByteArrayArray9334.length ^ 0xffffffff) < (i_34_
							^ 0xffffffff); i_34_++)
				...
				if (Class93.graphicsToolkit.p())
					i_35_++;
				AbstractToolkit.method1267(Class93.graphicsToolkit, Class244.anInt3081, 9, 4,
						Node_Sub54.GAME_SCENE_WDITH, Class377_Sub1.GAME_SCENE_HEIGHT, i_35_, bool_33_,
						Class93.graphicsToolkit.e() > 0);
				...
				LoadingBar.aBoolean2015 = Class213.aNode_Sub27_2512.aClass320_Sub24_7317.method3773(false) == 1;
				Class256.anInt3237 = (Class213.aNode_Sub27_2512.aClass320_Sub19_7301.method3751(false)
						^ 0xffffffff) == -2 ? -1 : Class94.anInt1249;
				Class382.aBoolean5254 = Class213.aNode_Sub27_2512.aClass320_Sub23_7290.method3770(false) == 1;
				Class169_Sub2_Sub1.aBoolean10563 = Class213.aNode_Sub27_2512.aClass320_Sub30_7275
						.method3796(false) == 1;
				Node_Sub38_Sub1.aClass277_Sub1_10084 = new Class277_Sub1(4, Node_Sub54.GAME_SCENE_WDITH,
						Class377_Sub1.GAME_SCENE_HEIGHT, false);
				if (Class61.anInt898 == 0)
					Actor.method863(Class188_Sub1_Sub1.aByteArrayArray9334, (byte) -74,
							Node_Sub38_Sub1.aClass277_Sub1_10084);
				else
					Class368.method4078(Class188_Sub1_Sub1.aByteArrayArray9334, (byte) -119,
							Node_Sub38_Sub1.aClass277_Sub1_10084);
				Class290_Sub2.method3426(Node_Sub54.GAME_SCENE_WDITH >> 4, (byte) 119,
						Class377_Sub1.GAME_SCENE_HEIGHT >> 4);
				Class89.method1022(false);
				if (bool_33_) {
					Node_Sub38_Sub17.method2842(true);
					Class270_Sub1.aClass277_Sub1_8028 = new Class277_Sub1(1, Node_Sub54.GAME_SCENE_WDITH,
							Class377_Sub1.GAME_SCENE_HEIGHT, true);
					if ((Class61.anInt898 ^ 0xffffffff) == -1) {
						Actor.method863(Class320_Sub6.aByteArrayArray8263, (byte) -74,
								Class270_Sub1.aClass277_Sub1_8028);
						Node_Sub24.method2650(true, -14651);
					} else {
						Class368.method4078(Class320_Sub6.aByteArrayArray8263, (byte) -116,
								Class270_Sub1.aClass277_Sub1_8028);
						Node_Sub24.method2650(true, -14651);
					}
					Class270_Sub1.aClass277_Sub1_8028.method3343(
							Node_Sub38_Sub1.aClass277_Sub1_10084.anIntArrayArrayArray3520[0], (byte) 119, 0);
					Class270_Sub1.aClass277_Sub1_8028.method3339(-2, null, Class93.graphicsToolkit, null);
					Node_Sub38_Sub17.method2842(false);
				}
				Node_Sub38_Sub1.aClass277_Sub1_10084.method3339(-2,
						bool_33_ ? Class270_Sub1.aClass277_Sub1_8028.anIntArrayArrayArray3520 : null,
						Class93.graphicsToolkit, Class304.SCENE_CLIP_DATA_PLANES);
				if ((Class61.anInt898 ^ 0xffffffff) != -1) {
					Node_Sub24.method2650(true, -14651);
					CacheNode_Sub7.method2317(FileOnDisk.aByteArrayArray1331, (byte) -122,
							Node_Sub38_Sub1.aClass277_Sub1_10084);
				} else {
					Node_Sub24.method2650(true, -14651);
				...
				Node_Sub24.method2650(true, -14651);
				Node_Sub38_Sub1.aClass277_Sub1_10084.method3346((byte) 75, Class93.graphicsToolkit,
						bool_33_ ? Class368.aPlaneArray4548[0] : null, null);
				Node_Sub38_Sub1.aClass277_Sub1_10084.method3356(false, Class93.graphicsToolkit, (byte) 83);
				Node_Sub24.method2650(true, -14651);
				if (bool_33_) {
					Node_Sub38_Sub17.method2842(true);
					Node_Sub24.method2650(true, -14651);
					if ((Class61.anInt898 ^ 0xffffffff) != -1)
						CacheNode_Sub7.method2317(Class320_Sub18.aByteArrayArray8378, (byte) -92,
								Class270_Sub1.aClass277_Sub1_8028);
					else
						Class178.method1811(31269, Class320_Sub18.aByteArrayArray8378,
								Class270_Sub1.aClass277_Sub1_8028);
					Node_Sub36_Sub2.method2761((byte) 125);
					Node_Sub24.method2650(true, -14651);
					Class270_Sub1.aClass277_Sub1_8028.method3346((byte) 75, Class93.graphicsToolkit, null,
							Node_Sub38_Sub37.aPlaneArray10466[0]);
					Class270_Sub1.aClass277_Sub1_8028.method3356(true, Class93.graphicsToolkit, (byte) 83);
					Node_Sub24.method2650(true, -14651);
					Node_Sub38_Sub17.method2842(false);
				}
				...
				for (int i_38_ = 0; (i_38_ ^ 0xffffffff) > -5; i_38_++)
					for (int i_39_ = 0; i_39_ < Node_Sub54.GAME_SCENE_WDITH; i_39_++)
						for (int i_40_ = 0; (i_40_ ^ 0xffffffff) > (Class377_Sub1.GAME_SCENE_HEIGHT
								^ 0xffffffff); i_40_++)
				...
				if (Node_Sub29.aFrame7344 != null && Class218.aClass123_2566.aClass365_1557 != null
						&& Class151.anInt1843 == 12) {
					Animable_Sub3.anInt9139++;
					Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, Class169_Sub3.aClass318_8808,
							Class218.aClass123_2566.isaacCipher);
					node_sub13.packet.writeInt(1057001181);
				...
				if ((Class61.anInt898 ^ 0xffffffff) == -1) {
					...
					for (int i_45_ = i_41_ - 1; i_42_ + 1 >= i_45_; i_45_++)
						for (int i_46_ = i_43_ - 1; (1 + i_44_ ^ 0xffffffff) <= (i_46_ ^ 0xffffffff); i_46_++)
							if ((i_45_ ^ 0xffffffff) > (i_41_ ^ 0xffffffff) || i_45_ > i_42_
				...
				if ((Class151.anInt1843 ^ 0xffffffff) != -5) {
					if ((Class151.anInt1843 ^ 0xffffffff) == -9)
						...
						if (Class218.aClass123_2566.aClass365_1557 != null) {
							Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, PlayerMasks.aClass318_1220,
									Class218.aClass123_2566.isaacCipher);
				...
				if (MiniMap.rebuildMiniMap) {
					DeveloperConsole.printConsoleMessage((byte) 43,
							"Took: " + (-Class366.aLong4528 + Class313.method3650(false)) + "ms");
					MiniMap.rebuildMiniMap = false;
				}
			}
		}
	}
	...
	public final void method2370(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_) {
		anInt11062++;
		int i_6_ = 0;
		...
		if (i_5_ >= 36) {
			...
			if ((i_0_ ^ 0xffffffff) >= (i_2_ ^ 0xffffffff) && (i_0_ ^ 0xffffffff) >= (i_3_ ^ 0xffffffff)) {
				if ((i_3_ ^ 0xffffffff) < (i_2_ ^ 0xffffffff)) {
					...
					if ((i_0_ == i_2_ || (i_6_ ^ 0xffffffff) >= (i_8_ ^ 0xffffffff))
							&& ((i_0_ ^ 0xffffffff) != (i_2_ ^ 0xffffffff)
					...
					if ((i_0_ ^ 0xffffffff) != (i_3_ ^ 0xffffffff) && (i_8_ ^ 0xffffffff) > (i_6_ ^ 0xffffffff)
							|| (i_3_ ^ 0xffffffff) == (i_0_ ^ 0xffffffff) && i_7_ > i_6_) {
						i_2_ -= i_3_;
						i_3_ -= i_0_;
						i_0_ *= anInt11057;
						while (--i_3_ >= 0) {
				...
				if (i_2_ != i_3_ && (i_6_ ^ 0xffffffff) > (i_7_ ^ 0xffffffff)
						|| i_2_ == i_3_ && (i_6_ ^ 0xffffffff) < (i_8_ ^ 0xffffffff)) {
					i_0_ -= i_3_;
					i_3_ -= i_2_;
					i_2_ *= anInt11057;
					while (--i_3_ >= 0) {
	...
	public final void method2372(int i, int i_14_, byte b, int i_15_, int i_16_) {
		anInt11057 = i + -i_16_;
		anInt11064 = i_16_;
	...
	public final boolean method2373(int i, int i_18_, int i_19_) {
		anInt11053++;
		if (i_18_ != 0)
			return true;
