...
public class t extends Plane implements Interface3 {
	...
	@Override
	public final native void CA(r var_r, int i, int i_67_, int i_68_, int i_69_, boolean bool);

	@Override
	public final native r fa(int i, int i_82_, r var_r);
	...
	private final native void ga(oa var_oa, ya var_ya, int i, int i_89_, int[][] is, int[][] is_90_, int i_91_,
			int i_92_, int i_93_);

	@Override
	public final native void ka(int i, int i_70_, int i_71_);

	@Override
	public final void method3250(Node_Sub29 node_sub29, int[] is) {
		aClass312_5019.method3625((byte) -54, node_sub29);
		V(node_sub29.hashCode(), node_sub29.method2705(32311), node_sub29.method2704(30), node_sub29.method2708(27433),
				node_sub29.method2711(123), node_sub29.method2710((byte) -61), is);
	}

	@Override
	public final void method3252(int i, int i_11_, int i_12_, boolean[][] bools, boolean bool, int i_13_) {
		anInt5021 = -1;
		int i_14_ = 0;
		float[] fs = new float[aClass312_5019.method3615(-87)];
		for (Node_Sub29 node_sub29 = (Node_Sub29) aClass312_5019
				.method3613(65280); node_sub29 != null; node_sub29 = (Node_Sub29) aClass312_5019.method3620(16776960))
	...
	@Override
	public final void method3253(int i, int i_29_, int[] is, int[] is_30_, int[] is_31_, int[] is_32_, int[] is_33_,
			int[] is_34_, int[] is_35_, int[] is_36_, int[] is_37_, int[] is_38_, int[] is_39_, int i_40_, int i_41_,
			int i_42_, boolean bool) {
		boolean bool_43_ = false;
		if (is_36_ != null) {
			int[] is_44_ = is_36_;
			for (int i_46_ : is_44_) {
				if (i_46_ != -1) {
					bool_43_ = true;
					break;
				}
	...
	@Override
	public final void method3255(int i, int i_83_, int i_84_, int i_85_, int i_86_, int i_87_, int i_88_, boolean[][] bools) {
		anOa5020.C().method154(this, i, i_83_, i_84_, i_85_, i_86_, i_87_, i_88_, bools);
	}

	@Override
	public final boolean method3256(r var_r, int i, int i_61_, int i_62_, int i_63_, boolean bool) {
		return true;
	}

	@Override
	public final void method3257(int i, int i_19_) {
		if (anInt5021 < 0)
	...
	@Override
	public final void method3259(int i, int i_20_, int i_21_, boolean[][] bools, boolean bool, int i_22_, int i_23_) {
		anInt5021 = i_22_;
		int i_24_ = 0;
	...
	@Override
	public final native void U(int i, int i_0_, int[] is, int[] is_1_, int[] is_2_, int[] is_3_, int[] is_4_, int[] is_5_,
			int[] is_6_, int[] is_7_, int i_8_, int i_9_, int i_10_, boolean bool);
	...
	@Override
	public final native void wa(r var_r, int i, int i_64_, int i_65_, int i_66_, boolean bool);
