...
public abstract class za extends Node {
	
	public static Class251 aClass251_7694;
	...
	public static final void method2991(String string, boolean bool) {
		anInt7695++;
		if (string != null) {
			...
			if (string_0_ != null) {
				...
				for (int i = 0; (i ^ 0xffffffff) > (Class235.anInt5122 ^ 0xffffffff); i++) {
					...
					if (Class310.method3601(string, string_2_, 30195, string_1_, string_0_)) {
						...
						Node_Sub13 node_sub13 = PacketDecoder.sendOutgoingOPCode(-386, EntityNode_Sub1.aClass318_5927,
